	   ...
	   <tr id="tr_more_info" style="display:none">
	   		<td colspan="2">	   				   			   		
				   ...
				   <tr id='tr_use_ssl' style="display:<?php echo $dbms != 'mysql' ? 'none' : ''; ?>">
				      ...
				      <td width="160px" class="nmLineV3">
				        <input type="checkbox" name='use_ssl' id='use_ssl' value="Y" <?php echo ($use_ssl=='Y')?"checked=checked":""; ?> />
				      </td>
				   </tr>
				   <tr id='tr_mysql_ssl_key' style="display:<?php echo $dbms != 'mysql' ? 'none' : ''; ?>">
				      ...
				      <td width="160px" class="nmLineV3">
				        <input type="text" class="nmInput" name='mysql_ssl_key' value="<?php echo str_replace('"', '&quot;', $mysql_ssl_key); ?>" />
				      </td>
				   </tr>
				   <tr id='tr_mysql_ssl_cert' style="display:<?php echo $dbms != 'mysql' ? 'none' : ''; ?>">
				      ...
				      <td width="160px" class="nmLineV3">
				        <input type="text" class="nmInput" name='mysql_ssl_cert' value="<?php echo str_replace('"', '&quot;', $mysql_ssl_cert); ?>" />
				      </td>
				   </tr>
				   <tr id='tr_mysql_ssl_capath' style="display:<?php echo $dbms != 'mysql' ? 'none' : ''; ?>">
				      ...
				      <td width="160px" class="nmLineV3">
				        <input type="text" class="nmInput" name='mysql_ssl_capath' value="<?php echo str_replace('"', '&quot;', $mysql_ssl_capath); ?>" />
				      </td>
				   </tr>
				   <tr id='tr_mysql_ssl_ca' style="display:<?php echo $dbms != 'mysql' ? 'none' : ''; ?>">
				      ...
				      <td width="160px" class="nmLineV3">
				        <input type="text" class="nmInput" name='mysql_ssl_ca' value="<?php echo str_replace('"', '&quot;', $mysql_ssl_ca); ?>" />
				      </td>
				   </tr>
				   <tr id='tr_mysql_ssl_cipher' style="display:<?php echo $dbms != 'mysql' ? 'none' : ''; ?>">
				      ...
				      <td width="160px" class="nmLineV3">
				        <input type="text" class="nmInput" name='mysql_ssl_cipher' value="<?php echo str_replace('"', '&quot;', $mysql_ssl_cipher); ?>" />
				      </td>
				   </tr>
		   		</table>
