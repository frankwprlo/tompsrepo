...
function db_conect($tpbanco, $servidor, $usuario, $senha, $banco, $protect, $sec="S", $persistent="N", $db2_param="", $database_encoding="", $nm_arr_db_extra_args = array())
{
    ...
    if ("NmScriptCaseAplOk" == $nm_reg_prod || $sec == "N")
    {
        ...
        else if($adodb_banco == 'pdosqlite' || $adodb_banco == 'pdo_informix' || $adodb_banco == 'pdo_mysql' || $adodb_banco == 'pdo_pgsql' || $adodb_banco == 'pdo_sqlsrv' || $adodb_banco == 'pdo_dblib' || $adodb_banco == 'pdo_sybase_odbc')
        {
            $adodb_banco = 'pdo';
        }
        ...
        elseif ($tpbanco == "pdo_sybase_odbc")
        {
