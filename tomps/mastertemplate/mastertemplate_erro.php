...
$old_error_handler = set_error_handler("mastertemplate_scriptcase_error_handler");

function mastertemplate_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['mastertemplate']['contr_erro']) && $_SESSION['scriptcase']['mastertemplate']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_mastertemplate->contr_mastertemplate->Apl_com_erro = true;
            if ($inicial_mastertemplate->contr_mastertemplate->NM_ajax_flag)
            {
                $inicial_mastertemplate->contr_mastertemplate->NM_ajax_info['errList']['geral_mastertemplate'][] = $msg;
                return;
            }
            mastertemplate_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function mastertemplate_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['mastertemplate'])  && '' != $_SESSION['scriptcase']['error_icon']['mastertemplate'])  ? $_SESSION['scriptcase']['error_icon']['mastertemplate']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['mastertemplate']) && '' != $_SESSION['scriptcase']['error_close']['mastertemplate']) ? $_SESSION['scriptcase']['error_close']['mastertemplate'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['mastertemplate']) && '' != $_SESSION['scriptcase']['error_span_title']['mastertemplate']) ? $_SESSION['scriptcase']['error_span_title']['mastertemplate'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['mastertemplate']) && '' != $_SESSION['scriptcase']['error_icon_title']['mastertemplate']) ? $_SESSION['scriptcase']['error_icon_title']['mastertemplate'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['mastertemplate']['error_buffer'] .= ob_get_flush();
}
