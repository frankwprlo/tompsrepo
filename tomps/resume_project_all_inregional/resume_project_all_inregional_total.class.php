...
class resume_project_all_inregional_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['resume_project_all_inregional']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['resume_project_all_inregional']['campos_busca']))
      { 
