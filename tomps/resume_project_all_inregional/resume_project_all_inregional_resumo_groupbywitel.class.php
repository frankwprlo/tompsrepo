...
class resume_project_all_inregional_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_mw_namawitel = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['contr_total_geral'] == "OK")
      {
          $this->array_total_mw_namawitel = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['arr_total']['mw_namawitel'];
      }
      else
      {
          $this->array_total_mw_namawitel = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['tot_geral'][2];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['tot_geral'][3];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['tot_geral'][4];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['tot_geral'][5];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['tot_geral'][6];
      $this->array_total_geral[6] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['tot_geral'][7];
      $this->array_total_geral[7] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['tot_geral'][8];
      $this->array_total_geral[8] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['tot_geral'][9];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   ...
   function completeMatrix()
   {
       ...
       $this->comp_sum = array(
           2 => "LOP",
           3 => "Nilai DRM(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
           4 => "Nilai Rekon(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
           5 => "Jml ODP",
           6 => "Preparing",
           7 => "Perijinan",
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['summarizing_fields_order']['groupbywitel']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['summarizing_fields_order']['groupbywitel'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['summarizing_fields_order']['groupbywitel'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['summarizing_fields_display']['groupbywitel'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['summarizing_fields_display']['groupbywitel'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['summarizing_fields_display']['groupbywitel'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['summarizing_fields_display']['groupbywitel'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['summarizing_fields_display']['groupbywitel'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['summarizing_fields_display']['groupbywitel'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['summarizing_fields_display']['groupbywitel'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_mw_namawitel as $i_mw_namawitel => $d_mw_namawitel) {
           if (!in_array($i_mw_namawitel, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_mw_namawitel[11] ] = $d_mw_namawitel[10];
               $this->comp_label[0][ $d_mw_namawitel[11] ] = $d_mw_namawitel[10];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'mw_namawitel', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_order_col'] = 9;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_order_sort'] = 'd';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_order_col']  = 0;
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_mw_namawitel => $l_mw_namawitel) {
           if (isset($this->array_total_mw_namawitel[$i_mw_namawitel])) {
               $this->comp_group[$i_mw_namawitel] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_mw_namawitel;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@resume_project_all_inregional@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['anlt_table_def']  = array();
   }
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_resume_project_all_inregional_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_resume_project_all_inregional_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['pivot_order_start'][$iYAxysIndex])
                       {
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "resume_project_all_inregional_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['opcao'] = "print";
      ...
      $this->Total   = new resume_project_all_inregional_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
      ...
      $this->array_total_mw_namawitel = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['arr_total']['mw_namawitel'];
      ksort($this->array_total_mw_namawitel);
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['responsive_chart']['active']) {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_resume_project_all_inregional_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_resume_project_all_inregional_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_resume_project_all_inregional_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['num_css'] . '.css');
     ...
     else
     {
      ...
      $nm_saida->saida(" </style>\r\n");
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "resume_project_all_inregional/resume_project_all_inregional_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "resume_project_all_inregional/resume_project_all_inregional_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnGroupByShow('" . $this->Ini->path_link . "resume_project_all_inregional/resume_project_all_inregional_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("resume_project_all_inregional_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'resume_project_all_inregional_config_pivot.php?nome_apl=resume_project_all_inregional&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_resume_project_all_inregional_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "resume_project_all_inregional/resume_project_all_inregional_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
   ...
   function monta_rodape()
   {
      ...
      $nm_cab_filtro   = ""; 
      $nm_cab_filtrobr = ""; 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['campos_busca']))
      { 
        $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['campos_busca'];
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
   ...
   //---- 
   function adiciona_registro($sum_tp_rab, $sum_tp_nilai, $sum_tp_odp, $avg_prepare, $avg_perijinan, $avg_inst_testcomm, $avg_closing, $avg_pencapaian, $quebra_mw_namawitel, $quebra_mw_namawitel_orig)
   {
      //----- Witel
      if (!isset($this->array_total_mw_namawitel[$quebra_mw_namawitel_orig]))
      {
         $this->array_total_mw_namawitel[$quebra_mw_namawitel_orig][0] = 1;
         $this->array_total_mw_namawitel[$quebra_mw_namawitel_orig][1] = $sum_tp_rab;
         $this->array_total_mw_namawitel[$quebra_mw_namawitel_orig][2] = $sum_tp_nilai;
         $this->array_total_mw_namawitel[$quebra_mw_namawitel_orig][3] = $sum_tp_odp;
         $this->array_total_mw_namawitel[$quebra_mw_namawitel_orig][4] = $avg_prepare;
         $this->array_total_mw_namawitel[$quebra_mw_namawitel_orig][5] = $avg_perijinan;
         $this->array_total_mw_namawitel[$quebra_mw_namawitel_orig][6] = $avg_inst_testcomm;
         $this->array_total_mw_namawitel[$quebra_mw_namawitel_orig][7] = $avg_closing;
         $this->array_total_mw_namawitel[$quebra_mw_namawitel_orig][8] = $avg_pencapaian;
         $this->array_total_mw_namawitel[$quebra_mw_namawitel_orig][9] = 1;
         $this->array_total_mw_namawitel[$quebra_mw_namawitel_orig][10] = $quebra_mw_namawitel;
         $this->array_total_mw_namawitel[$quebra_mw_namawitel_orig][11] = $quebra_mw_namawitel_orig;
      }
      else
      {
         $this->array_total_mw_namawitel[$quebra_mw_namawitel_orig][0]++;
         $this->array_total_mw_namawitel[$quebra_mw_namawitel_orig][1] += $sum_tp_rab;
         $this->array_total_mw_namawitel[$quebra_mw_namawitel_orig][2] += $sum_tp_nilai;
         $this->array_total_mw_namawitel[$quebra_mw_namawitel_orig][3] += $sum_tp_odp;
         $this->array_total_mw_namawitel[$quebra_mw_namawitel_orig][4] += $avg_prepare;
         ...
         $this->array_total_mw_namawitel[$quebra_mw_namawitel_orig][7] += $avg_closing;
         $this->array_total_mw_namawitel[$quebra_mw_namawitel_orig][8] += $avg_pencapaian;
         $this->array_total_mw_namawitel[$quebra_mw_namawitel_orig][9]++;
      }
      //----- Total
      if (empty($this->array_total_geral))
      {
         $this->array_total_geral[0] = 1;
         $this->array_total_geral[1] = $sum_tp_rab;
         $this->array_total_geral[2] = $sum_tp_nilai;
         $this->array_total_geral[3] = $sum_tp_odp;
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['arr_total']['mw_namawitel'] as $campo_mw_namawitel => $dados_mw_namawitel)
      {
         $this->array_total_mw_namawitel[$campo_mw_namawitel][2] = $dados_mw_namawitel[1];
         $this->array_total_mw_namawitel[$campo_mw_namawitel][3] = $dados_mw_namawitel[2];
         $this->array_total_mw_namawitel[$campo_mw_namawitel][4] = $dados_mw_namawitel[3];
         $this->array_total_mw_namawitel[$campo_mw_namawitel][5] = $dados_mw_namawitel[4];
         $this->array_total_mw_namawitel[$campo_mw_namawitel][6] = $dados_mw_namawitel[5];
         $this->array_total_mw_namawitel[$campo_mw_namawitel][7] = $dados_mw_namawitel[6];
         $this->array_total_mw_namawitel[$campo_mw_namawitel][8] = $dados_mw_namawitel[7];
         $this->array_total_mw_namawitel[$campo_mw_namawitel][9] = $dados_mw_namawitel[8];
         $this->array_total_mw_namawitel[$campo_mw_namawitel][1] = $dados_mw_namawitel[9];
      }
   }
   //---- 
   function finaliza_arrays()
   {
      foreach ($this->array_total_mw_namawitel as $campo_mw_namawitel => $dados_mw_namawitel)
      {
         nmgp_Trunc_Num($this->array_total_mw_namawitel[$campo_mw_namawitel][1], 0);
         nmgp_Trunc_Num($this->array_total_mw_namawitel[$campo_mw_namawitel][2], 0);
         nmgp_Trunc_Num($this->array_total_mw_namawitel[$campo_mw_namawitel][3], 0);
         if ($this->array_total_mw_namawitel[$campo_mw_namawitel][0] != 0) {$this->array_total_mw_namawitel[$campo_mw_namawitel][4] /= $this->array_total_mw_namawitel[$campo_mw_namawitel][0];}
         nmgp_Trunc_Num($this->array_total_mw_namawitel[$campo_mw_namawitel][4], 2);
         if ($this->array_total_mw_namawitel[$campo_mw_namawitel][0] != 0) {$this->array_total_mw_namawitel[$campo_mw_namawitel][5] /= $this->array_total_mw_namawitel[$campo_mw_namawitel][0];}
         nmgp_Trunc_Num($this->array_total_mw_namawitel[$campo_mw_namawitel][5], 2);
         if ($this->array_total_mw_namawitel[$campo_mw_namawitel][0] != 0) {$this->array_total_mw_namawitel[$campo_mw_namawitel][6] /= $this->array_total_mw_namawitel[$campo_mw_namawitel][0];}
         nmgp_Trunc_Num($this->array_total_mw_namawitel[$campo_mw_namawitel][6], 2);
         if ($this->array_total_mw_namawitel[$campo_mw_namawitel][0] != 0) {$this->array_total_mw_namawitel[$campo_mw_namawitel][7] /= $this->array_total_mw_namawitel[$campo_mw_namawitel][0];}
         nmgp_Trunc_Num($this->array_total_mw_namawitel[$campo_mw_namawitel][7], 2);
         if ($this->array_total_mw_namawitel[$campo_mw_namawitel][0] != 0) {$this->array_total_mw_namawitel[$campo_mw_namawitel][8] /= $this->array_total_mw_namawitel[$campo_mw_namawitel][0];}
         nmgp_Trunc_Num($this->array_total_mw_namawitel[$campo_mw_namawitel][8], 2);
      }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'mw_namawitel');
     $campos_order = $this->Ini->Get_date_order_groupby("MW_NAMAWITEL", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->tp_rab = $rs_res->fields[12] ;  
            $this->tp_nilai = $rs_res->fields[13] ;  
            $this->tp_lokasi = $rs_res->fields[14] ;  
            $this->tp_odp = $rs_res->fields[15] ;  
            $this->tp_planstart = $rs_res->fields[16] ;  
            $this->tp_planfinish = $rs_res->fields[17] ;  
            $this->tp_summary = $rs_res->fields[18] ;  
            $this->tp_status = $rs_res->fields[19] ;  
            $this->tp_jenisproject = $rs_res->fields[20] ;  
            $this->tp_targetwaktu = $rs_res->fields[21] ;  
...
$_SESSION['scriptcase']['resume_project_all_inregional']['contr_erro'] = 'off'; 
            $this->mw_namawitel_orig = $this->mw_namawitel;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->tp_rab, $this->tp_nilai, $this->tp_odp, $this->prepare, $this->perijinan, $this->inst_testcomm, $this->closing, $this->pencapaian, $this->mw_namawitel, $this->mw_namawitel_orig);
            }
   }
//
...
$_SESSION['scriptcase']['resume_project_all_inregional']['contr_erro'] = 'off';
         ...
         $this->adiciona_registro(NM_encode_input(sc_strip_script($this->tp_rab)), NM_encode_input(sc_strip_script($this->tp_nilai)), NM_encode_input(sc_strip_script($this->tp_odp)), NM_encode_input(sc_strip_script($this->prepare)), NM_encode_input(sc_strip_script($this->perijinan)), NM_encode_input(sc_strip_script($this->inst_testcomm)), NM_encode_input(sc_strip_script($this->closing)), NM_encode_input(sc_strip_script($this->pencapaian)), sc_strip_script($this->mw_namawitel), sc_strip_script($mw_namawitel_orig));
         $this->rs_grid->MoveNext();
      }
      $this->finaliza_arrays();
      $this->rs_grid->Close();
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['tot_geral'][2] = $this->array_total_geral[1];
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['tot_geral'][3] = $this->array_total_geral[2];
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['tot_geral'][4] = $this->array_total_geral[3];
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['tot_geral'][5] = $this->array_total_geral[4];
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['tot_geral'][6] = $this->array_total_geral[5];
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['tot_geral'][7] = $this->array_total_geral[6];
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['tot_geral'][8] = $this->array_total_geral[7];
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['tot_geral'][9] = $this->array_total_geral[8];
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['tot_geral'][1] = $this->array_total_geral[0];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inregional']['arr_total']['mw_namawitel'] = $this->array_total_mw_namawitel;
      }
   }
