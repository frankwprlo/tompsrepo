<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new update_ptosentase_project_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class update_ptosentase_project_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["tp_id"]   = (isset($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["tp_id"])) ? $_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["tp_id"] : "ID";
   $tab_ger_campos['tp_idlop'] = "on";
   $tab_def_campos['tp_idlop'] = "TP_IDLOP";
   $tab_converte["TP_IDLOP"]   = "tp_idlop";
   $tab_labels["tp_idlop"]   = (isset($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["tp_idlop"])) ? $_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["tp_idlop"] : "IDLOP";
   $tab_ger_campos['tp_taskaktif'] = "on";
   $tab_def_campos['tp_taskaktif'] = "TP_TASKAKTIF";
   $tab_converte["TP_TASKAKTIF"]   = "tp_taskaktif";
   $tab_labels["tp_taskaktif"]   = (isset($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["tp_taskaktif"])) ? $_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["tp_taskaktif"] : "TASK<br>AKTIF";
   $tab_ger_campos['tp_prosentase'] = "on";
   $tab_def_campos['tp_prosentase'] = "TP_PROSENTASE";
   $tab_converte["TP_PROSENTASE"]   = "tp_prosentase";
   $tab_labels["tp_prosentase"]   = (isset($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["tp_prosentase"])) ? $_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["tp_prosentase"] : "PRO<br>SENTASE";
   $tab_ger_campos['tp_tahapanaktif'] = "on";
   $tab_def_campos['tp_tahapanaktif'] = "TP_TAHAPANAKTIF";
   $tab_converte["TP_TAHAPANAKTIF"]   = "tp_tahapanaktif";
   $tab_labels["tp_tahapanaktif"]   = (isset($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["tp_tahapanaktif"])) ? $_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["tp_tahapanaktif"] : "TAHAPAN<br>AKTIF";
   $tab_ger_campos['tp_taskaktifstatus'] = "on";
   $tab_def_campos['tp_taskaktifstatus'] = "TP_TASKAKTIFSTATUS";
   $tab_converte["TP_TASKAKTIFSTATUS"]   = "tp_taskaktifstatus";
   $tab_labels["tp_taskaktifstatus"]   = (isset($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["tp_taskaktifstatus"])) ? $_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["tp_taskaktifstatus"] : "TASKAKTIF<br>STATUS";
   $tab_ger_campos['tp_taskaktif_number'] = "on";
   $tab_def_campos['tp_taskaktif_number'] = "TP_TASKAKTIF_NUMBER";
   $tab_converte["TP_TASKAKTIF_NUMBER"]   = "tp_taskaktif_number";
   $tab_labels["tp_taskaktif_number"]   = (isset($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["tp_taskaktif_number"])) ? $_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["tp_taskaktif_number"] : "TASKAKTIF<br>NUMBER";
   ...
   $tab_labels["tp_templateproject"]   = (isset($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["tp_templateproject"])) ? $_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["tp_templateproject"] : "TEMPLATE<br>PROJECT";
   $tab_ger_campos['tp_planstart'] = "on";
   $tab_def_campos['tp_planstart'] = "TP_PLANSTART";
   $tab_converte["TP_PLANSTART"]   = "tp_planstart";
   $tab_labels["tp_planstart"]   = (isset($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["tp_planstart"])) ? $_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["tp_planstart"] : "PLANSTART";
   $tab_ger_campos['tp_targetwaktu'] = "on";
   $tab_def_campos['tp_targetwaktu'] = "TP_TARGETWAKTU";
   $tab_converte["TP_TARGETWAKTU"]   = "tp_targetwaktu";
   $tab_labels["tp_targetwaktu"]   = (isset($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["tp_targetwaktu"])) ? $_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["tp_targetwaktu"] : "TARGET<br>WAKTU";
   $tab_ger_campos['tp_planfinish'] = "on";
   $tab_def_campos['tp_planfinish'] = "TP_PLANFINISH";
   $tab_converte["TP_PLANFINISH"]   = "tp_planfinish";
   $tab_labels["tp_planfinish"]   = (isset($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["tp_planfinish"])) ? $_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["tp_planfinish"] : "PLANFINISH";
   $tab_ger_campos['anomali'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['anomali'] = "anomali";
       $tab_converte["anomali"]   = "anomali";
   }
   else
   {
       $tab_def_campos['anomali'] = "";
       $tab_converte[""]   = "anomali";
   }
   $tab_labels["anomali"]   = (isset($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["anomali"])) ? $_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["anomali"] : "anomali";
   $tab_ger_campos['awaldetail'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['awaldetail'] = "awaldetail";
       $tab_converte["awaldetail"]   = "awaldetail";
   }
   else
   {
       $tab_def_campos['awaldetail'] = "";
       $tab_converte[""]   = "awaldetail";
   }
   $tab_labels["awaldetail"]   = (isset($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["awaldetail"])) ? $_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["awaldetail"] : "awaldetail";
   $tab_ger_campos['akhirdetail'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['akhirdetail'] = "akhirdetail";
       $tab_converte["akhirdetail"]   = "akhirdetail";
   }
   else
   {
       $tab_def_campos['akhirdetail'] = "";
       $tab_converte[""]   = "akhirdetail";
   }
   $tab_labels["akhirdetail"]   = (isset($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["akhirdetail"])) ? $_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["akhirdetail"] : "akhirdetail";
   $tab_ger_campos['maxiddetail'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['maxiddetail'] = "maxiddetail";
       $tab_converte["maxiddetail"]   = "maxiddetail";
   }
   else
   {
       $tab_def_campos['maxiddetail'] = "";
       $tab_converte[""]   = "maxiddetail";
   }
   $tab_labels["maxiddetail"]   = (isset($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["maxiddetail"])) ? $_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["maxiddetail"] : "maxid<br>tbl<br>detail";
   $tab_ger_campos['milestone'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['milestone'] = "milestone";
       $tab_converte["milestone"]   = "milestone";
   }
   else
   {
       $tab_def_campos['milestone'] = "";
       $tab_converte[""]   = "milestone";
   }
   $tab_labels["milestone"]   = (isset($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["milestone"])) ? $_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["milestone"] : "milestone";
   $tab_ger_campos['prosenakhir'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prosenakhir'] = "prosenakhir";
       $tab_converte["prosenakhir"]   = "prosenakhir";
   }
   else
   {
       $tab_def_campos['prosenakhir'] = "";
       $tab_converte[""]   = "prosenakhir";
   }
   $tab_labels["prosenakhir"]   = (isset($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["prosenakhir"])) ? $_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['labels']["prosenakhir"] : "prosen<br>akhir";
   $tab_ger_campos['anomali'] = "none";
   $tab_ger_campos['awaldetail'] = "none";
   $tab_ger_campos['akhirdetail'] = "none";
   $tab_ger_campos['maxiddetail'] = "none";
   $tab_ger_campos['milestone'] = "none";
   $tab_ger_campos['prosenakhir'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - AKSESSMR.TBL_PROJECT</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "update_ptosentase_project_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['update_ptosentase_project']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
