 ...
 */
    ...
    session_start();
    $SC_apl_proc = "update_ptosentase_project";
...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['update_ptosentase_project']['show_skip_charts_option']) || !$_SESSION['sc_session']['update_ptosentase_project']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
