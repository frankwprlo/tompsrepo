...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate mw_idwitel_
  function do_ajax_witel_validate_mw_idwitel_(iNumLinha)
  {
    var nomeCampo_mw_idwitel_ = "mw_idwitel_" + iNumLinha;
    var var_mw_idwitel_ = scAjaxGetFieldHidden(nomeCampo_mw_idwitel_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_witel_validate_mw_idwitel_(var_mw_idwitel_, iNumLinha, var_script_case_init, do_ajax_witel_validate_mw_idwitel__cb);
  } // do_ajax_witel_validate_mw_idwitel_

  function do_ajax_witel_validate_mw_idwitel__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "mw_idwitel_" + iLineNumber;
    }
    else
    {
      sFieldValid = "mw_idwitel_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "mw_idwitel_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "mw_idwitel_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_witel_validate_mw_idwitel__cb

  // ---------- Validate mw_kodewitel_
  function do_ajax_witel_validate_mw_kodewitel_(iNumLinha)
  {
    var nomeCampo_mw_kodewitel_ = "mw_kodewitel_" + iNumLinha;
    var var_mw_kodewitel_ = scAjaxGetFieldText(nomeCampo_mw_kodewitel_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_witel_validate_mw_kodewitel_(var_mw_kodewitel_, iNumLinha, var_script_case_init, do_ajax_witel_validate_mw_kodewitel__cb);
  } // do_ajax_witel_validate_mw_kodewitel_

  function do_ajax_witel_validate_mw_kodewitel__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "mw_kodewitel_" + iLineNumber;
    }
    else
    {
      sFieldValid = "mw_kodewitel_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "mw_kodewitel_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "mw_kodewitel_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_witel_validate_mw_kodewitel__cb

  // ---------- Validate mw_namawitel_
  function do_ajax_witel_validate_mw_namawitel_(iNumLinha)
  {
    var nomeCampo_mw_namawitel_ = "mw_namawitel_" + iNumLinha;
    var var_mw_namawitel_ = scAjaxGetFieldText(nomeCampo_mw_namawitel_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_witel_validate_mw_namawitel_(var_mw_namawitel_, iNumLinha, var_script_case_init, do_ajax_witel_validate_mw_namawitel__cb);
  } // do_ajax_witel_validate_mw_namawitel_

  function do_ajax_witel_validate_mw_namawitel__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "mw_namawitel_" + iLineNumber;
    }
    else
    {
      sFieldValid = "mw_namawitel_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "mw_namawitel_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "mw_namawitel_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_witel_validate_mw_namawitel__cb

  // ---------- Validate mw_iddivre_
  function do_ajax_witel_validate_mw_iddivre_(iNumLinha)
  {
    var nomeCampo_mw_iddivre_ = "mw_iddivre_" + iNumLinha;
    var var_mw_iddivre_ = scAjaxGetFieldSelect(nomeCampo_mw_iddivre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_witel_validate_mw_iddivre_(var_mw_iddivre_, iNumLinha, var_script_case_init, do_ajax_witel_validate_mw_iddivre__cb);
  } // do_ajax_witel_validate_mw_iddivre_

  function do_ajax_witel_validate_mw_iddivre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "mw_iddivre_" + iLineNumber;
    }
    else
    {
      sFieldValid = "mw_iddivre_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "mw_iddivre_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "mw_iddivre_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_witel_validate_mw_iddivre__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_witel_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_witel_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_witel_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_witel_add_new_line_cb);
  } // do_ajax_witel_add_new_line

  function do_ajax_witel_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_witel_add_new_line_cb

  // ---------- backup_line
  function do_ajax_witel_backup_line(iNumLinha)
  {
    var var_mw_idwitel_ = scAjaxGetFieldHidden("mw_idwitel_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_witel_backup_line(var_mw_idwitel_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_witel_backup_line_cb);
  } // do_ajax_witel_backup_line

  function do_ajax_witel_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_witel_backup_line_cb

  function do_ajax_witel_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_witel_cancel_insert

  function do_ajax_witel_cancel_update(iSeqVert)
  {
    do_ajax_witel_backup_line(iSeqVert);
...
?>
  } // do_ajax_witel_cancel_update

  function do_ajax_witel_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_witel_restore_buttons

  // ---------- table_refresh
  function do_ajax_witel_table_refresh()
  {
    var var_mw_idwitel_ = document.F2.mw_idwitel_.value;
    ...
    scAjaxProcOn();
    x_ajax_witel_table_refresh(var_mw_idwitel_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_witel_table_refresh_cb);
  } //  do_ajax_witel_table_refresh

  function do_ajax_witel_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.mw_idwitel_.value = scAjaxGetKeyValue("mw_idwitel_");
    ...
    sc_insert_open = false;
  } // do_ajax_witel_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_witel_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_witel_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_mw_idwitel_ = scAjaxGetFieldHidden("mw_idwitel_" + iNumLinha);
    var var_mw_kodewitel_ = scAjaxGetFieldText("mw_kodewitel_" + iNumLinha);
    var var_mw_namawitel_ = scAjaxGetFieldText("mw_namawitel_" + iNumLinha);
    var var_mw_iddivre_ = scAjaxGetFieldSelect("mw_iddivre_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_witel_submit_form(var_mw_idwitel_, var_mw_kodewitel_, var_mw_namawitel_, var_mw_iddivre_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_witel_submit_form_cb);
  } // do_ajax_witel_submit_form

  function do_ajax_witel_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("mw_idwitel_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("mw_kodewitel_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("mw_namawitel_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("mw_iddivre_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_witel_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_witel_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_witel_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("mw_idwitel_" + iNavForm);
      scAjaxHideErrorDisplay("mw_kodewitel_" + iNavForm);
      scAjaxHideErrorDisplay("mw_namawitel_" + iNavForm);
      scAjaxHideErrorDisplay("mw_iddivre_" + iNavForm);
    }
    var var_mw_idwitel_ = document.F2.mw_idwitel_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_witel_navigate_form(var_mw_idwitel_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_witel_navigate_form_cb);
  } // do_ajax_witel_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['witel']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_witel_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.mw_idwitel_.value = scAjaxGetKeyValue("mw_idwitel_" + var_last_index);
...
?>
  ...
  } // do_ajax_witel_navigate_form_cb
  function sc_hide_witel_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "mw_idwitel_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "mw_kodewitel_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "mw_namawitel_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "mw_iddivre_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["mw_idwitel_" + iNumLinha] = {"label": "IDWitel<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["mw_kodewitel_" + iNumLinha] = {"label": "Kode Witel<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["mw_namawitel_" + iNumLinha] = {"label": "Nama Witel<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["mw_iddivre_" + iNumLinha] = {"label": "MW IDDIVRE<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["mw_idwitel_"][iNumLinha] = "mw_idwitel_" + iNumLinha;
    ajax_field_mult["mw_kodewitel_"][iNumLinha] = "mw_kodewitel_" + iNumLinha;
    ajax_field_mult["mw_namawitel_"][iNumLinha] = "mw_namawitel_" + iNumLinha;
    ajax_field_mult["mw_iddivre_"][iNumLinha] = "mw_iddivre_" + iNumLinha;
    ajax_field_id["mw_idwitel_" + iNumLinha] = new Array("hidden_field_label_mw_idwitel_", "hidden_field_data_mw_idwitel_" + iNumLinha);
    ajax_field_id["mw_kodewitel_" + iNumLinha] = new Array("hidden_field_label_mw_kodewitel_", "hidden_field_data_mw_kodewitel_" + iNumLinha);
    ajax_field_id["mw_namawitel_" + iNumLinha] = new Array("hidden_field_label_mw_namawitel_", "hidden_field_data_mw_namawitel_" + iNumLinha);
    ajax_field_id["mw_iddivre_" + iNumLinha] = new Array("hidden_field_label_mw_iddivre_", "hidden_field_data_mw_iddivre_" + iNumLinha);
    ajax_error_count["mw_idwitel_" + iNumLinha] = "off";
    ajax_error_count["mw_kodewitel_" + iNumLinha] = "off";
    ajax_error_count["mw_namawitel_" + iNumLinha] = "off";
    ajax_error_count["mw_iddivre_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["mw_idwitel_" + iNumLinha] = "on";
    ajax_read_only["mw_kodewitel_" + iNumLinha] = "off";
    ajax_read_only["mw_namawitel_" + iNumLinha] = "off";
    ajax_read_only["mw_iddivre_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["mw_idwitel_" + iNumLinha] = "on";
    ajax_read_only["mw_kodewitel_" + iNumLinha] = "on";
    ajax_read_only["mw_namawitel_" + iNumLinha] = "on";
    ajax_read_only["mw_iddivre_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["mw_idwitel_" + iNumLinha] = null;
    ajax_error_list["mw_kodewitel_" + iNumLinha] = null;
    ajax_error_list["mw_namawitel_" + iNumLinha] = null;
    ajax_error_list["mw_iddivre_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "mw_idwitel_": new Array(),
    "mw_kodewitel_": new Array(),
    "mw_namawitel_": new Array(),
    "mw_iddivre_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["mw_idwitel_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["mw_idwitel_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["mw_idwitel_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["mw_idwitel_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["mw_idwitel_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["mw_kodewitel_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["mw_kodewitel_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["mw_kodewitel_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["mw_kodewitel_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["mw_kodewitel_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["mw_namawitel_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["mw_namawitel_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["mw_namawitel_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["mw_namawitel_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["mw_namawitel_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["mw_iddivre_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["mw_iddivre_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["mw_iddivre_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["mw_iddivre_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["mw_iddivre_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['mw_idwitel_'])) ? $this->nmgp_cmp_readonly['mw_idwitel_'] : 'on';
?>
    scAjaxFieldRead("mw_idwitel_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['mw_kodewitel_'])) ? $this->nmgp_cmp_readonly['mw_kodewitel_'] : 'off';
?>
    scAjaxFieldRead("mw_kodewitel_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['mw_namawitel_'])) ? $this->nmgp_cmp_readonly['mw_namawitel_'] : 'off';
?>
    scAjaxFieldRead("mw_namawitel_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['mw_iddivre_'])) ? $this->nmgp_cmp_readonly['mw_iddivre_'] : 'off';
?>
    scAjaxFieldRead("mw_iddivre_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("mw_idwitel_" + iSeq, "on");
    scAjaxFieldRead("mw_kodewitel_" + iSeq, "on");
    scAjaxFieldRead("mw_namawitel_" + iSeq, "on");
    scAjaxFieldRead("mw_iddivre_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["mw_idwitel_" + iRow] || "on" == ajax_error_count["mw_kodewitel_" + iRow] || "on" == ajax_error_count["mw_namawitel_" + iRow] || "on" == ajax_error_count["mw_iddivre_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_mw_idwitel_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_mw_kodewitel_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_mw_namawitel_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_mw_iddivre_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["mw_idwitel_" + iRow] && "off" == ajax_error_count["mw_kodewitel_" + iRow] && "off" == ajax_error_count["mw_namawitel_" + iRow] && "off" == ajax_error_count["mw_iddivre_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["mw_idwitel_" + iRow] = "off";
        ajax_error_count["mw_kodewitel_" + iRow] = "off";
        ajax_error_count["mw_namawitel_" + iRow] = "off";
        ajax_error_count["mw_iddivre_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_mw_idwitel_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_mw_kodewitel_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_mw_namawitel_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_mw_iddivre_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("mw_idwitel_" == sIndex)
    {
      scAjaxSetFieldLabel(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
    }
    if ("mw_kodewitel_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
    }
    if ("mw_namawitel_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
    }
    if ("mw_iddivre_" == sIndex)
    {
