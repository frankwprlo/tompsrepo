<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="po_id_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['po_id_']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit_inline']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="odp_edit_inline"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['where_detal']))
  {
?>  
  if (parent && parent.nmsc_iframe_liga_odp_edit.scInlineFormReceive)
  {
    parent.nmsc_iframe_liga_odp_edit.scInlineFormReceive(oResp, <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit_inline']['inline_form_seq'] ?>);
    return true;
  }
<?php
  }
...
?>  
  ...
  {
    parent.scInlineFormReceive(oResp, <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit_inline']['inline_form_seq'] ?>);
    return true;
  }
<?php
  }
