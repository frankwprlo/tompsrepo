<?php
class odp_edit_form extends odp_edit_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['sc_redir_atualiz'] == 'ok')
{
?>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("odp_edit_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('odp_edit_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['recarga'];
}
...
<?php
$_SESSION['scriptcase']['error_span_title']['odp_edit'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['odp_edit'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['dashboard_info']['maximized']))
  {
?>
<tr><td>
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR align="center" valign="middle">
        ...
        <TD class="scFormHeaderFont">
          <?php echo "LOP : " . $_SESSION['var_LOP'] . " , Nama Project : " . $_SESSION['var_namaproject'] . " , Lokasi : " . $_SESSION['var_lokasi'] . "" ?>
        </TD>
       </TR>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['run_iframe'] != "R")
{
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bnovo", "do_ajax_odp_edit_add_new_line(); return false;", "do_ajax_odp_edit_add_new_line(); return false;", "sc_b_new_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
 ...
 ?>
   ...
   <?php if ($this->Embutida_form && $this->nmgp_botoes['insert'] != "on") {?>
    <TD class="scFormLabelOddMult"  width="10"> &nbsp; </TD>
   <?php }?>
   <?php if ((!isset($this->nmgp_cmp_hidden['po_id_']) || $this->nmgp_cmp_hidden['po_id_'] == 'on') && ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir"))) { 
      if (!isset($this->nm_new_label['po_id_'])) {
          $this->nm_new_label['po_id_'] = "ID Table"; } ?>

    <TD class="scFormLabelOddMult css_po_id__label" id="hidden_field_label_po_id_" style="<?php echo $sStyleHidden_po_id_; ?>" > <?php echo $this->nm_new_label['po_id_'] ?> </TD>
   <?php }?>
...
<?php
          $date_format_show = strtolower(str_replace(';', ' ', $this->field_config['po_tglbast_']['date_format']));
...
?>
    ...
    <TD class="scFormLabelOddMult css_po_tglbast__label" id="hidden_field_label_po_tglbast_" style="<?php echo $sStyleHidden_po_tglbast_; ?>" > <?php echo $this->nm_new_label['po_tglbast_'] ?><br><?php echo $date_format_show ?> </TD>
   <?php } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['po_witel_']) && $this->nmgp_cmp_hidden['po_witel_'] == 'off') { $sStyleHidden_po_witel_ = 'display: none'; }
      if (1 || !isset($this->nmgp_cmp_hidden['po_witel_']) || $this->nmgp_cmp_hidden['po_witel_'] == 'on') {
      if (!isset($this->nm_new_label['po_witel_'])) {
          $this->nm_new_label['po_witel_'] = "Witel"; } ?>

    <TD class="scFormLabelOddMult css_po_witel__label" id="hidden_field_label_po_witel_" style="<?php echo $sStyleHidden_po_witel_; ?>" > <?php echo $this->nm_new_label['po_witel_'] ?> </TD>
   <?php } ?>

   <?php if (isset($this->nmgp_cmp_hidden['po_sto_']) && $this->nmgp_cmp_hidden['po_sto_'] == 'off') { $sStyleHidden_po_sto_ = 'display: none'; }
      if (1 || !isset($this->nmgp_cmp_hidden['po_sto_']) || $this->nmgp_cmp_hidden['po_sto_'] == 'on') {
      if (!isset($this->nm_new_label['po_sto_'])) {
          $this->nm_new_label['po_sto_'] = "STO"; } ?>

    <TD class="scFormLabelOddMult css_po_sto__label" id="hidden_field_label_po_sto_" style="<?php echo $sStyleHidden_po_sto_; ?>" > <?php echo $this->nm_new_label['po_sto_'] ?> </TD>
   <?php } ?>

   <?php if (isset($this->nmgp_cmp_hidden['po_mitra_']) && $this->nmgp_cmp_hidden['po_mitra_'] == 'off') { $sStyleHidden_po_mitra_ = 'display: none'; }
      if (1 || !isset($this->nmgp_cmp_hidden['po_mitra_']) || $this->nmgp_cmp_hidden['po_mitra_'] == 'on') {
      if (!isset($this->nm_new_label['po_mitra_'])) {
          $this->nm_new_label['po_mitra_'] = "Mitra"; } ?>

    <TD class="scFormLabelOddMult css_po_mitra__label" id="hidden_field_label_po_mitra_" style="<?php echo $sStyleHidden_po_mitra_; ?>" > <?php echo $this->nm_new_label['po_mitra_'] ?> </TD>
   <?php } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_odp_edit);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_odp_edit = $this->form_vert_odp_edit;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_odp_edit))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_odp_edit as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->po_tglentry_ = $this->form_vert_odp_edit[$sc_seq_vert]['po_tglentry_'];
       $this->po_entryby_ = $this->form_vert_odp_edit[$sc_seq_vert]['po_entryby_'];
       $this->po_tglupdate_ = $this->form_vert_odp_edit[$sc_seq_vert]['po_tglupdate_'];
       $this->po_updateby_ = $this->form_vert_odp_edit[$sc_seq_vert]['po_updateby_'];
       if (isset($this->Embutida_ronly) && $this->Embutida_ronly && !$Line_Add)
       {
           ...
           $this->nmgp_cmp_readonly['po_witel_'] = true;
           $this->nmgp_cmp_readonly['po_sto_'] = true;
           $this->nmgp_cmp_readonly['po_mitra_'] = true;
       }
       elseif ($Line_Add)
       {
           ...
           if (!isset($this->nmgp_cmp_readonly['po_witel_']) || $this->nmgp_cmp_readonly['po_witel_'] != "on") {$this->nmgp_cmp_readonly['po_witel_'] = false;}
           if (!isset($this->nmgp_cmp_readonly['po_sto_']) || $this->nmgp_cmp_readonly['po_sto_'] != "on") {$this->nmgp_cmp_readonly['po_sto_'] = false;}
           if (!isset($this->nmgp_cmp_readonly['po_mitra_']) || $this->nmgp_cmp_readonly['po_mitra_'] != "on") {$this->nmgp_cmp_readonly['po_mitra_'] = false;}
       }
              foreach ($this->form_vert_form_preenchimento[$sc_seq_vert] as $sCmpNome => $mCmpVal)
              {
                  eval("\$this->" . $sCmpNome . " = \$mCmpVal;");
              }
        $this->po_id_ = $this->form_vert_odp_edit[$sc_seq_vert]['po_id_']; 
       $po_id_ = $this->po_id_; 
       $sStyleHidden_po_id_ = '';
       ...
       $this->po_idproject_ = $this->form_vert_odp_edit[$sc_seq_vert]['po_idproject_']; 
       ...
       $this->po_tpmoid_ = $this->form_vert_odp_edit[$sc_seq_vert]['po_tpmoid_']; 
       ...
       $this->po_tipenode_ = $this->form_vert_odp_edit[$sc_seq_vert]['po_tipenode_']; 
       ...
       $this->po_namanode_ = $this->form_vert_odp_edit[$sc_seq_vert]['po_namanode_']; 
       ...
       $this->po_merk_ = $this->form_vert_odp_edit[$sc_seq_vert]['po_merk_']; 
       ...
       $this->po_kapport_ = $this->form_vert_odp_edit[$sc_seq_vert]['po_kapport_']; 
       ...
       $this->po_alamatlokasi_ = $this->form_vert_odp_edit[$sc_seq_vert]['po_alamatlokasi_']; 
       ...
       $this->po_latitude_ = $this->form_vert_odp_edit[$sc_seq_vert]['po_latitude_']; 
       ...
       $this->po_longitude_ = $this->form_vert_odp_edit[$sc_seq_vert]['po_longitude_']; 
       ...
       $this->po_nosp_ = $this->form_vert_odp_edit[$sc_seq_vert]['po_nosp_']; 
       ...
       $this->po_tglbast_ = $this->form_vert_odp_edit[$sc_seq_vert]['po_tglbast_']; 
       ...
       $this->po_uraian_ = $this->form_vert_odp_edit[$sc_seq_vert]['po_uraian_']; 
       $po_uraian_ = $this->po_uraian_; 
       $po_uraian__tmp = str_replace(array('\r\n', '\n\r', '\n', '\r'), array("\r\n", "\n\r", "\n", "\r"), $po_uraian_);
       $po_uraian__val = nl2br($po_uraian__tmp);
       ...
       $this->po_witel_ = $this->form_vert_odp_edit[$sc_seq_vert]['po_witel_']; 
       $po_witel_ = $this->po_witel_; 
       $sStyleHidden_po_witel_ = '';
       if (isset($sCheckRead_po_witel_))
       {
           unset($sCheckRead_po_witel_);
       }
       if (isset($this->nmgp_cmp_readonly['po_witel_']))
       {
           $sCheckRead_po_witel_ = $this->nmgp_cmp_readonly['po_witel_'];
       }
       if (isset($this->nmgp_cmp_hidden['po_witel_']) && $this->nmgp_cmp_hidden['po_witel_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['po_witel_']);
           $sStyleHidden_po_witel_ = 'display: none;';
       }
       $bTestReadOnly_po_witel_ = true;
       $sStyleReadLab_po_witel_ = 'display: none;';
       $sStyleReadInp_po_witel_ = '';
       if (isset($this->nmgp_cmp_readonly['po_witel_']) && $this->nmgp_cmp_readonly['po_witel_'] == 'on')
       {
           $bTestReadOnly_po_witel_ = false;
           unset($this->nmgp_cmp_readonly['po_witel_']);
           $sStyleReadLab_po_witel_ = '';
           $sStyleReadInp_po_witel_ = 'display: none;';
       }
       $this->po_sto_ = $this->form_vert_odp_edit[$sc_seq_vert]['po_sto_']; 
       $po_sto_ = $this->po_sto_; 
       $sStyleHidden_po_sto_ = '';
       if (isset($sCheckRead_po_sto_))
       {
           unset($sCheckRead_po_sto_);
       }
       if (isset($this->nmgp_cmp_readonly['po_sto_']))
       {
           $sCheckRead_po_sto_ = $this->nmgp_cmp_readonly['po_sto_'];
       }
       if (isset($this->nmgp_cmp_hidden['po_sto_']) && $this->nmgp_cmp_hidden['po_sto_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['po_sto_']);
           $sStyleHidden_po_sto_ = 'display: none;';
       }
       $bTestReadOnly_po_sto_ = true;
       $sStyleReadLab_po_sto_ = 'display: none;';
       $sStyleReadInp_po_sto_ = '';
       if (isset($this->nmgp_cmp_readonly['po_sto_']) && $this->nmgp_cmp_readonly['po_sto_'] == 'on')
       {
           $bTestReadOnly_po_sto_ = false;
           unset($this->nmgp_cmp_readonly['po_sto_']);
           $sStyleReadLab_po_sto_ = '';
           $sStyleReadInp_po_sto_ = 'display: none;';
       }
       $this->po_mitra_ = $this->form_vert_odp_edit[$sc_seq_vert]['po_mitra_']; 
       $po_mitra_ = $this->po_mitra_; 
       $sStyleHidden_po_mitra_ = '';
       if (isset($sCheckRead_po_mitra_))
       {
           unset($sCheckRead_po_mitra_);
       }
       if (isset($this->nmgp_cmp_readonly['po_mitra_']))
       {
           $sCheckRead_po_mitra_ = $this->nmgp_cmp_readonly['po_mitra_'];
       }
       if (isset($this->nmgp_cmp_hidden['po_mitra_']) && $this->nmgp_cmp_hidden['po_mitra_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['po_mitra_']);
           $sStyleHidden_po_mitra_ = 'display: none;';
       }
       $bTestReadOnly_po_mitra_ = true;
       $sStyleReadLab_po_mitra_ = 'display: none;';
       $sStyleReadInp_po_mitra_ = '';
       if (isset($this->nmgp_cmp_readonly['po_mitra_']) && $this->nmgp_cmp_readonly['po_mitra_'] == 'on')
       {
           $bTestReadOnly_po_mitra_ = false;
           unset($this->nmgp_cmp_readonly['po_mitra_']);
           $sStyleReadLab_po_mitra_ = '';
           $sStyleReadInp_po_mitra_ = 'display: none;';
       }
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_odp_edit_add_new_line(" . $sc_seq_vert . ")", "do_ajax_odp_edit_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_odp_edit_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_odp_edit_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_odp_edit_cancel_update(" . $sc_seq_vert . ")", "do_ajax_odp_edit_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOddMult css_po_id__line" id="hidden_field_data_po_id_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_po_id_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_po_id__line" style="vertical-align: top;padding: 0px"><span id="id_read_on_po_id_<?php echo $sc_seq_vert ?>" class="css_po_id__line" style="<?php echo $sStyleReadLab_po_id_; ?>"><?php echo $this->form_encode_input($this->po_id_); ?></span><span id="id_read_off_po_id_<?php echo $sc_seq_vert ?>" style="<?php echo $sStyleReadInp_po_id_; ?>"><input type="hidden" id="id_sc_field_po_id_<?php echo $sc_seq_vert ?>" name="po_id_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($po_id_) . "\">"?>
<span id="id_ajax_label_po_id_<?php echo $sc_seq_vert; ?>"><?php echo nl2br($po_id_); ?></span>
</span></span></td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_po_id_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_po_id_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
<?php }?>
...
<?php if ($bTestReadOnly_po_idproject_ && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["po_idproject_"]) &&  $this->nmgp_cmp_readonly["po_idproject_"] == "on")) { 

 ?>
<input type="hidden" name="po_idproject_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($po_idproject_) . "\"><span id=\"id_ajax_label_po_idproject_" . $sc_seq_vert . "\">" . $po_idproject_ . "</span>"; ?>
<?php } else { ?>
...
<input type="hidden" name="po_tpmoid_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($po_tpmoid_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
...
<?php if ($bTestReadOnly_po_tpmoid_ && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["po_tpmoid_"]) &&  $this->nmgp_cmp_readonly["po_tpmoid_"] == "on")) { 

 ?>
<input type="hidden" name="po_tpmoid_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($po_tpmoid_) . "\"><span id=\"id_ajax_label_po_tpmoid_" . $sc_seq_vert . "\">" . $po_tpmoid_ . "</span>"; ?>
<?php } else { ?>
<span id="id_read_on_po_tpmoid_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-po_tpmoid_<?php echo $sc_seq_vert ?> css_po_tpmoid__line" style="<?php echo $sStyleReadLab_po_tpmoid_; ?>"><?php echo $this->form_encode_input($this->po_tpmoid_); ?></span><span id="id_read_off_po_tpmoid_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_po_tpmoid_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_po_tpmoid__obj" style="" id="id_sc_field_po_tpmoid_<?php echo $sc_seq_vert ?>" type=text name="po_tpmoid_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($po_tpmoid_) ?>"
...
<?php if ($bTestReadOnly_po_tipenode_ && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["po_tipenode_"]) &&  $this->nmgp_cmp_readonly["po_tipenode_"] == "on")) { 

 ?>
<input type="hidden" name="po_tipenode_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($po_tipenode_) . "\"><span id=\"id_ajax_label_po_tipenode_" . $sc_seq_vert . "\">" . $po_tipenode_ . "</span>"; ?>
<?php } else { ?>
...
<?php if ($bTestReadOnly_po_namanode_ && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["po_namanode_"]) &&  $this->nmgp_cmp_readonly["po_namanode_"] == "on")) { 

 ?>
<input type="hidden" name="po_namanode_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($po_namanode_) . "\"><span id=\"id_ajax_label_po_namanode_" . $sc_seq_vert . "\">" . $po_namanode_ . "</span>"; ?>
<?php } else { ?>
...
<?php if ($bTestReadOnly_po_merk_ && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["po_merk_"]) &&  $this->nmgp_cmp_readonly["po_merk_"] == "on")) { 

 ?>
<input type="hidden" name="po_merk_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($po_merk_) . "\"><span id=\"id_ajax_label_po_merk_" . $sc_seq_vert . "\">" . $po_merk_ . "</span>"; ?>
<?php } else { ?>
...
<?php if ($bTestReadOnly_po_kapport_ && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["po_kapport_"]) &&  $this->nmgp_cmp_readonly["po_kapport_"] == "on")) { 

 ?>
<input type="hidden" name="po_kapport_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($po_kapport_) . "\"><span id=\"id_ajax_label_po_kapport_" . $sc_seq_vert . "\">" . $po_kapport_ . "</span>"; ?>
<?php } else { ?>
...
<span id="id_read_on_po_alamatlokasi_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-po_alamatlokasi_<?php echo $sc_seq_vert ?> css_po_alamatlokasi__line" style="<?php echo $sStyleReadLab_po_alamatlokasi_; ?>"><?php echo $this->form_encode_input($this->po_alamatlokasi_); ?></span><span id="id_read_off_po_alamatlokasi_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_po_alamatlokasi_; ?>">
 ...
 size=30 maxlength=100 alt="{datatype: 'text', maxLength: 100, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: 'upper', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<span id="id_read_on_po_nosp_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-po_nosp_<?php echo $sc_seq_vert ?> css_po_nosp__line" style="<?php echo $sStyleReadLab_po_nosp_; ?>"><?php echo $this->form_encode_input($this->po_nosp_); ?></span><span id="id_read_off_po_nosp_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_po_nosp_; ?>">
 ...
 size=30 maxlength=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php if ($bTestReadOnly_po_uraian_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["po_uraian_"]) &&  $this->nmgp_cmp_readonly["po_uraian_"] == "on") { 
 ...
 ?>
<input type="hidden" name="po_uraian_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($po_uraian_) . "\">" . $po_uraian__val . ""; ?>
<?php } else { ?>
<span id="id_read_on_po_uraian_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-po_uraian_<?php echo $sc_seq_vert ?> css_po_uraian__line" style="<?php echo $sStyleReadLab_po_uraian_; ?>"><?php echo $this->form_encode_input($po_uraian__val); ?></span><span id="id_read_off_po_uraian_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_po_uraian_; ?>">
 <textarea  class="sc-js-input scFormObjectOddMult css_po_uraian__obj" style="white-space: pre-wrap;" name="po_uraian_<?php echo $sc_seq_vert ?>" id="id_sc_field_po_uraian_<?php echo $sc_seq_vert ?>" rows="2" cols="20"
...
<?php echo $po_uraian_; ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['po_witel_']) && $this->nmgp_cmp_hidden['po_witel_'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="po_witel_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($po_witel_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult css_po_witel__line" id="hidden_field_data_po_witel_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_po_witel_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_po_witel__line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly_po_witel_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["po_witel_"]) &&  $this->nmgp_cmp_readonly["po_witel_"] == "on") { 

 ?>
<input type="hidden" name="po_witel_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($po_witel_) . "\">" . $po_witel_ . ""; ?>
<?php } else { ?>
<span id="id_read_on_po_witel_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-po_witel_<?php echo $sc_seq_vert ?> css_po_witel__line" style="<?php echo $sStyleReadLab_po_witel_; ?>"><?php echo $this->form_encode_input($this->po_witel_); ?></span><span id="id_read_off_po_witel_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_po_witel_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_po_witel__obj" style="" id="id_sc_field_po_witel_<?php echo $sc_seq_vert ?>" type=text name="po_witel_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($po_witel_) ?>"
 size=30 maxlength=60 alt="{datatype: 'text', maxLength: 60, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_po_witel_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_po_witel_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>

   <?php if (isset($this->nmgp_cmp_hidden['po_sto_']) && $this->nmgp_cmp_hidden['po_sto_'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="po_sto_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($po_sto_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult css_po_sto__line" id="hidden_field_data_po_sto_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_po_sto_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_po_sto__line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly_po_sto_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["po_sto_"]) &&  $this->nmgp_cmp_readonly["po_sto_"] == "on") { 

 ?>
<input type="hidden" name="po_sto_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($po_sto_) . "\">" . $po_sto_ . ""; ?>
<?php } else { ?>
<span id="id_read_on_po_sto_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-po_sto_<?php echo $sc_seq_vert ?> css_po_sto__line" style="<?php echo $sStyleReadLab_po_sto_; ?>"><?php echo $this->form_encode_input($this->po_sto_); ?></span><span id="id_read_off_po_sto_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_po_sto_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_po_sto__obj" style="" id="id_sc_field_po_sto_<?php echo $sc_seq_vert ?>" type=text name="po_sto_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($po_sto_) ?>"
 size=20 maxlength=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_po_sto_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_po_sto_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>

   <?php if (isset($this->nmgp_cmp_hidden['po_mitra_']) && $this->nmgp_cmp_hidden['po_mitra_'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="po_mitra_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($po_mitra_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult css_po_mitra__line" id="hidden_field_data_po_mitra_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_po_mitra_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_po_mitra__line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly_po_mitra_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["po_mitra_"]) &&  $this->nmgp_cmp_readonly["po_mitra_"] == "on") { 

 ?>
<input type="hidden" name="po_mitra_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($po_mitra_) . "\">" . $po_mitra_ . ""; ?>
<?php } else { ?>
<span id="id_read_on_po_mitra_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-po_mitra_<?php echo $sc_seq_vert ?> css_po_mitra__line" style="<?php echo $sStyleReadLab_po_mitra_; ?>"><?php echo $this->form_encode_input($this->po_mitra_); ?></span><span id="id_read_off_po_mitra_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_po_mitra_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_po_mitra__obj" style="" id="id_sc_field_po_mitra_<?php echo $sc_seq_vert ?>" type=text name="po_mitra_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($po_mitra_) ?>"
 size=20 maxlength=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_po_mitra_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_po_mitra_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php   
       ...
       if (isset($sCheckRead_po_witel_))
       {
           $this->nmgp_cmp_readonly['po_witel_'] = $sCheckRead_po_witel_;
       }
       if ('display: none;' == $sStyleHidden_po_witel_)
       {
           $this->nmgp_cmp_hidden['po_witel_'] = 'off';
       }
       if (isset($sCheckRead_po_sto_))
       {
           $this->nmgp_cmp_readonly['po_sto_'] = $sCheckRead_po_sto_;
       }
       if ('display: none;' == $sStyleHidden_po_sto_)
       {
           $this->nmgp_cmp_hidden['po_sto_'] = 'off';
       }
       if (isset($sCheckRead_po_mitra_))
       {
           $this->nmgp_cmp_readonly['po_mitra_'] = $sCheckRead_po_mitra_;
       }
       if ('display: none;' == $sStyleHidden_po_mitra_)
       {
           $this->nmgp_cmp_hidden['po_mitra_'] = 'off';
       }
   ...
   { 
       ...
       $this->form_vert_odp_edit = $guarda_form_vert_odp_edit;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['odp_edit']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("odp_edit");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("odp_edit");
 parent.scAjaxDetailHeight("odp_edit", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
