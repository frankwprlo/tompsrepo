...
class report_others_inwitel_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['report_others_inwitel']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['report_others_inwitel']['campos_busca']))
      { 
