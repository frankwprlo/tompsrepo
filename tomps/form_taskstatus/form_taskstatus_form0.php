<?php
class form_taskstatus_form extends form_taskstatus_apl
{
function Form_Init()
{
...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - AKSESSMR.TB_TASKTSTATUS"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - AKSESSMR.TB_TASKTSTATUS"); } ?></TITLE>
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['sc_redir_atualiz'] == 'ok')
{
?>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_taskstatus/form_taskstatus_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_taskstatus_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_taskstatus_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['recarga'];
}
...
<?php
 include_once("form_taskstatus_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_taskstatus'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_taskstatus'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['run_iframe'] != "R")
{
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bnovo", "do_ajax_form_taskstatus_add_new_line(); return false;", "do_ajax_form_taskstatus_add_new_line(); return false;", "sc_b_new_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['statusid_']) && $this->nmgp_cmp_hidden['statusid_'] == 'off') { $sStyleHidden_statusid_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['statusid_'])) {
          $this->nm_new_label['statusid_'] = "StatusID"; } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['statusname_']) && $this->nmgp_cmp_hidden['statusname_'] == 'off') { $sStyleHidden_statusname_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['statusname_'])) {
          $this->nm_new_label['statusname_'] = "Nama Status Task"; } ?>
...
?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['uodatedate_']) && $this->nmgp_cmp_hidden['uodatedate_'] == 'off') { $sStyleHidden_uodatedate_ = 'display: none'; }
      if (1 || !isset($this->nmgp_cmp_hidden['uodatedate_']) || $this->nmgp_cmp_hidden['uodatedate_'] == 'on') {
      if (!isset($this->nm_new_label['uodatedate_'])) {
          $this->nm_new_label['uodatedate_'] = "Tgl Update"; } ?>
<?php
          $date_format_show = strtolower(str_replace(';', ' ', $this->field_config['uodatedate_']['date_format']));
          $date_format_show = str_replace("dd", $this->Ini->Nm_lang['lang_othr_date_days'], $date_format_show);
          $date_format_show = str_replace("mm", $this->Ini->Nm_lang['lang_othr_date_mnth'], $date_format_show);
          $date_format_show = str_replace("yyyy", $this->Ini->Nm_lang['lang_othr_date_year'], $date_format_show);
          $date_format_show = str_replace("aaaa", $this->Ini->Nm_lang['lang_othr_date_year'], $date_format_show);
...
?>
    ...
    <TD class="scFormLabelOddMult css_uodatedate__label" id="hidden_field_label_uodatedate_" style="<?php echo $sStyleHidden_uodatedate_; ?>" > <?php echo $this->nm_new_label['uodatedate_'] ?><br><?php echo $date_format_show ?> </TD>
   <?php } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_taskstatus);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_taskstatus = $this->form_vert_form_taskstatus;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_taskstatus))
   {
       $sc_seq_vert = 0;
   }
           ...
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['uodatedate_']))
           {
               $this->nmgp_cmp_readonly['uodatedate_'] = 'on';
           }
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['updateby_']))
           {
               $this->nmgp_cmp_readonly['updateby_'] = 'on';
           }
   foreach ($this->form_vert_form_taskstatus as $sc_seq_vert => $sc_lixo)
   {
       ...
       if (isset($this->Embutida_ronly) && $this->Embutida_ronly && !$Line_Add)
       {
           ...
           $this->nmgp_cmp_readonly['uodatedate_'] = true;
       ...
       elseif ($Line_Add)
       {
           ...
           if (!isset($this->nmgp_cmp_readonly['uodatedate_']) || $this->nmgp_cmp_readonly['uodatedate_'] != "on") {$this->nmgp_cmp_readonly['uodatedate_'] = false;}
        ...
        $this->statusid_ = $this->form_vert_form_taskstatus[$sc_seq_vert]['statusid_']; 
       ...
       $this->statusname_ = $this->form_vert_form_taskstatus[$sc_seq_vert]['statusname_']; 
       ...
       $this->description_ = $this->form_vert_form_taskstatus[$sc_seq_vert]['description_']; 
       ...
       $this->entrydate_ = $this->form_vert_form_taskstatus[$sc_seq_vert]['entrydate_']; 
       ...
       $this->entryby_ = $this->form_vert_form_taskstatus[$sc_seq_vert]['entryby_']; 
       ...
       $this->uodatedate_ = $this->form_vert_form_taskstatus[$sc_seq_vert]['uodatedate_']; 
       $uodatedate_ = $this->uodatedate_; 
       $sStyleHidden_uodatedate_ = '';
       if (isset($sCheckRead_uodatedate_))
       {
           unset($sCheckRead_uodatedate_);
       }
       if (isset($this->nmgp_cmp_readonly['uodatedate_']))
       {
           $sCheckRead_uodatedate_ = $this->nmgp_cmp_readonly['uodatedate_'];
       }
       if (isset($this->nmgp_cmp_hidden['uodatedate_']) && $this->nmgp_cmp_hidden['uodatedate_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['uodatedate_']);
           $sStyleHidden_uodatedate_ = 'display: none;';
       }
       $bTestReadOnly_uodatedate_ = true;
       $sStyleReadLab_uodatedate_ = 'display: none;';
       $sStyleReadInp_uodatedate_ = '';
       if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["uodatedate_"]) &&  $this->nmgp_cmp_readonly["uodatedate_"] == "on"))
       {
           $bTestReadOnly_uodatedate_ = false;
           unset($this->nmgp_cmp_readonly['uodatedate_']);
           $sStyleReadLab_uodatedate_ = '';
           $sStyleReadInp_uodatedate_ = 'display: none;';
       }
       $this->updateby_ = $this->form_vert_form_taskstatus[$sc_seq_vert]['updateby_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_taskstatus_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_taskstatus_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_taskstatus_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_taskstatus_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_taskstatus_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_taskstatus_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php } else { ?>
<span id="id_read_on_description_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-description_<?php echo $sc_seq_vert ?> css_description__line" style="<?php echo $sStyleReadLab_description_; ?>"><?php echo $this->form_encode_input($this->description_); ?></span><span id="id_read_off_description_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_description_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_description__obj" style="" id="id_sc_field_description_<?php echo $sc_seq_vert ?>" type=text name="description_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($description_) ?>"
...
<span id="id_read_on_entryby_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-entryby_<?php echo $sc_seq_vert ?> css_entryby__line" style="<?php echo $sStyleReadLab_entryby_; ?>"><?php echo $this->form_encode_input($this->entryby_); ?></span><span id="id_read_off_entryby_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_entryby_; ?>">
 ...
 size=6 maxlength=6 alt="{datatype: 'text', maxLength: 6, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['uodatedate_']) && $this->nmgp_cmp_hidden['uodatedate_'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="uodatedate_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($uodatedate_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult css_uodatedate__line" id="hidden_field_data_uodatedate_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_uodatedate_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_uodatedate__line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly_uodatedate_ && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["uodatedate_"]) &&  $this->nmgp_cmp_readonly["uodatedate_"] == "on")) { 

 ?>
<input type="hidden" name="uodatedate_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($uodatedate_) . "\"><span id=\"id_ajax_label_uodatedate_" . $sc_seq_vert . "\">" . $uodatedate_ . "</span>"; ?>
<?php } else { ?>
<span id="id_read_on_uodatedate_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-uodatedate_<?php echo $sc_seq_vert ?> css_uodatedate__line" style="<?php echo $sStyleReadLab_uodatedate_; ?>"><?php echo $this->form_encode_input($uodatedate_); ?></span><span id="id_read_off_uodatedate_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_uodatedate_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_uodatedate__obj" style="" id="id_sc_field_uodatedate_<?php echo $sc_seq_vert ?>" type=text name="uodatedate_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($uodatedate_) ?>"
 size=10 alt="{datatype: 'date', dateSep: '<?php echo $this->field_config['uodatedate_']['date_sep']; ?>', dateFormat: '<?php echo $this->field_config['uodatedate_']['date_format']; ?>', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ><?php
$tmp_form_data = $this->field_config['uodatedate_']['date_format'];
$tmp_form_data = str_replace('aaaa', 'yyyy', $tmp_form_data);
$tmp_form_data = str_replace('dd'  , $this->Ini->Nm_lang['lang_othr_date_days'], $tmp_form_data);
$tmp_form_data = str_replace('mm'  , $this->Ini->Nm_lang['lang_othr_date_mnth'], $tmp_form_data);
$tmp_form_data = str_replace('yyyy', $this->Ini->Nm_lang['lang_othr_date_year'], $tmp_form_data);
...
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_uodatedate_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_uodatedate_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php   
       ...
       if (isset($sCheckRead_uodatedate_))
       {
           $this->nmgp_cmp_readonly['uodatedate_'] = $sCheckRead_uodatedate_;
       }
       if ('display: none;' == $sStyleHidden_uodatedate_)
       {
           $this->nmgp_cmp_hidden['uodatedate_'] = 'off';
       }
       if (isset($sCheckRead_updateby_))
       {
   ...
   { 
       ...
       $this->form_vert_form_taskstatus = $guarda_form_vert_form_taskstatus;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_taskstatus']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_taskstatus");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_taskstatus");
 parent.scAjaxDetailHeight("form_taskstatus", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
