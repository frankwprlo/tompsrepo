<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new dashboard_alarmtasktahapan_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class dashboard_alarmtasktahapan_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["ppo_projectid"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['labels']["ppo_projectid"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['labels']["ppo_projectid"] : "PPO PROJECTID";
   $tab_ger_campos['ppo_status'] = "on";
   $tab_def_campos['ppo_status'] = "PPO_STATUS";
   $tab_converte["PPO_STATUS"]   = "ppo_status";
   $tab_labels["ppo_status"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['labels']["ppo_status"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['labels']["ppo_status"] : "PPO STATUS";
   ...
   $tab_labels["ppo_tahapanproject"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['labels']["ppo_tahapanproject"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['labels']["ppo_tahapanproject"] : "PPO TAHAPANPROJECT";
   $tab_ger_campos['ppo_tasknumber'] = "on";
   $tab_def_campos['ppo_tasknumber'] = "PPO_TASKNUMBER";
   $tab_converte["PPO_TASKNUMBER"]   = "ppo_tasknumber";
   $tab_labels["ppo_tasknumber"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['labels']["ppo_tasknumber"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['labels']["ppo_tasknumber"] : "PPO TASKNUMBER";
   $tab_ger_campos['targetplanfinish'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['targetplanfinish'] = "targetplanfinish";
       $tab_converte["targetplanfinish"]   = "targetplanfinish";
   }
   else
   {
       $tab_def_campos['targetplanfinish'] = "PPO_TARGETSELESAI";
       $tab_converte["PPO_TARGETSELESAI"]   = "targetplanfinish";
   }
   $tab_labels["targetplanfinish"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['labels']["targetplanfinish"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['labels']["targetplanfinish"] : "TARGETPLANFINISH";
   $tab_ger_campos['now'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['now'] = "now";
       $tab_converte["now"]   = "now";
   }
   else
   {
       $tab_def_campos['now'] = "NOW()";
   ...
   $tab_labels["now"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['labels']["now"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['labels']["now"] : "NOW";
   $tab_ger_campos['ppo_targethari'] = "on";
   $tab_def_campos['ppo_targethari'] = "PPO_TARGETHARI";
   $tab_converte["PPO_TARGETHARI"]   = "ppo_targethari";
   $tab_labels["ppo_targethari"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['labels']["ppo_targethari"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['labels']["ppo_targethari"] : "PPO TARGETHARI";
   $tab_ger_campos['selisih'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['selisih'] = "selisih";
       $tab_converte["selisih"]   = "selisih";
   }
   else
   {
       $tab_def_campos['selisih'] = "DATEDIFF(PPO_TARGETSELESAI,NOW())";
       $tab_converte["DATEDIFF(PPO_TARGETSELESAI,NOW())"]   = "selisih";
   }
   $tab_labels["selisih"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['labels']["selisih"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['labels']["selisih"] : "SELISIH";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE>Alarm Task Tahapan Project Lokasi Witel <?php echo $_SESSION['kodewitel'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "dashboard_alarmtasktahapan_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['dashboard_alarmtasktahapan']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
