...
class dashboard_alarmtasktahapan_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "dashboard_alarmtasktahapan.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarmtasktahapan']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarmtasktahapan']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarmtasktahapan']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarmtasktahapan']['rtf_name']);
      }
   ...
   function NM_export_ppo_projectid()
   {
         ...
         $this->ppo_projectid = str_replace('<', '&lt;', $this->ppo_projectid);
         $this->ppo_projectid = str_replace('>', '&gt;', $this->ppo_projectid);
         $this->Texto_tag .= "<td>" . $this->ppo_projectid . "</td>\r\n";
   }
   //----- ppo_status
   function NM_export_ppo_status()
   {
         ...
         $this->ppo_status = str_replace('<', '&lt;', $this->ppo_status);
         $this->ppo_status = str_replace('>', '&gt;', $this->ppo_status);
         $this->Texto_tag .= "<td>" . $this->ppo_status . "</td>\r\n";
   }
   //----- ppo_tahapanproject
   function NM_export_ppo_tahapanproject()
   {
         ...
         $this->ppo_tahapanproject = str_replace('<', '&lt;', $this->ppo_tahapanproject);
         $this->ppo_tahapanproject = str_replace('>', '&gt;', $this->ppo_tahapanproject);
         $this->Texto_tag .= "<td>" . $this->ppo_tahapanproject . "</td>\r\n";
   }
   //----- ppo_tasknumber
   function NM_export_ppo_tasknumber()
   {
         ...
         $this->ppo_tasknumber = str_replace('<', '&lt;', $this->ppo_tasknumber);
         $this->ppo_tasknumber = str_replace('>', '&gt;', $this->ppo_tasknumber);
         $this->Texto_tag .= "<td>" . $this->ppo_tasknumber . "</td>\r\n";
   }
   //----- targetplanfinish
   function NM_export_targetplanfinish()
   {
         ...
         $this->targetplanfinish = str_replace('<', '&lt;', $this->targetplanfinish);
         $this->targetplanfinish = str_replace('>', '&gt;', $this->targetplanfinish);
         $this->Texto_tag .= "<td>" . $this->targetplanfinish . "</td>\r\n";
   }
   //----- now
   function NM_export_now()
   {
         ...
         $this->now = str_replace('<', '&lt;', $this->now);
         $this->now = str_replace('>', '&gt;', $this->now);
         $this->Texto_tag .= "<td>" . $this->now . "</td>\r\n";
   }
   //----- ppo_targethari
   function NM_export_ppo_targethari()
   {
         ...
         $this->ppo_targethari = str_replace('<', '&lt;', $this->ppo_targethari);
         $this->ppo_targethari = str_replace('>', '&gt;', $this->ppo_targethari);
         $this->Texto_tag .= "<td>" . $this->ppo_targethari . "</td>\r\n";
   }
   //----- selisih
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarmtasktahapan']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarmtasktahapan']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Alarm Task Tahapan Project Lokasi Witel <?php echo $_SESSION['kodewitel'] ?> :: RTF</TITLE>
