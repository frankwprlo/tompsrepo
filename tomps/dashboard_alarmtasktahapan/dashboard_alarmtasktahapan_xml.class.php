...
class dashboard_alarmtasktahapan_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "dashboard_alarmtasktahapan.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarmtasktahapan']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarmtasktahapan']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarmtasktahapan']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarmtasktahapan']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         ...
         $this->xml_registro = "<dashboard_alarmtasktahapan";
   ...
   {
         nmgp_Form_Num_Val($this->ppo_projectid, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->ppo_projectid))
         {
             $this->ppo_projectid = sc_convert_encoding($this->ppo_projectid, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " ppo_projectid =\"" . $this->trata_dados($this->ppo_projectid) . "\"";
   }
   //----- ppo_status
   function NM_export_ppo_status()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->ppo_status))
         {
             $this->ppo_status = sc_convert_encoding($this->ppo_status, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " ppo_status =\"" . $this->trata_dados($this->ppo_status) . "\"";
   }
   //----- ppo_tahapanproject
   function NM_export_ppo_tahapanproject()
   {
         nmgp_Form_Num_Val($this->ppo_tahapanproject, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->ppo_tahapanproject))
         {
             $this->ppo_tahapanproject = sc_convert_encoding($this->ppo_tahapanproject, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " ppo_tahapanproject =\"" . $this->trata_dados($this->ppo_tahapanproject) . "\"";
   }
   //----- ppo_tasknumber
   function NM_export_ppo_tasknumber()
   {
         nmgp_Form_Num_Val($this->ppo_tasknumber, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->ppo_tasknumber))
         {
             $this->ppo_tasknumber = sc_convert_encoding($this->ppo_tasknumber, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " ppo_tasknumber =\"" . $this->trata_dados($this->ppo_tasknumber) . "\"";
   }
   //----- targetplanfinish
   function NM_export_targetplanfinish()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->targetplanfinish))
         {
             $this->targetplanfinish = sc_convert_encoding($this->targetplanfinish, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " targetplanfinish =\"" . $this->trata_dados($this->targetplanfinish) . "\"";
   }
   //----- now
   function NM_export_now()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->now))
         {
             $this->now = sc_convert_encoding($this->now, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " now =\"" . $this->trata_dados($this->now) . "\"";
   }
   //----- ppo_targethari
   function NM_export_ppo_targethari()
   {
         nmgp_Form_Num_Val($this->ppo_targethari, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "1", "S", "2", "", "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->ppo_targethari))
         {
             $this->ppo_targethari = sc_convert_encoding($this->ppo_targethari, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " ppo_targethari =\"" . $this->trata_dados($this->ppo_targethari) . "\"";
   }
   //----- selisih
   function NM_export_selisih()
   {
         nmgp_Form_Num_Val($this->selisih, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->selisih))
         {
             $this->selisih = sc_convert_encoding($this->selisih, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " selisih =\"" . $this->trata_dados($this->selisih) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarmtasktahapan']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarmtasktahapan']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Alarm Task Tahapan Project Lokasi Witel <?php echo $_SESSION['kodewitel'] ?> :: XML</TITLE>
