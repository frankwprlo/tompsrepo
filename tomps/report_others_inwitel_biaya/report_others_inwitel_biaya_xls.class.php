...
class report_others_inwitel_biaya_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= "_report_others_inwitel_biaya";
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "report_others_inwitel_biaya.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->tp_jenisproject = $rs->fields[2] ;  
         ...
         $this->tp_summary = $rs->fields[16] ;  
         $this->tp_status = $rs->fields[17] ;  
         $this->tp_status = (string)$this->tp_status;
         $this->tp_nilai = $rs->fields[18] ;  
         $this->tp_nilai = (string)$this->tp_nilai;
         $this->tp_rab = $rs->fields[19] ;  
         $this->tp_rab = (string)$this->tp_rab;
         $this->tp_mitra = $rs->fields[20] ;  
         $this->tp_mitra = (string)$this->tp_mitra;
         $this->tp_witel = $rs->fields[21] ;  
         $this->tp_witel = (string)$this->tp_witel;
         $this->tp_templateproject = $rs->fields[22] ;  
...
$_SESSION['scriptcase']['report_others_inwitel_biaya']['contr_erro'] = 'off'; 
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya'][$path_doc_md5][1] = $this->Tit_doc;
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE>List Project Detail :: Excel</TITLE>
