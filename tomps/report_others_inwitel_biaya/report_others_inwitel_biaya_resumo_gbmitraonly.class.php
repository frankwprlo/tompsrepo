...
class report_others_inwitel_biaya_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['contr_total_geral'] == "OK")
      {
          $this->array_total_tm_namamitra = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['arr_total']['tm_namamitra'];
          $this->array_total_tj_namajenis = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['arr_total']['tj_namajenis'];
      }
      else
      {
          $this->array_total_tm_namamitra = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['tot_geral'][2];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['tot_geral'][4];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['tot_geral'][3];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['tot_geral'][5];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['tot_geral'][6];
      $this->array_total_geral[6] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['tot_geral'][7];
      $this->array_total_geral[7] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['tot_geral'][8];
      $this->array_total_geral[8] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['tot_geral'][9];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
...
TestComm",
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['summarizing_fields_order']['gbmitraonly']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['summarizing_fields_order']['gbmitraonly'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['summarizing_fields_order']['gbmitraonly'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['summarizing_fields_display']['gbmitraonly'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['summarizing_fields_display']['gbmitraonly'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['summarizing_fields_display']['gbmitraonly'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['summarizing_fields_display']['gbmitraonly'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['summarizing_fields_display']['gbmitraonly'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['summarizing_fields_display']['gbmitraonly'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['summarizing_fields_display']['gbmitraonly'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_tm_namamitra as $i_tm_namamitra => $d_tm_namamitra) {
           ...
           foreach ($this->array_total_tj_namajenis[$i_tm_namamitra] as $i_tj_namajenis => $d_tj_namajenis) {
               if (!in_array($i_tj_namajenis, $this->comp_label[1][ $d_tm_namamitra[11] ], true)) {
                   $this->comp_index[1][ $d_tj_namajenis[11] ] = $d_tj_namajenis[10];
                   $this->comp_label[1][ $d_tm_namamitra[11] ][ $d_tj_namajenis[11] ] = $d_tj_namajenis[10];
               }
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_tabular_label'];
       ...
       foreach ($this->comp_label[0] as $i_tm_namamitra => $l_tm_namamitra) {
           ...
           foreach ($this->comp_label[1][$i_tm_namamitra] as $i_tj_namajenis => $l_tj_namajenis) {
               if (isset($this->array_total_tj_namajenis[$i_tm_namamitra][$i_tj_namajenis])) {
                   $this->comp_group[$i_tm_namamitra][$i_tj_namajenis] = array();
               }
           }
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@report_others_inwitel_biaya@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['pivot_order_start'][$iYAxysIndex])
                       {
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "report_others_inwitel_biaya_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['opcao'] = "print";
      ...
      $this->Total   = new report_others_inwitel_biaya_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['responsive_chart']['active']) {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_report_others_inwitel_biaya_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_report_others_inwitel_biaya_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_report_others_inwitel_biaya_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['num_css'] . '.css');
     ...
     else
     {
      ...
      $nm_saida->saida(" </style>\r\n");
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "report_others_inwitel_biaya/report_others_inwitel_biaya_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("report_others_inwitel_biaya_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'report_others_inwitel_biaya_config_pivot.php?nome_apl=report_others_inwitel_biaya&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_report_others_inwitel_biaya_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "report_others_inwitel_biaya/report_others_inwitel_biaya_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      $nm_saida->saida("        <TD class=\"" . $this->css_scGridHeaderFont . "\">\r\n");
      $nm_saida->saida("          " . "group by Mitra Pelaksana &Jenis Project" . "\r\n");
      $nm_saida->saida("        </TD>\r\n");
      $nm_saida->saida("       </TR>\r\n");
      $nm_saida->saida("      </TABLE>\r\n");
      $nm_saida->saida("     </TD>\r\n");
   ...
   function monta_rodape()
   {
      ...
      $nm_cab_filtro   = ""; 
      $nm_cab_filtrobr = ""; 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['campos_busca']))
      { 
        $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['campos_busca'];
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
   ...
   //---- 
   function adiciona_registro($sum_tp_odp, $sum_tp_nilai, $sum_tp_rab, $avg_prepare, $avg_perijinan, $avg_inst_testcomm, $avg_closing, $avg_pencapaian, $quebra_tm_namamitra, $quebra_tj_namajenis, $quebra_tm_namamitra_orig, $quebra_tj_namajenis_orig)
   {
      //----- Mitra
      ...
      //----- TJ NAMAJENIS
      if (!isset($this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig]))
      {
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][0] = 1;
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][1] = $sum_tp_odp;
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][2] = $sum_tp_nilai;
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][3] = $sum_tp_rab;
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][4] = $avg_prepare;
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][5] = $avg_perijinan;
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][6] = $avg_inst_testcomm;
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][7] = $avg_closing;
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][8] = $avg_pencapaian;
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][9] = 1;
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][10] = $quebra_tj_namajenis;
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][11] = $quebra_tj_namajenis_orig;
      }
      else
      {
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][0]++;
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][1] += $sum_tp_odp;
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][2] += $sum_tp_nilai;
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][3] += $sum_tp_rab;
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][4] += $avg_prepare;
         ...
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][7] += $avg_closing;
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][8] += $avg_pencapaian;
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][9]++;
      }
      //----- Total
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['arr_total']['tm_namamitra'] as $campo_tm_namamitra => $dados_tm_namamitra)
      {
         $this->array_total_tm_namamitra[$campo_tm_namamitra][2] = $dados_tm_namamitra[1];
         $this->array_total_tm_namamitra[$campo_tm_namamitra][4] = $dados_tm_namamitra[2];
         $this->array_total_tm_namamitra[$campo_tm_namamitra][3] = $dados_tm_namamitra[3];
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['arr_total']['tj_namajenis'][$campo_tm_namamitra] as $campo_tj_namajenis => $dados_tj_namajenis)
         {
            $this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][2] = $dados_tj_namajenis[1];
            $this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][4] = $dados_tj_namajenis[2];
            $this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][3] = $dados_tj_namajenis[3];
            $this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][5] = $dados_tj_namajenis[4];
            $this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][6] = $dados_tj_namajenis[5];
            $this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][7] = $dados_tj_namajenis[6];
            $this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][8] = $dados_tj_namajenis[7];
            $this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][9] = $dados_tj_namajenis[8];
            $this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][1] = $dados_tj_namajenis[9];
         }
      }
   }
   //---- 
   function finaliza_arrays()
   {
      foreach ($this->array_total_tm_namamitra as $campo_tm_namamitra => $dados_tm_namamitra)
      {
         ...
         foreach ($this->array_total_tj_namajenis[$campo_tm_namamitra] as $campo_tj_namajenis => $dados_tj_namajenis)
         {
            nmgp_Trunc_Num($this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][1], 0);
            nmgp_Trunc_Num($this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][2], 0);
            nmgp_Trunc_Num($this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][3], 0);
            if ($this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][0] != 0) {$this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][4] /= $this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][0];}
            nmgp_Trunc_Num($this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][4], 2);
            if ($this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][0] != 0) {$this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][5] /= $this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][0];}
            nmgp_Trunc_Num($this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][5], 2);
            if ($this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][0] != 0) {$this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][6] /= $this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][0];}
            nmgp_Trunc_Num($this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][6], 2);
            if ($this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][0] != 0) {$this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][7] /= $this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][0];}
            nmgp_Trunc_Num($this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][7], 2);
            if ($this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][0] != 0) {$this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][8] /= $this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][0];}
            nmgp_Trunc_Num($this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][8], 2);
         }
      }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->tp_jenisproject = $rs_res->fields[2] ;  
            ...
            $this->tp_nilai = $rs_res->fields[18] ;  
            $this->tp_rab = $rs_res->fields[19] ;  
            $this->tp_mitra = $rs_res->fields[20] ;  
            $this->tp_witel = $rs_res->fields[21] ;  
            $this->tp_templateproject = $rs_res->fields[22] ;  
...
$_SESSION['scriptcase']['report_others_inwitel_biaya']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->tp_odp, $this->tp_nilai, $this->tp_rab, $this->prepare, $this->perijinan, $this->inst_testcomm, $this->closing, $this->pencapaian, $this->tm_namamitra, $this->tj_namajenis, $this->tm_namamitra_orig,  $this->tj_namajenis_orig);
            }
   }
//
...
$_SESSION['scriptcase']['report_others_inwitel_biaya']['contr_erro'] = 'off';
      ...
      $this->finaliza_arrays();
      $this->rs_grid->Close();
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['tot_geral'][2] = $this->array_total_geral[1];
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['tot_geral'][3] = $this->array_total_geral[2];
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['tot_geral'][4] = $this->array_total_geral[3];
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['tot_geral'][5] = $this->array_total_geral[4];
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['tot_geral'][6] = $this->array_total_geral[5];
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['tot_geral'][7] = $this->array_total_geral[6];
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['tot_geral'][8] = $this->array_total_geral[7];
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['tot_geral'][9] = $this->array_total_geral[8];
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['tot_geral'][1] = $this->array_total_geral[0];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['arr_total']['tm_namamitra'] = $this->array_total_tm_namamitra;
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inwitel_biaya']['arr_total']['tj_namajenis'] = $this->array_total_tj_namajenis;
      }
   }
