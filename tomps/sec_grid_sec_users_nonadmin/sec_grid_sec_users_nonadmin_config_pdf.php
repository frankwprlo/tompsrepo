 ...
 */
    ...
    session_start();
    $SC_apl_proc = "sec_grid_sec_users_nonadmin";
...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['sec_grid_sec_users_nonadmin']['show_skip_charts_option']) || !$_SESSION['sc_session']['sec_grid_sec_users_nonadmin']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
