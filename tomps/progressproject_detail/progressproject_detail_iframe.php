...
$oExportPdf = new progressproject_detail_export_pdf;
$oExportPdf->exportPdf();

class progressproject_detail_export_pdf {
...
$STR_btn    = '';
$STR_lang   = '';
if (isset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['progressproject_detail']['progressproject_detail_iframe_params']))
{
    $STR_schema = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['progressproject_detail']['progressproject_detail_iframe_params']['str_schema'];
    $STR_tmp    = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['progressproject_detail']['progressproject_detail_iframe_params']['str_tmp'];
    $STR_prod   = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['progressproject_detail']['progressproject_detail_iframe_params']['str_prod'];
    $STR_btn    = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['progressproject_detail']['progressproject_detail_iframe_params']['str_btn'];
    $STR_lang   = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['progressproject_detail']['progressproject_detail_iframe_params']['str_lang'];
}
if (isset($aParams['sc_create_charts'])) {
    $_SESSION['sc_session'][ $aParams['script_case_init'] ]['progressproject_detail']['skip_charts'] = 'N' == $aParams['sc_create_charts'];
}
$Nm_lang     = array();
...
<head>
 <title><?php echo $Nm_lang['lang_othr_grid_titl'] ?> - AKSESSMR.V_PROJECT_DETAIL :: PDF</title>
...
?>
 ...
 function checkPDF() {
  $.get(nm_url_rand("progressproject_detail_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['progressproject_detail']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['progressproject_detail']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_progressproject_detail.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['progressproject_detail']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['progressproject_detail']['pdf_name'] : "progressproject_detail.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$path_doc_md5 = md5($NM_pdfurl . "/" . $NM_pdfbase);
$_SESSION['sc_session'][$aParams['script_case_init']]['progressproject_detail'][$path_doc_md5][0] = $NM_pdfurl . "/" . $NM_pdfbase;
$_SESSION['sc_session'][$aParams['script_case_init']]['progressproject_detail'][$path_doc_md5][1] = $NM_tit_doc;
$NM_volta   = "volta_grid";
?>
