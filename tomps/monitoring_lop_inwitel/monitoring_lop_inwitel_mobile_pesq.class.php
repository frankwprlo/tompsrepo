...
class monitoring_lop_inwitel_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . monitoring_lop_inwitel_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . monitoring_lop_inwitel_pack_protect_string($Tipo_filter[0]) . "\">.." . monitoring_lop_inwitel_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   { 
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_datel'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_datel'][] = trim($rs->fields[0]);
   ...
   { 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_sto'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_sto'][] = trim($rs->fields[0]);
            $cmp1 = NM_charset_to_utf8(trim($rs->fields[0]));
            $cmp2 = NM_charset_to_utf8(trim($rs->fields[1]));
            $nmgp_def_dados[] = array($cmp1 . "##@@" . $cmp2 => $cmp2); 
            $rs->MoveNext() ; 
   ...
   function lookup_ajax_tp_lokasi($tp_lokasi)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct TP_LOKASI from " . $this->Ini->nm_tabela . " where TP_DIVRE='" . $_SESSION['iddivre'] . "' AND TP_WITEL='" . $_SESSION['idwitel'] . "' and  TP_LOKASI like '%" . $tp_lokasi . "%' order by TP_LOKASI"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_tp_namalop($tp_namalop)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct TP_NAMALOP from " . $this->Ini->nm_tabela . " where TP_DIVRE='" . $_SESSION['iddivre'] . "' AND TP_WITEL='" . $_SESSION['idwitel'] . "' and  TP_NAMALOP like '%" . $tp_namalop . "%' order by TP_NAMALOP"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Monitoring List of Project </TITLE>
...
<?php
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['orig_pesq'] == "res")  
    { 
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>monitoring_lop_inwitel/monitoring_lop_inwitel_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="monitoring_lop_inwitel_ajax_search.js"></script>
 <script type="text/javascript" src="monitoring_lop_inwitel_ajax.js"></script>
 <script type="text/javascript">
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['dashboard_info']['compact_mode'])
      {
          return;
      }
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR align="center" valign="middle">
        ...
        <TD class="scFilterHeaderFont">
          Monitoring List of Project <?php echo $_SESSION['kodewitel'] ?>
        </TD>
       </TR>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $tp_thn_release = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_thn_release']; 
          $tp_thn_release_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_thn_release_cond']; 
          $tp_prjtrelease = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_prjtrelease']; 
          $tp_prjtrelease_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_prjtrelease_cond']; 
          $tp_batch = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_batch']; 
          $tp_batch_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_batch_cond']; 
          $tp_witel = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_witel']; 
          $tp_witel_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_witel_cond']; 
          $tp_datel = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_datel']; 
          $tp_datel_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_datel_cond']; 
          $tp_sto = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_sto']; 
          $tp_sto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_sto_cond']; 
          $tp_projectname = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_projectname']; 
          $tp_projectname_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_projectname_cond']; 
          $tp_lokasi = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_lokasi']; 
          $tp_lokasi_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_lokasi_cond']; 
          $tp_status = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_status']; 
          $tp_status_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_status_cond']; 
          $tp_planfinish_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_planfinish_dia']; 
          $tp_planfinish_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_planfinish_mes']; 
          $tp_planfinish_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_planfinish_ano']; 
          $tp_planfinish_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_planfinish_input_2_dia']; 
          $tp_planfinish_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_planfinish_input_2_mes']; 
          $tp_planfinish_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_planfinish_input_2_ano']; 
          $tp_planfinish_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_planfinish_cond']; 
          $tp_jenisproject = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_jenisproject']; 
          $tp_jenisproject_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_jenisproject_cond']; 
          $tp_namalop = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_namalop']; 
          $tp_namalop_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_namalop_cond']; 
          $remainsnew = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['remainsnew']; 
          $remainsnew_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['remainsnew_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['NM_operador']; 
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_thn_release'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_thn_release'][] = trim($rs->fields[0]);
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_prjtrelease'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_prjtrelease'][] = trim($rs->fields[0]);
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_batch'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_batch'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
<?php
      ...
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT MW_IDWITEL, MW_NAMAWITEL  FROM AKSESSMR.TBL_MAS_WITEL WHERE MW_IDDIVRE=" . $_SESSION['iddivre'] . " AND MW_IDWITEL=" . $_SESSION['idwitel'] . " ORDER BY MW_NAMAWITEL"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_witel'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_witel'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_tp_projectname" name="tp_projectname_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_tp_lokasi"  <?php echo $str_hide_tp_lokasi?>><?php
      if ($tp_lokasi != "")
      {
      $tp_lokasi_look = substr($this->Db->qstr($tp_lokasi), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct TP_LOKASI from " . $this->Ini->nm_tabela . " where TP_DIVRE='" . $_SESSION['iddivre'] . "' AND TP_WITEL='" . $_SESSION['idwitel'] . "' and TP_LOKASI = '$tp_lokasi_look' order by TP_LOKASI"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_status'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_status'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_jenisproject'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_jenisproject'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_tp_namalop"  <?php echo $str_hide_tp_namalop?>><?php
      if ($tp_namalop != "")
      {
      $tp_namalop_look = substr($this->Db->qstr($tp_namalop), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct TP_NAMALOP from " . $this->Ini->nm_tabela . " where TP_DIVRE='" . $_SESSION['iddivre'] . "' AND TP_WITEL='" . $_SESSION['idwitel'] . "' and TP_NAMALOP = '$tp_namalop_look' order by TP_NAMALOP"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_remainsnew"  <?php echo $str_hide_remainsnew?>><INPUT  type="text" id="SC_remainsnew" name="remainsnew" value="<?php echo NM_encode_input($remainsnew) ?>" size=10 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '.', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<?php
   if (is_file("monitoring_lop_inwitel_help.txt"))
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    $('#SC_tp_planfinish_dia').bind('change', function() {sc_monitoring_lop_inwitel_valida_dia(this)});
    $('#SC_tp_planfinish_input_2_dia').bind('change', function() {sc_monitoring_lop_inwitel_valida_dia(this)});
    $('#SC_tp_planfinish_input_2_mes').bind('change', function() {sc_monitoring_lop_inwitel_valida_mes(this)});
    $('#SC_tp_planfinish_mes').bind('change', function() {sc_monitoring_lop_inwitel_valida_mes(this)});
 }
 function sc_monitoring_lop_inwitel_valida_dia(obj)
 {
 ...
 function sc_monitoring_lop_inwitel_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "projectamo/monitoring_lop_inwitel";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "monitoring_lop_inwitel/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function trata_campos()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca'];
      }
      $tmp_pos = strpos($tp_thn_release, "##@@");
      if ($tmp_pos === false) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_thn_release'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_prjtrelease'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_batch'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_witel'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_datel'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_sto'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_status'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['psq_check_ret']['tp_jenisproject'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_thn_release'] = $tp_thn_release; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_thn_release_cond'] = $tp_thn_release_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_prjtrelease'] = $tp_prjtrelease; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_prjtrelease_cond'] = $tp_prjtrelease_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_batch'] = $tp_batch; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_batch_cond'] = $tp_batch_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_witel'] = $tp_witel; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_witel_cond'] = $tp_witel_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_datel'] = $tp_datel; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_datel_cond'] = $tp_datel_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_sto'] = $tp_sto; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_sto_cond'] = $tp_sto_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_projectname'] = $tp_projectname; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_projectname_cond'] = $tp_projectname_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_lokasi'] = $tp_lokasi; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_lokasi_cond'] = $tp_lokasi_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_status'] = $tp_status; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_status_cond'] = $tp_status_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_planfinish_dia'] = $tp_planfinish_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_planfinish_mes'] = $tp_planfinish_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_planfinish_ano'] = $tp_planfinish_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_planfinish_input_2_dia'] = $tp_planfinish_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_planfinish_input_2_mes'] = $tp_planfinish_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_planfinish_input_2_ano'] = $tp_planfinish_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_planfinish_cond'] = $tp_planfinish_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_jenisproject'] = $tp_jenisproject; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_jenisproject_cond'] = $tp_jenisproject_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_namalop'] = $tp_namalop; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_namalop_cond'] = $tp_namalop_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['remainsnew'] = $remainsnew; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['remainsnew_cond'] = $remainsnew_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca_ant']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca'];
      }
      ...
      if ($tp_planfinish_cond != "TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_planfinish'] = $val[0];
          ...
          if ($tp_planfinish_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']['tp_planfinish_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['where_pesq_ant'] || $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca_ant'] != $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campos_busca'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['contr_array_resumo'] = "NAO";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['where_pesq_ant'] = $this->comando . $this->comando_fim;
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['fast_search']);
