<?php
class monitoring_lop_inwitel_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['charts_html'] = '';
   ...
   { 
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['monitoring_lop_inwitel'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'];
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] == "pdf")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] == "pdf")
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] = "igual";
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'];
 }
...
//
   ...
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "monitoring_lop_inwitel/monitoring_lop_inwitel_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'])
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['force_toolbar']);
   } 
   $this->width_tabula_quebra  = "0px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['monitoring_lop_inwitel']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['monitoring_lop_inwitel']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['monitoring_lop_inwitel']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opc_psq'])
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['mostra_edit'] = "N";
   }
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'])
   ...
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['print_all'];
   if ($this->Print_All)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['monitoring_lop_inwitel']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['monitoring_lop_inwitel']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['monitoring_lop_inwitel']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] = "muda_qt_linhas";
   } 

   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['monitoring_lop_inwitel'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['monitoring_lop_inwitel'];
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "monitoring_lop_inwitel/monitoring_lop_inwitel_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "monitoring_lop_inwitel_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new monitoring_lop_inwitel_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['monitoring_lop_inwitel']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['monitoring_lop_inwitel']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['monitoring_lop_inwitel']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['monitoring_lop_inwitel']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['monitoring_lop_inwitel']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['monitoring_lop_inwitel']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['monitoring_lop_inwitel']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['monitoring_lop_inwitel']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_quebra'] = array(); 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao']       = "igual" ; 
   } 
// 
   $this->count_ger = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['final']; 
   ...
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'])
   { 
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<HEAD>
 <TITLE>Monitoring List of Project <?php echo $_SESSION['kodewitel'] ?> :: PDF</TITLE>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['pivot_charts']) : 0;
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>Monitoring List of Project " . $_SESSION['kodewitel'] . "</TITLE>\r\n");
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ajax_nav'])
       { 
           ...
           $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . session_id() . "\">\r\n");
           $nm_saida->saida("   </form>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"monitoring_lop_inwitel_jquery.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"monitoring_lop_inwitel_ajax.js\"></script>\r\n");
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($this->count_ger) . ";\r\n");
           }
           else
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_reg_grid']) . ";\r\n");
           }
           $gridWidthCorrection = '';
           ...
           $nm_saida->saida("   gridHeaders = $(\".sc-ui-grid-header-row-monitoring_lop_inwitel-1\");\r\n");
           ...
           $nm_saida->saida("   tableOriginal = $(\"#sc-ui-grid-body-1d7dc5af\");\r\n");
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ancor_save']);
           }
           $nm_saida->saida("   });\r\n");
           ...
           $nm_saida->saida("       dataType: \"html\",\r\n");
           $nm_saida->saida("       url: \"monitoring_lop_inwitel_save_grid.php\",\r\n");
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_monitoring_lop_inwitel_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'])
       {
       ...
       elseif ($this->NM_opcao == "print" || $this->Print_All)
       {
           ...
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_monitoring_lop_inwitel_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_monitoring_lop_inwitel_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "monitoring_lop_inwitel/monitoring_lop_inwitel_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           $cada_css = ".monitoring_lop_inwitel_" . substr($cada_css, 1);
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf" && !$this->Print_All)
       { 
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['monitoring_lop_inwitel']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['monitoring_lop_inwitel']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['monitoring_lop_inwitel']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['monitoring_lop_inwitel']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida']) ? "monitoring_lop_inwitel_" : "";
   $this->css_sep = " ";
...
//----- 
 function cabecalho()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opc_liga']['cab']))
   {
       return; 
   }
   $nm_cab_filtro   = ""; 
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cond_pesq'], 0, $trab_pos);
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['sv_dt_head'] = array();
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
       $_SESSION['scriptcase']['saida_html'] = "";
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['sv_dt_head'][1] = $sc_data_cab1;
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['sv_dt_head']['fix'] = $nm_data_fixa;
   ...
   $nm_saida->saida("          Monitoring List of Project " . $_SESSION['kodewitel'] . "\r\n");
   $nm_saida->saida("        </TD>\r\n");
   $nm_saida->saida("       </TR>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_monitoring_lop_inwitel__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-monitoring_lop_inwitel-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida_label']) { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opc_psq']) { 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] || ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['exibe_seq'] == "S")) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_tp_jmldistribusi_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
     ...
     { 
         ...
         { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 $css_emb .= ".monitoring_lop_inwitel_" . substr($cada_css, 1);
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_tp_prjtrelease()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TP_PRJTRELEASE')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
 ...
 function NM_label_tp_batch()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TP_BATCH')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_witel()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TP_WITEL')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_datel()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TP_DATEL')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_sto()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TP_STO')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_jenisproject()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TP_JENISPROJECT')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_lokasi()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TP_LOKASI')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_projectname()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TP_PROJECTNAME')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_planstart()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TP_PLANSTART')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_planfinish()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TP_PLANFINISH')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_odp()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TP_ODP')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_nilai()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TP_NILAI')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_rab()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TP_RAB')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_status()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TP_STATUS')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_kickoff_meeting()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'KICKOFF_MEETING')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_survey()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'SURVEY')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_rab_apd_kml()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'RAB_APD_KML')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_njki_justifikasi_nodin()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'NJKI_JUSTIFIKASI_NODIN')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_perijinan()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'PERIJINAN')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_delivery_material()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'DELIVERY_MATERIAL')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tcbr()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TCBR')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_hdpe_tanam_tiang()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'HDPE_TANAM_TIANG')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_gelar_kabel()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'GELAR_KABEL')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_pasang_terminal_odf()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'PASANG_TERMINAL_ODF')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_pasang_terminal_odc()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'PASANG_TERMINAL_ODC')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_pasang_terminal_odp()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'PASANG_TERMINAL_ODP')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_terminasi()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TERMINASI')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_test_comm()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TEST_COMM')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_uji_terima()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'UJI_TERIMA')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_rekon_amandemen()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'REKON_AMANDEMEN')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_baut_bast()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'BAUT_BAST')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_gr_ir()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'GR_IR')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_id()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TP_ID')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_actualstart()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TP_ACTUALSTART')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_actualfinish()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TP_ACTUALFINISH')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_templateproject()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TP_TEMPLATEPROJECT')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_targetwaktu()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TP_TARGETWAKTU')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_jmldistribusi()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_cmp'] == 'TP_JMLDISTRIBUSI')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['ini_cor_grid']);
       }
   }
...
// 
   $SC_Label = (isset($this->New_label['tp_thn_release'])) ? $this->New_label['tp_thn_release'] : "Release Project"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['tp_thn_release'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_prjtrelease'])) ? $this->New_label['tp_prjtrelease'] : "Sub-Release"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['tp_prjtrelease'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_batch'])) ? $this->New_label['tp_batch'] : "Batch"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['tp_batch'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_witel'])) ? $this->New_label['tp_witel'] : "Kode Witel"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['tp_witel'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_datel'])) ? $this->New_label['tp_datel'] : "Kode Datel"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['tp_datel'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_sto'])) ? $this->New_label['tp_sto'] : "Kode STO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['tp_sto'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_jenisproject'])) ? $this->New_label['tp_jenisproject'] : "Jenis Project"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['tp_jenisproject'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_lokasi'])) ? $this->New_label['tp_lokasi'] : "Lokasi Project"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['tp_lokasi'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_projectname'])) ? $this->New_label['tp_projectname'] : "Nama Project"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['tp_projectname'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_planstart'])) ? $this->New_label['tp_planstart'] : "Tgl Mulai ( Plan )"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['tp_planstart'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_planfinish'])) ? $this->New_label['tp_planfinish'] : "Tgl Selesai ( Plan )"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['tp_planfinish'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_odp'])) ? $this->New_label['tp_odp'] : "Jml ODP"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['tp_odp'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_nilai'])) ? $this->New_label['tp_nilai'] : "Nilai Rekon"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['tp_nilai'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_rab'])) ? $this->New_label['tp_rab'] : "Nilai DRM"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['tp_rab'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['remainsnew'])) ? $this->New_label['remainsnew'] : "Tgl Sekarang - Tgl Plan Selesai"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['remainsnew'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_status'])) ? $this->New_label['tp_status'] : "Kode Status"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['tp_status'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['kickoff_meeting'])) ? $this->New_label['kickoff_meeting'] : "Kickoff Meeting"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['kickoff_meeting'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['survey'])) ? $this->New_label['survey'] : "Survey"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['survey'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['rab_apd_kml'])) ? $this->New_label['rab_apd_kml'] : "RAB APD KML"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['rab_apd_kml'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['njki_justifikasi_nodin'])) ? $this->New_label['njki_justifikasi_nodin'] : "Njki Justifikasi Nodin"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['njki_justifikasi_nodin'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['perijinan'])) ? $this->New_label['perijinan'] : "Perijinan"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['perijinan'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['delivery_material'])) ? $this->New_label['delivery_material'] : "Delivery Material"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['delivery_material'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tcbr'])) ? $this->New_label['tcbr'] : "TCBR"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['tcbr'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['hdpe_tanam_tiang'])) ? $this->New_label['hdpe_tanam_tiang'] : "HDPE Tanam Tiang"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['hdpe_tanam_tiang'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['gelar_kabel'])) ? $this->New_label['gelar_kabel'] : "Gelar Kabel"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['gelar_kabel'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['pasang_terminal_odf'])) ? $this->New_label['pasang_terminal_odf'] : "Pasang Terminal ODF"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['pasang_terminal_odf'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['pasang_terminal_odc'])) ? $this->New_label['pasang_terminal_odc'] : "Pasang Terminal ODC"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['pasang_terminal_odc'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['pasang_terminal_odp'])) ? $this->New_label['pasang_terminal_odp'] : "Pasang Terminal ODP"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['pasang_terminal_odp'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['terminasi'])) ? $this->New_label['terminasi'] : "Terminasi"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['terminasi'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['test_comm'])) ? $this->New_label['test_comm'] : "Test Comm"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['test_comm'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['uji_terima'])) ? $this->New_label['uji_terima'] : "Uji Terima"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['uji_terima'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['rekon_amandemen'])) ? $this->New_label['rekon_amandemen'] : "Rekon Amandemen"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['rekon_amandemen'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['baut_bast'])) ? $this->New_label['baut_bast'] : "Baut Bast"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['baut_bast'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['gr_ir'])) ? $this->New_label['gr_ir'] : "GR IR"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['gr_ir'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_id'])) ? $this->New_label['tp_id'] : "Project ID"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['tp_id'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_actualstart'])) ? $this->New_label['tp_actualstart'] : "Tgl Mulai ( actual )"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['tp_actualstart'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_actualfinish'])) ? $this->New_label['tp_actualfinish'] : "Tgl Selesai ( actual )"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['tp_actualfinish'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_templateproject'])) ? $this->New_label['tp_templateproject'] : "Nama Template"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['tp_templateproject'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_targetwaktu'])) ? $this->New_label['tp_targetwaktu'] : "Target"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['tp_targetwaktu'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_jmldistribusi'])) ? $this->New_label['tp_jmldistribusi'] : "Jml Distribusi"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['labels']['tp_jmldistribusi'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['monitoring_lop_inwitel']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['monitoring_lop_inwitel']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['monitoring_lop_inwitel']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_monitoring_lop_inwitel#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               $nm_saida->saida("  <tr><td class=\"" . $this->css_scGridTabelaTd . " " . "\" style=\"font-family:" . $this->Ini->texto_fonte_tipo_impar . ";font-size:12px;color:#000000;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\">\r\n");
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['force_toolbar'] = true;
           } 
   ...
   { 
       $nm_saida->saida(" <TR> \r\n");
       $nm_id_aplicacao = " id=\"apl_monitoring_lop_inwitel#?#1\"";
   } 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-1d7dc5af\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida_grid'])
   { 
       $_SESSION['scriptcase']['saida_html'] = "";
   } 
// 
   ...
   $ini_grid = true;
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          $this->NM_field_style = array();
          //---------- Gauge ----------
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
          ...
          $GLOBALS["tp_status"] = (string)$GLOBALS["tp_status"];
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['final'] + 1; 
          if (!$ini_grid) {
...
$_SESSION['scriptcase']['monitoring_lop_inwitel']['contr_erro'] = 'off';
          if (($nm_houve_quebra == "S" || $nm_inicio_pag == 0) && !$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida_grid'])
          { 
              $this->label_grid($linhas);
              $nm_houve_quebra = "N";
          } 
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] || ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['exibe_seq'] == "S")) { 
          ...
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida_grid'])
 ...
 function NM_calc_span()
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida_pdf'] == "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['exibe_seq'] != "S" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
       {
           $this->NM_colspan--; 
       }
   } 
 ...
 function quebra_geral_sc_free_total_bot() 
 {
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "monitoring_lop_inwitel/monitoring_lop_inwitel_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnSelCamposShow('" . $this->Ini->path_link . "monitoring_lop_inwitel/monitoring_lop_inwitel_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['SC_Ind_Groupby'] != "sc_free_total")
      ...
      {
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpesquisa", "", "", "pesq_top", "", "Filter Data", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "Klik untuk memfilter data", "thickbox", "" . $this->Ini->path_link . "monitoring_lop_inwitel/monitoring_lop_inwitel.php?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&nmgp_opcao=busca&nmgp_orig_pesq=grid&KeepThis=true&TB_iframe=true&height=0&width=0&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
           $nm_saida->saida("           $Cod_Btn \r\n");
           $NM_btn = true;
      }
          if (is_file("monitoring_lop_inwitel_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("monitoring_lop_inwitel_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['dashboard_info']['under_dashboard']))
      {
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['sc_modal'])
        {
   ...
   function nmgp_barra_bot_normal()
   {
      ...
      $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"left\" width=\"33%\"> \r\n");
          ...
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_lin_grid'];
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_lin_grid'] == 10) ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_lin_grid'] == 20) ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_lin_grid'] == 50) ? " selected" : "";
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opc_liga']['nav']))
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_avanca", "nm_gp_submit_rec('" . $this->Rec_fim . "')", "nm_gp_submit_rec('" . $this->Rec_fim . "')", "forward_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opc_liga']['nav']))
          {
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   ...
   $nm_saida->saida("   scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           if ($this->arr_buttons['bcons_avanca']['type'] != 'image')
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
   ...
   {
       $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
       $nm_saida->saida("      parent.scAjaxDetailHeight('monitoring_lop_inwitel', $(document).innerHeight());\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
 }
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"monitoring_lop_inwitel\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"monitoring_lop_inwitel_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . NM_encode_input(session_id()) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['monitoring_lop_inwitel_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@monitoring_lop_inwitel@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   $nm_saida->saida("       if (\"pdf\" == x)\r\n");
   $nm_saida->saida("       {\r\n");
   $nm_saida->saida("           window.location = \"" . $this->Ini->path_link . "monitoring_lop_inwitel/monitoring_lop_inwitel_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_create_charts=\" + crt + \"&sc_graf_pdf=\" + g;\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['monitoring_lop_inwitel']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Doc = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Doc = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Doc = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"monitoring_lop_inwitel_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['monitoring_lop_inwitel']['reg_start']))
   {
       $nm_saida->saida("      parent.scAjaxDetailStatus('monitoring_lop_inwitel');\r\n");
       $nm_saida->saida("      parent.scAjaxDetailHeight('monitoring_lop_inwitel', $(document).innerHeight());\r\n");
   }
   $nm_saida->saida("   </script>\r\n");
 }
