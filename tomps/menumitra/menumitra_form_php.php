...
class menumitra_form_php
{
   ...
   function init()
   {
      ...
      //check prod
      if(!isset($_SESSION['scriptcase']['menumitra']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['menumitra']['glo_nm_path_prod']))
      {
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
...
if ($this->Db)
{
    $this->Db->Close(); 
      ...
      if ($_SESSION['scriptcase']['sc_item_menu'] == "menumitra")
      {
              $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("v_table_project_copy_for_report_mitra") . "/?nm_run_menu=1&nm_apl_menu=menumitra&script_case_init=1&script_case_session=" . session_id() . "";
      }
      elseif (isset($_SESSION['scriptcase']['sc_def_menu']['menumitra']))
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['menumitra'] as $id_item => $arr_item)
         {
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("v_table_project_copy_for_report_mitra") . "/?nm_run_menu=1&nm_apl_menu=menumitra&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_30")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("list_project_inwitel") . "/?nm_run_menu=1&nm_apl_menu=menumitra&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_28")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("v_table_project_copy_mitra") . "/?nm_run_menu=1&nm_apl_menu=menumitra&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "&script_case_session=" . session_id() . "";
      }
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("report_mitra_other") . "/?nm_run_menu=1&nm_apl_menu=menumitra&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_16")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("report_realisasiproject_mitra") . "/?nm_run_menu=1&nm_apl_menu=menumitra&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_26")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("app_change_pswd") . "/?nm_run_menu=1&nm_apl_menu=menumitra&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_32")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("app_Login") . "/?script_case_init=" . $_SESSION['sc_session'][1]['menumitra']['init'] . "&script_case_session=" . session_id() . "";
      }
      }
      if (!$link_url)
      {
      ...
      $_SESSION['scriptcase']['menu_apls']['menumitra'][$this->menu_sc_init] = array();
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="script_case_session" value="<?php echo NM_encode_input(session_id()) ?>"> 
          <input type=hidden name="nm_apl_menu" value="menumitra"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "menumitra")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'menumitra', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
<?php
   ...
   function Gera_sc_init($apl_menu)
   {
        ...
        $this->menu_sc_init = $_SESSION['scriptcase']['menumitra']['sc_init'][$apl_menu];
...
SC_dir_app_ini('projectamo');
$controle = new menumitra_form_php();
$controle->init();
?>
