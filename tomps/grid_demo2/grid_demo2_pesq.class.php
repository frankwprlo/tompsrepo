...
class grid_demo2_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_demo2_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_demo2_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_demo2_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nomortahapan')
      {
          $nomortahapan = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nomortahapan($nomortahapan);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_ppo_tasktahapan')
      {
          $ppo_tasktahapan = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_ppo_tasktahapan($ppo_tasktahapan);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_ppo_targethari')
      {
          $ppo_targethari = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_ppo_targethari($ppo_targethari);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_acumtarget')
      {
          $acumtarget = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_acumtarget($acumtarget);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_nomortahapan($nomortahapan)
   {
      $nomortahapan = substr($this->Db->qstr($nomortahapan), 1, -1);
            $nomortahapan_look = substr($this->Db->qstr($nomortahapan), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct NOMORTAHAPAN from " . $this->Ini->nm_tabela . " where  NOMORTAHAPAN like '%" . $nomortahapan . "%' order by NOMORTAHAPAN"; 
   ...
   function lookup_ajax_ppo_tasktahapan($ppo_tasktahapan)
   {
      $ppo_tasktahapan = substr($this->Db->qstr($ppo_tasktahapan), 1, -1);
            $ppo_tasktahapan_look = substr($this->Db->qstr($ppo_tasktahapan), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct PPO_TASKTAHAPAN from " . $this->Ini->nm_tabela . " where  PPO_TASKTAHAPAN like '%" . $ppo_tasktahapan . "%' order by PPO_TASKTAHAPAN"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_ppo_targethari($ppo_targethari)
   {
      $ppo_targethari = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $ppo_targethari);
      $ppo_targethari = substr($this->Db->qstr($ppo_targethari), 1, -1);
            $ppo_targethari_look = substr($this->Db->qstr($ppo_targethari), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct PPO_TARGETHARI from " . $this->Ini->nm_tabela . " where   CAST (PPO_TARGETHARI AS TEXT)  like '%" . $ppo_targethari . "%' order by PPO_TARGETHARI"; 
      }
      else
      {
          $nm_comando = "select distinct PPO_TARGETHARI from " . $this->Ini->nm_tabela . " where  PPO_TARGETHARI like '%" . $ppo_targethari . "%' order by PPO_TARGETHARI"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_acumtarget($acumtarget)
   {
      $acumtarget = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $acumtarget);
      $acumtarget = substr($this->Db->qstr($acumtarget), 1, -1);
            $acumtarget_look = substr($this->Db->qstr($acumtarget), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct ACUMTARGET from " . $this->Ini->nm_tabela . " where   CAST (ACUMTARGET AS TEXT)  like '%" . $acumtarget . "%' order by ACUMTARGET"; 
      }
      else
      {
          $nm_comando = "select distinct ACUMTARGET from " . $this->Ini->nm_tabela . " where  ACUMTARGET like '%" . $acumtarget . "%' order by ACUMTARGET"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - demo2</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_demo2/grid_demo2_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_demo2_ajax_search.js"></script>
 <script type="text/javascript" src="grid_demo2_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_nomortahapan_cond#NMF#' + search_get_sel_txt('SC_nomortahapan_cond') + '@NMF@';
  str_out += 'SC_nomortahapan#NMF#' + search_get_text('SC_nomortahapan') + '@NMF@';
  str_out += 'id_ac_nomortahapan#NMF#' + search_get_text('id_ac_nomortahapan') + '@NMF@';
  str_out += 'SC_ppo_tasktahapan_cond#NMF#' + search_get_sel_txt('SC_ppo_tasktahapan_cond') + '@NMF@';
  str_out += 'SC_ppo_tasktahapan#NMF#' + search_get_text('SC_ppo_tasktahapan') + '@NMF@';
  str_out += 'id_ac_ppo_tasktahapan#NMF#' + search_get_text('id_ac_ppo_tasktahapan') + '@NMF@';
  str_out += 'SC_ppo_targethari_cond#NMF#' + search_get_sel_txt('SC_ppo_targethari_cond') + '@NMF@';
  str_out += 'SC_ppo_targethari#NMF#' + search_get_text('SC_ppo_targethari') + '@NMF@';
  str_out += 'id_ac_ppo_targethari#NMF#' + search_get_text('id_ac_ppo_targethari') + '@NMF@';
  str_out += 'SC_acumtarget_cond#NMF#' + search_get_sel_txt('SC_acumtarget_cond') + '@NMF@';
  str_out += 'SC_acumtarget#NMF#' + search_get_text('SC_acumtarget') + '@NMF@';
  str_out += 'id_ac_acumtarget#NMF#' + search_get_text('id_ac_acumtarget') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_nomortahapan").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nomortahapan",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_nomortahapan").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_nomortahapan").val( $(this).val() );
       }
     }
   });
   $("#id_ac_ppo_tasktahapan").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_ppo_tasktahapan",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_ppo_tasktahapan").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_ppo_tasktahapan").val( $(this).val() );
       }
     }
   });
   $("#id_ac_ppo_targethari").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_ppo_targethari",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_ppo_targethari").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_ppo_targethari").val( $(this).val() );
       }
     }
   });
   $("#id_ac_acumtarget").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_acumtarget",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_acumtarget").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_acumtarget").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - demo2</span></td>
...
<?php
   ...
   {
      global 
             $nomortahapan_cond, $nomortahapan, $nomortahapan_autocomp,
             $ppo_tasktahapan_cond, $ppo_tasktahapan, $ppo_tasktahapan_autocomp,
             $ppo_targethari_cond, $ppo_targethari, $ppo_targethari_autocomp,
             $acumtarget_cond, $acumtarget, $acumtarget_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $nomortahapan = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca']['nomortahapan']; 
          $nomortahapan_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca']['nomortahapan_cond']; 
          $ppo_tasktahapan = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca']['ppo_tasktahapan']; 
          $ppo_tasktahapan_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca']['ppo_tasktahapan_cond']; 
          $ppo_targethari = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca']['ppo_targethari']; 
          $ppo_targethari_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca']['ppo_targethari_cond']; 
          $acumtarget = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca']['acumtarget']; 
          $acumtarget_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca']['acumtarget_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca']['NM_operador']; 
      } 
      if (!isset($nomortahapan_cond) || empty($nomortahapan_cond))
      {
         $nomortahapan_cond = "qp";
      }
      if (!isset($ppo_tasktahapan_cond) || empty($ppo_tasktahapan_cond))
      {
         $ppo_tasktahapan_cond = "qp";
      }
      if (!isset($ppo_targethari_cond) || empty($ppo_targethari_cond))
      {
         $ppo_targethari_cond = "gt";
      }
      if (!isset($acumtarget_cond) || empty($acumtarget_cond))
      {
         $acumtarget_cond = "gt";
      }
      ...
      $str_hide_nomortahapan = (in_array($nomortahapan_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_ppo_tasktahapan = (in_array($ppo_tasktahapan_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_ppo_targethari = (in_array($ppo_targethari_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_acumtarget = (in_array($acumtarget_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($nomortahapan) || $nomortahapan == "")
      {
          $nomortahapan = "";
      }
      if (isset($nomortahapan) && !empty($nomortahapan))
      {
         $tmp_pos = strpos($nomortahapan, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nomortahapan = substr($nomortahapan, 0, $tmp_pos);
         }
      }
      if (!isset($ppo_tasktahapan) || $ppo_tasktahapan == "")
      {
          $ppo_tasktahapan = "";
      }
      if (isset($ppo_tasktahapan) && !empty($ppo_tasktahapan))
      {
         $tmp_pos = strpos($ppo_tasktahapan, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $ppo_tasktahapan = substr($ppo_tasktahapan, 0, $tmp_pos);
         }
      }
      if (!isset($ppo_targethari) || $ppo_targethari == "")
      {
          $ppo_targethari = "";
      }
      if (isset($ppo_targethari) && !empty($ppo_targethari))
      {
         $tmp_pos = strpos($ppo_targethari, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $ppo_targethari = substr($ppo_targethari, 0, $tmp_pos);
         }
      }
      if (!isset($acumtarget) || $acumtarget == "")
      {
          $acumtarget = "";
      }
      if (isset($acumtarget) && !empty($acumtarget))
      {
         $tmp_pos = strpos($acumtarget, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $acumtarget = substr($acumtarget, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['nomortahapan'])) ? $this->New_label['nomortahapan'] : "NOMORTAHAPAN"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_nomortahapan_cond" name="nomortahapan_cond" onChange="nm_campos_between(document.getElementById('id_vis_nomortahapan'), this, 'nomortahapan')">
       <OPTION value="qp" <?php if ("qp" == $nomortahapan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nomortahapan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nomortahapan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nomortahapan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nomortahapan" <?php echo $str_hide_nomortahapan?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['nomortahapan'])) ? $this->New_label['nomortahapan'] : "NOMORTAHAPAN";
 $nmgp_tab_label .= "nomortahapan?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      if ($nomortahapan != "")
      ...
      $nomortahapan_look = substr($this->Db->qstr($nomortahapan), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct NOMORTAHAPAN from " . $this->Ini->nm_tabela . " where NOMORTAHAPAN = '$nomortahapan_look' order by NOMORTAHAPAN"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$nomortahapan]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$nomortahapan];
      }
      else
      {
          $sAutocompValue = $nomortahapan;
      }
?>
<INPUT  type="text" id="SC_nomortahapan" name="nomortahapan" value="<?php echo NM_encode_input($nomortahapan) ?>" size=50 alt="{datatype: 'text', maxLength: 80, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nomortahapan" name="nomortahapan_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['ppo_tasktahapan'])) ? $this->New_label['ppo_tasktahapan'] : "PPO TASKTAHAPAN"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_ppo_tasktahapan_cond" name="ppo_tasktahapan_cond" onChange="nm_campos_between(document.getElementById('id_vis_ppo_tasktahapan'), this, 'ppo_tasktahapan')">
       <OPTION value="qp" <?php if ("qp" == $ppo_tasktahapan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $ppo_tasktahapan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $ppo_tasktahapan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $ppo_tasktahapan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ppo_tasktahapan" <?php echo $str_hide_ppo_tasktahapan?> valign="top">
 ...
 $nmgp_tab_label .= "ppo_tasktahapan?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      if ($ppo_tasktahapan != "")
      ...
      $ppo_tasktahapan_look = substr($this->Db->qstr($ppo_tasktahapan), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct PPO_TASKTAHAPAN from " . $this->Ini->nm_tabela . " where PPO_TASKTAHAPAN = '$ppo_tasktahapan_look' order by PPO_TASKTAHAPAN"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$ppo_tasktahapan]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$ppo_tasktahapan];
      }
      else
      {
          $sAutocompValue = $ppo_tasktahapan;
      }
?>
<INPUT  type="text" id="SC_ppo_tasktahapan" name="ppo_tasktahapan" value="<?php echo NM_encode_input($ppo_tasktahapan) ?>" size=50 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_ppo_tasktahapan" name="ppo_tasktahapan_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['ppo_targethari'])) ? $this->New_label['ppo_targethari'] : "PPO TARGETHARI"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_ppo_targethari_cond" name="ppo_targethari_cond" onChange="nm_campos_between(document.getElementById('id_vis_ppo_targethari'), this, 'ppo_targethari')">
       <OPTION value="gt" <?php if ("gt" == $ppo_targethari_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $ppo_targethari_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $ppo_targethari_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ppo_targethari" <?php echo $str_hide_ppo_targethari?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['ppo_targethari'])) ? $this->New_label['ppo_targethari'] : "PPO TARGETHARI";
 $nmgp_tab_label .= "ppo_targethari?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      if ($ppo_targethari != "")
      ...
      $ppo_targethari_look = substr($this->Db->qstr($ppo_targethari), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($ppo_targethari))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct PPO_TARGETHARI from " . $this->Ini->nm_tabela . " where PPO_TARGETHARI = $ppo_targethari_look order by PPO_TARGETHARI"; 
      }
      else
      {
          $nm_comando = "select distinct PPO_TARGETHARI from " . $this->Ini->nm_tabela . " where PPO_TARGETHARI = $ppo_targethari_look order by PPO_TARGETHARI"; 
      ...
      if (isset($nmgp_def_dados[0][$ppo_targethari]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$ppo_targethari];
      }
      else
      {
            nmgp_Form_Num_Val($ppo_targethari, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $ppo_targethari;
      }
?>
<INPUT  type="text" id="SC_ppo_targethari" name="ppo_targethari" value="<?php echo NM_encode_input($ppo_targethari) ?>" size=12 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_ppo_targethari" name="ppo_targethari_autocomp" size="12" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['acumtarget'])) ? $this->New_label['acumtarget'] : "ACUMTARGET"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_acumtarget_cond" name="acumtarget_cond" onChange="nm_campos_between(document.getElementById('id_vis_acumtarget'), this, 'acumtarget')">
       <OPTION value="gt" <?php if ("gt" == $acumtarget_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $acumtarget_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $acumtarget_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_acumtarget" <?php echo $str_hide_acumtarget?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['acumtarget'])) ? $this->New_label['acumtarget'] : "ACUMTARGET";
 $nmgp_tab_label .= "acumtarget?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      if ($acumtarget != "")
      ...
      $acumtarget_look = substr($this->Db->qstr($acumtarget), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($acumtarget))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct ACUMTARGET from " . $this->Ini->nm_tabela . " where ACUMTARGET = $acumtarget_look order by ACUMTARGET"; 
      }
      else
      {
          $nm_comando = "select distinct ACUMTARGET from " . $this->Ini->nm_tabela . " where ACUMTARGET = $acumtarget_look order by ACUMTARGET"; 
      ...
      if (isset($nmgp_def_dados[0][$acumtarget]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$acumtarget];
      }
      else
      {
            nmgp_Form_Num_Val($acumtarget, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $acumtarget;
      }
?>
<INPUT  type="text" id="SC_acumtarget" name="acumtarget" value="<?php echo NM_encode_input($acumtarget) ?>" size=12 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_acumtarget" name="acumtarget_autocomp" size="12" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_demo2_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_demo2']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_demo2']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_nomortahapan'), document.F1.nomortahapan_cond, 'nomortahapan');
   document.F1.nomortahapan.value = "";
   document.F1.nomortahapan_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_ppo_tasktahapan'), document.F1.ppo_tasktahapan_cond, 'ppo_tasktahapan');
   document.F1.ppo_tasktahapan.value = "";
   document.F1.ppo_tasktahapan_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_ppo_targethari'), document.F1.ppo_targethari_cond, 'ppo_targethari');
   document.F1.ppo_targethari.value = "";
   document.F1.ppo_targethari_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_acumtarget'), document.F1.acumtarget_cond, 'acumtarget');
   document.F1.acumtarget.value = "";
   document.F1.acumtarget_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "projectamo/grid_demo2";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_nomortahapan_cond'] = 'cond';
      $tp_fields['SC_nomortahapan'] = 'text_aut';
      $tp_fields['id_ac_nomortahapan'] = 'text_aut';
      $tp_fields['SC_ppo_tasktahapan_cond'] = 'cond';
      $tp_fields['SC_ppo_tasktahapan'] = 'text_aut';
      $tp_fields['id_ac_ppo_tasktahapan'] = 'text_aut';
      $tp_fields['SC_ppo_targethari_cond'] = 'cond';
      $tp_fields['SC_ppo_targethari'] = 'text_aut';
      $tp_fields['id_ac_ppo_targethari'] = 'text_aut';
      $tp_fields['SC_acumtarget_cond'] = 'cond';
      $tp_fields['SC_acumtarget'] = 'text_aut';
      $tp_fields['id_ac_acumtarget'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $nomortahapan_cond, $nomortahapan, $nomortahapan_autocomp,
             $ppo_tasktahapan_cond, $ppo_tasktahapan, $ppo_tasktahapan_autocomp,
             $ppo_targethari_cond, $ppo_targethari, $ppo_targethari_autocomp,
             $acumtarget_cond, $acumtarget, $acumtarget_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($nomortahapan_autocomp) && empty($nomortahapan))
      {
          $nomortahapan = $nomortahapan_autocomp;
      }
      if (!empty($ppo_tasktahapan_autocomp) && empty($ppo_tasktahapan))
      {
          $ppo_tasktahapan = $ppo_tasktahapan_autocomp;
      }
      if (!empty($ppo_targethari_autocomp) && empty($ppo_targethari))
      {
          $ppo_targethari = $ppo_targethari_autocomp;
      }
      if (!empty($acumtarget_autocomp) && empty($acumtarget))
      {
          $acumtarget = $acumtarget_autocomp;
      }
      $nomortahapan_cond_salva = $nomortahapan_cond; 
      if (!isset($nomortahapan_input_2) || $nomortahapan_input_2 == "")
      {
          $nomortahapan_input_2 = $nomortahapan;
      }
      $ppo_tasktahapan_cond_salva = $ppo_tasktahapan_cond; 
      if (!isset($ppo_tasktahapan_input_2) || $ppo_tasktahapan_input_2 == "")
      {
          $ppo_tasktahapan_input_2 = $ppo_tasktahapan;
      }
      $ppo_targethari_cond_salva = $ppo_targethari_cond; 
      if (!isset($ppo_targethari_input_2) || $ppo_targethari_input_2 == "")
      {
          $ppo_targethari_input_2 = $ppo_targethari;
      }
      $acumtarget_cond_salva = $acumtarget_cond; 
      if (!isset($acumtarget_input_2) || $acumtarget_input_2 == "")
      {
          $acumtarget_input_2 = $acumtarget;
      }
      if ($ppo_targethari_cond != "in")
      {
          nm_limpa_numero($ppo_targethari, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $ppo_targethari);
          ...
          $ppo_targethari = implode(",", $Nm_sc_valores);
      }
      if ($acumtarget_cond != "in")
      {
          nm_limpa_numero($acumtarget, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $acumtarget);
          foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
          {
              $Nm_sc_valor = trim($Nm_sc_valor);
              nm_limpa_numero($Nm_sc_valor, $_SESSION['scriptcase']['reg_conf']['grup_num']); 
          ...
          $acumtarget = implode(",", $Nm_sc_valores);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca']['nomortahapan'] = $nomortahapan; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca']['nomortahapan_cond'] = $nomortahapan_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca']['ppo_tasktahapan'] = $ppo_tasktahapan; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca']['ppo_tasktahapan_cond'] = $ppo_tasktahapan_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca']['ppo_targethari'] = $ppo_targethari; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca']['ppo_targethari_cond'] = $ppo_targethari_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca']['acumtarget'] = $acumtarget; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca']['acumtarget_cond'] = $acumtarget_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($ppo_targethari_cond != "in" && $ppo_targethari_cond != "bw" && !empty($ppo_targethari) && !is_numeric($ppo_targethari))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : PPO TARGETHARI";
      }
      if ($ppo_targethari_cond == "bw" && ((!empty($ppo_targethari) && !is_numeric($ppo_targethari)) || (!empty($ppo_targethari_input_2) && !is_numeric($ppo_targethari_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : PPO TARGETHARI";
      }
      if ($acumtarget_cond != "in" && $acumtarget_cond != "bw" && !empty($acumtarget) && !is_numeric($acumtarget))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : ACUMTARGET";
      }
      if ($acumtarget_cond == "bw" && ((!empty($acumtarget) && !is_numeric($acumtarget)) || (!empty($acumtarget_input_2) && !is_numeric($acumtarget_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : ACUMTARGET";
      }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nomortahapan'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['nomortahapan'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nomortahapan'] = $nomortahapan;
      }
      $ppo_tasktahapan_look = substr($this->Db->qstr($ppo_tasktahapan), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct PPO_TASKTAHAPAN from " . $this->Ini->nm_tabela . " where PPO_TASKTAHAPAN = '$ppo_tasktahapan_look' order by PPO_TASKTAHAPAN"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['ppo_tasktahapan'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['ppo_tasktahapan'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['ppo_tasktahapan'] = $ppo_tasktahapan;
      }
      $ppo_targethari_look = substr($this->Db->qstr($ppo_targethari), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($ppo_targethari))
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['ppo_targethari'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['ppo_targethari'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['ppo_targethari'] = $ppo_targethari;
      }
      $acumtarget_look = substr($this->Db->qstr($acumtarget), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($acumtarget))
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['acumtarget'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['acumtarget'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['acumtarget'] = $acumtarget;
      }

      //----- $nomortahapan
      $this->Date_part = false;
      if (isset($nomortahapan) || $nomortahapan_cond == "nu" || $nomortahapan_cond == "nn" || $nomortahapan_cond == "ep" || $nomortahapan_cond == "ne")
      {
         $this->monta_condicao("NOMORTAHAPAN", $nomortahapan_cond, $nomortahapan, "", "nomortahapan");
      }

      //----- $ppo_tasktahapan
      $this->Date_part = false;
      if (isset($ppo_tasktahapan) || $ppo_tasktahapan_cond == "nu" || $ppo_tasktahapan_cond == "nn" || $ppo_tasktahapan_cond == "ep" || $ppo_tasktahapan_cond == "ne")
      {
         $this->monta_condicao("PPO_TASKTAHAPAN", $ppo_tasktahapan_cond, $ppo_tasktahapan, "", "ppo_tasktahapan");
      }

      //----- $ppo_targethari
      $this->Date_part = false;
      if (isset($ppo_targethari) || $ppo_targethari_cond == "nu" || $ppo_targethari_cond == "nn" || $ppo_targethari_cond == "ep" || $ppo_targethari_cond == "ne")
      {
         $this->monta_condicao("PPO_TARGETHARI", $ppo_targethari_cond, $ppo_targethari, "", "ppo_targethari");
      }

      //----- $acumtarget
      $this->Date_part = false;
      if (isset($acumtarget) || $acumtarget_cond == "nu" || $acumtarget_cond == "nn" || $acumtarget_cond == "ep" || $acumtarget_cond == "ne")
      {
         $this->monta_condicao("ACUMTARGET", $acumtarget_cond, $acumtarget, "", "acumtarget");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_demo2']['where_pesq_ant'] = $this->comando . $this->comando_fim;
