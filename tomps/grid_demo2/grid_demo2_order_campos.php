<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_demo2_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_demo2_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['nomortahapan'] = "on";
   $tab_def_campos['nomortahapan'] = "NOMORTAHAPAN";
   $tab_converte["NOMORTAHAPAN"]   = "nomortahapan";
   $tab_labels["nomortahapan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_demo2']['labels']["nomortahapan"])) ? $_SESSION['sc_session'][$sc_init]['grid_demo2']['labels']["nomortahapan"] : "NOMORTAHAPAN";
   ...
   $tab_labels["ppo_tasktahapan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_demo2']['labels']["ppo_tasktahapan"])) ? $_SESSION['sc_session'][$sc_init]['grid_demo2']['labels']["ppo_tasktahapan"] : "PPO TASKTAHAPAN";
   $tab_ger_campos['ppo_targethari'] = "on";
   $tab_def_campos['ppo_targethari'] = "PPO_TARGETHARI";
   $tab_converte["PPO_TARGETHARI"]   = "ppo_targethari";
   $tab_labels["ppo_targethari"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_demo2']['labels']["ppo_targethari"])) ? $_SESSION['sc_session'][$sc_init]['grid_demo2']['labels']["ppo_targethari"] : "PPO TARGETHARI";
   $tab_ger_campos['acumtarget'] = "on";
   $tab_def_campos['acumtarget'] = "ACUMTARGET";
   $tab_converte["ACUMTARGET"]   = "acumtarget";
   $tab_labels["acumtarget"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_demo2']['labels']["acumtarget"])) ? $_SESSION['sc_session'][$sc_init]['grid_demo2']['labels']["acumtarget"] : "ACUMTARGET";
   $tab_ger_campos['ppo_realaktual'] = "on";
   $tab_def_campos['ppo_realaktual'] = "PPO_REALAKTUAL";
   $tab_converte["PPO_REALAKTUAL"]   = "ppo_realaktual";
   $tab_labels["ppo_realaktual"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_demo2']['labels']["ppo_realaktual"])) ? $_SESSION['sc_session'][$sc_init]['grid_demo2']['labels']["ppo_realaktual"] : "PPO REALAKTUAL";
   $tab_ger_campos['acumreal'] = "on";
   $tab_def_campos['acumreal'] = "ACUMREAL";
   $tab_converte["ACUMREAL"]   = "acumreal";
   $tab_labels["acumreal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_demo2']['labels']["acumreal"])) ? $_SESSION['sc_session'][$sc_init]['grid_demo2']['labels']["acumreal"] : "ACUMREAL";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_demo2']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_demo2']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_demo2']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_demo2']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_demo2']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_demo2']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_demo2']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_demo2']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_demo2']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - demo2</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_demo2_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_demo2']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_demo2']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
