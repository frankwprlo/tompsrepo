...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "ppo_targethari";$Nm_numeric[] = "acumtarget";$Nm_numeric[] = "ppo_realaktual";$Nm_numeric[] = "acumreal";$Nm_numeric[] = "ppo_targethari";$Nm_numeric[] = "acumtarget";$Nm_numeric[] = "ppo_realaktual";$Nm_numeric[] = "acumreal";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_nomortahapan"  <?php echo $str_hide_nomortahapan?>><?php
      if ($nomortahapan != "")
      {
      $nomortahapan_look = substr($this->Db->qstr($nomortahapan), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_ppo_tasktahapan"  <?php echo $str_hide_ppo_tasktahapan?>><?php
      if ($ppo_tasktahapan != "")
      {
      $ppo_tasktahapan_look = substr($this->Db->qstr($ppo_tasktahapan), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_ppo_targethari"  <?php echo $str_hide_ppo_targethari?>><?php
      if ($ppo_targethari != "")
      {
      $ppo_targethari_look = substr($this->Db->qstr($ppo_targethari), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_acumtarget"  <?php echo $str_hide_acumtarget?>><?php
      if ($acumtarget != "")
      {
      $acumtarget_look = substr($this->Db->qstr($acumtarget), 1, -1); 
      $nmgp_def_dados = array(); 
