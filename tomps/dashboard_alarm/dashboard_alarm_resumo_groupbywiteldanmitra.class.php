...
class dashboard_alarm_resumo
{
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_tp_datel;
   var $array_total_tp_mitra;
   ...
   var $sc_proc_quebra_tp_mitra;
   var $count_tp_mitra;
   var $cnt_tp_mitra_tp_id;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_tp_datel = array();
      $this->array_total_tp_mitra = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['dashboard_info']['under_dashboard'] ? "off" : "on";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['dashboard_alarm'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['dashboard_alarm'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['dashboard_alarm']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['dashboard_alarm']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['dashboard_alarm']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['contr_total_geral'] == "OK")
      {
          $this->array_total_tp_datel = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['arr_total']['tp_datel'];
          $this->array_total_tp_mitra = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['arr_total']['tp_mitra'];
      }
      else
      {
          $this->array_total_tp_datel = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['arr_total']['tp_datel'] = $this->array_total_tp_datel;
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['arr_total']['tp_mitra'] = $this->array_total_tp_mitra;
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $Lab_tp_datel = "TP DATEL";
       $Lab_tp_mitra = "TP MITRA";
       $this->comp_field = array(
           $Lab_tp_datel,
           $Lab_tp_mitra,
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['summarizing_fields_order']['groupbywiteldanmitra']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['summarizing_fields_order']['groupbywiteldanmitra'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['summarizing_fields_order']['groupbywiteldanmitra'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['summarizing_fields_display']['groupbywiteldanmitra'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['summarizing_fields_display']['groupbywiteldanmitra'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['summarizing_fields_display']['groupbywiteldanmitra'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['summarizing_fields_display']['groupbywiteldanmitra'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['summarizing_fields_display']['groupbywiteldanmitra'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['summarizing_fields_display']['groupbywiteldanmitra'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['summarizing_fields_display']['groupbywiteldanmitra'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_tp_datel as $i_tp_datel => $d_tp_datel) {
           if (!in_array($i_tp_datel, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_tp_datel[3] ] = $d_tp_datel[2];
               $this->comp_label[0][ $d_tp_datel[3] ] = $d_tp_datel[2];
           }
           foreach ($this->array_total_tp_mitra[$i_tp_datel] as $i_tp_mitra => $d_tp_mitra) {
               if (!in_array($i_tp_mitra, $this->comp_label[1][ $d_tp_datel[3] ], true)) {
                   $this->comp_index[1][ $d_tp_mitra[3] ] = $d_tp_mitra[2];
                   $this->comp_label[1][ $d_tp_datel[3] ][ $d_tp_mitra[3] ] = $d_tp_mitra[2];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'tp_datel', 'prot' => ''),
           array('name' => 'tp_mitra', 'prot' => ''),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_tp_datel => $l_tp_datel) {
           if (isset($this->array_total_tp_datel[$i_tp_datel])) {
               $this->comp_group[$i_tp_datel] = array();
           }
           foreach ($this->comp_label[1][$i_tp_datel] as $i_tp_mitra => $l_tp_mitra) {
               if (isset($this->array_total_tp_mitra[$i_tp_datel][$i_tp_mitra])) {
                   $this->comp_group[$i_tp_datel][$i_tp_mitra] = array();
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_tp_datel;
       }
       elseif (1 == $level) {
           $return = $this->array_total_tp_mitra;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@dashboard_alarm@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_order_start'][$iYAxysIndex])
                       {
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['dashboard_alarm']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['dashboard_alarm']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['dashboard_alarm']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['dashboard_alarm']) . "_";
               } 
           }
       }
   ...
   {
      global $nm_saida;
      $res_sem_reg = "hanya menampilkan project yg target penyelesaiannya < 8 hari dari tanggal sekarang!"; 
      $nm_saida->saida("  <TR id=\"summary_body\">\r\n");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['ajax_nav'])
      { 
          $_SESSION['scriptcase']['saida_html'] = "";
      } 
      $nm_saida->saida("   <TD class=\"scGridFieldOdd scGridFieldOddFont\" align=\"center\" style=\"vertical-align: top;font-family:" . $this->Ini->texto_fonte_tipo_impar . ";font-size:12px;color:#FF3300;\">\r\n");
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "dashboard_alarm_total.class.php"); 
      }
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['print_all'];
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['opcao'] = "print";
      ...
      $this->Total   = new dashboard_alarm_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_tp_datel);
      ksort($this->array_total_tp_mitra);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>Alarm</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"dashboard_alarm_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"dashboard_alarm_jquery.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_dashboard_alarm_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_dashboard_alarm_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_dashboard_alarm_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['num_css'] . '.css');
     ...
     else
     {
      ...
      $nm_saida->saida(" </style>\r\n");
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "dashboard_alarm/dashboard_alarm_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "dashboard_alarm/dashboard_alarm_config_print.php?nm_opc=resumo&nm_cor=AM&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $NM_btn = false;
         if (is_file("dashboard_alarm_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("dashboard_alarm_help.txt"); 
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'dashboard_alarm_config_pivot.php?nome_apl=dashboard_alarm&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"dashboard_alarm_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("</form> \r\n");
      ...
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['dashboard_alarm_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@dashboard_alarm@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
      $nm_saida->saida("  if (\"pdf_res\" == x)\r\n");
      $nm_saida->saida("  {\r\n");
      $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "dashboard_alarm/dashboard_alarm_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_create_charts=\" + crt + \"&sc_graf_pdf=\" + g;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_dashboard_alarm_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "dashboard_alarm/dashboard_alarm_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['print_all'];
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pdf_res'])
       {
           $nm_saida->saida("<TR>\r\n");
           $nm_saida->saida("<TD style=\"padding: 0px\">\r\n");
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['cond_pesq'], 0, $trab_pos);
   ...
   //---- 
   function adiciona_registro($cnt_tp_id, $quebra_tp_datel, $quebra_tp_mitra, $quebra_tp_datel_orig, $quebra_tp_mitra_orig)
   {
      //----- TP DATEL
      if (!isset($this->array_total_tp_datel[$quebra_tp_datel_orig]))
      {
         $this->array_total_tp_datel[$quebra_tp_datel_orig][0] = 1;
         $this->array_total_tp_datel[$quebra_tp_datel_orig][1] = 1;
         $this->array_total_tp_datel[$quebra_tp_datel_orig][2] = $quebra_tp_datel;
         $this->array_total_tp_datel[$quebra_tp_datel_orig][3] = $quebra_tp_datel_orig;
      }
      else
      {
         $this->array_total_tp_datel[$quebra_tp_datel_orig][0]++;
         $this->array_total_tp_datel[$quebra_tp_datel_orig][1] ++;
      }
      //----- TP MITRA
      if (!isset($this->array_total_tp_mitra[$quebra_tp_datel_orig][$quebra_tp_mitra_orig]))
      {
         $this->array_total_tp_mitra[$quebra_tp_datel_orig][$quebra_tp_mitra_orig][0] = 1;
         $this->array_total_tp_mitra[$quebra_tp_datel_orig][$quebra_tp_mitra_orig][1] = 1;
         $this->array_total_tp_mitra[$quebra_tp_datel_orig][$quebra_tp_mitra_orig][2] = $quebra_tp_mitra;
         $this->array_total_tp_mitra[$quebra_tp_datel_orig][$quebra_tp_mitra_orig][3] = $quebra_tp_mitra_orig;
      }
      else
      {
         $this->array_total_tp_mitra[$quebra_tp_datel_orig][$quebra_tp_mitra_orig][0]++;
         $this->array_total_tp_mitra[$quebra_tp_datel_orig][$quebra_tp_mitra_orig][1] ++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'tp_datel');
     $campos_order = $this->Ini->Get_date_order_groupby("TP_DATEL", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'tp_mitra');
     $campos_order = $this->Ini->Get_date_order_groupby("TP_MITRA", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->tp_mitra = $rs_res->fields[1] ;  
            $this->tp_odp = $rs_res->fields[2] ;  
            $this->tp_planstart = $rs_res->fields[3] ;  
            $this->tp_planfinish = $rs_res->fields[4] ;  
            $this->tp_divre = $rs_res->fields[5] ;  
            $this->tp_witel = $rs_res->fields[6] ;  
            $this->tp_datel = $rs_res->fields[7] ;  
            $this->tglsekarang = $rs_res->fields[8] ;  
            $this->sisawaktu = $rs_res->fields[9] ;  
            $this->tp_datel_orig = $this->tp_datel;
            $this->tp_mitra_orig = $this->tp_mitra;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->tp_id, $this->tp_datel, $this->tp_mitra, $this->tp_datel_orig,  $this->tp_mitra_orig);
            }
   }
//
