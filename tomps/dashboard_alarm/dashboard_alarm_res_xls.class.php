...
class dashboard_alarm_res_xls
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "dashboard_alarm.xls";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['xls_name']);
      }
   ...
   function grava_arquivo()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['pivot_group_by'];
      ...
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['arr_export']['data'];
      $b_display = false;
      $contr_rowspan = array();
      $contr_colspan = array();
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_alarm']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE>List Project Alarm Lokasi Witel <?php echo $_SESSION['kodewitel'] ?>  :: Excel</TITLE>
