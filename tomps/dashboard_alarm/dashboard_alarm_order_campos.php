<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new dashboard_alarm_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class dashboard_alarm_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["tp_id"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_alarm']['labels']["tp_id"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_alarm']['labels']["tp_id"] : "TP ID";
   $tab_ger_campos['tp_mitra'] = "on";
   $tab_def_campos['tp_mitra'] = "TP_MITRA";
   $tab_converte["TP_MITRA"]   = "tp_mitra";
   $tab_labels["tp_mitra"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_alarm']['labels']["tp_mitra"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_alarm']['labels']["tp_mitra"] : "TP MITRA";
   $tab_ger_campos['tp_odp'] = "on";
   $tab_def_campos['tp_odp'] = "TP_ODP";
   $tab_converte["TP_ODP"]   = "tp_odp";
   $tab_labels["tp_odp"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_alarm']['labels']["tp_odp"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_alarm']['labels']["tp_odp"] : "TP ODP";
   $tab_ger_campos['tp_planstart'] = "on";
   $tab_def_campos['tp_planstart'] = "TP_PLANSTART";
   $tab_converte["TP_PLANSTART"]   = "tp_planstart";
   $tab_labels["tp_planstart"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_alarm']['labels']["tp_planstart"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_alarm']['labels']["tp_planstart"] : "TP PLANSTART";
   $tab_ger_campos['tp_planfinish'] = "on";
   $tab_def_campos['tp_planfinish'] = "TP_PLANFINISH";
   $tab_converte["TP_PLANFINISH"]   = "tp_planfinish";
   $tab_labels["tp_planfinish"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_alarm']['labels']["tp_planfinish"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_alarm']['labels']["tp_planfinish"] : "TP PLANFINISH";
   $tab_ger_campos['tp_divre'] = "on";
   $tab_def_campos['tp_divre'] = "TP_DIVRE";
   $tab_converte["TP_DIVRE"]   = "tp_divre";
   $tab_labels["tp_divre"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_alarm']['labels']["tp_divre"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_alarm']['labels']["tp_divre"] : "TP DIVRE";
   $tab_ger_campos['tp_witel'] = "on";
   $tab_def_campos['tp_witel'] = "TP_WITEL";
   $tab_converte["TP_WITEL"]   = "tp_witel";
   $tab_labels["tp_witel"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_alarm']['labels']["tp_witel"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_alarm']['labels']["tp_witel"] : "TP WITEL";
   $tab_ger_campos['tp_datel'] = "on";
   $tab_def_campos['tp_datel'] = "TP_DATEL";
   $tab_converte["TP_DATEL"]   = "tp_datel";
   $tab_labels["tp_datel"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_alarm']['labels']["tp_datel"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_alarm']['labels']["tp_datel"] : "TP DATEL";
   $tab_ger_campos['tglsekarang'] = "on";
   $tab_def_campos['tglsekarang'] = "TGLSEKARANG";
   $tab_converte["TGLSEKARANG"]   = "tglsekarang";
   $tab_labels["tglsekarang"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_alarm']['labels']["tglsekarang"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_alarm']['labels']["tglsekarang"] : "TGLSEKARANG";
   $tab_ger_campos['sisawaktu'] = "on";
   $tab_def_campos['sisawaktu'] = "SISAWAKTU";
   $tab_converte["SISAWAKTU"]   = "sisawaktu";
   $tab_labels["sisawaktu"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_alarm']['labels']["sisawaktu"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_alarm']['labels']["sisawaktu"] : "SISAWAKTU";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['dashboard_alarm']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['dashboard_alarm']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['dashboard_alarm']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['dashboard_alarm']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['dashboard_alarm']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['dashboard_alarm']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['dashboard_alarm']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['dashboard_alarm']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['dashboard_alarm']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE>List Project Alarm Lokasi Witel <?php echo $_SESSION['kodewitel'] ?> </TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "dashboard_alarm_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['dashboard_alarm']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['dashboard_alarm']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
