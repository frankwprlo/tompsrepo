...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["projectamo_____dashboard_alarm"]))
   {
      unset($_SESSION['session_sec_aplicacao']["projectamo_____dashboard_alarm"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['dashboard_alarm']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['dashboard_alarm']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['dashboard_alarm']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['dashboard_alarm']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['dashboard_alarm']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['dashboard_alarm']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['dashboard_alarm']['embutida_filho'] as $ind => $sc_init)
          {
