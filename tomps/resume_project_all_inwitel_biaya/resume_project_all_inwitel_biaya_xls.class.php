...
class resume_project_all_inwitel_biaya_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= "_resume_project_all_inwitel_biaya";
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "resume_project_all_inwitel_biaya.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['order_grid'];
...
$_SESSION['scriptcase']['resume_project_all_inwitel_biaya']['contr_erro'] = 'off'; 
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya'][$path_doc_md5][1] = $this->Tit_doc;
?>
