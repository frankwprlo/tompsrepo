...
TestComm",
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['summarizing_fields_order']['gbmitra']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['summarizing_fields_order']['gbmitra'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['summarizing_fields_order']['gbmitra'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['summarizing_fields_display']['gbmitra'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['summarizing_fields_display']['gbmitra'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['summarizing_fields_display']['gbmitra'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['summarizing_fields_display']['gbmitra'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['summarizing_fields_display']['gbmitra'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['summarizing_fields_display']['gbmitra'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['summarizing_fields_display']['gbmitra'] as $i_sum => $d_sum)
           {
...
//--- 
   ...
   function compat_arrays()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['arr_total']['statusname'] as $campo_statusname => $dados_statusname)
      {
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['arr_total']['tm_namamitra'][$campo_statusname] as $campo_tm_namamitra => $dados_tm_namamitra)
         {
            $this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][4] = $dados_tm_namamitra[1];
            $this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][3] = $dados_tm_namamitra[2];
            $this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][2] = $dados_tm_namamitra[3];
