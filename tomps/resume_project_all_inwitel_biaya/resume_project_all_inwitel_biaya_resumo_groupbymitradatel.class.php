...
class resume_project_all_inwitel_biaya_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_statusname = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['arr_total']['statusname'];
          $this->array_total_md_namadatel = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['arr_total']['md_namadatel'];
...
TestComm",
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['summarizing_fields_order']['groupbymitradatel']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['summarizing_fields_order']['groupbymitradatel'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['summarizing_fields_order']['groupbymitradatel'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['summarizing_fields_display']['groupbymitradatel'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['summarizing_fields_display']['groupbymitradatel'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['summarizing_fields_display']['groupbymitradatel'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['summarizing_fields_display']['groupbymitradatel'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['summarizing_fields_display']['groupbymitradatel'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['summarizing_fields_display']['groupbymitradatel'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['summarizing_fields_display']['groupbymitradatel'] as $i_sum => $d_sum)
           {
...
//--- 
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['arr_total']['statusname'] as $campo_statusname => $dados_statusname)
      {
         $this->array_total_statusname[$campo_statusname][4] = $dados_statusname[1];
         $this->array_total_statusname[$campo_statusname][3] = $dados_statusname[2];
         $this->array_total_statusname[$campo_statusname][2] = $dados_statusname[3];
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['arr_total']['md_namadatel'][$campo_statusname] as $campo_md_namadatel => $dados_md_namadatel)
         {
            $this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][4] = $dados_md_namadatel[1];
            $this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][3] = $dados_md_namadatel[2];
            $this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][2] = $dados_md_namadatel[3];
            ...
            foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['arr_total']['tm_namamitra'][$campo_statusname][$campo_md_namadatel] as $campo_tm_namamitra => $dados_tm_namamitra)
            {
               $this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][4] = $dados_tm_namamitra[1];
               $this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][3] = $dados_tm_namamitra[2];
               $this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][2] = $dados_tm_namamitra[3];
...
$_SESSION['scriptcase']['resume_project_all_inwitel_biaya']['contr_erro'] = 'off';
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['arr_total']['statusname'] = $this->array_total_statusname;
          $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel_biaya']['arr_total']['md_namadatel'] = $this->array_total_md_namadatel;
