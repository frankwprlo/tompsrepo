...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_tp_prjtrelease"  <?php echo $str_hide_tp_prjtrelease?>><?php
      if ($tp_prjtrelease != "")
      {
      $tp_prjtrelease_look = substr($this->Db->qstr($tp_prjtrelease), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_tp_datel"  <?php echo $str_hide_tp_datel?>><?php
      if ($tp_datel != "")
      {
      $tp_datel_look = substr($this->Db->qstr($tp_datel), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_tp_mitra"  <?php echo $str_hide_tp_mitra?>><?php
      if ($tp_mitra != "")
      {
      $tp_mitra_look = substr($this->Db->qstr($tp_mitra), 1, -1); 
      $nmgp_def_dados = array(); 
