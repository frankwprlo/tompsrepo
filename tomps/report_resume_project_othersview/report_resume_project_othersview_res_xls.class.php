...
class report_resume_project_othersview_res_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function grava_arquivo()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_group_by'];
      ...
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['arr_export']['data'];
      $b_display = false;
      $contr_rowspan = array();
      $contr_colspan = array();
