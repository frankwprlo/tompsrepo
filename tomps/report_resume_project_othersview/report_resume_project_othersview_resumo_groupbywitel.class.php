...
class report_resume_project_othersview_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_ketstatustask   = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['contr_total_geral'] == "OK")
      {
          $this->array_total_ketstatustask = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['arr_total']['ketstatustask'];
          $this->array_total_tp_witel = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['arr_total']['tp_witel'];
          $this->array_total_tp_tahapanaktif = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['arr_total']['tp_tahapanaktif'];
          $this->array_total_grouptaskaktif = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['arr_total']['grouptaskaktif'];
      }
      else
      {
          $this->array_total_ketstatustask = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['arr_total']['ketstatustask'] = $this->array_total_ketstatustask;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['arr_total']['tp_witel'] = $this->array_total_tp_witel;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['arr_total']['tp_tahapanaktif'] = $this->array_total_tp_tahapanaktif;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['arr_total']['grouptaskaktif'] = $this->array_total_grouptaskaktif;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $Lab_ketstatustask = "KETSTATUSTASK";
       $Lab_tp_witel = "TP WITEL";
       $Lab_tp_tahapanaktif = "TP TAHAPANAKTIF";
       $Lab_grouptaskaktif = "GROUPTASKAKTIF";
       $this->comp_field = array(
           $Lab_ketstatustask,
           $Lab_tp_witel,
           $Lab_tp_tahapanaktif,
       ...
       //-----
       $this->comp_sum = array(
           2 => "TP IDLOP (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['summarizing_fields_order']['groupbywitel']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['summarizing_fields_order']['groupbywitel'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['summarizing_fields_order']['groupbywitel'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['summarizing_fields_display']['groupbywitel'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['summarizing_fields_display']['groupbywitel'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['summarizing_fields_display']['groupbywitel'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['summarizing_fields_display']['groupbywitel'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['summarizing_fields_display']['groupbywitel'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['summarizing_fields_display']['groupbywitel'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['summarizing_fields_display']['groupbywitel'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "tp_idlop", 'show' => true),
       );
       ...
       //-----
       foreach ($this->array_total_ketstatustask as $i_ketstatustask => $d_ketstatustask) {
           if (!in_array($i_ketstatustask, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_ketstatustask[3] ] = $d_ketstatustask[2];
               $this->comp_label[0][ $d_ketstatustask[3] ] = $d_ketstatustask[2];
           }
           foreach ($this->array_total_tp_witel[$i_ketstatustask] as $i_tp_witel => $d_tp_witel) {
               if (!in_array($i_tp_witel, $this->comp_label[1][ $d_ketstatustask[3] ], true)) {
                   $this->comp_index[1][ $d_tp_witel[3] ] = $d_tp_witel[2];
                   $this->comp_label[1][ $d_ketstatustask[3] ][ $d_tp_witel[3] ] = $d_tp_witel[2];
               }
               foreach ($this->array_total_tp_tahapanaktif[$i_ketstatustask][$i_tp_witel] as $i_tp_tahapanaktif => $d_tp_tahapanaktif) {
                   if (!in_array($i_tp_tahapanaktif, $this->comp_label[2][ $d_ketstatustask[3] ][ $d_tp_witel[3] ], true)) {
                       $this->comp_index[2][ $d_tp_tahapanaktif[3] ] = $d_tp_tahapanaktif[2];
                       $this->comp_label[2][ $d_ketstatustask[3] ][ $d_tp_witel[3] ][ $d_tp_tahapanaktif[3] ] = $d_tp_tahapanaktif[2];
                   }
                   foreach ($this->array_total_grouptaskaktif[$i_ketstatustask][$i_tp_witel][$i_tp_tahapanaktif] as $i_grouptaskaktif => $d_grouptaskaktif) {
                       if (!in_array($i_grouptaskaktif, $this->comp_label[3][ $d_ketstatustask[3] ][ $d_tp_witel[3] ][ $d_tp_tahapanaktif[3] ], true)) {
                           $this->comp_index[3][ $d_grouptaskaktif[3] ] = $d_grouptaskaktif[2];
                           $this->comp_label[3][ $d_ketstatustask[3] ][ $d_tp_witel[3] ][ $d_tp_tahapanaktif[3] ][ $d_grouptaskaktif[3] ] = $d_grouptaskaktif[2];
                       }
                   }
               }
           }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'ketstatustask', 'prot' => '@aspass@'),
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_ketstatustask => $l_ketstatustask) {
           if (isset($this->array_total_ketstatustask[$i_ketstatustask])) {
               $this->comp_group[$i_ketstatustask] = array();
           }
           foreach ($this->comp_label[1][$i_ketstatustask] as $i_tp_witel => $l_tp_witel) {
               if (isset($this->array_total_tp_witel[$i_ketstatustask][$i_tp_witel])) {
                   $this->comp_group[$i_ketstatustask][$i_tp_witel] = array();
               }
               foreach ($this->comp_label[2][$i_ketstatustask][$i_tp_witel] as $i_tp_tahapanaktif => $l_tp_tahapanaktif) {
                   if (isset($this->array_total_tp_tahapanaktif[$i_ketstatustask][$i_tp_witel][$i_tp_tahapanaktif])) {
                       $this->comp_group[$i_ketstatustask][$i_tp_witel][$i_tp_tahapanaktif] = array();
                   }
                   foreach ($this->comp_label[3][$i_ketstatustask][$i_tp_witel][$i_tp_tahapanaktif] as $i_grouptaskaktif => $l_grouptaskaktif) {
                       if (isset($this->array_total_grouptaskaktif[$i_ketstatustask][$i_tp_witel][$i_tp_tahapanaktif][$i_grouptaskaktif])) {
                           $this->comp_group[$i_ketstatustask][$i_tp_witel][$i_tp_tahapanaktif][$i_grouptaskaktif] = array();
                       }
                   }
               }
           }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_ketstatustask;
       }
       elseif (1 == $level) {
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@report_resume_project_othersview@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['pivot_order_start'][$iYAxysIndex])
                       {
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "report_resume_project_othersview_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['opcao'] = "print";
      ...
      $this->Total   = new report_resume_project_othersview_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_ketstatustask);
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['responsive_chart']['active']) {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_report_resume_project_othersview_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_report_resume_project_othersview_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_report_resume_project_othersview_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['num_css'] . '.css');
     ...
     else
     {
      ...
      $nm_saida->saida(" </style>\r\n");
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "report_resume_project_othersview/report_resume_project_othersview_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpesquisa", "", "", "Rpesq_top", "", "Filter Data", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "report_resume_project_othersview/report_resume_project_othersview.php?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&nmgp_opcao=busca&nmgp_orig_pesq=res&KeepThis=true&TB_iframe=true&height=0&width=0&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
         $nm_saida->saida("     </TD> \r\n");
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "report_resume_project_othersview/report_resume_project_othersview_config_print.php?nm_opc=resumo&nm_cor=AM&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
         $nm_saida->saida("     </TD> \r\n");
         $nm_saida->saida("     <TD class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"right\">\r\n");
         $NM_btn = false;
         if (is_file("report_resume_project_othersview_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'report_resume_project_othersview_config_pivot.php?nome_apl=report_resume_project_othersview&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"report_resume_project_othersview_iframe_prt.php\" \r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_report_resume_project_othersview_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "report_resume_project_othersview/report_resume_project_othersview_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $tp_planfinish_2 = $Busca_temp['tp_planfinish_input_2']; 
          $tp_divre = $Busca_temp['tp_divre']; 
          $tmp_pos = strpos($tp_divre, "##@@");
          if ($tmp_pos !== false && !is_array($tp_divre))
          {
   ...
   function monta_rodape()
   {
      ...
      $nm_cab_filtro   = ""; 
      $nm_cab_filtrobr = ""; 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['campos_busca']))
      { 
        $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project_othersview']['campos_busca'];
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
   ...
   //---- 
   function adiciona_registro($cnt_tp_idlop, $quebra_ketstatustask, $quebra_tp_witel, $quebra_tp_tahapanaktif, $quebra_grouptaskaktif, $quebra_ketstatustask_orig, $quebra_tp_witel_orig, $quebra_tp_tahapanaktif_orig, $quebra_grouptaskaktif_orig)
   {
      //----- KETSTATUSTASK
      if (!isset($this->array_total_ketstatustask[$quebra_ketstatustask_orig]))
      {
         $this->array_total_ketstatustask[$quebra_ketstatustask_orig][0] = 1;
         $this->array_total_ketstatustask[$quebra_ketstatustask_orig][1] = 1;
         $this->array_total_ketstatustask[$quebra_ketstatustask_orig][2] = $quebra_ketstatustask;
         $this->array_total_ketstatustask[$quebra_ketstatustask_orig][3] = $quebra_ketstatustask_orig;
      }
      else
      {
         $this->array_total_ketstatustask[$quebra_ketstatustask_orig][0]++;
         $this->array_total_ketstatustask[$quebra_ketstatustask_orig][1] ++;
      }
      //----- Witel
      if (!isset($this->array_total_tp_witel[$quebra_ketstatustask_orig][$quebra_tp_witel_orig]))
      {
         $this->array_total_tp_witel[$quebra_ketstatustask_orig][$quebra_tp_witel_orig][0] = 1;
         $this->array_total_tp_witel[$quebra_ketstatustask_orig][$quebra_tp_witel_orig][1] = 1;
         $this->array_total_tp_witel[$quebra_ketstatustask_orig][$quebra_tp_witel_orig][2] = $quebra_tp_witel;
         $this->array_total_tp_witel[$quebra_ketstatustask_orig][$quebra_tp_witel_orig][3] = $quebra_tp_witel_orig;
      }
      else
      {
         $this->array_total_tp_witel[$quebra_ketstatustask_orig][$quebra_tp_witel_orig][0]++;
         $this->array_total_tp_witel[$quebra_ketstatustask_orig][$quebra_tp_witel_orig][1] ++;
      }
      //----- TP TAHAPANAKTIF
      if (!isset($this->array_total_tp_tahapanaktif[$quebra_ketstatustask_orig][$quebra_tp_witel_orig][$quebra_tp_tahapanaktif_orig]))
      {
         $this->array_total_tp_tahapanaktif[$quebra_ketstatustask_orig][$quebra_tp_witel_orig][$quebra_tp_tahapanaktif_orig][0] = 1;
         $this->array_total_tp_tahapanaktif[$quebra_ketstatustask_orig][$quebra_tp_witel_orig][$quebra_tp_tahapanaktif_orig][1] = 1;
         $this->array_total_tp_tahapanaktif[$quebra_ketstatustask_orig][$quebra_tp_witel_orig][$quebra_tp_tahapanaktif_orig][2] = $quebra_tp_tahapanaktif;
         $this->array_total_tp_tahapanaktif[$quebra_ketstatustask_orig][$quebra_tp_witel_orig][$quebra_tp_tahapanaktif_orig][3] = $quebra_tp_tahapanaktif_orig;
      }
      else
      {
         $this->array_total_tp_tahapanaktif[$quebra_ketstatustask_orig][$quebra_tp_witel_orig][$quebra_tp_tahapanaktif_orig][0]++;
         $this->array_total_tp_tahapanaktif[$quebra_ketstatustask_orig][$quebra_tp_witel_orig][$quebra_tp_tahapanaktif_orig][1] ++;
      }
      //----- GROUPTASKAKTIF
      if (!isset($this->array_total_grouptaskaktif[$quebra_ketstatustask_orig][$quebra_tp_witel_orig][$quebra_tp_tahapanaktif_orig][$quebra_grouptaskaktif_orig]))
      {
         $this->array_total_grouptaskaktif[$quebra_ketstatustask_orig][$quebra_tp_witel_orig][$quebra_tp_tahapanaktif_orig][$quebra_grouptaskaktif_orig][0] = 1;
         $this->array_total_grouptaskaktif[$quebra_ketstatustask_orig][$quebra_tp_witel_orig][$quebra_tp_tahapanaktif_orig][$quebra_grouptaskaktif_orig][1] = 1;
         $this->array_total_grouptaskaktif[$quebra_ketstatustask_orig][$quebra_tp_witel_orig][$quebra_tp_tahapanaktif_orig][$quebra_grouptaskaktif_orig][2] = $quebra_grouptaskaktif;
         $this->array_total_grouptaskaktif[$quebra_ketstatustask_orig][$quebra_tp_witel_orig][$quebra_tp_tahapanaktif_orig][$quebra_grouptaskaktif_orig][3] = $quebra_grouptaskaktif_orig;
      }
      else
      {
         $this->array_total_grouptaskaktif[$quebra_ketstatustask_orig][$quebra_tp_witel_orig][$quebra_tp_tahapanaktif_orig][$quebra_grouptaskaktif_orig][0]++;
         $this->array_total_grouptaskaktif[$quebra_ketstatustask_orig][$quebra_tp_witel_orig][$quebra_tp_tahapanaktif_orig][$quebra_grouptaskaktif_orig][1] ++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'ketstatustask');
     $campos_order = $this->Ini->Get_date_order_groupby("KETSTATUSTASK", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->tp_id = $rs_res->fields[1] ;  
            $this->tp_batch = $rs_res->fields[2] ;  
            $this->tp_projectname = $rs_res->fields[3] ;  
            $this->tp_lokasi = $rs_res->fields[4] ;  
            $this->tp_mitra = $rs_res->fields[5] ;  
            $this->tp_witel = $rs_res->fields[6] ;  
            $this->tp_sto = $rs_res->fields[7] ;  
            $this->tp_odp = $rs_res->fields[8] ;  
            $this->tp_planstart = $rs_res->fields[9] ;  
            $this->tp_planfinish = $rs_res->fields[10] ;  
            $this->tp_summary = $rs_res->fields[11] ;  
            $this->tp_status = $rs_res->fields[12] ;  
            $this->tp_actualstart = $rs_res->fields[13] ;  
            $this->tp_actualfinish = $rs_res->fields[14] ;  
            $this->tp_templateproject = $rs_res->fields[15] ;  
            $this->tp_jenisproject = $rs_res->fields[16] ;  
            $this->tp_prjtrelease = $rs_res->fields[17] ;  
            $this->tp_targetwaktu = $rs_res->fields[18] ;  
            $this->tp_datel = $rs_res->fields[19] ;  
            $this->tp_nokontrak = $rs_res->fields[20] ;  
            $this->tp_ponumber = $rs_res->fields[21] ;  
            $this->tp_divre = $rs_res->fields[22] ;  
            $this->tp_idlop = $rs_res->fields[23] ;  
            $this->tp_namalop = $rs_res->fields[24] ;  
            $this->tp_nilai = $rs_res->fields[25] ;  
            $this->tp_nilai =  str_replace(",", ".", $this->tp_nilai);
            $this->tp_rab = $rs_res->fields[26] ;  
            $this->tp_rab =  str_replace(",", ".", $this->tp_rab);
            $this->tp_jmldistribusi = $rs_res->fields[27] ;  
            $this->tp_prosentase = $rs_res->fields[28] ;  
            $this->tp_prosentase =  str_replace(",", ".", $this->tp_prosentase);
            $this->grouptaskaktif = $rs_res->fields[29] ;  
            $this->ketstatustask = $rs_res->fields[30] ;  
            $this->ketselesaiproject = $rs_res->fields[31] ;  
            $this->tp_tahapanaktif = $rs_res->fields[32] ;  
            $this->ketstatustask_orig = $this->ketstatustask;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->tp_idlop, $this->ketstatustask, $this->tp_witel, $this->tp_tahapanaktif, $this->grouptaskaktif, $this->ketstatustask_orig,  $this->tp_witel_orig,  $this->tp_tahapanaktif_orig,  $this->grouptaskaktif_orig);
            }
   }
//
