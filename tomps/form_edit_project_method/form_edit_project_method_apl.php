<?php
//
class form_edit_project_method_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_edit_project_method']['nm_run_menu'] = 1;
      } 
      if (isset($_SESSION['sc_session'][$script_case_init]['form_edit_project_method']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_edit_project_method']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_edit_project_method']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_edit_project_method']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_edit_project_method']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_edit_project_method']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->idwitel)) 
          {
              $_SESSION['idwitel'] = $this->idwitel;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_edit_project_method']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_edit_project_method']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_edit_project_method']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_edit_project_method']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_edit_project_method']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_edit_project_method']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_edit_project_method']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_edit_project_method']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_edit_project_method_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("en_us");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_edit_project_method']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_edit_project_method']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_edit_project_method'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_edit_project_method']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_edit_project_method']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_edit_project_method') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_edit_project_method']['label'] = "Form Update Data Proyek";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_edit_project_method")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_edit_project_method']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_edit_project_method'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_edit_project_method']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_form_insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_edit_project_method'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_edit_project_method'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_edit_project_method/form_edit_project_method_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_edit_project_method_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_edit_project_method_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_edit_project_method_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_edit_project_method/form_edit_project_method_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_edit_project_method_erro.class.php"); 
      }
      $this->Erro      = new form_edit_project_method_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['opcao']))
         { 
             if ($this->tp_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_edit_project_method']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['sc_redir_atualiz'] == "ok")
          {
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_edit_project_method']) || !is_array($this->NM_ajax_info['errList']['geral_form_edit_project_method']))
              {
                  $this->NM_ajax_info['errList']['geral_form_edit_project_method'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_edit_project_method'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    {
        global $teste_validade;
               if (!empty($this->tp_thn_release) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_thn_release']) && !in_array($this->tp_thn_release, $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_thn_release']))
               {
    ...
    {
        global $teste_validade;
      if ($this->tp_prjtrelease == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_prjtrelease']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_prjtrelease'] == "on"))
      {
          ...
          if (!empty($this->tp_prjtrelease) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_prjtrelease']) && !in_array($this->tp_prjtrelease, $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_prjtrelease']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_prjtrelease']))
              {
    ...
    {
        global $teste_validade;
               if (!empty($this->tp_batch) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_batch']) && !in_array($this->tp_batch, $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_batch']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
      if ($this->tp_templateproject == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_templateproject']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_templateproject'] == "on"))
      {
          ...
          if (!empty($this->tp_templateproject) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_templateproject']) && !in_array($this->tp_templateproject, $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_templateproject']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_templateproject']))
              {
    ...
    function ValidateField_tp_targetwaktu(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_targetwaktu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_targetwaktu'] == "on") 
           { 
    ...
    {
        global $teste_validade;
      if ($this->tp_jenisproject == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_jenisproject']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_jenisproject'] == "on"))
      {
          ...
          if (!empty($this->tp_jenisproject) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_jenisproject']) && !in_array($this->tp_jenisproject, $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_jenisproject']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_jenisproject']))
              {
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_projectname']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_projectname'] == "on")) 
      { 
    ...
    function ValidateField_tp_planstart(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif ((!$this->NM_ajax_flag || 'validate_tp_planstart' != $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_planstart']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_planstart'] == "on")) 
           { 
    ...
    function ValidateField_tp_planfinish(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif ((!$this->NM_ajax_flag || 'validate_tp_planfinish' != $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_planfinish']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_planfinish'] == "on")) 
           { 
    ...
    {
        global $teste_validade;
      if ($this->tp_divre == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_divre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_divre'] == "on"))
      {
          $Campos_Falta[] = "Divre" ; 
          ...
          if (!empty($this->tp_divre) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_divre']) && !in_array($this->tp_divre, $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_divre']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_divre']))
              {
    ...
    {
        global $teste_validade;
      if ($this->tp_witel == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_witel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_witel'] == "on"))
      {
          $Campos_Falta[] = "Witel" ; 
          ...
          if (!empty($this->tp_witel) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_witel']) && !in_array($this->tp_witel, $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_witel']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_witel']))
              {
    ...
    {
        global $teste_validade;
      if ($this->tp_datel == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_datel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_datel'] == "on"))
      {
          $Campos_Falta[] = "Datel" ; 
          ...
          if (!empty($this->tp_datel) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_datel']) && !in_array($this->tp_datel, $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_datel']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_datel']))
              {
    ...
    {
        global $teste_validade;
      if ($this->tp_sto == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_sto']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_sto'] == "on"))
      {
          $Campos_Falta[] = "STO" ; 
          ...
          if (!empty($this->tp_sto) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_sto']) && !in_array($this->tp_sto, $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_sto']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_sto']))
              {
    ...
    {
        global $teste_validade;
      if ($this->tp_mitra == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_mitra']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['php_cmp_required']['tp_mitra'] == "on"))
      {
          $Campos_Falta[] = "Mitra" ; 
          ...
          if (!empty($this->tp_mitra) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_mitra']) && !in_array($this->tp_mitra, $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_mitra']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_mitra']))
              {
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['tp_id']['keyVal'] = form_edit_project_method_pack_protect_string($this->nmgp_dados_form['tp_id']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_thn_release']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_thn_release'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_thn_release']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_thn_release'] = array(); 
}
$aLookup[] = array(form_edit_project_method_pack_protect_string('') => form_edit_project_method_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_thn_release'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_edit_project_method_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_edit_project_method_pack_protect_string(NM_charset_to_utf8($rs->fields[0])));
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_thn_release'][] = $rs->fields[0];
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_thn_release']['valList'][$i] = form_edit_project_method_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_prjtrelease']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_prjtrelease'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_prjtrelease']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_prjtrelease'] = array(); 
}
$aLookup[] = array(form_edit_project_method_pack_protect_string('') => form_edit_project_method_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_prjtrelease'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(form_edit_project_method_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_edit_project_method_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_prjtrelease'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_prjtrelease']['valList'][$i] = form_edit_project_method_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_batch']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_batch'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_batch']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_batch'] = array(); 
}
$aLookup[] = array(form_edit_project_method_pack_protect_string('') => form_edit_project_method_pack_protect_string('Pilh Batch'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_batch'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_batch'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_batch']['valList'][$i] = form_edit_project_method_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_templateproject']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_templateproject'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_templateproject']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_templateproject'] = array(); 
}
$aLookup[] = array(form_edit_project_method_pack_protect_string('') => form_edit_project_method_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_templateproject'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_templateproject'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_templateproject']['valList'][$i] = form_edit_project_method_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_jenisproject']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_jenisproject'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_jenisproject']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_jenisproject'] = array(); 
}
$aLookup[] = array(form_edit_project_method_pack_protect_string('') => form_edit_project_method_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_jenisproject'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_jenisproject'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_jenisproject']['valList'][$i] = form_edit_project_method_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_divre']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_divre'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_divre']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_divre'] = array(); 
}
$aLookup[] = array(form_edit_project_method_pack_protect_string('') => form_edit_project_method_pack_protect_string('Pilih Divre'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_divre'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_divre'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_divre']['valList'][$i] = form_edit_project_method_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_witel']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_witel'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_witel']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_witel'] = array(); 
}
$aLookup[] = array(form_edit_project_method_pack_protect_string('') => form_edit_project_method_pack_protect_string('Pilih Witel'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_witel'][] = '';
if ($this->tp_divre != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_witel'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_witel']['valList'][$i] = form_edit_project_method_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_datel']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_datel'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_datel']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_datel'] = array(); 
}
$aLookup[] = array(form_edit_project_method_pack_protect_string('') => form_edit_project_method_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_datel'][] = '';
if ($this->tp_witel != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_datel'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_datel']['valList'][$i] = form_edit_project_method_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_sto']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_sto'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_sto']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_sto'] = array(); 
}
$aLookup[] = array(form_edit_project_method_pack_protect_string('') => form_edit_project_method_pack_protect_string('Pilih STO'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_sto'][] = '';
if ($this->tp_datel != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_sto'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_sto']['valList'][$i] = form_edit_project_method_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_mitra']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_mitra'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_mitra']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_mitra'] = array(); 
}
$aLookup[] = array(form_edit_project_method_pack_protect_string('') => form_edit_project_method_pack_protect_string('Pilih Mitra'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_mitra'][] = '';
...
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['Lookup_tp_mitra'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_mitra']['valList'][$i] = form_edit_project_method_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_tp_jmldistribusi($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->tp_id)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_ex_update = true; 
          $SC_ex_upd_or = true; 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          $this->tp_thn_release = $this->tp_thn_release_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['db_changed'] = true;
      ...
      { 
          ...
          { 
              $NM_seq_auto = "NEXT VALUE FOR AKSESSMR.TBL_PROJECT_SEQ, ";
              $NM_cmp_auto = "TP_ID, ";
          } 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          { 
              $NM_seq_auto = "AKSESSMR.TBL_PROJECT_SEQ.NEXTVAL, ";
              $NM_cmp_auto = "TP_ID, ";
          } 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
          { 
              $NM_seq_auto = "nextval('AKSESSMR.TBL_PROJECT_SEQ'), ";
              $NM_cmp_auto = "TP_ID, ";
          } 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $NM_seq_auto = "gen_id(AKSESSMR.TBL_PROJECT_SEQ, 1), ";
              $NM_cmp_auto = "TP_ID, ";
          } 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select AKSESSMR.TBL_PROJECT_SEQ.currval from dual"; 
                  $rsy = $this->Db->Execute($_SESSION['scriptcase']['sc_sql_ult_comando']); 
                  if ($rsy === false && !$rsy->EOF)  
                  { 
                      $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_db2))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "values PREVVAL FOR AKSESSMR.TBL_PROJECT_SEQ"; 
                  $rsy = $this->Db->Execute($_SESSION['scriptcase']['sc_sql_ult_comando']); 
                  if ($rsy === false && !$rsy->EOF)  
                  { 
                      $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select CURRVAL('AKSESSMR.TBL_PROJECT_SEQ')"; 
                  $rsy = $this->Db->Execute($_SESSION['scriptcase']['sc_sql_ult_comando']); 
                  if ($rsy === false && !$rsy->EOF)  
                  { 
                      $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select gen_id(AKSESSMR.TBL_PROJECT_SEQ, 0) from " . $this->Ini->nm_tabela; 
                  $rsy = $this->Db->Execute($_SESSION['scriptcase']['sc_sql_ult_comando']); 
                  if ($rsy === false && !$rsy->EOF)  
                  { 
                      $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['total']);
              }

              $this->sc_evento = "insert"; 
              $this->sc_insert_on = true; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['parms'] = "tp_id?#?$this->tp_id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['run_iframe'] == "R")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_edit_project_method = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['total'] = $qt_geral_reg_form_edit_project_method;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->tp_id))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_edit_project_method = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_start'] > $qt_geral_reg_form_edit_project_method)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_start'] = $qt_geral_reg_form_edit_project_method; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_edit_project_method) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_start'] < $qt_geral_reg_form_edit_project_method;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['dados_select'];
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['reg_start'] + 1;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_edit_project_method_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['csrf_token'];
    }
...
{ 
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_edit_project_method = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['total'] = $qt_geral_reg_form_edit_project_method;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_edit_project_method_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_edit_project_method_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_edit_project_method_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_edit_project_method']['masterValue'] as $cmp_master => $val_master)
        {
?>
