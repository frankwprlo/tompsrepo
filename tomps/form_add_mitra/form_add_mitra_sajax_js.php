  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_add_mitra" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate tm_idmitra_
  function do_ajax_form_add_mitra_validate_tm_idmitra_(iNumLinha)
  {
    var nomeCampo_tm_idmitra_ = "tm_idmitra_" + iNumLinha;
    var var_tm_idmitra_ = scAjaxGetFieldHidden(nomeCampo_tm_idmitra_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_add_mitra_validate_tm_idmitra_(var_tm_idmitra_, iNumLinha, var_script_case_init, do_ajax_form_add_mitra_validate_tm_idmitra__cb);
  } // do_ajax_form_add_mitra_validate_tm_idmitra_

  function do_ajax_form_add_mitra_validate_tm_idmitra__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tm_idmitra_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tm_idmitra_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "tm_idmitra_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tm_idmitra_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_add_mitra_validate_tm_idmitra__cb

  // ---------- Validate tm_namamitra_
  function do_ajax_form_add_mitra_validate_tm_namamitra_(iNumLinha)
  {
    var nomeCampo_tm_namamitra_ = "tm_namamitra_" + iNumLinha;
    var var_tm_namamitra_ = scAjaxGetFieldText(nomeCampo_tm_namamitra_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_add_mitra_validate_tm_namamitra_(var_tm_namamitra_, iNumLinha, var_script_case_init, do_ajax_form_add_mitra_validate_tm_namamitra__cb);
  } // do_ajax_form_add_mitra_validate_tm_namamitra_

  function do_ajax_form_add_mitra_validate_tm_namamitra__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tm_namamitra_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tm_namamitra_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tm_namamitra_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tm_namamitra_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_add_mitra_validate_tm_namamitra__cb

  // ---------- Validate tm_divre_
  function do_ajax_form_add_mitra_validate_tm_divre_(iNumLinha)
  {
    var nomeCampo_tm_divre_ = "tm_divre_" + iNumLinha;
    var var_tm_divre_ = scAjaxGetFieldSelect(nomeCampo_tm_divre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_add_mitra_validate_tm_divre_(var_tm_divre_, iNumLinha, var_script_case_init, do_ajax_form_add_mitra_validate_tm_divre__cb);
  } // do_ajax_form_add_mitra_validate_tm_divre_

  function do_ajax_form_add_mitra_validate_tm_divre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tm_divre_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tm_divre_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tm_divre_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tm_divre_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_add_mitra_validate_tm_divre__cb

  // ---------- Validate tm_witel_
  function do_ajax_form_add_mitra_validate_tm_witel_(iNumLinha)
  {
    var nomeCampo_tm_witel_ = "tm_witel_" + iNumLinha;
    var var_tm_witel_ = scAjaxGetFieldSelect(nomeCampo_tm_witel_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_add_mitra_validate_tm_witel_(var_tm_witel_, iNumLinha, var_script_case_init, do_ajax_form_add_mitra_validate_tm_witel__cb);
  } // do_ajax_form_add_mitra_validate_tm_witel_

  function do_ajax_form_add_mitra_validate_tm_witel__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tm_witel_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tm_witel_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tm_witel_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tm_witel_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_add_mitra_validate_tm_witel__cb

  // ---------- Refresh tm_divre_
  function do_ajax_form_add_mitra_refresh_tm_divre_(iSeqForm)
  {
    var var_tm_divre_ = scAjaxGetFieldSelect("tm_divre_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "tm_witel_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_add_mitra_refresh_tm_divre_(var_tm_divre_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_add_mitra_refresh_tm_divre__cb);
  } // do_ajax_form_add_mitra_refresh_tm_divre_

  function do_ajax_form_add_mitra_refresh_tm_divre__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_add_mitra_refresh_tm_divre__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_add_mitra_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_add_mitra_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_add_mitra_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_add_mitra_add_new_line_cb);
  } // do_ajax_form_add_mitra_add_new_line

  function do_ajax_form_add_mitra_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_add_mitra_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_add_mitra_backup_line(iNumLinha)
  {
    var var_tm_idmitra_ = scAjaxGetFieldHidden("tm_idmitra_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_add_mitra_backup_line(var_tm_idmitra_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_add_mitra_backup_line_cb);
  } // do_ajax_form_add_mitra_backup_line

  function do_ajax_form_add_mitra_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_add_mitra_backup_line_cb

  function do_ajax_form_add_mitra_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_add_mitra_cancel_insert

  function do_ajax_form_add_mitra_cancel_update(iSeqVert)
  {
    do_ajax_form_add_mitra_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_add_mitra_cancel_update

  function do_ajax_form_add_mitra_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_add_mitra_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_add_mitra_table_refresh()
  {
    var var_tm_idmitra_ = document.F2.tm_idmitra_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_add_mitra_table_refresh(var_tm_idmitra_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_add_mitra_table_refresh_cb);
  } //  do_ajax_form_add_mitra_table_refresh

  function do_ajax_form_add_mitra_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.tm_idmitra_.value = scAjaxGetKeyValue("tm_idmitra_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_add_mitra_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_add_mitra_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_add_mitra_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_tm_idmitra_ = scAjaxGetFieldHidden("tm_idmitra_" + iNumLinha);
    var var_tm_namamitra_ = scAjaxGetFieldText("tm_namamitra_" + iNumLinha);
    var var_tm_divre_ = scAjaxGetFieldSelect("tm_divre_" + iNumLinha);
    var var_tm_witel_ = scAjaxGetFieldSelect("tm_witel_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_add_mitra_submit_form(var_tm_idmitra_, var_tm_namamitra_, var_tm_divre_, var_tm_witel_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_add_mitra_submit_form_cb);
  } // do_ajax_form_add_mitra_submit_form

  function do_ajax_form_add_mitra_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tm_idmitra_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tm_namamitra_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tm_divre_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tm_witel_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_form_add_mitra_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_add_mitra_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_add_mitra_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("tm_idmitra_" + iNavForm);
      scAjaxHideErrorDisplay("tm_namamitra_" + iNavForm);
      scAjaxHideErrorDisplay("tm_divre_" + iNavForm);
      scAjaxHideErrorDisplay("tm_witel_" + iNavForm);
    }
    var var_tm_idmitra_ = document.F2.tm_idmitra_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_add_mitra_navigate_form(var_tm_idmitra_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_add_mitra_navigate_form_cb);
  } // do_ajax_form_add_mitra_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_add_mitra']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_add_mitra_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.tm_idmitra_.value = scAjaxGetKeyValue("tm_idmitra_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_add_mitra_navigate_form_cb
  function sc_hide_form_add_mitra_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_add_mitra_form
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "tm_idmitra_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tm_namamitra_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tm_divre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tm_witel_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["tm_idmitra_" + iNumLinha] = {"label": "ID Mitra<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tm_namamitra_" + iNumLinha] = {"label": "Nama Mitra<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tm_divre_" + iNumLinha] = {"label": "Divre<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tm_witel_" + iNumLinha] = {"label": "Witel<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["tm_idmitra_"][iNumLinha] = "tm_idmitra_" + iNumLinha;
    ajax_field_mult["tm_namamitra_"][iNumLinha] = "tm_namamitra_" + iNumLinha;
    ajax_field_mult["tm_divre_"][iNumLinha] = "tm_divre_" + iNumLinha;
    ajax_field_mult["tm_witel_"][iNumLinha] = "tm_witel_" + iNumLinha;
    ajax_field_id["tm_idmitra_" + iNumLinha] = new Array("hidden_field_label_tm_idmitra_", "hidden_field_data_tm_idmitra_" + iNumLinha);
    ajax_field_id["tm_namamitra_" + iNumLinha] = new Array("hidden_field_label_tm_namamitra_", "hidden_field_data_tm_namamitra_" + iNumLinha);
    ajax_field_id["tm_divre_" + iNumLinha] = new Array("hidden_field_label_tm_divre_", "hidden_field_data_tm_divre_" + iNumLinha);
    ajax_field_id["tm_witel_" + iNumLinha] = new Array("hidden_field_label_tm_witel_", "hidden_field_data_tm_witel_" + iNumLinha);
    ajax_error_count["tm_idmitra_" + iNumLinha] = "off";
    ajax_error_count["tm_namamitra_" + iNumLinha] = "off";
    ajax_error_count["tm_divre_" + iNumLinha] = "off";
    ajax_error_count["tm_witel_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["tm_idmitra_" + iNumLinha] = "on";
    ajax_read_only["tm_namamitra_" + iNumLinha] = "off";
    ajax_read_only["tm_divre_" + iNumLinha] = "off";
    ajax_read_only["tm_witel_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["tm_idmitra_" + iNumLinha] = "on";
    ajax_read_only["tm_namamitra_" + iNumLinha] = "on";
    ajax_read_only["tm_divre_" + iNumLinha] = "on";
    ajax_read_only["tm_witel_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["tm_idmitra_" + iNumLinha] = null;
    ajax_error_list["tm_namamitra_" + iNumLinha] = null;
    ajax_error_list["tm_divre_" + iNumLinha] = null;
    ajax_error_list["tm_witel_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "tm_idmitra_": new Array(),
    "tm_namamitra_": new Array(),
    "tm_divre_": new Array(),
    "tm_witel_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["tm_idmitra_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tm_idmitra_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tm_idmitra_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tm_idmitra_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tm_idmitra_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tm_namamitra_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tm_namamitra_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tm_namamitra_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tm_namamitra_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tm_namamitra_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tm_divre_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tm_divre_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tm_divre_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tm_divre_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tm_divre_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tm_witel_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tm_witel_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tm_witel_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tm_witel_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tm_witel_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tm_idmitra_'])) ? $this->nmgp_cmp_readonly['tm_idmitra_'] : 'on';
?>
    scAjaxFieldRead("tm_idmitra_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tm_namamitra_'])) ? $this->nmgp_cmp_readonly['tm_namamitra_'] : 'off';
?>
    scAjaxFieldRead("tm_namamitra_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tm_divre_'])) ? $this->nmgp_cmp_readonly['tm_divre_'] : 'off';
?>
    scAjaxFieldRead("tm_divre_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tm_witel_'])) ? $this->nmgp_cmp_readonly['tm_witel_'] : 'off';
?>
    scAjaxFieldRead("tm_witel_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("tm_idmitra_" + iSeq, "on");
    scAjaxFieldRead("tm_namamitra_" + iSeq, "on");
    scAjaxFieldRead("tm_divre_" + iSeq, "on");
    scAjaxFieldRead("tm_witel_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tm_idmitra_" + iRow] || "on" == ajax_error_count["tm_namamitra_" + iRow] || "on" == ajax_error_count["tm_divre_" + iRow] || "on" == ajax_error_count["tm_witel_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tm_idmitra_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tm_namamitra_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tm_divre_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tm_witel_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tm_idmitra_" + iRow] && "off" == ajax_error_count["tm_namamitra_" + iRow] && "off" == ajax_error_count["tm_divre_" + iRow] && "off" == ajax_error_count["tm_witel_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tm_idmitra_" + iRow] = "off";
        ajax_error_count["tm_namamitra_" + iRow] = "off";
        ajax_error_count["tm_divre_" + iRow] = "off";
        ajax_error_count["tm_witel_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_tm_idmitra_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tm_namamitra_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tm_divre_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tm_witel_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("tm_idmitra_" == sIndex)
    {
      scAjaxSetFieldLabel(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
    }
    if ("tm_namamitra_" == sIndex)
    {
