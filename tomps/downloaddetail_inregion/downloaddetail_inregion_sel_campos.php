<?php
   ...
   session_start();
    ...
    $Sel_Cmp = new downloaddetail_inregion_sel_cmp(); 
    $Sel_Cmp->Sel_cmp_init();
   
class downloaddetail_inregion_sel_cmp
{
function Sel_cmp_init()
{
   ...
   $tab_blk_campos[] = "tp_idlop";
   $tab_ger_campos['tp_namalop'] = "on";
   $tab_blk_campos[] = "tp_namalop";
   $tab_ger_campos['tp_jmldistribusi'] = "on";
   $tab_blk_campos[] = "tp_jmldistribusi";
   $tab_ger_campos['tp_nilai'] = "on";
   $tab_blk_campos[] = "tp_nilai";
   $tab_ger_campos['tp_rab'] = "on";
   $tab_blk_campos[] = "tp_rab";
   $tab_ger_campos['mw_namawitel'] = "on";
   $tab_blk_campos[] = "mw_namawitel";
   $tab_ger_campos['md_namadivre'] = "on";
   $tab_blk_campos[] = "md_namadivre";
   $tab_ger_campos['tp_taskaktif'] = "on";
   $tab_blk_campos[] = "tp_taskaktif";
   $tab_ger_campos['tp_prosentase'] = "on";
   $tab_blk_campos[] = "tp_prosentase";
   $tab_ger_campos['tp_tahapanaktif'] = "on";
   $tab_blk_campos[] = "tp_tahapanaktif";
   $tab_ger_campos['tp_taskaktifstatus'] = "on";
   $tab_blk_campos[] = "tp_taskaktifstatus";
   $tab_ger_campos['tp_taskaktifplanstart'] = "on";
   $tab_blk_campos[] = "tp_taskaktifplanstart";
   $tab_ger_campos['tp_taskaktifplanfinish'] = "on";
   $tab_blk_campos[] = "tp_taskaktifplanfinish";
   ...
   if (isset($_SESSION['sc_session'][$this->sc_init]['downloaddetail_inregion']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->sc_init]['downloaddetail_inregion']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->sc_init]['downloaddetail_inregion']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (isset($_SESSION['sc_session'][$this->sc_init]['downloaddetail_inregion']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->sc_init]['downloaddetail_inregion']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->sc_init]['downloaddetail_inregion']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
...
function Sel_processa_out()
{
   ...
   $arr_temp = array();
   if (!isset($_SESSION['sc_session'][$this->sc_init]['downloaddetail_inregion']['usr_cmp_sel']))
   {
       $_SESSION['sc_session'][$this->sc_init]['downloaddetail_inregion']['usr_cmp_sel'] = array();
   }
   $arr_order = $_SESSION['sc_session'][$this->sc_init]['downloaddetail_inregion']['field_order'];
   $_SESSION['sc_session'][$this->sc_init]['downloaddetail_inregion']['field_order'] = array();
   $campos_sel = explode("@?@", $this->campos_sel);
   foreach ($campos_sel as $campo_order)
   {
       if (isset($tab_ger_campos[$campo_order]))
       {
           $_SESSION['sc_session'][$this->sc_init]['downloaddetail_inregion']['field_order'][] = $campo_order;
       }
   }
   foreach ($arr_order as $campo_order)
   {
       if (!in_array($campo_order, $_SESSION['sc_session'][$this->sc_init]['downloaddetail_inregion']['field_order']))
       {
           $_SESSION['sc_session'][$this->sc_init]['downloaddetail_inregion']['field_order'][] = $campo_order;
       }
   }
   ...
   $_SESSION['sc_session'][$this->sc_init]['downloaddetail_inregion']['usr_cmp_sel'] = $arr_temp;
?>
...
?>
  function scSubmitSelCampos(sPos) {
   ...
   $.ajax({
    type: "POST",
    url: "downloaddetail_inregion_sel_campos.php",
    data: {
...
<?php
   ...
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if ($NM_cada_opc != "on")
           {
               $prep_combo[strtolower($NM_cada_field)] = $_SESSION['sc_session'][$this->sc_init]['downloaddetail_inregion']['labels'][$NM_cada_field];
           }
       }
   }
...
<?php
   if (isset($_SESSION['sc_session'][$this->sc_init]['downloaddetail_inregion']['field_order']))
   {
       foreach ($_SESSION['sc_session'][$this->sc_init]['downloaddetail_inregion']['field_order'] as $NM_cada_field)
       {
           if ($tab_ger_campos[$NM_cada_field] == "on")
           {
               ...
               {
?>
     <li class="sc_ui_litem scAppDivSelectFieldsEnabled" id="sc_id_itemsel_<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $_SESSION['sc_session'][$this->sc_init]['downloaddetail_inregion']['labels'][$NM_cada_field]; ?></li>
<?php
               }
               else
               {
?>
     <li class="sc_ui_litem scAppDivSelectFieldsDisabled" id="sc_id_itemsel_<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $_SESSION['sc_session'][$this->sc_init]['downloaddetail_inregion']['labels'][$NM_cada_field]; ?></li>
<?php
               }
           }
       }
