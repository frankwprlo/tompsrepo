...
class downloaddetail_inregion_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= "_downloaddetail_inregion";
      $this->Arquivo   .= ".xlsx";
      $this->Tit_doc    = "downloaddetail_inregion.xlsx";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inregion']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inregion']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inregion']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inregion']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inregion']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->tp_witel = $rs->fields[7] ;  
         $this->tp_witel = (string)$this->tp_witel;
         $this->tp_sto = $rs->fields[8] ;  
         $this->tp_sto = (string)$this->tp_sto;
         $this->tp_odp = $rs->fields[9] ;  
         $this->tp_odp = (string)$this->tp_odp;
         $this->tp_planstart = $rs->fields[10] ;  
         $this->tp_planfinish = $rs->fields[11] ;  
         $this->tp_entrydate = $rs->fields[12] ;  
         $this->tp_entryby = $rs->fields[13] ;  
         $this->tp_updatedate = $rs->fields[14] ;  
         $this->tp_updateby = $rs->fields[15] ;  
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
          { 
              $this->tp_summary = "";  
              if (is_file($rs_grid->fields[16])) 
              { 
                  $this->tp_summary = file_get_contents($rs_grid->fields[16]);  
              } 
          } 
         else
         { 
         ...
         $this->tp_actualstart = $rs->fields[18] ;  
         $this->tp_actualfinish = $rs->fields[19] ;  
         $this->tp_templateproject = $rs->fields[20] ;  
         $this->tp_templateproject = (string)$this->tp_templateproject;
         $this->tp_jenisproject = $rs->fields[21] ;  
         $this->tp_jenisproject = (string)$this->tp_jenisproject;
         $this->tp_targetwaktu = $rs->fields[22] ;  
         $this->tp_targetwaktu = (string)$this->tp_targetwaktu;
         $this->tp_datel = $rs->fields[23] ;  
         $this->tp_datel = (string)$this->tp_datel;
         $this->tp_nokontrak = $rs->fields[24] ;  
         $this->tp_ponumber = $rs->fields[25] ;  
         $this->statusname = $rs->fields[26] ;  
         $this->ms_namasto = $rs->fields[27] ;  
         $this->tm_namamitra = $rs->fields[28] ;  
         $this->tp_idlop = $rs->fields[29] ;  
         $this->tp_namalop = $rs->fields[30] ;  
         $this->tp_jmldistribusi = $rs->fields[31] ;  
         ...
         $this->mw_namawitel = $rs->fields[34] ;  
         $this->md_namadivre = $rs->fields[35] ;  
         $this->tp_taskaktif = $rs->fields[36] ;  
         $this->tp_prosentase = $rs->fields[37] ;  
         $this->tp_prosentase =  str_replace(",", ".", $this->tp_prosentase);
         $this->tp_prosentase = (string)$this->tp_prosentase;
         $this->tp_tahapanaktif = $rs->fields[38] ;  
         $this->tp_taskaktifstatus = $rs->fields[39] ;  
         $this->tp_taskaktifstatus = (string)$this->tp_taskaktifstatus;
         $this->tp_taskaktifplanstart = $rs->fields[40] ;  
         $this->tp_taskaktifplanfinish = $rs->fields[41] ;  
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inregion']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inregion']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inregion'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inregion'][$path_doc_md5][1] = $this->Tit_doc;
?>
