...
class dashboard_recentlyclose_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= "_dashboard_recentlyclose";
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "dashboard_recentlyclose.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['order_grid'];
      ...
      { 
          ...
          if ($Cada_col == "md_kodedatel" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      while (!$rs->EOF)
      {
         ...
         $this->tp_datel = $rs->fields[1] ;  
         $this->tp_divre = $rs->fields[2] ;  
         $this->tp_divre = (string)$this->tp_divre;
         $this->tj_namajenis = $rs->fields[3] ;  
         $this->md_kodedatel = $rs->fields[4] ;  
         $this->tp_id = $rs->fields[5] ;  
         $this->tp_id = (string)$this->tp_id;
         $this->tp_odp = $rs->fields[6] ;  
         $this->tp_odp = (string)$this->tp_odp;
         $this->keterangan = $rs->fields[7] ;  
   ...
   {
         $this->tp_datel = html_entity_decode($this->tp_datel, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->tp_datel = strip_tags($this->tp_datel);
         if (!NM_is_utf8($this->tp_datel))
         {
             $this->tp_datel = sc_convert_encoding($this->tp_datel, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->tp_datel, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- tp_divre
   ...
   //----- md_kodedatel
   function NM_export_md_kodedatel()
   {
         $this->md_kodedatel = html_entity_decode($this->md_kodedatel, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->md_kodedatel = strip_tags($this->md_kodedatel);
         if (!NM_is_utf8($this->md_kodedatel))
         {
             $this->md_kodedatel = sc_convert_encoding($this->md_kodedatel, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->md_kodedatel, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- tp_id
   ...
   function NM_export_keterangan()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->keterangan, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose'][$path_doc_md5][1] = $this->Tit_doc;
?>
