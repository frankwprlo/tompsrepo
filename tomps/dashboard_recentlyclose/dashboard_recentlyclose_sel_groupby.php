<?php
   ...
   $Sel_Groupby = new dashboard_recentlyclose_sel_Groupby(); 
   $Sel_Groupby->Sel_Groupby_init();
   
class dashboard_recentlyclose_sel_Groupby
{
function Sel_Groupby_init()
{
   ...
   $groupby_atual = $_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['SC_Ind_Groupby'];
...
function Sel_processa_out($sel_groupby)
{
   ...
   {
       $_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['SC_Ind_Groupby']     = $sel_groupby;
       $_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['contr_array_resumo'] = "NAO";
       $_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['contr_total_geral']  = "NAO";
       unset($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['ordem_quebra']);
       unset($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['ordem_select']);
       unset($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['tot_geral']);
       unset($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['arr_total']);
       unset($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['pivot_group_by']);
       unset($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['pivot_x_axys']);
       unset($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['pivot_y_axys']);
       unset($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['pivot_fill']);
       unset($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['pivot_order']);
       unset($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['pivot_order_col']);
       unset($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['pivot_order_level']);
       unset($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['pivot_order_sort']);
       unset($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['pivot_tabular']);
   }
?>
...
?>
 <script language="javascript" type="text/javascript">
  function scSubmitGroupBy(sPos) {
   $.ajax({
    type: "POST",
    url: "dashboard_recentlyclose_sel_groupby.php",
    data: {
...
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
...
{
  $max_height = 1;
  if (isset($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
...
<?php
    ...
    $iTabCount            = 0;
    foreach ($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['SC_All_Groupby'] as $QB => $Tp)
    {
        if (!in_array($QB, $_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['SC_Groupby_hide']))
        {
...
<?php
     if (!in_array("groupbykatwaktu", $_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['SC_Groupby_hide']))
     {
        if ($groupby_atual == "groupbykatwaktu")
        {
            $check = " checked";
            $bStartFree = false;
        }
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();' name="sel_groupby" value="groupbykatwaktu" id="sc_id_sel_groupby_groupbykatwaktu"<?php echo $check ?> style='display:' />
      <label for="sc_id_sel_groupby_groupbykatwaktu">
        Group by Kategori Waktu
<?php
    $prep_labels = array();
    $prep_labels[] = "KETERANGAN";
    $prep_labels[] = "";
?>
        <span>
...
?>
<?php
     if (!in_array("groupbyjenisproject", $_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['SC_Groupby_hide']))
     {
        if ($groupby_atual == "groupbyjenisproject")
        {
            $check = " checked";
            $bStartFree = false;
        }
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();' name="sel_groupby" value="groupbyjenisproject" id="sc_id_sel_groupby_groupbyjenisproject"<?php echo $check ?> style='display:' />
      <label for="sc_id_sel_groupby_groupbyjenisproject">
        group by Jenis Project
<?php
    $prep_labels = array();
    $prep_labels[] = "MD KODEDATEL";
    $prep_labels[] = "TJ NAMAJENIS";
?>
        <span>
        <?php echo implode($prep_labels, ', ');?>
        </span>
...
?>
 <tr id="sc_id_summary" class="SummaryBox" style='display:<?php echo ($has_total_dynamic)?'':'none';?>'>
  <td>
    ...
    <?php
    foreach ($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['summarizing_fields_control'] as $nome_quebra => $_arr_fields_totals)
    {
    ?>
...
<?php
          if(isset($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['summarizing_fields_order'][ $nome_quebra ]) && is_array($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['summarizing_fields_order'][ $nome_quebra ]) && !empty($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['summarizing_fields_order'][ $nome_quebra ]))
          {
           foreach ($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['summarizing_fields_order'][ $nome_quebra ] as $i_sum)
           {
            if ('' != $i_sum && isset($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['summarizing_fields_display'][ $nome_quebra ][$i_sum]))
            {
                $d_sum = $_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['summarizing_fields_display'][ $nome_quebra ][$i_sum];
                if ($d_sum['display'])
                {
                    $sLabel = $d_sum['label'];
                    $sId    = '';
                    $bFound = false;
                    $iKey   = $key_total;
                    if(isset($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['summarizing_fields_control'][$nome_quebra]))
                    {
                        foreach ($_SESSION['sc_session'][$sc_init]['dashboard_recentlyclose']['summarizing_fields_control'][$nome_quebra] as $_key_total => $d_field)
                        {
                            if(is_array($d_field))
                            {
                                    $l_field = $d_field['cmp_res'];
