 ...
 */
    ...
    session_start();
    $SC_apl_proc = "dashboard_recentlyclose";
...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['dashboard_recentlyclose']['show_skip_charts_option']) || !$_SESSION['sc_session']['dashboard_recentlyclose']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
