...
class dashboard_recentlyclose_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_md_kodedatel = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['contr_total_geral'] == "OK")
      {
          $this->array_total_md_kodedatel = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['arr_total']['md_kodedatel'];
          $this->array_total_tj_namajenis = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['arr_total']['tj_namajenis'];
      }
      else
      {
          $this->array_total_md_kodedatel = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['tot_geral'][3];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['arr_total']['md_kodedatel'] = $this->array_total_md_kodedatel;
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['arr_total']['tj_namajenis'] = $this->array_total_tj_namajenis;
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['summarizing_fields_order']['groupbyjenisproject']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['summarizing_fields_order']['groupbyjenisproject'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['summarizing_fields_order']['groupbyjenisproject'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['summarizing_fields_display']['groupbyjenisproject'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['summarizing_fields_display']['groupbyjenisproject'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['summarizing_fields_display']['groupbyjenisproject'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['summarizing_fields_display']['groupbyjenisproject'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['summarizing_fields_display']['groupbyjenisproject'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['summarizing_fields_display']['groupbyjenisproject'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['summarizing_fields_display']['groupbyjenisproject'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "tp_odp", 'show' => true),
           3 => array('field' => "tp_id", 'show' => true),
       );
       ...
       //-----
       foreach ($this->array_total_md_kodedatel as $i_md_kodedatel => $d_md_kodedatel) {
           if (!in_array($i_md_kodedatel, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_md_kodedatel[4] ] = $d_md_kodedatel[3];
               $this->comp_label[0][ $d_md_kodedatel[4] ] = $d_md_kodedatel[3];
           }
           foreach ($this->array_total_tj_namajenis[$i_md_kodedatel] as $i_tj_namajenis => $d_tj_namajenis) {
               if (!in_array($i_tj_namajenis, $this->comp_label[1][ $d_md_kodedatel[4] ], true)) {
                   $this->comp_index[1][ $d_tj_namajenis[4] ] = $d_tj_namajenis[3];
                   $this->comp_label[1][ $d_md_kodedatel[4] ][ $d_tj_namajenis[4] ] = $d_tj_namajenis[3];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'md_kodedatel', 'prot' => '@aspass@'),
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_md_kodedatel => $l_md_kodedatel) {
           if (isset($this->array_total_md_kodedatel[$i_md_kodedatel])) {
               $this->comp_group[$i_md_kodedatel] = array();
           }
           foreach ($this->comp_label[1][$i_md_kodedatel] as $i_tj_namajenis => $l_tj_namajenis) {
               if (isset($this->array_total_tj_namajenis[$i_md_kodedatel][$i_tj_namajenis])) {
                   $this->comp_group[$i_md_kodedatel][$i_tj_namajenis] = array();
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_md_kodedatel;
       }
       elseif (1 == $level) {
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@dashboard_recentlyclose@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_order_start'][$iYAxysIndex])
                       {
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "dashboard_recentlyclose_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['opcao'] = "print";
      ...
      $this->Total   = new dashboard_recentlyclose_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_groupbyjenisproject("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_md_kodedatel);
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>LOP Status Close / Complete</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_dashboard_recentlyclose_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_dashboard_recentlyclose_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_dashboard_recentlyclose_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['num_css'] . '.css');
     ...
     else
     {
      ...
      $nm_saida->saida(" </style>\r\n");
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "dashboard_recentlyclose/dashboard_recentlyclose_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['opcao'] == "pdf")
      { 
              $nm_saida->saida("  <div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">LOP Close</H1></div>\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "dashboard_recentlyclose/dashboard_recentlyclose_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnGroupByShow('" . $this->Ini->path_link . "dashboard_recentlyclose/dashboard_recentlyclose_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
      }
         ...
         $NM_btn = false;
         if (is_file("dashboard_recentlyclose_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'dashboard_recentlyclose_config_pivot.php?nome_apl=dashboard_recentlyclose&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_dashboard_recentlyclose_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "dashboard_recentlyclose/dashboard_recentlyclose_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['cond_pesq'], 0, $trab_pos);
      ...
      $nm_saida->saida("          LOP Status Close / Complete\r\n");
      $nm_saida->saida("        </TD>\r\n");
      $nm_saida->saida("       </TR>\r\n");
   ...
   function monta_rodape()
   {
      ...
      $nm_cab_filtro   = ""; 
      $nm_cab_filtrobr = ""; 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['campos_busca']))
      { 
        $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['campos_busca'];
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
      ...
      $nm_saida->saida("       <TR align=\"right\" valign=\"middle\">\r\n");
      $nm_saida->saida("        <TD class=\"" . $this->css_scGridFooterFont . "\">\r\n");
      $nm_saida->saida("          " . "Selisih Tgl Sekarang - Tgl Selesai Actual : Between 1 AND 7 = '1TO7'       Between 8 AND 14 = '8TO14'       Between 15 AND 30 = '15TO30'        ELSE '>30 Hari'" . "\r\n");
      $nm_saida->saida("        </TD>\r\n");
      $nm_saida->saida("       </TR>\r\n");
      $nm_saida->saida("      </TABLE>\r\n");
      $nm_saida->saida("     </TD>\r\n");
   ...
   //---- 
   function adiciona_registro($cnt_tp_id, $sum_tp_odp, $quebra_md_kodedatel, $quebra_tj_namajenis, $quebra_md_kodedatel_orig, $quebra_tj_namajenis_orig)
   {
      //----- MD KODEDATEL
      if (!isset($this->array_total_md_kodedatel[$quebra_md_kodedatel_orig]))
      {
         $this->array_total_md_kodedatel[$quebra_md_kodedatel_orig][0] = 1;
         $this->array_total_md_kodedatel[$quebra_md_kodedatel_orig][1] = 1;
         $this->array_total_md_kodedatel[$quebra_md_kodedatel_orig][2] = $sum_tp_odp;
         $this->array_total_md_kodedatel[$quebra_md_kodedatel_orig][3] = $quebra_md_kodedatel;
         $this->array_total_md_kodedatel[$quebra_md_kodedatel_orig][4] = $quebra_md_kodedatel_orig;
      }
      else
      {
         $this->array_total_md_kodedatel[$quebra_md_kodedatel_orig][0]++;
         $this->array_total_md_kodedatel[$quebra_md_kodedatel_orig][1] ++;
         $this->array_total_md_kodedatel[$quebra_md_kodedatel_orig][2] += $sum_tp_odp;
      }
      //----- TJ NAMAJENIS
      if (!isset($this->array_total_tj_namajenis[$quebra_md_kodedatel_orig][$quebra_tj_namajenis_orig]))
      {
         $this->array_total_tj_namajenis[$quebra_md_kodedatel_orig][$quebra_tj_namajenis_orig][0] = 1;
         $this->array_total_tj_namajenis[$quebra_md_kodedatel_orig][$quebra_tj_namajenis_orig][1] = 1;
         $this->array_total_tj_namajenis[$quebra_md_kodedatel_orig][$quebra_tj_namajenis_orig][2] = $sum_tp_odp;
         $this->array_total_tj_namajenis[$quebra_md_kodedatel_orig][$quebra_tj_namajenis_orig][3] = $quebra_tj_namajenis;
         $this->array_total_tj_namajenis[$quebra_md_kodedatel_orig][$quebra_tj_namajenis_orig][4] = $quebra_tj_namajenis_orig;
      }
      else
      {
         $this->array_total_tj_namajenis[$quebra_md_kodedatel_orig][$quebra_tj_namajenis_orig][0]++;
         $this->array_total_tj_namajenis[$quebra_md_kodedatel_orig][$quebra_tj_namajenis_orig][1] ++;
         $this->array_total_tj_namajenis[$quebra_md_kodedatel_orig][$quebra_tj_namajenis_orig][2] += $sum_tp_odp;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'md_kodedatel');
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->tp_witel = $rs_res->fields[0] ;  
            $this->tp_datel = $rs_res->fields[1] ;  
            $this->tp_divre = $rs_res->fields[2] ;  
            $this->tj_namajenis = $rs_res->fields[3] ;  
            $this->md_kodedatel = $rs_res->fields[4] ;  
            $this->tp_id = $rs_res->fields[5] ;  
            $this->tp_odp = $rs_res->fields[6] ;  
            $this->keterangan = $rs_res->fields[7] ;  
            $this->md_kodedatel_orig = $this->md_kodedatel;
            $this->tj_namajenis_orig = $this->tj_namajenis;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->tp_id, $this->tp_odp, $this->md_kodedatel, $this->tj_namajenis, $this->md_kodedatel_orig,  $this->tj_namajenis_orig);
            }
   }
//
