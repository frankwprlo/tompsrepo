...
class dashboard_recentlyclose_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_keterangan = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['arr_total']['keterangan'];
          $this->array_total_tp_datel = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['arr_total']['tp_datel'];
      }
      else
      {
          $this->array_total_keterangan = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['arr_total']['keterangan'] = $this->array_total_keterangan;
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['arr_total']['tp_datel'] = $this->array_total_tp_datel;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['summarizing_fields_order']['groupbykatwaktu']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['summarizing_fields_order']['groupbykatwaktu'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['summarizing_fields_order']['groupbykatwaktu'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['summarizing_fields_display']['groupbykatwaktu'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['summarizing_fields_display']['groupbykatwaktu'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['summarizing_fields_display']['groupbykatwaktu'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['summarizing_fields_display']['groupbykatwaktu'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['summarizing_fields_display']['groupbykatwaktu'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['summarizing_fields_display']['groupbykatwaktu'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['summarizing_fields_display']['groupbykatwaktu'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_keterangan as $i_keterangan => $d_keterangan) {
           if (!in_array($i_keterangan, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_keterangan[4] ] = $d_keterangan[3];
               $this->comp_label[0][ $d_keterangan[4] ] = $d_keterangan[3];
           }
           foreach ($this->array_total_tp_datel[$i_keterangan] as $i_tp_datel => $d_tp_datel) {
               if (!in_array($i_tp_datel, $this->comp_label[1][ $d_keterangan[4] ], true)) {
                   $this->comp_index[1][ $d_tp_datel[4] ] = $d_tp_datel[3];
                   $this->comp_label[1][ $d_keterangan[4] ][ $d_tp_datel[4] ] = $d_tp_datel[3];
               }
           }
       }
       ...
       $this->comp_links_fl = array(
           ...
           array('name' => 'tp_datel', 'prot' => '@aspass@'),
       );
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_recentlyclose']['pivot_order_level'] = 0;
       }
       ...
       foreach ($this->comp_label[0] as $i_keterangan => $l_keterangan) {
           ...
           foreach ($this->comp_label[1][$i_keterangan] as $i_tp_datel => $l_tp_datel) {
               if (isset($this->array_total_tp_datel[$i_keterangan][$i_tp_datel])) {
                   $this->comp_group[$i_keterangan][$i_tp_datel] = array();
               }
           }
       }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_groupbykatwaktu("res");
...
{ 
   ...
   //---- 
   function adiciona_registro($cnt_tp_id, $sum_tp_odp, $quebra_keterangan, $quebra_tp_datel, $quebra_keterangan_orig, $quebra_tp_datel_orig)
   {
      //----- KETERANGAN
      if (!isset($this->array_total_keterangan[$quebra_keterangan_orig]))
      {
         $this->array_total_keterangan[$quebra_keterangan_orig][0] = 1;
         $this->array_total_keterangan[$quebra_keterangan_orig][1] = 1;
         $this->array_total_keterangan[$quebra_keterangan_orig][2] = $sum_tp_odp;
         $this->array_total_keterangan[$quebra_keterangan_orig][3] = $quebra_keterangan;
         $this->array_total_keterangan[$quebra_keterangan_orig][4] = $quebra_keterangan_orig;
      }
      else
      {
         $this->array_total_keterangan[$quebra_keterangan_orig][0]++;
         $this->array_total_keterangan[$quebra_keterangan_orig][1] ++;
         $this->array_total_keterangan[$quebra_keterangan_orig][2] += $sum_tp_odp;
      }
      //----- 
      if (!isset($this->array_total_tp_datel[$quebra_keterangan_orig][$quebra_tp_datel_orig]))
      {
         $this->array_total_tp_datel[$quebra_keterangan_orig][$quebra_tp_datel_orig][0] = 1;
         $this->array_total_tp_datel[$quebra_keterangan_orig][$quebra_tp_datel_orig][1] = 1;
         $this->array_total_tp_datel[$quebra_keterangan_orig][$quebra_tp_datel_orig][2] = $sum_tp_odp;
         $this->array_total_tp_datel[$quebra_keterangan_orig][$quebra_tp_datel_orig][3] = $quebra_tp_datel;
         $this->array_total_tp_datel[$quebra_keterangan_orig][$quebra_tp_datel_orig][4] = $quebra_tp_datel_orig;
      }
      else
      {
         $this->array_total_tp_datel[$quebra_keterangan_orig][$quebra_tp_datel_orig][0]++;
         $this->array_total_tp_datel[$quebra_keterangan_orig][$quebra_tp_datel_orig][1] ++;
         $this->array_total_tp_datel[$quebra_keterangan_orig][$quebra_tp_datel_orig][2] += $sum_tp_odp;
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->tp_id, $this->tp_odp, $this->keterangan, $this->tp_datel, $this->keterangan_orig,  $this->tp_datel_orig);
            }
   }
//
