...
class grid_V_TBL_PROJECT_grid
{
   ...
   var $tp_rab;
   var $tp_prosentase;
   var $grid_V_RESUME_DETAILPROJECT;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (!is_file($this->Ini->link_grid_V_RESUME_DETAILPROJECT_cons_emb))
   {
   ...
   else
   {
       ...
       $_SESSION['scriptcase']['grid_V_RESUME_DETAILPROJECT']['protect_modal'] = $this->Ini->sc_page;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_RESUME_DETAILPROJECT']['exibe_titulos'] = "S";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_RESUME_DETAILPROJECT']['exibe_total'] = "S";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_RESUME_DETAILPROJECT']['exibe_seq'] = "S";
       include_once ($this->Ini->link_grid_V_RESUME_DETAILPROJECT_cons_emb);
       $this->grid_V_RESUME_DETAILPROJECT = new grid_V_RESUME_DETAILPROJECT_apl ;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_RESUME_DETAILPROJECT']['embutida'] = false;
       unset($_SESSION['scriptcase']['grid_V_RESUME_DETAILPROJECT']['protect_modal']);
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['charts_html'] = '';
   ...
   { 
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_V_TBL_PROJECT'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'];
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] == "pdf")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] == "pdf")
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] = "igual";
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'];
 }
...
//
   ...
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_V_TBL_PROJECT/grid_V_TBL_PROJECT_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['doc_word'])
       { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'])
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['force_toolbar']);
   } 
   $this->width_tabula_quebra  = "0px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_V_TBL_PROJECT']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_V_TBL_PROJECT']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_V_TBL_PROJECT']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opc_psq'])
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['mostra_edit'] = "N";
   }
   $this->NM_cont_emb_linha = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['emb_linha'];
   $this->NM_cont_body   = 0; 
   $this->NM_emb_tree_no = false; 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'])
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("grid_V_TBL_PROJECT", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_V_TBL_PROJECT']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_V_TBL_PROJECT']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_V_TBL_PROJECT']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_pesq_ant'];  
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] = "muda_qt_linhas";
   } 

   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_V_TBL_PROJECT'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_V_TBL_PROJECT'];
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_V_TBL_PROJECT/grid_V_TBL_PROJECT_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_V_TBL_PROJECT_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new grid_V_TBL_PROJECT_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_V_TBL_PROJECT']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_V_TBL_PROJECT']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_V_TBL_PROJECT']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_V_TBL_PROJECT']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_V_TBL_PROJECT']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_V_TBL_PROJECT']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_V_TBL_PROJECT']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_V_TBL_PROJECT']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_quebra'] = array(); 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_orig'] = "";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_pesq_filtro'] = "";
   }   
   if  (!empty($this->nm_where_dinamico)) 
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao']       = "igual" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_RESUME_DETAILPROJECT']['opcao_print'] = "print" ; 
   } 
// 
   $this->count_ger = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['sc_total']);
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $this->tp_idlop = $this->rs_grid->fields[2] ;  
       ...
       $this->tp_summary = $this->rs_grid->fields[12] ;  
       $this->tp_status = $this->rs_grid->fields[13] ;  
       $this->tp_status = (string)$this->tp_status;
       $this->tp_actualstart = $this->rs_grid->fields[14] ;  
       $this->tp_actualfinish = $this->rs_grid->fields[15] ;  
       $this->tp_templateproject = $this->rs_grid->fields[16] ;  
       ...
       $this->tp_ponumber = $this->rs_grid->fields[20] ;  
       $this->tp_nokontrak = $this->rs_grid->fields[21] ;  
       $this->realisasi = $this->rs_grid->fields[22] ;  
       $this->realisasi = (string)$this->realisasi;
       $this->tm_namamitra = $this->rs_grid->fields[23] ;  
       $this->statusname = $this->rs_grid->fields[24] ;  
       $this->templatename = $this->rs_grid->fields[25] ;  
       $this->md_kodedivre = $this->rs_grid->fields[26] ;  
       $this->mw_namawitel = $this->rs_grid->fields[27] ;  
       $this->md_namadatel = $this->rs_grid->fields[28] ;  
       $this->ms_namasto = $this->rs_grid->fields[29] ;  
       $this->tp_releasename = $this->rs_grid->fields[30] ;  
       $this->tj_namajenis = $this->rs_grid->fields[31] ;  
       ...
       $this->tp_prosentase = $this->rs_grid->fields[34] ;  
       $this->tp_prosentase =  str_replace(",", ".", $this->tp_prosentase);
       $this->tp_prosentase = (string)$this->tp_prosentase;
       $this->SC_seq_register = $this->nmgp_reg_start ; 
       $this->SC_seq_page = 0;
       $this->SC_sep_quebra = false;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['final']; 
   ...
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'])
   { 
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - V_TBL_PROJECT :: PDF</TITLE>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['pivot_charts']) : 0;
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>" . $this->Ini->Nm_lang['lang_othr_grid_titl'] . " - V_TBL_PROJECT</TITLE>\r\n");
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ajax_nav'])
       { 
           ...
           $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . session_id() . "\">\r\n");
           $nm_saida->saida("   </form>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_V_TBL_PROJECT_jquery.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_V_TBL_PROJECT_ajax.js\"></script>\r\n");
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($this->count_ger) . ";\r\n");
           }
           else
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_reg_grid']) . ";\r\n");
           }
           $gridWidthCorrection = '';
           ...
           $nm_saida->saida("   gridHeaders = $(\".sc-ui-grid-header-row-grid_V_TBL_PROJECT-1\");\r\n");
           ...
           $nm_saida->saida("   tableOriginal = $(\"#sc-ui-grid-body-9eb472f4\");\r\n");
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
           ...
           $nm_saida->saida("       dataType: \"html\",\r\n");
           $nm_saida->saida("       url: \"grid_V_TBL_PROJECT_save_grid.php\",\r\n");
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_V_TBL_PROJECT_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'])
       {
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_V_TBL_PROJECT_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_V_TBL_PROJECT_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_V_TBL_PROJECT/grid_V_TBL_PROJECT_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           $cada_css = ".grid_V_TBL_PROJECT_" . substr($cada_css, 1);
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'])
   { 
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf" && !$this->Print_All)
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['doc_word'])
       { 
       ...
       $nm_saida->saida("       <TABLE width='100%' cellspacing=0 cellpadding=0>\r\n");
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf" && 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao_print'] != "print") 
       { 
           $nm_saida->saida("    <TR>\r\n");
           $nm_saida->saida("    <TD  colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_A_grid_V_TBL_PROJECT\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_A_grid_V_TBL_PROJECT\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
           $nm_saida->saida("    <TR>\r\n");
           $nm_saida->saida("    <TD style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_E_grid_V_TBL_PROJECT\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_E_grid_V_TBL_PROJECT\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    <td style=\"padding: 0px;  vertical-align: top;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\"><tr>\r\n");
           $nm_saida->saida("    <TD colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\" width=1>\r\n");
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_AL_grid_V_TBL_PROJECT\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_AL_grid_V_TBL_PROJECT\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
        } 
   }  
 ...
 {  
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_RESUME_DETAILPROJECT']['cab_embutida'] = "N";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_RESUME_DETAILPROJECT']['SC_herda_css'] = "S"; 
   $compl_css = "";
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'])
   {
       ...
       $_SESSION['scriptcase']['grid_V_RESUME_DETAILPROJECT']['protect_modal'] = $this->Ini->sc_page;
       include_once ($this->Ini->link_grid_V_RESUME_DETAILPROJECT_cons_emb);
       $this->grid_V_RESUME_DETAILPROJECT = new grid_V_RESUME_DETAILPROJECT_sub_css ;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_RESUME_DETAILPROJECT']['embutida'] = false;
       unset($_SESSION['scriptcase']['grid_V_RESUME_DETAILPROJECT']['protect_modal']);
       $this->NM_css_val_embed = "sznmxizkjnvl";
       $this->NM_css_ajx_embed = "Ajax_res";
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_V_TBL_PROJECT']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_V_TBL_PROJECT']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_V_TBL_PROJECT']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_V_TBL_PROJECT']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida']) ? "grid_V_TBL_PROJECT_" : "";
   $this->css_sep = " ";
...
//----- 
 function cabecalho()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opc_liga']['cab']))
   {
       return; 
   }
   $nm_cab_filtro   = ""; 
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cond_pesq'], 0, $trab_pos);
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['sv_dt_head'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['sv_dt_head']['fix'] = $nm_data_fixa;
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['sv_dt_head']['fix'] != $nm_data_fixa)
   {
       $nm_refresch_cab_rod = true;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
       $_SESSION['scriptcase']['saida_html'] = "";
   } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['sv_dt_head']['fix'] = $nm_data_fixa;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf")
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['doc_word'])
   {
       $loc_img_word = $this->Ini->root . $this->Ini->path_imag_cab . "/scriptcase__NM__scriptcase5_logo_simple.png";
   ...
   {
       $img_NM_CAB_LOGOTIPO = $this->NM_raiz_img . $this->Ini->path_imag_cab . "/scriptcase__NM__scriptcase5_logo_simple.png";
   }
   ...
   $nm_saida->saida("          " . $this->Ini->Nm_lang['lang_othr_grid_titl'] . " - V_TBL_PROJECT\r\n");
   $nm_saida->saida("        </TD>\r\n");
   $nm_saida->saida("       </TR>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_V_TBL_PROJECT__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-grid_V_TBL_PROJECT-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_tp_prosentase_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_tp_prosentase_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida_pdf'] != "pdf") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_tp_prosentase_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['exibe_seq'] == "S")) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_tp_prosentase_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
     ...
     { 
         ...
         { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 $css_emb .= ".grid_V_TBL_PROJECT_" . substr($cada_css, 1);
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_tp_id()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_cmp'] == 'TP_ID')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_label'] == "desc")
          {
 ...
 function NM_label_tp_thn_release()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_cmp'] == 'TP_THN_RELEASE')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_idlop()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_cmp'] == 'TP_IDLOP')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_batch()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_cmp'] == 'TP_BATCH')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_projectname()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_cmp'] == 'TP_PROJECTNAME')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_lokasi()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_cmp'] == 'TP_LOKASI')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_jmlport()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_tp_jmlport_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_tp_jmlport_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ini_cor_grid']);
       }
   }
...
// 
   $SC_Label = (isset($this->New_label['tp_id'])) ? $this->New_label['tp_id'] : "TP ID"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_id'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_thn_release'])) ? $this->New_label['tp_thn_release'] : "TP THN RELEASE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_thn_release'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_idlop'])) ? $this->New_label['tp_idlop'] : "TP IDLOP"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_idlop'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_batch'])) ? $this->New_label['tp_batch'] : "TP BATCH"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_batch'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_projectname'])) ? $this->New_label['tp_projectname'] : "TP PROJECTNAME"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_projectname'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_lokasi'])) ? $this->New_label['tp_lokasi'] : "TP LOKASI"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_lokasi'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_mitra'])) ? $this->New_label['tp_mitra'] : "TP MITRA"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_mitra'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_odp'])) ? $this->New_label['tp_odp'] : "TP ODP"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_odp'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_jmlport'])) ? $this->New_label['tp_jmlport'] : "TP JMLPORT"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_jmlport'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_jmldistribusi'])) ? $this->New_label['tp_jmldistribusi'] : "TP JMLDISTRIBUSI"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_jmldistribusi'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_planstart'])) ? $this->New_label['tp_planstart'] : "TP PLANSTART"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_planstart'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_planfinish'])) ? $this->New_label['tp_planfinish'] : "TP PLANFINISH"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_planfinish'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_summary'])) ? $this->New_label['tp_summary'] : "TP SUMMARY"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_summary'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_status'])) ? $this->New_label['tp_status'] : "TP STATUS"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_status'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_actualstart'])) ? $this->New_label['tp_actualstart'] : "TP ACTUALSTART"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_actualstart'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_actualfinish'])) ? $this->New_label['tp_actualfinish'] : "TP ACTUALFINISH"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_actualfinish'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_templateproject'])) ? $this->New_label['tp_templateproject'] : "TP TEMPLATEPROJECT"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_templateproject'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_jenisproject'])) ? $this->New_label['tp_jenisproject'] : "TP JENISPROJECT"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_jenisproject'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_prjtrelease'])) ? $this->New_label['tp_prjtrelease'] : "TP PRJTRELEASE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_prjtrelease'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_targetwaktu'])) ? $this->New_label['tp_targetwaktu'] : "TP TARGETWAKTU"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_targetwaktu'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_ponumber'])) ? $this->New_label['tp_ponumber'] : "TP PONUMBER"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_ponumber'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_nokontrak'])) ? $this->New_label['tp_nokontrak'] : "TP NOKONTRAK"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_nokontrak'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['realisasi'])) ? $this->New_label['realisasi'] : "REALISASI"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['realisasi'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tm_namamitra'])) ? $this->New_label['tm_namamitra'] : "TM NAMAMITRA"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tm_namamitra'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['statusname'])) ? $this->New_label['statusname'] : "STATUSNAME"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['statusname'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['templatename'])) ? $this->New_label['templatename'] : "TEMPLATENAME"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['templatename'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['md_kodedivre'])) ? $this->New_label['md_kodedivre'] : "MD KODEDIVRE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['md_kodedivre'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['mw_namawitel'])) ? $this->New_label['mw_namawitel'] : "MW NAMAWITEL"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['mw_namawitel'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['md_namadatel'])) ? $this->New_label['md_namadatel'] : "MD NAMADATEL"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['md_namadatel'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ms_namasto'])) ? $this->New_label['ms_namasto'] : "MS NAMASTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['ms_namasto'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_releasename'])) ? $this->New_label['tp_releasename'] : "TP RELEASENAME"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_releasename'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tj_namajenis'])) ? $this->New_label['tj_namajenis'] : "TJ NAMAJENIS"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tj_namajenis'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_nilai'])) ? $this->New_label['tp_nilai'] : "TP NILAI"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_nilai'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_rab'])) ? $this->New_label['tp_rab'] : "TP RAB"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_rab'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_prosentase'])) ? $this->New_label['tp_prosentase'] : "TP PROSENTASE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['labels']['tp_prosentase'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_V_TBL_PROJECT']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_V_TBL_PROJECT']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_V_TBL_PROJECT']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_V_TBL_PROJECT#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               $nm_saida->saida("  <tr><td class=\"" . $this->css_scGridTabelaTd . " " . "\" style=\"font-family:" . $this->Ini->texto_fonte_tipo_impar . ";font-size:12px;color:#000000;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\">\r\n");
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cab_embutida'] != "S")
               {
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_grid_V_TBL_PROJECT\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_grid_V_TBL_PROJECT\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               $nm_saida->saida("    </TD>\r\n");
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  " . $this->nm_grid_sem_reg . "\r\n");
           ...
           { 
               ...
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_A_grid_V_TBL_PROJECT', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_D_grid_V_TBL_PROJECT', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_E_grid_V_TBL_PROJECT', 'value' => 'NM_Blank_Page.htm');
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  </td></tr>\r\n");
           if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf" &&
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_DL_grid_V_TBL_PROJECT\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_DL_grid_V_TBL_PROJECT\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               $nm_saida->saida("</TD>\r\n");
               $nm_saida->saida("    <TD style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_D_grid_V_TBL_PROJECT\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_D_grid_V_TBL_PROJECT\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               $nm_saida->saida("    </TD>\r\n");
               $nm_saida->saida("    </TR>\r\n");
           } 
       $nm_saida->saida("</TABLE>\r\n");
   ...
   { 
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_grid_V_TBL_PROJECT\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_grid_V_TBL_PROJECT\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       ...
       $nm_id_aplicacao = " id=\"apl_grid_V_TBL_PROJECT#?#1\"";
   } 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-9eb472f4\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida_grid'])
   { 
       $_SESSION['scriptcase']['saida_html'] = "";
   } 
// 
   ...
   $ini_grid = true;
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          $this->NM_field_style = array();
          $this->NM_cont_emb_linha++;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['emb_linha']++;
          if ($this->Ini->qual_linha == "impar")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_RESUME_DETAILPROJECT']['ini_cor_grid'] = "impar";
          }
          //---------- Gauge ----------
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
          ...
          $this->tp_prosentase = (string)$this->tp_prosentase;
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['final'] + 1; 
          if (!$ini_grid) {
          ...
          if (($nm_houve_quebra == "S" || $nm_inicio_pag == 0) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida_grid'])
          { 
              $this->label_grid($linhas);
              $nm_houve_quebra = "N";
          } 
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['dado_psq_ret'];
              eval("\$teste = \$this->$temp;");
          }
          $this->SC_ancora = $this->SC_seq_page;
          $nm_saida->saida("    <TR  class=\"" . $this->css_line_back . "\"" . $NM_destaque . " id=\"SC_ancor" . $this->SC_ancora . "\">\r\n");
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_detail_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"  >&nbsp;</TD>\r\n");
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_detail_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\" >\r\n");
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . $teste . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . $teste . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
          $nm_saida->saida(" $Cod_Btn</TD>\r\n");
 } 
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['mostra_edit'] != "N"){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  NOWRAP align=\"center\" valign=\"top\" WIDTH=\"1px\" ><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px;\"><tr><td style=\"padding: 0px\"><img id=\"b_open_emb_grid_V_TBL_PROJECT_linha_" . $this->NM_cont_emb_linha . "\" style=\"display:''\" onclick=\"document.getElementById('b_open_emb_grid_V_TBL_PROJECT_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; document.getElementById('b_close_emb_grid_V_TBL_PROJECT_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; document.getElementById('emb_grid_V_TBL_PROJECT_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">\r\n");
          $nm_saida->saida("<img id=\"b_close_emb_grid_V_TBL_PROJECT_linha_" . $this->NM_cont_emb_linha . "\" style=\"display:none\" onclick=\"document.getElementById('b_close_emb_grid_V_TBL_PROJECT_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; document.getElementById('b_open_emb_grid_V_TBL_PROJECT_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; document.getElementById('emb_grid_V_TBL_PROJECT_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">\r\n");
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida_pdf'] != "pdf"){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  NOWRAP align=\"center\" valign=\"top\" WIDTH=\"1px\" ><img id=\"b_open_emb_grid_V_TBL_PROJECT_linha_" . $this->NM_cont_emb_linha . "\" style=\"display:''\" onclick=\"document.getElementById('b_open_emb_grid_V_TBL_PROJECT_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; document.getElementById('b_close_emb_grid_V_TBL_PROJECT_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; document.getElementById('emb_grid_V_TBL_PROJECT_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">\r\n");
          $nm_saida->saida("<img id=\"b_close_emb_grid_V_TBL_PROJECT_linha_" . $this->NM_cont_emb_linha . "\" style=\"display:none\" onclick=\"document.getElementById('b_close_emb_grid_V_TBL_PROJECT_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; document.getElementById('b_open_emb_grid_V_TBL_PROJECT_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; document.getElementById('emb_grid_V_TBL_PROJECT_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">\r\n");
          $nm_saida->saida("</TD>\r\n");
 } 
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['exibe_seq'] == "S")) { 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  NOWRAP align=\"right\" valign=\"top\"  >" . $seq_det . "</TD>\r\n");
 } 
          ...
          { 
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida_pdf'] != "pdf")
              { 
                  $nm_saida->saida("<TR  class=\"" . $this->css_line_back . "\" id=\"emb_grid_V_TBL_PROJECT_linha_" . $this->NM_cont_emb_linha . "\"  style=\"display:none\">\r\n");
              } 
              else 
              { 
                  $nm_saida->saida("<TR  class=\"" . $this->css_line_back . "\" id=\"emb_grid_V_TBL_PROJECT_linha_" . $this->NM_cont_emb_linha . "\"  style=\"display:''\">\r\n");
              } 
          ...
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   if (method_exists($this->grid_V_RESUME_DETAILPROJECT, "close_emb")) 
   {
       $this->grid_V_RESUME_DETAILPROJECT->close_emb();
   }
   if (!$this->rs_grid->EOF) 
   { 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida_grid'])
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf" && empty($this->nm_grid_sem_reg) && 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao_print'] != "print") 
   { 
       $nm_saida->saida("</TABLE></TD>\r\n");
       $nm_saida->saida("<TD style=\"padding: 0px; border-width: 0px;\" valign=\"top\" width=1>\r\n");
 ...
 function NM_grid_detail()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_detail_grid_line . "\"  style=\"" . $this->Css_Cmp['css_detail_grid_line'] . "\"  align=\"\" valign=\"\"  >\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_RESUME_DETAILPROJECT']['embutida_treeview'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida_pdf'] != "pdf")
          { 
              $link_div = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_RESUME_DETAILPROJECT']['ind_tree']++;
              $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_RESUME_DETAILPROJECT']['ind_tree'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_V_RESUME_DETAILPROJECT'][$this->NM_cont_body][1] = 'top';
              if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp)
              { 
                  $link_div  = "<img id=\"b_open_grid_V_RESUME_DETAILPROJECT_" . $this->NM_cont_body . "\" style=\"display:''\" onclick=\"document.getElementById('b_open_grid_V_RESUME_DETAILPROJECT_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_close_grid_V_RESUME_DETAILPROJECT_" . $this->NM_cont_body . "').style.display = ''; NM_liga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_V_RESUME_DETAILPROJECT, 'grid_V_RESUME_DETAILPROJECT'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">";
                  $link_div .= "<img id=\"b_close_grid_V_RESUME_DETAILPROJECT_" . $this->NM_cont_body . "\" style=\"display:none\" onclick=\"document.getElementById('b_close_grid_V_RESUME_DETAILPROJECT_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_open_grid_V_RESUME_DETAILPROJECT_" . $this->NM_cont_body . "').style.display = ''; NM_apaga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_V_RESUME_DETAILPROJECT, 'grid_V_RESUME_DETAILPROJECT'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">";
              }
              $nm_saida->saida("<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\">");
              $nm_saida->saida("<TR> <TD align=\"left\">");
              $nm_saida->saida("<DIV id=\"tbody_grid_V_RESUME_DETAILPROJECT_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
              $nm_saida->saida($link_div . "</DIV></TD></TR>");
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_RESUME_DETAILPROJECT']['ind_tree']++;
              $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_RESUME_DETAILPROJECT']['ind_tree'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_V_RESUME_DETAILPROJECT'][$this->NM_cont_body][1] = 'bot';
              $nm_saida->saida("<tr><td>");
              if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp)
              { 
                  $nm_saida->saida("<DIV id=\"tbody_grid_V_RESUME_DETAILPROJECT_" . $this->NM_cont_body . "_bot\" style=\"display:none\">");
              }
              else
              { 
                  $nm_saida->saida("<DIV id=\"tbody_grid_V_RESUME_DETAILPROJECT_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
              }
          }
          $GLOBALS["script_case_init"] = $this->Ini->sc_page;
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_RESUME_DETAILPROJECT']['embutida'] = false;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_RESUME_DETAILPROJECT']['emb_lig_aba']))
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'])
              { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['emb_lig_aba'] = array_merge($this->Ini->Init_apl_lig, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_RESUME_DETAILPROJECT']['emb_lig_aba']);
              }
              else 
              { 
                 $this->Ini->Init_apl_lig = array_merge($this->Ini->Init_apl_lig, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_RESUME_DETAILPROJECT']['emb_lig_aba']);
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_RESUME_DETAILPROJECT']['embutida_treeview'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida_pdf'] != "pdf")
          { 
 ...
 function NM_calc_span()
 {
   ...
   {
       $this->NM_colspan--;
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['exibe_seq'] != "S" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf")
       {
           $this->NM_colspan--; 
       }
   } 
 ...
 function quebra_geral_sc_free_total_bot() 
 {
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            </div>\r\n");
              ...
              $nm_saida->saida("           </td></tr><tr><td class=\"scBtnGrpBackground\">\r\n");
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_V_TBL_PROJECT/grid_V_TBL_PROJECT_config_print.php?nm_opc=AM&nm_cor=AM&language=en_us&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['filter'] == "on"  && !$this->grid_emb_form)
      {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['SC_Ind_Groupby'] != "sc_free_total")
        {
          ...
          if (is_file("grid_V_TBL_PROJECT_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("grid_V_TBL_PROJECT_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['dashboard_info']['under_dashboard']))
      {
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['sc_modal'])
        {
   ...
   function nmgp_barra_bot_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao_print'] != "print") 
      {
          ...
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_lin_grid'];
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_lin_grid'] == 10) ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_lin_grid'] == 20) ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_lin_grid'] == 50) ? " selected" : "";
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opc_liga']['nav']))
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_avanca", "nm_gp_submit_rec('" . $this->Rec_fim . "')", "nm_gp_submit_rec('" . $this->Rec_fim . "')", "forward_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opc_liga']['nav']))
          {
   ...
   function nmgp_barra_top_mobile()
   {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['fast_search'][2] : "";
      ...
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          else
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_V_TBL_PROJECT/grid_V_TBL_PROJECT_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_V_TBL_PROJECT/grid_V_TBL_PROJECT_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf" &&
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao_print'] != "print" && !$this->Print_All) 
   { 
      $nm_saida->saida("     <tr><td colspan=3  class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\"> \r\n");
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_B_grid_V_TBL_PROJECT\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_B_grid_V_TBL_PROJECT\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
      $nm_saida->saida("     </td></tr> \r\n");
   } 
   $nm_saida->saida("   </TABLE>\r\n");
   $nm_saida->saida("   </div>\r\n");
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           if ($this->arr_buttons['bcons_avanca']['type'] != 'image')
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
   ...
   {
       $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
       $nm_saida->saida("      parent.scAjaxDetailHeight('grid_V_TBL_PROJECT', $(document).innerHeight());\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
 }
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_V_TBL_PROJECT\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_V_TBL_PROJECT_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . NM_encode_input(session_id()) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("                     action=\"grid_V_TBL_PROJECT_iframe_prt.php\" \r\n");
   ...
   if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['sc_modal']) || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['dashboard_info']['under_dashboard'])) {
   ...
   $nm_saida->saida("      {\r\n");
   $nm_saida->saida("          NM_ancor_ult_lig = ancor;\r\n");
   $nm_saida->saida("          par_modal = '?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&nmgp_outra_jan=true&nmgp_url_saida=modal&SC_lig_apl_orig=grid_V_TBL_PROJECT';\r\n");
   $nm_saida->saida("          if (opc != null && opc != '') \r\n");
   $nm_saida->saida("          {\r\n");
   ...
   $nm_saida->saida("          return;\r\n");
   $nm_saida->saida("      }\r\n");
   $nm_saida->saida("      if (pos == \"A\") {obj = document.getElementById('nmsc_iframe_liga_A_grid_V_TBL_PROJECT');} \r\n");
   $nm_saida->saida("      if (pos == \"B\") {obj = document.getElementById('nmsc_iframe_liga_B_grid_V_TBL_PROJECT');} \r\n");
   $nm_saida->saida("      if (pos == \"E\") {obj = document.getElementById('nmsc_iframe_liga_E_grid_V_TBL_PROJECT');} \r\n");
   $nm_saida->saida("      if (pos == \"D\") {obj = document.getElementById('nmsc_iframe_liga_D_grid_V_TBL_PROJECT');} \r\n");
   ...
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['grid_V_TBL_PROJECT_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_V_TBL_PROJECT@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   $nm_saida->saida("       if (\"pdf\" == x)\r\n");
   $nm_saida->saida("       {\r\n");
   $nm_saida->saida("           window.location = \"" . $this->Ini->path_link . "grid_V_TBL_PROJECT/grid_V_TBL_PROJECT_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_create_charts=\" + crt + \"&sc_graf_pdf=\" + g;\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_V_TBL_PROJECT']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Doc = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Doc = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Doc = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_V_TBL_PROJECT_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['reg_start']))
   {
       $nm_saida->saida("      parent.scAjaxDetailStatus('grid_V_TBL_PROJECT');\r\n");
       $nm_saida->saida("      parent.scAjaxDetailHeight('grid_V_TBL_PROJECT', $(document).innerHeight());\r\n");
   }
   $nm_saida->saida("   </script>\r\n");
 }
