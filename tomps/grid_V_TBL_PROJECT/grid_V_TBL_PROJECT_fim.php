...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["projectamo_____grid_V_TBL_PROJECT"]))
   {
      unset($_SESSION['session_sec_aplicacao']["projectamo_____grid_V_TBL_PROJECT"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_V_TBL_PROJECT']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_V_TBL_PROJECT']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_V_TBL_PROJECT']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_V_TBL_PROJECT']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_V_TBL_PROJECT']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_V_TBL_PROJECT</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_V_TBL_PROJECT']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_V_TBL_PROJECT']['embutida_filho'] as $ind => $sc_init)
          {
