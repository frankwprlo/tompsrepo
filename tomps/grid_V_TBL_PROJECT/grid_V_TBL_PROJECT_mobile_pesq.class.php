...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_tp_id"  <?php echo $str_hide_tp_id?>><?php
      if ($tp_id != "")
      {
      $tp_id_look = substr($this->Db->qstr($tp_id), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_tp_thn_release"  <?php echo $str_hide_tp_thn_release?>><?php
      if ($tp_thn_release != "")
      {
      $tp_thn_release_look = substr($this->Db->qstr($tp_thn_release), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_tp_idlop"  <?php echo $str_hide_tp_idlop?>><?php
      if ($tp_idlop != "")
      {
      $tp_idlop_look = substr($this->Db->qstr($tp_idlop), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_tp_batch"  <?php echo $str_hide_tp_batch?>><?php
      if ($tp_batch != "")
      {
      $tp_batch_look = substr($this->Db->qstr($tp_batch), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_tp_divre"  <?php echo $str_hide_tp_divre?>><?php
      if ($tp_divre != "")
      {
      $tp_divre_look = substr($this->Db->qstr($tp_divre), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_tp_witel"  <?php echo $str_hide_tp_witel?>><?php
      if ($tp_witel != "")
      {
      $tp_witel_look = substr($this->Db->qstr($tp_witel), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_tp_sto"  <?php echo $str_hide_tp_sto?>><?php
      if ($tp_sto != "")
      {
      $tp_sto_look = substr($this->Db->qstr($tp_sto), 1, -1); 
      $nmgp_def_dados = array(); 
