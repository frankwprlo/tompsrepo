...
class grid_V_TBL_PROJECT_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_V_TBL_PROJECT_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_V_TBL_PROJECT_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_V_TBL_PROJECT_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_tp_thn_release')
      {
          $tp_thn_release = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_tp_thn_release($tp_thn_release);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_tp_sto')
      {
          $tp_sto = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_tp_sto($tp_sto);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_tp_id($tp_id)
   {
      ...
      {
          $nm_comando = "select distinct TP_ID from " . $this->Ini->nm_tabela . " where   CAST (TP_ID AS TEXT)  like '%" . $tp_id . "%' order by TP_ID"; 
      }
      else
      {
          $nm_comando = "select distinct TP_ID from " . $this->Ini->nm_tabela . " where  TP_ID like '%" . $tp_id . "%' order by TP_ID"; 
      }
   ...
   function lookup_ajax_tp_thn_release($tp_thn_release)
   {
      $tp_thn_release = substr($this->Db->qstr($tp_thn_release), 1, -1);
            $tp_thn_release_look = substr($this->Db->qstr($tp_thn_release), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct TP_THN_RELEASE from " . $this->Ini->nm_tabela . " where  TP_THN_RELEASE like '%" . $tp_thn_release . "%' order by TP_THN_RELEASE"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_tp_idlop($tp_idlop)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct TP_IDLOP from " . $this->Ini->nm_tabela . " where  TP_IDLOP like '%" . $tp_idlop . "%' order by TP_IDLOP"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_tp_batch($tp_batch)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct TP_BATCH from " . $this->Ini->nm_tabela . " where  TP_BATCH like '%" . $tp_batch . "%' order by TP_BATCH"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_tp_divre($tp_divre)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct TP_DIVRE from " . $this->Ini->nm_tabela . " where   CAST (TP_DIVRE AS TEXT)  like '%" . $tp_divre . "%' order by TP_DIVRE"; 
      }
      else
      {
          $nm_comando = "select distinct TP_DIVRE from " . $this->Ini->nm_tabela . " where  TP_DIVRE like '%" . $tp_divre . "%' order by TP_DIVRE"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_tp_witel($tp_witel)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct TP_WITEL from " . $this->Ini->nm_tabela . " where   CAST (TP_WITEL AS TEXT)  like '%" . $tp_witel . "%' order by TP_WITEL"; 
      }
      else
      {
          $nm_comando = "select distinct TP_WITEL from " . $this->Ini->nm_tabela . " where  TP_WITEL like '%" . $tp_witel . "%' order by TP_WITEL"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_tp_sto($tp_sto)
   {
      $tp_sto = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $tp_sto);
      $tp_sto = substr($this->Db->qstr($tp_sto), 1, -1);
            $tp_sto_look = substr($this->Db->qstr($tp_sto), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct TP_STO from " . $this->Ini->nm_tabela . " where   CAST (TP_STO AS TEXT)  like '%" . $tp_sto . "%' order by TP_STO"; 
      }
      else
      {
          $nm_comando = "select distinct TP_STO from " . $this->Ini->nm_tabela . " where  TP_STO like '%" . $tp_sto . "%' order by TP_STO"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - V_TBL_PROJECT</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_V_TBL_PROJECT/grid_V_TBL_PROJECT_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_V_TBL_PROJECT_ajax_search.js"></script>
 <script type="text/javascript" src="grid_V_TBL_PROJECT_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_tp_id_cond#NMF#' + search_get_sel_txt('SC_tp_id_cond') + '@NMF@';
  str_out += 'SC_tp_id#NMF#' + search_get_text('SC_tp_id') + '@NMF@';
  str_out += 'id_ac_tp_id#NMF#' + search_get_text('id_ac_tp_id') + '@NMF@';
  str_out += 'SC_tp_thn_release_cond#NMF#' + search_get_sel_txt('SC_tp_thn_release_cond') + '@NMF@';
  str_out += 'SC_tp_thn_release#NMF#' + search_get_text('SC_tp_thn_release') + '@NMF@';
  str_out += 'id_ac_tp_thn_release#NMF#' + search_get_text('id_ac_tp_thn_release') + '@NMF@';
  str_out += 'SC_tp_idlop_cond#NMF#' + search_get_sel_txt('SC_tp_idlop_cond') + '@NMF@';
  str_out += 'SC_tp_idlop#NMF#' + search_get_text('SC_tp_idlop') + '@NMF@';
  str_out += 'id_ac_tp_idlop#NMF#' + search_get_text('id_ac_tp_idlop') + '@NMF@';
  ...
  str_out += 'SC_tp_sto#NMF#' + search_get_text('SC_tp_sto') + '@NMF@';
  str_out += 'id_ac_tp_sto#NMF#' + search_get_text('id_ac_tp_sto') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   ...
   $("#id_ac_tp_thn_release").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_tp_thn_release",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_tp_thn_release").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_tp_thn_release").val( $(this).val() );
       }
     }
   });
   ...
   $("#id_ac_tp_sto").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_tp_sto",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_tp_sto").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_tp_sto").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - V_TBL_PROJECT</span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $tp_thn_release_cond, $tp_thn_release, $tp_thn_release_autocomp,
             ...
             $tp_sto_cond, $tp_sto, $tp_sto_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $tp_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_id']; 
          $tp_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_id_cond']; 
          $tp_thn_release = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_thn_release']; 
          $tp_thn_release_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_thn_release_cond']; 
          $tp_idlop = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_idlop']; 
          $tp_idlop_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_idlop_cond']; 
          $tp_batch = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_batch']; 
          $tp_batch_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_batch_cond']; 
          $tp_divre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_divre']; 
          $tp_divre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_divre_cond']; 
          $tp_witel = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_witel']; 
          $tp_witel_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_witel_cond']; 
          $tp_sto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_sto']; 
          $tp_sto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_sto_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['NM_operador']; 
      } 
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['tp_id'])) ? $this->New_label['tp_id'] : "TP ID"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_tp_id_cond" name="tp_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_tp_id'), this, 'tp_id')">
       <OPTION value="gt" <?php if ("gt" == $tp_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $tp_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $tp_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tp_id" <?php echo $str_hide_tp_id?> valign="top">
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct TP_ID from " . $this->Ini->nm_tabela . " where TP_ID = $tp_id_look order by TP_ID"; 
      }
      else
      {
          $nm_comando = "select distinct TP_ID from " . $this->Ini->nm_tabela . " where TP_ID = $tp_id_look order by TP_ID"; 
...
?>
<INPUT  type="text" id="SC_tp_id" name="tp_id" value="<?php echo NM_encode_input($tp_id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_tp_id" name="tp_id_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['tp_thn_release'])) ? $this->New_label['tp_thn_release'] : "TP THN RELEASE"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_tp_thn_release_cond" name="tp_thn_release_cond" onChange="nm_campos_between(document.getElementById('id_vis_tp_thn_release'), this, 'tp_thn_release')">
       <OPTION value="qp" <?php if ("qp" == $tp_thn_release_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $tp_thn_release_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $tp_thn_release_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $tp_thn_release_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
      ...
      $tp_thn_release_look = substr($this->Db->qstr($tp_thn_release), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct TP_THN_RELEASE from " . $this->Ini->nm_tabela . " where TP_THN_RELEASE = '$tp_thn_release_look' order by TP_THN_RELEASE"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$tp_thn_release]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$tp_thn_release];
      }
      else
      {
          $sAutocompValue = $tp_thn_release;
      }
?>
<INPUT  type="text" id="SC_tp_thn_release" name="tp_thn_release" value="<?php echo NM_encode_input($tp_thn_release) ?>" size=4 alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_tp_thn_release" name="tp_thn_release_autocomp" size="4" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['tp_idlop'])) ? $this->New_label['tp_idlop'] : "TP IDLOP"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_tp_idlop_cond" name="tp_idlop_cond" onChange="nm_campos_between(document.getElementById('id_vis_tp_idlop'), this, 'tp_idlop')">
       <OPTION value="qp" <?php if ("qp" == $tp_idlop_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $tp_idlop_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $tp_idlop_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $tp_idlop_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
      ...
      $tp_idlop_look = substr($this->Db->qstr($tp_idlop), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct TP_IDLOP from " . $this->Ini->nm_tabela . " where TP_IDLOP = '$tp_idlop_look' order by TP_IDLOP"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<INPUT  type="text" id="SC_tp_idlop" name="tp_idlop" value="<?php echo NM_encode_input($tp_idlop) ?>" size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_tp_idlop" name="tp_idlop_autocomp" size="20" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['tp_batch'])) ? $this->New_label['tp_batch'] : "TP BATCH"; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<?php
      ...
      $tp_batch_look = substr($this->Db->qstr($tp_batch), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct TP_BATCH from " . $this->Ini->nm_tabela . " where TP_BATCH = '$tp_batch_look' order by TP_BATCH"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_tp_batch" name="tp_batch_autocomp" size="30" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['tp_divre'])) ? $this->New_label['tp_divre'] : "TP DIVRE"; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct TP_DIVRE from " . $this->Ini->nm_tabela . " where TP_DIVRE = $tp_divre_look order by TP_DIVRE"; 
      }
      else
      {
          $nm_comando = "select distinct TP_DIVRE from " . $this->Ini->nm_tabela . " where TP_DIVRE = $tp_divre_look order by TP_DIVRE"; 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_tp_divre" name="tp_divre_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['tp_witel'])) ? $this->New_label['tp_witel'] : "TP WITEL"; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct TP_WITEL from " . $this->Ini->nm_tabela . " where TP_WITEL = $tp_witel_look order by TP_WITEL"; 
      }
      else
      {
          $nm_comando = "select distinct TP_WITEL from " . $this->Ini->nm_tabela . " where TP_WITEL = $tp_witel_look order by TP_WITEL"; 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_tp_witel" name="tp_witel_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['tp_sto'])) ? $this->New_label['tp_sto'] : "TP STO"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_tp_sto_cond" name="tp_sto_cond" onChange="nm_campos_between(document.getElementById('id_vis_tp_sto'), this, 'tp_sto')">
       <OPTION value="gt" <?php if ("gt" == $tp_sto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $tp_sto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $tp_sto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
      ...
      $tp_sto_look = substr($this->Db->qstr($tp_sto), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($tp_sto))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct TP_STO from " . $this->Ini->nm_tabela . " where TP_STO = $tp_sto_look order by TP_STO"; 
      }
      else
      {
          $nm_comando = "select distinct TP_STO from " . $this->Ini->nm_tabela . " where TP_STO = $tp_sto_look order by TP_STO"; 
      ...
      if (isset($nmgp_def_dados[0][$tp_sto]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$tp_sto];
      }
      else
      {
            nmgp_Form_Num_Val($tp_sto, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $tp_sto;
      }
?>
<INPUT  type="text" id="SC_tp_sto" name="tp_sto" value="<?php echo NM_encode_input($tp_sto) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_tp_sto" name="tp_sto_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_V_TBL_PROJECT_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_V_TBL_PROJECT']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_V_TBL_PROJECT']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.tp_thn_release_autocomp.value = "";
   ...
   document.F1.tp_sto_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "projectamo/grid_V_TBL_PROJECT";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_tp_id_cond'] = 'cond';
      $tp_fields['SC_tp_id'] = 'text_aut';
      $tp_fields['id_ac_tp_id'] = 'text_aut';
      $tp_fields['SC_tp_thn_release_cond'] = 'cond';
      $tp_fields['SC_tp_thn_release'] = 'text_aut';
      $tp_fields['id_ac_tp_thn_release'] = 'text_aut';
      $tp_fields['SC_tp_idlop_cond'] = 'cond';
      $tp_fields['SC_tp_idlop'] = 'text_aut';
      $tp_fields['id_ac_tp_idlop'] = 'text_aut';
      ...
      $tp_fields['SC_tp_sto'] = 'text_aut';
      $tp_fields['id_ac_tp_sto'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $tp_id_cond, $tp_id, $tp_id_autocomp,
             $tp_thn_release_cond, $tp_thn_release, $tp_thn_release_autocomp,
             $tp_idlop_cond, $tp_idlop, $tp_idlop_autocomp,
             $tp_batch_cond, $tp_batch, $tp_batch_autocomp,
             $tp_divre_cond, $tp_divre, $tp_divre_autocomp,
             $tp_witel_cond, $tp_witel, $tp_witel_autocomp,
             $tp_sto_cond, $tp_sto, $tp_sto_autocomp, $nmgp_tab_label;
      ...
      if (!empty($tp_thn_release_autocomp) && empty($tp_thn_release))
      {
          $tp_thn_release = $tp_thn_release_autocomp;
      }
      ...
      if (!empty($tp_sto_autocomp) && empty($tp_sto))
      {
          $tp_sto = $tp_sto_autocomp;
      }
      ...
      if ($tp_sto_cond != "in")
      {
          nm_limpa_numero($tp_sto, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $tp_sto);
          foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
          {
              $Nm_sc_valor = trim($Nm_sc_valor);
              nm_limpa_numero($Nm_sc_valor, $_SESSION['scriptcase']['reg_conf']['grup_num']); 
          ...
          $tp_sto = implode(",", $Nm_sc_valores);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_id'] = $tp_id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_id_cond'] = $tp_id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_thn_release'] = $tp_thn_release; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_thn_release_cond'] = $tp_thn_release_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_idlop'] = $tp_idlop; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_idlop_cond'] = $tp_idlop_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_batch'] = $tp_batch; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_batch_cond'] = $tp_batch_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_divre'] = $tp_divre; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_divre_cond'] = $tp_divre_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_witel'] = $tp_witel; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_witel_cond'] = $tp_witel_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_sto'] = $tp_sto; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['tp_sto_cond'] = $tp_sto_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($tp_id_cond != "in" && $tp_id_cond != "bw" && !empty($tp_id) && !is_numeric($tp_id))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : TP ID";
      }
      ...
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : TP DIVRE";
      }
      ...
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : TP WITEL";
      }
      if ($tp_witel_cond == "bw" && ((!empty($tp_witel) && !is_numeric($tp_witel)) || (!empty($tp_witel_input_2) && !is_numeric($tp_witel_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : TP WITEL";
      }
      if ($tp_sto_cond != "in" && $tp_sto_cond != "bw" && !empty($tp_sto) && !is_numeric($tp_sto))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : TP STO";
      }
      if ($tp_sto_cond == "bw" && ((!empty($tp_sto) && !is_numeric($tp_sto)) || (!empty($tp_sto_input_2) && !is_numeric($tp_sto_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : TP STO";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['tp_thn_release'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['tp_thn_release'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['tp_thn_release'] = $tp_thn_release;
      }
      $tp_idlop_look = substr($this->Db->qstr($tp_idlop), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct TP_IDLOP from " . $this->Ini->nm_tabela . " where TP_IDLOP = '$tp_idlop_look' order by TP_IDLOP"; 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['tp_sto'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['tp_sto'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['tp_sto'] = $tp_sto;
      }
      ...
      //----- $tp_thn_release
      $this->Date_part = false;
      if (isset($tp_thn_release) || $tp_thn_release_cond == "nu" || $tp_thn_release_cond == "nn" || $tp_thn_release_cond == "ep" || $tp_thn_release_cond == "ne")
      {
      ...
      //----- $tp_sto
      $this->Date_part = false;
      if (isset($tp_sto) || $tp_sto_cond == "nu" || $tp_sto_cond == "nn" || $tp_sto_cond == "ep" || $tp_sto_cond == "ne")
      {
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_V_TBL_PROJECT']['where_pesq_ant'] = $this->comando . $this->comando_fim;
