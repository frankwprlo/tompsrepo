...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate ms_idsto_
  function do_ajax_sto_validate_ms_idsto_(iNumLinha)
  {
    var nomeCampo_ms_idsto_ = "ms_idsto_" + iNumLinha;
    var var_ms_idsto_ = scAjaxGetFieldHidden(nomeCampo_ms_idsto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sto_validate_ms_idsto_(var_ms_idsto_, iNumLinha, var_script_case_init, do_ajax_sto_validate_ms_idsto__cb);
  } // do_ajax_sto_validate_ms_idsto_

  function do_ajax_sto_validate_ms_idsto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ms_idsto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ms_idsto_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "ms_idsto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ms_idsto_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sto_validate_ms_idsto__cb

  // ---------- Validate ms_witel_
  function do_ajax_sto_validate_ms_witel_(iNumLinha)
  {
    var nomeCampo_ms_witel_ = "ms_witel_" + iNumLinha;
    var var_ms_witel_ = scAjaxGetFieldSelect(nomeCampo_ms_witel_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sto_validate_ms_witel_(var_ms_witel_, iNumLinha, var_script_case_init, do_ajax_sto_validate_ms_witel__cb);
  } // do_ajax_sto_validate_ms_witel_

  function do_ajax_sto_validate_ms_witel__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ms_witel_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ms_witel_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ms_witel_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ms_witel_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sto_validate_ms_witel__cb

  // ---------- Validate ms_datel_
  function do_ajax_sto_validate_ms_datel_(iNumLinha)
  {
    var nomeCampo_ms_datel_ = "ms_datel_" + iNumLinha;
    var var_ms_datel_ = scAjaxGetFieldSelect(nomeCampo_ms_datel_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sto_validate_ms_datel_(var_ms_datel_, iNumLinha, var_script_case_init, do_ajax_sto_validate_ms_datel__cb);
  } // do_ajax_sto_validate_ms_datel_

  function do_ajax_sto_validate_ms_datel__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ms_datel_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ms_datel_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ms_datel_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ms_datel_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sto_validate_ms_datel__cb

  // ---------- Validate ms_kodesto_
  function do_ajax_sto_validate_ms_kodesto_(iNumLinha)
  {
    var nomeCampo_ms_kodesto_ = "ms_kodesto_" + iNumLinha;
    var var_ms_kodesto_ = scAjaxGetFieldText(nomeCampo_ms_kodesto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sto_validate_ms_kodesto_(var_ms_kodesto_, iNumLinha, var_script_case_init, do_ajax_sto_validate_ms_kodesto__cb);
  } // do_ajax_sto_validate_ms_kodesto_

  function do_ajax_sto_validate_ms_kodesto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ms_kodesto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ms_kodesto_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ms_kodesto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ms_kodesto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sto_validate_ms_kodesto__cb

  // ---------- Validate ms_namasto_
  function do_ajax_sto_validate_ms_namasto_(iNumLinha)
  {
    var nomeCampo_ms_namasto_ = "ms_namasto_" + iNumLinha;
    var var_ms_namasto_ = scAjaxGetFieldText(nomeCampo_ms_namasto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sto_validate_ms_namasto_(var_ms_namasto_, iNumLinha, var_script_case_init, do_ajax_sto_validate_ms_namasto__cb);
  } // do_ajax_sto_validate_ms_namasto_

  function do_ajax_sto_validate_ms_namasto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ms_namasto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ms_namasto_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ms_namasto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ms_namasto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sto_validate_ms_namasto__cb

  // ---------- Refresh ms_witel_
  function do_ajax_sto_refresh_ms_witel_(iSeqForm)
  {
    var var_ms_witel_ = scAjaxGetFieldSelect("ms_witel_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "ms_datel_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_sto_refresh_ms_witel_(var_ms_witel_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_sto_refresh_ms_witel__cb);
  } // do_ajax_sto_refresh_ms_witel_

  function do_ajax_sto_refresh_ms_witel__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sto_refresh_ms_witel__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_sto_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_sto_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_sto_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_sto_add_new_line_cb);
  } // do_ajax_sto_add_new_line

  function do_ajax_sto_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_sto_add_new_line_cb

  // ---------- backup_line
  function do_ajax_sto_backup_line(iNumLinha)
  {
    var var_ms_kodesto_ = scAjaxGetFieldText("ms_kodesto_" + iNumLinha);
    var var_ms_idsto_ = scAjaxGetFieldHidden("ms_idsto_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sto_backup_line(var_ms_kodesto_, var_ms_idsto_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_sto_backup_line_cb);
  } // do_ajax_sto_backup_line

  function do_ajax_sto_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_sto_backup_line_cb

  function do_ajax_sto_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_sto_cancel_insert

  function do_ajax_sto_cancel_update(iSeqVert)
  {
    do_ajax_sto_backup_line(iSeqVert);
...
?>
  } // do_ajax_sto_cancel_update

  function do_ajax_sto_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_sto_restore_buttons

  // ---------- table_refresh
  function do_ajax_sto_table_refresh()
  {
    var var_ms_kodesto_ = document.F2.ms_kodesto_.value;
    var var_ms_idsto_ = document.F2.ms_idsto_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_sto_table_refresh(var_ms_kodesto_, var_ms_idsto_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_sto_table_refresh_cb);
  } //  do_ajax_sto_table_refresh

  function do_ajax_sto_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.ms_kodesto_.value = scAjaxGetKeyValue("ms_kodesto_");
    document.F2.ms_idsto_.value = scAjaxGetKeyValue("ms_idsto_");
    ...
    sc_insert_open = false;
  } // do_ajax_sto_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_sto_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_sto_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_ms_idsto_ = scAjaxGetFieldHidden("ms_idsto_" + iNumLinha);
    var var_ms_witel_ = scAjaxGetFieldSelect("ms_witel_" + iNumLinha);
    var var_ms_datel_ = scAjaxGetFieldSelect("ms_datel_" + iNumLinha);
    var var_ms_kodesto_ = scAjaxGetFieldText("ms_kodesto_" + iNumLinha);
    var var_ms_namasto_ = scAjaxGetFieldText("ms_namasto_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_sto_submit_form(var_ms_idsto_, var_ms_witel_, var_ms_datel_, var_ms_kodesto_, var_ms_namasto_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_sto_submit_form_cb);
  } // do_ajax_sto_submit_form

  function do_ajax_sto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("ms_idsto_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ms_witel_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ms_datel_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ms_kodesto_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ms_namasto_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_sto_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_sto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_sto_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("ms_idsto_" + iNavForm);
      scAjaxHideErrorDisplay("ms_witel_" + iNavForm);
      scAjaxHideErrorDisplay("ms_datel_" + iNavForm);
      scAjaxHideErrorDisplay("ms_kodesto_" + iNavForm);
      scAjaxHideErrorDisplay("ms_namasto_" + iNavForm);
    }
    var var_ms_kodesto_ = document.F2.ms_kodesto_.value;
    var var_ms_idsto_ = document.F2.ms_idsto_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_sto_navigate_form(var_ms_kodesto_, var_ms_idsto_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_sto_navigate_form_cb);
  } // do_ajax_sto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['sto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_sto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.ms_kodesto_.value = scAjaxGetKeyValue("ms_kodesto_" + var_last_index);
    document.F2.ms_idsto_.value = scAjaxGetKeyValue("ms_idsto_" + var_last_index);
...
?>
  ...
  } // do_ajax_sto_navigate_form_cb
  function sc_hide_sto_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "ms_idsto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ms_witel_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ms_datel_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ms_kodesto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ms_namasto_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["ms_idsto_" + iNumLinha] = {"label": "MS IDSTO<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ms_witel_" + iNumLinha] = {"label": "MS WITEL<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ms_datel_" + iNumLinha] = {"label": "MS DATEL<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ms_kodesto_" + iNumLinha] = {"label": "MS KODESTO<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ms_namasto_" + iNumLinha] = {"label": "MS NAMASTO<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["ms_idsto_"][iNumLinha] = "ms_idsto_" + iNumLinha;
    ajax_field_mult["ms_witel_"][iNumLinha] = "ms_witel_" + iNumLinha;
    ajax_field_mult["ms_datel_"][iNumLinha] = "ms_datel_" + iNumLinha;
    ajax_field_mult["ms_kodesto_"][iNumLinha] = "ms_kodesto_" + iNumLinha;
    ajax_field_mult["ms_namasto_"][iNumLinha] = "ms_namasto_" + iNumLinha;
    ajax_field_id["ms_idsto_" + iNumLinha] = new Array("hidden_field_label_ms_idsto_", "hidden_field_data_ms_idsto_" + iNumLinha);
    ajax_field_id["ms_witel_" + iNumLinha] = new Array("hidden_field_label_ms_witel_", "hidden_field_data_ms_witel_" + iNumLinha);
    ajax_field_id["ms_datel_" + iNumLinha] = new Array("hidden_field_label_ms_datel_", "hidden_field_data_ms_datel_" + iNumLinha);
    ajax_field_id["ms_kodesto_" + iNumLinha] = new Array("hidden_field_label_ms_kodesto_", "hidden_field_data_ms_kodesto_" + iNumLinha);
    ajax_field_id["ms_namasto_" + iNumLinha] = new Array("hidden_field_label_ms_namasto_", "hidden_field_data_ms_namasto_" + iNumLinha);
    ajax_error_count["ms_idsto_" + iNumLinha] = "off";
    ajax_error_count["ms_witel_" + iNumLinha] = "off";
    ajax_error_count["ms_datel_" + iNumLinha] = "off";
    ajax_error_count["ms_kodesto_" + iNumLinha] = "off";
    ajax_error_count["ms_namasto_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["ms_idsto_" + iNumLinha] = "on";
    ajax_read_only["ms_witel_" + iNumLinha] = "off";
    ajax_read_only["ms_datel_" + iNumLinha] = "off";
    ajax_read_only["ms_kodesto_" + iNumLinha] = "on";
    ajax_read_only["ms_namasto_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["ms_idsto_" + iNumLinha] = "on";
    ajax_read_only["ms_witel_" + iNumLinha] = "on";
    ajax_read_only["ms_datel_" + iNumLinha] = "on";
    ajax_read_only["ms_kodesto_" + iNumLinha] = "on";
    ajax_read_only["ms_namasto_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["ms_idsto_" + iNumLinha] = null;
    ajax_error_list["ms_witel_" + iNumLinha] = null;
    ajax_error_list["ms_datel_" + iNumLinha] = null;
    ajax_error_list["ms_kodesto_" + iNumLinha] = null;
    ajax_error_list["ms_namasto_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    ...
    "ms_witel_": new Array(),
    "ms_datel_": new Array(),
    "ms_kodesto_": new Array(),
    "ms_namasto_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["ms_idsto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ms_idsto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ms_idsto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ms_idsto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ms_idsto_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ms_witel_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ms_witel_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ms_witel_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ms_witel_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ms_witel_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ms_datel_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ms_datel_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ms_datel_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ms_datel_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ms_datel_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ms_kodesto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ms_kodesto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ms_kodesto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ms_kodesto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ms_kodesto_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ms_namasto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ms_namasto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ms_namasto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ms_namasto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ms_namasto_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ms_idsto_'])) ? $this->nmgp_cmp_readonly['ms_idsto_'] : 'on';
?>
    scAjaxFieldRead("ms_idsto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ms_witel_'])) ? $this->nmgp_cmp_readonly['ms_witel_'] : 'off';
?>
    scAjaxFieldRead("ms_witel_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ms_datel_'])) ? $this->nmgp_cmp_readonly['ms_datel_'] : 'off';
?>
    scAjaxFieldRead("ms_datel_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ms_kodesto_'])) ? $this->nmgp_cmp_readonly['ms_kodesto_'] : 'on';
?>
    scAjaxFieldRead("ms_kodesto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ms_namasto_'])) ? $this->nmgp_cmp_readonly['ms_namasto_'] : 'off';
?>
    scAjaxFieldRead("ms_namasto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("ms_idsto_" + iSeq, "on");
    scAjaxFieldRead("ms_witel_" + iSeq, "on");
    scAjaxFieldRead("ms_datel_" + iSeq, "on");
    scAjaxFieldRead("ms_kodesto_" + iSeq, "on");
    scAjaxFieldRead("ms_namasto_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["ms_idsto_" + iRow] || "on" == ajax_error_count["ms_witel_" + iRow] || "on" == ajax_error_count["ms_datel_" + iRow] || "on" == ajax_error_count["ms_kodesto_" + iRow] || "on" == ajax_error_count["ms_namasto_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ms_idsto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ms_witel_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ms_datel_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ms_kodesto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ms_namasto_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["ms_idsto_" + iRow] && "off" == ajax_error_count["ms_witel_" + iRow] && "off" == ajax_error_count["ms_datel_" + iRow] && "off" == ajax_error_count["ms_kodesto_" + iRow] && "off" == ajax_error_count["ms_namasto_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["ms_idsto_" + iRow] = "off";
        ajax_error_count["ms_witel_" + iRow] = "off";
        ajax_error_count["ms_datel_" + iRow] = "off";
        ajax_error_count["ms_kodesto_" + iRow] = "off";
        ajax_error_count["ms_namasto_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_ms_idsto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ms_witel_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ms_datel_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ms_kodesto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ms_namasto_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("ms_kodesto_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
    }
    if ("ms_namasto_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
