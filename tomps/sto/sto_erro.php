...
$old_error_handler = set_error_handler("sto_scriptcase_error_handler");

function sto_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['sto']['contr_erro']) && $_SESSION['scriptcase']['sto']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        {
            global $inicial_sto;
            $inicial_sto->contr_sto->Apl_com_erro = true;
            if ($inicial_sto->contr_sto->NM_ajax_flag)
            {
                $inicial_sto->contr_sto->NM_ajax_info['errList']['geral_sto'][] = $msg;
                return;
            }
            sto_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function sto_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['sto'])  && '' != $_SESSION['scriptcase']['error_icon']['sto'])  ? $_SESSION['scriptcase']['error_icon']['sto']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['sto']) && '' != $_SESSION['scriptcase']['error_close']['sto']) ? $_SESSION['scriptcase']['error_close']['sto'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['sto']) && '' != $_SESSION['scriptcase']['error_span_title']['sto']) ? $_SESSION['scriptcase']['error_span_title']['sto'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['sto']) && '' != $_SESSION['scriptcase']['error_icon_title']['sto']) ? $_SESSION['scriptcase']['error_icon_title']['sto'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['sto']['error_buffer'] .= ob_get_flush();
}
