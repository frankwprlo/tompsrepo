<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="ms_kodesto_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['ms_kodesto_']); ?>">
<input type="hidden" name="ms_idsto_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['ms_idsto_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="sto"/>
  <input type="hidden" name="nmgp_parms" value=""> 
