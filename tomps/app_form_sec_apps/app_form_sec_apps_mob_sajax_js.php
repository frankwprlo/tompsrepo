...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate app_name
  function do_ajax_app_form_sec_apps_mob_validate_app_name()
  {
    var nomeCampo_app_name = "app_name";
    var var_app_name = scAjaxGetFieldText(nomeCampo_app_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_sec_apps_mob_validate_app_name(var_app_name, var_script_case_init, do_ajax_app_form_sec_apps_mob_validate_app_name_cb);
  } // do_ajax_app_form_sec_apps_mob_validate_app_name

  function do_ajax_app_form_sec_apps_mob_validate_app_name_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_sec_apps_mob_validate_app_name_cb

  // ---------- Validate description
  function do_ajax_app_form_sec_apps_mob_validate_description()
  {
    var nomeCampo_description = "description";
    var var_description = scAjaxGetFieldText(nomeCampo_description);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_sec_apps_mob_validate_description(var_description, var_script_case_init, do_ajax_app_form_sec_apps_mob_validate_description_cb);
  } // do_ajax_app_form_sec_apps_mob_validate_description

  function do_ajax_app_form_sec_apps_mob_validate_description_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_sec_apps_mob_validate_description_cb
  // ---------- Form
  function do_ajax_app_form_sec_apps_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_sec_apps_mob_submit_form(var_app_name, var_description, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_sec_apps_mob_submit_form_cb);
...
?>
  ...
  function do_ajax_app_form_sec_apps_mob_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_sec_apps_mob_navigate_form(var_app_name, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_app_form_sec_apps_mob_navigate_form_cb);
