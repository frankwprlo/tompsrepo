...
class resume_project_all_inwitel_resumo
{
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_order']['gbmitra']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_order']['gbmitra'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_order']['gbmitra'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_display']['gbmitra'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_display']['gbmitra'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_display']['gbmitra'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_display']['gbmitra'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_display']['gbmitra'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_display']['gbmitra'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_display']['gbmitra'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_statusname as $i_statusname => $d_statusname) {
           ...
           foreach ($this->array_total_tm_namamitra[$i_statusname] as $i_tm_namamitra => $d_tm_namamitra) {
               if (!in_array($i_tm_namamitra, $this->comp_label[1][ $d_statusname[11] ], true)) {
                   $this->comp_index[1][ $d_tm_namamitra[11] ] = $d_tm_namamitra[10];
                   $this->comp_label[1][ $d_statusname[11] ][ $d_tm_namamitra[11] ] = $d_tm_namamitra[10];
               }
           }
       }
       ...
       foreach ($this->comp_label[0] as $i_statusname => $l_statusname) {
           ...
           foreach ($this->comp_label[1][$i_statusname] as $i_tm_namamitra => $l_tm_namamitra) {
               if (isset($this->array_total_tm_namamitra[$i_statusname][$i_tm_namamitra])) {
                   $this->comp_group[$i_statusname][$i_tm_namamitra] = array();
               }
           }
       }
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_tp_odp, $sum_tp_nilai, $sum_tp_rab, $avg_prepare, $avg_perijinan, $avg_inst_testcomm, $avg_closing, $avg_pencapaian, $quebra_statusname, $quebra_tm_namamitra, $quebra_statusname_orig, $quebra_tm_namamitra_orig)
   {
      //----- Status Project
      ...
      //----- Mitra
      if (!isset($this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig]))
      {
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][0] = 1;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][1] = $sum_tp_odp;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][2] = $sum_tp_nilai;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][3] = $sum_tp_rab;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][4] = $avg_prepare;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][5] = $avg_perijinan;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][6] = $avg_inst_testcomm;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][7] = $avg_closing;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][8] = $avg_pencapaian;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][9] = 1;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][10] = $quebra_tm_namamitra;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][11] = $quebra_tm_namamitra_orig;
      }
      else
      {
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][0]++;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][1] += $sum_tp_odp;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][2] += $sum_tp_nilai;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][3] += $sum_tp_rab;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][4] += $avg_prepare;
         ...
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][7] += $avg_closing;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][8] += $avg_pencapaian;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][9]++;
      }
      //----- Total
   ...
   function compat_arrays()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['arr_total']['statusname'] as $campo_statusname => $dados_statusname)
      {
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['arr_total']['tm_namamitra'][$campo_statusname] as $campo_tm_namamitra => $dados_tm_namamitra)
         {
            $this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][2] = $dados_tm_namamitra[1];
            $this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][3] = $dados_tm_namamitra[2];
            $this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][4] = $dados_tm_namamitra[3];
            $this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][5] = $dados_tm_namamitra[4];
            $this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][6] = $dados_tm_namamitra[5];
            $this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][7] = $dados_tm_namamitra[6];
            $this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][8] = $dados_tm_namamitra[7];
            $this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][9] = $dados_tm_namamitra[8];
            $this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][1] = $dados_tm_namamitra[9];
         }
      }
   }
   //---- 
   function finaliza_arrays()
   {
      foreach ($this->array_total_statusname as $campo_statusname => $dados_statusname)
      {
         ...
         foreach ($this->array_total_tm_namamitra[$campo_statusname] as $campo_tm_namamitra => $dados_tm_namamitra)
         {
            nmgp_Trunc_Num($this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][1], 0);
            nmgp_Trunc_Num($this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][2], 0);
            nmgp_Trunc_Num($this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][3], 0);
            if ($this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][0] != 0) {$this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][4] /= $this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][0];}
            nmgp_Trunc_Num($this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][4], 2);
            if ($this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][0] != 0) {$this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][5] /= $this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][0];}
            nmgp_Trunc_Num($this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][5], 2);
            if ($this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][0] != 0) {$this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][6] /= $this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][0];}
            nmgp_Trunc_Num($this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][6], 2);
            if ($this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][0] != 0) {$this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][7] /= $this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][0];}
            nmgp_Trunc_Num($this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][7], 2);
            if ($this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][0] != 0) {$this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][8] /= $this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][0];}
            nmgp_Trunc_Num($this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][8], 2);
         }
      }
...
$_SESSION['scriptcase']['resume_project_all_inwitel']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->tp_odp, $this->tp_nilai, $this->tp_rab, $this->prepare, $this->perijinan, $this->inst_testcomm, $this->closing, $this->pencapaian, $this->statusname, $this->tm_namamitra, $this->statusname_orig,  $this->tm_namamitra_orig);
            }
   }
//
