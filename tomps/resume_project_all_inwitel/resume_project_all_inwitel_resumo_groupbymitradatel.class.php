...
class resume_project_all_inwitel_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['contr_total_geral'] == "OK")
      {
          $this->array_total_statusname = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['arr_total']['statusname'];
          $this->array_total_md_namadatel = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['arr_total']['md_namadatel'];
          $this->array_total_tm_namamitra = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['arr_total']['tm_namamitra'];
      }
      else
      {
          $this->array_total_statusname = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['tot_geral'][2];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['tot_geral'][3];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['tot_geral'][4];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['tot_geral'][5];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['tot_geral'][6];
      $this->array_total_geral[6] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['tot_geral'][7];
      $this->array_total_geral[7] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['tot_geral'][8];
      $this->array_total_geral[8] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['tot_geral'][9];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_order']['groupbymitradatel']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_order']['groupbymitradatel'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_order']['groupbymitradatel'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_display']['groupbymitradatel'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_display']['groupbymitradatel'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_display']['groupbymitradatel'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_display']['groupbymitradatel'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_display']['groupbymitradatel'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_display']['groupbymitradatel'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_display']['groupbymitradatel'] as $i_sum => $d_sum)
           {
       ...
       $this->comp_sum_lnk = array(
           ...
           5 => array('field' => "tp_rab", 'show' => true),
       ...
       foreach ($this->array_total_statusname as $i_statusname => $d_statusname) {
           if (!in_array($i_statusname, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_statusname[11] ] = $d_statusname[10];
               $this->comp_label[0][ $d_statusname[11] ] = $d_statusname[10];
           }
           foreach ($this->array_total_md_namadatel[$i_statusname] as $i_md_namadatel => $d_md_namadatel) {
               if (!in_array($i_md_namadatel, $this->comp_label[1][ $d_statusname[11] ], true)) {
                   $this->comp_index[1][ $d_md_namadatel[11] ] = $d_md_namadatel[10];
                   $this->comp_label[1][ $d_statusname[11] ][ $d_md_namadatel[11] ] = $d_md_namadatel[10];
               }
               foreach ($this->array_total_tm_namamitra[$i_statusname][$i_md_namadatel] as $i_tm_namamitra => $d_tm_namamitra) {
                   if (!in_array($i_tm_namamitra, $this->comp_label[2][ $d_statusname[11] ][ $d_md_namadatel[11] ], true)) {
                       $this->comp_index[2][ $d_tm_namamitra[11] ] = $d_tm_namamitra[10];
                       $this->comp_label[2][ $d_statusname[11] ][ $d_md_namadatel[11] ][ $d_tm_namamitra[11] ] = $d_tm_namamitra[10];
                   }
               }
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_tabular_label'];
       ...
       foreach ($this->comp_label[0] as $i_statusname => $l_statusname) {
           ...
           foreach ($this->comp_label[1][$i_statusname] as $i_md_namadatel => $l_md_namadatel) {
               ...
               foreach ($this->comp_label[2][$i_statusname][$i_md_namadatel] as $i_tm_namamitra => $l_tm_namamitra) {
                   if (isset($this->array_total_tm_namamitra[$i_statusname][$i_md_namadatel][$i_tm_namamitra])) {
                       $this->comp_group[$i_statusname][$i_md_namadatel][$i_tm_namamitra] = array();
                   }
               }
           }
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@resume_project_all_inwitel@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|9' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags($Lab_statusname)),
           ...
           '1|9' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags($Lab_md_namadatel)),
               'label_y'  => $this->getChartText(strip_tags("Pencapaian")),
               'format'   => $this->formatChartValue(9),
           ),
           '2|9' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['anlt_table_def']  = array();
   }
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_resume_project_all_inwitel_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_resume_project_all_inwitel_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order_start'][$iYAxysIndex])
                       {
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "resume_project_all_inwitel_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['opcao'] = "print";
      ...
      $this->Total   = new resume_project_all_inwitel_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['responsive_chart']['active']) {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_resume_project_all_inwitel_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_resume_project_all_inwitel_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_resume_project_all_inwitel_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['num_css'] . '.css');
     ...
     else
     {
      ...
      $nm_saida->saida(" </style>\r\n");
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "resume_project_all_inwitel/resume_project_all_inwitel_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "resume_project_all_inwitel/resume_project_all_inwitel_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnGroupByShow('" . $this->Ini->path_link . "resume_project_all_inwitel/resume_project_all_inwitel_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("resume_project_all_inwitel_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'resume_project_all_inwitel_config_pivot.php?nome_apl=resume_project_all_inwitel&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_resume_project_all_inwitel_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "resume_project_all_inwitel/resume_project_all_inwitel_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
   ...
   function monta_rodape()
   {
      ...
      $nm_cab_filtro   = ""; 
      $nm_cab_filtrobr = ""; 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['campos_busca']))
      { 
        $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['campos_busca'];
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
   ...
   //---- 
   function adiciona_registro($sum_tp_odp, $sum_tp_nilai, $sum_tp_rab, $avg_prepare, $avg_perijinan, $avg_inst_testcomm, $avg_closing, $avg_pencapaian, $quebra_statusname, $quebra_md_namadatel, $quebra_tm_namamitra, $quebra_statusname_orig, $quebra_md_namadatel_orig, $quebra_tm_namamitra_orig)
   {
      //----- Status Project
      if (!isset($this->array_total_statusname[$quebra_statusname_orig]))
      {
         $this->array_total_statusname[$quebra_statusname_orig][0] = 1;
         $this->array_total_statusname[$quebra_statusname_orig][1] = $sum_tp_odp;
         $this->array_total_statusname[$quebra_statusname_orig][2] = $sum_tp_nilai;
         $this->array_total_statusname[$quebra_statusname_orig][3] = $sum_tp_rab;
         $this->array_total_statusname[$quebra_statusname_orig][4] = $avg_prepare;
         $this->array_total_statusname[$quebra_statusname_orig][5] = $avg_perijinan;
         $this->array_total_statusname[$quebra_statusname_orig][6] = $avg_inst_testcomm;
         $this->array_total_statusname[$quebra_statusname_orig][7] = $avg_closing;
         $this->array_total_statusname[$quebra_statusname_orig][8] = $avg_pencapaian;
         $this->array_total_statusname[$quebra_statusname_orig][9] = 1;
         $this->array_total_statusname[$quebra_statusname_orig][10] = $quebra_statusname;
         $this->array_total_statusname[$quebra_statusname_orig][11] = $quebra_statusname_orig;
      }
      else
      {
         ...
         $this->array_total_statusname[$quebra_statusname_orig][7] += $avg_closing;
         $this->array_total_statusname[$quebra_statusname_orig][8] += $avg_pencapaian;
         $this->array_total_statusname[$quebra_statusname_orig][9]++;
      }
      //----- Datel
      if (!isset($this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig]))
      {
         ...
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][1] = $sum_tp_odp;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][2] = $sum_tp_nilai;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][3] = $sum_tp_rab;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][4] = $avg_prepare;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][5] = $avg_perijinan;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][6] = $avg_inst_testcomm;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][7] = $avg_closing;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][8] = $avg_pencapaian;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][9] = 1;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][10] = $quebra_md_namadatel;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][11] = $quebra_md_namadatel_orig;
      }
      else
      {
         ...
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][7] += $avg_closing;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][8] += $avg_pencapaian;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][9]++;
      }
      //----- Mitra
      if (!isset($this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tm_namamitra_orig]))
      {
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tm_namamitra_orig][0] = 1;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tm_namamitra_orig][1] = $sum_tp_odp;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tm_namamitra_orig][2] = $sum_tp_nilai;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tm_namamitra_orig][3] = $sum_tp_rab;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tm_namamitra_orig][4] = $avg_prepare;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tm_namamitra_orig][5] = $avg_perijinan;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tm_namamitra_orig][6] = $avg_inst_testcomm;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tm_namamitra_orig][7] = $avg_closing;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tm_namamitra_orig][8] = $avg_pencapaian;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tm_namamitra_orig][9] = 1;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tm_namamitra_orig][10] = $quebra_tm_namamitra;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tm_namamitra_orig][11] = $quebra_tm_namamitra_orig;
      }
      else
      {
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tm_namamitra_orig][0]++;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tm_namamitra_orig][1] += $sum_tp_odp;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tm_namamitra_orig][2] += $sum_tp_nilai;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tm_namamitra_orig][3] += $sum_tp_rab;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tm_namamitra_orig][4] += $avg_prepare;
         ...
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tm_namamitra_orig][7] += $avg_closing;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tm_namamitra_orig][8] += $avg_pencapaian;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tm_namamitra_orig][9]++;
      }
      //----- Total
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['arr_total']['statusname'] as $campo_statusname => $dados_statusname)
      {
         ...
         $this->array_total_statusname[$campo_statusname][7] = $dados_statusname[6];
         $this->array_total_statusname[$campo_statusname][8] = $dados_statusname[7];
         $this->array_total_statusname[$campo_statusname][9] = $dados_statusname[8];
         $this->array_total_statusname[$campo_statusname][1] = $dados_statusname[9];
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['arr_total']['md_namadatel'][$campo_statusname] as $campo_md_namadatel => $dados_md_namadatel)
         {
            ...
            $this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][7] = $dados_md_namadatel[6];
            $this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][8] = $dados_md_namadatel[7];
            $this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][9] = $dados_md_namadatel[8];
            $this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][1] = $dados_md_namadatel[9];
            foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['arr_total']['tm_namamitra'][$campo_statusname][$campo_md_namadatel] as $campo_tm_namamitra => $dados_tm_namamitra)
            {
               $this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][2] = $dados_tm_namamitra[1];
               $this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][3] = $dados_tm_namamitra[2];
               $this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][4] = $dados_tm_namamitra[3];
               $this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][5] = $dados_tm_namamitra[4];
               $this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][6] = $dados_tm_namamitra[5];
               $this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][7] = $dados_tm_namamitra[6];
               $this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][8] = $dados_tm_namamitra[7];
               $this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][9] = $dados_tm_namamitra[8];
               $this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][1] = $dados_tm_namamitra[9];
            }
         }
      }
   }
   ...
   function finaliza_arrays()
   {
      ...
      {
         nmgp_Trunc_Num($this->array_total_statusname[$campo_statusname][1], 0);
         nmgp_Trunc_Num($this->array_total_statusname[$campo_statusname][2], 0);
         nmgp_Trunc_Num($this->array_total_statusname[$campo_statusname][3], 0);
         ...
         if ($this->array_total_statusname[$campo_statusname][0] != 0) {$this->array_total_statusname[$campo_statusname][6] /= $this->array_total_statusname[$campo_statusname][0];}
         nmgp_Trunc_Num($this->array_total_statusname[$campo_statusname][6], 2);
         if ($this->array_total_statusname[$campo_statusname][0] != 0) {$this->array_total_statusname[$campo_statusname][7] /= $this->array_total_statusname[$campo_statusname][0];}
         nmgp_Trunc_Num($this->array_total_statusname[$campo_statusname][7], 2);
         if ($this->array_total_statusname[$campo_statusname][0] != 0) {$this->array_total_statusname[$campo_statusname][8] /= $this->array_total_statusname[$campo_statusname][0];}
         nmgp_Trunc_Num($this->array_total_statusname[$campo_statusname][8], 2);
         foreach ($this->array_total_md_namadatel[$campo_statusname] as $campo_md_namadatel => $dados_md_namadatel)
         {
            nmgp_Trunc_Num($this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][1], 0);
            nmgp_Trunc_Num($this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][2], 0);
            nmgp_Trunc_Num($this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][3], 0);
            ...
            if ($this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][0] != 0) {$this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][6] /= $this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][0];}
            nmgp_Trunc_Num($this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][6], 2);
            if ($this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][0] != 0) {$this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][7] /= $this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][0];}
            nmgp_Trunc_Num($this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][7], 2);
            if ($this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][0] != 0) {$this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][8] /= $this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][0];}
            nmgp_Trunc_Num($this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][8], 2);
            foreach ($this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel] as $campo_tm_namamitra => $dados_tm_namamitra)
            {
               nmgp_Trunc_Num($this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][1], 0);
               nmgp_Trunc_Num($this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][2], 0);
               nmgp_Trunc_Num($this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][3], 0);
               if ($this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][0] != 0) {$this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][4] /= $this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][0];}
               nmgp_Trunc_Num($this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][4], 2);
               if ($this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][0] != 0) {$this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][5] /= $this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][0];}
               nmgp_Trunc_Num($this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][5], 2);
               if ($this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][0] != 0) {$this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][6] /= $this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][0];}
               nmgp_Trunc_Num($this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][6], 2);
               if ($this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][0] != 0) {$this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][7] /= $this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][0];}
               nmgp_Trunc_Num($this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][7], 2);
               if ($this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][0] != 0) {$this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][8] /= $this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][0];}
               nmgp_Trunc_Num($this->array_total_tm_namamitra[$campo_statusname][$campo_md_namadatel][$campo_tm_namamitra][8], 2);
            }
         }
      }
...
$_SESSION['scriptcase']['resume_project_all_inwitel']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->tp_odp, $this->tp_nilai, $this->tp_rab, $this->prepare, $this->perijinan, $this->inst_testcomm, $this->closing, $this->pencapaian, $this->statusname, $this->md_namadatel, $this->tm_namamitra, $this->statusname_orig,  $this->md_namadatel_orig,  $this->tm_namamitra_orig);
            }
   }
//
...
$_SESSION['scriptcase']['resume_project_all_inwitel']['contr_erro'] = 'off';
      ...
      $this->finaliza_arrays();
      $this->rs_grid->Close();
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['tot_geral'][2] = $this->array_total_geral[1];
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['tot_geral'][3] = $this->array_total_geral[2];
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['tot_geral'][4] = $this->array_total_geral[3];
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['tot_geral'][5] = $this->array_total_geral[4];
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['tot_geral'][6] = $this->array_total_geral[5];
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['tot_geral'][7] = $this->array_total_geral[6];
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['tot_geral'][8] = $this->array_total_geral[7];
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['tot_geral'][9] = $this->array_total_geral[8];
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['tot_geral'][1] = $this->array_total_geral[0];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['arr_total']['statusname'] = $this->array_total_statusname;
          $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['arr_total']['md_namadatel'] = $this->array_total_md_namadatel;
          $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['arr_total']['tm_namamitra'] = $this->array_total_tm_namamitra;
      }
   }
