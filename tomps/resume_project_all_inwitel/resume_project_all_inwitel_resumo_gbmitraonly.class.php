...
class resume_project_all_inwitel_resumo
{
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_order']['gbmitraonly']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_order']['gbmitraonly'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_order']['gbmitraonly'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_display']['gbmitraonly'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_display']['gbmitraonly'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_display']['gbmitraonly'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_display']['gbmitraonly'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_display']['gbmitraonly'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_display']['gbmitraonly'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['summarizing_fields_display']['gbmitraonly'] as $i_sum => $d_sum)
           {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order_col'] = 4;
       }
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['pivot_order_sort'] = 'd';
       }
...
//--- 
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_project_all_inwitel']['arr_total']['tm_namamitra'] as $campo_tm_namamitra => $dados_tm_namamitra)
      {
