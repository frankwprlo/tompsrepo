  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_project_edit_update_main_deleteproject" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idproject
  function do_ajax_project_edit_update_main_deleteproject_validate_idproject()
  {
  } // do_ajax_project_edit_update_main_deleteproject_validate_idproject

  function do_ajax_project_edit_update_main_deleteproject_validate_idproject_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_project_edit_update_main_deleteproject_validate_idproject_cb

  // ---------- Validate namaproject
  function do_ajax_project_edit_update_main_deleteproject_validate_namaproject()
  {
  } // do_ajax_project_edit_update_main_deleteproject_validate_namaproject

  function do_ajax_project_edit_update_main_deleteproject_validate_namaproject_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_project_edit_update_main_deleteproject_validate_namaproject_cb

  // ---------- Validate lokasiproject
  function do_ajax_project_edit_update_main_deleteproject_validate_lokasiproject()
  {
  } // do_ajax_project_edit_update_main_deleteproject_validate_lokasiproject

  function do_ajax_project_edit_update_main_deleteproject_validate_lokasiproject_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_project_edit_update_main_deleteproject_validate_lokasiproject_cb

  // ---------- Validate namalop
  function do_ajax_project_edit_update_main_deleteproject_validate_namalop()
  {
  } // do_ajax_project_edit_update_main_deleteproject_validate_namalop

  function do_ajax_project_edit_update_main_deleteproject_validate_namalop_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "namalop";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_project_edit_update_main_deleteproject_validate_namalop_cb
  // ---------- Form
  function do_ajax_project_edit_update_main_deleteproject_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_project_edit_update_main_deleteproject_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_project_edit_update_main_deleteproject_submit_form(var_idproject, var_namaproject, var_lokasiproject, var_namalop, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_project_edit_update_main_deleteproject_submit_form_cb);
  } // do_ajax_project_edit_update_main_deleteproject_submit_form

  function do_ajax_project_edit_update_main_deleteproject_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_project_edit_update_main_deleteproject_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_project_edit_update_main_deleteproject_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_project_edit_update_main_deleteproject_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_deleteproject']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_project_edit_update_main_deleteproject_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_project_edit_update_main_deleteproject_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_project_edit_update_main_deleteproject_navigate_form_cb
  function sc_hide_project_edit_update_main_deleteproject_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_project_edit_update_main_deleteproject_form
