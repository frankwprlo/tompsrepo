...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["projectamo_____v_table_project_copy"]))
   {
      unset($_SESSION['session_sec_aplicacao']["projectamo_____v_table_project_copy"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['v_table_project_copy']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['v_table_project_copy']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['v_table_project_copy']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['v_table_project_copy']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['v_table_project_copy']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>v_table_project_copy</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['v_table_project_copy']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['v_table_project_copy']['embutida_filho'] as $ind => $sc_init)
          {
