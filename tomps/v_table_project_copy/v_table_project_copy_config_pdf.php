 ...
 */
    ...
    session_start();
    $SC_apl_proc = "v_table_project_copy";
...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['v_table_project_copy']['show_skip_charts_option']) || !$_SESSION['sc_session']['v_table_project_copy']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
