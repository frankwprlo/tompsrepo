<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new v_table_project_copy_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class v_table_project_copy_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["tp_id"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_id"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_id"] : "TP ID";
   $tab_ger_campos['mw_namawitel'] = "on";
   $tab_def_campos['mw_namawitel'] = "MW_NAMAWITEL";
   $tab_converte["MW_NAMAWITEL"]   = "mw_namawitel";
   $tab_labels["mw_namawitel"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["mw_namawitel"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["mw_namawitel"] : "MW NAMAWITEL";
   $tab_ger_campos['md_namadatel'] = "on";
   $tab_def_campos['md_namadatel'] = "MD_NAMADATEL";
   $tab_converte["MD_NAMADATEL"]   = "md_namadatel";
   $tab_labels["md_namadatel"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["md_namadatel"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["md_namadatel"] : "MD NAMADATEL";
   $tab_ger_campos['ms_namasto'] = "on";
   $tab_def_campos['ms_namasto'] = "MS_NAMASTO";
   $tab_converte["MS_NAMASTO"]   = "ms_namasto";
   $tab_labels["ms_namasto"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["ms_namasto"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["ms_namasto"] : "MS NAMASTO";
   $tab_ger_campos['templatename'] = "on";
   $tab_def_campos['templatename'] = "TEMPLATENAME";
   $tab_converte["TEMPLATENAME"]   = "templatename";
   $tab_labels["templatename"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["templatename"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["templatename"] : "TEMPLATENAME";
   $tab_ger_campos['statusname'] = "on";
   $tab_def_campos['statusname'] = "STATUSNAME";
   $tab_converte["STATUSNAME"]   = "statusname";
   $tab_labels["statusname"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["statusname"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["statusname"] : "STATUSNAME";
   $tab_ger_campos['tm_namamitra'] = "on";
   $tab_def_campos['tm_namamitra'] = "TM_NAMAMITRA";
   $tab_converte["TM_NAMAMITRA"]   = "tm_namamitra";
   $tab_labels["tm_namamitra"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tm_namamitra"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tm_namamitra"] : "TM NAMAMITRA";
   $tab_ger_campos['tp_batch'] = "on";
   $tab_def_campos['tp_batch'] = "TP_BATCH";
   $tab_converte["TP_BATCH"]   = "tp_batch";
   $tab_labels["tp_batch"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_batch"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_batch"] : "TP BATCH";
   $tab_ger_campos['tp_projectname'] = "on";
   $tab_def_campos['tp_projectname'] = "TP_PROJECTNAME";
   $tab_converte["TP_PROJECTNAME"]   = "tp_projectname";
   $tab_labels["tp_projectname"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_projectname"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_projectname"] : "TP PROJECTNAME";
   $tab_ger_campos['tp_lokasi'] = "on";
   $tab_def_campos['tp_lokasi'] = "TP_LOKASI";
   $tab_converte["TP_LOKASI"]   = "tp_lokasi";
   $tab_labels["tp_lokasi"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_lokasi"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_lokasi"] : "TP LOKASI";
   $tab_ger_campos['tp_odp'] = "on";
   $tab_def_campos['tp_odp'] = "TP_ODP";
   $tab_converte["TP_ODP"]   = "tp_odp";
   $tab_labels["tp_odp"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_odp"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_odp"] : "TP ODP";
   $tab_ger_campos['tp_planstart'] = "on";
   $tab_def_campos['tp_planstart'] = "TP_PLANSTART";
   $tab_converte["TP_PLANSTART"]   = "tp_planstart";
   $tab_labels["tp_planstart"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_planstart"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_planstart"] : "TP PLANSTART";
   $tab_ger_campos['tp_planfinish'] = "on";
   $tab_def_campos['tp_planfinish'] = "TP_PLANFINISH";
   $tab_converte["TP_PLANFINISH"]   = "tp_planfinish";
   $tab_labels["tp_planfinish"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_planfinish"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_planfinish"] : "TP PLANFINISH";
   $tab_ger_campos['tp_summary'] = "on";
   $tab_def_campos['tp_summary'] = "TP_SUMMARY";
   $tab_converte["TP_SUMMARY"]   = "tp_summary";
   $tab_labels["tp_summary"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_summary"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_summary"] : "TP SUMMARY";
   $tab_ger_campos['tp_status'] = "on";
   $tab_def_campos['tp_status'] = "TP_STATUS";
   $tab_converte["TP_STATUS"]   = "tp_status";
   $tab_labels["tp_status"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_status"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_status"] : "TP STATUS";
   ...
   $tab_labels["tp_jenisproject"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_jenisproject"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_jenisproject"] : "TP JENISPROJECT";
   $tab_ger_campos['tp_prjtrelease'] = "on";
   $tab_def_campos['tp_prjtrelease'] = "TP_PRJTRELEASE";
   $tab_converte["TP_PRJTRELEASE"]   = "tp_prjtrelease";
   $tab_labels["tp_prjtrelease"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_prjtrelease"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_prjtrelease"] : "TP PRJTRELEASE";
   $tab_ger_campos['tp_targetwaktu'] = "on";
   $tab_def_campos['tp_targetwaktu'] = "TP_TARGETWAKTU";
   $tab_converte["TP_TARGETWAKTU"]   = "tp_targetwaktu";
   $tab_labels["tp_targetwaktu"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_targetwaktu"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["tp_targetwaktu"] : "TP TARGETWAKTU";
   $tab_ger_campos['prepare'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prepare'] = "prepare";
       $tab_converte["prepare"]   = "prepare";
   }
   else
   {
       $tab_def_campos['prepare'] = "";
       $tab_converte[""]   = "prepare";
   }
   $tab_labels["prepare"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["prepare"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["prepare"] : "Preparing";
   $tab_ger_campos['perijinan'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['perijinan'] = "perijinan";
       $tab_converte["perijinan"]   = "perijinan";
   }
   else
   {
       $tab_def_campos['perijinan'] = "";
       $tab_converte[""]   = "perijinan";
   }
   $tab_labels["perijinan"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["perijinan"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["perijinan"] : "Perijinan";
   $tab_ger_campos['inst_testcomm'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['inst_testcomm'] = "inst_testcomm";
       $tab_converte["inst_testcomm"]   = "inst_testcomm";
   }
   else
   {
       $tab_def_campos['inst_testcomm'] = "";
       $tab_converte[""]   = "inst_testcomm";
   }
   $tab_labels["inst_testcomm"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["inst_testcomm"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["inst_testcomm"] : "Instalasi & TestComm";
   $tab_ger_campos['closing'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['closing'] = "closing";
       $tab_converte["closing"]   = "closing";
   }
   else
   {
       $tab_def_campos['closing'] = "";
       $tab_converte[""]   = "closing";
   }
   $tab_labels["closing"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["closing"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["closing"] : "Closing";
   $tab_ger_campos['pencapaian'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pencapaian'] = "pencapaian";
       $tab_converte["pencapaian"]   = "pencapaian";
   }
   else
   {
       $tab_def_campos['pencapaian'] = "";
       $tab_converte[""]   = "pencapaian";
   }
   $tab_labels["pencapaian"]   = (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["pencapaian"])) ? $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['labels']["pencapaian"] : "Pencapaian(%)";
   $tab_ger_campos['prepare'] = "none";
   $tab_ger_campos['perijinan'] = "none";
   $tab_ger_campos['inst_testcomm'] = "none";
   $tab_ger_campos['closing'] = "none";
   $tab_ger_campos['pencapaian'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['v_table_project_copy']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['v_table_project_copy']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['v_table_project_copy']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['v_table_project_copy']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "v_table_project_copy_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['v_table_project_copy']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
