<?php
class downloaddetail_inwitel_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['downloaddetail_inwitel']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['downloaddetail_inwitel']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['downloaddetail_inwitel']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['charts_html'] = '';
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'])
   { 
   ...
   { 
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['downloaddetail_inwitel'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'];
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] == "pdf")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] == "pdf")
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] = "igual";
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'];
 }
...
//
   ...
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "downloaddetail_inwitel/downloaddetail_inwitel_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['doc_word'])
       { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'])
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['force_toolbar']);
   } 
   $this->width_tabula_quebra  = "0px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['downloaddetail_inwitel']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['downloaddetail_inwitel']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['downloaddetail_inwitel']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opc_psq'])
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['mostra_edit'] = "N";
   }
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'])
   ...
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("downloaddetail_inwitel", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['downloaddetail_inwitel']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['downloaddetail_inwitel']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['downloaddetail_inwitel']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_pesq_ant'];  
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['campos_busca'];
   ...
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_pesq_filtro'];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] = "muda_qt_linhas";
   } 

   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['downloaddetail_inwitel'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['downloaddetail_inwitel'];
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "downloaddetail_inwitel/downloaddetail_inwitel_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "downloaddetail_inwitel_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new downloaddetail_inwitel_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['downloaddetail_inwitel']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['downloaddetail_inwitel']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['downloaddetail_inwitel']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['downloaddetail_inwitel']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['downloaddetail_inwitel']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['downloaddetail_inwitel']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['downloaddetail_inwitel']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['downloaddetail_inwitel']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_quebra'] = array(); 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_orig'] = " where TP_WITEL='" . $_SESSION['idwitel'] . "' AND TP_DIVRE='" . $_SESSION['iddivre'] . "'";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_pesq_filtro'] = "";
   }   
   if  (!empty($this->nm_where_dinamico)) 
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao']       = "igual" ; 
   } 
// 
   $this->count_ger = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['sc_total']);
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
...
//----- 
   ...
   { 
       $nmgp_select = "SELECT TP_ID, TP_THN_RELEASE, TP_PRJTRELEASE, TP_BATCH, TP_IDLOP, TP_NAMALOP, TP_LOKASI, MD_NAMADIVRE, MW_NAMAWITEL, MS_NAMASTO, TP_PROJECTNAME, TM_NAMAMITRA, TP_ODP, str_replace (convert(char(10),TP_PLANSTART,102), '.', '-') + ' ' + convert(char(8),TP_PLANSTART,20), str_replace (convert(char(10),TP_PLANFINISH,102), '.', '-') + ' ' + convert(char(8),TP_PLANFINISH,20), str_replace (convert(char(10),TP_ACTUALSTART,102), '.', '-') + ' ' + convert(char(8),TP_ACTUALSTART,20), str_replace (convert(char(10),TP_ACTUALFINISH,102), '.', '-') + ' ' + convert(char(8),TP_ACTUALFINISH,20), TP_TEMPLATEPROJECT, TP_JENISPROJECT, TP_TARGETWAKTU, TP_NOKONTRAK, TP_PONUMBER, TP_JMLDISTRIBUSI, TP_NILAI, TP_RAB, STATUSNAME, TP_SUMMARY, TP_WITEL, TP_DATEL, TP_STO, TP_STATUS, TP_MITRA, TP_TASKAKTIF, TP_PROSENTASE, TP_TAHAPANAKTIF, TP_TASKAKTIFSTATUS, str_replace (convert(char(10),TP_TASKAKTIFPLANSTART,102), '.', '-') + ' ' + convert(char(8),TP_TASKAKTIFPLANSTART,20), str_replace (convert(char(10),TP_TASKAKTIFPLANFINISH,102), '.', '-') + ' ' + convert(char(8),TP_TASKAKTIFPLANFINISH,20), str_replace (convert(char(10),TP_ENTRYDATE,102), '.', '-') + ' ' + convert(char(8),TP_ENTRYDATE,20), TP_ENTRYBY, str_replace (convert(char(10),TP_UPDATEDATE,102), '.', '-') + ' ' + convert(char(8),TP_UPDATEDATE,20), TP_UPDATEBY from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
   { 
       $nmgp_select = "SELECT TP_ID, TP_THN_RELEASE, TP_PRJTRELEASE, TP_BATCH, TP_IDLOP, TP_NAMALOP, TP_LOKASI, MD_NAMADIVRE, MW_NAMAWITEL, MS_NAMASTO, TP_PROJECTNAME, TM_NAMAMITRA, TP_ODP, TP_PLANSTART, TP_PLANFINISH, TP_ACTUALSTART, TP_ACTUALFINISH, TP_TEMPLATEPROJECT, TP_JENISPROJECT, TP_TARGETWAKTU, TP_NOKONTRAK, TP_PONUMBER, TP_JMLDISTRIBUSI, TP_NILAI, TP_RAB, STATUSNAME, TP_SUMMARY, TP_WITEL, TP_DATEL, TP_STO, TP_STATUS, TP_MITRA, TP_TASKAKTIF, TP_PROSENTASE, TP_TAHAPANAKTIF, TP_TASKAKTIFSTATUS, TP_TASKAKTIFPLANSTART, TP_TASKAKTIFPLANFINISH, TP_ENTRYDATE, TP_ENTRYBY, TP_UPDATEDATE, TP_UPDATEBY from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
   { 
       $nmgp_select = "SELECT TP_ID, TP_THN_RELEASE, TP_PRJTRELEASE, TP_BATCH, TP_IDLOP, TP_NAMALOP, TP_LOKASI, MD_NAMADIVRE, MW_NAMAWITEL, MS_NAMASTO, TP_PROJECTNAME, TM_NAMAMITRA, TP_ODP, convert(char(23),TP_PLANSTART,121), convert(char(23),TP_PLANFINISH,121), convert(char(23),TP_ACTUALSTART,121), convert(char(23),TP_ACTUALFINISH,121), TP_TEMPLATEPROJECT, TP_JENISPROJECT, TP_TARGETWAKTU, TP_NOKONTRAK, TP_PONUMBER, TP_JMLDISTRIBUSI, TP_NILAI, TP_RAB, STATUSNAME, TP_SUMMARY, TP_WITEL, TP_DATEL, TP_STO, TP_STATUS, TP_MITRA, TP_TASKAKTIF, TP_PROSENTASE, TP_TAHAPANAKTIF, TP_TASKAKTIFSTATUS, convert(char(23),TP_TASKAKTIFPLANSTART,121), convert(char(23),TP_TASKAKTIFPLANFINISH,121), convert(char(23),TP_ENTRYDATE,121), TP_ENTRYBY, convert(char(23),TP_UPDATEDATE,121), TP_UPDATEBY from " . $this->Ini->nm_tabela; 
   } 
   ...
   { 
       $nmgp_select = "SELECT TP_ID, TP_THN_RELEASE, TP_PRJTRELEASE, TP_BATCH, TP_IDLOP, TP_NAMALOP, TP_LOKASI, MD_NAMADIVRE, MW_NAMAWITEL, MS_NAMASTO, TP_PROJECTNAME, TM_NAMAMITRA, TP_ODP, EXTEND(TP_PLANSTART, YEAR TO DAY), EXTEND(TP_PLANFINISH, YEAR TO DAY), EXTEND(TP_ACTUALSTART, YEAR TO DAY), EXTEND(TP_ACTUALFINISH, YEAR TO DAY), TP_TEMPLATEPROJECT, TP_JENISPROJECT, TP_TARGETWAKTU, TP_NOKONTRAK, TP_PONUMBER, TP_JMLDISTRIBUSI, TP_NILAI, TP_RAB, STATUSNAME, LOTOFILE(TP_SUMMARY, '" . $this->Ini->root . $this->Ini->path_imag_temp . "/sc_blob_informix', 'client') as tp_summary, TP_WITEL, TP_DATEL, TP_STO, TP_STATUS, TP_MITRA, TP_TASKAKTIF, TP_PROSENTASE, TP_TAHAPANAKTIF, TP_TASKAKTIFSTATUS, EXTEND(TP_TASKAKTIFPLANSTART, YEAR TO DAY), EXTEND(TP_TASKAKTIFPLANFINISH, YEAR TO DAY), EXTEND(TP_ENTRYDATE, YEAR TO DAY), TP_ENTRYBY, EXTEND(TP_UPDATEDATE, YEAR TO DAY), TP_UPDATEBY from " . $this->Ini->nm_tabela; 
   } 
   else 
   { 
       $nmgp_select = "SELECT TP_ID, TP_THN_RELEASE, TP_PRJTRELEASE, TP_BATCH, TP_IDLOP, TP_NAMALOP, TP_LOKASI, MD_NAMADIVRE, MW_NAMAWITEL, MS_NAMASTO, TP_PROJECTNAME, TM_NAMAMITRA, TP_ODP, TP_PLANSTART, TP_PLANFINISH, TP_ACTUALSTART, TP_ACTUALFINISH, TP_TEMPLATEPROJECT, TP_JENISPROJECT, TP_TARGETWAKTU, TP_NOKONTRAK, TP_PONUMBER, TP_JMLDISTRIBUSI, TP_NILAI, TP_RAB, STATUSNAME, TP_SUMMARY, TP_WITEL, TP_DATEL, TP_STO, TP_STATUS, TP_MITRA, TP_TASKAKTIF, TP_PROSENTASE, TP_TAHAPANAKTIF, TP_TASKAKTIFSTATUS, TP_TASKAKTIFPLANSTART, TP_TASKAKTIFPLANFINISH, TP_ENTRYDATE, TP_ENTRYBY, TP_UPDATEDATE, TP_UPDATEBY from " . $this->Ini->nm_tabela; 
   } 
   $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_pesq']; 
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $this->tp_namalop = $this->rs_grid->fields[5] ;  
       $this->tp_lokasi = $this->rs_grid->fields[6] ;  
       $this->md_namadivre = $this->rs_grid->fields[7] ;  
       $this->mw_namawitel = $this->rs_grid->fields[8] ;  
       $this->ms_namasto = $this->rs_grid->fields[9] ;  
       $this->tp_projectname = $this->rs_grid->fields[10] ;  
       $this->tm_namamitra = $this->rs_grid->fields[11] ;  
       ...
       $this->tp_actualstart = $this->rs_grid->fields[15] ;  
       $this->tp_actualfinish = $this->rs_grid->fields[16] ;  
       $this->tp_templateproject = $this->rs_grid->fields[17] ;  
       ...
       $this->tp_jmldistribusi = $this->rs_grid->fields[22] ;  
       $this->tp_jmldistribusi = (string)$this->tp_jmldistribusi;
       $this->tp_nilai = $this->rs_grid->fields[23] ;  
       $this->tp_nilai = (string)$this->tp_nilai;
       $this->tp_rab = $this->rs_grid->fields[24] ;  
       $this->tp_rab = (string)$this->tp_rab;
       $this->statusname = $this->rs_grid->fields[25] ;  
       if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
       { 
           $this->tp_summary = "";  
           if (is_file($this->rs_grid->fields[26])) 
           { 
               $this->tp_summary = file_get_contents($this->rs_grid->fields[26]);  
           } 
       } 
       else
       { 
           $this->tp_summary = $this->rs_grid->fields[26] ;  
       } 
       $this->tp_witel = $this->rs_grid->fields[27] ;  
       $this->tp_witel = (string)$this->tp_witel;
       $this->tp_datel = $this->rs_grid->fields[28] ;  
       $this->tp_datel = (string)$this->tp_datel;
       $this->tp_sto = $this->rs_grid->fields[29] ;  
       $this->tp_sto = (string)$this->tp_sto;
       $this->tp_status = $this->rs_grid->fields[30] ;  
       $this->tp_status = (string)$this->tp_status;
       $this->tp_mitra = $this->rs_grid->fields[31] ;  
       $this->tp_mitra = (string)$this->tp_mitra;
       $this->tp_taskaktif = $this->rs_grid->fields[32] ;  
       $this->tp_prosentase = $this->rs_grid->fields[33] ;  
       $this->tp_prosentase =  str_replace(",", ".", $this->tp_prosentase);
       $this->tp_prosentase = (string)$this->tp_prosentase;
       $this->tp_tahapanaktif = $this->rs_grid->fields[34] ;  
       $this->tp_taskaktifstatus = $this->rs_grid->fields[35] ;  
       $this->tp_taskaktifstatus = (string)$this->tp_taskaktifstatus;
       $this->tp_taskaktifplanstart = $this->rs_grid->fields[36] ;  
       $this->tp_taskaktifplanfinish = $this->rs_grid->fields[37] ;  
       $this->tp_entrydate = $this->rs_grid->fields[38] ;  
       $this->tp_entryby = $this->rs_grid->fields[39] ;  
       $this->tp_updatedate = $this->rs_grid->fields[40] ;  
       $this->tp_updateby = $this->rs_grid->fields[41] ;  
       $this->SC_seq_register = $this->nmgp_reg_start ; 
       $this->SC_seq_page = 0;
       $this->SC_sep_quebra = false;
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['final']; 
   ...
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'])
   { 
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<HEAD>
 <TITLE>Data LOP Detail :: PDF</TITLE>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['pivot_charts']) : 0;
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>Data LOP Detail</TITLE>\r\n");
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ajax_nav'])
       { 
           ...
           $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . session_id() . "\">\r\n");
           $nm_saida->saida("   </form>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"downloaddetail_inwitel_jquery.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"downloaddetail_inwitel_ajax.js\"></script>\r\n");
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($this->count_ger) . ";\r\n");
           }
           else
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_reg_grid']) . ";\r\n");
           }
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ancor_save']);
           }
           $nm_saida->saida("   });\r\n");
           ...
           $nm_saida->saida("       dataType: \"html\",\r\n");
           $nm_saida->saida("       url: \"downloaddetail_inwitel_save_grid.php\",\r\n");
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_downloaddetail_inwitel_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'])
       {
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_downloaddetail_inwitel_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_downloaddetail_inwitel_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "downloaddetail_inwitel/downloaddetail_inwitel_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           $cada_css = ".downloaddetail_inwitel_" . substr($cada_css, 1);
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf" && !$this->Print_All)
       { 
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['downloaddetail_inwitel']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['downloaddetail_inwitel']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['downloaddetail_inwitel']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['downloaddetail_inwitel']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida']) ? "downloaddetail_inwitel_" : "";
   $this->css_sep = " ";
...
//----- 
 function cabecalho()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opc_liga']['cab']))
   {
       return; 
   }
   $nm_cab_filtro   = ""; 
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['cond_pesq'], 0, $trab_pos);
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   { 
   ...
   $nm_saida->saida("          Data LOP Detail\r\n");
   $nm_saida->saida("        </TD>\r\n");
   $nm_saida->saida("       </TR>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_downloaddetail_inwitel__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-downloaddetail_inwitel-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_tp_updateby_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_tp_updateby_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] || ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['exibe_seq'] == "S")) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_tp_updateby_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
     ...
     { 
         ...
         { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 $css_emb .= ".downloaddetail_inwitel_" . substr($cada_css, 1);
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_tp_id()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_ID')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
 ...
 function NM_label_tp_thn_release()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_THN_RELEASE')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_prjtrelease()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_PRJTRELEASE')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_batch()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_BATCH')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_idlop()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_IDLOP')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_namalop()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_NAMALOP')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_lokasi()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_LOKASI')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['md_namadivre'])) ? $this->New_label['md_namadivre'] : "DIVRE"; 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'MD_NAMADIVRE')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_mw_namawitel()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'MW_NAMAWITEL')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_ms_namasto()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'MS_NAMASTO')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_projectname()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_PROJECTNAME')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tm_namamitra()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TM_NAMAMITRA')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_odp()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_ODP')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_planstart()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_PLANSTART')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_planfinish()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_PLANFINISH')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_actualstart()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_ACTUALSTART')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_actualfinish()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_ACTUALFINISH')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_templateproject()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_TEMPLATEPROJECT')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_jenisproject()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_JENISPROJECT')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_targetwaktu()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_TARGETWAKTU')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_nokontrak()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_NOKONTRAK')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_ponumber()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_PONUMBER')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_jmldistribusi()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_JMLDISTRIBUSI')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_nilai()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_NILAI')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_rab()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_RAB')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_statusname()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'STATUSNAME')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_summary()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_SUMMARY')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_witel()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_WITEL')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_datel()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_DATEL')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_sto()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_STO')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['tp_status'])) ? $this->New_label['tp_status'] : "ID Status"; 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_STATUS')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_mitra()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_MITRA')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_taskaktif()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_TASKAKTIF')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_prosentase()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_PROSENTASE')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_tahapanaktif()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_TAHAPANAKTIF')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_taskaktifstatus()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_TASKAKTIFSTATUS')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_taskaktifplanstart()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_TASKAKTIFPLANSTART')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_taskaktifplanfinish()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_TASKAKTIFPLANFINISH')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_entrydate()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_ENTRYDATE')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_entryby()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_ENTRYBY')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_updatedate()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_UPDATEDATE')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_updateby()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_cmp'] == 'TP_UPDATEBY')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ini_cor_grid']);
       }
   }
...
// 
   $SC_Label = (isset($this->New_label['tp_id'])) ? $this->New_label['tp_id'] : "ID Table"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_id'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_thn_release'])) ? $this->New_label['tp_thn_release'] : "Release Project"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_thn_release'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_prjtrelease'])) ? $this->New_label['tp_prjtrelease'] : "Sub-Release"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_prjtrelease'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_batch'])) ? $this->New_label['tp_batch'] : "BATCH"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_batch'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_idlop'])) ? $this->New_label['tp_idlop'] : "ID LOP"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_idlop'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_namalop'])) ? $this->New_label['tp_namalop'] : "NAMALOP"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_namalop'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_lokasi'])) ? $this->New_label['tp_lokasi'] : "LOKASI"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_lokasi'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['md_namadivre'])) ? $this->New_label['md_namadivre'] : "DIVRE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['md_namadivre'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['mw_namawitel'])) ? $this->New_label['mw_namawitel'] : "WITEL"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['mw_namawitel'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ms_namasto'])) ? $this->New_label['ms_namasto'] : "STO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['ms_namasto'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_projectname'])) ? $this->New_label['tp_projectname'] : "PROJECTNAME"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_projectname'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tm_namamitra'])) ? $this->New_label['tm_namamitra'] : "MITRA"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tm_namamitra'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_odp'])) ? $this->New_label['tp_odp'] : "ODP"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_odp'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_planstart'])) ? $this->New_label['tp_planstart'] : "PLANSTART"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_planstart'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_planfinish'])) ? $this->New_label['tp_planfinish'] : "PLANFINISH"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_planfinish'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_actualstart'])) ? $this->New_label['tp_actualstart'] : "ACTUALSTART"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_actualstart'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_actualfinish'])) ? $this->New_label['tp_actualfinish'] : "ACTUALFINISH"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_actualfinish'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_templateproject'])) ? $this->New_label['tp_templateproject'] : "TEMPLATEPROJECT"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_templateproject'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_jenisproject'])) ? $this->New_label['tp_jenisproject'] : "JENISPROJECT"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_jenisproject'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_targetwaktu'])) ? $this->New_label['tp_targetwaktu'] : "TARGETWAKTU"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_targetwaktu'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_nokontrak'])) ? $this->New_label['tp_nokontrak'] : "NOKONTRAK"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_nokontrak'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_ponumber'])) ? $this->New_label['tp_ponumber'] : "PO Number"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_ponumber'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_jmldistribusi'])) ? $this->New_label['tp_jmldistribusi'] : "Jml Distribusi"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_jmldistribusi'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_nilai'])) ? $this->New_label['tp_nilai'] : "Nilai Rekon"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_nilai'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_rab'])) ? $this->New_label['tp_rab'] : "Nilai DRM"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_rab'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['statusname'])) ? $this->New_label['statusname'] : "Status Project"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['statusname'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_summary'])) ? $this->New_label['tp_summary'] : "SUMMARY"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_summary'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_witel'])) ? $this->New_label['tp_witel'] : "ID WITEL"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_witel'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_datel'])) ? $this->New_label['tp_datel'] : "DATEL"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_datel'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_sto'])) ? $this->New_label['tp_sto'] : "ID STO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_sto'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_status'])) ? $this->New_label['tp_status'] : "ID Status"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_status'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_mitra'])) ? $this->New_label['tp_mitra'] : "ID Mitra"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_mitra'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_taskaktif'])) ? $this->New_label['tp_taskaktif'] : "TASKAKTIF"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_taskaktif'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_prosentase'])) ? $this->New_label['tp_prosentase'] : "PROSENTASE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_prosentase'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_tahapanaktif'])) ? $this->New_label['tp_tahapanaktif'] : "TAHAPANAKTIF"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_tahapanaktif'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_taskaktifstatus'])) ? $this->New_label['tp_taskaktifstatus'] : "TASKAKTIFSTATUS"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_taskaktifstatus'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_taskaktifplanstart'])) ? $this->New_label['tp_taskaktifplanstart'] : "TASKAKTIFPLANSTART"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_taskaktifplanstart'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_taskaktifplanfinish'])) ? $this->New_label['tp_taskaktifplanfinish'] : "TASKAKTIFPLANFINISH"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_taskaktifplanfinish'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_entrydate'])) ? $this->New_label['tp_entrydate'] : "ENTRYDATE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_entrydate'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_entryby'])) ? $this->New_label['tp_entryby'] : "ENTRYBY"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_entryby'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_updatedate'])) ? $this->New_label['tp_updatedate'] : "UPDATEDATE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_updatedate'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_updateby'])) ? $this->New_label['tp_updateby'] : "UPDATEBY"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['labels']['tp_updateby'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['downloaddetail_inwitel']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['downloaddetail_inwitel']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['downloaddetail_inwitel']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_downloaddetail_inwitel#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               $nm_saida->saida("  <tr><td class=\"" . $this->css_scGridTabelaTd . " " . "\" style=\"font-family:" . $this->Ini->texto_fonte_tipo_impar . ";font-size:12px;color:#000000;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\">\r\n");
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  " . $this->nm_grid_sem_reg . "\r\n");
   ...
   { 
       $nm_saida->saida(" <TR> \r\n");
       $nm_id_aplicacao = " id=\"apl_downloaddetail_inwitel#?#1\"";
   } 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-839e3801\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida_grid'])
   { 
       $_SESSION['scriptcase']['saida_html'] = "";
   } 
// 
   ...
   $ini_grid = true;
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          $this->NM_field_style = array();
          //---------- Gauge ----------
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
          ...
          $this->tp_updateby = $this->rs_grid->fields[41] ;  
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['final'] + 1; 
          if (!$ini_grid) {
          ...
          if (($nm_houve_quebra == "S" || $nm_inicio_pag == 0) && !$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida_grid'])
          { 
              $this->label_grid($linhas);
              $nm_houve_quebra = "N";
          } 
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['dado_psq_ret'];
          ...
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_tp_updateby_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_tp_updateby_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . $teste . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . $teste . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
          $nm_saida->saida(" $Cod_Btn</TD>\r\n");
 } 
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] || ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['exibe_seq'] == "S")) { 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_tp_updateby_grid_line'] . "\" NOWRAP align=\"right\" valign=\"top\"   HEIGHT=\"0px\">" . $seq_det . "</TD>\r\n");
 } 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['field_order'] as $Cada_col)
          { 
              $NM_func_grid = "NM_grid_" . $Cada_col;
              $this->$NM_func_grid();
          } 
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida_grid'])
 ...
 function NM_calc_span()
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida_pdf'] == "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['exibe_seq'] != "S" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
       {
           $this->NM_colspan--; 
       }
   } 
 ...
 function quebra_geral_sc_free_total_bot() 
 {
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "nm_gp_move('xls', '0')", "nm_gp_move('xls', '0')", "xls_top", "", "Download ke Excel", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "klik disini untuk download", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
          if (is_file("downloaddetail_inwitel_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("downloaddetail_inwitel_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['dashboard_info']['under_dashboard']))
      {
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "downloaddetail_inwitel/downloaddetail_inwitel_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnSelCamposShow('" . $this->Ini->path_link . "downloaddetail_inwitel/downloaddetail_inwitel_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
          $nm_saida->saida("         </td> \r\n");
   ...
   function nmgp_barra_bot_normal()
   {
      ...
      $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"left\" width=\"33%\"> \r\n");
          ...
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_lin_grid'];
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_lin_grid'] == 10) ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_lin_grid'] == 20) ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_lin_grid'] == 50) ? " selected" : "";
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opc_liga']['nav']))
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_avanca", "nm_gp_submit_rec('" . $this->Rec_fim . "')", "nm_gp_submit_rec('" . $this->Rec_fim . "')", "forward_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opc_liga']['nav']))
          {
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </TABLE>\r\n");
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['ajax_nav'])
       {
   ...
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           if ($this->arr_buttons['bcons_avanca']['type'] != 'image')
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
   ...
   {
       $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
       $nm_saida->saida("      parent.scAjaxDetailHeight('downloaddetail_inwitel', $(document).innerHeight());\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
 }
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"downloaddetail_inwitel\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"downloaddetail_inwitel_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . NM_encode_input(session_id()) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['downloaddetail_inwitel_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@downloaddetail_inwitel@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   $nm_saida->saida("       if (\"pdf\" == x)\r\n");
   $nm_saida->saida("       {\r\n");
   $nm_saida->saida("           window.location = \"" . $this->Ini->path_link . "downloaddetail_inwitel/downloaddetail_inwitel_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_create_charts=\" + crt + \"&sc_graf_pdf=\" + g;\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['downloaddetail_inwitel']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Doc = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Doc = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Doc = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"downloaddetail_inwitel_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['reg_start']))
   {
       $nm_saida->saida("      parent.scAjaxDetailStatus('downloaddetail_inwitel');\r\n");
       $nm_saida->saida("      parent.scAjaxDetailHeight('downloaddetail_inwitel', $(document).innerHeight());\r\n");
   }
   $nm_saida->saida("   </script>\r\n");
 }
