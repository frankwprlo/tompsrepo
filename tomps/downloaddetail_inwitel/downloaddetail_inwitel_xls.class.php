...
class downloaddetail_inwitel_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= "_downloaddetail_inwitel";
      $this->Arquivo   .= ".xlsx";
      $this->Tit_doc    = "downloaddetail_inwitel.xlsx";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['order_grid'];
      ...
      { 
          ...
          if ($Cada_col == "md_namadivre" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "tp_taskaktifplanstart" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "tp_taskaktifplanfinish" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      while (!$rs->EOF)
      {
         ...
         $this->tp_prjtrelease = $rs->fields[2] ;  
         $this->tp_prjtrelease = (string)$this->tp_prjtrelease;
         $this->tp_batch = $rs->fields[3] ;  
         $this->tp_idlop = $rs->fields[4] ;  
         $this->tp_namalop = $rs->fields[5] ;  
         $this->tp_lokasi = $rs->fields[6] ;  
         $this->md_namadivre = $rs->fields[7] ;  
         $this->mw_namawitel = $rs->fields[8] ;  
         $this->ms_namasto = $rs->fields[9] ;  
         $this->tp_projectname = $rs->fields[10] ;  
         $this->tm_namamitra = $rs->fields[11] ;  
         $this->tp_odp = $rs->fields[12] ;  
         $this->tp_odp = (string)$this->tp_odp;
         $this->tp_planstart = $rs->fields[13] ;  
         $this->tp_planfinish = $rs->fields[14] ;  
         $this->tp_actualstart = $rs->fields[15] ;  
         $this->tp_actualfinish = $rs->fields[16] ;  
         $this->tp_templateproject = $rs->fields[17] ;  
         ...
         $this->tp_jmldistribusi = $rs->fields[22] ;  
         $this->tp_jmldistribusi = (string)$this->tp_jmldistribusi;
         $this->tp_nilai = $rs->fields[23] ;  
         $this->tp_nilai = (string)$this->tp_nilai;
         $this->tp_rab = $rs->fields[24] ;  
         $this->tp_rab = (string)$this->tp_rab;
         $this->statusname = $rs->fields[25] ;  
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
          { 
              $this->tp_summary = "";  
              if (is_file($rs_grid->fields[26])) 
              { 
                  $this->tp_summary = file_get_contents($rs_grid->fields[26]);  
              } 
          } 
         else
         { 
             $this->tp_summary = $rs->fields[26] ;  
         } 
         $this->tp_witel = $rs->fields[27] ;  
         $this->tp_witel = (string)$this->tp_witel;
         $this->tp_datel = $rs->fields[28] ;  
         $this->tp_datel = (string)$this->tp_datel;
         $this->tp_sto = $rs->fields[29] ;  
         $this->tp_sto = (string)$this->tp_sto;
         $this->tp_status = $rs->fields[30] ;  
         $this->tp_status = (string)$this->tp_status;
         $this->tp_mitra = $rs->fields[31] ;  
         $this->tp_mitra = (string)$this->tp_mitra;
         $this->tp_taskaktif = $rs->fields[32] ;  
         $this->tp_prosentase = $rs->fields[33] ;  
         $this->tp_prosentase =  str_replace(",", ".", $this->tp_prosentase);
         $this->tp_prosentase = (string)$this->tp_prosentase;
         $this->tp_tahapanaktif = $rs->fields[34] ;  
         $this->tp_taskaktifstatus = $rs->fields[35] ;  
         $this->tp_taskaktifstatus = (string)$this->tp_taskaktifstatus;
         $this->tp_taskaktifplanstart = $rs->fields[36] ;  
         $this->tp_taskaktifplanfinish = $rs->fields[37] ;  
         $this->tp_entrydate = $rs->fields[38] ;  
         $this->tp_entryby = $rs->fields[39] ;  
         $this->tp_updatedate = $rs->fields[40] ;  
         $this->tp_updateby = $rs->fields[41] ;  
   ...
   //----- md_namadivre
   function NM_export_md_namadivre()
   {
         $this->md_namadivre = html_entity_decode($this->md_namadivre, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->md_namadivre = strip_tags($this->md_namadivre);
         if (!NM_is_utf8($this->md_namadivre))
         {
             $this->md_namadivre = sc_convert_encoding($this->md_namadivre, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->md_namadivre, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- mw_namawitel
   ...
   function NM_export_tp_taskaktifplanstart()
   {
         $this->tp_taskaktifplanstart = substr($this->tp_taskaktifplanstart, 0, 10);
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         if (empty($this->tp_taskaktifplanstart) || $this->tp_taskaktifplanstart == "0000-00-00")
         {
             $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->tp_taskaktifplanstart, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->tp_taskaktifplanstart);
             $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getNumberFormat()->setFormatCode($this->SC_date_conf_region);
         }
         $this->Xls_col++;
   }
   //----- tp_taskaktifplanfinish
   function NM_export_tp_taskaktifplanfinish()
   {
         $this->tp_taskaktifplanfinish = substr($this->tp_taskaktifplanfinish, 0, 10);
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         if (empty($this->tp_taskaktifplanfinish) || $this->tp_taskaktifplanfinish == "0000-00-00")
         {
             $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->tp_taskaktifplanfinish, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->tp_taskaktifplanfinish);
             $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getNumberFormat()->setFormatCode($this->SC_date_conf_region);
         }
         $this->Xls_col++;
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail_inwitel'][$path_doc_md5][1] = $this->Tit_doc;
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE>Data LOP Detail :: Excel</TITLE>
