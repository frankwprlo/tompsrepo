<?php
   ...
   session_start();
    ...
    $Sel_Cmp = new downloaddetail_sel_cmp(); 
    $Sel_Cmp->Sel_cmp_init();
   
class downloaddetail_sel_cmp
{
function Sel_cmp_init()
{
   ...
   $tab_ger_campos['tp_witel'] = "on";
   $tab_ger_campos['tp_sto'] = "on";
   $tab_ger_campos['tp_odp'] = "on";
   $tab_ger_campos['tp_planstart'] = "on";
   $tab_ger_campos['tp_planfinish'] = "on";
   $tab_ger_campos['tp_entrydate'] = "on";
   $tab_blk_campos[] = "tp_entrydate";
   $tab_ger_campos['tp_entryby'] = "on";
   $tab_blk_campos[] = "tp_entryby";
   $tab_ger_campos['tp_updatedate'] = "on";
   $tab_blk_campos[] = "tp_updatedate";
   $tab_ger_campos['tp_updateby'] = "on";
   $tab_blk_campos[] = "tp_updateby";
   ...
   $tab_ger_campos['tp_datel'] = "on";
   $tab_ger_campos['tp_nokontrak'] = "on";
   $tab_ger_campos['tp_ponumber'] = "on";
   $tab_ger_campos['ppo_id'] = "on";
   $tab_blk_campos[] = "ppo_id";
   $tab_ger_campos['ppo_projectid'] = "on";
   $tab_blk_campos[] = "ppo_projectid";
   $tab_ger_campos['ppo_tahapanproject'] = "on";
   $tab_blk_campos[] = "ppo_tahapanproject";
   $tab_ger_campos['ppo_tasktahapan'] = "on";
   $tab_blk_campos[] = "ppo_tasktahapan";
   $tab_ger_campos['ppo_entrydate'] = "on";
   $tab_blk_campos[] = "ppo_entrydate";
   $tab_ger_campos['ppo_entryby'] = "on";
   $tab_blk_campos[] = "ppo_entryby";
   $tab_ger_campos['ppo_updatedate'] = "on";
   $tab_blk_campos[] = "ppo_updatedate";
   $tab_ger_campos['ppo_updateby'] = "on";
   $tab_blk_campos[] = "ppo_updateby";
   $tab_ger_campos['ppo_note'] = "on";
   $tab_blk_campos[] = "ppo_note";
   $tab_ger_campos['ppo_evident_one'] = "on";
   $tab_blk_campos[] = "ppo_evident_one";
   $tab_ger_campos['ppo_evident_two'] = "on";
   $tab_blk_campos[] = "ppo_evident_two";
   $tab_ger_campos['ppo_evident_three'] = "on";
   $tab_blk_campos[] = "ppo_evident_three";
   $tab_ger_campos['ppo_status'] = "on";
   $tab_blk_campos[] = "ppo_status";
   $tab_ger_campos['ppo_tglmulaiplan'] = "on";
   $tab_blk_campos[] = "ppo_tglmulaiplan";
   $tab_ger_campos['ppo_targethari'] = "on";
   $tab_blk_campos[] = "ppo_targethari";
   $tab_ger_campos['ppo_targetselesai'] = "on";
   $tab_blk_campos[] = "ppo_targetselesai";
   $tab_ger_campos['ppo_tglmulaiactual'] = "on";
   $tab_blk_campos[] = "ppo_tglmulaiactual";
   $tab_ger_campos['ppo_tglselesaiactual'] = "on";
   $tab_blk_campos[] = "ppo_tglselesaiactual";
   $tab_ger_campos['ppo_tasknumber'] = "on";
   $tab_blk_campos[] = "ppo_tasknumber";
   $tab_ger_campos['ppo_realaktual'] = "on";
   $tab_blk_campos[] = "ppo_realaktual";
   $tab_ger_campos['statusname'] = "on";
   $tab_blk_campos[] = "statusname";
   $tab_ger_campos['ms_namasto'] = "on";
   $tab_blk_campos[] = "ms_namasto";
   $tab_ger_campos['md_namadatel'] = "on";
   $tab_blk_campos[] = "md_namadatel";
   $tab_ger_campos['tm_namamitra'] = "on";
   $tab_blk_campos[] = "tm_namamitra";
   $tab_ger_campos['statusproject'] = "on";
   $tab_blk_campos[] = "statusproject";
   ...
   if (isset($_SESSION['sc_session'][$this->sc_init]['downloaddetail']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->sc_init]['downloaddetail']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->sc_init]['downloaddetail']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (isset($_SESSION['sc_session'][$this->sc_init]['downloaddetail']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->sc_init]['downloaddetail']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->sc_init]['downloaddetail']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
...
function Sel_processa_out()
{
   ...
   $arr_temp = array();
   if (!isset($_SESSION['sc_session'][$this->sc_init]['downloaddetail']['usr_cmp_sel']))
   {
       $_SESSION['sc_session'][$this->sc_init]['downloaddetail']['usr_cmp_sel'] = array();
   }
   $arr_order = $_SESSION['sc_session'][$this->sc_init]['downloaddetail']['field_order'];
   $_SESSION['sc_session'][$this->sc_init]['downloaddetail']['field_order'] = array();
   $campos_sel = explode("@?@", $this->campos_sel);
   foreach ($campos_sel as $campo_order)
   {
       if (isset($tab_ger_campos[$campo_order]))
       {
           $_SESSION['sc_session'][$this->sc_init]['downloaddetail']['field_order'][] = $campo_order;
       }
   }
   foreach ($arr_order as $campo_order)
   {
       if (!in_array($campo_order, $_SESSION['sc_session'][$this->sc_init]['downloaddetail']['field_order']))
       {
           $_SESSION['sc_session'][$this->sc_init]['downloaddetail']['field_order'][] = $campo_order;
       }
   }
   ...
   $_SESSION['sc_session'][$this->sc_init]['downloaddetail']['usr_cmp_sel'] = $arr_temp;
?>
...
?>
  function scSubmitSelCampos(sPos) {
   ...
   $.ajax({
    type: "POST",
    url: "downloaddetail_sel_campos.php",
    data: {
...
<?php
   ...
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if ($NM_cada_opc != "on")
           {
               $prep_combo[strtolower($NM_cada_field)] = $_SESSION['sc_session'][$this->sc_init]['downloaddetail']['labels'][$NM_cada_field];
           }
       }
   }
...
<?php
   if (isset($_SESSION['sc_session'][$this->sc_init]['downloaddetail']['field_order']))
   {
       foreach ($_SESSION['sc_session'][$this->sc_init]['downloaddetail']['field_order'] as $NM_cada_field)
       {
           if ($tab_ger_campos[$NM_cada_field] == "on")
           {
               ...
               {
?>
     <li class="sc_ui_litem scAppDivSelectFieldsEnabled" id="sc_id_itemsel_<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $_SESSION['sc_session'][$this->sc_init]['downloaddetail']['labels'][$NM_cada_field]; ?></li>
<?php
               }
               else
               {
?>
     <li class="sc_ui_litem scAppDivSelectFieldsDisabled" id="sc_id_itemsel_<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $_SESSION['sc_session'][$this->sc_init]['downloaddetail']['labels'][$NM_cada_field]; ?></li>
<?php
               }
           }
       }
