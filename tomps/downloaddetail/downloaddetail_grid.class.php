...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['charts_html'] = '';
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'])
   { 
   ...
   { 
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['downloaddetail'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'];
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] == "pdf")
       { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'];
 }
...
//
   ...
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "downloaddetail/downloaddetail_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['doc_word'])
       { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'])
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['force_toolbar']);
   } 
   $this->width_tabula_quebra  = "0px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['downloaddetail']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['downloaddetail']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['downloaddetail']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opc_psq'])
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['mostra_edit'] = "N";
   }
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'])
   ...
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['print_all'];
   if ($this->Print_All)
   {
   ...
   $this->Cmps_ord_def['PPO_ID'] = " asc";
   $this->Cmps_ord_def['PPO_PROJECTID'] = " asc";
   $this->Cmps_ord_def['PPO_TAHAPANPROJECT'] = " asc";
   $this->Cmps_ord_def['PPO_TASKTAHAPAN'] = " asc";
   $this->Cmps_ord_def['PPO_ENTRYDATE'] = " asc";
   $this->Cmps_ord_def['PPO_ENTRYBY'] = " asc";
   $this->Cmps_ord_def['PPO_UPDATEDATE'] = " asc";
   $this->Cmps_ord_def['PPO_UPDATEBY'] = " asc";
   $this->Cmps_ord_def['PPO_NOTE'] = " asc";
   $this->Cmps_ord_def['PPO_EVIDENT_ONE'] = " asc";
   $this->Cmps_ord_def['PPO_EVIDENT_TWO'] = " asc";
   $this->Cmps_ord_def['PPO_EVIDENT_THREE'] = " asc";
   $this->Cmps_ord_def['PPO_STATUS'] = " asc";
   $this->Cmps_ord_def['PPO_TGLMULAIPLAN'] = " asc";
   $this->Cmps_ord_def['PPO_TARGETHARI'] = " asc";
   $this->Cmps_ord_def['PPO_TARGETSELESAI'] = " asc";
   $this->Cmps_ord_def['PPO_TGLMULAIACTUAL'] = " asc";
   $this->Cmps_ord_def['PPO_TGLSELESAIACTUAL'] = " asc";
   $this->Cmps_ord_def['PPO_TASKNUMBER'] = " asc";
   $this->Cmps_ord_def['PPO_REALAKTUAL'] = " asc";
   ...
   $this->Cmps_ord_def['STATUSPROJECT'] = " asc";
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['where_pesq_ant'];  
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] = "muda_qt_linhas";
   } 

   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['downloaddetail'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['downloaddetail'];
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "downloaddetail/downloaddetail_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "downloaddetail_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new downloaddetail_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['downloaddetail']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['downloaddetail']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['downloaddetail']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['downloaddetail']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['downloaddetail']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['downloaddetail']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['downloaddetail']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['downloaddetail']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_quebra'] = array(); 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['where_orig'] = " where TP_WITEL='" . $_SESSION['idwitel'] . "'";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['where_orig'];  
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao']       = "igual" ; 
   } 
// 
   $this->count_ger = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['sc_total']);
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $this->tp_batch = $this->rs_grid->fields[1] ;  
       $this->tp_projectname = $this->rs_grid->fields[2] ;  
       $this->tp_lokasi = $this->rs_grid->fields[3] ;  
       $this->tp_mitra = $this->rs_grid->fields[4] ;  
       $this->tp_mitra = (string)$this->tp_mitra;
       $this->tp_witel = $this->rs_grid->fields[5] ;  
       $this->tp_witel = (string)$this->tp_witel;
       $this->tp_sto = $this->rs_grid->fields[6] ;  
       ...
       $this->tp_planfinish = $this->rs_grid->fields[9] ;  
       $this->tp_entrydate = $this->rs_grid->fields[10] ;  
       $this->tp_entryby = $this->rs_grid->fields[11] ;  
       $this->tp_updatedate = $this->rs_grid->fields[12] ;  
       $this->tp_updateby = $this->rs_grid->fields[13] ;  
       if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
       { 
           $this->tp_summary = "";  
           if (is_file($this->rs_grid->fields[14])) 
           { 
               $this->tp_summary = file_get_contents($this->rs_grid->fields[14]);  
           } 
       } 
       else
       { 
           $this->tp_summary = $this->rs_grid->fields[14] ;  
       } 
       $this->tp_status = $this->rs_grid->fields[15] ;  
       $this->tp_status = (string)$this->tp_status;
       $this->tp_actualstart = $this->rs_grid->fields[16] ;  
       $this->tp_actualfinish = $this->rs_grid->fields[17] ;  
       $this->tp_templateproject = $this->rs_grid->fields[18] ;  
       ...
       $this->tp_prjtrelease = $this->rs_grid->fields[20] ;  
       ...
       $this->tp_datel = $this->rs_grid->fields[22] ;  
       $this->tp_datel = (string)$this->tp_datel;
       $this->tp_nokontrak = $this->rs_grid->fields[23] ;  
       $this->tp_ponumber = $this->rs_grid->fields[24] ;  
       $this->ppo_id = $this->rs_grid->fields[25] ;  
       $this->ppo_id = (string)$this->ppo_id;
       $this->ppo_projectid = $this->rs_grid->fields[26] ;  
       $this->ppo_projectid = (string)$this->ppo_projectid;
       $this->ppo_tahapanproject = $this->rs_grid->fields[27] ;  
       $this->ppo_tahapanproject = (string)$this->ppo_tahapanproject;
       $this->ppo_tasktahapan = $this->rs_grid->fields[28] ;  
       $this->ppo_entrydate = $this->rs_grid->fields[29] ;  
       $this->ppo_entryby = $this->rs_grid->fields[30] ;  
       $this->ppo_updatedate = $this->rs_grid->fields[31] ;  
       $this->ppo_updateby = $this->rs_grid->fields[32] ;  
       $this->ppo_note = $this->rs_grid->fields[33] ;  
       $this->ppo_evident_one = $this->rs_grid->fields[34] ;  
       $this->ppo_evident_two = $this->rs_grid->fields[35] ;  
       $this->ppo_evident_three = $this->rs_grid->fields[36] ;  
       $this->ppo_status = $this->rs_grid->fields[37] ;  
       $this->ppo_tglmulaiplan = $this->rs_grid->fields[38] ;  
       $this->ppo_targethari = $this->rs_grid->fields[39] ;  
       $this->ppo_targethari = (string)$this->ppo_targethari;
       $this->ppo_targetselesai = $this->rs_grid->fields[40] ;  
       $this->ppo_tglmulaiactual = $this->rs_grid->fields[41] ;  
       $this->ppo_tglselesaiactual = $this->rs_grid->fields[42] ;  
       $this->ppo_tasknumber = $this->rs_grid->fields[43] ;  
       $this->ppo_tasknumber = (string)$this->ppo_tasknumber;
       $this->ppo_realaktual = $this->rs_grid->fields[44] ;  
       $this->ppo_realaktual =  str_replace(",", ".", $this->ppo_realaktual);
       $this->ppo_realaktual = (string)$this->ppo_realaktual;
       $this->statusname = $this->rs_grid->fields[45] ;  
       $this->ms_namasto = $this->rs_grid->fields[46] ;  
       $this->md_namadatel = $this->rs_grid->fields[47] ;  
       $this->tm_namamitra = $this->rs_grid->fields[48] ;  
       $this->statusproject = $this->rs_grid->fields[49] ;  
       $this->SC_seq_register = $this->nmgp_reg_start ; 
       $this->SC_seq_page = 0;
       $this->SC_sep_quebra = false;
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['final']; 
   ...
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'])
   { 
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['pivot_charts']) : 0;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ajax_nav'])
       { 
           ...
           $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . session_id() . "\">\r\n");
           $nm_saida->saida("   </form>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"downloaddetail_jquery.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"downloaddetail_ajax.js\"></script>\r\n");
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($this->count_ger) . ";\r\n");
           }
           else
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_reg_grid']) . ";\r\n");
           }
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ancor_save']);
           }
           $nm_saida->saida("   });\r\n");
           ...
           $nm_saida->saida("       dataType: \"html\",\r\n");
           $nm_saida->saida("       url: \"downloaddetail_save_grid.php\",\r\n");
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_downloaddetail_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'])
       {
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_downloaddetail_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_downloaddetail_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "downloaddetail/downloaddetail_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           $cada_css = ".downloaddetail_" . substr($cada_css, 1);
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf" && !$this->Print_All)
       { 
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['downloaddetail']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['downloaddetail']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['downloaddetail']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['downloaddetail']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida']) ? "downloaddetail_" : "";
   $this->css_sep = " ";
   ...
   $this->css_ppo_updatedate_label = $compl_css_emb . "css_ppo_updatedate_label";
   $this->css_ppo_updatedate_grid_line = $compl_css_emb . "css_ppo_updatedate_grid_line";
   $this->css_ppo_updateby_label = $compl_css_emb . "css_ppo_updateby_label";
   $this->css_ppo_updateby_grid_line = $compl_css_emb . "css_ppo_updateby_grid_line";
   $this->css_ppo_note_label = $compl_css_emb . "css_ppo_note_label";
   $this->css_ppo_note_grid_line = $compl_css_emb . "css_ppo_note_grid_line";
   $this->css_ppo_evident_one_label = $compl_css_emb . "css_ppo_evident_one_label";
   $this->css_ppo_evident_one_grid_line = $compl_css_emb . "css_ppo_evident_one_grid_line";
   $this->css_ppo_evident_two_label = $compl_css_emb . "css_ppo_evident_two_label";
   $this->css_ppo_evident_two_grid_line = $compl_css_emb . "css_ppo_evident_two_grid_line";
   $this->css_ppo_evident_three_label = $compl_css_emb . "css_ppo_evident_three_label";
   $this->css_ppo_evident_three_grid_line = $compl_css_emb . "css_ppo_evident_three_grid_line";
   ...
   $this->css_ppo_realaktual_label = $compl_css_emb . "css_ppo_realaktual_label";
   $this->css_ppo_realaktual_grid_line = $compl_css_emb . "css_ppo_realaktual_grid_line";
   ...
   $this->css_statusproject_label = $compl_css_emb . "css_statusproject_label";
   $this->css_statusproject_grid_line = $compl_css_emb . "css_statusproject_grid_line";
 }  
// 
 function label_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_downloaddetail__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-downloaddetail-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_statusproject_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_statusproject_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
     ...
     { 
         ...
         { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 $css_emb .= ".downloaddetail_" . substr($cada_css, 1);
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_tp_id()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_ID')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
 ...
 function NM_label_tp_batch()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_BATCH')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_projectname()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_PROJECTNAME')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_lokasi()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_LOKASI')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_mitra()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_MITRA')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_witel()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_WITEL')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_sto()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_STO')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_odp()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_ODP')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_planstart()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_PLANSTART')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_planfinish()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_PLANFINISH')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_entrydate()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_ENTRYDATE')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_entryby()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_ENTRYBY')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_updatedate()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_UPDATEDATE')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_updateby()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_UPDATEBY')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_summary()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_SUMMARY')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_status()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_STATUS')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_actualstart()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_ACTUALSTART')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_actualfinish()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_ACTUALFINISH')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_templateproject()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_TEMPLATEPROJECT')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_jenisproject()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_JENISPROJECT')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_prjtrelease()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_PRJTRELEASE')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_targetwaktu()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_TARGETWAKTU')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_datel()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_DATEL')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_nokontrak()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_NOKONTRAK')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_ponumber()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TP_PONUMBER')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_ppo_id()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_ppo_id_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ppo_id_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'PPO_ID')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('PPO_ID')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_ppo_projectid()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_ppo_projectid_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ppo_projectid_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'PPO_PROJECTID')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('PPO_PROJECTID')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_ppo_tahapanproject()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_ppo_tahapanproject_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ppo_tahapanproject_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'PPO_TAHAPANPROJECT')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('PPO_TAHAPANPROJECT')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_ppo_tasktahapan()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_ppo_tasktahapan_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ppo_tasktahapan_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'PPO_TASKTAHAPAN')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('PPO_TASKTAHAPAN')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_ppo_entrydate()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_ppo_entrydate_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ppo_entrydate_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'PPO_ENTRYDATE')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('PPO_ENTRYDATE')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_ppo_entryby()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_ppo_entryby_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ppo_entryby_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'PPO_ENTRYBY')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('PPO_ENTRYBY')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_ppo_updatedate()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['ppo_updatedate'])) ? $this->New_label['ppo_updatedate'] : "PPO UPDATEDATE"; 
   if (!isset($this->NM_cmp_hidden['ppo_updatedate']) || $this->NM_cmp_hidden['ppo_updatedate'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_ppo_updatedate_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ppo_updatedate_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'PPO_UPDATEDATE')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('PPO_UPDATEDATE')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_ppo_updateby()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['ppo_updateby'])) ? $this->New_label['ppo_updateby'] : "PPO UPDATEBY"; 
   if (!isset($this->NM_cmp_hidden['ppo_updateby']) || $this->NM_cmp_hidden['ppo_updateby'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_ppo_updateby_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ppo_updateby_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'PPO_UPDATEBY')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('PPO_UPDATEBY')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_ppo_note()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_ppo_note_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ppo_note_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'PPO_NOTE')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('PPO_NOTE')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_ppo_evident_one()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['ppo_evident_one'])) ? $this->New_label['ppo_evident_one'] : "PPO EVIDENT ONE"; 
   if (!isset($this->NM_cmp_hidden['ppo_evident_one']) || $this->NM_cmp_hidden['ppo_evident_one'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_ppo_evident_one_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ppo_evident_one_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'PPO_EVIDENT_ONE')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('PPO_EVIDENT_ONE')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_ppo_evident_two()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['ppo_evident_two'])) ? $this->New_label['ppo_evident_two'] : "PPO EVIDENT TWO"; 
   if (!isset($this->NM_cmp_hidden['ppo_evident_two']) || $this->NM_cmp_hidden['ppo_evident_two'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_ppo_evident_two_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ppo_evident_two_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'PPO_EVIDENT_TWO')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('PPO_EVIDENT_TWO')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_ppo_evident_three()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['ppo_evident_three'])) ? $this->New_label['ppo_evident_three'] : "PPO EVIDENT THREE"; 
   if (!isset($this->NM_cmp_hidden['ppo_evident_three']) || $this->NM_cmp_hidden['ppo_evident_three'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_ppo_evident_three_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ppo_evident_three_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'PPO_EVIDENT_THREE')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('PPO_EVIDENT_THREE')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_ppo_status()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_ppo_status_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ppo_status_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'PPO_STATUS')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('PPO_STATUS')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_ppo_tglmulaiplan()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_ppo_tglmulaiplan_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ppo_tglmulaiplan_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'PPO_TGLMULAIPLAN')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('PPO_TGLMULAIPLAN')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_ppo_targethari()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_ppo_targethari_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ppo_targethari_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'PPO_TARGETHARI')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('PPO_TARGETHARI')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_ppo_targetselesai()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_ppo_targetselesai_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ppo_targetselesai_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'PPO_TARGETSELESAI')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('PPO_TARGETSELESAI')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_ppo_tglmulaiactual()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_ppo_tglmulaiactual_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ppo_tglmulaiactual_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'PPO_TGLMULAIACTUAL')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('PPO_TGLMULAIACTUAL')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_ppo_tglselesaiactual()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_ppo_tglselesaiactual_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ppo_tglselesaiactual_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'PPO_TGLSELESAIACTUAL')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('PPO_TGLSELESAIACTUAL')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_ppo_tasknumber()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_ppo_tasknumber_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ppo_tasknumber_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'PPO_TASKNUMBER')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('PPO_TASKNUMBER')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_ppo_realaktual()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['ppo_realaktual'])) ? $this->New_label['ppo_realaktual'] : "PPO REALAKTUAL"; 
   if (!isset($this->NM_cmp_hidden['ppo_realaktual']) || $this->NM_cmp_hidden['ppo_realaktual'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_ppo_realaktual_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ppo_realaktual_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'PPO_REALAKTUAL')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('PPO_REALAKTUAL')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_statusname()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'STATUSNAME')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_ms_namasto()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'MS_NAMASTO')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_md_namadatel()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'MD_NAMADATEL')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tm_namamitra()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'TM_NAMAMITRA')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_statusproject()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['statusproject'])) ? $this->New_label['statusproject'] : "STATUSPROJECT"; 
   if (!isset($this->NM_cmp_hidden['statusproject']) || $this->NM_cmp_hidden['statusproject'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_statusproject_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_statusproject_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_cmp'] == 'STATUSPROJECT')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('STATUSPROJECT')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ini_cor_grid']);
       }
   }
...
// 
   $SC_Label = (isset($this->New_label['tp_id'])) ? $this->New_label['tp_id'] : "ID"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_id'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_batch'])) ? $this->New_label['tp_batch'] : "BATCH"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_batch'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_projectname'])) ? $this->New_label['tp_projectname'] : "PROJECTNAME"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_projectname'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_lokasi'])) ? $this->New_label['tp_lokasi'] : "LOKASI"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_lokasi'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_mitra'])) ? $this->New_label['tp_mitra'] : "MITRA"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_mitra'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_witel'])) ? $this->New_label['tp_witel'] : "WITEL"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_witel'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_sto'])) ? $this->New_label['tp_sto'] : "STO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_sto'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_odp'])) ? $this->New_label['tp_odp'] : "ODP"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_odp'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_planstart'])) ? $this->New_label['tp_planstart'] : "PLANSTART"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_planstart'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_planfinish'])) ? $this->New_label['tp_planfinish'] : "PLANFINISH"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_planfinish'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_entrydate'])) ? $this->New_label['tp_entrydate'] : "ENTRYDATE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_entrydate'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_entryby'])) ? $this->New_label['tp_entryby'] : "ENTRYBY"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_entryby'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_updatedate'])) ? $this->New_label['tp_updatedate'] : "UPDATEDATE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_updatedate'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_updateby'])) ? $this->New_label['tp_updateby'] : "UPDATEBY"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_updateby'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_summary'])) ? $this->New_label['tp_summary'] : "SUMMARY"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_summary'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_status'])) ? $this->New_label['tp_status'] : "STATUS"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_status'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_actualstart'])) ? $this->New_label['tp_actualstart'] : "ACTUALSTART"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_actualstart'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_actualfinish'])) ? $this->New_label['tp_actualfinish'] : "ACTUALFINISH"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_actualfinish'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_templateproject'])) ? $this->New_label['tp_templateproject'] : "TEMPLATEPROJECT"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_templateproject'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_jenisproject'])) ? $this->New_label['tp_jenisproject'] : "JENISPROJECT"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_jenisproject'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_prjtrelease'])) ? $this->New_label['tp_prjtrelease'] : "PRJTRELEASE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_prjtrelease'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_targetwaktu'])) ? $this->New_label['tp_targetwaktu'] : "TARGETWAKTU"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_targetwaktu'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_datel'])) ? $this->New_label['tp_datel'] : "DATEL"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_datel'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_nokontrak'])) ? $this->New_label['tp_nokontrak'] : "NOKONTRAK"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_nokontrak'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_ponumber'])) ? $this->New_label['tp_ponumber'] : "PONUMBER"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tp_ponumber'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ppo_id'])) ? $this->New_label['ppo_id'] : "PPO ID"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['ppo_id'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ppo_projectid'])) ? $this->New_label['ppo_projectid'] : "PPO PROJECTID"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['ppo_projectid'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ppo_tahapanproject'])) ? $this->New_label['ppo_tahapanproject'] : "PPO TAHAPANPROJECT"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['ppo_tahapanproject'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ppo_tasktahapan'])) ? $this->New_label['ppo_tasktahapan'] : "PPO TASKTAHAPAN"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['ppo_tasktahapan'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ppo_entrydate'])) ? $this->New_label['ppo_entrydate'] : "PPO ENTRYDATE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['ppo_entrydate'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ppo_entryby'])) ? $this->New_label['ppo_entryby'] : "PPO ENTRYBY"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['ppo_entryby'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ppo_updatedate'])) ? $this->New_label['ppo_updatedate'] : "PPO UPDATEDATE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['ppo_updatedate'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ppo_updateby'])) ? $this->New_label['ppo_updateby'] : "PPO UPDATEBY"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['ppo_updateby'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ppo_note'])) ? $this->New_label['ppo_note'] : "PPO NOTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['ppo_note'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ppo_evident_one'])) ? $this->New_label['ppo_evident_one'] : "PPO EVIDENT ONE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['ppo_evident_one'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ppo_evident_two'])) ? $this->New_label['ppo_evident_two'] : "PPO EVIDENT TWO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['ppo_evident_two'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ppo_evident_three'])) ? $this->New_label['ppo_evident_three'] : "PPO EVIDENT THREE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['ppo_evident_three'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ppo_status'])) ? $this->New_label['ppo_status'] : "PPO STATUS"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['ppo_status'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ppo_tglmulaiplan'])) ? $this->New_label['ppo_tglmulaiplan'] : "PPO TGLMULAIPLAN"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['ppo_tglmulaiplan'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ppo_targethari'])) ? $this->New_label['ppo_targethari'] : "PPO TARGETHARI"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['ppo_targethari'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ppo_targetselesai'])) ? $this->New_label['ppo_targetselesai'] : "PPO TARGETSELESAI"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['ppo_targetselesai'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ppo_tglmulaiactual'])) ? $this->New_label['ppo_tglmulaiactual'] : "PPO TGLMULAIACTUAL"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['ppo_tglmulaiactual'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ppo_tglselesaiactual'])) ? $this->New_label['ppo_tglselesaiactual'] : "PPO TGLSELESAIACTUAL"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['ppo_tglselesaiactual'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ppo_tasknumber'])) ? $this->New_label['ppo_tasknumber'] : "PPO TASKNUMBER"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['ppo_tasknumber'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ppo_realaktual'])) ? $this->New_label['ppo_realaktual'] : "PPO REALAKTUAL"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['ppo_realaktual'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['statusname'])) ? $this->New_label['statusname'] : "STATUSNAME"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['statusname'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ms_namasto'])) ? $this->New_label['ms_namasto'] : "MS NAMASTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['ms_namasto'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['md_namadatel'])) ? $this->New_label['md_namadatel'] : "MD NAMADATEL"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['md_namadatel'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tm_namamitra'])) ? $this->New_label['tm_namamitra'] : "TM NAMAMITRA"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['tm_namamitra'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['statusproject'])) ? $this->New_label['statusproject'] : "STATUSPROJECT"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['labels']['statusproject'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['downloaddetail']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['downloaddetail']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['downloaddetail']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_downloaddetail#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               $nm_saida->saida("  <tr><td class=\"" . $this->css_scGridTabelaTd . " " . "\" style=\"font-family:" . $this->Ini->texto_fonte_tipo_impar . ";font-size:12px;color:#000000;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\">\r\n");
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  " . $this->nm_grid_sem_reg . "\r\n");
   ...
   { 
       $nm_saida->saida(" <TR> \r\n");
       $nm_id_aplicacao = " id=\"apl_downloaddetail#?#1\"";
   } 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-1ff34d88\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida_grid'])
   { 
       $_SESSION['scriptcase']['saida_html'] = "";
   } 
// 
   $nm_quant_linhas = 0 ;
   $nm_inicio_pag = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] == "pdf")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['final'] = 0;
   } 
   ...
   $ini_grid = true;
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          $this->NM_field_style = array();
          //---------- Gauge ----------
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
          ...
          $this->statusproject = $this->rs_grid->fields[49] ;  
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['final'] + 1; 
          if (!$ini_grid) {
          ...
          if (($nm_houve_quebra == "S" || $nm_inicio_pag == 0) && !$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida_grid'])
          { 
              $this->label_grid($linhas);
              $nm_houve_quebra = "N";
          } 
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['dado_psq_ret'];
          ...
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_statusproject_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_statusproject_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . $teste . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . $teste . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
          ...
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida_grid'])
 ...
 function NM_grid_ppo_id()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['ppo_id']) || $this->NM_cmp_hidden['ppo_id'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->ppo_id)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
 ...
 function NM_grid_ppo_updatedate()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['ppo_updatedate']) || $this->NM_cmp_hidden['ppo_updatedate'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->ppo_updatedate)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_ppo_updatedate_grid_line . "\"  style=\"" . $this->Css_Cmp['css_ppo_updatedate_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_ppo_updatedate_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_ppo_updateby()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['ppo_updateby']) || $this->NM_cmp_hidden['ppo_updateby'] != "off") { 
          $conteudo = sc_strip_script($this->ppo_updateby); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_ppo_updateby_grid_line . "\"  style=\"" . $this->Css_Cmp['css_ppo_updateby_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_ppo_updateby_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_grid_ppo_evident_one()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['ppo_evident_one']) || $this->NM_cmp_hidden['ppo_evident_one'] != "off") { 
          $conteudo = sc_strip_script($this->ppo_evident_one); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_ppo_evident_one_grid_line . "\"  style=\"" . $this->Css_Cmp['css_ppo_evident_one_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_ppo_evident_one_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_ppo_evident_two()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['ppo_evident_two']) || $this->NM_cmp_hidden['ppo_evident_two'] != "off") { 
          $conteudo = sc_strip_script($this->ppo_evident_two); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_ppo_evident_two_grid_line . "\"  style=\"" . $this->Css_Cmp['css_ppo_evident_two_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_ppo_evident_two_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_ppo_evident_three()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['ppo_evident_three']) || $this->NM_cmp_hidden['ppo_evident_three'] != "off") { 
          $conteudo = sc_strip_script($this->ppo_evident_three); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_ppo_evident_three_grid_line . "\"  style=\"" . $this->Css_Cmp['css_ppo_evident_three_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_ppo_evident_three_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_grid_ppo_realaktual()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['ppo_realaktual']) || $this->NM_cmp_hidden['ppo_realaktual'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->ppo_realaktual)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_ppo_realaktual_grid_line . "\"  style=\"" . $this->Css_Cmp['css_ppo_realaktual_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_ppo_realaktual_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_grid_statusproject()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['statusproject']) || $this->NM_cmp_hidden['statusproject'] != "off") { 
          $conteudo = sc_strip_script($this->statusproject); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_statusproject_grid_line . "\"  style=\"" . $this->Css_Cmp['css_statusproject_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_statusproject_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function quebra_geral_sc_free_total_bot() 
 {
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          if (is_file("downloaddetail_help.txt") && !$this->grid_emb_form)
          {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['dashboard_info']['under_dashboard']))
      {
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "downloaddetail/downloaddetail_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnSelCamposShow('" . $this->Ini->path_link . "downloaddetail/downloaddetail_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
          $nm_saida->saida("         </td> \r\n");
   ...
   function nmgp_barra_bot_normal()
   {
      ...
      $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"left\" width=\"33%\"> \r\n");
          ...
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_lin_grid'];
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_lin_grid'] == 10) ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_lin_grid'] == 20) ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_lin_grid'] == 50) ? " selected" : "";
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opc_liga']['nav']))
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_avanca", "nm_gp_submit_rec('" . $this->Rec_fim . "')", "nm_gp_submit_rec('" . $this->Rec_fim . "')", "forward_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opc_liga']['nav']))
          {
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </TABLE>\r\n");
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['ajax_nav'])
       {
   ...
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           if ($this->arr_buttons['bcons_avanca']['type'] != 'image')
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
   ...
   {
       $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
       $nm_saida->saida("      parent.scAjaxDetailHeight('downloaddetail', $(document).innerHeight());\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
 }
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"downloaddetail\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"downloaddetail_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . NM_encode_input(session_id()) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['downloaddetail_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@downloaddetail@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   $nm_saida->saida("       if (\"pdf\" == x)\r\n");
   $nm_saida->saida("       {\r\n");
   $nm_saida->saida("           window.location = \"" . $this->Ini->path_link . "downloaddetail/downloaddetail_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_create_charts=\" + crt + \"&sc_graf_pdf=\" + g;\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['campo_psq_ret']) )
   {
      ...
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['downloaddetail']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Doc = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Doc = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Doc = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"downloaddetail_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['downloaddetail']['reg_start']))
   {
       $nm_saida->saida("      parent.scAjaxDetailStatus('downloaddetail');\r\n");
       $nm_saida->saida("      parent.scAjaxDetailHeight('downloaddetail', $(document).innerHeight());\r\n");
   }
   $nm_saida->saida("   </script>\r\n");
 }
