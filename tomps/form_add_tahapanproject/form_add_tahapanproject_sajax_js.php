  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_add_tahapanproject" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idtable_
  function do_ajax_form_add_tahapanproject_validate_idtable_(iNumLinha)
  {
    var nomeCampo_idtable_ = "idtable_" + iNumLinha;
    var var_idtable_ = scAjaxGetFieldHidden(nomeCampo_idtable_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_add_tahapanproject_validate_idtable_(var_idtable_, iNumLinha, var_script_case_init, do_ajax_form_add_tahapanproject_validate_idtable__cb);
  } // do_ajax_form_add_tahapanproject_validate_idtable_

  function do_ajax_form_add_tahapanproject_validate_idtable__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idtable_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idtable_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idtable_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idtable_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_add_tahapanproject_validate_idtable__cb

  // ---------- Validate projectphaseid_
  function do_ajax_form_add_tahapanproject_validate_projectphaseid_(iNumLinha)
  {
    var nomeCampo_projectphaseid_ = "projectphaseid_" + iNumLinha;
    var var_projectphaseid_ = scAjaxGetFieldSelect(nomeCampo_projectphaseid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_add_tahapanproject_validate_projectphaseid_(var_projectphaseid_, iNumLinha, var_script_case_init, do_ajax_form_add_tahapanproject_validate_projectphaseid__cb);
  } // do_ajax_form_add_tahapanproject_validate_projectphaseid_

  function do_ajax_form_add_tahapanproject_validate_projectphaseid__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "projectphaseid_" + iLineNumber;
    }
    else
    {
      sFieldValid = "projectphaseid_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "projectphaseid_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "projectphaseid_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_add_tahapanproject_validate_projectphaseid__cb

  // ---------- Validate templateproject_
  function do_ajax_form_add_tahapanproject_validate_templateproject_(iNumLinha)
  {
    var nomeCampo_templateproject_ = "templateproject_" + iNumLinha;
    var var_templateproject_ = scAjaxGetFieldHidden(nomeCampo_templateproject_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_add_tahapanproject_validate_templateproject_(var_templateproject_, iNumLinha, var_script_case_init, do_ajax_form_add_tahapanproject_validate_templateproject__cb);
  } // do_ajax_form_add_tahapanproject_validate_templateproject_

  function do_ajax_form_add_tahapanproject_validate_templateproject__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "templateproject_" + iLineNumber;
    }
    else
    {
      sFieldValid = "templateproject_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "templateproject_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "templateproject_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_add_tahapanproject_validate_templateproject__cb

  // ---------- Validate phasetarget_
  function do_ajax_form_add_tahapanproject_validate_phasetarget_(iNumLinha)
  {
    var nomeCampo_phasetarget_ = "phasetarget_" + iNumLinha;
    var var_phasetarget_ = scAjaxGetFieldText(nomeCampo_phasetarget_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_add_tahapanproject_validate_phasetarget_(var_phasetarget_, iNumLinha, var_script_case_init, do_ajax_form_add_tahapanproject_validate_phasetarget__cb);
  } // do_ajax_form_add_tahapanproject_validate_phasetarget_

  function do_ajax_form_add_tahapanproject_validate_phasetarget__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "phasetarget_" + iLineNumber;
    }
    else
    {
      sFieldValid = "phasetarget_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "phasetarget_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "phasetarget_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_add_tahapanproject_validate_phasetarget__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_add_tahapanproject_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_add_tahapanproject_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_add_tahapanproject_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_add_tahapanproject_add_new_line_cb);
  } // do_ajax_form_add_tahapanproject_add_new_line

  function do_ajax_form_add_tahapanproject_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_add_tahapanproject_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_add_tahapanproject_backup_line(iNumLinha)
  {
    var var_idtable_ = scAjaxGetFieldHidden("idtable_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_add_tahapanproject_backup_line(var_idtable_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_add_tahapanproject_backup_line_cb);
  } // do_ajax_form_add_tahapanproject_backup_line

  function do_ajax_form_add_tahapanproject_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_add_tahapanproject_backup_line_cb

  function do_ajax_form_add_tahapanproject_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_add_tahapanproject_cancel_insert

  function do_ajax_form_add_tahapanproject_cancel_update(iSeqVert)
  {
    do_ajax_form_add_tahapanproject_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_add_tahapanproject_cancel_update

  function do_ajax_form_add_tahapanproject_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_add_tahapanproject_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_add_tahapanproject_table_refresh()
  {
    var var_idtable_ = document.F2.idtable_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_add_tahapanproject_table_refresh(var_idtable_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_add_tahapanproject_table_refresh_cb);
  } //  do_ajax_form_add_tahapanproject_table_refresh

  function do_ajax_form_add_tahapanproject_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.idtable_.value = scAjaxGetKeyValue("idtable_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_add_tahapanproject_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_add_tahapanproject_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_add_tahapanproject_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_idtable_ = scAjaxGetFieldHidden("idtable_" + iNumLinha);
    var var_projectphaseid_ = scAjaxGetFieldSelect("projectphaseid_" + iNumLinha);
    var var_templateproject_ = scAjaxGetFieldHidden("templateproject_" + iNumLinha);
    var var_phasetarget_ = scAjaxGetFieldText("phasetarget_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_add_tahapanproject_submit_form(var_idtable_, var_projectphaseid_, var_templateproject_, var_phasetarget_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_add_tahapanproject_submit_form_cb);
  } // do_ajax_form_add_tahapanproject_submit_form

  function do_ajax_form_add_tahapanproject_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idtable_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("projectphaseid_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("templateproject_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("phasetarget_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_form_add_tahapanproject_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_add_tahapanproject_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_add_tahapanproject_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idtable_" + iNavForm);
      scAjaxHideErrorDisplay("projectphaseid_" + iNavForm);
      scAjaxHideErrorDisplay("templateproject_" + iNavForm);
      scAjaxHideErrorDisplay("phasetarget_" + iNavForm);
    }
    var var_idtable_ = document.F2.idtable_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_add_tahapanproject_navigate_form(var_idtable_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_add_tahapanproject_navigate_form_cb);
  } // do_ajax_form_add_tahapanproject_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_add_tahapanproject']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_add_tahapanproject_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.idtable_.value = scAjaxGetKeyValue("idtable_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_add_tahapanproject_navigate_form_cb
  function sc_hide_form_add_tahapanproject_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_add_tahapanproject_form
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idtable_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "projectphaseid_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "templateproject_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "phasetarget_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idtable_" + iNumLinha] = {"label": "IDTable<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["projectphaseid_" + iNumLinha] = {"label": "ProjectTahapanID<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["templateproject_" + iNumLinha] = {"label": "Template Project<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["phasetarget_" + iNumLinha] = {"label": "Target Tahapan(hari)<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idtable_"][iNumLinha] = "idtable_" + iNumLinha;
    ajax_field_mult["projectphaseid_"][iNumLinha] = "projectphaseid_" + iNumLinha;
    ajax_field_mult["templateproject_"][iNumLinha] = "templateproject_" + iNumLinha;
    ajax_field_mult["phasetarget_"][iNumLinha] = "phasetarget_" + iNumLinha;
    ajax_field_id["idtable_" + iNumLinha] = new Array("hidden_field_label_idtable_", "hidden_field_data_idtable_" + iNumLinha);
    ajax_field_id["projectphaseid_" + iNumLinha] = new Array("hidden_field_label_projectphaseid_", "hidden_field_data_projectphaseid_" + iNumLinha);
    ajax_field_id["templateproject_" + iNumLinha] = new Array("hidden_field_label_templateproject_", "hidden_field_data_templateproject_" + iNumLinha);
    ajax_field_id["phasetarget_" + iNumLinha] = new Array("hidden_field_label_phasetarget_", "hidden_field_data_phasetarget_" + iNumLinha);
    ajax_error_count["idtable_" + iNumLinha] = "off";
    ajax_error_count["projectphaseid_" + iNumLinha] = "off";
    ajax_error_count["templateproject_" + iNumLinha] = "off";
    ajax_error_count["phasetarget_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idtable_" + iNumLinha] = "on";
    ajax_read_only["projectphaseid_" + iNumLinha] = "off";
    ajax_read_only["templateproject_" + iNumLinha] = "off";
    ajax_read_only["phasetarget_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["idtable_" + iNumLinha] = "on";
    ajax_read_only["projectphaseid_" + iNumLinha] = "on";
    ajax_read_only["templateproject_" + iNumLinha] = "on";
    ajax_read_only["phasetarget_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idtable_" + iNumLinha] = null;
    ajax_error_list["projectphaseid_" + iNumLinha] = null;
    ajax_error_list["templateproject_" + iNumLinha] = null;
    ajax_error_list["phasetarget_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idtable_": new Array(),
    "projectphaseid_": new Array(),
    "templateproject_": new Array(),
    "phasetarget_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idtable_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idtable_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idtable_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idtable_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idtable_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["projectphaseid_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["projectphaseid_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["projectphaseid_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["projectphaseid_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["projectphaseid_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["templateproject_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["templateproject_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["templateproject_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["templateproject_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["templateproject_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["phasetarget_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["phasetarget_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["phasetarget_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["phasetarget_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["phasetarget_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idtable_'])) ? $this->nmgp_cmp_readonly['idtable_'] : 'on';
?>
    scAjaxFieldRead("idtable_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['projectphaseid_'])) ? $this->nmgp_cmp_readonly['projectphaseid_'] : 'off';
?>
    scAjaxFieldRead("projectphaseid_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['templateproject_'])) ? $this->nmgp_cmp_readonly['templateproject_'] : 'off';
?>
    scAjaxFieldRead("templateproject_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['phasetarget_'])) ? $this->nmgp_cmp_readonly['phasetarget_'] : 'off';
?>
    scAjaxFieldRead("phasetarget_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idtable_" + iSeq, "on");
    scAjaxFieldRead("projectphaseid_" + iSeq, "on");
    scAjaxFieldRead("templateproject_" + iSeq, "on");
    scAjaxFieldRead("phasetarget_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idtable_" + iRow] || "on" == ajax_error_count["projectphaseid_" + iRow] || "on" == ajax_error_count["templateproject_" + iRow] || "on" == ajax_error_count["phasetarget_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idtable_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_projectphaseid_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_templateproject_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_phasetarget_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idtable_" + iRow] && "off" == ajax_error_count["projectphaseid_" + iRow] && "off" == ajax_error_count["templateproject_" + iRow] && "off" == ajax_error_count["phasetarget_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idtable_" + iRow] = "off";
        ajax_error_count["projectphaseid_" + iRow] = "off";
        ajax_error_count["templateproject_" + iRow] = "off";
        ajax_error_count["phasetarget_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idtable_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_projectphaseid_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_templateproject_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_phasetarget_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("projectphaseid_" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
      return;
    }
    if ("templateproject_" == sIndex)
    {
      scAjaxSetFieldLabel(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
    }
    if ("phasetarget_" == sIndex)
    {
