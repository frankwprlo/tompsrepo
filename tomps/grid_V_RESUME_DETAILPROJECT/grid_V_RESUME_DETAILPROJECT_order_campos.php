<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_V_RESUME_DETAILPROJECT_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_V_RESUME_DETAILPROJECT_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['ppo_projectid'] = "on";
   $tab_def_campos['ppo_projectid'] = "PPO_PROJECTID";
   $tab_converte["PPO_PROJECTID"]   = "ppo_projectid";
   $tab_labels["ppo_projectid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["ppo_projectid"])) ? $_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["ppo_projectid"] : "PPO PROJECTID";
   $tab_ger_campos['taskproses'] = "on";
   $tab_def_campos['taskproses'] = "TASKPROSES";
   $tab_converte["TASKPROSES"]   = "taskproses";
   $tab_labels["taskproses"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["taskproses"])) ? $_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["taskproses"] : "TASKPROSES";
   $tab_ger_campos['taskprosesname'] = "on";
   $tab_def_campos['taskprosesname'] = "TASKPROSESNAME";
   $tab_converte["TASKPROSESNAME"]   = "taskprosesname";
   $tab_labels["taskprosesname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["taskprosesname"])) ? $_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["taskprosesname"] : "TASKPROSESNAME";
   $tab_ger_campos['ppo_tahapanproject'] = "on";
   $tab_def_campos['ppo_tahapanproject'] = "PPO_TAHAPANPROJECT";
   $tab_converte["PPO_TAHAPANPROJECT"]   = "ppo_tahapanproject";
   $tab_labels["ppo_tahapanproject"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["ppo_tahapanproject"])) ? $_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["ppo_tahapanproject"] : "PPO TAHAPANPROJECT";
   $tab_ger_campos['ppo_tasktahapan'] = "on";
   $tab_def_campos['ppo_tasktahapan'] = "PPO_TASKTAHAPAN";
   $tab_converte["PPO_TASKTAHAPAN"]   = "ppo_tasktahapan";
   $tab_labels["ppo_tasktahapan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["ppo_tasktahapan"])) ? $_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["ppo_tasktahapan"] : "PPO TASKTAHAPAN";
   $tab_ger_campos['ppo_tasknumber'] = "on";
   $tab_def_campos['ppo_tasknumber'] = "PPO_TASKNUMBER";
   $tab_converte["PPO_TASKNUMBER"]   = "ppo_tasknumber";
   $tab_labels["ppo_tasknumber"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["ppo_tasknumber"])) ? $_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["ppo_tasknumber"] : "PPO TASKNUMBER";
   $tab_ger_campos['ppo_status'] = "on";
   $tab_def_campos['ppo_status'] = "PPO_STATUS";
   $tab_converte["PPO_STATUS"]   = "ppo_status";
   $tab_labels["ppo_status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["ppo_status"])) ? $_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["ppo_status"] : "PPO STATUS";
   $tab_ger_campos['statusname'] = "on";
   $tab_def_campos['statusname'] = "STATUSNAME";
   $tab_converte["STATUSNAME"]   = "statusname";
   $tab_labels["statusname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["statusname"])) ? $_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["statusname"] : "STATUSNAME";
   $tab_ger_campos['ppo_tglmulaiplan'] = "on";
   $tab_def_campos['ppo_tglmulaiplan'] = "PPO_TGLMULAIPLAN";
   $tab_converte["PPO_TGLMULAIPLAN"]   = "ppo_tglmulaiplan";
   $tab_labels["ppo_tglmulaiplan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["ppo_tglmulaiplan"])) ? $_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["ppo_tglmulaiplan"] : "PPO TGLMULAIPLAN";
   $tab_ger_campos['ppo_targethari'] = "on";
   $tab_def_campos['ppo_targethari'] = "PPO_TARGETHARI";
   $tab_converte["PPO_TARGETHARI"]   = "ppo_targethari";
   $tab_labels["ppo_targethari"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["ppo_targethari"])) ? $_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["ppo_targethari"] : "PPO TARGETHARI";
   $tab_ger_campos['ppo_targetselesai'] = "on";
   $tab_def_campos['ppo_targetselesai'] = "PPO_TARGETSELESAI";
   $tab_converte["PPO_TARGETSELESAI"]   = "ppo_targetselesai";
   $tab_labels["ppo_targetselesai"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["ppo_targetselesai"])) ? $_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["ppo_targetselesai"] : "PPO TARGETSELESAI";
   $tab_ger_campos['ppo_tglmulaiactual'] = "on";
   $tab_def_campos['ppo_tglmulaiactual'] = "PPO_TGLMULAIACTUAL";
   $tab_converte["PPO_TGLMULAIACTUAL"]   = "ppo_tglmulaiactual";
   $tab_labels["ppo_tglmulaiactual"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["ppo_tglmulaiactual"])) ? $_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["ppo_tglmulaiactual"] : "PPO TGLMULAIACTUAL";
   $tab_ger_campos['ppo_tglselesaiactual'] = "on";
   $tab_def_campos['ppo_tglselesaiactual'] = "PPO_TGLSELESAIACTUAL";
   $tab_converte["PPO_TGLSELESAIACTUAL"]   = "ppo_tglselesaiactual";
   $tab_labels["ppo_tglselesaiactual"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["ppo_tglselesaiactual"])) ? $_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["ppo_tglselesaiactual"] : "PPO TGLSELESAIACTUAL";
   $tab_ger_campos['sisatarget'] = "on";
   $tab_def_campos['sisatarget'] = "SISATARGET";
   $tab_converte["SISATARGET"]   = "sisatarget";
   $tab_labels["sisatarget"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["sisatarget"])) ? $_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["sisatarget"] : "SISATARGET";
   $tab_ger_campos['realisasi'] = "on";
   $tab_def_campos['realisasi'] = "REALISASI";
   $tab_converte["REALISASI"]   = "realisasi";
   $tab_labels["realisasi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["realisasi"])) ? $_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["realisasi"] : "REALISASI";
   $tab_ger_campos['ketrealiasisijmlhari'] = "on";
   $tab_def_campos['ketrealiasisijmlhari'] = "KETREALIASISIJMLHARI";
   $tab_converte["KETREALIASISIJMLHARI"]   = "ketrealiasisijmlhari";
   $tab_labels["ketrealiasisijmlhari"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["ketrealiasisijmlhari"])) ? $_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['labels']["ketrealiasisijmlhari"] : "KETREALIASISIJMLHARI";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - V_RESUME_DETAILPROJECT</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_V_RESUME_DETAILPROJECT_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_V_RESUME_DETAILPROJECT']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
