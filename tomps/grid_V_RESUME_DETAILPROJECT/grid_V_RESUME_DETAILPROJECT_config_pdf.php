 ...
 */
    ...
    session_start();
    $SC_apl_proc = "grid_V_RESUME_DETAILPROJECT";
...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['grid_V_RESUME_DETAILPROJECT']['show_skip_charts_option']) || !$_SESSION['sc_session']['grid_V_RESUME_DETAILPROJECT']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
