...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      else
      {
         ...
         $nomeX = $nome;
         if ($nome == "group_id") {$nomeX = "GROUP_ID";}
         $nome = $nomeX;
         $nome_sum = "AKSESSMR.SEC_GROUPS.$nome";
...
<?php
   ...
   function monta_form()
   {
      ...
      { 
          ...
          $group_id = $_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_groups']['campos_busca']['group_id']; 
          $group_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_groups']['campos_busca']['group_id_cond']; 
...
<?php
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_groups']['psq_check_ret']['group_id'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_groups']['psq_check_ret']['group_id'][] = trim($rs->fields[0]);
...
<?php
   ...
   function trata_campos()
   {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_groups']['psq_check_ret']['group_id'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_groups']['campos_busca']['group_id'] = $group_id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_groups']['campos_busca']['group_id_cond'] = $group_id_cond_salva; 
