<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_perfil']          = "conn_mysql_1";
   $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_path_prod']       = "/libdemo/prod";
   $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_path_imagens']    = "/libdemo/file/img";
   $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_path_imag_temp']  = "/libdemo/tmp";
   $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_path_doc']        = "/var/www/html/tompsdemo";
//
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao'], $this->root . $this->path_prod, 'projectamo'); 
      } 
      else 
      { 
          ob_start();
...
//----- 
   function controle()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao'], $this->Ini->root . $this->Ini->path_prod, 'projectamo'); 
      } 
      else 
      { 
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
      {
          ...
          $this->Db->Execute("alter session set nls_time_tz_format      = 'hh24:mi:ss'");
          $this->Db->Execute("alter session set nls_numeric_characters  = '.,'");
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_search_sec_groups']['decimal_db'] = "."; 
      } 
