...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate pswd
  function do_ajax_app_form_add_users_mob_validate_pswd()
  {
    var nomeCampo_pswd = "pswd";
    var var_pswd = scAjaxGetFieldText(nomeCampo_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_mob_validate_pswd(var_pswd, var_script_case_init, do_ajax_app_form_add_users_mob_validate_pswd_cb);
  } // do_ajax_app_form_add_users_mob_validate_pswd

  function do_ajax_app_form_add_users_mob_validate_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pswd";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_mob_validate_pswd_cb
  ...
  // ---------- Validate name
  function do_ajax_app_form_add_users_mob_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_mob_validate_name(var_name, var_script_case_init, do_ajax_app_form_add_users_mob_validate_name_cb);
  } // do_ajax_app_form_add_users_mob_validate_name

  function do_ajax_app_form_add_users_mob_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "name";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_mob_validate_name_cb
  // ---------- Form
  function do_ajax_app_form_add_users_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_add_users_mob_submit_form(var_login, var_pswd, var_confirm_pswd, var_email, var_name, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_add_users_mob_submit_form_cb);
