...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_tahapanproject_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tahapanproject_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['recarga'];
}
...
<?php
 include_once("form_tahapanproject_js0.php");
?>
<script type="text/javascript" src="<?php  echo $this->Ini->path_js . "/nm_rpc.js" ?>"> 
</script> 
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tahapanproject'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tahapanproject'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_phasetarget_label" id="hidden_field_label_phasetarget" style="<?php echo $sStyleHidden_phasetarget; ?>"><span id="id_label_phasetarget"><?php echo $this->nm_new_label['phasetarget']; ?></span></TD>
    <TD class="scFormDataOdd css_phasetarget_line" id="hidden_field_data_phasetarget" style="<?php echo $sStyleHidden_phasetarget; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_phasetarget_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idtable_label" id="hidden_field_label_idtable" style="<?php echo $sStyleHidden_idtable; ?>"><span id="id_label_idtable"><?php echo $this->nm_new_label['idtable']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['php_cmp_required']['idtable']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['php_cmp_required']['idtable'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_idtable_line" id="hidden_field_data_idtable" style="<?php echo $sStyleHidden_idtable; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idtable_line" style="vertical-align: top;padding: 0px">
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailtahapan'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailtahapan'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['form_tahapanproject_detail_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detailtahapan'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['form_tahapanproject_detail_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['form_tahapanproject_detail_script_case_init'] ]['form_tahapanproject_detail']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['form_tahapanproject_detail_script_case_init'] ]['form_tahapanproject_detail']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['form_tahapanproject_detail_script_case_init'] ]['form_tahapanproject_detail']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['form_tahapanproject_detail_script_case_init'] ]['form_tahapanproject_detail']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['form_tahapanproject_detail_script_case_init'] ]['form_tahapanproject_detail']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['form_tahapanproject_detail_script_case_init'] ]['form_tahapanproject_detail']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['form_tahapanproject_detail_script_case_init'] ]['form_tahapanproject_detail']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['form_tahapanproject_detail_script_case_init'] ]['form_tahapanproject_detail']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['form_tahapanproject_detail_script_case_init'] ]['form_tahapanproject_detail']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['form_tahapanproject_detail_script_case_init'] ]['form_tahapanproject_detail']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['form_tahapanproject_detail_script_case_init'] ]['form_tahapanproject_detail']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['form_tahapanproject_detail_script_case_init'] ]['form_tahapanproject_detail']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['form_tahapanproject_detail_script_case_init'] ]['form_tahapanproject']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_tahapanproject_empty.htm' : $this->Ini->link_form_tahapanproject_detail_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_detailtahapan']) && 'nmsc_iframe_liga_form_tahapanproject_detail' != $this->Ini->sc_lig_target['C_@scinf_detailtahapan'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detailtahapan'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['form_tahapanproject_detail_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_tahapanproject_detail"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_tahapanproject_detail"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tahapanproject");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tahapanproject");
 parent.scAjaxDetailHeight("form_tahapanproject", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
