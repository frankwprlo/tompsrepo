  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tahapanproject_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_tahapanproject_mob_validate_templateproject()
  {
    ...
    x_ajax_form_tahapanproject_mob_validate_templateproject(var_templateproject, var_script_case_init, do_ajax_form_tahapanproject_mob_validate_templateproject_cb);
  } // do_ajax_form_tahapanproject_mob_validate_templateproject

  function do_ajax_form_tahapanproject_mob_validate_templateproject_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tahapanproject_mob_validate_templateproject_cb

  // ---------- Validate projectphaseid
  function do_ajax_form_tahapanproject_mob_validate_projectphaseid()
  {
    var nomeCampo_projectphaseid = "projectphaseid";
    var var_projectphaseid = scAjaxGetFieldHidden(nomeCampo_projectphaseid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tahapanproject_mob_validate_projectphaseid(var_projectphaseid, var_script_case_init, do_ajax_form_tahapanproject_mob_validate_projectphaseid_cb);
  } // do_ajax_form_tahapanproject_mob_validate_projectphaseid

  function do_ajax_form_tahapanproject_mob_validate_projectphaseid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tahapanproject_mob_validate_projectphaseid_cb

  // ---------- Validate phasetarget
  function do_ajax_form_tahapanproject_mob_validate_phasetarget()
  {
    var nomeCampo_phasetarget = "phasetarget";
    var var_phasetarget = scAjaxGetFieldText(nomeCampo_phasetarget);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tahapanproject_mob_validate_phasetarget(var_phasetarget, var_script_case_init, do_ajax_form_tahapanproject_mob_validate_phasetarget_cb);
  } // do_ajax_form_tahapanproject_mob_validate_phasetarget

  function do_ajax_form_tahapanproject_mob_validate_phasetarget_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tahapanproject_mob_validate_phasetarget_cb

  // ---------- Validate idtable
  function do_ajax_form_tahapanproject_mob_validate_idtable()
  {
    var nomeCampo_idtable = "idtable";
    var var_idtable = scAjaxGetFieldText(nomeCampo_idtable);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tahapanproject_mob_validate_idtable(var_idtable, var_script_case_init, do_ajax_form_tahapanproject_mob_validate_idtable_cb);
  } // do_ajax_form_tahapanproject_mob_validate_idtable

  function do_ajax_form_tahapanproject_mob_validate_idtable_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idtable";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tahapanproject_mob_validate_idtable_cb

  // ---------- Validate detailtahapan
  function do_ajax_form_tahapanproject_mob_validate_detailtahapan()
  {
    var nomeCampo_detailtahapan = "detailtahapan";
    var var_detailtahapan = scAjaxGetFieldText(nomeCampo_detailtahapan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tahapanproject_mob_validate_detailtahapan(var_detailtahapan, var_script_case_init, do_ajax_form_tahapanproject_mob_validate_detailtahapan_cb);
  } // do_ajax_form_tahapanproject_mob_validate_detailtahapan

  function do_ajax_form_tahapanproject_mob_validate_detailtahapan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tahapanproject_mob_validate_detailtahapan_cb
  // ---------- Form
  function do_ajax_form_tahapanproject_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tahapanproject_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tahapanproject_mob_submit_form(var_templateproject, var_projectphaseid, var_phasetarget, var_idtable, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tahapanproject_mob_submit_form_cb);
  } // do_ajax_form_tahapanproject_mob_submit_form

  function do_ajax_form_tahapanproject_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_tahapanproject_mob_submit_form_cb

  var scStatusDetail = {};
  scStatusDetail["form_tahapanproject_detail_mob"] = "off";

  function do_ajax_form_tahapanproject_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tahapanproject_detail_mob"] = "on";
    x_ajax_form_tahapanproject_mob_navigate_form(var_idtable, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tahapanproject_mob_navigate_form_cb);
  } // do_ajax_form_tahapanproject_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tahapanproject_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tahapanproject_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tahapanproject_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tahapanproject_detail_mob"] && "nmsc_iframe_liga_form_tahapanproject_detail_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tahapanproject_detail_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tahapanproject_detail_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tahapanproject_detail_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tahapanproject_detail_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tahapanproject_detail_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert();
...
{
?>
    do_ajax_form_tahapanproject_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tahapanproject_mob_navigate_form_cb
  function sc_hide_form_tahapanproject_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tahapanproject_detail_mob"])
    {
      return true;
    }
    return false;
