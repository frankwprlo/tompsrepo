...
class v_table_project_copy_for_report_mitra_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_tj_namajenis = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['contr_total_geral'] == "OK")
      {
          $this->array_total_statusname = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['arr_total']['statusname'];
          $this->array_total_md_namadatel = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['arr_total']['md_namadatel'];
          $this->array_total_tj_namajenis = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['arr_total']['tj_namajenis'];
      }
      else
      {
          $this->array_total_statusname = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['tot_geral'][2];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['tot_geral'][3];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['tot_geral'][4];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['tot_geral'][5];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['tot_geral'][6];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $Lab_statusname = "Status Project";
       $Lab_md_namadatel = "Datel";
       $Lab_tj_namajenis = "Jenis Project";
       $this->comp_field = array(
           $Lab_statusname,
           $Lab_md_namadatel,
           $Lab_tj_namajenis,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_order']['groupbymitradatel']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_order']['groupbymitradatel'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_order']['groupbymitradatel'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_display']['groupbymitradatel'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_display']['groupbymitradatel'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_display']['groupbymitradatel'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_display']['groupbymitradatel'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_display']['groupbymitradatel'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_display']['groupbymitradatel'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_display']['groupbymitradatel'] as $i_sum => $d_sum)
           {
       ...
       $this->comp_sum_lnk = array(
           ...
           3 => array('field' => "prepare", 'show' => true),
           4 => array('field' => "perijinan", 'show' => true),
           5 => array('field' => "inst_testcomm", 'show' => true),
           6 => array('field' => "closing", 'show' => true),
           7 => array('field' => "pencapaian", 'show' => true),
       );
       ...
       $this->comp_sum_css = array(
           ...
           3 => "css_prepare_avg",
           4 => "css_perijinan_avg",
           5 => "css_inst_testcomm_avg",
           6 => "css_closing_avg",
           7 => "css_pencapaian_avg",
       );

       //-----
       foreach ($this->array_total_statusname as $i_statusname => $d_statusname) {
           if (!in_array($i_statusname, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_statusname[8] ] = $d_statusname[7];
               $this->comp_label[0][ $d_statusname[8] ] = $d_statusname[7];
           }
           foreach ($this->array_total_md_namadatel[$i_statusname] as $i_md_namadatel => $d_md_namadatel) {
               if (!in_array($i_md_namadatel, $this->comp_label[1][ $d_statusname[8] ], true)) {
                   $this->comp_index[1][ $d_md_namadatel[8] ] = $d_md_namadatel[7];
                   $this->comp_label[1][ $d_statusname[8] ][ $d_md_namadatel[8] ] = $d_md_namadatel[7];
               }
               foreach ($this->array_total_tj_namajenis[$i_statusname][$i_md_namadatel] as $i_tj_namajenis => $d_tj_namajenis) {
                   if (!in_array($i_tj_namajenis, $this->comp_label[2][ $d_statusname[8] ][ $d_md_namadatel[8] ], true)) {
                       $this->comp_index[2][ $d_tj_namajenis[8] ] = $d_tj_namajenis[7];
                       $this->comp_label[2][ $d_statusname[8] ][ $d_md_namadatel[8] ][ $d_tj_namajenis[8] ] = $d_tj_namajenis[7];
                   }
               }
           }
       }
       ...
       $this->comp_links_fl = array(
           ...
           array('name' => 'tj_namajenis', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_statusname => $l_statusname) {
           if (isset($this->array_total_statusname[$i_statusname])) {
               $this->comp_group[$i_statusname] = array();
           }
           foreach ($this->comp_label[1][$i_statusname] as $i_md_namadatel => $l_md_namadatel) {
               if (isset($this->array_total_md_namadatel[$i_statusname][$i_md_namadatel])) {
                   $this->comp_group[$i_statusname][$i_md_namadatel] = array();
               }
               foreach ($this->comp_label[2][$i_statusname][$i_md_namadatel] as $i_tj_namajenis => $l_tj_namajenis) {
                   if (isset($this->array_total_tj_namajenis[$i_statusname][$i_md_namadatel][$i_tj_namajenis])) {
                       $this->comp_group[$i_statusname][$i_md_namadatel][$i_tj_namajenis] = array();
                   }
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       ...
       elseif (2 == $level) {
           $return = $this->array_total_tj_namajenis;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@v_table_project_copy_for_report_mitra@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['pivot_order_start'][$iYAxysIndex])
                       {
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "v_table_project_copy_for_report_mitra_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['opcao'] = "print";
      ...
      $this->Total   = new v_table_project_copy_for_report_mitra_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
      ...
      ksort($this->array_total_tj_namajenis);
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['responsive_chart']['active']) {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_v_table_project_copy_for_report_mitra_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_v_table_project_copy_for_report_mitra_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_v_table_project_copy_for_report_mitra_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['num_css'] . '.css');
     ...
     else
     {
      ...
      $nm_saida->saida(" </style>\r\n");
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "v_table_project_copy_for_report_mitra/v_table_project_copy_for_report_mitra_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("v_table_project_copy_for_report_mitra_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'v_table_project_copy_for_report_mitra_config_pivot.php?nome_apl=v_table_project_copy_for_report_mitra&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_v_table_project_copy_for_report_mitra_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "v_table_project_copy_for_report_mitra/v_table_project_copy_for_report_mitra_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      $nm_saida->saida("          Resume Project Detail " . $_SESSION['kodewitel'] . "  Mitra : " . $_SESSION['namamitra'] . "\r\n");
      $nm_saida->saida("        </TD>\r\n");
      $nm_saida->saida("       </TR>\r\n");
   ...
   function monta_rodape()
   {
      ...
      $nm_cab_filtro   = ""; 
      $nm_cab_filtrobr = ""; 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']))
      { 
        $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca'];
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
   ...
   //---- 
   function adiciona_registro($avg_prepare, $avg_perijinan, $avg_inst_testcomm, $avg_closing, $avg_pencapaian, $quebra_statusname, $quebra_md_namadatel, $quebra_tj_namajenis, $quebra_statusname_orig, $quebra_md_namadatel_orig, $quebra_tj_namajenis_orig)
   {
      //----- Status Project
      if (!isset($this->array_total_statusname[$quebra_statusname_orig]))
      {
         $this->array_total_statusname[$quebra_statusname_orig][0] = 1;
         $this->array_total_statusname[$quebra_statusname_orig][1] = $avg_prepare;
         $this->array_total_statusname[$quebra_statusname_orig][2] = $avg_perijinan;
         $this->array_total_statusname[$quebra_statusname_orig][3] = $avg_inst_testcomm;
         $this->array_total_statusname[$quebra_statusname_orig][4] = $avg_closing;
         $this->array_total_statusname[$quebra_statusname_orig][5] = $avg_pencapaian;
         $this->array_total_statusname[$quebra_statusname_orig][6] = 1;
         $this->array_total_statusname[$quebra_statusname_orig][7] = $quebra_statusname;
         $this->array_total_statusname[$quebra_statusname_orig][8] = $quebra_statusname_orig;
      }
      else
      {
         $this->array_total_statusname[$quebra_statusname_orig][0]++;
         $this->array_total_statusname[$quebra_statusname_orig][1] += $avg_prepare;
         $this->array_total_statusname[$quebra_statusname_orig][2] += $avg_perijinan;
         $this->array_total_statusname[$quebra_statusname_orig][3] += $avg_inst_testcomm;
         $this->array_total_statusname[$quebra_statusname_orig][4] += $avg_closing;
         $this->array_total_statusname[$quebra_statusname_orig][5] += $avg_pencapaian;
         $this->array_total_statusname[$quebra_statusname_orig][6]++;
      }
      //----- Datel
      if (!isset($this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig]))
      {
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][0] = 1;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][1] = $avg_prepare;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][2] = $avg_perijinan;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][3] = $avg_inst_testcomm;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][4] = $avg_closing;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][5] = $avg_pencapaian;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][6] = 1;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][7] = $quebra_md_namadatel;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][8] = $quebra_md_namadatel_orig;
      }
      else
      {
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][0]++;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][1] += $avg_prepare;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][2] += $avg_perijinan;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][3] += $avg_inst_testcomm;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][4] += $avg_closing;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][5] += $avg_pencapaian;
         $this->array_total_md_namadatel[$quebra_statusname_orig][$quebra_md_namadatel_orig][6]++;
      }
      //----- Jenis Project
      if (!isset($this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tj_namajenis_orig]))
      {
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tj_namajenis_orig][0] = 1;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tj_namajenis_orig][1] = $avg_prepare;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tj_namajenis_orig][2] = $avg_perijinan;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tj_namajenis_orig][3] = $avg_inst_testcomm;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tj_namajenis_orig][4] = $avg_closing;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tj_namajenis_orig][5] = $avg_pencapaian;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tj_namajenis_orig][6] = 1;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tj_namajenis_orig][7] = $quebra_tj_namajenis;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tj_namajenis_orig][8] = $quebra_tj_namajenis_orig;
      }
      else
      {
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tj_namajenis_orig][0]++;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tj_namajenis_orig][1] += $avg_prepare;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tj_namajenis_orig][2] += $avg_perijinan;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tj_namajenis_orig][3] += $avg_inst_testcomm;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tj_namajenis_orig][4] += $avg_closing;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tj_namajenis_orig][5] += $avg_pencapaian;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_md_namadatel_orig][$quebra_tj_namajenis_orig][6]++;
      }
      //----- Total
      if (empty($this->array_total_geral))
      {
         $this->array_total_geral[0] = 1;
         $this->array_total_geral[1] = $avg_prepare;
         $this->array_total_geral[2] = $avg_perijinan;
         $this->array_total_geral[3] = $avg_inst_testcomm;
         $this->array_total_geral[4] = $avg_closing;
         $this->array_total_geral[5] = $avg_pencapaian;
         $this->array_total_geral[6] = 1;
      }
      else
      {
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['arr_total']['statusname'] as $campo_statusname => $dados_statusname)
      {
         $this->array_total_statusname[$campo_statusname][2] = $dados_statusname[1];
         $this->array_total_statusname[$campo_statusname][3] = $dados_statusname[2];
         $this->array_total_statusname[$campo_statusname][4] = $dados_statusname[3];
         $this->array_total_statusname[$campo_statusname][5] = $dados_statusname[4];
         $this->array_total_statusname[$campo_statusname][6] = $dados_statusname[5];
         $this->array_total_statusname[$campo_statusname][1] = $dados_statusname[6];
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['arr_total']['md_namadatel'][$campo_statusname] as $campo_md_namadatel => $dados_md_namadatel)
         {
            $this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][2] = $dados_md_namadatel[1];
            $this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][3] = $dados_md_namadatel[2];
            $this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][4] = $dados_md_namadatel[3];
            $this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][5] = $dados_md_namadatel[4];
            $this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][6] = $dados_md_namadatel[5];
            $this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][1] = $dados_md_namadatel[6];
            foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['arr_total']['tj_namajenis'][$campo_statusname][$campo_md_namadatel] as $campo_tj_namajenis => $dados_tj_namajenis)
            {
               $this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][2] = $dados_tj_namajenis[1];
               $this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][3] = $dados_tj_namajenis[2];
               $this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][4] = $dados_tj_namajenis[3];
               $this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][5] = $dados_tj_namajenis[4];
               $this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][6] = $dados_tj_namajenis[5];
               $this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][1] = $dados_tj_namajenis[6];
            }
         }
      }
   }
   ...
   {
      foreach ($this->array_total_statusname as $campo_statusname => $dados_statusname)
      {
         if ($this->array_total_statusname[$campo_statusname][0] != 0) {$this->array_total_statusname[$campo_statusname][1] /= $this->array_total_statusname[$campo_statusname][0];}
         nmgp_Trunc_Num($this->array_total_statusname[$campo_statusname][1], 2);
         if ($this->array_total_statusname[$campo_statusname][0] != 0) {$this->array_total_statusname[$campo_statusname][2] /= $this->array_total_statusname[$campo_statusname][0];}
         nmgp_Trunc_Num($this->array_total_statusname[$campo_statusname][2], 2);
         if ($this->array_total_statusname[$campo_statusname][0] != 0) {$this->array_total_statusname[$campo_statusname][3] /= $this->array_total_statusname[$campo_statusname][0];}
         nmgp_Trunc_Num($this->array_total_statusname[$campo_statusname][3], 2);
         if ($this->array_total_statusname[$campo_statusname][0] != 0) {$this->array_total_statusname[$campo_statusname][4] /= $this->array_total_statusname[$campo_statusname][0];}
         nmgp_Trunc_Num($this->array_total_statusname[$campo_statusname][4], 2);
         if ($this->array_total_statusname[$campo_statusname][0] != 0) {$this->array_total_statusname[$campo_statusname][5] /= $this->array_total_statusname[$campo_statusname][0];}
         nmgp_Trunc_Num($this->array_total_statusname[$campo_statusname][5], 2);
         foreach ($this->array_total_md_namadatel[$campo_statusname] as $campo_md_namadatel => $dados_md_namadatel)
         {
            if ($this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][0] != 0) {$this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][1] /= $this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][0];}
            nmgp_Trunc_Num($this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][1], 2);
            if ($this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][0] != 0) {$this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][2] /= $this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][0];}
            nmgp_Trunc_Num($this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][2], 2);
            if ($this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][0] != 0) {$this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][3] /= $this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][0];}
            nmgp_Trunc_Num($this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][3], 2);
            if ($this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][0] != 0) {$this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][4] /= $this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][0];}
            nmgp_Trunc_Num($this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][4], 2);
            if ($this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][0] != 0) {$this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][5] /= $this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][0];}
            nmgp_Trunc_Num($this->array_total_md_namadatel[$campo_statusname][$campo_md_namadatel][5], 2);
            foreach ($this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel] as $campo_tj_namajenis => $dados_tj_namajenis)
            {
               if ($this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][0] != 0) {$this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][1] /= $this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][0];}
               nmgp_Trunc_Num($this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][1], 2);
               if ($this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][0] != 0) {$this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][2] /= $this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][0];}
               nmgp_Trunc_Num($this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][2], 2);
               if ($this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][0] != 0) {$this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][3] /= $this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][0];}
               nmgp_Trunc_Num($this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][3], 2);
               if ($this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][0] != 0) {$this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][4] /= $this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][0];}
               nmgp_Trunc_Num($this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][4], 2);
               if ($this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][0] != 0) {$this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][5] /= $this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][0];}
               nmgp_Trunc_Num($this->array_total_tj_namajenis[$campo_statusname][$campo_md_namadatel][$campo_tj_namajenis][5], 2);
            }
         }
      }
      $this->array_total_geral[1] /= $this->array_total_geral[0];
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $format       = $this->Ini->Get_Gb_date_format('', 'tj_namajenis');
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->tp_idlop = $rs_res->fields[1] ;  
            $this->statusname = $rs_res->fields[2] ;  
            $this->tp_projectname = $rs_res->fields[3] ;  
            $this->tp_releasename = $rs_res->fields[4] ;  
            $this->tj_namajenis = $rs_res->fields[5] ;  
            $this->tp_lokasi = $rs_res->fields[6] ;  
            $this->tp_odp = $rs_res->fields[7] ;  
            $this->tp_jmlport = $rs_res->fields[8] ;  
            $this->tp_jmldistribusi = $rs_res->fields[9] ;  
            $this->tp_planstart = $rs_res->fields[10] ;  
            $this->tp_planfinish = $rs_res->fields[11] ;  
            $this->tp_targetwaktu = $rs_res->fields[12] ;  
            $this->tm_namamitra = $rs_res->fields[13] ;  
            $this->mw_namawitel = $rs_res->fields[14] ;  
            $this->md_namadatel = $rs_res->fields[15] ;  
            $this->ms_namasto = $rs_res->fields[16] ;  
            $this->templatename = $rs_res->fields[17] ;  
            $this->tp_jenisproject = $rs_res->fields[18] ;  
            $this->tp_prjtrelease = $rs_res->fields[19] ;  
            $this->tp_prosentase = $rs_res->fields[20] ;  
            $this->tp_batch = $rs_res->fields[21] ;  
            $this->tp_mitra = $rs_res->fields[22] ;  
            $this->tp_witel = $rs_res->fields[23] ;  
            $this->tp_sto = $rs_res->fields[24] ;  
            $this->tp_entrydate = $rs_res->fields[25] ;  
            $this->tp_entryby = $rs_res->fields[26] ;  
            $this->tp_updatedate = $rs_res->fields[27] ;  
            $this->tp_updateby = $rs_res->fields[28] ;  
            $this->tp_summary = $rs_res->fields[29] ;  
            $this->tp_status = $rs_res->fields[30] ;  
            $this->tp_actualstart = $rs_res->fields[31] ;  
            $this->tp_actualfinish = $rs_res->fields[32] ;  
            $this->tp_templateproject = $rs_res->fields[33] ;  
            $this->tp_datel = $rs_res->fields[34] ;  
            $this->tp_nokontrak = $rs_res->fields[35] ;  
            $this->tp_ponumber = $rs_res->fields[36] ;  
...
$_SESSION['scriptcase']['v_table_project_copy_for_report_mitra']['contr_erro'] = 'off'; 
            ...
            $this->tj_namajenis_orig = $this->tj_namajenis;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->prepare, $this->perijinan, $this->inst_testcomm, $this->closing, $this->pencapaian, $this->statusname, $this->md_namadatel, $this->tj_namajenis, $this->statusname_orig,  $this->md_namadatel_orig,  $this->tj_namajenis_orig);
            }
   }
//
...
$_SESSION['scriptcase']['v_table_project_copy_for_report_mitra']['contr_erro'] = 'off';
         ...
         $this->adiciona_registro(NM_encode_input(sc_strip_script($this->prepare)), NM_encode_input(sc_strip_script($this->perijinan)), NM_encode_input(sc_strip_script($this->inst_testcomm)), NM_encode_input(sc_strip_script($this->closing)), NM_encode_input(sc_strip_script($this->pencapaian)), sc_strip_script($this->statusname), sc_strip_script($this->md_namadatel), sc_strip_script($this->tj_namajenis), sc_strip_script($statusname_orig), sc_strip_script($md_namadatel_orig), sc_strip_script($tj_namajenis_orig));
         $this->rs_grid->MoveNext();
      }
      $this->finaliza_arrays();
      $this->rs_grid->Close();
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['tot_geral'][2] = $this->array_total_geral[1];
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['tot_geral'][3] = $this->array_total_geral[2];
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['tot_geral'][4] = $this->array_total_geral[3];
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['tot_geral'][5] = $this->array_total_geral[4];
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['tot_geral'][6] = $this->array_total_geral[5];
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['tot_geral'][1] = $this->array_total_geral[0];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['arr_total']['statusname'] = $this->array_total_statusname;
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['arr_total']['md_namadatel'] = $this->array_total_md_namadatel;
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['arr_total']['tj_namajenis'] = $this->array_total_tj_namajenis;
      }
   }
