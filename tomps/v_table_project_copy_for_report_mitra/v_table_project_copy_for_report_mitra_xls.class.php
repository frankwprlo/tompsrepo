...
class v_table_project_copy_for_report_mitra_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= "_v_table_project_copy_for_report_mitra";
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "v_table_project_copy_for_report_mitra.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['order_grid'];
      ...
      { 
          ...
          if ($Cada_col == "prepare" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "inst_testcomm" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "closing" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "pencapaian" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      while (!$rs->EOF)
      {
         ...
         $this->statusname = $rs->fields[2] ;  
         $this->tp_projectname = $rs->fields[3] ;  
         $this->tp_releasename = $rs->fields[4] ;  
         $this->tj_namajenis = $rs->fields[5] ;  
         $this->tp_lokasi = $rs->fields[6] ;  
         ...
         $this->tp_targetwaktu = $rs->fields[12] ;  
         $this->tp_targetwaktu = (string)$this->tp_targetwaktu;
         $this->tm_namamitra = $rs->fields[13] ;  
         $this->mw_namawitel = $rs->fields[14] ;  
         $this->md_namadatel = $rs->fields[15] ;  
         $this->ms_namasto = $rs->fields[16] ;  
         $this->templatename = $rs->fields[17] ;  
         $this->tp_jenisproject = $rs->fields[18] ;  
         $this->tp_jenisproject = (string)$this->tp_jenisproject;
         $this->tp_prjtrelease = $rs->fields[19] ;  
         $this->tp_prjtrelease = (string)$this->tp_prjtrelease;
         $this->tp_prosentase = $rs->fields[20] ;  
         $this->tp_prosentase = (string)$this->tp_prosentase;
         $this->tp_batch = $rs->fields[21] ;  
         $this->tp_mitra = $rs->fields[22] ;  
         $this->tp_mitra = (string)$this->tp_mitra;
         $this->tp_witel = $rs->fields[23] ;  
         $this->tp_witel = (string)$this->tp_witel;
         $this->tp_sto = $rs->fields[24] ;  
         $this->tp_sto = (string)$this->tp_sto;
         $this->tp_entrydate = $rs->fields[25] ;  
         $this->tp_entryby = $rs->fields[26] ;  
         $this->tp_updatedate = $rs->fields[27] ;  
         $this->tp_updateby = $rs->fields[28] ;  
         $this->tp_summary = $rs->fields[29] ;  
         $this->tp_status = $rs->fields[30] ;  
         $this->tp_status = (string)$this->tp_status;
         $this->tp_actualstart = $rs->fields[31] ;  
         $this->tp_actualfinish = $rs->fields[32] ;  
         $this->tp_templateproject = $rs->fields[33] ;  
         $this->tp_templateproject = (string)$this->tp_templateproject;
         $this->tp_datel = $rs->fields[34] ;  
         $this->tp_datel = (string)$this->tp_datel;
         $this->tp_nokontrak = $rs->fields[35] ;  
         $this->tp_ponumber = $rs->fields[36] ;  
...
$_SESSION['scriptcase']['v_table_project_copy_for_report_mitra']['contr_erro'] = 'off'; 
   ...
   function NM_export_tp_releasename()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->tp_releasename, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- tj_namajenis
   function NM_export_tj_namajenis()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->tj_namajenis, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- tp_lokasi
   ...
   function NM_export_tp_jmlport()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->tp_jmlport, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- tp_jmldistribusi
   function NM_export_tp_jmldistribusi()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->tp_jmldistribusi, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- tp_planstart
   ...
   function NM_export_mw_namawitel()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->mw_namawitel, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- md_namadatel
   ...
   function NM_export_templatename()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->templatename, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- tp_jenisproject
   ...
   function NM_export_perijinan()
   {
         ...
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->perijinan);
         $this->Xls_col++;
   }
   //----- inst_testcomm
   function NM_export_inst_testcomm()
   {
         if (!NM_is_utf8($this->inst_testcomm))
         {
             $this->inst_testcomm = sc_convert_encoding($this->inst_testcomm, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->inst_testcomm))
         {
             $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getNumberFormat()->setFormatCode('#,##0.00');
         }
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->inst_testcomm);
         $this->Xls_col++;
   }
   //----- closing
   function NM_export_closing()
   {
         if (!NM_is_utf8($this->closing))
         {
         ...
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->closing);
         $this->Xls_col++;
   }
   //----- tp_prosentase
   function NM_export_tp_prosentase()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->tp_prosentase, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- tp_batch
   ...
   {
         $this->tp_mitra = html_entity_decode($this->tp_mitra, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->tp_mitra = strip_tags($this->tp_mitra);
         if (!NM_is_utf8($this->tp_mitra))
         {
             $this->tp_mitra = sc_convert_encoding($this->tp_mitra, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->tp_mitra, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- tp_witel
   ...
   {
         $this->tp_status = html_entity_decode($this->tp_status, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->tp_status = strip_tags($this->tp_status);
         if (!NM_is_utf8($this->tp_status))
         {
             $this->tp_status = sc_convert_encoding($this->tp_status, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->tp_status, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- tp_actualstart
   ...
   {
         if (!NM_is_utf8($this->pencapaian))
         {
             $this->pencapaian = sc_convert_encoding($this->pencapaian, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->pencapaian))
         {
             $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getNumberFormat()->setFormatCode('#,##0.00');
         }
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->pencapaian);
         $this->Xls_col++;
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra'][$path_doc_md5][1] = $this->Tit_doc;
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE>Resume Project Detail <?php echo $_SESSION['kodewitel'] ?>  Mitra : <?php echo $_SESSION['namamitra'] ?> :: Excel</TITLE>
