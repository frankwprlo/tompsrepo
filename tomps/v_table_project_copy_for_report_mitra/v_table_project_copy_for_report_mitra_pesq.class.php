...
class v_table_project_copy_for_report_mitra_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
   ...
   function lookup_ajax_tp_datel()
   {
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['psq_check_ret']['tp_datel'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['psq_check_ret']['tp_datel'][] = trim($rs->fields[0]);
   ...
   { 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['psq_check_ret']['tp_sto'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['psq_check_ret']['tp_sto'][] = trim($rs->fields[0]);
            $cmp1 = NM_charset_to_utf8(trim($rs->fields[0]));
            $cmp2 = NM_charset_to_utf8(trim($rs->fields[1]));
            $nmgp_def_dados[] = array($cmp1 . "##@@" . $cmp2 => $cmp2); 
            $rs->MoveNext() ; 
   ...
   function lookup_ajax_tp_odp($tp_odp)
   {
      ...
      {
          $nm_comando = "select distinct TP_ODP from " . $this->Ini->nm_tabela . " where TP_MITRA='" . $_SESSION['user_group'] . "' AND TP_DIVRE='" . $_SESSION['iddivre'] . "' AND TP_WITEL='" . $_SESSION['idwitel'] . "' and   CAST (TP_ODP AS TEXT)  like '%" . $tp_odp . "%' order by TP_ODP"; 
      }
      else
      {
          $nm_comando = "select distinct TP_ODP from " . $this->Ini->nm_tabela . " where TP_MITRA='" . $_SESSION['user_group'] . "' AND TP_DIVRE='" . $_SESSION['iddivre'] . "' AND TP_WITEL='" . $_SESSION['idwitel'] . "' and  TP_ODP like '%" . $tp_odp . "%' order by TP_ODP"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Resume Project Detail <?php echo $_SESSION['kodewitel'] ?>  Mitra : <?php echo $_SESSION['namamitra'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>v_table_project_copy_for_report_mitra/v_table_project_copy_for_report_mitra_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="v_table_project_copy_for_report_mitra_ajax_search.js"></script>
 <script type="text/javascript" src="v_table_project_copy_for_report_mitra_ajax.js"></script>
 <script type="text/javascript">
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['dashboard_info']['compact_mode'])
      {
          return;
      }
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR align="center" valign="middle">
        ...
        <TD class="scFilterHeaderFont">
          Resume Project Detail <?php echo $_SESSION['kodewitel'] ?>  Mitra : <?php echo $_SESSION['namamitra'] ?>
        </TD>
       </TR>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $tp_jenisproject = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_jenisproject']; 
          $tp_jenisproject_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_jenisproject_cond']; 
          $tp_prjtrelease = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_prjtrelease']; 
          $tp_prjtrelease_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_prjtrelease_cond']; 
          $tp_status = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_status']; 
          $tp_status_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_status_cond']; 
          $tp_mitra = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_mitra']; 
          $tp_mitra_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_mitra_cond']; 
          $tp_datel = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_datel']; 
          $tp_datel_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_datel_cond']; 
          $tp_sto = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_sto']; 
          $tp_sto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_sto_cond']; 
          $tp_odp = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_odp']; 
          $tp_odp_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_odp_cond']; 
          $tp_planstart_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planstart_dia']; 
          $tp_planstart_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planstart_mes']; 
          $tp_planstart_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planstart_ano']; 
          $tp_planstart_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planstart_input_2_dia']; 
          $tp_planstart_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planstart_input_2_mes']; 
          $tp_planstart_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planstart_input_2_ano']; 
          $tp_planstart_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planstart_cond']; 
          $tp_planfinish_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planfinish_dia']; 
          $tp_planfinish_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planfinish_mes']; 
          $tp_planfinish_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planfinish_ano']; 
          $tp_planfinish_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planfinish_input_2_dia']; 
          $tp_planfinish_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planfinish_input_2_mes']; 
          $tp_planfinish_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planfinish_input_2_ano']; 
          $tp_planfinish_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planfinish_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['NM_operador']; 
      } 
...
?>
    ...
    <TR>
     <TD colspan="24" height="20" class="scFilterBlockBack">
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['psq_check_ret']['tp_jenisproject'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['psq_check_ret']['tp_jenisproject'][] = trim($rs->fields[0]);
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['psq_check_ret']['tp_prjtrelease'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['psq_check_ret']['tp_prjtrelease'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['tp_status'])) ? $this->New_label['tp_status'] : "StatusID"; ?></TD>
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['psq_check_ret']['tp_status'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['psq_check_ret']['tp_status'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['tp_mitra'])) ? $this->New_label['tp_mitra'] : "ID Mitra"; ?></TD>
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['psq_check_ret']['tp_mitra'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['psq_check_ret']['tp_mitra'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['tp_datel'])) ? $this->New_label['tp_datel'] : "ID Datel"; ?></TD>
...
?>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['tp_sto'])) ? $this->New_label['tp_sto'] : "ID STO"; ?></TD>
...
?>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['tp_odp'])) ? $this->New_label['tp_odp'] : "Jml ODP"; ?></TD>
      
      <INPUT type="hidden" id="SC_tp_odp_cond" name="tp_odp_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tp_odp" <?php echo $str_hide_tp_odp?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct TP_ODP from " . $this->Ini->nm_tabela . " where TP_MITRA='" . $_SESSION['user_group'] . "' AND TP_DIVRE='" . $_SESSION['iddivre'] . "' AND TP_WITEL='" . $_SESSION['idwitel'] . "' and TP_ODP = $tp_odp_look order by TP_ODP"; 
      }
      else
      {
          $nm_comando = "select distinct TP_ODP from " . $this->Ini->nm_tabela . " where TP_MITRA='" . $_SESSION['user_group'] . "' AND TP_DIVRE='" . $_SESSION['iddivre'] . "' AND TP_WITEL='" . $_SESSION['idwitel'] . "' and TP_ODP = $tp_odp_look order by TP_ODP"; 
...
?>
<?php
   if (is_file("v_table_project_copy_for_report_mitra_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['opc_psq'])
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['orig_pesq'] == "grid")
   {
...
<SCRIPT type="text/javascript">
 ...
 function limpa_form()
 {
   ...
   document.F1.tp_planfinish_input_2_ano.value = "";
         ...
         function nm_display_calendar_tp_planstart(sField)
         {
             ...
             sValue   += document.F1.elements[sField_d].value;
             tb_show('', '<?php echo $this->Ini->path_link; ?>v_table_project_copy_for_report_mitra/v_table_project_copy_for_report_mitra.php?nm_cal_display=Y&field=' + sField + '&value=' + sValue + '&inter=10&week_ini=<?php echo $_SESSION['scriptcase']['reg_conf']['date_week_ini']; ?>&Orig=pesq&Seq=0&script_case_init=<?php  echo NM_encode_input($this->Ini->sc_page); ?>&script_case_session=<?php  echo session_id(); ?>&TB_iframe=true&height=150&width=220&modal=true', '');
         }
 ...
 {
    $('#SC_tp_planfinish_dia').bind('change', function() {sc_v_table_project_copy_for_report_mitra_valida_dia(this)});
    $('#SC_tp_planfinish_input_2_dia').bind('change', function() {sc_v_table_project_copy_for_report_mitra_valida_dia(this)});
    $('#SC_tp_planfinish_input_2_mes').bind('change', function() {sc_v_table_project_copy_for_report_mitra_valida_mes(this)});
    $('#SC_tp_planfinish_mes').bind('change', function() {sc_v_table_project_copy_for_report_mitra_valida_mes(this)});
    $('#SC_tp_planstart_dia').bind('change', function() {sc_v_table_project_copy_for_report_mitra_valida_dia(this)});
    $('#SC_tp_planstart_input_2_dia').bind('change', function() {sc_v_table_project_copy_for_report_mitra_valida_dia(this)});
    $('#SC_tp_planstart_input_2_mes').bind('change', function() {sc_v_table_project_copy_for_report_mitra_valida_mes(this)});
    $('#SC_tp_planstart_mes').bind('change', function() {sc_v_table_project_copy_for_report_mitra_valida_mes(this)});
 }
 function sc_v_table_project_copy_for_report_mitra_valida_dia(obj)
 {
 ...
 function sc_v_table_project_copy_for_report_mitra_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['psq_check_ret']['tp_jenisproject'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['psq_check_ret']['tp_prjtrelease'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['psq_check_ret']['tp_status'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['psq_check_ret']['tp_mitra'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['psq_check_ret']['tp_datel'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['psq_check_ret']['tp_sto'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_jenisproject'] = $tp_jenisproject; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_jenisproject_cond'] = $tp_jenisproject_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_prjtrelease'] = $tp_prjtrelease; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_prjtrelease_cond'] = $tp_prjtrelease_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_status'] = $tp_status; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_status_cond'] = $tp_status_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_mitra'] = $tp_mitra; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_mitra_cond'] = $tp_mitra_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_datel'] = $tp_datel; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_datel_cond'] = $tp_datel_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_sto'] = $tp_sto; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_sto_cond'] = $tp_sto_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_odp'] = $tp_odp; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_odp_cond'] = $tp_odp_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planstart_dia'] = $tp_planstart_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planstart_mes'] = $tp_planstart_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planstart_ano'] = $tp_planstart_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planstart_input_2_dia'] = $tp_planstart_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planstart_input_2_mes'] = $tp_planstart_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planstart_input_2_ano'] = $tp_planstart_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planstart_cond'] = $tp_planstart_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planfinish_dia'] = $tp_planfinish_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planfinish_mes'] = $tp_planfinish_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planfinish_ano'] = $tp_planfinish_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planfinish_input_2_dia'] = $tp_planfinish_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planfinish_input_2_mes'] = $tp_planfinish_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planfinish_input_2_ano'] = $tp_planfinish_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planfinish_cond'] = $tp_planfinish_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['NM_operador'] = $this->NM_operador; 
   ...
   { 
      ...
      if ($tp_planstart_cond != "TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planstart'] = $val[0];
          ...
          if ($tp_planstart_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planstart_input_2'] = $val[1];
      ...
      if ($tp_planfinish_cond != "TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planfinish'] = $val[0];
          ...
          if ($tp_planfinish_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']['tp_planfinish_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['where_pesq_ant'] = $this->comando . $this->comando_fim;
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['fast_search']);
