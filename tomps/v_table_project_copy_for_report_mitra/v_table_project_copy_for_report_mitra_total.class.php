...
class v_table_project_copy_for_report_mitra_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['v_table_project_copy_for_report_mitra']['campos_busca']))
      { 
