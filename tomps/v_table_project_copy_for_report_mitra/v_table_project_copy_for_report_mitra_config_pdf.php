 ...
 */
    ...
    session_start();
    $SC_apl_proc = "v_table_project_copy_for_report_mitra";
	...
	$createCharts = (isset($_GET['create_charts'])) ? $_GET['create_charts'] : 'S';
...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['v_table_project_copy_for_report_mitra']['show_skip_charts_option']) || !$_SESSION['sc_session']['v_table_project_copy_for_report_mitra']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
...
?>
     parent.nm_gp_move('<?php echo NM_encode_input($opc); ?>', '<?php echo NM_encode_input($target); ?>', cor, parms_pdf, grafico, create);return false;
  }
