...
class v_table_project_copy_for_report_mitra_resumo
{
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_order']['gbmitraonly']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_order']['gbmitraonly'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_order']['gbmitraonly'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_display']['gbmitraonly'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_display']['gbmitraonly'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_display']['gbmitraonly'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_display']['gbmitraonly'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_display']['gbmitraonly'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_display']['gbmitraonly'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_display']['gbmitraonly'] as $i_sum => $d_sum)
           {
...
{ 
   ...
   //---- 
   function adiciona_registro($avg_prepare, $avg_perijinan, $avg_inst_testcomm, $avg_closing, $avg_pencapaian, $quebra_statusname, $quebra_statusname_orig)
   {
      //----- Status Project
...
$_SESSION['scriptcase']['v_table_project_copy_for_report_mitra']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->prepare, $this->perijinan, $this->inst_testcomm, $this->closing, $this->pencapaian, $this->statusname, $this->statusname_orig);
            }
   }
//
