...
class v_table_project_copy_for_report_mitra_resumo
{
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_order']['gbmitra']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_order']['gbmitra'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_order']['gbmitra'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_display']['gbmitra'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_display']['gbmitra'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_display']['gbmitra'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_display']['gbmitra'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_display']['gbmitra'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_display']['gbmitra'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['summarizing_fields_display']['gbmitra'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_statusname as $i_statusname => $d_statusname) {
           ...
           foreach ($this->array_total_tj_namajenis[$i_statusname] as $i_tj_namajenis => $d_tj_namajenis) {
               if (!in_array($i_tj_namajenis, $this->comp_label[1][ $d_statusname[8] ], true)) {
                   $this->comp_index[1][ $d_tj_namajenis[8] ] = $d_tj_namajenis[7];
                   $this->comp_label[1][ $d_statusname[8] ][ $d_tj_namajenis[8] ] = $d_tj_namajenis[7];
               }
           }
       }
       ...
       foreach ($this->comp_label[0] as $i_statusname => $l_statusname) {
           ...
           foreach ($this->comp_label[1][$i_statusname] as $i_tj_namajenis => $l_tj_namajenis) {
               if (isset($this->array_total_tj_namajenis[$i_statusname][$i_tj_namajenis])) {
                   $this->comp_group[$i_statusname][$i_tj_namajenis] = array();
               }
           }
       }
...
{ 
   ...
   //---- 
   function adiciona_registro($avg_prepare, $avg_perijinan, $avg_inst_testcomm, $avg_closing, $avg_pencapaian, $quebra_statusname, $quebra_tj_namajenis, $quebra_statusname_orig, $quebra_tj_namajenis_orig)
   {
      //----- Status Project
      ...
      //----- Jenis Project
      if (!isset($this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_tj_namajenis_orig]))
      {
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_tj_namajenis_orig][0] = 1;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_tj_namajenis_orig][1] = $avg_prepare;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_tj_namajenis_orig][2] = $avg_perijinan;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_tj_namajenis_orig][3] = $avg_inst_testcomm;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_tj_namajenis_orig][4] = $avg_closing;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_tj_namajenis_orig][5] = $avg_pencapaian;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_tj_namajenis_orig][6] = 1;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_tj_namajenis_orig][7] = $quebra_tj_namajenis;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_tj_namajenis_orig][8] = $quebra_tj_namajenis_orig;
      }
      else
      {
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_tj_namajenis_orig][0]++;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_tj_namajenis_orig][1] += $avg_prepare;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_tj_namajenis_orig][2] += $avg_perijinan;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_tj_namajenis_orig][3] += $avg_inst_testcomm;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_tj_namajenis_orig][4] += $avg_closing;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_tj_namajenis_orig][5] += $avg_pencapaian;
         $this->array_total_tj_namajenis[$quebra_statusname_orig][$quebra_tj_namajenis_orig][6]++;
      }
      //----- Total
   ...
   function compat_arrays()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['arr_total']['statusname'] as $campo_statusname => $dados_statusname)
      {
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_for_report_mitra']['arr_total']['tj_namajenis'][$campo_statusname] as $campo_tj_namajenis => $dados_tj_namajenis)
         {
            $this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][2] = $dados_tj_namajenis[1];
            $this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][3] = $dados_tj_namajenis[2];
            $this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][4] = $dados_tj_namajenis[3];
            $this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][5] = $dados_tj_namajenis[4];
            $this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][6] = $dados_tj_namajenis[5];
            $this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][1] = $dados_tj_namajenis[6];
         }
      }
   }
   //---- 
   function finaliza_arrays()
   {
      foreach ($this->array_total_statusname as $campo_statusname => $dados_statusname)
      {
         ...
         foreach ($this->array_total_tj_namajenis[$campo_statusname] as $campo_tj_namajenis => $dados_tj_namajenis)
         {
            if ($this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][0] != 0) {$this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][1] /= $this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][0];}
            nmgp_Trunc_Num($this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][1], 2);
            if ($this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][0] != 0) {$this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][2] /= $this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][0];}
            nmgp_Trunc_Num($this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][2], 2);
            if ($this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][0] != 0) {$this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][3] /= $this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][0];}
            nmgp_Trunc_Num($this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][3], 2);
            if ($this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][0] != 0) {$this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][4] /= $this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][0];}
            nmgp_Trunc_Num($this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][4], 2);
            if ($this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][0] != 0) {$this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][5] /= $this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][0];}
            nmgp_Trunc_Num($this->array_total_tj_namajenis[$campo_statusname][$campo_tj_namajenis][5], 2);
         }
      }
...
$_SESSION['scriptcase']['v_table_project_copy_for_report_mitra']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->prepare, $this->perijinan, $this->inst_testcomm, $this->closing, $this->pencapaian, $this->statusname, $this->tj_namajenis, $this->statusname_orig,  $this->tj_namajenis_orig);
            }
   }
//
