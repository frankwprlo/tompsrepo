...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "tp_id";$Nm_numeric[] = "tp_mitra";$Nm_numeric[] = "tp_witel";$Nm_numeric[] = "tp_sto";$Nm_numeric[] = "tp_odp";$Nm_numeric[] = "tp_status";$Nm_numeric[] = "tp_templateproject";$Nm_numeric[] = "tp_jenisproject";$Nm_numeric[] = "tp_prjtrelease";$Nm_numeric[] = "tp_targetwaktu";$Nm_numeric[] = "tp_datel";$Nm_numeric[] = "tp_prosentase";$Nm_numeric[] = "";
...
<HTML>
<HEAD>
 <TITLE>Resume Project Detail Divre : <?php echo $_SESSION['kodedivre'] ?></TITLE>
...
?>
   <span id="idAjaxSelect_tp_batch">
      <SELECT class="scFilterObjectOdd" id="SC_tp_batch" name="tp_batch"  size="1">
       <OPTION value=""></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
...
?>
    ...
    <TR>
     <TD colspan="7" height="20" class="scFilterBlockBack">
...
<?php echo $SC_Label ?><br>
      <SELECT class="sc-js-input scFilterObjectOdd" alt="{autoTab: false, enterTab: true}" id="SC_tp_planstart_cond" name="tp_planstart_cond" onChange="nm_campos_between(document.getElementById('id_vis_tp_planstart'), this, 'tp_planstart')">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_tp_planstart_dia" name="tp_planstart_dia" value="<?php echo NM_encode_input($tp_planstart_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_tp_planstart_mes" name="tp_planstart_mes" value="<?php echo NM_encode_input($tp_planstart_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_tp_planstart_ano" name="tp_planstart_ano" value="<?php echo NM_encode_input($tp_planstart_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: true}">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_tp_planstart_input_2_dia" name="tp_planstart_input_2_dia" value="<?php echo NM_encode_input($tp_planstart_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_tp_planstart_input_2_mes" name="tp_planstart_input_2_mes" value="<?php echo NM_encode_input($tp_planstart_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_tp_planstart_input_2_ano" name="tp_planstart_input_2_ano" value="<?php echo NM_encode_input($tp_planstart_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: true}">
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         ...
         case "tp_batch" : return ('class="scFilterObjectOdd"'); break;
