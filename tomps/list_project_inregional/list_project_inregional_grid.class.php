<?php
class list_project_inregional_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['list_project_inregional']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['list_project_inregional']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['list_project_inregional']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['charts_html'] = '';
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'])
   { 
   ...
   { 
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['list_project_inregional'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'];
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] == "pdf")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] == "pdf")
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] = "igual";
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'];
 }
...
//
   ...
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "list_project_inregional/list_project_inregional_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['doc_word'])
       { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'])
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['force_toolbar']);
   } 
   $this->width_tabula_quebra  = "0px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['list_project_inregional']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['list_project_inregional']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['list_project_inregional']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opc_psq'])
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['mostra_edit'] = "N";
   }
   $this->NM_cont_emb_linha = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['emb_linha'];
   $this->NM_cont_body   = 0; 
   $this->NM_emb_tree_no = false; 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'])
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("list_project_inregional", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['list_project_inregional']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['list_project_inregional']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['list_project_inregional']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_pesq_ant'];  
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca'];
   ...
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_pesq_filtro'];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] = "muda_qt_linhas";
   } 
       ob_start(); 
   $_SESSION['scriptcase']['list_project_inregional']['contr_erro'] = 'on';
...
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_dinamico']) || $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_dinamico'] != $this->nm_where_dinamico) {
    $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_dinamico'] = $this->nm_where_dinamico;
    unset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['inicio']);
}
...
$_SESSION['scriptcase']['list_project_inregional']['contr_erro'] = 'off'; 
       $this->SC_Buf_onInit = ob_get_clean();; 

   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['list_project_inregional'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['list_project_inregional'];
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "list_project_inregional/list_project_inregional_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "list_project_inregional_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new list_project_inregional_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['list_project_inregional']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['list_project_inregional']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['list_project_inregional']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['list_project_inregional']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['list_project_inregional']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['list_project_inregional']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['list_project_inregional']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['list_project_inregional']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_select']['TP_ID'] = 'DESC'; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_quebra'] = array(); 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_orig'] = " where TP_DIVRE='" . $_SESSION['iddivre'] . "'";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_pesq_filtro'] = "";
   }   
   if  (!empty($this->nm_where_dinamico)) 
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao']       = "igual" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['v_resume_detailproject']['opcao_print'] = "print" ; 
   } 
// 
   $this->count_ger = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['sc_total']);
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
...
//----- 
   ...
   { 
       $nmgp_select = "SELECT TP_ID, TP_THN_RELEASE, TP_PRJTRELEASE, TP_BATCH, TP_IDLOP, MW_NAMAWITEL, MD_NAMADATEL, MS_NAMASTO, STATUSNAME, TM_NAMAMITRA, TP_PROJECTNAME, TJ_NAMAJENIS, TP_LOKASI, TP_ODP, EXTEND(TP_PLANSTART, YEAR TO FRACTION), EXTEND(TP_PLANFINISH, YEAR TO FRACTION), TP_TARGETWAKTU, TP_PROSENTASE, TP_MITRA, TP_WITEL, TP_STO, EXTEND(TP_ENTRYDATE, YEAR TO FRACTION), TP_ENTRYBY, EXTEND(TP_UPDATEDATE, YEAR TO FRACTION), TP_UPDATEBY, TP_SUMMARY, TP_STATUS, EXTEND(TP_ACTUALSTART, YEAR TO FRACTION), EXTEND(TP_ACTUALFINISH, YEAR TO FRACTION), TP_TEMPLATEPROJECT, TP_JENISPROJECT, TP_DATEL, TEMPLATENAME, TP_NOKONTRAK, TP_PONUMBER, TP_RELEASENAME from " . $this->Ini->nm_tabela; 
   } 
   else 
   { 
       $nmgp_select = "SELECT TP_ID, TP_THN_RELEASE, TP_PRJTRELEASE, TP_BATCH, TP_IDLOP, MW_NAMAWITEL, MD_NAMADATEL, MS_NAMASTO, STATUSNAME, TM_NAMAMITRA, TP_PROJECTNAME, TJ_NAMAJENIS, TP_LOKASI, TP_ODP, TP_PLANSTART, TP_PLANFINISH, TP_TARGETWAKTU, TP_PROSENTASE, TP_MITRA, TP_WITEL, TP_STO, TP_ENTRYDATE, TP_ENTRYBY, TP_UPDATEDATE, TP_UPDATEBY, TP_SUMMARY, TP_STATUS, TP_ACTUALSTART, TP_ACTUALFINISH, TP_TEMPLATEPROJECT, TP_JENISPROJECT, TP_DATEL, TEMPLATENAME, TP_NOKONTRAK, TP_PONUMBER, TP_RELEASENAME from " . $this->Ini->nm_tabela; 
   } 
   $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_pesq']; 
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $this->tp_datel = $this->rs_grid->fields[31] ;  
       $this->tp_datel = (string)$this->tp_datel;
       $this->templatename = $this->rs_grid->fields[32] ;  
       $this->tp_nokontrak = $this->rs_grid->fields[33] ;  
       $this->tp_ponumber = $this->rs_grid->fields[34] ;  
       $this->tp_releasename = $this->rs_grid->fields[35] ;  
       $this->SC_seq_register = $this->nmgp_reg_start ; 
       $this->SC_seq_page = 0;
       $this->SC_sep_quebra = false;
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['final']; 
   ...
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'])
   { 
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<HEAD>
 <TITLE>Resume Project Detail Divre : <?php echo $_SESSION['kodedivre'] ?> :: PDF</TITLE>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['pivot_charts']) : 0;
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>Resume Project Detail Divre : " . $_SESSION['kodedivre'] . "</TITLE>\r\n");
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ajax_nav'])
       { 
           ...
           $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . session_id() . "\">\r\n");
           $nm_saida->saida("   </form>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"list_project_inregional_jquery.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"list_project_inregional_ajax.js\"></script>\r\n");
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($this->count_ger) . ";\r\n");
           }
           else
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_reg_grid']) . ";\r\n");
           }
           $gridWidthCorrection = '';
           ...
           $nm_saida->saida("   gridHeaders = $(\".sc-ui-grid-header-row-list_project_inregional-1\");\r\n");
           ...
           $nm_saida->saida("   tableOriginal = $(\"#sc-ui-grid-body-5fefb27f\");\r\n");
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ancor_save']);
           }
           $nm_saida->saida("   });\r\n");
           ...
           $nm_saida->saida("       dataType: \"html\",\r\n");
           $nm_saida->saida("       url: \"list_project_inregional_save_grid.php\",\r\n");
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_list_project_inregional_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'])
       {
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_list_project_inregional_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_list_project_inregional_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "list_project_inregional/list_project_inregional_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           $cada_css = ".list_project_inregional_" . substr($cada_css, 1);
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf" && !$this->Print_All)
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['doc_word'])
       { 
       ...
       $nm_saida->saida("       <TABLE width='100%' cellspacing=0 cellpadding=0>\r\n");
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf" && 
           $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print") 
       { 
           $nm_saida->saida("    <TR>\r\n");
           $nm_saida->saida("    <TD  colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_A_list_project_inregional\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_A_list_project_inregional\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
           $nm_saida->saida("    <TR>\r\n");
           $nm_saida->saida("    <TD style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_E_list_project_inregional\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_E_list_project_inregional\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    <td style=\"padding: 0px;  vertical-align: top;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\"><tr>\r\n");
           $nm_saida->saida("    <TD colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\" width=1>\r\n");
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_AL_list_project_inregional\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_AL_list_project_inregional\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
        } 
   }  
 ...
 {  
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['v_resume_detailproject']['SC_herda_css'] = "S"; 
   $compl_css = "";
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['list_project_inregional']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['list_project_inregional']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['list_project_inregional']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['list_project_inregional']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida']) ? "list_project_inregional_" : "";
   $this->css_sep = " ";
...
//----- 
 function cabecalho()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opc_liga']['cab']))
   {
       return; 
   }
   $nm_cab_filtro   = ""; 
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cond_pesq'], 0, $trab_pos);
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   { 
   ...
   $nm_saida->saida("          Resume Project Detail Divre : " . $_SESSION['kodedivre'] . "\r\n");
   $nm_saida->saida("        </TD>\r\n");
   $nm_saida->saida("       </TR>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_list_project_inregional__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-list_project_inregional-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_tp_releasename_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_tp_releasename_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida_pdf'] != "pdf") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_tp_releasename_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] || ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['exibe_seq'] == "S")) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_tp_releasename_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
     ...
     { 
         ...
         { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 $css_emb .= ".list_project_inregional_" . substr($cada_css, 1);
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_tp_id()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_ID')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
 ...
 function NM_label_tp_thn_release()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_THN_RELEASE')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_prjtrelease()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_PRJTRELEASE')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_batch()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_BATCH')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_idlop()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_IDLOP')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_mw_namawitel()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'MW_NAMAWITEL')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_md_namadatel()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'MD_NAMADATEL')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_ms_namasto()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'MS_NAMASTO')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_statusname()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'STATUSNAME')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tm_namamitra()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TM_NAMAMITRA')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_projectname()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_PROJECTNAME')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tj_namajenis()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TJ_NAMAJENIS')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_lokasi()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_LOKASI')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_odp()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_ODP')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_planstart()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_PLANSTART')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_planfinish()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_PLANFINISH')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_targetwaktu()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_TARGETWAKTU')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_prosentase()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_PROSENTASE')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_mitra()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_MITRA')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_witel()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_WITEL')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_sto()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_STO')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_entrydate()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_ENTRYDATE')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_entryby()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_ENTRYBY')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_updatedate()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_UPDATEDATE')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_updateby()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_UPDATEBY')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_summary()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_SUMMARY')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_status()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_STATUS')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_actualstart()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_ACTUALSTART')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_actualfinish()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_ACTUALFINISH')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_templateproject()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_TEMPLATEPROJECT')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_jenisproject()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_JENISPROJECT')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_datel()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_DATEL')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_templatename()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TEMPLATENAME')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_nokontrak()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_NOKONTRAK')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_ponumber()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_PONUMBER')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_tp_releasename()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_cmp'] == 'TP_RELEASENAME')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ini_cor_grid']);
       }
   }
...
// 
   $SC_Label = (isset($this->New_label['tp_id'])) ? $this->New_label['tp_id'] : "ID"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_id'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_thn_release'])) ? $this->New_label['tp_thn_release'] : "Release Project"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_thn_release'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_prjtrelease'])) ? $this->New_label['tp_prjtrelease'] : "Sub-Release"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_prjtrelease'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_batch'])) ? $this->New_label['tp_batch'] : "Batch"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_batch'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_idlop'])) ? $this->New_label['tp_idlop'] : "ID LOP"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_idlop'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['mw_namawitel'])) ? $this->New_label['mw_namawitel'] : "Witel"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['mw_namawitel'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['md_namadatel'])) ? $this->New_label['md_namadatel'] : "Datel"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['md_namadatel'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ms_namasto'])) ? $this->New_label['ms_namasto'] : "STO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['ms_namasto'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['statusname'])) ? $this->New_label['statusname'] : "Status Project"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['statusname'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tm_namamitra'])) ? $this->New_label['tm_namamitra'] : "Mitra"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tm_namamitra'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_projectname'])) ? $this->New_label['tp_projectname'] : "Nama Project"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_projectname'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tj_namajenis'])) ? $this->New_label['tj_namajenis'] : "Jenis Project"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tj_namajenis'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_lokasi'])) ? $this->New_label['tp_lokasi'] : "Lokasi"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_lokasi'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_odp'])) ? $this->New_label['tp_odp'] : "Jml ODP"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_odp'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_planstart'])) ? $this->New_label['tp_planstart'] : "Plan Mulai"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_planstart'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_planfinish'])) ? $this->New_label['tp_planfinish'] : "Plan Selesai"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_planfinish'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_targetwaktu'])) ? $this->New_label['tp_targetwaktu'] : "Target Deploy"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_targetwaktu'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['prepare'])) ? $this->New_label['prepare'] : "Preparing (15%)"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['prepare'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['perijinan'])) ? $this->New_label['perijinan'] : "Perijinan (15%)"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['perijinan'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['inst_testcomm'])) ? $this->New_label['inst_testcomm'] : "Inst.& TestComm (50%)"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['inst_testcomm'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['closing'])) ? $this->New_label['closing'] : "Closing ( 20%)"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['closing'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_prosentase'])) ? $this->New_label['tp_prosentase'] : "Pencapaian Project"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_prosentase'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_mitra'])) ? $this->New_label['tp_mitra'] : "Kode Mitra"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_mitra'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_witel'])) ? $this->New_label['tp_witel'] : "Kode Witel"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_witel'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_sto'])) ? $this->New_label['tp_sto'] : "Kode STO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_sto'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_entrydate'])) ? $this->New_label['tp_entrydate'] : "Tgl Entry"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_entrydate'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_entryby'])) ? $this->New_label['tp_entryby'] : "Petugas Entry"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_entryby'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_updatedate'])) ? $this->New_label['tp_updatedate'] : "Tgl Update"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_updatedate'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_updateby'])) ? $this->New_label['tp_updateby'] : "Petugas Update"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_updateby'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_summary'])) ? $this->New_label['tp_summary'] : "Summary"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_summary'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_status'])) ? $this->New_label['tp_status'] : "Kode Status"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_status'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_actualstart'])) ? $this->New_label['tp_actualstart'] : "Tgl Start Actual"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_actualstart'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_actualfinish'])) ? $this->New_label['tp_actualfinish'] : "Tgl Finish Actual"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_actualfinish'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_templateproject'])) ? $this->New_label['tp_templateproject'] : "Project Template"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_templateproject'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_jenisproject'])) ? $this->New_label['tp_jenisproject'] : "Kode Jenis Project"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_jenisproject'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_datel'])) ? $this->New_label['tp_datel'] : "TP DATEL"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_datel'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['templatename'])) ? $this->New_label['templatename'] : "Project Template"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['templatename'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_nokontrak'])) ? $this->New_label['tp_nokontrak'] : "No.Kontrak"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_nokontrak'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_ponumber'])) ? $this->New_label['tp_ponumber'] : "PO.Number"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_ponumber'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tp_releasename'])) ? $this->New_label['tp_releasename'] : "Project Release"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['labels']['tp_releasename'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['list_project_inregional']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['list_project_inregional']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['list_project_inregional']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_list_project_inregional#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               $nm_saida->saida("  <tr><td class=\"" . $this->css_scGridTabelaTd . " " . "\" style=\"font-family:" . $this->Ini->texto_fonte_tipo_impar . ";font-size:12px;color:#000000;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\">\r\n");
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cab_embutida'] != "S")
               {
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_list_project_inregional\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_list_project_inregional\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               $nm_saida->saida("    </TD>\r\n");
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  " . $this->nm_grid_sem_reg . "\r\n");
           ...
           { 
               ...
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_A_list_project_inregional', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_D_list_project_inregional', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_E_list_project_inregional', 'value' => 'NM_Blank_Page.htm');
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  </td></tr>\r\n");
           if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf" &&
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_DL_list_project_inregional\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_DL_list_project_inregional\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               $nm_saida->saida("</TD>\r\n");
               $nm_saida->saida("    <TD style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_D_list_project_inregional\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_D_list_project_inregional\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               $nm_saida->saida("    </TD>\r\n");
               $nm_saida->saida("    </TR>\r\n");
           } 
       $nm_saida->saida("</TABLE>\r\n");
   ...
   { 
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_list_project_inregional\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_list_project_inregional\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       ...
       $nm_id_aplicacao = " id=\"apl_list_project_inregional#?#1\"";
   } 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-5fefb27f\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'])
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cab_embutida'] != "S" )
      { 
...
// 
   ...
   $ini_grid = true;
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          $this->NM_field_style = array();
          $this->NM_cont_emb_linha++;
          $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['emb_linha']++;
          if ($this->Ini->qual_linha == "impar")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['v_resume_detailproject']['ini_cor_grid'] = "impar";
          }
          //---------- Gauge ----------
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
          ...
          $this->tp_releasename = $this->rs_grid->fields[35] ;  
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['final'] + 1; 
          if (!$ini_grid) {
...
FROM AKSESSMR.TBL_PROJECT_PROGRESS
...
$_SESSION['scriptcase']['list_project_inregional']['contr_erro'] = 'off';
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['dado_psq_ret'];
          ...
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_tp_releasename_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_tp_releasename_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . $teste . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . $teste . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
          $nm_saida->saida(" $Cod_Btn</TD>\r\n");
 } 
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['mostra_edit'] != "N"){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  NOWRAP align=\"center\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px;\"><tr><td style=\"padding: 0px\"><img id=\"b_open_emb_list_project_inregional_linha_" . $this->NM_cont_emb_linha . "\" style=\"display:''\" onclick=\"document.getElementById('b_open_emb_list_project_inregional_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; document.getElementById('b_close_emb_list_project_inregional_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; document.getElementById('emb_list_project_inregional_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">\r\n");
          $nm_saida->saida("<img id=\"b_close_emb_list_project_inregional_linha_" . $this->NM_cont_emb_linha . "\" style=\"display:none\" onclick=\"document.getElementById('b_close_emb_list_project_inregional_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; document.getElementById('b_open_emb_list_project_inregional_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; document.getElementById('emb_list_project_inregional_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">\r\n");
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida_pdf'] != "pdf"){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  NOWRAP align=\"center\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\"><img id=\"b_open_emb_list_project_inregional_linha_" . $this->NM_cont_emb_linha . "\" style=\"display:''\" onclick=\"document.getElementById('b_open_emb_list_project_inregional_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; document.getElementById('b_close_emb_list_project_inregional_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; document.getElementById('emb_list_project_inregional_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">\r\n");
          $nm_saida->saida("<img id=\"b_close_emb_list_project_inregional_linha_" . $this->NM_cont_emb_linha . "\" style=\"display:none\" onclick=\"document.getElementById('b_close_emb_list_project_inregional_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; document.getElementById('b_open_emb_list_project_inregional_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; document.getElementById('emb_list_project_inregional_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">\r\n");
          $nm_saida->saida("</TD>\r\n");
 } 
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] || ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['exibe_seq'] == "S")) { 
          ...
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['field_order'] as $Cada_col)
          { 
          ...
          { 
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida_pdf'] != "pdf")
              { 
                  $nm_saida->saida("<TR  class=\"" . $this->css_line_back . "\" id=\"emb_list_project_inregional_linha_" . $this->NM_cont_emb_linha . "\"  style=\"display:none\">\r\n");
              } 
              else 
              { 
                  $nm_saida->saida("<TR  class=\"" . $this->css_line_back . "\" id=\"emb_list_project_inregional_linha_" . $this->NM_cont_emb_linha . "\"  style=\"display:''\">\r\n");
              } 
          ...
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf" && empty($this->nm_grid_sem_reg) && 
       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print") 
   { 
       $nm_saida->saida("</TABLE></TD>\r\n");
       $nm_saida->saida("<TD style=\"padding: 0px; border-width: 0px;\" valign=\"top\" width=1>\r\n");
 ...
 if (!$this->Ini->SC_Link_View && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf" && $_SESSION['scriptcase']['contr_link_emb'] != "pdf" && $conteudo != "&nbsp;"){ $this->Ind_lig_mult++;
       if (isset($this->Ini->sc_lig_md5["progressproject"]) && $this->Ini->sc_lig_md5["progressproject"] == "S") {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['dashboard_info']['under_dashboard'] && isset($this->Ini->sc_lig_target['C_@scinf_tp_prosentase']))
           {
               if ('' != $Parms_Lig)
               {
                   $Parms_Lig .= '*scout';
               }
               $Parms_Lig .= 'under_dashboard*scin1*scoutdashboard_app*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['dashboard_info']['dashboard_app'] . '*scoutown_widget*scin' . $this->Ini->sc_lig_target['C_@scinf_tp_prosentase'] . '*scoutparent_widget*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['dashboard_info']['own_widget'] . '*scoutcompact_mode*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['dashboard_info']['compact_mode'] ? '1' : '0');
           }
           $Md5_Lig    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@list_project_inregional@SC_par@" . md5($Parms_Lig);
           $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
       } else {
 ...
 function NM_grid_detaiil()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_detaiil_grid_line . "\"  style=\"" . $this->Css_Cmp['css_detaiil_grid_line'] . "\"  align=\"\" valign=\"\"  >\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_resume_detailproject']['embutida_treeview'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida_pdf'] != "pdf")
          { 
              $link_div = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_resume_detailproject']['embutida'] = true;
          if (method_exists($this->v_resume_detailproject, "controle") && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida_pdf'] != "pdf")
          {
          ...
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'])
              { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['emb_lig_aba'] = array_merge($this->Ini->Init_apl_lig, $_SESSION['sc_session'][$this->Ini->sc_page]['v_resume_detailproject']['emb_lig_aba']);
              }
              else 
              { 
 ...
 function NM_calc_span()
 {
   ...
   {
       $this->NM_colspan--;
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['exibe_seq'] != "S" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
       {
           $this->NM_colspan--; 
       }
   } 
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "list_project_inregional/list_project_inregional_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnSelCamposShow('" . $this->Ini->path_link . "list_project_inregional/list_project_inregional_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['SC_Ind_Groupby'] != "sc_free_total")
        {
          ...
          if (is_file("list_project_inregional_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("list_project_inregional_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['dashboard_info']['under_dashboard']))
      {
      ...
      $nm_saida->saida("        </tr> \r\n");
      $nm_saida->saida("       </table> \r\n");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ajax_nav'] && $this->force_toolbar)
      { 
   ...
   function nmgp_barra_bot_normal()
   {
      ...
      $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"left\" width=\"33%\"> \r\n");
          ...
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_lin_grid'];
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_lin_grid'] == 10) ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_lin_grid'] == 20) ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_lin_grid'] == 50) ? " selected" : "";
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opc_liga']['nav']))
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_avanca", "nm_gp_submit_rec('" . $this->Rec_fim . "')", "nm_gp_submit_rec('" . $this->Rec_fim . "')", "forward_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opc_liga']['nav']))
          {
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf" &&
        $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao_print'] != "print" && !$this->Print_All) 
   { 
      $nm_saida->saida("     <tr><td colspan=3  class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\"> \r\n");
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_B_list_project_inregional\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_B_list_project_inregional\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
      $nm_saida->saida("     </td></tr> \r\n");
   } 
   $nm_saida->saida("   </TABLE>\r\n");
   $nm_saida->saida("   </div>\r\n");
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           if ($this->arr_buttons['bcons_avanca']['type'] != 'image')
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
   ...
   {
       $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
       $nm_saida->saida("      parent.scAjaxDetailHeight('list_project_inregional', $(document).innerHeight());\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
 }
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"list_project_inregional\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"list_project_inregional_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . NM_encode_input(session_id()) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['sc_modal']) || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['dashboard_info']['under_dashboard'])) {
   ...
   $nm_saida->saida("      {\r\n");
   $nm_saida->saida("          NM_ancor_ult_lig = ancor;\r\n");
   $nm_saida->saida("          par_modal = '?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&nmgp_outra_jan=true&nmgp_url_saida=modal&SC_lig_apl_orig=list_project_inregional';\r\n");
   $nm_saida->saida("          if (opc != null && opc != '') \r\n");
   $nm_saida->saida("          {\r\n");
   ...
   $nm_saida->saida("          return;\r\n");
   $nm_saida->saida("      }\r\n");
   $nm_saida->saida("      if (pos == \"A\") {obj = document.getElementById('nmsc_iframe_liga_A_list_project_inregional');} \r\n");
   $nm_saida->saida("      if (pos == \"B\") {obj = document.getElementById('nmsc_iframe_liga_B_list_project_inregional');} \r\n");
   $nm_saida->saida("      if (pos == \"E\") {obj = document.getElementById('nmsc_iframe_liga_E_list_project_inregional');} \r\n");
   $nm_saida->saida("      if (pos == \"D\") {obj = document.getElementById('nmsc_iframe_liga_D_list_project_inregional');} \r\n");
   ...
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['list_project_inregional_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@list_project_inregional@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   $nm_saida->saida("       if (\"pdf\" == x)\r\n");
   $nm_saida->saida("       {\r\n");
   $nm_saida->saida("           window.location = \"" . $this->Ini->path_link . "list_project_inregional/list_project_inregional_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_create_charts=\" + crt + \"&sc_graf_pdf=\" + g;\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['list_project_inregional']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Doc = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Doc = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Doc = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"list_project_inregional_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['reg_start']))
   {
       $nm_saida->saida("      parent.scAjaxDetailStatus('list_project_inregional');\r\n");
       $nm_saida->saida("      parent.scAjaxDetailHeight('list_project_inregional', $(document).innerHeight());\r\n");
   }
   $nm_saida->saida("   </script>\r\n");
 }
