...
class list_project_inregional_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      ...
      if ($this->NM_ajax_opcao == 'autocomp_tp_idlop')
      {
          $tp_idlop = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_tp_idlop($tp_idlop);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_tp_id')
      {
          $tp_id = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_tp_id($tp_id);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_tp_idlop($tp_idlop)
   {
      $tp_idlop = substr($this->Db->qstr($tp_idlop), 1, -1);
            $tp_idlop_look = substr($this->Db->qstr($tp_idlop), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct TP_IDLOP from " . $this->Ini->nm_tabela . " where TP_DIVRE='" . $_SESSION['iddivre'] . "' and  TP_IDLOP like '%" . $tp_idlop . "%' order by TP_IDLOP"; 
   ...
   function lookup_ajax_tp_id($tp_id)
   {
      $tp_id = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $tp_id);
      $tp_id = substr($this->Db->qstr($tp_id), 1, -1);
            $tp_id_look = substr($this->Db->qstr($tp_id), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct TP_ID from " . $this->Ini->nm_tabela . " where TP_DIVRE='" . $_SESSION['iddivre'] . "' and   CAST (TP_ID AS TEXT)  like '%" . $tp_id . "%' order by TP_ID"; 
      }
      else
      {
          $nm_comando = "select distinct TP_ID from " . $this->Ini->nm_tabela . " where TP_DIVRE='" . $_SESSION['iddivre'] . "' and  TP_ID like '%" . $tp_id . "%' order by TP_ID"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   { 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_datel'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_datel'][] = trim($rs->fields[0]);
            $cmp1 = NM_charset_to_utf8(trim($rs->fields[0]));
   ...
   { 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_sto'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_sto'][] = trim($rs->fields[0]);
            $cmp1 = NM_charset_to_utf8(trim($rs->fields[0]));
            $cmp2 = NM_charset_to_utf8(trim($rs->fields[1]));
            $nmgp_def_dados[] = array($cmp1 . "##@@" . $cmp2 => $cmp2); 
            $rs->MoveNext() ; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Resume Project Detail Divre : </TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>list_project_inregional/list_project_inregional_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="list_project_inregional_ajax_search.js"></script>
 <script type="text/javascript" src="list_project_inregional_ajax.js"></script>
 <script type="text/javascript">
   ...
   $("#id_ac_tp_id").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_tp_id",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_tp_id").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_tp_id").val( $(this).val() );
       }
     }
   });
   $("#id_ac_tp_idlop").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_tp_idlop",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_tp_idlop").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_tp_idlop").val( $(this).val() );
       }
     }
   });
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<TR align="center">
 <TD colspan="3">
     <table  style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%" cellpadding="0" cellspacing="0">
       <tr valign="middle">
         <td align="left" ><span class="scFilterHeaderFont"> Resume Project Detail Divre : <?php echo $_SESSION['kodedivre'] ?> </span></td>
         <td style="font-size: 5px">&nbsp; &nbsp; </td>
         <td align="center" ><span class="scFilterHeaderFont">  </span></td>
         <td style="font-size: 5px">&nbsp; &nbsp; </td>
         <td align="right" ><span class="scFilterHeaderFont"> <?php echo $nm_data_fixa; ?> &nbsp;&nbsp;</span></td>
...
<?php
   ...
   {
      global 
             $tp_idlop_cond, $tp_idlop, $tp_idlop_autocomp,
             ...
             $tp_id_cond, $tp_id, $tp_id_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $tp_idlop = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_idlop']; 
          $tp_idlop_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_idlop_cond']; 
          $tp_thn_release = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_thn_release']; 
          $tp_thn_release_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_thn_release_cond']; 
          $tp_prjtrelease = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_prjtrelease']; 
          $tp_prjtrelease_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_prjtrelease_cond']; 
          $tp_batch = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_batch']; 
          $tp_batch_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_batch_cond']; 
          $tp_mitra = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_mitra']; 
          $tp_mitra_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_mitra_cond']; 
          $tp_status = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_status']; 
          $tp_status_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_status_cond']; 
          $tp_jenisproject = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_jenisproject']; 
          $tp_jenisproject_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_jenisproject_cond']; 
          $tp_id = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_id']; 
          $tp_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_id_cond']; 
          $tp_witel = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_witel']; 
          $tp_witel_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_witel_cond']; 
          $tp_datel = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_datel']; 
          $tp_datel_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_datel_cond']; 
          $tp_sto = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_sto']; 
          $tp_sto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_sto_cond']; 
          $tp_projectname = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_projectname']; 
          $tp_projectname_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_projectname_cond']; 
          $tp_planstart_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planstart_dia']; 
          $tp_planstart_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planstart_mes']; 
          $tp_planstart_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planstart_ano']; 
          $tp_planstart_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planstart_input_2_dia']; 
          $tp_planstart_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planstart_input_2_mes']; 
          $tp_planstart_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planstart_input_2_ano']; 
          $tp_planstart_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planstart_cond']; 
          $tp_planfinish_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planfinish_dia']; 
          $tp_planfinish_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planfinish_mes']; 
          $tp_planfinish_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planfinish_ano']; 
          $tp_planfinish_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planfinish_input_2_dia']; 
          $tp_planfinish_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planfinish_input_2_mes']; 
          $tp_planfinish_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planfinish_input_2_ano']; 
          $tp_planfinish_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planfinish_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['NM_operador']; 
      } 
      if (!isset($tp_idlop_cond) || empty($tp_idlop_cond))
      {
         $tp_idlop_cond = "qp";
      }
      ...
      if (!isset($tp_id_cond) || empty($tp_id_cond))
      {
         $tp_id_cond = "eq";
      }
      ...
      $str_hide_tp_idlop = (in_array($tp_idlop_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_hide_tp_id = (in_array($tp_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($tp_idlop) || $tp_idlop == "")
      {
          $tp_idlop = "";
      }
      if (isset($tp_idlop) && !empty($tp_idlop))
      {
         $tmp_pos = strpos($tp_idlop, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $tp_idlop = substr($tp_idlop, 0, $tmp_pos);
         }
      }
      ...
      if (isset($tp_id) && !empty($tp_id))
      {
         $tmp_pos = strpos($tp_id, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $tp_id = substr($tp_id, 0, $tmp_pos);
         }
      }
    ...
    <TR>
     <TD colspan="1" height="20" class="scFilterBlockBack">
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
       <TR>
        <TD class="scFilterBlockFont css_blk_0"><?php echo $Img_tit_blk_i ?>View Filter<?php echo $Img_tit_blk_f ?></TD>
      ...
      <INPUT type="hidden" id="SC_tp_idlop_cond" name="tp_idlop_cond" value="qp">

    <TD nowrap class="scFilterLabelOdd" > <?php
 $SC_Label = (isset($this->New_label['tp_idlop'])) ? $this->New_label['tp_idlop'] : "ID LOP";
 $nmgp_tab_label .= "tp_idlop?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_tp_idlop"  <?php echo $str_hide_tp_idlop?>><?php
      if ($tp_idlop != "")
      {
      $tp_idlop_look = substr($this->Db->qstr($tp_idlop), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct TP_IDLOP from " . $this->Ini->nm_tabela . " where TP_DIVRE='" . $_SESSION['iddivre'] . "' and TP_IDLOP = '$tp_idlop_look' order by TP_IDLOP"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$tp_idlop]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$tp_idlop];
      }
      else
      {
          $sAutocompValue = $tp_idlop;
      }
?>
<INPUT  type="text" id="SC_tp_idlop" name="tp_idlop" value="<?php echo NM_encode_input($tp_idlop) ?>" size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: true}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_tp_idlop" name="tp_idlop_autocomp" size="20" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: true}">
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_tp_thn_release"  <?php echo $str_hide_tp_thn_release?>>
<?php
      $tp_thn_release_look = substr($this->Db->qstr($tp_thn_release), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT TMT_TAHUN  FROM TBL_MAS_TAHUN  ORDER BY TMT_ENTRYDATE"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_thn_release'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_thn_release'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_tp_thn_release">
      <SELECT class="scFilterObjectEven" id="SC_tp_thn_release" name="tp_thn_release"  size="1">
       <OPTION value=""></OPTION>
<?php
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_prjtrelease'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_prjtrelease'][] = trim($rs->fields[0]);
...
?>
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_tp_batch"  <?php echo $str_hide_tp_batch?>>
<?php
      $tp_batch_look = substr($this->Db->qstr($tp_batch), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT KODESP  FROM TBL_BATCH  ORDER BY KODESP"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_batch'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_batch'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
<?php
   ...
   if (is_numeric($tp_witel))
   { 
      $nm_comando = "SELECT TM_IDMITRA, TM_NAMAMITRA  FROM TBL_MITRA  WHERE TM_DIVRE=" . $_SESSION['iddivre'] . " AND TM_WITEL=$tp_witel  ORDER BY TM_NAMAMITRA"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_mitra'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_mitra'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_status'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_status'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_tp_status">
      <SELECT class="scFilterObjectEven" id="SC_tp_status" name="tp_status"  size="1">
       <OPTION value=""></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_jenisproject'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_jenisproject'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
    ...
    <TR>
     <TD colspan="1" height="20" class="scFilterBlockBack">
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
       <TR>
        <TD class="scFilterBlockFont css_blk_1"><?php echo $Img_tit_blk_i ?>Others<?php echo $Img_tit_blk_f ?></TD>
      ...
      <INPUT type="hidden" id="SC_tp_id_cond" name="tp_id_cond" value="eq">

    <TD nowrap class="scFilterLabelOdd" > <?php
 $SC_Label = (isset($this->New_label['tp_id'])) ? $this->New_label['tp_id'] : "ID";
 $nmgp_tab_label .= "tp_id?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_tp_id"  <?php echo $str_hide_tp_id?>><?php
      if ($tp_id != "")
      {
      $tp_id_look = substr($this->Db->qstr($tp_id), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct TP_ID from " . $this->Ini->nm_tabela . " where TP_DIVRE='" . $_SESSION['iddivre'] . "' and TP_ID = $tp_id_look order by TP_ID"; 
      }
      else
      {
          $nm_comando = "select distinct TP_ID from " . $this->Ini->nm_tabela . " where TP_DIVRE='" . $_SESSION['iddivre'] . "' and TP_ID = $tp_id_look order by TP_ID"; 
      ...
      if (isset($nmgp_def_dados[0][$tp_id]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$tp_id];
      }
      else
      {
            nmgp_Form_Num_Val($tp_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $tp_id;
      }
?>
<INPUT  type="text" id="SC_tp_id" name="tp_id" value="<?php echo NM_encode_input($tp_id) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: true}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_tp_id" name="tp_id_autocomp" size="10" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: true}">
...
<?php
      ...
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT MW_IDWITEL, MW_NAMAWITEL  FROM TBL_MAS_WITEL   WHERE MW_IDDIVRE='" . $_SESSION['iddivre'] . "'  ORDER BY MW_NAMAWITEL"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_witel'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_witel'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_tp_sto">
      <SELECT class="scFilterObjectEven" id="SC_tp_sto" name="tp_sto"  size="1">
       <OPTION value=""></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
...
?>
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_tp_projectname"  <?php echo $str_hide_tp_projectname?>><?php
      if ($tp_projectname != "")
      {
      $tp_projectname_look = substr($this->Db->qstr($tp_projectname), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<INPUT  type="text" id="SC_tp_projectname" name="tp_projectname" value="<?php echo NM_encode_input($tp_projectname) ?>" size=20 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: true}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_tp_projectname" name="tp_projectname_autocomp" size="20" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: true}">
...
<?php echo $SC_Label ?><br>
      <SELECT class="sc-js-input scFilterObjectEven" alt="{autoTab: false, enterTab: true}" id="SC_tp_planstart_cond" name="tp_planstart_cond" onChange="nm_campos_between(document.getElementById('id_vis_tp_planstart'), this, 'tp_planstart')">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tp_planstart_dia" name="tp_planstart_dia" value="<?php echo NM_encode_input($tp_planstart_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tp_planstart_mes" name="tp_planstart_mes" value="<?php echo NM_encode_input($tp_planstart_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tp_planstart_ano" name="tp_planstart_ano" value="<?php echo NM_encode_input($tp_planstart_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: true}">
...
?>
        <SPAN id="id_vis_tp_planstart"  <?php echo $str_display_tp_planstart; ?> class="scFilterFieldFontEven">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tp_planstart_input_2_dia" name="tp_planstart_input_2_dia" value="<?php echo NM_encode_input($tp_planstart_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tp_planstart_input_2_mes" name="tp_planstart_input_2_mes" value="<?php echo NM_encode_input($tp_planstart_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tp_planstart_input_2_ano" name="tp_planstart_input_2_ano" value="<?php echo NM_encode_input($tp_planstart_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: true}">
...
?>
                 ...
                 <SPAN id="id_css_tp_planstart" class="scFilterFieldFontEven">
...
?>
<?php echo $SC_Label ?><br>
      <SELECT class="sc-js-input scFilterObjectOdd" alt="{autoTab: false, enterTab: true}" id="SC_tp_planfinish_cond" name="tp_planfinish_cond" onChange="nm_campos_between(document.getElementById('id_vis_tp_planfinish'), this, 'tp_planfinish')">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_tp_planfinish_dia" name="tp_planfinish_dia" value="<?php echo NM_encode_input($tp_planfinish_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_tp_planfinish_mes" name="tp_planfinish_mes" value="<?php echo NM_encode_input($tp_planfinish_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_tp_planfinish_ano" name="tp_planfinish_ano" value="<?php echo NM_encode_input($tp_planfinish_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: true}">
...
?>
        <SPAN id="id_vis_tp_planfinish"  <?php echo $str_display_tp_planfinish; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?> 
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_tp_planfinish_input_2_dia" name="tp_planfinish_input_2_dia" value="<?php echo NM_encode_input($tp_planfinish_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_tp_planfinish_input_2_mes" name="tp_planfinish_input_2_mes" value="<?php echo NM_encode_input($tp_planfinish_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_tp_planfinish_input_2_ano" name="tp_planfinish_input_2_ano" value="<?php echo NM_encode_input($tp_planfinish_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: true}">
...
?>
<?php
   if (is_file("list_project_inregional_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opc_psq'])
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['orig_pesq'] == "grid")
   {
...
<SCRIPT type="text/javascript">
 ...
 {
   document.F1.reset();
   nm_campos_between(document.getElementById('id_vis_tp_idlop'), document.F1.tp_idlop_cond, 'tp_idlop');
   document.F1.tp_idlop.value = "";
   document.F1.tp_idlop_autocomp.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_tp_id'), document.F1.tp_id_cond, 'tp_id');
   document.F1.tp_id.value = "";
   document.F1.tp_id_autocomp.value = "";
   ...
   document.F1.tp_planfinish_input_2_ano.value = "";
         ...
         function nm_display_calendar_tp_planstart(sField)
         {
             ...
             sValue   += document.F1.elements[sField_d].value;
             tb_show('', '<?php echo $this->Ini->path_link; ?>list_project_inregional/list_project_inregional.php?nm_cal_display=Y&field=' + sField + '&value=' + sValue + '&inter=10&week_ini=<?php echo $_SESSION['scriptcase']['reg_conf']['date_week_ini']; ?>&Orig=pesq&Seq=0&script_case_init=<?php  echo NM_encode_input($this->Ini->sc_page); ?>&script_case_session=<?php  echo session_id(); ?>&TB_iframe=true&height=150&width=220&modal=true', '');
         }
 ...
 {
    $('#SC_tp_planfinish_dia').bind('change', function() {sc_list_project_inregional_valida_dia(this)});
    $('#SC_tp_planfinish_input_2_dia').bind('change', function() {sc_list_project_inregional_valida_dia(this)});
    $('#SC_tp_planfinish_input_2_mes').bind('change', function() {sc_list_project_inregional_valida_mes(this)});
    $('#SC_tp_planfinish_mes').bind('change', function() {sc_list_project_inregional_valida_mes(this)});
    $('#SC_tp_planstart_dia').bind('change', function() {sc_list_project_inregional_valida_dia(this)});
    $('#SC_tp_planstart_input_2_dia').bind('change', function() {sc_list_project_inregional_valida_dia(this)});
    $('#SC_tp_planstart_input_2_mes').bind('change', function() {sc_list_project_inregional_valida_mes(this)});
    $('#SC_tp_planstart_mes').bind('change', function() {sc_list_project_inregional_valida_mes(this)});
 }
 function sc_list_project_inregional_valida_dia(obj)
 {
 ...
 function sc_list_project_inregional_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "projectamo/list_project_inregional";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   {
      global $tp_idlop_cond, $tp_idlop, $tp_idlop_autocomp,
             $tp_thn_release_cond, $tp_thn_release,
             $tp_prjtrelease_cond, $tp_prjtrelease,
             $tp_batch_cond, $tp_batch,
             $tp_mitra_cond, $tp_mitra,
      ...
      if (!empty($tp_idlop_autocomp) && empty($tp_idlop))
      {
          $tp_idlop = $tp_idlop_autocomp;
      }
      if (!empty($tp_id_autocomp) && empty($tp_id))
      {
          $tp_id = $tp_id_autocomp;
      }
      if (!empty($tp_projectname_autocomp) && empty($tp_projectname))
      {
          $tp_projectname = $tp_projectname_autocomp;
      }
      $tp_idlop_cond_salva = $tp_idlop_cond; 
      if (!isset($tp_idlop_input_2) || $tp_idlop_input_2 == "")
      {
          $tp_idlop_input_2 = $tp_idlop;
      }
      ...
      $tp_id_cond_salva = $tp_id_cond; 
      if (!isset($tp_id_input_2) || $tp_id_input_2 == "")
      {
          $tp_id_input_2 = $tp_id;
      }
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_thn_release'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Release Project : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($tp_prjtrelease, "##@@");
      if ($tmp_pos === false) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_prjtrelease'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Sub-Release : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($tp_batch, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $tp_batch;
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_batch'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_mitra'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_status'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_jenisproject'])) {
      ...
      if ($tp_id_cond != "in")
      {
          nm_limpa_numero($tp_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $tp_id);
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_witel'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Witel : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($tp_datel, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $tp_datel;
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_datel'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['psq_check_ret']['tp_sto'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "STO : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_idlop'] = $tp_idlop; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_idlop_cond'] = $tp_idlop_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_thn_release'] = $tp_thn_release; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_thn_release_cond'] = $tp_thn_release_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_prjtrelease'] = $tp_prjtrelease; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_prjtrelease_cond'] = $tp_prjtrelease_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_batch'] = $tp_batch; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_batch_cond'] = $tp_batch_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_mitra'] = $tp_mitra; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_mitra_cond'] = $tp_mitra_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_status'] = $tp_status; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_status_cond'] = $tp_status_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_jenisproject'] = $tp_jenisproject; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_jenisproject_cond'] = $tp_jenisproject_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_id'] = $tp_id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_id_cond'] = $tp_id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_witel'] = $tp_witel; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_witel_cond'] = $tp_witel_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_datel'] = $tp_datel; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_datel_cond'] = $tp_datel_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_sto'] = $tp_sto; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_sto_cond'] = $tp_sto_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_projectname'] = $tp_projectname; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_projectname_cond'] = $tp_projectname_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planstart_dia'] = $tp_planstart_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planstart_mes'] = $tp_planstart_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planstart_ano'] = $tp_planstart_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planstart_input_2_dia'] = $tp_planstart_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planstart_input_2_mes'] = $tp_planstart_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planstart_input_2_ano'] = $tp_planstart_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planstart_cond'] = $tp_planstart_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planfinish_dia'] = $tp_planfinish_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planfinish_mes'] = $tp_planfinish_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planfinish_ano'] = $tp_planfinish_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planfinish_input_2_dia'] = $tp_planfinish_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planfinish_input_2_mes'] = $tp_planfinish_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planfinish_input_2_ano'] = $tp_planfinish_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planfinish_cond'] = $tp_planfinish_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($tp_id_cond != "in" && $tp_id_cond != "bw" && !empty($tp_id) && !is_numeric($tp_id))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : ID";
      }
      if ($tp_id_cond == "bw" && ((!empty($tp_id) && !is_numeric($tp_id)) || (!empty($tp_id_input_2) && !is_numeric($tp_id_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : ID";
      }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['tp_idlop'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['tp_idlop'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['tp_idlop'] = $tp_idlop;
      }
   ...
   { 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['tp_id'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['tp_id'] = $tp_id;
      }
      $Conteudo = $tp_witel;
      if (strpos($Conteudo, "##@@") !== false)
      {
      ...
      if (isset($tp_idlop) || $tp_idlop_cond == "nu" || $tp_idlop_cond == "nn" || $tp_idlop_cond == "ep" || $tp_idlop_cond == "ne")
      {
         $this->monta_condicao("TP_IDLOP", $tp_idlop_cond, $tp_idlop, "", "tp_idlop");
      }
      ...
      //----- $tp_id
      $this->Date_part = false;
      if (isset($tp_id) || $tp_id_cond == "nu" || $tp_id_cond == "nn" || $tp_id_cond == "ep" || $tp_id_cond == "ne")
      {
         $this->monta_condicao("TP_ID", $tp_id_cond, $tp_id, "", "tp_id");
      }
      ...
      if ($tp_planstart_cond != "TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planstart'] = $val[0];
          ...
          if ($tp_planstart_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planstart_input_2'] = $val[1];
      ...
      if ($tp_planfinish_cond != "TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planfinish'] = $val[0];
          ...
          if ($tp_planfinish_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']['tp_planfinish_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['contr_array_resumo'] = "NAO";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['where_pesq_ant'] = $this->comando . $this->comando_fim;
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['list_project_inregional']['fast_search']);
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "tp_thn_release" : return ('class="scFilterObjectEven"'); break;
         ...
         case "tp_status" : return ('class="scFilterObjectEven"'); break;
         ...
         case "tp_sto" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
