...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["projectamo_____list_project_inwitel"]))
   {
      unset($_SESSION['session_sec_aplicacao']["projectamo_____list_project_inwitel"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['list_project_inwitel']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['list_project_inwitel']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['list_project_inwitel']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['list_project_inwitel']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['list_project_inwitel']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>list_project_inwitel</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['list_project_inwitel']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['list_project_inwitel']['embutida_filho'] as $ind => $sc_init)
          {
