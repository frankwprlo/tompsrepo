...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_tp_idlop" name="tp_idlop_autocomp" size="20" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: true}">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_tp_id" name="tp_id_autocomp" size="10" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: true}">
