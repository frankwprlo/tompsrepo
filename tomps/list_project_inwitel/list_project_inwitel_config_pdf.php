 ...
 */
    ...
    session_start();
    $SC_apl_proc = "list_project_inwitel";
...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['list_project_inwitel']['show_skip_charts_option']) || !$_SESSION['sc_session']['list_project_inwitel']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
