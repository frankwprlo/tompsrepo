...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate links
  function do_ajax_app_Login_mob_validate_links()
  {
    var nomeCampo_links = "links";
    var var_links = scAjaxGetFieldText(nomeCampo_links);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_mob_validate_links(var_links, var_script_case_init, do_ajax_app_Login_mob_validate_links_cb);
  } // do_ajax_app_Login_mob_validate_links

  function do_ajax_app_Login_mob_validate_links_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "links";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_mob_validate_links_cb
  // ---------- Form
  function do_ajax_app_Login_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_Login_mob_submit_form(var_login, var_pswd, var_links, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_captcha_code, var_csrf_token, do_ajax_app_Login_mob_submit_form_cb);
