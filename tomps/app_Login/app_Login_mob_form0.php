...
<table width="100%" height="67px" class="scFormHeader">
        <tr>
                <td width="5px"></td>
        <td width="67px" class="scFormHeaderFont"><IMG SRC="<?php echo $this->Ini->path_imag_cab ?>/sys__NM__img__NM__lock.png" BORDER="0"/></td>
               <td class="scFormHeaderFont"><span id="lin1_col1"><?php if ($this->nmgp_opcao == "novo") { echo ""; } else { echo "Login"; } ?></span><br /><span id="lin2_col1"></span></td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_login_line" id="hidden_field_data_login" style="<?php echo $sStyleHidden_login; ?>"> <span class="scFormLabelOddFormat css_login_label"><span id="id_label_login"><?php echo $this->nm_new_label['login']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['php_cmp_required']['login']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['php_cmp_required']['login'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<span id="id_read_on_login" class="sc-ui-readonly-login css_login_line" style="<?php echo $sStyleReadLab_login; ?>"><?php echo $this->form_encode_input($this->login); ?></span><span id="id_read_off_login" style="white-space: nowrap;<?php echo $sStyleReadInp_login; ?>">
 ...
 size=10 maxlength=60 alt="{datatype: 'text', maxLength: 60, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: true, autoTab: false, selectOnFocus: false, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pswd_line" id="hidden_field_data_pswd" style="<?php echo $sStyleHidden_pswd; ?>"> <span class="scFormLabelOddFormat css_pswd_label"><span id="id_label_pswd"><?php echo $this->nm_new_label['pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['php_cmp_required']['pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['php_cmp_required']['pswd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<span id="id_read_on_pswd" class="sc-ui-readonly-pswd css_pswd_line" style="<?php echo $sStyleReadLab_pswd; ?>"><?php echo $this->form_encode_input($this->pswd); ?></span><span id="id_read_off_pswd" style="white-space: nowrap;<?php echo $sStyleReadInp_pswd; ?>"><input class="sc-js-input scFormObjectOdd css_pswd_obj" style="" id="id_sc_field_pswd" type=password name="pswd" value="" 
 size=10 maxlength=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: true, autoTab: false, selectOnFocus: false, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
 </TD>
   <?php }?>
...
<input type="hidden" name="links_sc_target_name" value = "">
 ...
 <a href="javascript:nm_menu_link_links('app_form_add_users', '_self')" class="scFormLinkOdd"><?php echo $this->Ini->Nm_lang['lang_new_user'] ?></a>
<br>

 <a href="javascript:nm_menu_link_links('app_retrieve_pswd', '_self')" class="scFormLinkOdd"><?php echo $this->Ini->Nm_lang['lang_subject_mail'] ?></a>
<?php  } ?>
 </TD>
   <?php }?>
...
function captchaReloadImage() {
 ...
 document.getElementById("id_captcha_img").src = "app_Login_mob_captcha_show.php?sid=" + sRand;
}
</script>
<table style="border-collapse: collapse; border-width: 0px">
 ...
 ?>
<img id="id_captcha_img" src="app_Login_mob_captcha_show.php?sid=<?php echo md5(uniqid(time())); ?>" /></td><td><?php echo nmButtonOutput($this->arr_buttons, "bcaptchareload", "captchaReloadImage()", "captchaReloadImage()", "id_captcha_reload", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
</td></tr></table></td>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bok", "nm_atualiza('alterar');", "nm_atualiza('alterar');", "sub_form_b", "", " Login ", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<div style="width: 100%; height:20px;" class="scFormFooter">
        <span class="scFormFooterFont" id="rod_col1"><?php echo "Silahkan Login !" ?></span>
