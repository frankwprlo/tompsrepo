...
//
   ...
   $_SESSION['scriptcase']['app_Login']['glo_nm_perfil']          = "conn_mysql_1";
   $_SESSION['scriptcase']['app_Login']['glo_nm_path_prod']       = "/libdemo/prod";
   $_SESSION['scriptcase']['app_Login']['glo_nm_path_imagens']    = "/libdemo/file/img";
   $_SESSION['scriptcase']['app_Login']['glo_nm_path_imag_temp']  = "/libdemo/tmp";
   $_SESSION['scriptcase']['app_Login']['glo_nm_path_doc']        = "/var/www/html/tompsdemo";
//
class app_Login_ini
{
   var $nm_cod_apl;
      ...
      if (isset($_SESSION['scriptcase']['user_logout']))
      {
          foreach ($_SESSION['scriptcase']['user_logout'] as $ind => $parms)
          {
              if (isset($_SESSION[$parms['V']]) && $_SESSION[$parms['V']] == $parms['U'])
              {
                  ...
                  {
                      $inicial_app_Login->contr_->NM_ajax_info['redir']['action']  = $nm_apl_dest;
                      ...
                      $inicial_app_Login->contr_app_Login->NM_ajax_info['redir']['script_case_session']  = session_id();
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'projectamo'); 
      } 
      else 
      { 
...
//
    ...
    else
    {
        ...
        if (isset($_POST["user_group"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['user_group']);
        }
        ...
        if (isset($_POST["priv_mitra"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['priv_mitra']);
        }
        ...
        if (isset($_POST["groups"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['groups']);
        }
        ...
        if (isset($_POST["iddivre"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['iddivre']);
        }
        ...
        if (isset($_POST["idwitel"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['idwitel']);
        }
        ...
        if (isset($_POST["usr_priv_lokasi"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['usr_priv_lokasi']);
        }
        ...
        if (isset($_POST["groupsname"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['groupsname']);
        }
        ...
        if (isset($_POST["kodewitel"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['kodewitel']);
        }
        ...
        if (isset($_POST["kodedivre"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['kodedivre']);
        }
        ...
        elseif ($_SESSION['sc_session'][$script_case_init]['app_Login']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['app_Login']['run_iframe'] != "R")
        {
           ...
           $nm_url_saida = str_replace("_fim.php", ".php", $nm_url_saida); 
            ...
            {
                $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['app_Login']['retorno_edit'] . "?script_case_init=" . $script_case_init . "&script_case_session=" . session_id();  
                $nm_apl_dependente = 1 ; 
                $nm_saida_global = $nm_url_saida;
            } 
        ...
        { 
            if (!empty($nmgp_url_saida) && empty($_SESSION['sc_session'][$script_case_init]['app_Login']['retorno_edit'])) 
            {
                $_SESSION['sc_session'][$script_case_init]['app_Login']['retorno_edit'] = $nmgp_url_saida . "?script_case_init=" . $script_case_init . "&script_case_session=" . session_id(); 
            } 
        } 
...
//
    ...
    function ajax_app_Login_submit_form($login, $pswd, $links, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $captcha_code, $csrf_token)
    {
        global $inicial_app_Login;
        //register_shutdown_function("app_Login_pack_ajax_response");
        $inicial_app_Login->contr_app_Login->NM_ajax_flag          = true;
...
//-----
   ...
   {
      global $inicial_app_Login;
      $aResp['ajaxAlert'] = array('message' => $inicial_app_Login->contr_app_Login->NM_ajax_info['ajaxAlert']['message']);
