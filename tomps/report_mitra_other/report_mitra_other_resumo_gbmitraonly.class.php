...
class report_mitra_other_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['contr_total_geral'] == "OK")
      {
          $this->array_total_tm_namamitra = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['arr_total']['tm_namamitra'];
          $this->array_total_tj_namajenis = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['arr_total']['tj_namajenis'];
      }
      else
      {
          $this->array_total_tm_namamitra = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['tot_geral'][2];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['tot_geral'][3];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['tot_geral'][4];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['tot_geral'][5];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['tot_geral'][6];
      $this->array_total_geral[6] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['tot_geral'][7];
      $this->array_total_geral[7] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['tot_geral'][8];
      $this->array_total_geral[8] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['tot_geral'][9];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
...
TestComm",
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['summarizing_fields_order']['gbmitraonly']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['summarizing_fields_order']['gbmitraonly'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['summarizing_fields_order']['gbmitraonly'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['summarizing_fields_display']['gbmitraonly'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['summarizing_fields_display']['gbmitraonly'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['summarizing_fields_display']['gbmitraonly'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['summarizing_fields_display']['gbmitraonly'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['summarizing_fields_display']['gbmitraonly'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['summarizing_fields_display']['gbmitraonly'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['summarizing_fields_display']['gbmitraonly'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@report_mitra_other@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['pivot_order_start'][$iYAxysIndex])
                       {
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "report_mitra_other_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['opcao'] = "print";
      ...
      $this->Total   = new report_mitra_other_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['responsive_chart']['active']) {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_report_mitra_other_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_report_mitra_other_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_report_mitra_other_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['num_css'] . '.css');
     ...
     else
     {
      ...
      $nm_saida->saida(" </style>\r\n");
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "report_mitra_other/report_mitra_other_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("report_mitra_other_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'report_mitra_other_config_pivot.php?nome_apl=report_mitra_other&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_report_mitra_other_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "report_mitra_other/report_mitra_other_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
   ...
   function monta_rodape()
   {
      ...
      $nm_cab_filtro   = ""; 
      $nm_cab_filtrobr = ""; 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['campos_busca']))
      { 
        $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['campos_busca'];
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
   ...
   //---- 
   function adiciona_registro($sum_tp_rab, $sum_tp_nilai, $sum_tp_odp, $avg_prepare, $avg_perijinan, $avg_inst_testcomm, $avg_closing, $avg_pencapaian, $quebra_tm_namamitra, $quebra_tj_namajenis, $quebra_tm_namamitra_orig, $quebra_tj_namajenis_orig)
   {
      //----- Mitra
      if (!isset($this->array_total_tm_namamitra[$quebra_tm_namamitra_orig]))
      {
         ...
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][1] = $sum_tp_rab;
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][2] = $sum_tp_nilai;
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][3] = $sum_tp_odp;
      ...
      if (!isset($this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig]))
      {
         ...
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][1] = $sum_tp_rab;
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][2] = $sum_tp_nilai;
         $this->array_total_tj_namajenis[$quebra_tm_namamitra_orig][$quebra_tj_namajenis_orig][3] = $sum_tp_odp;
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['arr_total']['tm_namamitra'] as $campo_tm_namamitra => $dados_tm_namamitra)
      {
         ...
         $this->array_total_tm_namamitra[$campo_tm_namamitra][4] = $dados_tm_namamitra[3];
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['arr_total']['tj_namajenis'][$campo_tm_namamitra] as $campo_tj_namajenis => $dados_tj_namajenis)
         {
            $this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][2] = $dados_tj_namajenis[1];
            $this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][3] = $dados_tj_namajenis[2];
            $this->array_total_tj_namajenis[$campo_tm_namamitra][$campo_tj_namajenis][4] = $dados_tj_namajenis[3];
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->statusname = $rs_res->fields[6] ;  
            $this->tm_namamitra = $rs_res->fields[7] ;  
            $this->tp_projectname = $rs_res->fields[8] ;  
            $this->tp_rab = $rs_res->fields[9] ;  
            $this->tp_nilai = $rs_res->fields[10] ;  
            $this->tp_lokasi = $rs_res->fields[11] ;  
            $this->tp_odp = $rs_res->fields[12] ;  
            $this->tp_planstart = $rs_res->fields[13] ;  
            $this->tp_planfinish = $rs_res->fields[14] ;  
            $this->tp_summary = $rs_res->fields[15] ;  
            $this->tp_status = $rs_res->fields[16] ;  
            $this->tp_jenisproject = $rs_res->fields[17] ;  
            $this->tp_prjtrelease = $rs_res->fields[18] ;  
            $this->tp_targetwaktu = $rs_res->fields[19] ;  
            $this->tp_batch = $rs_res->fields[20] ;  
            $this->tp_mitra = $rs_res->fields[21] ;  
            $this->tp_witel = $rs_res->fields[22] ;  
            $this->tp_sto = $rs_res->fields[23] ;  
            $this->tp_entrydate = $rs_res->fields[24] ;  
            $this->tp_entryby = $rs_res->fields[25] ;  
            $this->tp_updatedate = $rs_res->fields[26] ;  
            $this->tp_updateby = $rs_res->fields[27] ;  
            $this->tp_actualstart = $rs_res->fields[28] ;  
            $this->tp_actualfinish = $rs_res->fields[29] ;  
            $this->tp_templateproject = $rs_res->fields[30] ;  
            $this->tp_datel = $rs_res->fields[31] ;  
...
$_SESSION['scriptcase']['report_mitra_other']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->tp_rab, $this->tp_nilai, $this->tp_odp, $this->prepare, $this->perijinan, $this->inst_testcomm, $this->closing, $this->pencapaian, $this->tm_namamitra, $this->tj_namajenis, $this->tm_namamitra_orig,  $this->tj_namajenis_orig);
            }
   }
//
...
$_SESSION['scriptcase']['report_mitra_other']['contr_erro'] = 'off';
      ...
      $this->finaliza_arrays();
      $this->rs_grid->Close();
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['tot_geral'][2] = $this->array_total_geral[1];
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['tot_geral'][3] = $this->array_total_geral[2];
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['tot_geral'][4] = $this->array_total_geral[3];
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['tot_geral'][5] = $this->array_total_geral[4];
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['tot_geral'][6] = $this->array_total_geral[5];
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['tot_geral'][7] = $this->array_total_geral[6];
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['tot_geral'][8] = $this->array_total_geral[7];
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['tot_geral'][9] = $this->array_total_geral[8];
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['tot_geral'][1] = $this->array_total_geral[0];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['arr_total']['tm_namamitra'] = $this->array_total_tm_namamitra;
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['arr_total']['tj_namajenis'] = $this->array_total_tj_namajenis;
      }
   }
