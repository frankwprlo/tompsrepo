...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["projectamo_____report_mitra_other"]))
   {
      unset($_SESSION['session_sec_aplicacao']["projectamo_____report_mitra_other"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['report_mitra_other']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['report_mitra_other']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['report_mitra_other']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['report_mitra_other']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['report_mitra_other']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>report_mitra_other</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['report_mitra_other']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['report_mitra_other']['embutida_filho'] as $ind => $sc_init)
          {
