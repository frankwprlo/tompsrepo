...
class report_mitra_other_xls
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= "_report_mitra_other";
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "report_mitra_other.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->tp_batch = $rs->fields[20] ;  
         $this->tp_mitra = $rs->fields[21] ;  
         $this->tp_mitra = (string)$this->tp_mitra;
         $this->tp_witel = $rs->fields[22] ;  
         $this->tp_witel = (string)$this->tp_witel;
         $this->tp_sto = $rs->fields[23] ;  
         $this->tp_sto = (string)$this->tp_sto;
         $this->tp_entrydate = $rs->fields[24] ;  
         $this->tp_entryby = $rs->fields[25] ;  
         $this->tp_updatedate = $rs->fields[26] ;  
         $this->tp_updateby = $rs->fields[27] ;  
         $this->tp_actualstart = $rs->fields[28] ;  
         $this->tp_actualfinish = $rs->fields[29] ;  
         $this->tp_templateproject = $rs->fields[30] ;  
         $this->tp_templateproject = (string)$this->tp_templateproject;
         $this->tp_datel = $rs->fields[31] ;  
...
$_SESSION['scriptcase']['report_mitra_other']['contr_erro'] = 'off'; 
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_mitra_other'][$path_doc_md5][1] = $this->Tit_doc;
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE>Resume Project Detail :: Excel</TITLE>
