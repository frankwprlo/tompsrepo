 ...
 */
    ...
    session_start();
    $SC_apl_proc = "report_mitra_other";
...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['report_mitra_other']['show_skip_charts_option']) || !$_SESSION['sc_session']['report_mitra_other']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
