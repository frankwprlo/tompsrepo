...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate tmt_idtahapan_
  function do_ajax_tahapan_validate_tmt_idtahapan_(iNumLinha)
  {
    var nomeCampo_tmt_idtahapan_ = "tmt_idtahapan_" + iNumLinha;
    var var_tmt_idtahapan_ = scAjaxGetFieldHidden(nomeCampo_tmt_idtahapan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tahapan_validate_tmt_idtahapan_(var_tmt_idtahapan_, iNumLinha, var_script_case_init, do_ajax_tahapan_validate_tmt_idtahapan__cb);
  } // do_ajax_tahapan_validate_tmt_idtahapan_

  function do_ajax_tahapan_validate_tmt_idtahapan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tmt_idtahapan_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tmt_idtahapan_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "tmt_idtahapan_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tmt_idtahapan_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tahapan_validate_tmt_idtahapan__cb

  // ---------- Validate tmt_namatahapan_
  function do_ajax_tahapan_validate_tmt_namatahapan_(iNumLinha)
  {
    var nomeCampo_tmt_namatahapan_ = "tmt_namatahapan_" + iNumLinha;
    var var_tmt_namatahapan_ = scAjaxGetFieldText(nomeCampo_tmt_namatahapan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tahapan_validate_tmt_namatahapan_(var_tmt_namatahapan_, iNumLinha, var_script_case_init, do_ajax_tahapan_validate_tmt_namatahapan__cb);
  } // do_ajax_tahapan_validate_tmt_namatahapan_

  function do_ajax_tahapan_validate_tmt_namatahapan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tmt_namatahapan_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tmt_namatahapan_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tmt_namatahapan_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tmt_namatahapan_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tahapan_validate_tmt_namatahapan__cb

  // ---------- Validate tmt_description_
  function do_ajax_tahapan_validate_tmt_description_(iNumLinha)
  {
    var nomeCampo_tmt_description_ = "tmt_description_" + iNumLinha;
    var var_tmt_description_ = scAjaxGetFieldText(nomeCampo_tmt_description_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tahapan_validate_tmt_description_(var_tmt_description_, iNumLinha, var_script_case_init, do_ajax_tahapan_validate_tmt_description__cb);
  } // do_ajax_tahapan_validate_tmt_description_

  function do_ajax_tahapan_validate_tmt_description__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tmt_description_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tmt_description_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tmt_description_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tmt_description_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tahapan_validate_tmt_description__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_tahapan_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_tahapan_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_tahapan_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_tahapan_add_new_line_cb);
  } // do_ajax_tahapan_add_new_line

  function do_ajax_tahapan_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_tahapan_add_new_line_cb

  // ---------- backup_line
  function do_ajax_tahapan_backup_line(iNumLinha)
  {
    var var_tmt_idtahapan_ = scAjaxGetFieldHidden("tmt_idtahapan_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tahapan_backup_line(var_tmt_idtahapan_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_tahapan_backup_line_cb);
  } // do_ajax_tahapan_backup_line

  function do_ajax_tahapan_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_tahapan_backup_line_cb

  function do_ajax_tahapan_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_tahapan_cancel_insert

  function do_ajax_tahapan_cancel_update(iSeqVert)
  {
    do_ajax_tahapan_backup_line(iSeqVert);
...
?>
  } // do_ajax_tahapan_cancel_update

  function do_ajax_tahapan_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_tahapan_restore_buttons

  // ---------- table_refresh
  function do_ajax_tahapan_table_refresh()
  {
    var var_tmt_idtahapan_ = document.F2.tmt_idtahapan_.value;
    ...
    scAjaxProcOn();
    x_ajax_tahapan_table_refresh(var_tmt_idtahapan_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_tahapan_table_refresh_cb);
  } //  do_ajax_tahapan_table_refresh

  function do_ajax_tahapan_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.tmt_idtahapan_.value = scAjaxGetKeyValue("tmt_idtahapan_");
    ...
    sc_insert_open = false;
  } // do_ajax_tahapan_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_tahapan_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_tahapan_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_tmt_idtahapan_ = scAjaxGetFieldHidden("tmt_idtahapan_" + iNumLinha);
    var var_tmt_namatahapan_ = scAjaxGetFieldText("tmt_namatahapan_" + iNumLinha);
    var var_tmt_description_ = scAjaxGetFieldText("tmt_description_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_tahapan_submit_form(var_tmt_idtahapan_, var_tmt_namatahapan_, var_tmt_description_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_tahapan_submit_form_cb);
  } // do_ajax_tahapan_submit_form

  function do_ajax_tahapan_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tmt_idtahapan_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tmt_namatahapan_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tmt_description_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_tahapan_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_tahapan_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_tahapan_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("tmt_idtahapan_" + iNavForm);
      scAjaxHideErrorDisplay("tmt_namatahapan_" + iNavForm);
      scAjaxHideErrorDisplay("tmt_description_" + iNavForm);
    }
    var var_tmt_idtahapan_ = document.F2.tmt_idtahapan_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_tahapan_navigate_form(var_tmt_idtahapan_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_tahapan_navigate_form_cb);
  } // do_ajax_tahapan_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['tahapan']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_tahapan_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.tmt_idtahapan_.value = scAjaxGetKeyValue("tmt_idtahapan_" + var_last_index);
...
?>
  ...
  } // do_ajax_tahapan_navigate_form_cb
  function sc_hide_tahapan_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_tahapan_form
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "tmt_idtahapan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tmt_namatahapan_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tmt_description_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["tmt_idtahapan_" + iNumLinha] = {"label": "IDTahapan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tmt_namatahapan_" + iNumLinha] = {"label": "Nama Tahapan<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tmt_description_" + iNumLinha] = {"label": "Deskripsi<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["tmt_idtahapan_"][iNumLinha] = "tmt_idtahapan_" + iNumLinha;
    ajax_field_mult["tmt_namatahapan_"][iNumLinha] = "tmt_namatahapan_" + iNumLinha;
    ajax_field_mult["tmt_description_"][iNumLinha] = "tmt_description_" + iNumLinha;
    ajax_field_id["tmt_idtahapan_" + iNumLinha] = new Array("hidden_field_label_tmt_idtahapan_", "hidden_field_data_tmt_idtahapan_" + iNumLinha);
    ajax_field_id["tmt_namatahapan_" + iNumLinha] = new Array("hidden_field_label_tmt_namatahapan_", "hidden_field_data_tmt_namatahapan_" + iNumLinha);
    ajax_field_id["tmt_description_" + iNumLinha] = new Array("hidden_field_label_tmt_description_", "hidden_field_data_tmt_description_" + iNumLinha);
    ajax_error_count["tmt_idtahapan_" + iNumLinha] = "off";
    ajax_error_count["tmt_namatahapan_" + iNumLinha] = "off";
    ajax_error_count["tmt_description_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["tmt_idtahapan_" + iNumLinha] = "on";
    ajax_read_only["tmt_namatahapan_" + iNumLinha] = "off";
    ajax_read_only["tmt_description_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["tmt_idtahapan_" + iNumLinha] = "on";
    ajax_read_only["tmt_namatahapan_" + iNumLinha] = "on";
    ajax_read_only["tmt_description_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["tmt_idtahapan_" + iNumLinha] = null;
    ajax_error_list["tmt_namatahapan_" + iNumLinha] = null;
    ajax_error_list["tmt_description_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "tmt_idtahapan_": new Array(),
    "tmt_namatahapan_": new Array(),
    "tmt_description_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["tmt_idtahapan_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tmt_idtahapan_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tmt_idtahapan_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tmt_idtahapan_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tmt_idtahapan_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tmt_namatahapan_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tmt_namatahapan_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tmt_namatahapan_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tmt_namatahapan_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tmt_namatahapan_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tmt_description_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tmt_description_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tmt_description_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tmt_description_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tmt_description_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tmt_idtahapan_'])) ? $this->nmgp_cmp_readonly['tmt_idtahapan_'] : 'on';
?>
    scAjaxFieldRead("tmt_idtahapan_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tmt_namatahapan_'])) ? $this->nmgp_cmp_readonly['tmt_namatahapan_'] : 'off';
?>
    scAjaxFieldRead("tmt_namatahapan_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tmt_description_'])) ? $this->nmgp_cmp_readonly['tmt_description_'] : 'off';
?>
    scAjaxFieldRead("tmt_description_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("tmt_idtahapan_" + iSeq, "on");
    scAjaxFieldRead("tmt_namatahapan_" + iSeq, "on");
    scAjaxFieldRead("tmt_description_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tmt_idtahapan_" + iRow] || "on" == ajax_error_count["tmt_namatahapan_" + iRow] || "on" == ajax_error_count["tmt_description_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tmt_idtahapan_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tmt_namatahapan_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tmt_description_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tmt_idtahapan_" + iRow] && "off" == ajax_error_count["tmt_namatahapan_" + iRow] && "off" == ajax_error_count["tmt_description_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tmt_idtahapan_" + iRow] = "off";
        ajax_error_count["tmt_namatahapan_" + iRow] = "off";
        ajax_error_count["tmt_description_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_tmt_idtahapan_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tmt_namatahapan_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tmt_description_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("tmt_idtahapan_" == sIndex)
    {
      scAjaxSetFieldLabel(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
    }
    if ("tmt_namatahapan_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
    }
    if ("tmt_description_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
