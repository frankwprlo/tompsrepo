...
$old_error_handler = set_error_handler("tahapan_inline_scriptcase_error_handler");

function tahapan_inline_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['tahapan_inline']['contr_erro']) && $_SESSION['scriptcase']['tahapan_inline']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_tahapan_inline->contr_tahapan_inline->Apl_com_erro = true;
            if ($inicial_tahapan_inline->contr_tahapan_inline->NM_ajax_flag)
            {
                $inicial_tahapan_inline->contr_tahapan_inline->NM_ajax_info['errList']['geral_tahapan_inline'][] = $msg;
                return;
            }
            tahapan_inline_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function tahapan_inline_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['tahapan_inline'])  && '' != $_SESSION['scriptcase']['error_icon']['tahapan_inline'])  ? $_SESSION['scriptcase']['error_icon']['tahapan_inline']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['tahapan_inline']) && '' != $_SESSION['scriptcase']['error_close']['tahapan_inline']) ? $_SESSION['scriptcase']['error_close']['tahapan_inline'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['tahapan_inline']) && '' != $_SESSION['scriptcase']['error_span_title']['tahapan_inline']) ? $_SESSION['scriptcase']['error_span_title']['tahapan_inline'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['tahapan_inline']) && '' != $_SESSION['scriptcase']['error_icon_title']['tahapan_inline']) ? $_SESSION['scriptcase']['error_icon_title']['tahapan_inline'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['tahapan']['error_buffer'] .= ob_get_flush();
}
