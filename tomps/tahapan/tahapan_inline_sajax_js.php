  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_tahapan_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_tahapan_inline_validate_tmt_idtahapan_()
  {
    var nomeCampo_tmt_idtahapan_ = "tmt_idtahapan_";
    var var_tmt_idtahapan_ = scAjaxGetFieldHidden(nomeCampo_tmt_idtahapan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tahapan_inline_validate_tmt_idtahapan_(var_tmt_idtahapan_, var_script_case_init, do_ajax_tahapan_inline_validate_tmt_idtahapan__cb);
  } // do_ajax_tahapan_inline_validate_tmt_idtahapan_

  function do_ajax_tahapan_inline_validate_tmt_idtahapan__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tahapan_inline_validate_tmt_idtahapan__cb

  // ---------- Validate tmt_namatahapan_
  function do_ajax_tahapan_inline_validate_tmt_namatahapan_()
  {
    var nomeCampo_tmt_namatahapan_ = "tmt_namatahapan_";
    var var_tmt_namatahapan_ = scAjaxGetFieldText(nomeCampo_tmt_namatahapan_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tahapan_inline_validate_tmt_namatahapan_(var_tmt_namatahapan_, var_script_case_init, do_ajax_tahapan_inline_validate_tmt_namatahapan__cb);
  } // do_ajax_tahapan_inline_validate_tmt_namatahapan_

  function do_ajax_tahapan_inline_validate_tmt_namatahapan__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tahapan_inline_validate_tmt_namatahapan__cb

  // ---------- Validate tmt_description_
  function do_ajax_tahapan_inline_validate_tmt_description_()
  {
    var nomeCampo_tmt_description_ = "tmt_description_";
    var var_tmt_description_ = scAjaxGetFieldText(nomeCampo_tmt_description_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tahapan_inline_validate_tmt_description_(var_tmt_description_, var_script_case_init, do_ajax_tahapan_inline_validate_tmt_description__cb);
  } // do_ajax_tahapan_inline_validate_tmt_description_

  function do_ajax_tahapan_inline_validate_tmt_description__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tahapan_inline_validate_tmt_description__cb
  // ---------- Form
  function do_ajax_tahapan_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_tahapan_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_tmt_idtahapan_ = scAjaxGetFieldHidden("tmt_idtahapan_");
    var var_tmt_namatahapan_ = scAjaxGetFieldText("tmt_namatahapan_");
    var var_tmt_description_ = scAjaxGetFieldText("tmt_description_");
    ...
    scAjaxProcOn();
    x_ajax_tahapan_inline_submit_form(var_tmt_idtahapan_, var_tmt_namatahapan_, var_tmt_description_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_tahapan_inline_submit_form_cb);
  } // do_ajax_tahapan_inline_submit_form

  function do_ajax_tahapan_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tmt_idtahapan_");
      scAjaxHideErrorDisplay("tmt_namatahapan_");
      scAjaxHideErrorDisplay("tmt_description_");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_tahapan_inline_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_tahapan_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_tahapan_inline_navigate_form(var_tmt_idtahapan_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_tahapan_inline_navigate_form_cb);
  } // do_ajax_tahapan_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['tahapan_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_tahapan_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_tahapan_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_tahapan_inline_navigate_form_cb
  function sc_hide_tahapan_inline_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_tahapan_inline_form
  ...
  ajax_field_list[0] = "tmt_idtahapan_";
  ajax_field_list[1] = "tmt_namatahapan_";
  ajax_field_list[2] = "tmt_description_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "tmt_idtahapan_": {"label": "IDTahapan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tmt_namatahapan_": {"label": "Nama Tahapan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tmt_description_": {"label": "Deskripsi", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["tmt_idtahapan_"][1] = "tmt_idtahapan_";
  ajax_field_mult["tmt_namatahapan_"][1] = "tmt_namatahapan_";
  ajax_field_mult["tmt_description_"][1] = "tmt_description_";

  var ajax_field_id = {
    "tmt_idtahapan_": new Array("hidden_field_label_tmt_idtahapan_", "hidden_field_data_tmt_idtahapan_"),
    "tmt_namatahapan_": new Array("hidden_field_label_tmt_namatahapan_", "hidden_field_data_tmt_namatahapan_"),
    "tmt_description_": new Array("hidden_field_label_tmt_description_", "hidden_field_data_tmt_description_")
  };

  var ajax_read_only = {
    "tmt_idtahapan_": "on",
    "tmt_namatahapan_": "off",
    "tmt_description_": "off"
  };
