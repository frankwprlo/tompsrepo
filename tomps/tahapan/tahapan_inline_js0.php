<form name="F2" method=post 
               action="tahapan_inline.php" 
               target="_self"> 
<input type="hidden" name="tmt_idtahapan_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['tmt_idtahapan_']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['tahapan_inline']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="tahapan_inline"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tahapan']['where_detal']))
  {
?>  
  if (parent && parent.nmsc_iframe_liga_tahapan.scInlineFormReceive)
  {
    parent.nmsc_iframe_liga_tahapan.scInlineFormReceive(oResp, <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['tahapan_inline']['inline_form_seq'] ?>);
    return true;
  }
<?php
  }
...
?>  
  ...
  {
    parent.scInlineFormReceive(oResp, <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['tahapan_inline']['inline_form_seq'] ?>);
    return true;
  }
<?php
  }
