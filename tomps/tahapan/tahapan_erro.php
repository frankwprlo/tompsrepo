...
$old_error_handler = set_error_handler("tahapan_scriptcase_error_handler");

function tahapan_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['tahapan']['contr_erro']) && $_SESSION['scriptcase']['tahapan']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_tahapan->contr_tahapan->Apl_com_erro = true;
            if ($inicial_tahapan->contr_tahapan->NM_ajax_flag)
            {
                $inicial_tahapan->contr_tahapan->NM_ajax_info['errList']['geral_tahapan'][] = $msg;
                return;
            }
            tahapan_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function tahapan_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['tahapan'])  && '' != $_SESSION['scriptcase']['error_icon']['tahapan'])  ? $_SESSION['scriptcase']['error_icon']['tahapan']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['tahapan']) && '' != $_SESSION['scriptcase']['error_close']['tahapan']) ? $_SESSION['scriptcase']['error_close']['tahapan'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['tahapan']) && '' != $_SESSION['scriptcase']['error_span_title']['tahapan']) ? $_SESSION['scriptcase']['error_span_title']['tahapan'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['tahapan']) && '' != $_SESSION['scriptcase']['error_icon_title']['tahapan']) ? $_SESSION['scriptcase']['error_icon_title']['tahapan'] : '';
?>
