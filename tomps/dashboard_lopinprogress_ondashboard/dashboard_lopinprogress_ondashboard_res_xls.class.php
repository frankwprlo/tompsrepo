...
class dashboard_lopinprogress_ondashboard_res_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= "_dashboard_lopinprogress_ondashboard";
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "dashboard_lopinprogress_ondashboard.xls";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['xls_name']);
      }
      ...
      $this->Res       = new dashboard_lopinprogress_ondashboard_resumo("out");
   ...
   function grava_arquivo()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_group_by'];
      ...
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['arr_export']['data'];
      $b_display = false;
      $contr_rowspan = array();
      $contr_colspan = array();
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard'][$path_doc_md5][1] = $this->Tit_doc;
?>
