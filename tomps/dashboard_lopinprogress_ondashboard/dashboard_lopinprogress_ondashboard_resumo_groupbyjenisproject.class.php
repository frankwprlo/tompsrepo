...
class dashboard_lopinprogress_ondashboard_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['dashboard_info']['under_dashboard'] ? "off" : "on";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['dashboard_lopinprogress_ondashboard'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['dashboard_lopinprogress_ondashboard'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['dashboard_lopinprogress_ondashboard']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['dashboard_lopinprogress_ondashboard']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['dashboard_lopinprogress_ondashboard']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['campos_busca'];
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("dashboard_lopinprogress_ondashboard", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['contr_total_geral'] == "OK")
      {
          $this->array_total_kodedatel = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['arr_total']['kodedatel'];
          $this->array_total_jenisproject = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['arr_total']['jenisproject'];
      }
      else
      {
          $this->array_total_kodedatel = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['tot_geral'][3];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['summarizing_fields_order']['groupbyjenisproject']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['summarizing_fields_order']['groupbyjenisproject'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['summarizing_fields_order']['groupbyjenisproject'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['summarizing_fields_display']['groupbyjenisproject'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['summarizing_fields_display']['groupbyjenisproject'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['summarizing_fields_display']['groupbyjenisproject'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['summarizing_fields_display']['groupbyjenisproject'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['summarizing_fields_display']['groupbyjenisproject'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['summarizing_fields_display']['groupbyjenisproject'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['summarizing_fields_display']['groupbyjenisproject'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@dashboard_lopinprogress_ondashboard@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_order_start'][$iYAxysIndex])
                       {
   ...
   function resumo_init()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
      {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['dashboard_lopinprogress_ondashboard']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['dashboard_lopinprogress_ondashboard']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['dashboard_lopinprogress_ondashboard']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['dashboard_lopinprogress_ondashboard']) . "_";
               } 
           }
       }
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "dashboard_lopinprogress_ondashboard_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['print_all'];
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['opcao'] = "print";
      ...
      $this->Total   = new dashboard_lopinprogress_ondashboard_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['responsive_chart']['active']) {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"dashboard_lopinprogress_ondashboard_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"dashboard_lopinprogress_ondashboard_jquery.js\"></script>\r\n");
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_dashboard_lopinprogress_ondashboard_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_dashboard_lopinprogress_ondashboard_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_dashboard_lopinprogress_ondashboard_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['num_css'] . '.css');
     ...
     else
     {
      ...
      $nm_saida->saida(" </style>\r\n");
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "dashboard_lopinprogress_ondashboard/dashboard_lopinprogress_ondashboard_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['opcao'] == "pdf")
      { 
              $nm_saida->saida("  <div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">Summary</H1></div>\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "dashboard_lopinprogress_ondashboard/dashboard_lopinprogress_ondashboard_config_print.php?nm_opc=resumo&nm_cor=AM&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
         if (is_file("dashboard_lopinprogress_ondashboard_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("dashboard_lopinprogress_ondashboard_help.txt"); 
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'dashboard_lopinprogress_ondashboard_config_pivot.php?nome_apl=dashboard_lopinprogress_ondashboard&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"dashboard_lopinprogress_ondashboard_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("</form> \r\n");
      ...
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['dashboard_lopinprogress_ondashboard_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@dashboard_lopinprogress_ondashboard@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
      $nm_saida->saida("  if (\"pdf\" == x)\r\n");
      $nm_saida->saida("  {\r\n");
      $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "dashboard_lopinprogress_ondashboard/dashboard_lopinprogress_ondashboard_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_create_charts=\" + crt + \"&sc_graf_pdf=\" + g;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_dashboard_lopinprogress_ondashboard_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "dashboard_lopinprogress_ondashboard/dashboard_lopinprogress_ondashboard_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_bot()
 {
   global $nm_saida;
   $bPDF = false;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new dashboard_lopinprogress_ondashboard_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $nm_saida->saida("<TR>\r\n");
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_charts']);
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['pivot_charts'] as $chart_index => $chart_data)
       {
           $qtd_col++;
           if ($qtd_col > $lim_col)
           {
       ...
       $nm_saida->saida("</TR>\r\n");
       $nm_saida->saida("</TABLE>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
       }
   }
 }
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['cond_pesq'], 0, $trab_pos);
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['arr_total']['kodedatel'] as $campo_kodedatel => $dados_kodedatel)
      {
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['arr_total']['jenisproject'][$campo_kodedatel] as $campo_jenisproject => $dados_jenisproject)
         {
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['where_pesq']; 
...
//
   ...
   function totaliza_php_groupbyjenisproject()
   {
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['where_pesq_filtro'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['contr_total_geral'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['contr_array_resumo'] == "OK")
      {
          return;
      }
      //----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['ordem_grid']) 
        {
   ...
   $campos_order = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['ordem_desc']; 
   } 
   ...
   $nmgp_select .= $nmgp_order_by; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['order_grid'] = $nmgp_order_by;
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
      ...
      $this->finaliza_arrays();
      $this->rs_grid->Close();
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['tot_geral'][2] = $this->array_total_geral[1];
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['tot_geral'][3] = $this->array_total_geral[2];
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['tot_geral'][1] = $this->array_total_geral[0];
      $count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['tot_geral'][1];
      $sum_jumlahlop = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['tot_geral'][2];
      $sum_jumlahodp = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['tot_geral'][3];
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['contr_total_geral'] = "OK";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['SC_Ind_Groupby'] == "groupbyjenisproject")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['arr_total']['kodedatel'] = $this->array_total_kodedatel;
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_lopinprogress_ondashboard']['arr_total']['jenisproject'] = $this->array_total_jenisproject;
      }
   }
