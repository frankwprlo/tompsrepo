 ...
 */
    ...
    session_start();
    $SC_apl_proc = "timeplan_tahapan_new";
...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['timeplan_tahapan_new']['show_skip_charts_option']) || !$_SESSION['sc_session']['timeplan_tahapan_new']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
