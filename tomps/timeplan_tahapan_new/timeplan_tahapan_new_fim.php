...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["projectamo_____timeplan_tahapan_new"]))
   {
      unset($_SESSION['session_sec_aplicacao']["projectamo_____timeplan_tahapan_new"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['timeplan_tahapan_new']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['timeplan_tahapan_new']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['timeplan_tahapan_new']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['timeplan_tahapan_new']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['timeplan_tahapan_new']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>timeplan_tahapan_new</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['timeplan_tahapan_new']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['timeplan_tahapan_new']['embutida_filho'] as $ind => $sc_init)
          {
