...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["projectamo_____vmastertemplate"]))
   {
      unset($_SESSION['session_sec_aplicacao']["projectamo_____vmastertemplate"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['mastertemplate_copy'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['vmastertemplate']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['vmastertemplate']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['vmastertemplate']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['vmastertemplate']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['vmastertemplate']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['vmastertemplate']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['vmastertemplate']['embutida_filho'] as $ind => $sc_init)
          {
