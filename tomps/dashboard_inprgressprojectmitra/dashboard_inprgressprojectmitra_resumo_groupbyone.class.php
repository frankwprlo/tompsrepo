...
class dashboard_inprgressprojectmitra_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_tbl_mas_datel_md_kodedatel;
   var $array_total_tbl_mitra_tm_namamitra;
   ...
   var $sum_jumlahlop;
   var $sum_jumlahodp;
   var $sc_proc_quebra_tbl_mas_datel_md_kodedatel;
   var $count_tbl_mas_datel_md_kodedatel;
   var $sum_tbl_mas_datel_md_kodedatel_jumlahlop;
   var $sum_tbl_mas_datel_md_kodedatel_jumlahodp;
   var $sc_proc_quebra_tbl_mitra_tm_namamitra;
   var $count_tbl_mitra_tm_namamitra;
   var $sum_tbl_mitra_tm_namamitra_jumlahlop;
   var $sum_tbl_mitra_tm_namamitra_jumlahodp;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_tbl_mas_datel_md_kodedatel = array();
      $this->array_total_tbl_mitra_tm_namamitra     = array();
   ...
   function initializeButtons()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['dashboard_inprgressprojectmitra'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['dashboard_inprgressprojectmitra'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['dashboard_inprgressprojectmitra']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['dashboard_inprgressprojectmitra']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['dashboard_inprgressprojectmitra']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['campos_busca'];
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['contr_total_geral'] == "OK")
      {
          $this->array_total_tbl_mas_datel_md_kodedatel = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['arr_total']['tbl_mas_datel_md_kodedatel'];
          $this->array_total_tbl_mitra_tm_namamitra = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['arr_total']['tbl_mitra_tm_namamitra'];
      }
      else
      {
          $this->array_total_tbl_mas_datel_md_kodedatel = array();
          $this->array_total_tbl_mitra_tm_namamitra = array();
          $this->totaliza_php_groupbyone();
      }
      $this->array_total_geral = array();
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['tot_geral'][3];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $Lab_tbl_mas_datel_md_kodedatel = "MD KODEDATEL";
       $Lab_tbl_mitra_tm_namamitra = "TM NAMAMITRA";
       $this->comp_field = array(
           $Lab_tbl_mas_datel_md_kodedatel,
           $Lab_tbl_mitra_tm_namamitra,
       );

       //-----
       $this->comp_field_nm = array(
           'tbl_mas_datel_md_kodedatel' => 0,
           'tbl_mitra_tm_namamitra' => 1,
       );

       //-----
       $this->comp_sum = array(
           2 => "JUMLAHLOP (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           3 => "JUMLAHODP (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['summarizing_fields_order']['groupbyone']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['summarizing_fields_order']['groupbyone'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['summarizing_fields_order']['groupbyone'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['summarizing_fields_display']['groupbyone'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['summarizing_fields_display']['groupbyone'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['summarizing_fields_display']['groupbyone'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['summarizing_fields_display']['groupbyone'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['summarizing_fields_display']['groupbyone'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['summarizing_fields_display']['groupbyone'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['summarizing_fields_display']['groupbyone'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_tbl_mas_datel_md_kodedatel as $i_tbl_mas_datel_md_kodedatel => $d_tbl_mas_datel_md_kodedatel) {
           if (!in_array($i_tbl_mas_datel_md_kodedatel, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_tbl_mas_datel_md_kodedatel[4] ] = $d_tbl_mas_datel_md_kodedatel[3];
               $this->comp_label[0][ $d_tbl_mas_datel_md_kodedatel[4] ] = $d_tbl_mas_datel_md_kodedatel[3];
           }
           foreach ($this->array_total_tbl_mitra_tm_namamitra[$i_tbl_mas_datel_md_kodedatel] as $i_tbl_mitra_tm_namamitra => $d_tbl_mitra_tm_namamitra) {
               if (!in_array($i_tbl_mitra_tm_namamitra, $this->comp_label[1][ $d_tbl_mas_datel_md_kodedatel[4] ], true)) {
                   $this->comp_index[1][ $d_tbl_mitra_tm_namamitra[4] ] = $d_tbl_mitra_tm_namamitra[3];
                   $this->comp_label[1][ $d_tbl_mas_datel_md_kodedatel[4] ][ $d_tbl_mitra_tm_namamitra[4] ] = $d_tbl_mitra_tm_namamitra[3];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'TBL_MAS_DATEL.MD_KODEDATEL', 'prot' => '@aspass@'),
           array('name' => 'TBL_MITRA.TM_NAMAMITRA', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_tbl_mas_datel_md_kodedatel => $l_tbl_mas_datel_md_kodedatel) {
           if (isset($this->array_total_tbl_mas_datel_md_kodedatel[$i_tbl_mas_datel_md_kodedatel])) {
               $this->comp_group[$i_tbl_mas_datel_md_kodedatel] = array();
           }
           foreach ($this->comp_label[1][$i_tbl_mas_datel_md_kodedatel] as $i_tbl_mitra_tm_namamitra => $l_tbl_mitra_tm_namamitra) {
               if (isset($this->array_total_tbl_mitra_tm_namamitra[$i_tbl_mas_datel_md_kodedatel][$i_tbl_mitra_tm_namamitra])) {
                   $this->comp_group[$i_tbl_mas_datel_md_kodedatel][$i_tbl_mitra_tm_namamitra] = array();
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_tbl_mas_datel_md_kodedatel;
       }
       elseif (1 == $level) {
           $return = $this->array_total_tbl_mitra_tm_namamitra;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@dashboard_inprgressprojectmitra@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['pivot_order_start'][$iYAxysIndex])
                       {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['dashboard_inprgressprojectmitra']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['dashboard_inprgressprojectmitra']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['dashboard_inprgressprojectmitra']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['dashboard_inprgressprojectmitra']) . "_";
               } 
           }
       }
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "dashboard_inprgressprojectmitra_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['print_all'];
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['opcao'] = "print";
      ...
      $this->Total   = new dashboard_inprgressprojectmitra_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
      ...
      $this->array_total_tbl_mas_datel_md_kodedatel = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['arr_total']['tbl_mas_datel_md_kodedatel'];
      $this->array_total_tbl_mitra_tm_namamitra = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['arr_total']['tbl_mitra_tm_namamitra'];
      ksort($this->array_total_tbl_mas_datel_md_kodedatel);
      ksort($this->array_total_tbl_mitra_tm_namamitra);
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>Resume On-going Project Witel " . $_SESSION['kodewitel'] . " : by Mitra dan Datel</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"dashboard_inprgressprojectmitra_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"dashboard_inprgressprojectmitra_jquery.js\"></script>\r\n");
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_dashboard_inprgressprojectmitra_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_dashboard_inprgressprojectmitra_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_dashboard_inprgressprojectmitra_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['num_css'] . '.css');
     ...
     else
     {
      ...
      $nm_saida->saida(" </style>\r\n");
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "dashboard_inprgressprojectmitra/dashboard_inprgressprojectmitra_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['opcao'] == "pdf")
      { 
              $nm_saida->saida("  <div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">Mitra / Datel</H1></div>\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'dashboard_inprgressprojectmitra_config_pivot.php?nome_apl=dashboard_inprgressprojectmitra&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   </form> \r\n");
      ...
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['dashboard_inprgressprojectmitra_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@dashboard_inprgressprojectmitra@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
      $nm_saida->saida("  if (\"pdf\" == x)\r\n");
      $nm_saida->saida("  {\r\n");
      $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "dashboard_inprgressprojectmitra/dashboard_inprgressprojectmitra_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_create_charts=\" + crt + \"&sc_graf_pdf=\" + g;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_dashboard_inprgressprojectmitra_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "dashboard_inprgressprojectmitra/dashboard_inprgressprojectmitra_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['cond_pesq'], 0, $trab_pos);
      ...
      $nm_saida->saida("          Resume On-going Project Witel " . $_SESSION['kodewitel'] . " : by Mitra dan Datel\r\n");
      $nm_saida->saida("        </TD>\r\n");
      $nm_saida->saida("       </TR>\r\n");
   ...
   //---- 
   function adiciona_registro($sum_jumlahlop, $sum_jumlahodp, $quebra_tbl_mas_datel_md_kodedatel, $quebra_tbl_mitra_tm_namamitra, $quebra_tbl_mas_datel_md_kodedatel_orig, $quebra_tbl_mitra_tm_namamitra_orig)
   {
      //----- MD KODEDATEL
      if (!isset($this->array_total_tbl_mas_datel_md_kodedatel[$quebra_tbl_mas_datel_md_kodedatel_orig]))
      {
         $this->array_total_tbl_mas_datel_md_kodedatel[$quebra_tbl_mas_datel_md_kodedatel_orig][0] = 1;
         $this->array_total_tbl_mas_datel_md_kodedatel[$quebra_tbl_mas_datel_md_kodedatel_orig][1] = $sum_jumlahlop;
         $this->array_total_tbl_mas_datel_md_kodedatel[$quebra_tbl_mas_datel_md_kodedatel_orig][2] = $sum_jumlahodp;
         $this->array_total_tbl_mas_datel_md_kodedatel[$quebra_tbl_mas_datel_md_kodedatel_orig][3] = $quebra_tbl_mas_datel_md_kodedatel;
         $this->array_total_tbl_mas_datel_md_kodedatel[$quebra_tbl_mas_datel_md_kodedatel_orig][4] = $quebra_tbl_mas_datel_md_kodedatel_orig;
      }
      else
      {
         $this->array_total_tbl_mas_datel_md_kodedatel[$quebra_tbl_mas_datel_md_kodedatel_orig][0]++;
         $this->array_total_tbl_mas_datel_md_kodedatel[$quebra_tbl_mas_datel_md_kodedatel_orig][1] += $sum_jumlahlop;
         $this->array_total_tbl_mas_datel_md_kodedatel[$quebra_tbl_mas_datel_md_kodedatel_orig][2] += $sum_jumlahodp;
      }
      //----- TM NAMAMITRA
      if (!isset($this->array_total_tbl_mitra_tm_namamitra[$quebra_tbl_mas_datel_md_kodedatel_orig][$quebra_tbl_mitra_tm_namamitra_orig]))
      {
         $this->array_total_tbl_mitra_tm_namamitra[$quebra_tbl_mas_datel_md_kodedatel_orig][$quebra_tbl_mitra_tm_namamitra_orig][0] = 1;
         $this->array_total_tbl_mitra_tm_namamitra[$quebra_tbl_mas_datel_md_kodedatel_orig][$quebra_tbl_mitra_tm_namamitra_orig][1] = $sum_jumlahlop;
         $this->array_total_tbl_mitra_tm_namamitra[$quebra_tbl_mas_datel_md_kodedatel_orig][$quebra_tbl_mitra_tm_namamitra_orig][2] = $sum_jumlahodp;
         $this->array_total_tbl_mitra_tm_namamitra[$quebra_tbl_mas_datel_md_kodedatel_orig][$quebra_tbl_mitra_tm_namamitra_orig][3] = $quebra_tbl_mitra_tm_namamitra;
         $this->array_total_tbl_mitra_tm_namamitra[$quebra_tbl_mas_datel_md_kodedatel_orig][$quebra_tbl_mitra_tm_namamitra_orig][4] = $quebra_tbl_mitra_tm_namamitra_orig;
      }
      else
      {
         $this->array_total_tbl_mitra_tm_namamitra[$quebra_tbl_mas_datel_md_kodedatel_orig][$quebra_tbl_mitra_tm_namamitra_orig][0]++;
         $this->array_total_tbl_mitra_tm_namamitra[$quebra_tbl_mas_datel_md_kodedatel_orig][$quebra_tbl_mitra_tm_namamitra_orig][1] += $sum_jumlahlop;
         $this->array_total_tbl_mitra_tm_namamitra[$quebra_tbl_mas_datel_md_kodedatel_orig][$quebra_tbl_mitra_tm_namamitra_orig][2] += $sum_jumlahodp;
      }
      //----- Total
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['arr_total']['tbl_mas_datel_md_kodedatel'] as $campo_tbl_mas_datel_md_kodedatel => $dados_tbl_mas_datel_md_kodedatel)
      {
         $this->array_total_tbl_mas_datel_md_kodedatel[$campo_tbl_mas_datel_md_kodedatel][1] = $dados_tbl_mas_datel_md_kodedatel[1];
         $this->array_total_tbl_mas_datel_md_kodedatel[$campo_tbl_mas_datel_md_kodedatel][2] = $dados_tbl_mas_datel_md_kodedatel[2];
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['arr_total']['tbl_mitra_tm_namamitra'][$campo_tbl_mas_datel_md_kodedatel] as $campo_tbl_mitra_tm_namamitra => $dados_tbl_mitra_tm_namamitra)
         {
            $this->array_total_tbl_mitra_tm_namamitra[$campo_tbl_mas_datel_md_kodedatel][$campo_tbl_mitra_tm_namamitra][1] = $dados_tbl_mitra_tm_namamitra[1];
            $this->array_total_tbl_mitra_tm_namamitra[$campo_tbl_mas_datel_md_kodedatel][$campo_tbl_mitra_tm_namamitra][2] = $dados_tbl_mitra_tm_namamitra[2];
         }
      }
   }
   //---- 
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT TBL_MITRA.TM_NAMAMITRA as tbl_mitra_tm_namamitra, TBL_MAS_DATEL.MD_KODEDATEL as tbl_mas_datel_md_kodedatel, COUNT(TBL_PROJECT.TP_ID) as jumlahlop, SUM(TBL_PROJECT.TP_ODP) as jumlahodp from " . $this->Ini->nm_tabela; 
     } 
     ...
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['where_pesq']; 
     $nmgp_select .= " group by TBL_MITRA.TM_NAMAMITRA,TBL_MAS_DATEL.MD_KODEDATEL"; 
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'tbl_mas_datel_md_kodedatel');
     $campos_order = $this->Ini->Get_date_order_groupby("TBL_MAS_DATEL.MD_KODEDATEL", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'tbl_mitra_tm_namamitra');
     $campos_order = $this->Ini->Get_date_order_groupby("TBL_MITRA.TM_NAMAMITRA", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->tbl_mitra_tm_namamitra = $rs_res->fields[0] ;  
            $this->tbl_mas_datel_md_kodedatel = $rs_res->fields[1] ;  
            $this->jumlahlop = $rs_res->fields[2] ;  
            $this->jumlahodp = $rs_res->fields[3] ;  
            $this->jumlahodp =  str_replace(",", ".", $this->jumlahodp);
            $this->tbl_mas_datel_md_kodedatel_orig = $this->tbl_mas_datel_md_kodedatel;
            $this->tbl_mitra_tm_namamitra_orig = $this->tbl_mitra_tm_namamitra;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->jumlahlop, $this->jumlahodp, $this->tbl_mas_datel_md_kodedatel, $this->tbl_mitra_tm_namamitra, $this->tbl_mas_datel_md_kodedatel_orig,  $this->tbl_mitra_tm_namamitra_orig);
            }
   }
//
   ...
   function totaliza_php_groupbyone()
   {
      $this->sc_proc_grid = true;
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['where_pesq_filtro'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['contr_total_geral'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['contr_array_resumo'] == "OK")
      {
          return;
      }
      //----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['ordem_grid']) 
        {
   ...
   $campos_order = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['ordem_desc']; 
   } 
   ...
   $nmgp_select .= $nmgp_order_by; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['order_grid'] = $nmgp_order_by;
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
      ...
      {
         $this->tbl_mitra_tm_namamitra = $this->rs_grid->fields[0] ;  
         $this->tbl_mas_datel_md_kodedatel = $this->rs_grid->fields[1] ;  
         ...
         $tbl_mas_datel_md_kodedatel_orig = $this->tbl_mas_datel_md_kodedatel;
         $tbl_mitra_tm_namamitra_orig = $this->tbl_mitra_tm_namamitra;
         $this->arg_sum_tbl_mitra_tm_namamitra = " = " . $this->Db->qstr($this->tbl_mitra_tm_namamitra);
         $this->arg_sum_tbl_mas_datel_md_kodedatel = " = " . $this->Db->qstr($this->tbl_mas_datel_md_kodedatel);
         $this->adiciona_registro(NM_encode_input(sc_strip_script($this->jumlahlop)), NM_encode_input(sc_strip_script($this->jumlahodp)), sc_strip_script($this->tbl_mas_datel_md_kodedatel), sc_strip_script($this->tbl_mitra_tm_namamitra), sc_strip_script($tbl_mas_datel_md_kodedatel_orig), sc_strip_script($tbl_mitra_tm_namamitra_orig));
         $this->rs_grid->MoveNext();
      }
      $this->finaliza_arrays();
      $this->rs_grid->Close();
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['tot_geral'][2] = $this->array_total_geral[1];
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['tot_geral'][3] = $this->array_total_geral[2];
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['tot_geral'][1] = $this->array_total_geral[0];
      $count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['tot_geral'][1];
      $sum_jumlahlop = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['tot_geral'][2];
      $sum_jumlahodp = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['tot_geral'][3];
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['contr_total_geral'] = "OK";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['SC_Ind_Groupby'] == "groupbyone")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['arr_total']['tbl_mas_datel_md_kodedatel'] = $this->array_total_tbl_mas_datel_md_kodedatel;
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_inprgressprojectmitra']['arr_total']['tbl_mitra_tm_namamitra'] = $this->array_total_tbl_mitra_tm_namamitra;
      }
   }
