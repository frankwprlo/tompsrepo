<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new dashboard_inprgressprojectmitra_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class dashboard_inprgressprojectmitra_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['tbl_mitra_tm_namamitra'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tbl_mitra_tm_namamitra'] = "tbl_mitra_tm_namamitra";
       $tab_converte["tbl_mitra_tm_namamitra"]   = "tbl_mitra_tm_namamitra";
   }
   else
   {
       $tab_def_campos['tbl_mitra_tm_namamitra'] = "TBL_MITRA.TM_NAMAMITRA";
       $tab_converte["TBL_MITRA.TM_NAMAMITRA"]   = "tbl_mitra_tm_namamitra";
   }
   $tab_labels["tbl_mitra_tm_namamitra"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_inprgressprojectmitra']['labels']["tbl_mitra_tm_namamitra"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_inprgressprojectmitra']['labels']["tbl_mitra_tm_namamitra"] : "TM NAMAMITRA";
   $tab_ger_campos['tbl_mas_datel_md_kodedatel'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tbl_mas_datel_md_kodedatel'] = "tbl_mas_datel_md_kodedatel";
       $tab_converte["tbl_mas_datel_md_kodedatel"]   = "tbl_mas_datel_md_kodedatel";
   }
   else
   {
       $tab_def_campos['tbl_mas_datel_md_kodedatel'] = "TBL_MAS_DATEL.MD_KODEDATEL";
       $tab_converte["TBL_MAS_DATEL.MD_KODEDATEL"]   = "tbl_mas_datel_md_kodedatel";
   }
   $tab_labels["tbl_mas_datel_md_kodedatel"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_inprgressprojectmitra']['labels']["tbl_mas_datel_md_kodedatel"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_inprgressprojectmitra']['labels']["tbl_mas_datel_md_kodedatel"] : "MD KODEDATEL";
   $tab_ger_campos['jumlahlop'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jumlahlop'] = "jumlahlop";
       $tab_converte["jumlahlop"]   = "jumlahlop";
   }
   else
   {
       $tab_def_campos['jumlahlop'] = "COUNT(TBL_PROJECT.TP_ID)";
       $tab_converte["COUNT(TBL_PROJECT.TP_ID)"]   = "jumlahlop";
   }
   $tab_labels["jumlahlop"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_inprgressprojectmitra']['labels']["jumlahlop"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_inprgressprojectmitra']['labels']["jumlahlop"] : "JUMLAHLOP";
   $tab_ger_campos['jumlahodp'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jumlahodp'] = "jumlahodp";
       $tab_converte["jumlahodp"]   = "jumlahodp";
   }
   else
   {
       $tab_def_campos['jumlahodp'] = "SUM(TBL_PROJECT.TP_ODP)";
       $tab_converte["SUM(TBL_PROJECT.TP_ODP)"]   = "jumlahodp";
   }
   $tab_labels["jumlahodp"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_inprgressprojectmitra']['labels']["jumlahodp"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_inprgressprojectmitra']['labels']["jumlahodp"] : "JUMLAHODP";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['dashboard_inprgressprojectmitra']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['dashboard_inprgressprojectmitra']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['dashboard_inprgressprojectmitra']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['dashboard_inprgressprojectmitra']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['dashboard_inprgressprojectmitra']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['dashboard_inprgressprojectmitra']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['dashboard_inprgressprojectmitra']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['dashboard_inprgressprojectmitra']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['dashboard_inprgressprojectmitra']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['dashboard_inprgressprojectmitra']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['dashboard_inprgressprojectmitra']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['dashboard_inprgressprojectmitra']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "dashboard_inprgressprojectmitra_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['dashboard_inprgressprojectmitra']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['dashboard_inprgressprojectmitra']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
