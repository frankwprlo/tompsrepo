...
class report_others_inregional_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= "_report_others_inregional";
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "report_others_inregional.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inregional']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inregional']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inregional']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inregional']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inregional']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->tj_namajenis = $rs->fields[8] ;  
         $this->statusname = $rs->fields[9] ;  
         $this->tm_namamitra = $rs->fields[10] ;  
         $this->tp_projectname = $rs->fields[11] ;  
         $this->tp_rab = $rs->fields[12] ;  
         $this->tp_rab = (string)$this->tp_rab;
         $this->tp_nilai = $rs->fields[13] ;  
         $this->tp_nilai = (string)$this->tp_nilai;
         $this->tp_lokasi = $rs->fields[14] ;  
         $this->tp_odp = $rs->fields[15] ;  
         $this->tp_odp = (string)$this->tp_odp;
         $this->tp_planstart = $rs->fields[16] ;  
         $this->tp_planfinish = $rs->fields[17] ;  
         $this->tp_summary = $rs->fields[18] ;  
         $this->tp_status = $rs->fields[19] ;  
         $this->tp_status = (string)$this->tp_status;
         $this->tp_jenisproject = $rs->fields[20] ;  
         ...
         $this->tp_templateproject = $rs->fields[24] ;  
...
$_SESSION['scriptcase']['report_others_inregional']['contr_erro'] = 'off'; 
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inregional']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inregional']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inregional'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_others_inregional'][$path_doc_md5][1] = $this->Tit_doc;
?>
