...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['v_dashboard_lop']['show_skip_charts_option']) || !$_SESSION['sc_session']['v_dashboard_lop']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
