...
include_once('dashboard_curve_s_session.php');
@session_start();

$_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_perfil']          = "conn_mysql_1";
$_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_path_prod']       = "/libdemo/prod";
$_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_path_imagens']    = "/libdemo/file/img";
$_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_path_imag_temp']  = "/libdemo/tmp";
$_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_path_doc']        = "/var/www/html/tompsdemo";
...
if (!empty($_POST))
{
    foreach ($_POST as $nmgp_var => $nmgp_val)
    {
        ...
        nm_limpa_str_dashboard_curve_s($nmgp_val);
        $$nmgp_var = $nmgp_val;
    }
}
if (!empty($_GET))
...
if (isset($nmgp_parms) && !empty($nmgp_parms) && !is_array($nmgp_parms))
{
    ...
    while (!empty($todo[$ix]))
    {
       ...
       if (1 < sizeof($cadapar))
       {
           ...
           nm_limpa_str_dashboard_curve_s($cadapar[1]);
...
elseif (isset($script_case_init) && !empty($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['dashboard_curve_s']['parms']))
{
    if (!isset($nmgp_opcao) || ($nmgp_opcao != "incluir" && $nmgp_opcao != "novo" && $nmgp_opcao != "recarga" && $nmgp_opcao != "muda_form"))
    {
        $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['dashboard_curve_s']['parms']);
        $todo  = explode("?@?", $todox);
        $ix = 0;
        while (!empty($todo[$ix]))
        {
...
$dashboard_curve_s_control = new dashboard_curve_s_control();
$dashboard_curve_s_control->control();

class dashboard_curve_s_ini {
    ...
    function init()
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard_curve_s'])) {
            $_SESSION['sc_session'][$this->sc_page]['dashboard_curve_s'] = array();
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard_curve_s']['embutida_form'])) {
            $_SESSION['sc_session'][$this->sc_page]['dashboard_curve_s']['embutida_form'] = false;
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard_curve_s']['embutida_proc'])) {
            $_SESSION['sc_session'][$this->sc_page]['dashboard_curve_s']['embutida_proc'] = false;
        }
        if (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard_curve_s']['iframe_menu'])) {
            $_SESSION['sc_session'][$this->sc_page]['dashboard_curve_s']['iframe_menu'] = false;
        }

        $this->nm_cod_apl      = "dashboard_curve_s";
        $this->nm_nome_apl     = "";
        $this->nm_seguranca    = "";
        ...
        $this->nm_dt_criacao   = "20171125";
        $this->nm_hr_criacao   = "111629";
        $this->nm_autor_alt    = "admin";
        $this->nm_dt_ult_alt   = "20180304";
        $this->nm_hr_ult_alt   = "200519";
        ...
        //check prod
        if(empty($_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_path_prod']))
        {
            /*check prod*/$_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
        }
        //check img
        if(empty($_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_path_imagens']))
        {
            /*check img*/$_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
        }
        //check tmp
        if(empty($_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_path_imag_temp']))
        {
            /*check tmp*/$_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
        }
        //check doc
        if(empty($_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_path_doc']))
        {
            /*check doc*/$_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
        }
        ...
        $this->sc_protocolo   = "";
        $this->path_prod      = $_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_path_prod'];
        $this->path_imagens   = $_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_path_imagens'];
        $this->path_imag_temp = $_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_path_imag_temp'];
        $this->path_doc       = $_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_path_doc'];
        ...
        $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/dashboard_curve_s';
   ...
   {
      $con_devel             =  (isset($_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      ...
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_conexao']) && $_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_perfil']) && $_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['dashboard_curve_s']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['dashboard_curve_s']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      if (isset($_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_perfil'];
      }
      ...
      if (!$_SESSION['sc_session'][$this->sc_page]['dashboard_curve_s']['embutida_form'] || !$_SESSION['sc_session'][$this->sc_page]['dashboard_curve_s']['embutida_proc']) 
      {
...
// 
      ...
      {
         $_SESSION['sc_session'][$this->sc_page]['dashboard_curve_s']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['dashboard_curve_s']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['dashboard_curve_s']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
          {
              $_SESSION['sc_session'][$this->sc_page]['dashboard_curve_s']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['dashboard_curve_s']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['dashboard_curve_s']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['dashboard_curve_s']['SC_sep_date1'];
      }
// 
      if (!empty($this->nm_falta_var) || !empty($this->nm_falta_var_db) || $nm_crit_perfil)
      {
          ...
          echo "</table>";
          if (!$_SESSION['sc_session'][$this->sc_page]['dashboard_curve_s']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->sc_page]['dashboard_curve_s']['sc_outra_jan']) || $_SESSION['sc_session'][$this->sc_page]['dashboard_curve_s']['sc_outra_jan'] != 'dashboard_curve_s')) 
          { 
...
// 
  function conectDB()
  {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['dashboard_curve_s']['glo_nm_conexao'], $this->root . $this->path_prod, 'projectamo'); 
      } 
      else 
      { 
      ...
      if (in_array(strtolower($this->nm_tpbanco), $this->nm_bases_oracle))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['dashboard_curve_s']['decimal_db'] = "."; 
      } 
  }
...
} // dashboard_curve_s_ini

class dashboard_curve_s_control {
    ...
    function init()
    {
        if (!$this->Ini)
        {
            $this->Ini = new dashboard_curve_s_ini();
            $this->Ini->init();
        }
        ...
        $_SESSION['scriptcase']['sc_aba_iframe']['dashboard_curve_s'] = array(
        );

        $_SESSION['scriptcase']['dashboard_targets']['dashboard_curve_s'] = array();


        $_SESSION['scriptcase']['dashboard_scinit']['dashboard_curve_s'] = array();

        $_SESSION['scriptcase']['dashboard_scinit']['dashboard_curve_s']['dbifrm_widget1'] = rand(2, 10000);
        $_SESSION['scriptcase']['dashboard_scinit']['dashboard_curve_s']['dbifrm_widget2'] = rand(2, 10000);

        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard_curve_s'] = array();

        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard_curve_s']['chartplanrealisasidemo'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard_curve_s']['viewplanrealisasidemo'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
    ...
    function checkSecurity()
    {
        ...
        {
            $_SESSION['scriptcase']['sc_apl_seg']['dashboard_curve_s'] = "on";
        }

        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['dashboard_curve_s']) || $_SESSION['scriptcase']['sc_apl_seg']['dashboard_curve_s'] != "on")
        {
...
<head>
 ...
 <title>Average Plan vs Realisasi Project Witel <?php echo $_SESSION['kodewitel']; ?></title>
<?php
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="dashboard_curve_s_container_index.css" />
<?php
...
var scIframeSCInit = {};
<?php
        foreach ($_SESSION['scriptcase']['dashboard_scinit']['dashboard_curve_s'] as $sIframe => $iSCInit) {
?>
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR align="center" valign="middle">
        ...
        <TD class="scContainerHeaderFont">
          Average Plan vs Realisasi Project Witel <?php echo $_SESSION['kodewitel']; ?>
        </TD>
       </TR>
...
<div class='grid-stack'>
                <div  class="grid-stack-item" data-gs-x="1" data-gs-y="0" data-gs-width="9" data-gs-height="8"  data-gs-no-resize="1" data-gs-no-move="0" id="id-father-0">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-0">
                        <div class="widget-head widget-is-moveable" style="display:none">
                            ...
                            <a href="#" class="maximize" onclick="maximizeWidget('0');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Chart" /></a>
                            <h3 class="scContainerTitle">Chart</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none' id="id-div-iframe-0"><iframe id="id-iframe-0" name="dbifrm_widget1" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('chartplanrealisasidemo'); ?>/?script_case_session=<?php echo session_id(); ?>&script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard_curve_s"]["dbifrm_widget1"] ?>&under_dashboard=1&dashboard_app=dashboard_curve_s&own_widget=dbifrm_widget1&compact_mode=0"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="1" data-gs-y="8" data-gs-width="9" data-gs-height="8"  data-gs-no-resize="1" data-gs-no-move="0" id="id-father-1">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-1">
                        <div class="widget-head widget-is-moveable" style="display:none">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('1');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Data" /></a>
                            <h3 class="scContainerTitle">Data</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none' id="id-div-iframe-1"><iframe id="id-iframe-1" name="dbifrm_widget2" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('viewplanrealisasidemo'); ?>/?script_case_session=<?php echo session_id(); ?>&script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard_curve_s"]["dbifrm_widget2"] ?>&under_dashboard=1&dashboard_app=dashboard_curve_s&own_widget=dbifrm_widget2&compact_mode=0"></iframe></div>
                    </div>
                </div></div>
 ...
 <table style="width: 100%" class="scGridTabela">
  <tr class="scGridFieldOdd">
   <td class="scGridFieldOddFont" style="padding: 15px 30px; text-align: center">
    ...
    <br />
    <form name="Fsenha" method="post" action="dashboard_curve_s.php">
...
} // dashboard_curve_s_control

function nm_limpa_str_dashboard_curve_s(&$str)
{
