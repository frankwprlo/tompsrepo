...
class dashboard_seventypersen_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_v_project_lokasi_md_kodedatel;
   var $array_total_v_project_lokasi_tj_namajenis;
   ...
   var $conv_col;
   var $count_ger;
   var $sum_v_project_lokasi_tp_odp;
   var $sc_proc_quebra_v_project_lokasi_md_kodedatel;
   var $count_v_project_lokasi_md_kodedatel;
   var $sum_v_project_lokasi_md_kodedatel_v_project_lokasi_tp_odp;
   var $sc_proc_quebra_v_project_lokasi_tj_namajenis;
   var $count_v_project_lokasi_tj_namajenis;
   var $sum_v_project_lokasi_tj_namajenis_v_project_lokasi_tp_odp;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_v_project_lokasi_md_kodedatel = array();
      $this->array_total_v_project_lokasi_tj_namajenis = array();
   ...
   function initializeButtons()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['dashboard_seventypersen'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['dashboard_seventypersen'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['dashboard_seventypersen']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['dashboard_seventypersen']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['dashboard_seventypersen']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['campos_busca'];
         if ($_SESSION['scriptcase']['charset'] != "UTF-8")
         {
             $Busca_temp = NM_conv_charset($Busca_temp, $_SESSION['scriptcase']['charset'], "UTF-8");
         }
       $this->v_project_lokasi_tj_namajenis = $Busca_temp['v_project_lokasi_tj_namajenis']; 
       $tmp_pos = strpos($this->v_project_lokasi_tj_namajenis, "##@@");
       if ($tmp_pos !== false && !is_array($this->v_project_lokasi_tj_namajenis))
       {
           $this->v_project_lokasi_tj_namajenis = substr($this->v_project_lokasi_tj_namajenis, 0, $tmp_pos);
       }
       $this->v_project_lokasi_mw_kodewitel = $Busca_temp['v_project_lokasi_mw_kodewitel']; 
       $tmp_pos = strpos($this->v_project_lokasi_mw_kodewitel, "##@@");
       if ($tmp_pos !== false && !is_array($this->v_project_lokasi_mw_kodewitel))
       {
           $this->v_project_lokasi_mw_kodewitel = substr($this->v_project_lokasi_mw_kodewitel, 0, $tmp_pos);
       }
       $this->v_project_lokasi_md_kodedatel = $Busca_temp['v_project_lokasi_md_kodedatel']; 
       $tmp_pos = strpos($this->v_project_lokasi_md_kodedatel, "##@@");
       if ($tmp_pos !== false && !is_array($this->v_project_lokasi_md_kodedatel))
       {
           $this->v_project_lokasi_md_kodedatel = substr($this->v_project_lokasi_md_kodedatel, 0, $tmp_pos);
       }
       $this->v_proses_closing_tpp_idproject = $Busca_temp['v_proses_closing_tpp_idproject']; 
       $tmp_pos = strpos($this->v_proses_closing_tpp_idproject, "##@@");
       if ($tmp_pos !== false && !is_array($this->v_proses_closing_tpp_idproject))
       {
           $this->v_proses_closing_tpp_idproject = substr($this->v_proses_closing_tpp_idproject, 0, $tmp_pos);
       }
       $v_proses_closing_tpp_idproject_2 = $Busca_temp['v_proses_closing_tpp_idproject_input_2']; 
       $this->v_proses_closing_tpp_idproject_2 = $Busca_temp['v_proses_closing_tpp_idproject_input_2']; 
     } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['opcao'] != "pdf")
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['contr_total_geral'] == "OK")
      {
          $this->array_total_v_project_lokasi_md_kodedatel = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['arr_total']['v_project_lokasi_md_kodedatel'];
          $this->array_total_v_project_lokasi_tj_namajenis = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['arr_total']['v_project_lokasi_tj_namajenis'];
      }
      else
      {
          $this->array_total_v_project_lokasi_md_kodedatel = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['arr_total']['v_project_lokasi_md_kodedatel'] = $this->array_total_v_project_lokasi_md_kodedatel;
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['arr_total']['v_project_lokasi_tj_namajenis'] = $this->array_total_v_project_lokasi_tj_namajenis;
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $Lab_v_project_lokasi_md_kodedatel = "MD KODEDATEL";
       $Lab_v_project_lokasi_tj_namajenis = "TJ NAMAJENIS";
       $this->comp_field = array(
           $Lab_v_project_lokasi_md_kodedatel,
           $Lab_v_project_lokasi_tj_namajenis,
       );

       //-----
       $this->comp_field_nm = array(
           'v_project_lokasi_md_kodedatel' => 0,
           'v_project_lokasi_tj_namajenis' => 1,
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['summarizing_fields_order']['groupbyone']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['summarizing_fields_order']['groupbyone'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['summarizing_fields_order']['groupbyone'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['summarizing_fields_display']['groupbyone'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['summarizing_fields_display']['groupbyone'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['summarizing_fields_display']['groupbyone'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['summarizing_fields_display']['groupbyone'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['summarizing_fields_display']['groupbyone'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['summarizing_fields_display']['groupbyone'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['summarizing_fields_display']['groupbyone'] as $i_sum => $d_sum)
           {
       ...
       $this->comp_sum_lnk = array(
           ...
           3 => array('field' => "v_project_lokasi_tp_odp", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css___nm_count_nm___cnt",
           3 => "css_v_project_lokasi_tp_odp_sum",
       );

       //-----
       foreach ($this->array_total_v_project_lokasi_md_kodedatel as $i_v_project_lokasi_md_kodedatel => $d_v_project_lokasi_md_kodedatel) {
           if (!in_array($i_v_project_lokasi_md_kodedatel, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_v_project_lokasi_md_kodedatel[4] ] = $d_v_project_lokasi_md_kodedatel[3];
               $this->comp_label[0][ $d_v_project_lokasi_md_kodedatel[4] ] = $d_v_project_lokasi_md_kodedatel[3];
           }
           foreach ($this->array_total_v_project_lokasi_tj_namajenis[$i_v_project_lokasi_md_kodedatel] as $i_v_project_lokasi_tj_namajenis => $d_v_project_lokasi_tj_namajenis) {
               if (!in_array($i_v_project_lokasi_tj_namajenis, $this->comp_label[1][ $d_v_project_lokasi_md_kodedatel[4] ], true)) {
                   $this->comp_index[1][ $d_v_project_lokasi_tj_namajenis[4] ] = $d_v_project_lokasi_tj_namajenis[3];
                   $this->comp_label[1][ $d_v_project_lokasi_md_kodedatel[4] ][ $d_v_project_lokasi_tj_namajenis[4] ] = $d_v_project_lokasi_tj_namajenis[3];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'V_PROJECT_LOKASI.MD_KODEDATEL', 'prot' => '@aspass@'),
           array('name' => 'V_PROJECT_LOKASI.TJ_NAMAJENIS', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_v_project_lokasi_md_kodedatel => $l_v_project_lokasi_md_kodedatel) {
           if (isset($this->array_total_v_project_lokasi_md_kodedatel[$i_v_project_lokasi_md_kodedatel])) {
               $this->comp_group[$i_v_project_lokasi_md_kodedatel] = array();
           }
           foreach ($this->comp_label[1][$i_v_project_lokasi_md_kodedatel] as $i_v_project_lokasi_tj_namajenis => $l_v_project_lokasi_tj_namajenis) {
               if (isset($this->array_total_v_project_lokasi_tj_namajenis[$i_v_project_lokasi_md_kodedatel][$i_v_project_lokasi_tj_namajenis])) {
                   $this->comp_group[$i_v_project_lokasi_md_kodedatel][$i_v_project_lokasi_tj_namajenis] = array();
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_v_project_lokasi_md_kodedatel;
       }
       elseif (1 == $level) {
           $return = $this->array_total_v_project_lokasi_tj_namajenis;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@dashboard_seventypersen@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   function drawMatrixLabels()
   {
       ...
       $apl_cab_resumo = "Jenis Project / Datel";
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['pivot_order_start'][$iYAxysIndex])
                       {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['dashboard_seventypersen']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['dashboard_seventypersen']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['dashboard_seventypersen']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['dashboard_seventypersen']) . "_";
               } 
           }
       }
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "dashboard_seventypersen_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['print_all'];
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['opcao'] = "print";
      ...
      $this->Total   = new dashboard_seventypersen_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_groupbyone("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_v_project_lokasi_md_kodedatel);
      ksort($this->array_total_v_project_lokasi_tj_namajenis);
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>List Pencapaian Project >75% Lokasi Witel " . $_SESSION['kodewitel'] . "</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"dashboard_seventypersen_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"dashboard_seventypersen_jquery.js\"></script>\r\n");
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_dashboard_seventypersen_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_dashboard_seventypersen_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_dashboard_seventypersen_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['num_css'] . '.css');
     ...
     else
     {
      ...
      $nm_saida->saida(" </style>\r\n");
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "dashboard_seventypersen/dashboard_seventypersen_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['opcao'] == "pdf")
      { 
              $nm_saida->saida("  <div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">Jenis Project / Datel</H1></div>\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'dashboard_seventypersen_config_pivot.php?nome_apl=dashboard_seventypersen&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   </form> \r\n");
      ...
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['dashboard_seventypersen_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@dashboard_seventypersen@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
      $nm_saida->saida("  if (\"pdf\" == x)\r\n");
      $nm_saida->saida("  {\r\n");
      $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "dashboard_seventypersen/dashboard_seventypersen_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_create_charts=\" + crt + \"&sc_graf_pdf=\" + g;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_dashboard_seventypersen_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "dashboard_seventypersen/dashboard_seventypersen_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $v_project_lokasi_tj_namajenis = $Busca_temp['v_project_lokasi_tj_namajenis']; 
          $tmp_pos = strpos($v_project_lokasi_tj_namajenis, "##@@");
          if ($tmp_pos !== false && !is_array($v_project_lokasi_tj_namajenis))
          {
              $v_project_lokasi_tj_namajenis = substr($v_project_lokasi_tj_namajenis, 0, $tmp_pos);
          }
          $v_project_lokasi_mw_kodewitel = $Busca_temp['v_project_lokasi_mw_kodewitel']; 
          $tmp_pos = strpos($v_project_lokasi_mw_kodewitel, "##@@");
          if ($tmp_pos !== false && !is_array($v_project_lokasi_mw_kodewitel))
          {
              $v_project_lokasi_mw_kodewitel = substr($v_project_lokasi_mw_kodewitel, 0, $tmp_pos);
          }
          $v_project_lokasi_md_kodedatel = $Busca_temp['v_project_lokasi_md_kodedatel']; 
          $tmp_pos = strpos($v_project_lokasi_md_kodedatel, "##@@");
          if ($tmp_pos !== false && !is_array($v_project_lokasi_md_kodedatel))
          {
              $v_project_lokasi_md_kodedatel = substr($v_project_lokasi_md_kodedatel, 0, $tmp_pos);
          }
          $v_proses_closing_tpp_idproject = $Busca_temp['v_proses_closing_tpp_idproject']; 
          $tmp_pos = strpos($v_proses_closing_tpp_idproject, "##@@");
          if ($tmp_pos !== false && !is_array($v_proses_closing_tpp_idproject))
          {
              $v_proses_closing_tpp_idproject = substr($v_proses_closing_tpp_idproject, 0, $tmp_pos);
          }
          $v_proses_closing_tpp_idproject_2 = $Busca_temp['v_proses_closing_tpp_idproject_input_2']; 
      } 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['cond_pesq'], 0, $trab_pos);
      ...
      $nm_saida->saida("          List Pencapaian Project >75% Lokasi Witel " . $_SESSION['kodewitel'] . "\r\n");
      $nm_saida->saida("        </TD>\r\n");
      $nm_saida->saida("       </TR>\r\n");
   ...
   //---- 
   function adiciona_registro($sum_v_project_lokasi_tp_odp, $quebra_v_project_lokasi_md_kodedatel, $quebra_v_project_lokasi_tj_namajenis, $quebra_v_project_lokasi_md_kodedatel_orig, $quebra_v_project_lokasi_tj_namajenis_orig)
   {
      //----- MD KODEDATEL
      if (!isset($this->array_total_v_project_lokasi_md_kodedatel[$quebra_v_project_lokasi_md_kodedatel_orig]))
      {
         $this->array_total_v_project_lokasi_md_kodedatel[$quebra_v_project_lokasi_md_kodedatel_orig][0] = 1;
         $this->array_total_v_project_lokasi_md_kodedatel[$quebra_v_project_lokasi_md_kodedatel_orig][1] = $sum_v_project_lokasi_tp_odp;
         $this->array_total_v_project_lokasi_md_kodedatel[$quebra_v_project_lokasi_md_kodedatel_orig][2] = 1;
         $this->array_total_v_project_lokasi_md_kodedatel[$quebra_v_project_lokasi_md_kodedatel_orig][3] = $quebra_v_project_lokasi_md_kodedatel;
         $this->array_total_v_project_lokasi_md_kodedatel[$quebra_v_project_lokasi_md_kodedatel_orig][4] = $quebra_v_project_lokasi_md_kodedatel_orig;
      }
      else
      {
         $this->array_total_v_project_lokasi_md_kodedatel[$quebra_v_project_lokasi_md_kodedatel_orig][0]++;
         $this->array_total_v_project_lokasi_md_kodedatel[$quebra_v_project_lokasi_md_kodedatel_orig][1] += $sum_v_project_lokasi_tp_odp;
         $this->array_total_v_project_lokasi_md_kodedatel[$quebra_v_project_lokasi_md_kodedatel_orig][2]++;
      }
      //----- TJ NAMAJENIS
      if (!isset($this->array_total_v_project_lokasi_tj_namajenis[$quebra_v_project_lokasi_md_kodedatel_orig][$quebra_v_project_lokasi_tj_namajenis_orig]))
      {
         $this->array_total_v_project_lokasi_tj_namajenis[$quebra_v_project_lokasi_md_kodedatel_orig][$quebra_v_project_lokasi_tj_namajenis_orig][0] = 1;
         $this->array_total_v_project_lokasi_tj_namajenis[$quebra_v_project_lokasi_md_kodedatel_orig][$quebra_v_project_lokasi_tj_namajenis_orig][1] = $sum_v_project_lokasi_tp_odp;
         $this->array_total_v_project_lokasi_tj_namajenis[$quebra_v_project_lokasi_md_kodedatel_orig][$quebra_v_project_lokasi_tj_namajenis_orig][2] = 1;
         $this->array_total_v_project_lokasi_tj_namajenis[$quebra_v_project_lokasi_md_kodedatel_orig][$quebra_v_project_lokasi_tj_namajenis_orig][3] = $quebra_v_project_lokasi_tj_namajenis;
         $this->array_total_v_project_lokasi_tj_namajenis[$quebra_v_project_lokasi_md_kodedatel_orig][$quebra_v_project_lokasi_tj_namajenis_orig][4] = $quebra_v_project_lokasi_tj_namajenis_orig;
      }
      else
      {
         $this->array_total_v_project_lokasi_tj_namajenis[$quebra_v_project_lokasi_md_kodedatel_orig][$quebra_v_project_lokasi_tj_namajenis_orig][0]++;
         $this->array_total_v_project_lokasi_tj_namajenis[$quebra_v_project_lokasi_md_kodedatel_orig][$quebra_v_project_lokasi_tj_namajenis_orig][1] += $sum_v_project_lokasi_tp_odp;
         $this->array_total_v_project_lokasi_tj_namajenis[$quebra_v_project_lokasi_md_kodedatel_orig][$quebra_v_project_lokasi_tj_namajenis_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT V_PROJECT_LOKASI.TJ_NAMAJENIS as v_project_lokasi_tj_namajenis, V_PROJECT_LOKASI.MW_KODEWITEL as v_project_lokasi_mw_kodewitel, V_PROJECT_LOKASI.MD_KODEDATEL as v_project_lokasi_md_kodedatel, V_PROSES_CLOSING.TPP_IDPROJECT as v_proses_closing_tpp_idproject, V_PROJECT_LOKASI.TP_ODP as v_project_lokasi_tp_odp from " . $this->Ini->nm_tabela; 
     } 
     ...
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['dashboard_seventypersen']['where_pesq']; 
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'v_project_lokasi_md_kodedatel');
     $campos_order = $this->Ini->Get_date_order_groupby("V_PROJECT_LOKASI.MD_KODEDATEL", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'v_project_lokasi_tj_namajenis');
     $campos_order = $this->Ini->Get_date_order_groupby("V_PROJECT_LOKASI.TJ_NAMAJENIS", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->v_project_lokasi_tj_namajenis = $rs_res->fields[0] ;  
            $this->v_project_lokasi_mw_kodewitel = $rs_res->fields[1] ;  
            $this->v_project_lokasi_md_kodedatel = $rs_res->fields[2] ;  
            $this->v_proses_closing_tpp_idproject = $rs_res->fields[3] ;  
            $this->v_project_lokasi_tp_odp = $rs_res->fields[4] ;  
            $this->v_project_lokasi_md_kodedatel_orig = $this->v_project_lokasi_md_kodedatel;
            $this->v_project_lokasi_tj_namajenis_orig = $this->v_project_lokasi_tj_namajenis;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->v_project_lokasi_tp_odp, $this->v_project_lokasi_md_kodedatel, $this->v_project_lokasi_tj_namajenis, $this->v_project_lokasi_md_kodedatel_orig,  $this->v_project_lokasi_tj_namajenis_orig);
            }
   }
//
