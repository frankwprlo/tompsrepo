<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new dashboard_seventypersen_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class dashboard_seventypersen_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['v_project_lokasi_tj_namajenis'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['v_project_lokasi_tj_namajenis'] = "v_project_lokasi_tj_namajenis";
       $tab_converte["v_project_lokasi_tj_namajenis"]   = "v_project_lokasi_tj_namajenis";
   }
   else
   {
       $tab_def_campos['v_project_lokasi_tj_namajenis'] = "V_PROJECT_LOKASI.TJ_NAMAJENIS";
       $tab_converte["V_PROJECT_LOKASI.TJ_NAMAJENIS"]   = "v_project_lokasi_tj_namajenis";
   }
   $tab_labels["v_project_lokasi_tj_namajenis"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_seventypersen']['labels']["v_project_lokasi_tj_namajenis"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_seventypersen']['labels']["v_project_lokasi_tj_namajenis"] : "TJ NAMAJENIS";
   $tab_ger_campos['v_project_lokasi_mw_kodewitel'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['v_project_lokasi_mw_kodewitel'] = "v_project_lokasi_mw_kodewitel";
       $tab_converte["v_project_lokasi_mw_kodewitel"]   = "v_project_lokasi_mw_kodewitel";
   }
   else
   {
       $tab_def_campos['v_project_lokasi_mw_kodewitel'] = "V_PROJECT_LOKASI.MW_KODEWITEL";
       $tab_converte["V_PROJECT_LOKASI.MW_KODEWITEL"]   = "v_project_lokasi_mw_kodewitel";
   }
   $tab_labels["v_project_lokasi_mw_kodewitel"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_seventypersen']['labels']["v_project_lokasi_mw_kodewitel"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_seventypersen']['labels']["v_project_lokasi_mw_kodewitel"] : "MW KODEWITEL";
   $tab_ger_campos['v_project_lokasi_md_kodedatel'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['v_project_lokasi_md_kodedatel'] = "v_project_lokasi_md_kodedatel";
       $tab_converte["v_project_lokasi_md_kodedatel"]   = "v_project_lokasi_md_kodedatel";
   }
   else
   {
       $tab_def_campos['v_project_lokasi_md_kodedatel'] = "V_PROJECT_LOKASI.MD_KODEDATEL";
       $tab_converte["V_PROJECT_LOKASI.MD_KODEDATEL"]   = "v_project_lokasi_md_kodedatel";
   }
   $tab_labels["v_project_lokasi_md_kodedatel"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_seventypersen']['labels']["v_project_lokasi_md_kodedatel"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_seventypersen']['labels']["v_project_lokasi_md_kodedatel"] : "MD KODEDATEL";
   $tab_ger_campos['v_proses_closing_tpp_idproject'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['v_proses_closing_tpp_idproject'] = "v_proses_closing_tpp_idproject";
       $tab_converte["v_proses_closing_tpp_idproject"]   = "v_proses_closing_tpp_idproject";
   }
   else
   {
       $tab_def_campos['v_proses_closing_tpp_idproject'] = "V_PROSES_CLOSING.TPP_IDPROJECT";
       $tab_converte["V_PROSES_CLOSING.TPP_IDPROJECT"]   = "v_proses_closing_tpp_idproject";
   }
   $tab_labels["v_proses_closing_tpp_idproject"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_seventypersen']['labels']["v_proses_closing_tpp_idproject"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_seventypersen']['labels']["v_proses_closing_tpp_idproject"] : "TPP IDPROJECT";
   $tab_ger_campos['v_project_lokasi_tp_odp'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['v_project_lokasi_tp_odp'] = "v_project_lokasi_tp_odp";
       $tab_converte["v_project_lokasi_tp_odp"]   = "v_project_lokasi_tp_odp";
   }
   else
   {
       $tab_def_campos['v_project_lokasi_tp_odp'] = "V_PROJECT_LOKASI.TP_ODP";
       $tab_converte["V_PROJECT_LOKASI.TP_ODP"]   = "v_project_lokasi_tp_odp";
   }
   $tab_labels["v_project_lokasi_tp_odp"]   = (isset($_SESSION['sc_session'][$sc_init]['dashboard_seventypersen']['labels']["v_project_lokasi_tp_odp"])) ? $_SESSION['sc_session'][$sc_init]['dashboard_seventypersen']['labels']["v_project_lokasi_tp_odp"] : "TP ODP";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['dashboard_seventypersen']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['dashboard_seventypersen']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['dashboard_seventypersen']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['dashboard_seventypersen']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['dashboard_seventypersen']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['dashboard_seventypersen']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['dashboard_seventypersen']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['dashboard_seventypersen']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['dashboard_seventypersen']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['dashboard_seventypersen']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['dashboard_seventypersen']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['dashboard_seventypersen']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "dashboard_seventypersen_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['dashboard_seventypersen']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['dashboard_seventypersen']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
