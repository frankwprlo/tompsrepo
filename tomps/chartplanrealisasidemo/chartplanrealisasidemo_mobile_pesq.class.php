...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "nilai";$Nm_numeric[] = "nilai";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_keterangan"  <?php echo $str_hide_keterangan?>><?php
      if ($keterangan != "")
      {
      $keterangan_look = substr($this->Db->qstr($keterangan), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_nilai"  <?php echo $str_hide_nilai?>><?php
      if ($nilai != "")
      {
      $nilai_look = substr($this->Db->qstr($nilai), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nilai" name="nilai_autocomp" size="22" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_nilai"  <?php echo $str_display_nilai; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_nilai_input_2" name="nilai_input_2" value="<?php echo NM_encode_input($nilai_input_2) ?>" size=22 alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
