...
class chartplanrealisasidemo_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_keterangan;
   var $array_total_nomortahapan;
   ...
   var $sum_keterangan_nilai;
   var $sc_proc_quebra_nomortahapan;
   var $count_nomortahapan;
   var $sum_nomortahapan_nilai;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_keterangan   = array();
      $this->array_total_nomortahapan = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['dashboard_info']['under_dashboard'] ? "off" : "on";
      $this->nmgp_botoes['chart_detail'] = "on";
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['dashboard_info']['under_dashboard'] ? "off" : "on";

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['chartplanrealisasidemo'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['chartplanrealisasidemo'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chartplanrealisasidemo']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['chartplanrealisasidemo']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['chartplanrealisasidemo']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca'];
       ...
       $this->nilai = $Busca_temp['nilai']; 
       $tmp_pos = strpos($this->nilai, "##@@");
       if ($tmp_pos !== false && !is_array($this->nilai))
       {
           $this->nilai = substr($this->nilai, 0, $tmp_pos);
       }
       $nilai_2 = $Busca_temp['nilai_input_2']; 
       $this->nilai_2 = $Busca_temp['nilai_input_2']; 
     } 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['contr_total_geral'] == "OK")
      {
          $this->array_total_keterangan = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['arr_total']['keterangan'];
          $this->array_total_nomortahapan = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['arr_total']['nomortahapan'];
      }
      else
      {
          $this->array_total_keterangan = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['tot_geral'][1] == 0)
      {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['arr_total']['keterangan'] = $this->array_total_keterangan;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['arr_total']['nomortahapan'] = $this->array_total_nomortahapan;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $Lab_keterangan = "KETERANGAN";
       $Lab_nomortahapan = "Nomor-Tahapan";
       $this->comp_field = array(
           $Lab_keterangan,
           $Lab_nomortahapan,
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['summarizing_fields_order']['demo']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['summarizing_fields_order']['demo'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['summarizing_fields_order']['demo'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['summarizing_fields_display']['demo'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['summarizing_fields_display']['demo'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['summarizing_fields_display']['demo'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['summarizing_fields_display']['demo'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['summarizing_fields_display']['demo'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['summarizing_fields_display']['demo'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['summarizing_fields_display']['demo'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_keterangan as $i_keterangan => $d_keterangan) {
           if (!in_array($i_keterangan, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_keterangan[3] ] = $d_keterangan[2];
               $this->comp_label[0][ $d_keterangan[3] ] = $d_keterangan[2];
           }
           foreach ($this->array_total_nomortahapan[$i_keterangan] as $i_nomortahapan => $d_nomortahapan) {
               if (!in_array($i_nomortahapan, $this->comp_label[1][ $d_keterangan[3] ], true)) {
                   $this->comp_index[1][ $d_nomortahapan[3] ] = $d_nomortahapan[2];
                   $this->comp_label[1][ $d_keterangan[3] ][ $d_nomortahapan[3] ] = $d_nomortahapan[2];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'keterangan', 'prot' => '@aspass@'),
           array('name' => 'nomortahapan', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_keterangan => $l_keterangan) {
           if (isset($this->array_total_keterangan[$i_keterangan])) {
               $this->comp_group[$i_keterangan] = array();
           }
           foreach ($this->comp_label[1][$i_keterangan] as $i_nomortahapan => $l_nomortahapan) {
               if (isset($this->array_total_nomortahapan[$i_keterangan][$i_nomortahapan])) {
                   $this->comp_group[$i_keterangan][$i_nomortahapan] = array();
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_keterangan;
       }
       elseif (1 == $level) {
           $return = $this->array_total_nomortahapan;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@chartplanrealisasidemo@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           'T|1' => array(
               'title'    => $this->getChartText("Curve-s Target vs Realisasi"),
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Posisi"),
               'label_y'  => $this->getChartText("Milestone(days)"),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['anlt_table_def']  = array();
   }
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_chartplanrealisasidemo_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_chartplanrealisasidemo_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['arr_export']['data']  = $this->build_data;
           return;
       }
   ...
   function drawMatrixLabels()
   {
       ...
       $apl_cab_resumo = "Tahapan Project";
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_order_start'][$iYAxysIndex])
                       {
   ...
   function resumo_init()
   {
      ...
      $this->monta_html_ini();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
      {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chartplanrealisasidemo']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chartplanrealisasidemo']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chartplanrealisasidemo']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chartplanrealisasidemo']) . "_";
               } 
           }
       }
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['ajax_nav'])
      {
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "chartplanrealisasidemo_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['print_all'];
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['opcao'] = "print";
      ...
      $this->Total   = new chartplanrealisasidemo_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_demo("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_keterangan);
      ksort($this->array_total_nomortahapan);
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['responsive_chart']['active']) {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chartplanrealisasidemo_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chartplanrealisasidemo_jquery.js\"></script>\r\n");
      ...
      {
          $sFusionChartModule = $this->Graf->getChartModule('Line');
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chartplanrealisasidemo_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_chartplanrealisasidemo_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chartplanrealisasidemo_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['num_css'] . '.css');
     ...
     else
     {
      ...
      $nm_saida->saida(" </style>\r\n");
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "chartplanrealisasidemo/chartplanrealisasidemo_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['opcao'] == "pdf")
      { 
              $nm_saida->saida("  <div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">Tahapan Project</H1></div>\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['embutida'])
      {
         ...
         $NM_btn = false;
         if (is_file("chartplanrealisasidemo_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("chartplanrealisasidemo_help.txt"); 
   ...
   function monta_html_fim()
   {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['graf_pdf'] == "S")
      {
          $this->grafico_pdf();
      }
      else
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'chartplanrealisasidemo_config_pivot.php?nome_apl=chartplanrealisasidemo&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   </form> \r\n");
      ...
      if (!extension_loaded("zip"))
      {
          ...
          $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['chartplanrealisasidemo_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@chartplanrealisasidemo@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
          $nm_saida->saida("  if (\"pdf\" == x)\r\n");
          $nm_saida->saida("  {\r\n");
          $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "chartplanrealisasidemo/chartplanrealisasidemo_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_create_charts=\" + crt + \"&sc_graf_pdf=\" + g;\r\n");
          $nm_saida->saida("  }\r\n");
          $nm_saida->saida("  else\r\n");
          $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chartplanrealisasidemo_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "chartplanrealisasidemo/chartplanrealisasidemo_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['skip_charts']))
   {
      ...
      if (!isset($this->progress_fp) || !$this->progress_fp)
      {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_charts'] as $chart_index => $chart_data)
       {
           if (!$prim_graf)
           {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['chart_list']))
   {
       $prim_graf = true;
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['chart_list'] as $arr_chart)
       {
           if (!$prim_graf)
           {
               $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
...
//--- 
 function grafico_bot()
 {
   global $nm_saida;
   $bPDF = false;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new chartplanrealisasidemo_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
      ...
      if (isset($_POST['nmgp_opcao']) && 'ajax_navigate' == $_POST['nmgp_opcao'] && isset($_POST['opc']) && 'resumo' == $_POST['opc']) {
          $_SESSION['scriptcase']['tmp_saida_html'] = $_SESSION['scriptcase']['saida_html'];
          $_SESSION['scriptcase']['saida_html']     = '';
      }
       $nm_saida->saida("<TR>\r\n");
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['pivot_charts']);
       $sChartLang  = isset($this->Ini->Nm_lang['lang_pdff_pcht']) ? $this->Ini->Nm_lang['lang_pdff_pcht'] : 'Generating chart';
       if (!NM_is_utf8($sChartLang))
       {
           $sChartLang = sc_convert_encoding($sChartLang, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
       ...
       $nm_saida->saida("</TR>\r\n");
      if (isset($_POST['nmgp_opcao']) && 'ajax_navigate' == $_POST['nmgp_opcao'] && isset($_POST['opc']) && 'resumo' == $_POST['opc']) {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['new_charts'] = $_SESSION['scriptcase']['saida_html'];
          $_SESSION['scriptcase']['saida_html'] = $_SESSION['scriptcase']['tmp_saida_html'];
          unset($_SESSION['scriptcase']['tmp_saida_html']);
      }
       $nm_saida->saida("</TABLE>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_nilai, $quebra_keterangan, $quebra_nomortahapan, $quebra_keterangan_orig, $quebra_nomortahapan_orig)
   {
      //----- KETERANGAN
      if (!isset($this->array_total_keterangan[$quebra_keterangan_orig]))
      {
         $this->array_total_keterangan[$quebra_keterangan_orig][0] = 1;
         $this->array_total_keterangan[$quebra_keterangan_orig][1] = $sum_nilai;
         $this->array_total_keterangan[$quebra_keterangan_orig][2] = $quebra_keterangan;
         $this->array_total_keterangan[$quebra_keterangan_orig][3] = $quebra_keterangan_orig;
      }
      else
      {
         $this->array_total_keterangan[$quebra_keterangan_orig][0]++;
         $this->array_total_keterangan[$quebra_keterangan_orig][1] += $sum_nilai;
      }
      //----- Nomor-Tahapan
      if (!isset($this->array_total_nomortahapan[$quebra_keterangan_orig][$quebra_nomortahapan_orig]))
      {
         $this->array_total_nomortahapan[$quebra_keterangan_orig][$quebra_nomortahapan_orig][0] = 1;
         $this->array_total_nomortahapan[$quebra_keterangan_orig][$quebra_nomortahapan_orig][1] = $sum_nilai;
         $this->array_total_nomortahapan[$quebra_keterangan_orig][$quebra_nomortahapan_orig][2] = $quebra_nomortahapan;
         $this->array_total_nomortahapan[$quebra_keterangan_orig][$quebra_nomortahapan_orig][3] = $quebra_nomortahapan_orig;
      }
      else
      {
         $this->array_total_nomortahapan[$quebra_keterangan_orig][$quebra_nomortahapan_orig][0]++;
         $this->array_total_nomortahapan[$quebra_keterangan_orig][$quebra_nomortahapan_orig][1] += $sum_nilai;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT NOMORTAHAPAN, KETERANGAN, NILAI from " . $this->Ini->nm_tabela; 
     } 
     ...
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['where_pesq']; 
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'keterangan');
     $campos_order = $this->Ini->Get_date_order_groupby("KETERANGAN", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'nomortahapan');
     $campos_order = $this->Ini->Get_date_order_groupby("NOMORTAHAPAN", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->nomortahapan = $rs_res->fields[0] ;  
            $this->keterangan = $rs_res->fields[1] ;  
            $this->nilai = $rs_res->fields[2] ;  
            $_SESSION['scriptcase']['chartplanrealisasidemo']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['chartplanrealisasidemo']['contr_erro'] = 'off'; 
            $this->keterangan_orig = $this->keterangan;
            $this->nomortahapan_orig = $this->nomortahapan;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->nilai, $this->keterangan, $this->nomortahapan, $this->keterangan_orig,  $this->nomortahapan_orig);
            }
   }
//
