...
class chartplanrealisasidemo_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['opcao'] = "igual";
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . chartplanrealisasidemo_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . chartplanrealisasidemo_pack_protect_string($Tipo_filter[0]) . "\">.." . chartplanrealisasidemo_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_keterangan')
      {
          $keterangan = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_keterangan($keterangan);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nilai')
      {
          $nilai = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nilai($nilai);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_keterangan($keterangan)
   {
      $keterangan = substr($this->Db->qstr($keterangan), 1, -1);
            $keterangan_look = substr($this->Db->qstr($keterangan), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct KETERANGAN from " . $this->Ini->nm_tabela . " where  KETERANGAN like '%" . $keterangan . "%' order by KETERANGAN"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_nilai($nilai)
   {
      $nilai = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $nilai);
      $nilai = substr($this->Db->qstr($nilai), 1, -1);
            $nilai_look = substr($this->Db->qstr($nilai), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct NILAI from " . $this->Ini->nm_tabela . " where   CAST (NILAI AS TEXT)  like '%" . $nilai . "%' order by NILAI"; 
      }
      else
      {
          $nm_comando = "select distinct NILAI from " . $this->Ini->nm_tabela . " where  NILAI like '%" . $nilai . "%' order by NILAI"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>chartplanrealisasidemo/chartplanrealisasidemo_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="chartplanrealisasidemo_ajax_search.js"></script>
 <script type="text/javascript" src="chartplanrealisasidemo_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_keterangan_cond#NMF#' + search_get_sel_txt('SC_keterangan_cond') + '@NMF@';
  str_out += 'SC_keterangan#NMF#' + search_get_text('SC_keterangan') + '@NMF@';
  str_out += 'id_ac_keterangan#NMF#' + search_get_text('id_ac_keterangan') + '@NMF@';
  str_out += 'SC_nilai_cond#NMF#' + search_get_sel_txt('SC_nilai_cond') + '@NMF@';
  str_out += 'SC_nilai#NMF#' + search_get_text('SC_nilai') + '@NMF@';
  str_out += 'id_ac_nilai#NMF#' + search_get_text('id_ac_nilai') + '@NMF@';
  str_out += 'SC_nilai_input_2#NMF#' + search_get_text('SC_nilai_input_2') + '@NMF@';
   ...
   $("#id_ac_keterangan").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_keterangan",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_keterangan").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_keterangan").val( $(this).val() );
       }
     }
   });
   $("#id_ac_nilai").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nilai",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_nilai").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_nilai").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Curve-S</span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $keterangan_cond, $keterangan, $keterangan_autocomp,
             $nilai_cond, $nilai, $nilai_input_2, $nilai_autocomp,
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $nomortahapan = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca']['nomortahapan']; 
          $nomortahapan_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca']['nomortahapan_cond']; 
          $keterangan = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca']['keterangan']; 
          $keterangan_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca']['keterangan_cond']; 
          $nilai = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca']['nilai']; 
          $nilai_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca']['nilai_input_2']; 
          $nilai_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca']['nilai_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca']['NM_operador']; 
      } 
      if (!isset($nomortahapan_cond) || empty($nomortahapan_cond))
      {
         $nomortahapan_cond = "qp";
      }
      if (!isset($keterangan_cond) || empty($keterangan_cond))
      {
         $keterangan_cond = "qp";
      }
      if (!isset($nilai_cond) || empty($nilai_cond))
      {
         $nilai_cond = "gt";
      }
      ...
      $str_hide_keterangan = (in_array($keterangan_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nilai = (in_array($nilai_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_nilai = ('bw' == $nilai_cond) ? $display_aberto : $display_fechado;
      ...
      {
         $tmp_pos = strpos($keterangan, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $keterangan = substr($keterangan, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($nilai, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nilai = substr($nilai, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['nomortahapan'])) ? $this->New_label['nomortahapan'] : "Nomor-Tahapan"; ?></TD>
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nomortahapan" name="nomortahapan_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['keterangan'])) ? $this->New_label['keterangan'] : "KETERANGAN"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_keterangan_cond" name="keterangan_cond" onChange="nm_campos_between(document.getElementById('id_vis_keterangan'), this, 'keterangan')">
       <OPTION value="qp" <?php if ("qp" == $keterangan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $keterangan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $keterangan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $keterangan_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_keterangan" <?php echo $str_hide_keterangan?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['keterangan'])) ? $this->New_label['keterangan'] : "KETERANGAN";
 $nmgp_tab_label .= "keterangan?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      if ($keterangan != "")
      ...
      $keterangan_look = substr($this->Db->qstr($keterangan), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct KETERANGAN from " . $this->Ini->nm_tabela . " where KETERANGAN = '$keterangan_look' order by KETERANGAN"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$keterangan]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$keterangan];
      }
      else
      {
          $sAutocompValue = $keterangan;
      }
?>
<INPUT  type="text" id="SC_keterangan" name="keterangan" value="<?php echo NM_encode_input($keterangan) ?>" size=6 alt="{datatype: 'text', maxLength: 6, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_keterangan" name="keterangan_autocomp" size="6" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 6, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['nilai'])) ? $this->New_label['nilai'] : "NILAI"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_nilai_cond" name="nilai_cond" onChange="nm_campos_between(document.getElementById('id_vis_nilai'), this, 'nilai')">
       <OPTION value="gt" <?php if ("gt" == $nilai_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $nilai_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nilai_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $nilai_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nilai" <?php echo $str_hide_nilai?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['nilai'])) ? $this->New_label['nilai'] : "NILAI";
 $nmgp_tab_label .= "nilai?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      if ($nilai != "")
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct NILAI from " . $this->Ini->nm_tabela . " where NILAI = $nilai_look order by NILAI"; 
      }
      else
      {
          $nm_comando = "select distinct NILAI from " . $this->Ini->nm_tabela . " where NILAI = $nilai_look order by NILAI"; 
      ...
      if (isset($nmgp_def_dados[0][$nilai]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$nilai];
      }
      else
      {
            nmgp_Form_Num_Val($nilai, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $nilai;
      }
?>
<INPUT  type="text" id="SC_nilai" name="nilai" value="<?php echo NM_encode_input($nilai) ?>" size=22 alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nilai" name="nilai_autocomp" size="22" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_nilai"  <?php echo $str_display_nilai; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_nilai_input_2" name="nilai_input_2" value="<?php echo NM_encode_input($nilai_input_2) ?>" size=22 alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
...
?>
<?php
   if (is_file("chartplanrealisasidemo_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['chartplanrealisasidemo']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['chartplanrealisasidemo']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_keterangan'), document.F1.keterangan_cond, 'keterangan');
   document.F1.keterangan.value = "";
   document.F1.keterangan_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_nilai'), document.F1.nilai_cond, 'nilai');
   document.F1.nilai.value = "";
   document.F1.nilai_autocomp.value = "";
   document.F1.nilai_input_2.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "projectamo/chartplanrealisasidemo";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "chartplanrealisasidemo/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_keterangan_cond'] = 'cond';
      $tp_fields['SC_keterangan'] = 'text_aut';
      $tp_fields['id_ac_keterangan'] = 'text_aut';
      $tp_fields['SC_nilai_cond'] = 'cond';
      $tp_fields['SC_nilai'] = 'text_aut';
      $tp_fields['id_ac_nilai'] = 'text_aut';
      $tp_fields['SC_nilai_input_2'] = 'text';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   function trata_campos()
   {
      global $nomortahapan_cond, $nomortahapan, $nomortahapan_autocomp,
             $keterangan_cond, $keterangan, $keterangan_autocomp,
             $nilai_cond, $nilai, $nilai_input_2, $nilai_autocomp, $nmgp_tab_label;
      ...
      if (!empty($keterangan_autocomp) && empty($keterangan))
      {
          $keterangan = $keterangan_autocomp;
      }
      if (!empty($nilai_autocomp) && empty($nilai))
      {
          $nilai = $nilai_autocomp;
      }
      ...
      $keterangan_cond_salva = $keterangan_cond; 
      if (!isset($keterangan_input_2) || $keterangan_input_2 == "")
      {
          $keterangan_input_2 = $keterangan;
      }
      $nilai_cond_salva = $nilai_cond; 
      if (!isset($nilai_input_2) || $nilai_input_2 == "")
      {
          $nilai_input_2 = $nilai;
      }
      if ($nilai_cond != "in")
      {
          nm_limpa_numero($nilai, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $nilai);
          ...
          $nilai = implode(",", $Nm_sc_valores);
      }
      if ($nilai_cond != "in")
      {
          nm_limpa_numero($nilai_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca']['nomortahapan'] = $nomortahapan; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca']['nomortahapan_cond'] = $nomortahapan_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca']['keterangan'] = $keterangan; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca']['keterangan_cond'] = $keterangan_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca']['nilai'] = $nilai; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca']['nilai_input_2'] = $nilai_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca']['nilai_cond'] = $nilai_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($nilai_cond != "in" && $nilai_cond != "bw" && !empty($nilai) && !is_numeric($nilai))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : NILAI";
      }
      if ($nilai_cond == "bw" && ((!empty($nilai) && !is_numeric($nilai)) || (!empty($nilai_input_2) && !is_numeric($nilai_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : NILAI";
      }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['keterangan'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['keterangan'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['keterangan'] = $keterangan;
      }
      $nilai_look = substr($this->Db->qstr($nilai), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($nilai))
   { 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['nilai'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nilai'] = $nilai;
      }
      $Conteudo = $nilai_input_2;
      if (strtoupper($nilai_cond) != "II" && strtoupper($nilai_cond) != "QP" && strtoupper($nilai_cond) != "NP" && strtoupper($nilai_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['nilai_input_2'] = $Conteudo;
      ...
      //----- $keterangan
      $this->Date_part = false;
      if (isset($keterangan) || $keterangan_cond == "nu" || $keterangan_cond == "nn" || $keterangan_cond == "ep" || $keterangan_cond == "ne")
      {
         $this->monta_condicao("KETERANGAN", $keterangan_cond, $keterangan, "", "keterangan");
      }

      //----- $nilai
      $this->Date_part = false;
      if (isset($nilai) || $nilai_cond == "nu" || $nilai_cond == "nn" || $nilai_cond == "ep" || $nilai_cond == "ne")
      {
         $this->monta_condicao("NILAI", $nilai_cond, $nilai, $nilai_input_2, "nilai");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['where_pesq_ant'] = $this->comando . $this->comando_fim;
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['chartplanrealisasidemo']['fast_search']);
