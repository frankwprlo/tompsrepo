...
class report_realisasiproject_mitra_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['report_realisasiproject_mitra']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['report_realisasiproject_mitra']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang ;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(TP_ODP), avg(REALISASI), max(REALISASI), min(REALISASI) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['tot_geral'][2] = $rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $rt->fields[2] = (string)$rt->fields[2]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['tot_geral'][3] = $rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $rt->fields[3] = (string)$rt->fields[3]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['tot_geral'][4] = $rt->fields[3]; 
      $rt->fields[4] = str_replace(",", ".", $rt->fields[4]);
      $rt->fields[4] = (string)$rt->fields[4]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['tot_geral'][5] = $rt->fields[4]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['contr_total_geral'] = "OK";
   } 
   ...
   function Calc_resumo_groupbymitradatel($destino_resumo)
   {
      ...
      $this->nm_data = new nm_data("en_us");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['SC_Ind_Groupby'];
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_groupbymitradatel($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $cmp_sql_tp_num = array('tp_id' => 'N','tp_mitra' => 'N','tp_witel' => 'N','tp_sto' => 'N','tp_odp' => 'N','tp_status' => 'N','tp_templateproject' => 'N','tp_jenisproject' => 'N','tp_prjtrelease' => 'N','tp_targetwaktu' => 'N','tp_datel' => 'N','realisasi' => 'N','closing' => 'N','inst_testcomm' => 'N','pencapaian' => 'N','perijinan' => 'N','prepare' => 'N');
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
         $cmd_simp = "select count(*), sum(TP_ODP), avg(REALISASI), max(REALISASI), min(REALISASI)#@#cmps_quebras#@# from " . $this->Ini->nm_tabela . " " . $where_ok;
         $comando  = "select count(*), sum(SC_metric1), avg(SC_metric2), max(SC_metric2), min(SC_metric2)#@#cmps_quebras#@# from (";
         $comando .= "select TP_ODP as SC_metric1,REALISASI as SC_metric2, " . $cmps_quebras1 . " from " . $this->Ini->nm_tabela . " " .  $where_ok . ") SC_sel1 INNER JOIN (";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
