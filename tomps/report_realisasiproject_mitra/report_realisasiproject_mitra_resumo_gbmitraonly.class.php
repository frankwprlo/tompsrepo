...
class report_realisasiproject_mitra_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_tj_namajenis = $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['arr_total']['tj_namajenis'];
      }
      else
      {
          $this->array_total_tj_namajenis = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['arr_total']['tj_namajenis'] = $this->array_total_tj_namajenis;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['summarizing_fields_order']['gbmitraonly']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['summarizing_fields_order']['gbmitraonly'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['summarizing_fields_order']['gbmitraonly'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['summarizing_fields_display']['gbmitraonly'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['summarizing_fields_display']['gbmitraonly'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['summarizing_fields_display']['gbmitraonly'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['summarizing_fields_display']['gbmitraonly'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['summarizing_fields_display']['gbmitraonly'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['summarizing_fields_display']['gbmitraonly'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['summarizing_fields_display']['gbmitraonly'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_tj_namajenis as $i_tj_namajenis => $d_tj_namajenis) {
           if (!in_array($i_tj_namajenis, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_tj_namajenis[7] ] = $d_tj_namajenis[6];
               $this->comp_label[0][ $d_tj_namajenis[7] ] = $d_tj_namajenis[6];
           }
       }
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_tp_odp, $avg_realisasi, $max_realisasi, $min_realisasi, $quebra_tj_namajenis, $quebra_tj_namajenis_orig)
   {
      //----- Jenis Project
      if (!isset($this->array_total_tj_namajenis[$quebra_tj_namajenis_orig]))
      {
         ...
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][1] = $sum_tp_odp;
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][2] = $avg_realisasi;
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][3] = $max_realisasi;
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][4] = $min_realisasi;
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][5] = 1;
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][6] = $quebra_tj_namajenis;
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][7] = $quebra_tj_namajenis_orig;
      }
      else
      {
         ...
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][1] += $sum_tp_odp;
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][2] += $avg_realisasi;
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][3] = max($this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][3], $max_realisasi);
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][4] = min($this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][4], $min_realisasi);
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][5]++;
      }
   }
...
$_SESSION['scriptcase']['report_realisasiproject_mitra']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->tp_odp, $this->realisasi, $this->realisasi, $this->realisasi, $this->tj_namajenis, $this->tj_namajenis_orig);
            }
   }
//
