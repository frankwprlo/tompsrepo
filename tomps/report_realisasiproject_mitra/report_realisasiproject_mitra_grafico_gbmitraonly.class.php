...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['contr_label_graf']['tj_namajenis']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['contr_label_graf']['tj_namajenis']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['contr_label_graf']['tj_namajenis'];
      }
   }
