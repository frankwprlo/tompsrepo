...
class report_realisasiproject_mitra_resumo
{
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['summarizing_fields_order']['gbmitra']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['summarizing_fields_order']['gbmitra'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['summarizing_fields_order']['gbmitra'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['summarizing_fields_display']['gbmitra'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['summarizing_fields_display']['gbmitra'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['summarizing_fields_display']['gbmitra'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['summarizing_fields_display']['gbmitra'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['summarizing_fields_display']['gbmitra'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['summarizing_fields_display']['gbmitra'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['summarizing_fields_display']['gbmitra'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_tm_namamitra as $i_tm_namamitra => $d_tm_namamitra) {
           if (!in_array($i_tm_namamitra, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_tm_namamitra[7] ] = $d_tm_namamitra[6];
               $this->comp_label[0][ $d_tm_namamitra[7] ] = $d_tm_namamitra[6];
           }
       }
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_tp_odp, $avg_realisasi, $max_realisasi, $min_realisasi, $quebra_tm_namamitra, $quebra_tm_namamitra_orig)
   {
      //----- Mitra
      if (!isset($this->array_total_tm_namamitra[$quebra_tm_namamitra_orig]))
      {
         ...
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][2] = $avg_realisasi;
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][3] = $max_realisasi;
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][4] = $min_realisasi;
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][5] = 1;
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][6] = $quebra_tm_namamitra;
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][7] = $quebra_tm_namamitra_orig;
      }
      else
      {
         ...
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][1] += $sum_tp_odp;
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][2] += $avg_realisasi;
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][3] = max($this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][3], $max_realisasi);
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][4] = min($this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][4], $min_realisasi);
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][5]++;
      }
   }
...
$_SESSION['scriptcase']['report_realisasiproject_mitra']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->tp_odp, $this->realisasi, $this->realisasi, $this->realisasi, $this->tm_namamitra, $this->tm_namamitra_orig);
            }
   }
//
