...
class report_realisasiproject_mitra_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= "_report_realisasiproject_mitra";
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "report_realisasiproject_mitra.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['order_grid'];
...
$_SESSION['scriptcase']['report_realisasiproject_mitra']['contr_erro'] = 'off'; 
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_realisasiproject_mitra'][$path_doc_md5][1] = $this->Tit_doc;
?>
