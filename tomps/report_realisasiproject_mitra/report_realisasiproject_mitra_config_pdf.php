 ...
 */
    ...
    session_start();
    $SC_apl_proc = "report_realisasiproject_mitra";
...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['report_realisasiproject_mitra']['show_skip_charts_option']) || !$_SESSION['sc_session']['report_realisasiproject_mitra']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
