<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="kodesp_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['kodesp_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="batch"/>
  <input type="hidden" name="nmgp_parms" value=""> 
