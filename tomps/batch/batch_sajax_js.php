...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate kodesp_
  function do_ajax_batch_validate_kodesp_(iNumLinha)
  {
    var nomeCampo_kodesp_ = "kodesp_" + iNumLinha;
    var var_kodesp_ = scAjaxGetFieldHidden(nomeCampo_kodesp_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_batch_validate_kodesp_(var_kodesp_, iNumLinha, var_script_case_init, do_ajax_batch_validate_kodesp__cb);
  } // do_ajax_batch_validate_kodesp_

  function do_ajax_batch_validate_kodesp__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "kodesp_" + iLineNumber;
    }
    else
    {
      sFieldValid = "kodesp_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "kodesp_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "kodesp_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_batch_validate_kodesp__cb

  // ---------- Validate namabatch_
  function do_ajax_batch_validate_namabatch_(iNumLinha)
  {
    var nomeCampo_namabatch_ = "namabatch_" + iNumLinha;
    var var_namabatch_ = scAjaxGetFieldText(nomeCampo_namabatch_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_batch_validate_namabatch_(var_namabatch_, iNumLinha, var_script_case_init, do_ajax_batch_validate_namabatch__cb);
  } // do_ajax_batch_validate_namabatch_

  function do_ajax_batch_validate_namabatch__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "namabatch_" + iLineNumber;
    }
    else
    {
      sFieldValid = "namabatch_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "namabatch_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "namabatch_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_batch_validate_namabatch__cb

  // ---------- Validate deskripsi_
  function do_ajax_batch_validate_deskripsi_(iNumLinha)
  {
    var nomeCampo_deskripsi_ = "deskripsi_" + iNumLinha;
    var var_deskripsi_ = scAjaxGetFieldText(nomeCampo_deskripsi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_batch_validate_deskripsi_(var_deskripsi_, iNumLinha, var_script_case_init, do_ajax_batch_validate_deskripsi__cb);
  } // do_ajax_batch_validate_deskripsi_

  function do_ajax_batch_validate_deskripsi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_batch_validate_deskripsi__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_batch_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_batch_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_batch_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_batch_add_new_line_cb);
  } // do_ajax_batch_add_new_line

  function do_ajax_batch_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_batch_add_new_line_cb

  // ---------- backup_line
  function do_ajax_batch_backup_line(iNumLinha)
  {
    var var_kodesp_ = scAjaxGetFieldHidden("kodesp_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_batch_backup_line(var_kodesp_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_batch_backup_line_cb);
  } // do_ajax_batch_backup_line

  function do_ajax_batch_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_batch_backup_line_cb

  function do_ajax_batch_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_batch_cancel_insert

  function do_ajax_batch_cancel_update(iSeqVert)
  {
    do_ajax_batch_backup_line(iSeqVert);
...
?>
  } // do_ajax_batch_cancel_update

  function do_ajax_batch_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_batch_restore_buttons

  // ---------- table_refresh
  function do_ajax_batch_table_refresh()
  {
    var var_kodesp_ = document.F2.kodesp_.value;
    ...
    scAjaxProcOn();
    x_ajax_batch_table_refresh(var_kodesp_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_batch_table_refresh_cb);
  } //  do_ajax_batch_table_refresh

  function do_ajax_batch_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.kodesp_.value = scAjaxGetKeyValue("kodesp_");
    ...
    sc_insert_open = false;
  } // do_ajax_batch_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_batch_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_batch_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_kodesp_ = scAjaxGetFieldHidden("kodesp_" + iNumLinha);
    var var_namabatch_ = scAjaxGetFieldText("namabatch_" + iNumLinha);
...
?>
    x_ajax_batch_submit_form(var_kodesp_, var_namabatch_, var_deskripsi_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_batch_submit_form_cb);
  } // do_ajax_batch_submit_form

  function do_ajax_batch_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("kodesp_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("namabatch_" + sc_num_ult_line);
...
?>
  ...
  } // do_ajax_batch_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_batch_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_batch_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("kodesp_" + iNavForm);
      scAjaxHideErrorDisplay("namabatch_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_batch_navigate_form(var_kodesp_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_batch_navigate_form_cb);
  } // do_ajax_batch_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['batch']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_batch_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.kodesp_.value = scAjaxGetKeyValue("kodesp_" + var_last_index);
...
?>
  ...
  } // do_ajax_batch_navigate_form_cb
  function sc_hide_batch_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "kodesp_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "namabatch_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "deskripsi_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["kodesp_" + iNumLinha] = {"label": "IDBatch<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["namabatch_" + iNumLinha] = {"label": "Nama Batch<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["kodesp_"][iNumLinha] = "kodesp_" + iNumLinha;
    ajax_field_mult["namabatch_"][iNumLinha] = "namabatch_" + iNumLinha;
    ajax_field_mult["deskripsi_"][iNumLinha] = "deskripsi_" + iNumLinha;
    ajax_field_id["kodesp_" + iNumLinha] = new Array("hidden_field_label_kodesp_", "hidden_field_data_kodesp_" + iNumLinha);
    ajax_field_id["namabatch_" + iNumLinha] = new Array("hidden_field_label_namabatch_", "hidden_field_data_namabatch_" + iNumLinha);
    ajax_field_id["deskripsi_" + iNumLinha] = new Array("hidden_field_label_deskripsi_", "hidden_field_data_deskripsi_" + iNumLinha);
    ajax_error_count["kodesp_" + iNumLinha] = "off";
    ajax_error_count["namabatch_" + iNumLinha] = "off";
    ajax_error_count["deskripsi_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["kodesp_" + iNumLinha] = "on";
    ajax_read_only["namabatch_" + iNumLinha] = "off";
...
?>
    ajax_read_only["kodesp_" + iNumLinha] = "on";
    ajax_read_only["namabatch_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["kodesp_" + iNumLinha] = null;
    ajax_error_list["namabatch_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["kodesp_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["kodesp_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["kodesp_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["kodesp_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["kodesp_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["namabatch_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["namabatch_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["namabatch_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["namabatch_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["namabatch_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['kodesp_'])) ? $this->nmgp_cmp_readonly['kodesp_'] : 'on';
?>
    scAjaxFieldRead("kodesp_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['namabatch_'])) ? $this->nmgp_cmp_readonly['namabatch_'] : 'off';
?>
    scAjaxFieldRead("namabatch_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("kodesp_" + iSeq, "on");
    scAjaxFieldRead("namabatch_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["kodesp_" + iRow] || "on" == ajax_error_count["namabatch_" + iRow] || "on" == ajax_error_count["deskripsi_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_kodesp_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_namabatch_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["kodesp_" + iRow] && "off" == ajax_error_count["namabatch_" + iRow] && "off" == ajax_error_count["deskripsi_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["kodesp_" + iRow] = "off";
        ajax_error_count["namabatch_" + iRow] = "off";
      ...
      $("#hidden_field_data_kodesp_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_namabatch_" + iRow).removeClass("scFormErrorLine");
