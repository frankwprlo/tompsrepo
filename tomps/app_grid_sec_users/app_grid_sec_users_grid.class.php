...
//----- 
   ...
   { 
       $nmgp_select = "SELECT LOGIN, NAME, EMAIL, ACTIVE, PRIV_ADMIN, PRIV_MITRA, KODEMITRA, IDDIVRE, IDWITEL, PRIV_LOKASI from " . $this->Ini->nm_tabela; 
   } 
   ...
   { 
       ...
       $this->priv_mitra = $this->rs_grid->fields[5] ;  
       $this->kodemitra = $this->rs_grid->fields[6] ;  
       $this->kodemitra = (string)$this->kodemitra;
       $this->iddivre = $this->rs_grid->fields[7] ;  
       $this->iddivre = (string)$this->iddivre;
       $this->idwitel = $this->rs_grid->fields[8] ;  
       $this->idwitel = (string)$this->idwitel;
       $this->priv_lokasi = $this->rs_grid->fields[9] ;  
...
<?php
 ...
 {  
   ...
   $this->css_iddivre_label = $compl_css_emb . "css_iddivre_label";
   $this->css_iddivre_grid_line = $compl_css_emb . "css_iddivre_grid_line";
   $this->css_idwitel_label = $compl_css_emb . "css_idwitel_label";
   $this->css_idwitel_grid_line = $compl_css_emb . "css_idwitel_grid_line";
...
//----- 
 function cabecalho()
 {
   ...
   $nm_saida->saida("          " . $this->Ini->Nm_lang['lang_othr_grid_titl'] . "\r\n");
   $nm_saida->saida("        </TD>\r\n");
   $nm_saida->saida("       </TR>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_priv_lokasi_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] || ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['exibe_seq'] == "S")) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_priv_lokasi_label'] . "\" >&nbsp;</TD>\r\n");
   } 
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['priv_admin'])) ? $this->New_label['priv_admin'] : "PRIV ADMIN"; 
   if (!isset($this->NM_cmp_hidden['priv_admin']) || $this->NM_cmp_hidden['priv_admin'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_priv_admin_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_priv_admin_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 ...
 function NM_label_iddivre()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['iddivre'])) ? $this->New_label['iddivre'] : "IDDIVRE"; 
   if (!isset($this->NM_cmp_hidden['iddivre']) || $this->NM_cmp_hidden['iddivre'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_iddivre_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_iddivre_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_idwitel()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['idwitel'])) ? $this->New_label['idwitel'] : "IDWITEL"; 
   if (!isset($this->NM_cmp_hidden['idwitel']) || $this->NM_cmp_hidden['idwitel'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_idwitel_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_idwitel_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
...
// 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_priv_lokasi_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['mostra_edit'] != "N"){ 
              ...
              {
                  $Parms_Edt  = "login?#?" . str_replace('"', "@aspasd@", $this->login) . "?@?NM_btn_insert?#?S?@?NM_btn_update?#?S?@?NM_btn_delete?#?S?@?NM_btn_navega?#?S?@?nmgp_opcao?#?igual?@?";
                  if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['dashboard_info']['under_dashboard'] && isset($this->Ini->sc_lig_target['A_@scinf_']))
                  {
                      if ('' != $Parms_Edt && '?@?' != substr($Parms_Edt, -3) && '*scout' != substr($Parms_Edt, -6))
                      {
                          $Parms_Edt .= '*scout';
                      }
                      $Parms_Edt .= 'under_dashboard*scin1*scoutdashboard_app*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['dashboard_info']['dashboard_app'] . '*scoutown_widget*scin' . $this->Ini->sc_lig_target['A_@scinf_'] . '*scoutparent_widget*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['dashboard_info']['own_widget'] . '*scoutcompact_mode*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['dashboard_info']['compact_mode'] ? '1' : '0');
                  }
              ...
              {
                  $Md5_Edt  = "login?#?" . str_replace('"', "@aspasd@", $this->login) . "?@?NM_btn_insert?#?S?@?NM_btn_update?#?S?@?NM_btn_delete?#?S?@?NM_btn_navega?#?S?@?nmgp_opcao?#?igual?@?";
              }
              $Link_Edit = nmButtonOutput($this->arr_buttons, "bform_editar", "nm_gp_submit4('" .  $this->Ini->link_app_form_edit_users . "', '$this->nm_location',  '$Md5_Edt' , '". (isset($this->Ini->sc_lig_target['A_@scinf_']) ? $this->Ini->sc_lig_target['A_@scinf_'] : '_self') . "', '', 'app_form_edit_users', '" . $this->SC_ancora . "')", "nm_gp_submit4('" .  $this->Ini->link_app_form_edit_users . "', '$this->nm_location',  '$Md5_Edt' , '". (isset($this->Ini->sc_lig_target['A_@scinf_']) ? $this->Ini->sc_lig_target['A_@scinf_'] : '_self') . "', '', 'app_form_edit_users', '" . $this->SC_ancora . "')", "bedit", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
 ...
 function NM_grid_iddivre()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['iddivre']) || $this->NM_cmp_hidden['iddivre'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->iddivre)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_iddivre_grid_line . "\"  style=\"" . $this->Css_Cmp['css_iddivre_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_iddivre_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_idwitel()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['idwitel']) || $this->NM_cmp_hidden['idwitel'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->idwitel)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_idwitel_grid_line . "\"  style=\"" . $this->Css_Cmp['css_idwitel_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_idwitel_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_calc_span()
 {
   ...
   {
       $this->NM_colspan--;
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['exibe_seq'] != "S" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != "pdf")
       {
           $this->NM_colspan--; 
       }
   } 
   ...
   function nmgp_barra_top_normal()
   {
      ...
      $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"left\" width=\"33%\"> \r\n");
        if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['new'] == "on" && $this->nmgp_botoes['insert'] == "on" && !$this->grid_emb_form)
        {
           $Sc_parent = ($this->grid_emb_form_full) ? "S" : "";
           if (isset($this->Ini->sc_lig_md5["app_form_edit_users"]) && $this->Ini->sc_lig_md5["app_form_edit_users"] == "S") {
               $Parms_Lig  = "NM_cancel_insert_new*scin1*scoutNM_cancel_return_new*scin1*scoutnmgp_opcao*scinnovo*scoutNM_btn_insert*scinS*scoutNM_btn_new*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinS*scout";
               ...
               $Md5_Lig  = "NM_cancel_insert_new*scin1*scoutNM_cancel_return_new*scin1*scoutnmgp_opcao*scinnovo*scoutNM_btn_insert*scinS*scoutNM_btn_new*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinS*scout";
           }
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bnovo", "nm_gp_submit1('" .  $this->Ini->link_app_form_edit_users . "', '$this->nm_location', '$Md5_Lig', '_self', 'app_form_edit_users'); return false;", "nm_gp_submit1('" .  $this->Ini->link_app_form_edit_users . "', '$this->nm_location', '$Md5_Lig', '_self', 'app_form_edit_users'); return false;", "sc_b_new_top", "", "Tambah User", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "Klik untuk membuat user baru", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("       {\r\n");
   $nm_saida->saida("           window.location = \"" . $this->Ini->path_link . "app_grid_sec_users/app_grid_sec_users_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_create_charts=\" + crt + \"&sc_graf_pdf=\" + g;\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
