...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("mastertemplate_copy_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('mastertemplate_copy_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['recarga'];
}
?>
...
<?php
 include_once("mastertemplate_copy_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['mastertemplate_copy'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['mastertemplate_copy'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idtemplate_label" id="hidden_field_label_idtemplate" style="<?php echo $sStyleHidden_idtemplate; ?>"><span id="id_label_idtemplate"><?php echo $this->nm_new_label['idtemplate']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['php_cmp_required']['idtemplate']) || $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['php_cmp_required']['idtemplate'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_idtemplate_line" id="hidden_field_data_idtemplate" style="<?php echo $sStyleHidden_idtemplate; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idtemplate_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_templatename_label" id="hidden_field_label_templatename" style="<?php echo $sStyleHidden_templatename; ?>"><span id="id_label_templatename"><?php echo $this->nm_new_label['templatename']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['php_cmp_required']['templatename']) || $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['php_cmp_required']['templatename'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_templatename_line" id="hidden_field_data_templatename" style="<?php echo $sStyleHidden_templatename; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_templatename_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_deskripsi_label" id="hidden_field_label_deskripsi" style="<?php echo $sStyleHidden_deskripsi; ?>"><span id="id_label_deskripsi"><?php echo $this->nm_new_label['deskripsi']; ?></span></TD>
    <TD class="scFormDataOdd css_deskripsi_line" id="hidden_field_data_deskripsi" style="<?php echo $sStyleHidden_deskripsi; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_deskripsi_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_targetwaktu_label" id="hidden_field_label_targetwaktu" style="<?php echo $sStyleHidden_targetwaktu; ?>"><span id="id_label_targetwaktu"><?php echo $this->nm_new_label['targetwaktu']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['php_cmp_required']['targetwaktu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['php_cmp_required']['targetwaktu'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_targetwaktu_line" id="hidden_field_data_targetwaktu" style="<?php echo $sStyleHidden_targetwaktu; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_targetwaktu_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idwitel_line" id="hidden_field_data_idwitel" style="<?php echo $sStyleHidden_idwitel; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idwitel_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_iddivre_line" id="hidden_field_data_iddivre" style="<?php echo $sStyleHidden_iddivre; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_iddivre_line" style="vertical-align: top;padding: 0px">
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_tahapanproject'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_tahapanproject'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['form_add_tahapanproject_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_tahapanproject'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['form_add_tahapanproject_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['form_add_tahapanproject_script_case_init'] ]['form_add_tahapanproject']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['form_add_tahapanproject_script_case_init'] ]['form_add_tahapanproject']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['form_add_tahapanproject_script_case_init'] ]['form_add_tahapanproject']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['form_add_tahapanproject_script_case_init'] ]['form_add_tahapanproject']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['form_add_tahapanproject_script_case_init'] ]['form_add_tahapanproject']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['form_add_tahapanproject_script_case_init'] ]['form_add_tahapanproject']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['form_add_tahapanproject_script_case_init'] ]['form_add_tahapanproject']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['form_add_tahapanproject_script_case_init'] ]['form_add_tahapanproject']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['form_add_tahapanproject_script_case_init'] ]['form_add_tahapanproject']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['form_add_tahapanproject_script_case_init'] ]['form_add_tahapanproject']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['form_add_tahapanproject_script_case_init'] ]['form_add_tahapanproject']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['form_add_tahapanproject_script_case_init'] ]['form_add_tahapanproject']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['form_add_tahapanproject_script_case_init'] ]['mastertemplate_copy']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'mastertemplate_copy_empty.htm' : $this->Ini->link_form_add_tahapanproject_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_tahapanproject']) && 'nmsc_iframe_liga_form_add_tahapanproject' != $this->Ini->sc_lig_target['C_@scinf_tahapanproject'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_tahapanproject'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['form_add_tahapanproject_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_add_tahapanproject"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_add_tahapanproject"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['mastertemplate_copy']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("mastertemplate_copy");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("mastertemplate_copy");
 parent.scAjaxDetailHeight("mastertemplate_copy", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
