 ...
 */
    ...
    session_start();
    $SC_apl_proc = "v_dashboard_lop_detail";
...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['v_dashboard_lop_detail']['show_skip_charts_option']) || !$_SESSION['sc_session']['v_dashboard_lop_detail']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
