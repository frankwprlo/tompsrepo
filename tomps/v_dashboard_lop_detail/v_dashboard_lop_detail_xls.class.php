...
class v_dashboard_lop_detail_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['v_dashboard_lop_detail']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_dashboard_lop_detail']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          $this->Arquivo   .= "_v_dashboard_lop_detail";
          $this->Arquivo   .= ".xls";
          $this->Tit_doc    = "v_dashboard_lop_detail.xls";
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_dashboard_lop_detail']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['v_dashboard_lop_detail']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['v_dashboard_lop_detail']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['v_dashboard_lop_detail']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      ...
      { 
          ...
          $SC_Label = (isset($this->New_label['detaiil'])) ? $this->New_label['detaiil'] : "Detail"; 
          if (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off")
          {
              $this->arr_span['detaiil'] = $this->count_span;
              $this->Emb_label_cols_detaiil = 0;
                  ...
                  if (isset($_SESSION['scriptcase']['export_return']))
                  {
                     foreach ($_SESSION['scriptcase']['export_return']['label'] as $col => $dados)
                     {
                         if (isset($dados['col_span_i'])) {
                             $this->Emb_label_cols_detaiil += $dados['col_span_i'];
                         }
                         elseif (isset($dados['col_span_f'])) {
                             $this->Emb_label_cols_detaiil += $dados['col_span_f'];
                         }
                         else {
                             $this->Emb_label_cols_detaiil++;
                         }
                     }
                  }
              }
      ...
      { 
          ...
          {
              while ($this->count_span < $this->Emb_label_cols_detaiil)
              {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_dashboard_lop_detail']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['v_dashboard_lop_detail']['embutida_label'])
      { 
...
$_SESSION['scriptcase']['v_dashboard_lop_detail']['contr_erro'] = 'off'; 
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['v_dashboard_lop_detail']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->tp_releasename = $rs->fields[2] ;  
         $this->tp_batch = $rs->fields[3] ;  
         $this->tp_idlop = $rs->fields[4] ;  
         $this->mw_namawitel = $rs->fields[5] ;  
         $this->md_namadatel = $rs->fields[6] ;  
         $this->ms_namasto = $rs->fields[7] ;  
         $this->statusname = $rs->fields[8] ;  
         $this->tm_namamitra = $rs->fields[9] ;  
         $this->tp_projectname = $rs->fields[10] ;  
         $this->tj_namajenis = $rs->fields[11] ;  
         $this->tp_lokasi = $rs->fields[12] ;  
         $this->tp_odp = $rs->fields[13] ;  
         $this->tp_odp = (string)$this->tp_odp;
         $this->tp_planstart = $rs->fields[14] ;  
         $this->tp_planfinish = $rs->fields[15] ;  
         $this->tp_targetwaktu = $rs->fields[16] ;  
         $this->tp_targetwaktu = (string)$this->tp_targetwaktu;
         $this->tp_prosentase = $rs->fields[17] ;  
         ...
         $this->tp_sto = $rs->fields[20] ;  
         $this->tp_sto = (string)$this->tp_sto;
         $this->tp_entrydate = $rs->fields[21] ;  
         $this->tp_entryby = $rs->fields[22] ;  
         $this->tp_updatedate = $rs->fields[23] ;  
         $this->tp_updateby = $rs->fields[24] ;  
         $this->tp_summary = $rs->fields[25] ;  
         $this->tp_status = $rs->fields[26] ;  
         $this->tp_status = (string)$this->tp_status;
         $this->tp_actualstart = $rs->fields[27] ;  
         $this->tp_actualfinish = $rs->fields[28] ;  
         $this->tp_templateproject = $rs->fields[29] ;  
         $this->tp_templateproject = (string)$this->tp_templateproject;
         $this->tp_jenisproject = $rs->fields[30] ;  
         $this->tp_jenisproject = (string)$this->tp_jenisproject;
         $this->tp_prjtrelease = $rs->fields[31] ;  
         $this->tp_prjtrelease = (string)$this->tp_prjtrelease;
         $this->tp_datel = $rs->fields[32] ;  
         $this->tp_datel = (string)$this->tp_datel;
         $this->templatename = $rs->fields[33] ;  
         $this->tp_nokontrak = $rs->fields[34] ;  
         $this->tp_ponumber = $rs->fields[35] ;  
...
$_SESSION['scriptcase']['v_dashboard_lop_detail']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['v_dashboard_lop_detail']['embutida'])
         { 
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['v_dashboard_lop_detail']['embutida'])
      { 
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['v_dashboard_lop_detail']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_dashboard_lop_detail']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_dashboard_lop_detail'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_dashboard_lop_detail'][$path_doc_md5][1] = $this->Tit_doc;
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE>Resume Project Detail <?php echo $_SESSION['kodewitel'] ?> :: Excel</TITLE>
