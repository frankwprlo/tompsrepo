...
$old_error_handler = set_error_handler("project_release_inline_scriptcase_error_handler");

function project_release_inline_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['project_release_inline']['contr_erro']) && $_SESSION['scriptcase']['project_release_inline']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_project_release_inline->contr_project_release_inline->Apl_com_erro = true;
            if ($inicial_project_release_inline->contr_project_release_inline->NM_ajax_flag)
            {
                $inicial_project_release_inline->contr_project_release_inline->NM_ajax_info['errList']['geral_project_release_inline'][] = $msg;
                return;
            }
            project_release_inline_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function project_release_inline_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['project_release_inline'])  && '' != $_SESSION['scriptcase']['error_icon']['project_release_inline'])  ? $_SESSION['scriptcase']['error_icon']['project_release_inline']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['project_release_inline']) && '' != $_SESSION['scriptcase']['error_span_title']['project_release_inline']) ? $_SESSION['scriptcase']['error_span_title']['project_release_inline'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['project_release_inline']) && '' != $_SESSION['scriptcase']['error_icon_title']['project_release_inline']) ? $_SESSION['scriptcase']['error_icon_title']['project_release_inline'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['project_release']['error_buffer'] .= ob_get_flush();
}
