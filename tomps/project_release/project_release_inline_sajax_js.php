  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_project_release_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_project_release_inline_validate_tp_release_()
  {
    var nomeCampo_tp_release_ = "tp_release_";
    var var_tp_release_ = scAjaxGetFieldHidden(nomeCampo_tp_release_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_project_release_inline_validate_tp_release_(var_tp_release_, var_script_case_init, do_ajax_project_release_inline_validate_tp_release__cb);
  } // do_ajax_project_release_inline_validate_tp_release_

  function do_ajax_project_release_inline_validate_tp_release__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_project_release_inline_validate_tp_release__cb

  // ---------- Validate tp_releasename_
  function do_ajax_project_release_inline_validate_tp_releasename_()
  {
    var nomeCampo_tp_releasename_ = "tp_releasename_";
    var var_tp_releasename_ = scAjaxGetFieldText(nomeCampo_tp_releasename_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_project_release_inline_validate_tp_releasename_(var_tp_releasename_, var_script_case_init, do_ajax_project_release_inline_validate_tp_releasename__cb);
  } // do_ajax_project_release_inline_validate_tp_releasename_

  function do_ajax_project_release_inline_validate_tp_releasename__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_project_release_inline_validate_tp_releasename__cb

  // ---------- Validate tp_deskripsi_
  function do_ajax_project_release_inline_validate_tp_deskripsi_()
  {
    var nomeCampo_tp_deskripsi_ = "tp_deskripsi_";
    var var_tp_deskripsi_ = scAjaxGetFieldText(nomeCampo_tp_deskripsi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_project_release_inline_validate_tp_deskripsi_(var_tp_deskripsi_, var_script_case_init, do_ajax_project_release_inline_validate_tp_deskripsi__cb);
  } // do_ajax_project_release_inline_validate_tp_deskripsi_

  function do_ajax_project_release_inline_validate_tp_deskripsi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_project_release_inline_validate_tp_deskripsi__cb
  // ---------- Form
  function do_ajax_project_release_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_project_release_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_tp_release_ = scAjaxGetFieldHidden("tp_release_");
    var var_tp_releasename_ = scAjaxGetFieldText("tp_releasename_");
    var var_tp_deskripsi_ = scAjaxGetFieldText("tp_deskripsi_");
    ...
    scAjaxProcOn();
    x_ajax_project_release_inline_submit_form(var_tp_release_, var_tp_releasename_, var_tp_deskripsi_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_project_release_inline_submit_form_cb);
  } // do_ajax_project_release_inline_submit_form

  function do_ajax_project_release_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tp_release_");
      scAjaxHideErrorDisplay("tp_releasename_");
      scAjaxHideErrorDisplay("tp_deskripsi_");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_project_release_inline_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_project_release_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_project_release_inline_navigate_form(var_tp_release_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_project_release_inline_navigate_form_cb);
  } // do_ajax_project_release_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['project_release_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_project_release_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_project_release_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_project_release_inline_navigate_form_cb
  function sc_hide_project_release_inline_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_project_release_inline_form
  ...
  ajax_field_list[0] = "tp_release_";
  ajax_field_list[1] = "tp_releasename_";
  ajax_field_list[2] = "tp_deskripsi_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "tp_release_": {"label": "ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tp_releasename_": {"label": "Name", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tp_deskripsi_": {"label": "Deskripsi", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["tp_release_"][1] = "tp_release_";
  ajax_field_mult["tp_releasename_"][1] = "tp_releasename_";
  ajax_field_mult["tp_deskripsi_"][1] = "tp_deskripsi_";

  var ajax_field_id = {
    "tp_release_": new Array("hidden_field_label_tp_release_", "hidden_field_data_tp_release_"),
    "tp_releasename_": new Array("hidden_field_label_tp_releasename_", "hidden_field_data_tp_releasename_"),
    "tp_deskripsi_": new Array("hidden_field_label_tp_deskripsi_", "hidden_field_data_tp_deskripsi_")
  };
