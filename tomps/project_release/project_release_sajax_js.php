  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_project_release" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate tp_release_
  function do_ajax_project_release_validate_tp_release_(iNumLinha)
  {
    var nomeCampo_tp_release_ = "tp_release_" + iNumLinha;
    var var_tp_release_ = scAjaxGetFieldHidden(nomeCampo_tp_release_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_project_release_validate_tp_release_(var_tp_release_, iNumLinha, var_script_case_init, do_ajax_project_release_validate_tp_release__cb);
  } // do_ajax_project_release_validate_tp_release_

  function do_ajax_project_release_validate_tp_release__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tp_release_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tp_release_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "tp_release_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tp_release_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_project_release_validate_tp_release__cb

  // ---------- Validate tp_releasename_
  function do_ajax_project_release_validate_tp_releasename_(iNumLinha)
  {
    var nomeCampo_tp_releasename_ = "tp_releasename_" + iNumLinha;
    var var_tp_releasename_ = scAjaxGetFieldText(nomeCampo_tp_releasename_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_project_release_validate_tp_releasename_(var_tp_releasename_, iNumLinha, var_script_case_init, do_ajax_project_release_validate_tp_releasename__cb);
  } // do_ajax_project_release_validate_tp_releasename_

  function do_ajax_project_release_validate_tp_releasename__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tp_releasename_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tp_releasename_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tp_releasename_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tp_releasename_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_project_release_validate_tp_releasename__cb

  // ---------- Validate tp_deskripsi_
  function do_ajax_project_release_validate_tp_deskripsi_(iNumLinha)
  {
    var nomeCampo_tp_deskripsi_ = "tp_deskripsi_" + iNumLinha;
    var var_tp_deskripsi_ = scAjaxGetFieldText(nomeCampo_tp_deskripsi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_project_release_validate_tp_deskripsi_(var_tp_deskripsi_, iNumLinha, var_script_case_init, do_ajax_project_release_validate_tp_deskripsi__cb);
  } // do_ajax_project_release_validate_tp_deskripsi_

  function do_ajax_project_release_validate_tp_deskripsi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tp_deskripsi_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tp_deskripsi_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tp_deskripsi_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tp_deskripsi_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_project_release_validate_tp_deskripsi__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_project_release_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_project_release_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_project_release_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_project_release_add_new_line_cb);
  } // do_ajax_project_release_add_new_line

  function do_ajax_project_release_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_project_release_add_new_line_cb

  // ---------- backup_line
  function do_ajax_project_release_backup_line(iNumLinha)
  {
    var var_tp_release_ = scAjaxGetFieldHidden("tp_release_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_project_release_backup_line(var_tp_release_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_project_release_backup_line_cb);
  } // do_ajax_project_release_backup_line

  function do_ajax_project_release_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_project_release_backup_line_cb

  function do_ajax_project_release_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_project_release_cancel_insert

  function do_ajax_project_release_cancel_update(iSeqVert)
  {
    do_ajax_project_release_backup_line(iSeqVert);
...
?>
  } // do_ajax_project_release_cancel_update

  function do_ajax_project_release_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_project_release_restore_buttons

  // ---------- table_refresh
  function do_ajax_project_release_table_refresh()
  {
    var var_tp_release_ = document.F2.tp_release_.value;
    ...
    scAjaxProcOn();
    x_ajax_project_release_table_refresh(var_tp_release_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_project_release_table_refresh_cb);
  } //  do_ajax_project_release_table_refresh

  function do_ajax_project_release_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.tp_release_.value = scAjaxGetKeyValue("tp_release_");
    ...
    sc_insert_open = false;
  } // do_ajax_project_release_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_project_release_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_project_release_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_tp_release_ = scAjaxGetFieldHidden("tp_release_" + iNumLinha);
    var var_tp_releasename_ = scAjaxGetFieldText("tp_releasename_" + iNumLinha);
    var var_tp_deskripsi_ = scAjaxGetFieldText("tp_deskripsi_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_project_release_submit_form(var_tp_release_, var_tp_releasename_, var_tp_deskripsi_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_project_release_submit_form_cb);
  } // do_ajax_project_release_submit_form

  function do_ajax_project_release_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tp_release_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tp_releasename_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tp_deskripsi_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_project_release_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_project_release_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_project_release_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("tp_release_" + iNavForm);
      scAjaxHideErrorDisplay("tp_releasename_" + iNavForm);
      scAjaxHideErrorDisplay("tp_deskripsi_" + iNavForm);
    }
    var var_tp_release_ = document.F2.tp_release_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_project_release_navigate_form(var_tp_release_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_project_release_navigate_form_cb);
  } // do_ajax_project_release_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['project_release']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_project_release_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.tp_release_.value = scAjaxGetKeyValue("tp_release_" + var_last_index);
...
?>
  ...
  } // do_ajax_project_release_navigate_form_cb
  function sc_hide_project_release_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_project_release_form
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "tp_release_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tp_releasename_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tp_deskripsi_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["tp_release_" + iNumLinha] = {"label": "ID<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tp_releasename_" + iNumLinha] = {"label": "Name<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tp_deskripsi_" + iNumLinha] = {"label": "Deskripsi<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["tp_release_"][iNumLinha] = "tp_release_" + iNumLinha;
    ajax_field_mult["tp_releasename_"][iNumLinha] = "tp_releasename_" + iNumLinha;
    ajax_field_mult["tp_deskripsi_"][iNumLinha] = "tp_deskripsi_" + iNumLinha;
    ajax_field_id["tp_release_" + iNumLinha] = new Array("hidden_field_label_tp_release_", "hidden_field_data_tp_release_" + iNumLinha);
    ajax_field_id["tp_releasename_" + iNumLinha] = new Array("hidden_field_label_tp_releasename_", "hidden_field_data_tp_releasename_" + iNumLinha);
    ajax_field_id["tp_deskripsi_" + iNumLinha] = new Array("hidden_field_label_tp_deskripsi_", "hidden_field_data_tp_deskripsi_" + iNumLinha);
    ajax_error_count["tp_release_" + iNumLinha] = "off";
    ajax_error_count["tp_releasename_" + iNumLinha] = "off";
    ajax_error_count["tp_deskripsi_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["tp_release_" + iNumLinha] = "on";
    ajax_read_only["tp_releasename_" + iNumLinha] = "off";
    ajax_read_only["tp_deskripsi_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["tp_release_" + iNumLinha] = "on";
    ajax_read_only["tp_releasename_" + iNumLinha] = "on";
    ajax_read_only["tp_deskripsi_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["tp_release_" + iNumLinha] = null;
    ajax_error_list["tp_releasename_" + iNumLinha] = null;
    ajax_error_list["tp_deskripsi_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "tp_release_": new Array(),
    "tp_releasename_": new Array(),
    "tp_deskripsi_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["tp_release_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tp_release_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tp_release_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tp_release_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tp_release_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tp_releasename_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tp_releasename_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tp_releasename_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tp_releasename_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tp_releasename_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tp_deskripsi_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tp_deskripsi_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tp_deskripsi_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tp_deskripsi_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tp_deskripsi_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tp_release_'])) ? $this->nmgp_cmp_readonly['tp_release_'] : 'on';
?>
    scAjaxFieldRead("tp_release_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tp_releasename_'])) ? $this->nmgp_cmp_readonly['tp_releasename_'] : 'off';
?>
    scAjaxFieldRead("tp_releasename_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tp_deskripsi_'])) ? $this->nmgp_cmp_readonly['tp_deskripsi_'] : 'off';
?>
    scAjaxFieldRead("tp_deskripsi_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("tp_release_" + iSeq, "on");
    scAjaxFieldRead("tp_releasename_" + iSeq, "on");
    scAjaxFieldRead("tp_deskripsi_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tp_release_" + iRow] || "on" == ajax_error_count["tp_releasename_" + iRow] || "on" == ajax_error_count["tp_deskripsi_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tp_release_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tp_releasename_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tp_deskripsi_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tp_release_" + iRow] && "off" == ajax_error_count["tp_releasename_" + iRow] && "off" == ajax_error_count["tp_deskripsi_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tp_release_" + iRow] = "off";
        ajax_error_count["tp_releasename_" + iRow] = "off";
        ajax_error_count["tp_deskripsi_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_tp_release_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tp_releasename_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tp_deskripsi_" + iRow).removeClass("scFormErrorLine");
    }
  }
