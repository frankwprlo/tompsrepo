...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>project_edit_update_main_applink/project_edit_update_main_applink_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("project_edit_update_main_applink_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('project_edit_update_main_applink_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['recarga'];
}
?>
...
<?php
 include_once("project_edit_update_main_applink_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['project_edit_update_main_applink'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['project_edit_update_main_applink'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['dashboard_info']['maximized']))
  {
?>
<tr><td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['fast_search'][2] : "";
?> 
...
<?php 
    if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['generate_odp'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "generate_odp", "sc_btn_generate_odp()", "sc_btn_generate_odp()", "sc_generate_odp_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 
<?php
        $NM_btn = true;
    }
    if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['generate_odp_new'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "generate_odp_new", "sc_btn_generate_odp_new()", "sc_btn_generate_odp_new()", "sc_generate_odp_new_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 
<?php
        $NM_btn = true;
    }
    if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['progresstask'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "progresstask", "sc_btn_progresstask()", "sc_btn_progresstask()", "sc_progresstask_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
   ...
   {
       $this->nmgp_cmp_hidden['tp_templateproject'] = 'off';
   }
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_tp_id_line" id="hidden_field_data_tp_id" style="<?php echo $sStyleHidden_tp_id; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_id_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_tp_id" class="css_tp_id_line" style="<?php echo $sStyleReadLab_tp_id; ?>"><?php echo $this->form_encode_input($this->tp_id); ?></span><span id="id_read_off_tp_id" style="<?php echo $sStyleReadInp_tp_id; ?>"><input type="hidden" name="tp_id" value="<?php echo $this->form_encode_input($tp_id) . "\">"?><span id="id_ajax_label_tp_id"><?php echo nl2br($tp_id); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_thn_release_label" id="hidden_field_label_tp_thn_release" style="<?php echo $sStyleHidden_tp_thn_release; ?>"><span id="id_label_tp_thn_release"><?php echo $this->nm_new_label['tp_thn_release']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['php_cmp_required']['tp_thn_release']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['php_cmp_required']['tp_thn_release'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<span id="id_read_on_tp_namalop" class="sc-ui-readonly-tp_namalop css_tp_namalop_line" style="<?php echo $sStyleReadLab_tp_namalop; ?>"><?php echo $this->form_encode_input($this->tp_namalop); ?></span><span id="id_read_off_tp_namalop" style="white-space: nowrap;<?php echo $sStyleReadInp_tp_namalop; ?>">
 ...
 size=60 maxlength=100 alt="{datatype: 'text', maxLength: 100, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: 'words', enterTab: true, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_templateproject_label" id="hidden_field_label_tp_templateproject" style="<?php echo $sStyleHidden_tp_templateproject; ?>"><span id="id_label_tp_templateproject"><?php echo $this->nm_new_label['tp_templateproject']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['php_cmp_required']['tp_templateproject']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['php_cmp_required']['tp_templateproject'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_targetwaktu_label" id="hidden_field_label_tp_targetwaktu" style="<?php echo $sStyleHidden_tp_targetwaktu; ?>"><span id="id_label_tp_targetwaktu"><?php echo $this->nm_new_label['tp_targetwaktu']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['php_cmp_required']['tp_targetwaktu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['php_cmp_required']['tp_targetwaktu'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_planfinish_label" id="hidden_field_label_tp_planfinish" style="<?php echo $sStyleHidden_tp_planfinish; ?>"><span id="id_label_tp_planfinish"><?php echo $this->nm_new_label['tp_planfinish']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['php_cmp_required']['tp_planfinish']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['php_cmp_required']['tp_planfinish'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
$sTimeFormat = '';
?>
<?php echo nmButtonOutput($this->arr_buttons, "bcalendario", "nm_display_calendar('tp_planfinish', '', '10', '" . $_SESSION['scriptcase']['reg_conf']['date_week_ini']. "', '" . $sTimeFormat. "')", "nm_display_calendar('tp_planfinish', '', '10', '" . $_SESSION['scriptcase']['reg_conf']['date_week_ini']. "', '" . $sTimeFormat. "')", "calendar_tp_planfinish", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_jenisproject_label" id="hidden_field_label_tp_jenisproject" style="<?php echo $sStyleHidden_tp_jenisproject; ?>"><span id="id_label_tp_jenisproject"><?php echo $this->nm_new_label['tp_jenisproject']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['php_cmp_required']['tp_jenisproject']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['php_cmp_required']['tp_jenisproject'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<span id="id_read_on_tp_projectname" class="sc-ui-readonly-tp_projectname css_tp_projectname_line" style="<?php echo $sStyleReadLab_tp_projectname; ?>"><?php echo $this->form_encode_input($tp_projectname_val); ?></span><span id="id_read_off_tp_projectname" style="white-space: nowrap;<?php echo $sStyleReadInp_tp_projectname; ?>">
 <textarea  class="sc-js-input scFormObjectOdd css_tp_projectname_obj" style="white-space: pre-wrap;" name="tp_projectname" id="id_sc_field_tp_projectname" rows="2" cols="40"
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_divre_label" id="hidden_field_label_tp_divre" style="<?php echo $sStyleHidden_tp_divre; ?>"><span id="id_label_tp_divre"><?php echo $this->nm_new_label['tp_divre']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['php_cmp_required']['tp_divre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['php_cmp_required']['tp_divre'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_witel_label" id="hidden_field_label_tp_witel" style="<?php echo $sStyleHidden_tp_witel; ?>"><span id="id_label_tp_witel"><?php echo $this->nm_new_label['tp_witel']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['php_cmp_required']['tp_witel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['php_cmp_required']['tp_witel'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_sto_label" id="hidden_field_label_tp_sto" style="<?php echo $sStyleHidden_tp_sto; ?>"><span id="id_label_tp_sto"><?php echo $this->nm_new_label['tp_sto']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['php_cmp_required']['tp_sto']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['php_cmp_required']['tp_sto'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_mitra_label" id="hidden_field_label_tp_mitra" style="<?php echo $sStyleHidden_tp_mitra; ?>"><span id="id_label_tp_mitra"><?php echo $this->nm_new_label['tp_mitra']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['php_cmp_required']['tp_mitra']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['php_cmp_required']['tp_mitra'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
   $sCalDateFormat = strtolower($this->field_config['tp_planstart']['date_format']);
...
?>
    aFormat["tp_planstart"] = "<?php echo $sCalDateFormat; ?>";
<?php
   $sCalDateFormat = strtolower($this->field_config['tp_planfinish']['date_format']);
   $sCalDateFormat = str_replace('aaaa', 'yyyy', $sCalDateFormat);
   $sCalDateFormat = (strpos($sCalDateFormat, ';') !== false) ? substr($sCalDateFormat, 0, strpos($sCalDateFormat, ';')) : $sCalDateFormat;
?>
    aFormat["tp_planfinish"] = "<?php echo $sCalDateFormat; ?>";
    if (' ' != sValue && -1 < sValue.indexOf(' ')) {
        sTimeFormat = sValue.substr(sValue.indexOf(' ') + 1);
        sValue = sValue.substr(0, sValue.indexOf(' '));
    }
    tb_show('', '<?php echo $this->Ini->path_link . SC_dir_app_name('project_edit_update_main_applink'); ?>/project_edit_update_main_applink.php?nm_cal_display=Y&field=' + sField + '&value=' + sValue + '&sVert=' + cVert + '&inter=' + iInter + '&week_ini=' + sWeekIni + '&format=' + aFormat[sField] + '&time_format=' + sTimeFormat + '&script_case_init=<?php  echo $this->form_encode_input($this->Ini->sc_page); ?>&script_case_session=<?php echo session_id(); ?>&TB_iframe=true&height=150&width=220&modal=true', '');
}
function calendar_tp_planstart_callback(date, month, year, time)
{
...
?>
   ...
   document.F1.elements["tp_planstart"].value = data_ok;
   Obj_Form = document.F1.elements["tp_planstart"];
   if (Obj_Form.onchange && Obj_Form.onchange != '')
   {
       Obj_Form.onchange();
   }
}
function calendar_tp_planfinish_callback(date, month, year, time)
{
   if (String(month).length == 1)
   {
       month = '0' + month;
...
?>
   ...
   document.F1.elements["tp_planfinish"].value = data_ok;
   Obj_Form = document.F1.elements["tp_planfinish"];
   if (Obj_Form.onchange && Obj_Form.onchange != '')
   {
       Obj_Form.onchange();
   }
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("project_edit_update_main_applink");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("project_edit_update_main_applink");
 parent.scAjaxDetailHeight("project_edit_update_main_applink", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
