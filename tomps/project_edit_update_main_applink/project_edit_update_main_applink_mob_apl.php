<?php
//
class project_edit_update_main_applink_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_applink_mob']['nm_run_menu'] = 1;
      } 
      if (isset($_SESSION['sc_session'][$script_case_init]['project_edit_update_main_applink_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_applink_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_applink_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['project_edit_update_main_applink_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_applink_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_applink_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->idwitel)) 
          {
              $_SESSION['idwitel'] = $this->idwitel;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['project_edit_update_main_applink_mob']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_applink_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_applink_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_applink_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['project_edit_update_main_applink_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_applink_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_applink_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_applink_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new project_edit_update_main_applink_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_applink_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['project_edit_update_main_applink_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['project_edit_update_main_applink_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['project_edit_update_main_applink_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['project_edit_update_main_applink_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('project_edit_update_main_applink_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['project_edit_update_main_applink_mob']['label'] = "Form Update Data Proyek";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "project_edit_update_main_applink_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $this->arr_buttons['generate_odp']['hint']             = "";
      $this->arr_buttons['generate_odp']['type']             = "button";
      $this->arr_buttons['generate_odp']['value']            = "Generate ODP";
      $this->arr_buttons['generate_odp']['display']          = "only_text";
      $this->arr_buttons['generate_odp']['display_position'] = "text_right";
      $this->arr_buttons['generate_odp']['style']            = "default";
      $this->arr_buttons['generate_odp']['image']            = "";

      $this->arr_buttons['generate_odp_new']['hint']             = "Update jumlah ODP";
      $this->arr_buttons['generate_odp_new']['type']             = "button";
      $this->arr_buttons['generate_odp_new']['value']            = "Update ODP";
      ...
      $this->arr_buttons['progresstask']['hint']             = "";
      $this->arr_buttons['progresstask']['type']             = "button";
      $this->arr_buttons['progresstask']['value']            = "Generate Jadwal Project";
      $this->arr_buttons['progresstask']['display']          = "only_text";
      $this->arr_buttons['progresstask']['display_position'] = "text_right";
      $this->arr_buttons['progresstask']['style']            = "default";
      $this->arr_buttons['progresstask']['image']            = "";


      $_SESSION['scriptcase']['error_icon']['project_edit_update_main_applink_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['project_edit_update_main_applink_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['goto']      = 'on';
          }
      }
      ...
      $this->nmgp_botoes['generate_odp'] = "on";
      $this->nmgp_botoes['generate_odp_new'] = "on";
      $this->nmgp_botoes['progresstask'] = "on";
      if (isset($this->NM_btn_cancel) && 'N' == $this->NM_btn_cancel)
      {
          $this->nmgp_botoes['cancel'] = "off";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_applink_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['project_edit_update_main_applink_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['project_edit_update_main_applink_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['dados_form'];
          ...
          if (!isset($this->tp_jmldistribusi)){$this->tp_jmldistribusi = $this->nmgp_dados_form['tp_jmldistribusi'];} 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'project_edit_update_main_applink/project_edit_update_main_applink_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'project_edit_update_main_applink_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'project_edit_update_main_applink_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'project_edit_update_main_applink_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'project_edit_update_main_applink/project_edit_update_main_applink_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "project_edit_update_main_applink_mob_erro.class.php"); 
      }
      $this->Erro      = new project_edit_update_main_applink_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['opcao']))
         { 
             if ($this->tp_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_applink_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "novo")  
      {
          $this->nmgp_botoes['generate_odp'] = "off";
          $this->nmgp_botoes['generate_odp_new'] = "off";
          $this->nmgp_botoes['progresstask'] = "off";
      }
      elseif ($this->nmgp_opcao == "incluir")  
      {
          $this->nmgp_botoes['generate_odp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['botoes']['generate_odp'];
          $this->nmgp_botoes['generate_odp_new'] = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['botoes']['generate_odp_new'];
          $this->nmgp_botoes['progresstask'] = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['botoes']['progresstask'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      $this->field_config['tp_prosentase']['symbol_dec'] = '';
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['recarga'] = $this->nmgp_opcao;
      }
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_project_edit_update_main_applink_mob']) || !is_array($this->NM_ajax_info['errList']['geral_project_edit_update_main_applink_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_project_edit_update_main_applink_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_project_edit_update_main_applink_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
;
    ...
    {
        global $teste_validade;
      if ($this->tp_thn_release == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_thn_release']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_thn_release'] == "on"))
      {
          ...
          if (!empty($this->tp_thn_release) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_thn_release']) && !in_array($this->tp_thn_release, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_thn_release']))
          {
    ...
    {
        global $teste_validade;
      if ($this->tp_prjtrelease == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_prjtrelease']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_prjtrelease'] == "on"))
      {
          ...
          if (!empty($this->tp_prjtrelease) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_prjtrelease']) && !in_array($this->tp_prjtrelease, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_prjtrelease']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_prjtrelease']))
              {
    ...
    {
        global $teste_validade;
               if (!empty($this->tp_batch) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_batch']) && !in_array($this->tp_batch, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_batch']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_tp_namalop(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          if (NM_utf8_strlen($this->tp_namalop) > 100) 
          { 
              $Campos_Crit .= "Nama LOP " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 100 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['tp_namalop']))
              {
                  $Campos_Erros['tp_namalop'] = array();
              }
              $Campos_Erros['tp_namalop'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 100 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['tp_namalop'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 100 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
          $this->tp_namalop = ucwords($this->tp_namalop) ; 
      } 
    ...
    {
        global $teste_validade;
      if ($this->tp_templateproject == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_templateproject']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_templateproject'] == "on"))
      {
          ...
          if (!empty($this->tp_templateproject) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_templateproject']) && !in_array($this->tp_templateproject, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_templateproject']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_templateproject']))
              {
    ...
    function ValidateField_tp_targetwaktu(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_targetwaktu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_targetwaktu'] == "on") 
           { 
    ...
    function ValidateField_tp_planstart(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif ((!$this->NM_ajax_flag || 'validate_tp_planstart' != $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_planstart']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_planstart'] == "on")) 
           { 
    ...
    function ValidateField_tp_planfinish(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif ((!$this->NM_ajax_flag || 'validate_tp_planfinish' != $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_planfinish']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_planfinish'] == "on")) 
           { 
    ...
    {
        global $teste_validade;
      if ($this->tp_jenisproject == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_jenisproject']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_jenisproject'] == "on"))
      {
          ...
          if (!empty($this->tp_jenisproject) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_jenisproject']) && !in_array($this->tp_jenisproject, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_jenisproject']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_jenisproject']))
              {
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_projectname']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_projectname'] == "on")) 
      { 
    ...
    {
        global $teste_validade;
      if ($this->tp_divre == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_divre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_divre'] == "on"))
      {
          $Campos_Falta[] = "Divre" ; 
          ...
          if (!empty($this->tp_divre) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_divre']) && !in_array($this->tp_divre, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_divre']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_divre']))
              {
    ...
    {
        global $teste_validade;
      if ($this->tp_witel == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_witel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_witel'] == "on"))
      {
          $Campos_Falta[] = "Witel" ; 
          ...
          if (!empty($this->tp_witel) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_witel']) && !in_array($this->tp_witel, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_witel']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_witel']))
              {
    ...
    {
        global $teste_validade;
      if ($this->tp_datel == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_datel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_datel'] == "on"))
      {
          $Campos_Falta[] = "Datel" ; 
          ...
          if (!empty($this->tp_datel) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_datel']) && !in_array($this->tp_datel, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_datel']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_datel']))
              {
    ...
    {
        global $teste_validade;
      if ($this->tp_sto == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_sto']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_sto'] == "on"))
      {
          $Campos_Falta[] = "STO" ; 
          ...
          if (!empty($this->tp_sto) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_sto']) && !in_array($this->tp_sto, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_sto']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_sto']))
              {
    ...
    {
        global $teste_validade;
      if ($this->tp_mitra == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_mitra']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['php_cmp_required']['tp_mitra'] == "on"))
      {
          $Campos_Falta[] = "Mitra" ; 
          ...
          if (!empty($this->tp_mitra) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_mitra']) && !in_array($this->tp_mitra, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_mitra']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_mitra']))
              {
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['dados_form'] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      nm_limpa_numero($this->tp_prosentase, $this->field_config['tp_prosentase']['symbol_grp']) ; 
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['tp_id']['keyVal'] = project_edit_update_main_applink_mob_pack_protect_string($this->nmgp_dados_form['tp_id']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_thn_release']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_thn_release'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_thn_release']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_thn_release'] = array(); 
}
$aLookup[] = array(project_edit_update_main_applink_mob_pack_protect_string('') => project_edit_update_main_applink_mob_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_thn_release'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(project_edit_update_main_applink_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => project_edit_update_main_applink_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])));
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_thn_release'][] = $rs->fields[0];
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_thn_release']['valList'][$i] = project_edit_update_main_applink_mob_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_prjtrelease']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_prjtrelease'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_prjtrelease']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_prjtrelease'] = array(); 
}
$aLookup[] = array(project_edit_update_main_applink_mob_pack_protect_string('') => project_edit_update_main_applink_mob_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_prjtrelease'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(project_edit_update_main_applink_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => project_edit_update_main_applink_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_prjtrelease'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_prjtrelease']['valList'][$i] = project_edit_update_main_applink_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_batch']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_batch'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_batch']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_batch'] = array(); 
}
$aLookup[] = array(project_edit_update_main_applink_mob_pack_protect_string('') => project_edit_update_main_applink_mob_pack_protect_string('Pilh Batch'));
$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_batch'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_batch'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_batch']['valList'][$i] = project_edit_update_main_applink_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_templateproject']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_templateproject'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_templateproject']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_templateproject'] = array(); 
}
$aLookup[] = array(project_edit_update_main_applink_mob_pack_protect_string('') => project_edit_update_main_applink_mob_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_templateproject'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_templateproject'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_templateproject']['valList'][$i] = project_edit_update_main_applink_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_jenisproject']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_jenisproject'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_jenisproject']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_jenisproject'] = array(); 
}
$aLookup[] = array(project_edit_update_main_applink_mob_pack_protect_string('') => project_edit_update_main_applink_mob_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_jenisproject'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_jenisproject'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_jenisproject']['valList'][$i] = project_edit_update_main_applink_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_divre']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_divre'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_divre']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_divre'] = array(); 
}
$aLookup[] = array(project_edit_update_main_applink_mob_pack_protect_string('') => project_edit_update_main_applink_mob_pack_protect_string('Pilih Divre'));
$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_divre'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_divre'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_divre']['valList'][$i] = project_edit_update_main_applink_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_witel']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_witel'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_witel']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_witel'] = array(); 
}
$aLookup[] = array(project_edit_update_main_applink_mob_pack_protect_string('') => project_edit_update_main_applink_mob_pack_protect_string('Pilih Witel'));
$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_witel'][] = '';
if ($this->tp_divre != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_witel'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_witel']['valList'][$i] = project_edit_update_main_applink_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_datel']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_datel'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_datel']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_datel'] = array(); 
}
$aLookup[] = array(project_edit_update_main_applink_mob_pack_protect_string('') => project_edit_update_main_applink_mob_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_datel'][] = '';
if ($this->tp_witel != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_datel'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_datel']['valList'][$i] = project_edit_update_main_applink_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_sto']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_sto'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_sto']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_sto'] = array(); 
}
$aLookup[] = array(project_edit_update_main_applink_mob_pack_protect_string('') => project_edit_update_main_applink_mob_pack_protect_string('Pilih STO'));
$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_sto'][] = '';
if ($this->tp_datel != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_sto'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_sto']['valList'][$i] = project_edit_update_main_applink_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_mitra']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_mitra'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_mitra']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_mitra'] = array(); 
}
$aLookup[] = array(project_edit_update_main_applink_mob_pack_protect_string('') => project_edit_update_main_applink_mob_pack_protect_string('Pilih Mitra'));
$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_mitra'][] = '';
...
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['Lookup_tp_mitra'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_mitra']['valList'][$i] = project_edit_update_main_applink_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_tp_rab($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
   ...
   {
       $this->NM_ajax_info['btnVars']['var_btn_generate_odp_var_projectid'] = $this->form_encode_input($this->nmgp_dados_form['tp_id']);
       $this->NM_ajax_info['btnVars']['var_btn_generate_odp_var_lop'] = $this->form_encode_input($this->nmgp_dados_form['tp_idlop']);
       $this->NM_ajax_info['btnVars']['var_btn_generate_odp_var_namaproject'] = $this->form_encode_input($this->nmgp_dados_form['tp_projectname']);
       $this->NM_ajax_info['btnVars']['var_btn_generate_odp_var_lokasi'] = $this->form_encode_input($this->nmgp_dados_form['tp_lokasi']);
       $this->NM_ajax_info['btnVars']['var_btn_generate_odp_namawitel'] = $this->form_encode_input($this->nmgp_dados_form['tp_witel']);
       $this->NM_ajax_info['btnVars']['var_btn_generate_odp_namasto'] = $this->form_encode_input($this->nmgp_dados_form['tp_sto']);
       $this->NM_ajax_info['btnVars']['var_btn_generate_odp_new_var_projectid'] = $this->form_encode_input($this->nmgp_dados_form['tp_id']);
       $this->NM_ajax_info['btnVars']['var_btn_progresstask_var_idproject'] = $this->form_encode_input($this->nmgp_dados_form['tp_id']);
       $this->NM_ajax_info['btnVars']['var_btn_progresstask_var_var_tglmulaiproject'] = $this->form_encode_input($this->nmgp_dados_form['tp_planstart']);
       $this->NM_ajax_info['btnVars']['var_btn_progresstask_var_tglmulaibaru'] = $this->form_encode_input($this->nmgp_dados_form['tp_planstart']);
   } // ajax_add_parameters
  function nm_proc_onload($bFormat = true)
  {
      if ($this->sc_evento == "novo" || $this->sc_evento == "incluir" || ($this->nmgp_opcao == "nada" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['opc_ant']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['opc_ant'] == "novo") || (isset($GLOBALS['erro_incl']) && 1 == $GLOBALS['erro_incl']))
      {
      }
      else
      {
          ...
          {
              $this->nmgp_cmp_hidden["tp_status"] = "off"; $this->NM_ajax_info['fieldDisplay']['tp_status'] = 'off';
          }
      }
      if (!$this->NM_ajax_flag || !isset($this->nmgp_refresh_fields)) {
      $_SESSION['scriptcase']['project_edit_update_main_applink_mob']['contr_erro'] = 'on';
                        $this->cek_button();
$_SESSION['scriptcase']['project_edit_update_main_applink_mob']['contr_erro'] = 'off'; 
      }
      $this->nm_guardar_campos();
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->tp_id)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_ex_update = true; 
          $SC_ex_upd_or = true; 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              if (isset($NM_val_form['tp_jmldistribusi']) && $NM_val_form['tp_jmldistribusi'] != $this->nmgp_dados_select['tp_jmldistribusi']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " TP_JMLDISTRIBUSI = $this->tp_jmldistribusi"; 
                  $comando_oracle        .= " TP_JMLDISTRIBUSI = $this->tp_jmldistribusi"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
          ...
          $this->tp_thn_release = $this->tp_thn_release_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['db_changed'] = true;
              ...
              $this->nmgp_refresh_fields = array_diff(array('tp_id', 'tp_thn_release', 'tp_prjtrelease', 'tp_batch', 'tp_namalop', 'tp_templateproject', 'tp_targetwaktu', 'tp_planstart', 'tp_planfinish', 'tp_jenisproject', 'tp_projectname', 'tp_status', 'tp_divre', 'tp_witel', 'tp_datel', 'tp_sto', 'tp_idlop', 'tp_lokasi', 'tp_mitra', 'tp_nokontrak', 'tp_ponumber', 'tp_nilai', 'tp_summary', 'tp_rab'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['total']);
              }

              $this->sc_evento = "insert"; 
              $this->sc_insert_on = true; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_start'] = 0; 
              }
    ...
    if ("update" == $this->sc_evento && $this->nmgp_opcao != "nada") {
        ...
        $_SESSION['scriptcase']['project_edit_update_main_applink_mob']['contr_erro'] = 'on';
if (!isset($this->sc_temp_var_tglmulaibarudetail)) {$this->sc_temp_var_tglmulaibarudetail = (isset($_SESSION['var_tglmulaibarudetail'])) ? $_SESSION['var_tglmulaibarudetail'] : "";}
if (!isset($this->sc_temp_var_tglmulaibaru)) {$this->sc_temp_var_tglmulaibaru = (isset($_SESSION['var_tglmulaibaru'])) ? $_SESSION['var_tglmulaibaru'] : "";}
                         if ($this->nmgp_dados_form['tp_planstart'] != $this->tp_planstart || $this->nmgp_dados_form['tp_planfinish'] != $this->tp_planfinish )
{
	
$this->planstart_changed();
	$var_tglmulaibaru = $this->tp_planstart ;
	$var_tglmulaibarudetail = $this->tp_planstart ;
	 if (isset($var_tglmulaibaru)) {$this->sc_temp_var_tglmulaibaru = $var_tglmulaibaru;}
 if (isset($var_tglmulaibarudetail)) {$this->sc_temp_var_tglmulaibarudetail = $var_tglmulaibarudetail;}
;
	
}
if (isset($this->sc_temp_var_tglmulaibaru)) { $_SESSION['var_tglmulaibaru'] = $this->sc_temp_var_tglmulaibaru;}
if (isset($this->sc_temp_var_tglmulaibarudetail)) { $_SESSION['var_tglmulaibarudetail'] = $this->sc_temp_var_tglmulaibarudetail;}
$_SESSION['scriptcase']['project_edit_update_main_applink_mob']['contr_erro'] = 'off'; 
    }
      if (!empty($this->Campos_Mens_erro)) 
      {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['parms'] = "tp_id?#?$this->tp_id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['run_iframe'] == "R")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_project_edit_update_main_applink_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['total'] = $qt_geral_reg_project_edit_update_main_applink_mob;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->tp_id))
          {
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
                  $Key_Where = "TP_ID < $this->tp_id "; 
              }  
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              {
                  $Key_Where = "TP_ID < $this->tp_id "; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_project_edit_update_main_applink_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_start'] > $qt_geral_reg_project_edit_update_main_applink_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_start'] = $qt_geral_reg_project_edit_update_main_applink_mob; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_project_edit_update_main_applink_mob) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_filter']))
              {
                  ...
                  $this->NM_ajax_info['buttonDisplay']['generate_odp'] = $this->nmgp_botoes['generate_odp'] = "off";
                  $this->NM_ajax_info['buttonDisplay']['generate_odp_new'] = $this->nmgp_botoes['generate_odp_new'] = "off";
                  $this->NM_ajax_info['buttonDisplay']['progresstask'] = $this->nmgp_botoes['progresstask'] = "off";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_start'] < $qt_geral_reg_project_edit_update_main_applink_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   {  
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(TP_ID) from " . $this->Ini->nm_tabela . " where TP_ID < $this->tp_id" . $str_where_filter; 
         $rs = $this->Db->Execute("select max(TP_ID) from " . $this->Ini->nm_tabela . " where TP_ID < $this->tp_id" . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(TP_ID) from " . $this->Ini->nm_tabela . " where TP_ID < $this->tp_id" . $str_where_filter; 
     ...
     { 
         $this->tp_id = substr($this->Db->qstr($rs->fields[0]), 1, -1); 
         $rs->Close();  
         $this->nmgp_opcao = "igual";  
         return ;  
     } 
...
//-- 
   ...
   {  
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(TP_ID) from " . $this->Ini->nm_tabela . " where TP_ID > $this->tp_id" . $str_where_filter; 
         $rs = $this->Db->Execute("select min(TP_ID) from " . $this->Ini->nm_tabela . " where TP_ID > $this->tp_id" . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(TP_ID) from " . $this->Ini->nm_tabela . " where TP_ID > $this->tp_id" . $str_where_filter; 
...
//-- 
   ...
   {   
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(TP_ID) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
         $rs = $this->Db->Execute("select min(TP_ID) from " . $this->Ini->nm_tabela . " " . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(TP_ID) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
...
//-- 
   ...
   { 
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(TP_ID) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
         $rs = $this->Db->Execute("select max(TP_ID) from " . $this->Ini->nm_tabela . " " . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(TP_ID) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['reg_start'] + 1;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
$modificado_tp_planstart = $this->tp_planstart;
$modificado_tp_planfinish = $this->tp_planfinish;
$this->nm_formatar_campos('tp_templateproject', 'tp_targetwaktu', 'tp_planstart', 'tp_planfinish');
...
$check_jmldis = "SELECT COUNT(DISTINCT SUBSTRING(PO_NAMANODE,1,INSTR(PO_NAMANODE,'/')-1)) as JML FROM TB_PROJECT_ODP
WHERE PO_IDPROJECT=$this->tp_id ";
 
      $nm_select = $check_jmldis; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->rs = array();
      if ($rx = $this->Db->Execute($nm_select)) 
...
if ($this->tp_jmldistribusi  != $jmldis ) {
...
if ($tpc_odpnew  == 'Y') {
	...
	$this->NM_ajax_info['buttonDisplay']['generate_odp'] = $this->nmgp_botoes["generate_odp"] = "on";;
	$this->NM_ajax_info['buttonDisplay']['generate_odp_new'] = $this->nmgp_botoes["generate_odp_new"] = "off";;	
	};
if ($tpc_progresstask  == 'Y') {
	$this->NM_ajax_info['buttonDisplay']['progresstask'] = $this->nmgp_botoes["progresstask"] = "off";;
	} else {
	$this->NM_ajax_info['buttonDisplay']['progresstask'] = $this->nmgp_botoes["progresstask"] = "on";;
	};
if ($tpc_generatetask  == 'Y') {
	$this->NM_ajax_info['buttonDisplay']['generatetask'] = $this->nmgp_botoes["generatetask"] = "off";;
	} else {
	$this->NM_ajax_info['buttonDisplay']['generatetask'] = $this->nmgp_botoes["generatetask"] = "on";;
	};
...
function planstart_changed()
{
$_SESSION['scriptcase']['project_edit_update_main_applink_mob']['contr_erro'] = 'on';
if (!isset($this->sc_temp_var_projectid)) {$this->sc_temp_var_projectid = (isset($_SESSION['var_projectid'])) ? $_SESSION['var_projectid'] : "";}
                         

     $nm_select ="UPDATE TBL_PROJECT_PROGRESS SET TPP_TGLMULAIPLAN=null,TPP_TGLSELESAIPLAN=null ,TPP_TGLMULAIACTUAL=null ,TPP_TGLSELESAIACTUAL=null  WHERE TPP_IDPROJECT='$this->sc_temp_var_projectid'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     ...
     $nm_select ="UPDATE TBL_PROJECT_DETAIL SET PPO_TGLMULAIPLAN=null,PPO_TARGETSELESAI=null, PPO_TGLMULAIACTUAL=null, PPO_TGLSELESAIACTUAL=null  WHERE PPO_PROJECTID=$this->sc_temp_var_projectid"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="UPDATE TBL_PROJECT_CONTROL SET TPC_GENERATETASK='M', TPC_PROGRESSTASK='M',TPC_JADWALPROJECT='M' WHERE TPC_IDPROJECT='$this->sc_temp_var_projectid'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
WHERE TMT_TASKTAMPLATE=$this->sc_temp_var_templateproject
...
if (false == $this->rs )     
{
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_project_edit_update_main_applink_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$update_table  = 'TBL_PROJECT_DETAIL';      
$update_where  = "PPO_PROJECTID = $this->sc_temp_var_projectid AND PPO_TAHAPANPROJECT = $thpproject  AND PPO_IDTASKTAHAPAN = '$idtahapantask'"; 
$update_fields = array(   
     "PPO_TARGETHARI = $targettask ",
     "PPO_IS_CHANGE_TEMPLATE = 'Y'" ,
	...
	"PPO_ISCHANGETEMPBY = '$this->sc_temp_usr_login'",
	"PPO_ISCHANGETEMPDATE = sysdate"	
 );
...
$update_sql = 'UPDATE ' . $update_table
    ...
    $this->rs->Close();
     ...
     $nm_select ="UPDATE TBL_PROJECT_CONTROL SET TPC_GENERATETASK='' WHERE TPC_IDPROJECT='$this->sc_temp_var_projectid'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$update_where='';
$update_fields='';
$check_sql = "SELECT PROJECTPHASEID,PHASETARGET FROM TB_TAHAPAN_PROJECT WHERE TEMPLATEPROJECT='$this->sc_temp_var_templateproject'";
...
$update_where  = "TPP_IDPROJECT = $this->sc_temp_var_idproject"; 
$update_fields = array(   
	"TPP_PROJECTPHASEVALUE = '$phasetarget'",
	"TPP_PROSENTASEPROJECT = ''",
	"TPP_TGLMULAIPLAN = ''",
	"TPP_TGLSELESAIPLAN = ''",
	"TPP_TGLMULAIACTUAL = ''",
	"TPP_TGLSELESAIACTUAL = ''",
	"TPP_IS_CHANGE_TEMPLATE = 'Y'",
	"TPP_ISCHANGETEMPBY = '$this->sc_temp_usr_login'",
	"TPP_ISCHANGETEMPDATE = sysdate"
 );
$update_sql = 'UPDATE ' . $update_table
    . ' SET '   . implode(', ', $update_fields)
    . ' WHERE ' . $update_where;
   ...
   while(!$this->rs->EOF)
    {
		...
		$idtahapantask  = $this->rs->fields[4];
$update_table  = 'TBL_PROJECT_DETAIL';      
$update_where  = "PPO_PROJECTID = $this->tp_id  AND PPO_TAHAPANPROJECT = $thpproject  AND PPO_TASKTAHAPAN = '$tahapantask'"; 
$update_fields = array(   
     "PPO_TARGETHARI = $targettask ",
	 "PPO_TASKNUMBER = $tasknumber ",
	 "PPO_TGLMULAIPLAN = ''",
...
$update_sql = 'UPDATE ' . $update_table
    ...
    $this->rs->Close();
$javascript_title   = 'Template/ TOC project berubah';       
$javascript_message = 'Silahkan melanjutkan dengan klik tombol Generate Progress Task dan Generate Jadwal Project .';  
$this->sc_ajax_message($javascript_message, $javascript_title);
}
$_SESSION['scriptcase']['project_edit_update_main_applink_mob']['contr_erro'] = 'off';
}
function titip_onafterupdateodp()
{
$_SESSION['scriptcase']['project_edit_update_main_applink_mob']['contr_erro'] = 'on';
                         

if ($this->nmgp_dados_form['tp_templateproject'] != $this->tp_templateproject )
{

} elseif ($this->nmgp_dados_form['tp_planstart'] != $this->tp_planstart )
{

} elseif ($this->nmgp_dados_form['tp_jmldistribusi'] != $this->tp_jmldistribusi ){
$this->update_master_odp();
	} else {
	echo "test";
	}
$_SESSION['scriptcase']['project_edit_update_main_applink_mob']['contr_erro'] = 'off';
}
function update_master_odp()
{
$_SESSION['scriptcase']['project_edit_update_main_applink_mob']['contr_erro'] = 'on';
if (!isset($this->sc_temp_usr_login)) {$this->sc_temp_usr_login = (isset($_SESSION['usr_login'])) ? $_SESSION['usr_login'] : "";}
                         
$check_sql = "SELECT * FROM TBL_PROJECT_MASTER_ODP WHERE TPMO_PROJECTID=$this->tp_id ";
...
function update_table_project()
{
$_SESSION['scriptcase']['project_edit_update_main_applink_mob']['contr_erro'] = 'on';
if (!isset($this->sc_temp_usr_login)) {$this->sc_temp_usr_login = (isset($_SESSION['usr_login'])) ? $_SESSION['usr_login'] : "";}
                         
$update_table_proj  = 'TBL_PROJECT';      
$update_where_proj  = "TP_ID = $this->tp_id "; 
$update_fields_proj = array(   
     "TP_IS_CHANGE_TEMPLATE = 'Y'",
     "TP_ISCHANGETEMPBY = '$this->sc_temp_usr_login'",
	 "TP_ISCHANGETEMPDATE = sysdate",
 );

$update_tbl_project = 'UPDATE ' . $update_table_proj
    . ' SET '   . implode(', ', $update_fields_proj)
    . ' WHERE ' . $update_where_proj;

     $nm_select = $update_tbl_project; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("project_edit_update_main_applink_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['csrf_token'];
    }
...
{ 
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_project_edit_update_main_applink_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['total'] = $qt_geral_reg_project_edit_update_main_applink_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          project_edit_update_main_applink_mob_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "project_edit_update_main_applink_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "project_edit_update_main_applink_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_applink_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
