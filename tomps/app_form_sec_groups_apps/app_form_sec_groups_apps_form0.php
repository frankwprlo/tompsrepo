      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR align="center" valign="middle">
        ...
        <TD class="scFormHeaderFont">
          <?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - " . $this->Ini->Nm_lang['lang_list_apps_x_groups'] . ""; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_list_apps_x_groups'] . ""; } ?>
        </TD>
       </TR>
...
<?php
      $link_img = "";
      $SC_Label = "" . $this->Ini->Nm_lang['lang_sec_app_name']  . "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['ordem_cmp'] == "APP_NAME")
      {
...
<?php
      $link_img = "";
      $SC_Label = "" . $this->Ini->Nm_lang['lang_sec_priv_access']  . "";
      $nome_img = $this->Ini->Label_sort;
...
<?php
      $link_img = "";
      $SC_Label = "" . $this->Ini->Nm_lang['lang_sec_priv_insert']  . "";
      $nome_img = $this->Ini->Label_sort;
...
<?php
      $link_img = "";
      $SC_Label = "" . $this->Ini->Nm_lang['lang_sec_priv_delete']  . "";
      $nome_img = $this->Ini->Label_sort;
...
<?php
      $link_img = "";
      $SC_Label = "" . $this->Ini->Nm_lang['lang_sec_priv_update']  . "";
      $nome_img = $this->Ini->Label_sort;
...
<?php
      $link_img = "";
      $SC_Label = "" . $this->Ini->Nm_lang['lang_sec_priv_export']  . "";
      $nome_img = $this->Ini->Label_sort;
...
<?php
      $link_img = "";
      $SC_Label = "" . $this->Ini->Nm_lang['lang_sec_priv_print']  . "";
      $nome_img = $this->Ini->Label_sort;
...
{ 
   ...
   foreach ($this->form_vert_app_form_sec_groups_apps as $sc_seq_vert => $sc_lixo)
   {
       ...
       $this->group_id_ = $this->form_vert_app_form_sec_groups_apps[$sc_seq_vert]['group_id_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->app_name_ = $this->form_vert_app_form_sec_groups_apps[$sc_seq_vert]['app_name_']; 
...
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_app_name_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_app_name_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
$priv_access__look = "";
 ...
 if (empty($priv_access__look)) { $priv_access__look = $this->priv_access_; }
?>
<span id="id_read_on_priv_access_<?php echo $sc_seq_vert ; ?>" class="css_priv_access__line" style="<?php echo $sStyleReadLab_priv_access_; ?>"><?php echo $this->form_encode_input($priv_access__look); ?></span><span id="id_read_off_priv_access_<?php echo $sc_seq_vert ; ?>" style="<?php echo $sStyleReadInp_priv_access_; ?>"><?php echo "<div id=\"idAjaxCheckbox_priv_access_" . $sc_seq_vert . "\" style=\"display: inline-block\">\r\n"; ?><TABLE><TR>
  <TD class="scFormDataFontOddMult css_priv_access__line"> <input type=checkbox class="sc-ui-checkbox-priv_access_ sc-ui-checkbox-priv_access_<?php echo $sc_seq_vert ?>" name="priv_access_<?php echo $sc_seq_vert ?>[]" value="Y"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_access_'][] = 'Y'; ?>
<?php  if (in_array("Y", $this->priv_access__1))  { echo " checked" ;} ?> onClick="nm_check_insert(<?php echo $sc_seq_vert ?>);" ><?php echo $this->Ini->Nm_lang['lang_opt_yes']; ?></TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_priv_access_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_priv_access_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
$priv_insert__look = "";
 if (in_array("Y", $this->priv_insert__1))  { $priv_insert__look .= "" . $this->Ini->Nm_lang['lang_opt_yes'] . "<br />";} 
?>
<span id="id_read_on_priv_insert_<?php echo $sc_seq_vert ; ?>" class="css_priv_insert__line" style="<?php echo $sStyleReadLab_priv_insert_; ?>"><?php echo $this->form_encode_input($priv_insert__look); ?></span><span id="id_read_off_priv_insert_<?php echo $sc_seq_vert ; ?>" style="<?php echo $sStyleReadInp_priv_insert_; ?>"><?php echo "<div id=\"idAjaxCheckbox_priv_insert_" . $sc_seq_vert . "\" style=\"display: inline-block\">\r\n"; ?><TABLE><TR>
  <TD class="scFormDataFontOddMult css_priv_insert__line"> <input type=checkbox class="sc-ui-checkbox-priv_insert_ sc-ui-checkbox-priv_insert_<?php echo $sc_seq_vert ?>" name="priv_insert_<?php echo $sc_seq_vert ?>[]" value="Y"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_insert_'][] = 'Y'; ?>
<?php  if (in_array("Y", $this->priv_insert__1))  { echo " checked" ;} ?> onClick="nm_check_insert(<?php echo $sc_seq_vert ?>);" ><?php echo $this->Ini->Nm_lang['lang_opt_yes']; ?></TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_priv_insert_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_priv_insert_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
$priv_delete__look = "";
 ...
 if (empty($priv_delete__look)) { $priv_delete__look = $this->priv_delete_; }
?>
<span id="id_read_on_priv_delete_<?php echo $sc_seq_vert ; ?>" class="css_priv_delete__line" style="<?php echo $sStyleReadLab_priv_delete_; ?>"><?php echo $this->form_encode_input($priv_delete__look); ?></span><span id="id_read_off_priv_delete_<?php echo $sc_seq_vert ; ?>" style="<?php echo $sStyleReadInp_priv_delete_; ?>"><?php echo "<div id=\"idAjaxCheckbox_priv_delete_" . $sc_seq_vert . "\" style=\"display: inline-block\">\r\n"; ?><TABLE><TR>
  <TD class="scFormDataFontOddMult css_priv_delete__line"> <input type=checkbox class="sc-ui-checkbox-priv_delete_ sc-ui-checkbox-priv_delete_<?php echo $sc_seq_vert ?>" name="priv_delete_<?php echo $sc_seq_vert ?>[]" value="Y"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_delete_'][] = 'Y'; ?>
<?php  if (in_array("Y", $this->priv_delete__1))  { echo " checked" ;} ?> onClick="nm_check_insert(<?php echo $sc_seq_vert ?>);" ><?php echo $this->Ini->Nm_lang['lang_opt_yes']; ?></TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_priv_delete_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_priv_delete_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
$priv_update__look = "";
 ...
 if (empty($priv_update__look)) { $priv_update__look = $this->priv_update_; }
?>
<span id="id_read_on_priv_update_<?php echo $sc_seq_vert ; ?>" class="css_priv_update__line" style="<?php echo $sStyleReadLab_priv_update_; ?>"><?php echo $this->form_encode_input($priv_update__look); ?></span><span id="id_read_off_priv_update_<?php echo $sc_seq_vert ; ?>" style="<?php echo $sStyleReadInp_priv_update_; ?>"><?php echo "<div id=\"idAjaxCheckbox_priv_update_" . $sc_seq_vert . "\" style=\"display: inline-block\">\r\n"; ?><TABLE><TR>
  <TD class="scFormDataFontOddMult css_priv_update__line"> <input type=checkbox class="sc-ui-checkbox-priv_update_ sc-ui-checkbox-priv_update_<?php echo $sc_seq_vert ?>" name="priv_update_<?php echo $sc_seq_vert ?>[]" value="Y"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_update_'][] = 'Y'; ?>
<?php  if (in_array("Y", $this->priv_update__1))  { echo " checked" ;} ?> onClick="nm_check_insert(<?php echo $sc_seq_vert ?>);" ><?php echo $this->Ini->Nm_lang['lang_opt_yes']; ?></TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_priv_update_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_priv_update_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
$priv_export__look = "";
 if (in_array("Y", $this->priv_export__1))  { $priv_export__look .= "" . $this->Ini->Nm_lang['lang_opt_yes'] . "<br />";} 
?>
<span id="id_read_on_priv_export_<?php echo $sc_seq_vert ; ?>" class="css_priv_export__line" style="<?php echo $sStyleReadLab_priv_export_; ?>"><?php echo $this->form_encode_input($priv_export__look); ?></span><span id="id_read_off_priv_export_<?php echo $sc_seq_vert ; ?>" style="<?php echo $sStyleReadInp_priv_export_; ?>"><?php echo "<div id=\"idAjaxCheckbox_priv_export_" . $sc_seq_vert . "\" style=\"display: inline-block\">\r\n"; ?><TABLE><TR>
  <TD class="scFormDataFontOddMult css_priv_export__line"> <input type=checkbox class="sc-ui-checkbox-priv_export_ sc-ui-checkbox-priv_export_<?php echo $sc_seq_vert ?>" name="priv_export_<?php echo $sc_seq_vert ?>[]" value="Y"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_export_'][] = 'Y'; ?>
<?php  if (in_array("Y", $this->priv_export__1))  { echo " checked" ;} ?> onClick="nm_check_insert(<?php echo $sc_seq_vert ?>);" ><?php echo $this->Ini->Nm_lang['lang_opt_yes']; ?></TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_priv_export_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_priv_export_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
$priv_print__look = "";
 ...
 if (empty($priv_print__look)) { $priv_print__look = $this->priv_print_; }
?>
<span id="id_read_on_priv_print_<?php echo $sc_seq_vert ; ?>" class="css_priv_print__line" style="<?php echo $sStyleReadLab_priv_print_; ?>"><?php echo $this->form_encode_input($priv_print__look); ?></span><span id="id_read_off_priv_print_<?php echo $sc_seq_vert ; ?>" style="<?php echo $sStyleReadInp_priv_print_; ?>"><?php echo "<div id=\"idAjaxCheckbox_priv_print_" . $sc_seq_vert . "\" style=\"display: inline-block\">\r\n"; ?><TABLE><TR>
  <TD class="scFormDataFontOddMult css_priv_print__line"> <input type=checkbox class="sc-ui-checkbox-priv_print_ sc-ui-checkbox-priv_print_<?php echo $sc_seq_vert ?>" name="priv_print_<?php echo $sc_seq_vert ?>[]" value="Y"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_print_'][] = 'Y'; ?>
<?php  if (in_array("Y", $this->priv_print__1))  { echo " checked" ;} ?> onClick="nm_check_insert(<?php echo $sc_seq_vert ?>);" ><?php echo $this->Ini->Nm_lang['lang_opt_yes']; ?></TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_priv_print_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_priv_print_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "balterarsel", "nm_atualiza ('alterar');", "nm_atualiza ('alterar');", "sc_b_upd_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
