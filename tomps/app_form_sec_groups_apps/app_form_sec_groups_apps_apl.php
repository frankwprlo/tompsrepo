             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 if ($cadapar[0] == "GROUP_ID_")
                 {
                     ...
                     $this->NM_where_filter .= " = '" . $this->GROUP_ID_ . "'";
                 ...
                 {
                     $this->NM_where_filter .= (empty($this->NM_where_filter)) ? "(" : " and ";
                     $this->NM_where_filter .= " = '" . $this->APP_NAME_ . "'";
                     $this->has_where_params = true;
                     $tem_where_parms        = true;
                 }
                 elseif ($cadapar[0] == "NM_where_filter")
      ...
      { 
          ...
          { 
              ...
              if (isset($this->Embutida_form) && $this->Embutida_form)
              {
                  ...
                  $this->NM_ajax_info['fldList']['app_name_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->app_name_));
                  $this->NM_ajax_info['fldList']['app_name_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input($tmpLabel_app_name_));
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_access_'][] = 'Y';
          ...
          $tmpLabel_priv_access_ = $sLabelTemp;
                  ...
                  $this->NM_ajax_info['fldList']['priv_access_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->priv_access_));
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_insert_'][] = 'Y';
          ...
          $tmpLabel_priv_insert_ = $sLabelTemp;
                  ...
                  $this->NM_ajax_info['fldList']['priv_insert_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->priv_insert_));
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_delete_'][] = 'Y';
          ...
          $tmpLabel_priv_delete_ = $sLabelTemp;
                  ...
                  $this->NM_ajax_info['fldList']['priv_delete_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->priv_delete_));
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_update_'][] = 'Y';
          ...
          $tmpLabel_priv_update_ = $sLabelTemp;
                  ...
                  $this->NM_ajax_info['fldList']['priv_update_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->priv_update_));
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_export_'][] = 'Y';
          ...
          $tmpLabel_priv_export_ = $sLabelTemp;
                  ...
                  $this->NM_ajax_info['fldList']['priv_export_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->priv_export_));
...
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['Lookup_priv_print_'][] = 'Y';
          ...
          $tmpLabel_priv_print_ = $sLabelTemp;
                  ...
                  $this->NM_ajax_info['fldList']['priv_print_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input($this->priv_print_));
...
<?php
 ...
 function new_date_format($type, $field)
 {
   ...
   {
       $nmgp_def_dados  = "";
       $nmgp_def_dados .= "{lang_opt_yes}?#?Y?#?N?@?";
