...
$old_error_handler = set_error_handler("jenisproject_inline_scriptcase_error_handler");

function jenisproject_inline_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['jenisproject_inline']['contr_erro']) && $_SESSION['scriptcase']['jenisproject_inline']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_jenisproject_inline->contr_jenisproject_inline->Apl_com_erro = true;
            if ($inicial_jenisproject_inline->contr_jenisproject_inline->NM_ajax_flag)
            {
                $inicial_jenisproject_inline->contr_jenisproject_inline->NM_ajax_info['errList']['geral_jenisproject_inline'][] = $msg;
                return;
            }
            jenisproject_inline_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function jenisproject_inline_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['jenisproject_inline'])  && '' != $_SESSION['scriptcase']['error_icon']['jenisproject_inline'])  ? $_SESSION['scriptcase']['error_icon']['jenisproject_inline']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['jenisproject_inline']) && '' != $_SESSION['scriptcase']['error_span_title']['jenisproject_inline']) ? $_SESSION['scriptcase']['error_span_title']['jenisproject_inline'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['jenisproject_inline']) && '' != $_SESSION['scriptcase']['error_icon_title']['jenisproject_inline']) ? $_SESSION['scriptcase']['error_icon_title']['jenisproject_inline'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['jenisproject']['error_buffer'] .= ob_get_flush();
}
