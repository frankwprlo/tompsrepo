  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_jenisproject_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_jenisproject_inline_validate_tj_idjenis_()
  {
    var nomeCampo_tj_idjenis_ = "tj_idjenis_";
    var var_tj_idjenis_ = scAjaxGetFieldHidden(nomeCampo_tj_idjenis_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_jenisproject_inline_validate_tj_idjenis_(var_tj_idjenis_, var_script_case_init, do_ajax_jenisproject_inline_validate_tj_idjenis__cb);
  } // do_ajax_jenisproject_inline_validate_tj_idjenis_

  function do_ajax_jenisproject_inline_validate_tj_idjenis__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_jenisproject_inline_validate_tj_idjenis__cb

  // ---------- Validate tj_namajenis_
  function do_ajax_jenisproject_inline_validate_tj_namajenis_()
  {
    var nomeCampo_tj_namajenis_ = "tj_namajenis_";
    var var_tj_namajenis_ = scAjaxGetFieldText(nomeCampo_tj_namajenis_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_jenisproject_inline_validate_tj_namajenis_(var_tj_namajenis_, var_script_case_init, do_ajax_jenisproject_inline_validate_tj_namajenis__cb);
  } // do_ajax_jenisproject_inline_validate_tj_namajenis_

  function do_ajax_jenisproject_inline_validate_tj_namajenis__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_jenisproject_inline_validate_tj_namajenis__cb

  // ---------- Validate tj_deskripsi_
  function do_ajax_jenisproject_inline_validate_tj_deskripsi_()
  {
    var nomeCampo_tj_deskripsi_ = "tj_deskripsi_";
    var var_tj_deskripsi_ = scAjaxGetFieldText(nomeCampo_tj_deskripsi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_jenisproject_inline_validate_tj_deskripsi_(var_tj_deskripsi_, var_script_case_init, do_ajax_jenisproject_inline_validate_tj_deskripsi__cb);
  } // do_ajax_jenisproject_inline_validate_tj_deskripsi_

  function do_ajax_jenisproject_inline_validate_tj_deskripsi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_jenisproject_inline_validate_tj_deskripsi__cb
  // ---------- Form
  function do_ajax_jenisproject_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_jenisproject_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_tj_idjenis_ = scAjaxGetFieldHidden("tj_idjenis_");
    var var_tj_namajenis_ = scAjaxGetFieldText("tj_namajenis_");
    var var_tj_deskripsi_ = scAjaxGetFieldText("tj_deskripsi_");
    ...
    scAjaxProcOn();
    x_ajax_jenisproject_inline_submit_form(var_tj_idjenis_, var_tj_namajenis_, var_tj_deskripsi_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_jenisproject_inline_submit_form_cb);
  } // do_ajax_jenisproject_inline_submit_form

  function do_ajax_jenisproject_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tj_idjenis_");
      scAjaxHideErrorDisplay("tj_namajenis_");
      scAjaxHideErrorDisplay("tj_deskripsi_");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_jenisproject_inline_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_jenisproject_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_jenisproject_inline_navigate_form(var_tj_idjenis_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_jenisproject_inline_navigate_form_cb);
  } // do_ajax_jenisproject_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['jenisproject_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_jenisproject_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_jenisproject_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_jenisproject_inline_navigate_form_cb
  function sc_hide_jenisproject_inline_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_jenisproject_inline_form
  ...
  ajax_field_list[0] = "tj_idjenis_";
  ajax_field_list[1] = "tj_namajenis_";
  ajax_field_list[2] = "tj_deskripsi_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "tj_idjenis_": {"label": "ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tj_namajenis_": {"label": "Nama", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tj_deskripsi_": {"label": "Deskripsi", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["tj_idjenis_"][1] = "tj_idjenis_";
  ajax_field_mult["tj_namajenis_"][1] = "tj_namajenis_";
  ajax_field_mult["tj_deskripsi_"][1] = "tj_deskripsi_";

  var ajax_field_id = {
    "tj_idjenis_": new Array("hidden_field_label_tj_idjenis_", "hidden_field_data_tj_idjenis_"),
    "tj_namajenis_": new Array("hidden_field_label_tj_namajenis_", "hidden_field_data_tj_namajenis_"),
    "tj_deskripsi_": new Array("hidden_field_label_tj_deskripsi_", "hidden_field_data_tj_deskripsi_")
  };
