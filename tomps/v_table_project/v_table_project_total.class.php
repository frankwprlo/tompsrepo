...
class v_table_project_total
{
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['v_table_project']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['v_table_project']['campos_busca']))
      { 
