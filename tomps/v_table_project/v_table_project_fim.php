...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["projectamo_____v_table_project"]))
   {
      unset($_SESSION['session_sec_aplicacao']["projectamo_____v_table_project"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['v_table_project']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['v_table_project']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['v_table_project']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['v_table_project']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['v_table_project']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['v_table_project']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['v_table_project']['embutida_filho'] as $ind => $sc_init)
          {
