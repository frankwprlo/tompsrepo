...
class v_table_project_resumo
{
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['dashboard_info']['under_dashboard'] ? "off" : "on";
      $this->nmgp_botoes['chart_detail'] = "on";
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['dashboard_info']['under_dashboard'] ? "off" : "on";
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['dashboard_info']['under_dashboard'] ? "off" : "on";

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['v_table_project'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['v_table_project'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['v_table_project']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['v_table_project']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['v_table_project']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['campos_busca'];
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['contr_total_geral'] == "OK")
      {
          $this->array_total_statusname = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['arr_total']['statusname'];
          $this->array_total_tm_namamitra = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['arr_total']['tm_namamitra'];
      }
      else
      {
          $this->array_total_statusname = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][2];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][3];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][4];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][5];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][6];
      $this->array_total_geral[6] = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][7];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['contr_array_resumo'] = "OK";
   }
...
TestComm",
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['summarizing_fields_order']['gbmitra']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['summarizing_fields_order']['gbmitra'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['summarizing_fields_order']['gbmitra'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['summarizing_fields_display']['gbmitra'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['summarizing_fields_display']['gbmitra'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['summarizing_fields_display']['gbmitra'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['summarizing_fields_display']['gbmitra'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['summarizing_fields_display']['gbmitra'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['summarizing_fields_display']['gbmitra'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['summarizing_fields_display']['gbmitra'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_statusname as $i_statusname => $d_statusname) {
           if (!in_array($i_statusname, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_statusname[9] ] = $d_statusname[8];
               $this->comp_label[0][ $d_statusname[9] ] = $d_statusname[8];
           }
           foreach ($this->array_total_tm_namamitra[$i_statusname] as $i_tm_namamitra => $d_tm_namamitra) {
               if (!in_array($i_tm_namamitra, $this->comp_label[1][ $d_statusname[9] ], true)) {
                   $this->comp_index[1][ $d_tm_namamitra[9] ] = $d_tm_namamitra[8];
                   $this->comp_label[1][ $d_statusname[9] ][ $d_tm_namamitra[9] ] = $d_tm_namamitra[8];
               }
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@v_table_project@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['pivot_order_start'][$iYAxysIndex])
                       {
   ...
   function resumo_init()
   {
      ...
      $this->monta_html_ini();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
      {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['v_table_project']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['v_table_project']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['v_table_project']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['v_table_project']) . "_";
               } 
           }
       }
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "v_table_project_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['print_all'];
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['opcao'] = "print";
      ...
      $this->Total   = new v_table_project_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['responsive_chart']['active']) {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"v_table_project_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"v_table_project_jquery.js\"></script>\r\n");
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_v_table_project_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_v_table_project_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_v_table_project_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['num_css'] . '.css');
     ...
     else
     {
      ...
      $nm_saida->saida(" </style>\r\n");
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "v_table_project/v_table_project_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['embutida'])
      {
         ...
         $NM_btn = false;
         if (is_file("v_table_project_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("v_table_project_help.txt"); 
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'v_table_project_config_pivot.php?nome_apl=v_table_project&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   </form> \r\n");
      ...
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['v_table_project_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@v_table_project@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
      $nm_saida->saida("  if (\"pdf\" == x)\r\n");
      $nm_saida->saida("  {\r\n");
      $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "v_table_project/v_table_project_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_create_charts=\" + crt + \"&sc_graf_pdf=\" + g;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_v_table_project_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "v_table_project/v_table_project_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   //---- 
   function adiciona_registro($sum_tp_odp, $avg_prepare, $avg_perijinan, $avg_inst_testcomm, $avg_closing, $avg_pencapaian, $quebra_statusname, $quebra_tm_namamitra, $quebra_statusname_orig, $quebra_tm_namamitra_orig)
   {
      //----- STATUSNAME
      if (!isset($this->array_total_statusname[$quebra_statusname_orig]))
      {
         ...
         $this->array_total_statusname[$quebra_statusname_orig][2] = $avg_prepare;
         $this->array_total_statusname[$quebra_statusname_orig][3] = $avg_perijinan;
         $this->array_total_statusname[$quebra_statusname_orig][4] = $avg_inst_testcomm;
         $this->array_total_statusname[$quebra_statusname_orig][5] = $avg_closing;
         $this->array_total_statusname[$quebra_statusname_orig][6] = $avg_pencapaian;
         $this->array_total_statusname[$quebra_statusname_orig][7] = 1;
         $this->array_total_statusname[$quebra_statusname_orig][8] = $quebra_statusname;
         $this->array_total_statusname[$quebra_statusname_orig][9] = $quebra_statusname_orig;
      }
      else
      {
         ...
         $this->array_total_statusname[$quebra_statusname_orig][5] += $avg_closing;
         $this->array_total_statusname[$quebra_statusname_orig][6] += $avg_pencapaian;
         $this->array_total_statusname[$quebra_statusname_orig][7]++;
      }
      //----- TM NAMAMITRA
      if (!isset($this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig]))
      {
         ...
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][2] = $avg_prepare;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][3] = $avg_perijinan;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][4] = $avg_inst_testcomm;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][5] = $avg_closing;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][6] = $avg_pencapaian;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][7] = 1;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][8] = $quebra_tm_namamitra;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][9] = $quebra_tm_namamitra_orig;
      }
      else
      {
         ...
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][5] += $avg_closing;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][6] += $avg_pencapaian;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][7]++;
      }
      //----- Total
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['arr_total']['statusname'] as $campo_statusname => $dados_statusname)
      {
         ...
         $this->array_total_statusname[$campo_statusname][1] = $dados_statusname[7];
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['arr_total']['tm_namamitra'][$campo_statusname] as $campo_tm_namamitra => $dados_tm_namamitra)
         {
            ...
            $this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][1] = $dados_tm_namamitra[7];
         }
      }
   }
   //---- 
   function finaliza_arrays()
   {
      foreach ($this->array_total_statusname as $campo_statusname => $dados_statusname)
      {
         ...
         foreach ($this->array_total_tm_namamitra[$campo_statusname] as $campo_tm_namamitra => $dados_tm_namamitra)
         {
            ...
            if ($this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][0] != 0) {$this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][2] /= $this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][0];}
            nmgp_Trunc_Num($this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][2], 2);
            if ($this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][0] != 0) {$this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][3] /= $this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][0];}
            nmgp_Trunc_Num($this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][3], 2);
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['where_pesq']; 
     $campos_order = "";
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $_SESSION['scriptcase']['v_table_project']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['v_table_project']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->tp_odp, $this->prepare, $this->perijinan, $this->inst_testcomm, $this->closing, $this->pencapaian, $this->statusname, $this->tm_namamitra, $this->statusname_orig,  $this->tm_namamitra_orig);
            }
   }
//
   ...
   function totaliza_php_gbmitra()
   {
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['where_pesq_filtro'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['contr_total_geral'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['contr_array_resumo'] == "OK")
      {
          return;
      }
      //----- 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
         $nmgp_select = "SELECT TP_ID, STATUSNAME, TM_NAMAMITRA, TP_ODP, TP_TEMPLATEPROJECT from " . $this->Ini->nm_tabela; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
         $nmgp_select = "SELECT TP_ID, STATUSNAME, TM_NAMAMITRA, TP_ODP, TP_TEMPLATEPROJECT from " . $this->Ini->nm_tabela; 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['ordem_grid']) 
        {
   ...
   $campos_order = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['ordem_desc']; 
   } 
   ...
   $nmgp_select .= $nmgp_order_by; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['order_grid'] = $nmgp_order_by;
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
      ...
      while (!$this->rs_grid->EOF) 
      {
         ...
         $this->tp_templateproject = $this->rs_grid->fields[4] ;  
...
$_SESSION['scriptcase']['v_table_project']['contr_erro'] = 'off';
      ...
      $this->finaliza_arrays();
      $this->rs_grid->Close();
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][2] = $this->array_total_geral[1];
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][3] = $this->array_total_geral[2];
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][4] = $this->array_total_geral[3];
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][5] = $this->array_total_geral[4];
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][6] = $this->array_total_geral[5];
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][7] = $this->array_total_geral[6];
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][1] = $this->array_total_geral[0];
      $count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][1];
      $sum_tp_odp = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][2];
      $avg_prepare = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][3];
      $avg_perijinan = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][4];
      $avg_inst_testcomm = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][5];
      $avg_closing = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][6];
      $avg_pencapaian = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['tot_geral'][7];
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['contr_total_geral'] = "OK";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['SC_Ind_Groupby'] == "gbmitra")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['arr_total']['statusname'] = $this->array_total_statusname;
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project']['arr_total']['tm_namamitra'] = $this->array_total_tm_namamitra;
      }
   }
