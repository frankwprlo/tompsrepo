...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['v_table_project']['show_skip_charts_option']) || !$_SESSION['sc_session']['v_table_project']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
