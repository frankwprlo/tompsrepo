 ...
 */
    ...
    session_start();
    $SC_apl_proc = "resume_realisasi_project_inwitel";
...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['resume_realisasi_project_inwitel']['show_skip_charts_option']) || !$_SESSION['sc_session']['resume_realisasi_project_inwitel']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
