...
class resume_realisasi_project_inwitel_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= "_resume_realisasi_project_inwitel";
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "resume_realisasi_project_inwitel.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['order_grid'];
...
$_SESSION['scriptcase']['resume_realisasi_project_inwitel']['contr_erro'] = 'off'; 
   ...
   function NM_export_realisasi()
   {
         ...
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->realisasi);
         $this->Xls_col++;
   }
   //----- tp_releasename
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel'][$path_doc_md5][1] = $this->Tit_doc;
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE>List Data Detail :: Excel</TITLE>
