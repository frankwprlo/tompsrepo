...
class resume_realisasi_project_inwitel_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_tp_releasename;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_tp_releasename = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['contr_total_geral'] == "OK")
      {
          $this->array_total_tp_releasename = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['arr_total']['tp_releasename'];
          $this->array_total_tm_namamitra = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['arr_total']['tm_namamitra'];
      }
      else
      {
          $this->array_total_tp_releasename = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['tot_geral'][4];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['tot_geral'][2];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['tot_geral'][3];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['tot_geral'][5];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['tot_geral'][6];
      $this->array_total_geral[6] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['tot_geral'][7];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['arr_total']['tp_releasename'] = $this->array_total_tp_releasename;
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['arr_total']['tm_namamitra'] = $this->array_total_tm_namamitra;
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $Lab_tp_releasename = "Release Project";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_order']['groupbymitradatel']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_order']['groupbymitradatel'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_order']['groupbymitradatel'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_display']['groupbymitradatel'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_display']['groupbymitradatel'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_display']['groupbymitradatel'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_display']['groupbymitradatel'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_display']['groupbymitradatel'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_display']['groupbymitradatel'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_display']['groupbymitradatel'] as $i_sum => $d_sum)
           {
       ...
       $this->comp_sum_lnk = array(
           ...
           4 => array('field' => "tp_rab", 'show' => true),
           5 => array('field' => "tp_nilai", 'show' => true),
           6 => array('field' => "realisasi", 'show' => true),
           7 => array('field' => "realisasi", 'show' => true),
           8 => array('field' => "realisasi", 'show' => true),
       );
       ...
       //-----
       foreach ($this->array_total_tp_releasename as $i_tp_releasename => $d_tp_releasename) {
           if (!in_array($i_tp_releasename, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_tp_releasename[9] ] = $d_tp_releasename[8];
               $this->comp_label[0][ $d_tp_releasename[9] ] = $d_tp_releasename[8];
           }
           foreach ($this->array_total_tm_namamitra[$i_tp_releasename] as $i_tm_namamitra => $d_tm_namamitra) {
               if (!in_array($i_tm_namamitra, $this->comp_label[1][ $d_tp_releasename[9] ], true)) {
                   $this->comp_index[1][ $d_tm_namamitra[9] ] = $d_tm_namamitra[8];
                   $this->comp_label[1][ $d_tp_releasename[9] ][ $d_tm_namamitra[9] ] = $d_tm_namamitra[8];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'tp_releasename', 'prot' => '@aspass@'),
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_tp_releasename => $l_tp_releasename) {
           if (isset($this->array_total_tp_releasename[$i_tp_releasename])) {
               $this->comp_group[$i_tp_releasename] = array();
           }
           foreach ($this->comp_label[1][$i_tp_releasename] as $i_tm_namamitra => $l_tm_namamitra) {
               if (isset($this->array_total_tm_namamitra[$i_tp_releasename][$i_tm_namamitra])) {
                   $this->comp_group[$i_tp_releasename][$i_tm_namamitra] = array();
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_tp_releasename;
       }
       elseif (1 == $level) {
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@resume_realisasi_project_inwitel@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['anlt_table_def']  = array();
   }
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_resume_realisasi_project_inwitel_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_resume_realisasi_project_inwitel_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['pivot_order_start'][$iYAxysIndex])
                       {
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "resume_realisasi_project_inwitel_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['opcao'] = "print";
      ...
      $this->Total   = new resume_realisasi_project_inwitel_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_groupbymitradatel("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_tp_releasename);
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>Resume Realisasi Waktu Penyelesaian Project Witel " . $_SESSION['kodewitel'] . "</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_resume_realisasi_project_inwitel_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_resume_realisasi_project_inwitel_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_resume_realisasi_project_inwitel_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['num_css'] . '.css');
     ...
     else
     {
      ...
      $nm_saida->saida(" </style>\r\n");
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "resume_realisasi_project_inwitel/resume_realisasi_project_inwitel_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['responsive_chart']['active']) {
          ...
          {
              $summary_width = "width=\"50%\"";
          }
      }
      $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\">\r\n");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "resume_realisasi_project_inwitel/resume_realisasi_project_inwitel_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnGroupByShow('" . $this->Ini->path_link . "resume_realisasi_project_inwitel/resume_realisasi_project_inwitel_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("resume_realisasi_project_inwitel_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'resume_realisasi_project_inwitel_config_pivot.php?nome_apl=resume_realisasi_project_inwitel&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_resume_realisasi_project_inwitel_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "resume_realisasi_project_inwitel/resume_realisasi_project_inwitel_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      $nm_saida->saida("          Resume Realisasi Waktu Penyelesaian Project Witel " . $_SESSION['kodewitel'] . "\r\n");
      $nm_saida->saida("        </TD>\r\n");
      $nm_saida->saida("       </TR>\r\n");
      $nm_saida->saida("       <TR align=\"right\" valign=\"middle\">\r\n");
      $nm_saida->saida("        <TD class=\"" . $this->css_scGridHeaderFont . "\">\r\n");
      $nm_saida->saida("          " . "Avg,Max,Min in days" . "\r\n");
      $nm_saida->saida("        </TD>\r\n");
      $nm_saida->saida("       </TR>\r\n");
      $nm_saida->saida("      </TABLE>\r\n");
      $nm_saida->saida("     </TD>\r\n");
   ...
   function monta_rodape()
   {
      ...
      $nm_cab_filtro   = ""; 
      $nm_cab_filtrobr = ""; 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['campos_busca']))
      { 
        $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['campos_busca'];
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
   ...
   //---- 
   function adiciona_registro($sum_tp_rab, $sum_tp_nilai, $sum_tp_odp, $avg_realisasi, $max_realisasi, $min_realisasi, $quebra_tp_releasename, $quebra_tm_namamitra, $quebra_tp_releasename_orig, $quebra_tm_namamitra_orig)
   {
      //----- Release Project
      if (!isset($this->array_total_tp_releasename[$quebra_tp_releasename_orig]))
      {
         $this->array_total_tp_releasename[$quebra_tp_releasename_orig][0] = 1;
         $this->array_total_tp_releasename[$quebra_tp_releasename_orig][1] = $sum_tp_rab;
         $this->array_total_tp_releasename[$quebra_tp_releasename_orig][2] = $sum_tp_nilai;
         $this->array_total_tp_releasename[$quebra_tp_releasename_orig][3] = $sum_tp_odp;
         $this->array_total_tp_releasename[$quebra_tp_releasename_orig][4] = $avg_realisasi;
         $this->array_total_tp_releasename[$quebra_tp_releasename_orig][5] = $max_realisasi;
         $this->array_total_tp_releasename[$quebra_tp_releasename_orig][6] = $min_realisasi;
         $this->array_total_tp_releasename[$quebra_tp_releasename_orig][7] = 1;
         $this->array_total_tp_releasename[$quebra_tp_releasename_orig][8] = $quebra_tp_releasename;
         $this->array_total_tp_releasename[$quebra_tp_releasename_orig][9] = $quebra_tp_releasename_orig;
      }
      else
      {
         $this->array_total_tp_releasename[$quebra_tp_releasename_orig][0]++;
         $this->array_total_tp_releasename[$quebra_tp_releasename_orig][1] += $sum_tp_rab;
         $this->array_total_tp_releasename[$quebra_tp_releasename_orig][2] += $sum_tp_nilai;
         $this->array_total_tp_releasename[$quebra_tp_releasename_orig][3] += $sum_tp_odp;
         $this->array_total_tp_releasename[$quebra_tp_releasename_orig][4] += $avg_realisasi;
         $this->array_total_tp_releasename[$quebra_tp_releasename_orig][5] = max($this->array_total_tp_releasename[$quebra_tp_releasename_orig][5], $max_realisasi);
         $this->array_total_tp_releasename[$quebra_tp_releasename_orig][6] = min($this->array_total_tp_releasename[$quebra_tp_releasename_orig][6], $min_realisasi);
         $this->array_total_tp_releasename[$quebra_tp_releasename_orig][7]++;
      }
      //----- Mitra
      if (!isset($this->array_total_tm_namamitra[$quebra_tp_releasename_orig][$quebra_tm_namamitra_orig]))
      {
         $this->array_total_tm_namamitra[$quebra_tp_releasename_orig][$quebra_tm_namamitra_orig][0] = 1;
         $this->array_total_tm_namamitra[$quebra_tp_releasename_orig][$quebra_tm_namamitra_orig][1] = $sum_tp_rab;
         $this->array_total_tm_namamitra[$quebra_tp_releasename_orig][$quebra_tm_namamitra_orig][2] = $sum_tp_nilai;
         $this->array_total_tm_namamitra[$quebra_tp_releasename_orig][$quebra_tm_namamitra_orig][3] = $sum_tp_odp;
         $this->array_total_tm_namamitra[$quebra_tp_releasename_orig][$quebra_tm_namamitra_orig][4] = $avg_realisasi;
         $this->array_total_tm_namamitra[$quebra_tp_releasename_orig][$quebra_tm_namamitra_orig][5] = $max_realisasi;
         $this->array_total_tm_namamitra[$quebra_tp_releasename_orig][$quebra_tm_namamitra_orig][6] = $min_realisasi;
         $this->array_total_tm_namamitra[$quebra_tp_releasename_orig][$quebra_tm_namamitra_orig][7] = 1;
         $this->array_total_tm_namamitra[$quebra_tp_releasename_orig][$quebra_tm_namamitra_orig][8] = $quebra_tm_namamitra;
         $this->array_total_tm_namamitra[$quebra_tp_releasename_orig][$quebra_tm_namamitra_orig][9] = $quebra_tm_namamitra_orig;
      }
      else
      {
         $this->array_total_tm_namamitra[$quebra_tp_releasename_orig][$quebra_tm_namamitra_orig][0]++;
         $this->array_total_tm_namamitra[$quebra_tp_releasename_orig][$quebra_tm_namamitra_orig][1] += $sum_tp_rab;
         $this->array_total_tm_namamitra[$quebra_tp_releasename_orig][$quebra_tm_namamitra_orig][2] += $sum_tp_nilai;
         $this->array_total_tm_namamitra[$quebra_tp_releasename_orig][$quebra_tm_namamitra_orig][3] += $sum_tp_odp;
         $this->array_total_tm_namamitra[$quebra_tp_releasename_orig][$quebra_tm_namamitra_orig][4] += $avg_realisasi;
         $this->array_total_tm_namamitra[$quebra_tp_releasename_orig][$quebra_tm_namamitra_orig][5] = max($this->array_total_tm_namamitra[$quebra_tp_releasename_orig][$quebra_tm_namamitra_orig][5], $max_realisasi);
         $this->array_total_tm_namamitra[$quebra_tp_releasename_orig][$quebra_tm_namamitra_orig][6] = min($this->array_total_tm_namamitra[$quebra_tp_releasename_orig][$quebra_tm_namamitra_orig][6], $min_realisasi);
         $this->array_total_tm_namamitra[$quebra_tp_releasename_orig][$quebra_tm_namamitra_orig][7]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'tp_releasename');
     $campos_order = $this->Ini->Get_date_order_groupby("TP_RELEASENAME", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->statusname = $rs_res->fields[8] ;  
            $this->tm_namamitra = $rs_res->fields[9] ;  
            $this->tp_projectname = $rs_res->fields[10] ;  
            $this->tp_rab = $rs_res->fields[11] ;  
            $this->tp_nilai = $rs_res->fields[12] ;  
            $this->tp_lokasi = $rs_res->fields[13] ;  
            $this->tp_odp = $rs_res->fields[14] ;  
            $this->tp_planstart = $rs_res->fields[15] ;  
            $this->tp_planfinish = $rs_res->fields[16] ;  
            $this->tp_summary = $rs_res->fields[17] ;  
            $this->tp_status = $rs_res->fields[18] ;  
            $this->tp_jenisproject = $rs_res->fields[19] ;  
            $this->tp_targetwaktu = $rs_res->fields[20] ;  
            $this->realisasi = $rs_res->fields[21] ;  
            $this->tp_releasename = $rs_res->fields[22] ;  
            $this->tj_namajenis = $rs_res->fields[23] ;  
            $this->tp_mitra = $rs_res->fields[24] ;  
            $this->tp_witel = $rs_res->fields[25] ;  
            $this->tp_templateproject = $rs_res->fields[26] ;  
...
$_SESSION['scriptcase']['resume_realisasi_project_inwitel']['contr_erro'] = 'off'; 
            $this->tp_releasename_orig = $this->tp_releasename;
            $this->tm_namamitra_orig = $this->tm_namamitra;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->tp_rab, $this->tp_nilai, $this->tp_odp, $this->realisasi, $this->realisasi, $this->realisasi, $this->tp_releasename, $this->tm_namamitra, $this->tp_releasename_orig,  $this->tm_namamitra_orig);
            }
   }
//
