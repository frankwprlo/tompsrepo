<?php
   ...
   $Sel_Groupby = new resume_realisasi_project_inwitel_sel_Groupby(); 
   $Sel_Groupby->Sel_Groupby_init();
   
class resume_realisasi_project_inwitel_sel_Groupby
{
function Sel_Groupby_init()
{
   ...
   $groupby_atual = $_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['SC_Ind_Groupby'];
...
function Sel_processa_out($sel_groupby)
{
   ...
   {
       $_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['SC_Ind_Groupby']     = $sel_groupby;
       $_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['contr_array_resumo'] = "NAO";
       $_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['contr_total_geral']  = "NAO";
       unset($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['ordem_quebra']);
       unset($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['ordem_select']);
       unset($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['tot_geral']);
       unset($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['arr_total']);
       unset($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['pivot_group_by']);
       unset($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['pivot_x_axys']);
       unset($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['pivot_y_axys']);
       unset($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['pivot_fill']);
       unset($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['pivot_order']);
       unset($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['pivot_order_col']);
       unset($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['pivot_order_level']);
       unset($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['pivot_order_sort']);
       unset($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['pivot_tabular']);
   }
?>
...
?>
 <script language="javascript" type="text/javascript">
  function scSubmitGroupBy(sPos) {
   $.ajax({
    type: "POST",
    url: "resume_realisasi_project_inwitel_sel_groupby.php",
    data: {
...
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
...
{
  $max_height = 1;
  if (isset($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
...
<?php
    ...
    $iTabCount            = 0;
    foreach ($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['SC_All_Groupby'] as $QB => $Tp)
    {
        if (!in_array($QB, $_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['SC_Groupby_hide']))
        {
...
<?php
     if (!in_array("groupbymitradatel", $_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['SC_Groupby_hide']))
     {
...
?>
<?php
     if (!in_array("gbmitraonly", $_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['SC_Groupby_hide']))
     {
...
?>
<?php
     if (!in_array("gbmitra", $_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['SC_Groupby_hide']))
     {
...
?>
 <tr id="sc_id_summary" class="SummaryBox" style='display:<?php echo ($has_total_dynamic)?'':'none';?>'>
  <td>
    ...
    <?php
    foreach ($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['summarizing_fields_control'] as $nome_quebra => $_arr_fields_totals)
    {
    ?>
...
<?php
          if(isset($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['summarizing_fields_order'][ $nome_quebra ]) && is_array($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['summarizing_fields_order'][ $nome_quebra ]) && !empty($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['summarizing_fields_order'][ $nome_quebra ]))
          {
           foreach ($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['summarizing_fields_order'][ $nome_quebra ] as $i_sum)
           {
            if ('' != $i_sum && isset($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['summarizing_fields_display'][ $nome_quebra ][$i_sum]))
            {
                $d_sum = $_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['summarizing_fields_display'][ $nome_quebra ][$i_sum];
                if ($d_sum['display'])
                {
                    $sLabel = $d_sum['label'];
                    $sId    = '';
                    $bFound = false;
                    $iKey   = $key_total;
                    if(isset($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['summarizing_fields_control'][$nome_quebra]))
                    {
                        foreach ($_SESSION['sc_session'][$sc_init]['resume_realisasi_project_inwitel']['summarizing_fields_control'][$nome_quebra] as $_key_total => $d_field)
                        {
                            if(is_array($d_field))
                            {
                                    $l_field = $d_field['cmp_res'];
