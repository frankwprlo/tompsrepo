...
class resume_realisasi_project_inwitel_resumo
{
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_order']['gbmitra']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_order']['gbmitra'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_order']['gbmitra'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_display']['gbmitra'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_display']['gbmitra'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_display']['gbmitra'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_display']['gbmitra'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_display']['gbmitra'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_display']['gbmitra'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_display']['gbmitra'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_tm_namamitra as $i_tm_namamitra => $d_tm_namamitra) {
           if (!in_array($i_tm_namamitra, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_tm_namamitra[9] ] = $d_tm_namamitra[8];
               $this->comp_label[0][ $d_tm_namamitra[9] ] = $d_tm_namamitra[8];
           }
       }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_gbmitra("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_tp_rab, $sum_tp_nilai, $sum_tp_odp, $avg_realisasi, $max_realisasi, $min_realisasi, $quebra_tm_namamitra, $quebra_tm_namamitra_orig)
   {
      //----- Mitra
      if (!isset($this->array_total_tm_namamitra[$quebra_tm_namamitra_orig]))
      {
         ...
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][4] = $avg_realisasi;
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][5] = $max_realisasi;
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][6] = $min_realisasi;
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][7] = 1;
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][8] = $quebra_tm_namamitra;
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][9] = $quebra_tm_namamitra_orig;
      }
      else
      {
         ...
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][3] += $sum_tp_odp;
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][4] += $avg_realisasi;
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][5] = max($this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][5], $max_realisasi);
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][6] = min($this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][6], $min_realisasi);
         $this->array_total_tm_namamitra[$quebra_tm_namamitra_orig][7]++;
      }
   }
...
$_SESSION['scriptcase']['resume_realisasi_project_inwitel']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->tp_rab, $this->tp_nilai, $this->tp_odp, $this->realisasi, $this->realisasi, $this->realisasi, $this->tm_namamitra, $this->tm_namamitra_orig);
            }
   }
//
