...
class resume_realisasi_project_inwitel_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_tj_namajenis = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['arr_total']['tj_namajenis'];
      }
      else
      {
          $this->array_total_tj_namajenis = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['arr_total']['tj_namajenis'] = $this->array_total_tj_namajenis;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_order']['gbmitraonly']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_order']['gbmitraonly'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_order']['gbmitraonly'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_display']['gbmitraonly'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_display']['gbmitraonly'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_display']['gbmitraonly'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_display']['gbmitraonly'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_display']['gbmitraonly'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_display']['gbmitraonly'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['summarizing_fields_display']['gbmitraonly'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_tj_namajenis as $i_tj_namajenis => $d_tj_namajenis) {
           if (!in_array($i_tj_namajenis, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_tj_namajenis[9] ] = $d_tj_namajenis[8];
               $this->comp_label[0][ $d_tj_namajenis[9] ] = $d_tj_namajenis[8];
           }
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_tj_namajenis => $l_tj_namajenis) {
           if (isset($this->array_total_tj_namajenis[$i_tj_namajenis])) {
               $this->comp_group[$i_tj_namajenis] = array();
           }
       }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_gbmitraonly("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_tp_rab, $sum_tp_nilai, $sum_tp_odp, $avg_realisasi, $max_realisasi, $min_realisasi, $quebra_tj_namajenis, $quebra_tj_namajenis_orig)
   {
      //----- Jenis Project
      if (!isset($this->array_total_tj_namajenis[$quebra_tj_namajenis_orig]))
      {
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][0] = 1;
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][1] = $sum_tp_rab;
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][2] = $sum_tp_nilai;
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][3] = $sum_tp_odp;
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][4] = $avg_realisasi;
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][5] = $max_realisasi;
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][6] = $min_realisasi;
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][7] = 1;
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][8] = $quebra_tj_namajenis;
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][9] = $quebra_tj_namajenis_orig;
      }
      else
      {
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][0]++;
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][1] += $sum_tp_rab;
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][2] += $sum_tp_nilai;
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][3] += $sum_tp_odp;
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][4] += $avg_realisasi;
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][5] = max($this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][5], $max_realisasi);
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][6] = min($this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][6], $min_realisasi);
         $this->array_total_tj_namajenis[$quebra_tj_namajenis_orig][7]++;
      }
   }
...
$_SESSION['scriptcase']['resume_realisasi_project_inwitel']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->tp_rab, $this->tp_nilai, $this->tp_odp, $this->realisasi, $this->realisasi, $this->realisasi, $this->tj_namajenis, $this->tj_namajenis_orig);
            }
   }
//
