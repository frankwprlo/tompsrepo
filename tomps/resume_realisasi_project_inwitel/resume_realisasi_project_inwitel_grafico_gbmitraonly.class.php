...
<?php
   ...
   function inicializa_vars()
   {
      ...
      //---- Label
      $this->label    = array();
      $this->label[0] = "Jenis Project";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['contr_label_graf']['tj_namajenis']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['contr_label_graf']['tj_namajenis']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inwitel']['contr_label_graf']['tj_namajenis'];
      }
   }
