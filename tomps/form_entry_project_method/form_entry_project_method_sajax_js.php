  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_entry_project_method" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate tp_id
  function do_ajax_form_entry_project_method_validate_tp_id()
  {
    var nomeCampo_tp_id = "tp_id";
    var var_tp_id = scAjaxGetFieldHidden(nomeCampo_tp_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_id(var_tp_id, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_id_cb);
  } // do_ajax_form_entry_project_method_validate_tp_id

  function do_ajax_form_entry_project_method_validate_tp_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_id_cb

  // ---------- Validate tp_thn_release
  function do_ajax_form_entry_project_method_validate_tp_thn_release()
  {
    var nomeCampo_tp_thn_release = "tp_thn_release";
    var var_tp_thn_release = scAjaxGetFieldSelect(nomeCampo_tp_thn_release);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_thn_release(var_tp_thn_release, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_thn_release_cb);
  } // do_ajax_form_entry_project_method_validate_tp_thn_release

  function do_ajax_form_entry_project_method_validate_tp_thn_release_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_thn_release_cb

  // ---------- Validate tp_prjtrelease
  function do_ajax_form_entry_project_method_validate_tp_prjtrelease()
  {
    var nomeCampo_tp_prjtrelease = "tp_prjtrelease";
    var var_tp_prjtrelease = scAjaxGetFieldSelect(nomeCampo_tp_prjtrelease);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_prjtrelease(var_tp_prjtrelease, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_prjtrelease_cb);
  } // do_ajax_form_entry_project_method_validate_tp_prjtrelease

  function do_ajax_form_entry_project_method_validate_tp_prjtrelease_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_prjtrelease_cb

  // ---------- Validate tp_batch
  function do_ajax_form_entry_project_method_validate_tp_batch()
  {
    var nomeCampo_tp_batch = "tp_batch";
    var var_tp_batch = scAjaxGetFieldSelect(nomeCampo_tp_batch);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_batch(var_tp_batch, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_batch_cb);
  } // do_ajax_form_entry_project_method_validate_tp_batch

  function do_ajax_form_entry_project_method_validate_tp_batch_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_batch_cb

  // ---------- Validate tp_namalop
  function do_ajax_form_entry_project_method_validate_tp_namalop()
  {
    var nomeCampo_tp_namalop = "tp_namalop";
    var var_tp_namalop = scAjaxGetFieldText(nomeCampo_tp_namalop);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_namalop(var_tp_namalop, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_namalop_cb);
  } // do_ajax_form_entry_project_method_validate_tp_namalop

  function do_ajax_form_entry_project_method_validate_tp_namalop_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_namalop_cb

  // ---------- Validate tp_templateproject
  function do_ajax_form_entry_project_method_validate_tp_templateproject()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_templateproject(var_tp_templateproject, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_templateproject_cb);
  } // do_ajax_form_entry_project_method_validate_tp_templateproject

  function do_ajax_form_entry_project_method_validate_tp_templateproject_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_templateproject_cb

  // ---------- Validate tp_targetwaktu
  function do_ajax_form_entry_project_method_validate_tp_targetwaktu()
  {
    var nomeCampo_tp_targetwaktu = "tp_targetwaktu";
    var var_tp_targetwaktu = scAjaxGetFieldText(nomeCampo_tp_targetwaktu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_targetwaktu(var_tp_targetwaktu, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_targetwaktu_cb);
  } // do_ajax_form_entry_project_method_validate_tp_targetwaktu

  function do_ajax_form_entry_project_method_validate_tp_targetwaktu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_targetwaktu_cb

  // ---------- Validate tp_jenisproject
  function do_ajax_form_entry_project_method_validate_tp_jenisproject()
  {
    var nomeCampo_tp_jenisproject = "tp_jenisproject";
    var var_tp_jenisproject = scAjaxGetFieldSelect(nomeCampo_tp_jenisproject);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_jenisproject(var_tp_jenisproject, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_jenisproject_cb);
  } // do_ajax_form_entry_project_method_validate_tp_jenisproject

  function do_ajax_form_entry_project_method_validate_tp_jenisproject_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_jenisproject_cb

  // ---------- Validate tp_projectname
  function do_ajax_form_entry_project_method_validate_tp_projectname()
  {
    var nomeCampo_tp_projectname = "tp_projectname";
    var var_tp_projectname = scAjaxGetFieldText(nomeCampo_tp_projectname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_projectname(var_tp_projectname, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_projectname_cb);
  } // do_ajax_form_entry_project_method_validate_tp_projectname

  function do_ajax_form_entry_project_method_validate_tp_projectname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_projectname_cb

  // ---------- Validate tp_planstart
  function do_ajax_form_entry_project_method_validate_tp_planstart()
  {
    var nomeCampo_tp_planstart = "tp_planstart";
    var var_tp_planstart = scAjaxGetFieldText(nomeCampo_tp_planstart);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_planstart(var_tp_planstart, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_planstart_cb);
  } // do_ajax_form_entry_project_method_validate_tp_planstart

  function do_ajax_form_entry_project_method_validate_tp_planstart_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_planstart_cb

  // ---------- Validate tp_planfinish
  function do_ajax_form_entry_project_method_validate_tp_planfinish()
  {
    var nomeCampo_tp_planfinish = "tp_planfinish";
    var var_tp_planfinish = scAjaxGetFieldText(nomeCampo_tp_planfinish);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_planfinish(var_tp_planfinish, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_planfinish_cb);
  } // do_ajax_form_entry_project_method_validate_tp_planfinish

  function do_ajax_form_entry_project_method_validate_tp_planfinish_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_planfinish_cb

  // ---------- Validate tp_status
  function do_ajax_form_entry_project_method_validate_tp_status()
  {
    var nomeCampo_tp_status = "tp_status";
    var var_tp_status = scAjaxGetFieldText(nomeCampo_tp_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_status(var_tp_status, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_status_cb);
  } // do_ajax_form_entry_project_method_validate_tp_status

  function do_ajax_form_entry_project_method_validate_tp_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_status_cb

  // ---------- Validate tp_divre
  function do_ajax_form_entry_project_method_validate_tp_divre()
  {
    var nomeCampo_tp_divre = "tp_divre";
    var var_tp_divre = scAjaxGetFieldSelect(nomeCampo_tp_divre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_divre(var_tp_divre, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_divre_cb);
  } // do_ajax_form_entry_project_method_validate_tp_divre

  function do_ajax_form_entry_project_method_validate_tp_divre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_divre_cb

  // ---------- Validate tp_witel
  function do_ajax_form_entry_project_method_validate_tp_witel()
  {
    var nomeCampo_tp_witel = "tp_witel";
    var var_tp_witel = scAjaxGetFieldSelect(nomeCampo_tp_witel);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_witel(var_tp_witel, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_witel_cb);
  } // do_ajax_form_entry_project_method_validate_tp_witel

  function do_ajax_form_entry_project_method_validate_tp_witel_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_witel_cb

  // ---------- Validate tp_datel
  function do_ajax_form_entry_project_method_validate_tp_datel()
  {
    var nomeCampo_tp_datel = "tp_datel";
    var var_tp_datel = scAjaxGetFieldSelect(nomeCampo_tp_datel);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_datel(var_tp_datel, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_datel_cb);
  } // do_ajax_form_entry_project_method_validate_tp_datel

  function do_ajax_form_entry_project_method_validate_tp_datel_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_datel_cb

  // ---------- Validate tp_sto
  function do_ajax_form_entry_project_method_validate_tp_sto()
  {
    var nomeCampo_tp_sto = "tp_sto";
    var var_tp_sto = scAjaxGetFieldSelect(nomeCampo_tp_sto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_sto(var_tp_sto, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_sto_cb);
  } // do_ajax_form_entry_project_method_validate_tp_sto

  function do_ajax_form_entry_project_method_validate_tp_sto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tp_sto";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_sto_cb

  // ---------- Validate tp_idlop
  function do_ajax_form_entry_project_method_validate_tp_idlop()
  {
    var nomeCampo_tp_idlop = "tp_idlop";
    var var_tp_idlop = scAjaxGetFieldText(nomeCampo_tp_idlop);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_idlop(var_tp_idlop, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_idlop_cb);
  } // do_ajax_form_entry_project_method_validate_tp_idlop

  function do_ajax_form_entry_project_method_validate_tp_idlop_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_idlop_cb

  // ---------- Validate tp_lokasi
  function do_ajax_form_entry_project_method_validate_tp_lokasi()
  {
    var nomeCampo_tp_lokasi = "tp_lokasi";
    var var_tp_lokasi = scAjaxGetFieldText(nomeCampo_tp_lokasi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_lokasi(var_tp_lokasi, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_lokasi_cb);
  } // do_ajax_form_entry_project_method_validate_tp_lokasi

  function do_ajax_form_entry_project_method_validate_tp_lokasi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_lokasi_cb

  // ---------- Validate tp_mitra
  function do_ajax_form_entry_project_method_validate_tp_mitra()
  {
    var nomeCampo_tp_mitra = "tp_mitra";
    var var_tp_mitra = scAjaxGetFieldSelect(nomeCampo_tp_mitra);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_mitra(var_tp_mitra, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_mitra_cb);
  } // do_ajax_form_entry_project_method_validate_tp_mitra

  function do_ajax_form_entry_project_method_validate_tp_mitra_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_mitra_cb

  // ---------- Validate tp_nokontrak
  function do_ajax_form_entry_project_method_validate_tp_nokontrak()
  {
    var nomeCampo_tp_nokontrak = "tp_nokontrak";
    var var_tp_nokontrak = scAjaxGetFieldText(nomeCampo_tp_nokontrak);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_nokontrak(var_tp_nokontrak, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_nokontrak_cb);
  } // do_ajax_form_entry_project_method_validate_tp_nokontrak

  function do_ajax_form_entry_project_method_validate_tp_nokontrak_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_nokontrak_cb

  // ---------- Validate tp_ponumber
  function do_ajax_form_entry_project_method_validate_tp_ponumber()
  {
    var nomeCampo_tp_ponumber = "tp_ponumber";
    var var_tp_ponumber = scAjaxGetFieldText(nomeCampo_tp_ponumber);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_ponumber(var_tp_ponumber, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_ponumber_cb);
  } // do_ajax_form_entry_project_method_validate_tp_ponumber

  function do_ajax_form_entry_project_method_validate_tp_ponumber_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_ponumber_cb

  // ---------- Validate tp_nilai
  function do_ajax_form_entry_project_method_validate_tp_nilai()
  {
    var nomeCampo_tp_nilai = "tp_nilai";
    var var_tp_nilai = scAjaxGetFieldText(nomeCampo_tp_nilai);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_nilai(var_tp_nilai, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_nilai_cb);
  } // do_ajax_form_entry_project_method_validate_tp_nilai

  function do_ajax_form_entry_project_method_validate_tp_nilai_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_nilai_cb

  // ---------- Validate tp_summary
  function do_ajax_form_entry_project_method_validate_tp_summary()
  {
    var nomeCampo_tp_summary = "tp_summary";
    var var_tp_summary = scAjaxGetFieldText(nomeCampo_tp_summary);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_summary(var_tp_summary, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_summary_cb);
  } // do_ajax_form_entry_project_method_validate_tp_summary

  function do_ajax_form_entry_project_method_validate_tp_summary_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_summary_cb

  // ---------- Validate tp_rab
  function do_ajax_form_entry_project_method_validate_tp_rab()
  {
    var nomeCampo_tp_rab = "tp_rab";
    var var_tp_rab = scAjaxGetFieldText(nomeCampo_tp_rab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_rab(var_tp_rab, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_rab_cb);
  } // do_ajax_form_entry_project_method_validate_tp_rab

  function do_ajax_form_entry_project_method_validate_tp_rab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tp_rab";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_rab_cb

  // ---------- Validate tp_jmldistribusi
  function do_ajax_form_entry_project_method_validate_tp_jmldistribusi()
  {
    var nomeCampo_tp_jmldistribusi = "tp_jmldistribusi";
    var var_tp_jmldistribusi = scAjaxGetFieldText(nomeCampo_tp_jmldistribusi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_entry_project_method_validate_tp_jmldistribusi(var_tp_jmldistribusi, var_script_case_init, do_ajax_form_entry_project_method_validate_tp_jmldistribusi_cb);
  } // do_ajax_form_entry_project_method_validate_tp_jmldistribusi

  function do_ajax_form_entry_project_method_validate_tp_jmldistribusi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_validate_tp_jmldistribusi_cb

  // ---------- Refresh tp_divre
  function do_ajax_form_entry_project_method_refresh_tp_divre()
  {
    var var_tp_divre = scAjaxGetFieldSelect("tp_divre");
    var var_nmgp_refresh_fields = "tp_witel";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_entry_project_method_refresh_tp_divre(var_tp_divre, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_entry_project_method_refresh_tp_divre_cb);
  } // do_ajax_form_entry_project_method_refresh_tp_divre

  function do_ajax_form_entry_project_method_refresh_tp_divre_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    do_ajax_form_entry_project_method_refresh_tp_witel();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_refresh_tp_divre_cb

  // ---------- Refresh tp_witel
  function do_ajax_form_entry_project_method_refresh_tp_witel()
  {
    var var_tp_witel = scAjaxGetFieldSelect("tp_witel");
    var var_nmgp_refresh_fields = "tp_datel";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_entry_project_method_refresh_tp_witel(var_tp_witel, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_entry_project_method_refresh_tp_witel_cb);
  } // do_ajax_form_entry_project_method_refresh_tp_witel

  function do_ajax_form_entry_project_method_refresh_tp_witel_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    do_ajax_form_entry_project_method_refresh_tp_datel();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_refresh_tp_witel_cb

  // ---------- Refresh tp_datel
  function do_ajax_form_entry_project_method_refresh_tp_datel()
  {
    var var_tp_datel = scAjaxGetFieldSelect("tp_datel");
    var var_nmgp_refresh_fields = "tp_sto";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_entry_project_method_refresh_tp_datel(var_tp_datel, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_entry_project_method_refresh_tp_datel_cb);
  } // do_ajax_form_entry_project_method_refresh_tp_datel

  function do_ajax_form_entry_project_method_refresh_tp_datel_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    do_ajax_form_entry_project_method_refresh_tp_sto();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_refresh_tp_datel_cb

  // ---------- Refresh tp_sto
  function do_ajax_form_entry_project_method_refresh_tp_sto()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_entry_project_method_refresh_tp_sto(var_tp_sto, var_tp_divre, var_tp_witel, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_entry_project_method_refresh_tp_sto_cb);
  } // do_ajax_form_entry_project_method_refresh_tp_sto

  function do_ajax_form_entry_project_method_refresh_tp_sto_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_entry_project_method_refresh_tp_sto_cb

  // ---------- Event onchange tp_planstart
  function do_ajax_form_entry_project_method_event_tp_planstart_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_entry_project_method_event_tp_planstart_onchange(var_tp_targetwaktu, var_tp_planfinish, var_tp_planstart, var_script_case_init, do_ajax_form_entry_project_method_event_tp_planstart_onchange_cb);
  } // do_ajax_form_entry_project_method_event_tp_planstart_onchange

  function do_ajax_form_entry_project_method_event_tp_planstart_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tp_planstart";
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_entry_project_method_event_tp_planstart_onchange_cb

  // ---------- Event onchange tp_sto
  function do_ajax_form_entry_project_method_event_tp_sto_onchange()
  {
    var var_tp_sto = scAjaxGetFieldSelect("tp_sto");
    var var_tp_witel = scAjaxGetFieldSelect("tp_witel");
    var var_tp_divre = scAjaxGetFieldSelect("tp_divre");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_entry_project_method_event_tp_sto_onchange(var_tp_sto, var_tp_witel, var_tp_divre, var_tp_idlop, var_script_case_init, do_ajax_form_entry_project_method_event_tp_sto_onchange_cb);
  } // do_ajax_form_entry_project_method_event_tp_sto_onchange

  function do_ajax_form_entry_project_method_event_tp_sto_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tp_sto";
    ...
    do_ajax_form_entry_project_method_refresh_tp_sto();
    scAjaxRedir();
  } // do_ajax_form_entry_project_method_event_tp_sto_onchange_cb

  // ---------- Event onchange tp_templateproject
  function do_ajax_form_entry_project_method_event_tp_templateproject_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_entry_project_method_event_tp_templateproject_onchange(var_tp_templateproject, var_tp_targetwaktu, var_tp_planfinish, var_script_case_init, do_ajax_form_entry_project_method_event_tp_templateproject_onchange_cb);
  } // do_ajax_form_entry_project_method_event_tp_templateproject_onchange

  function do_ajax_form_entry_project_method_event_tp_templateproject_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tp_templateproject";
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_entry_project_method_event_tp_templateproject_onchange_cb
  // ---------- Form
  function do_ajax_form_entry_project_method_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_entry_project_method_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_entry_project_method_submit_form(var_tp_id, var_tp_thn_release, var_tp_prjtrelease, var_tp_batch, var_tp_namalop, var_tp_templateproject, var_tp_targetwaktu, var_tp_jenisproject, var_tp_projectname, var_tp_planstart, var_tp_planfinish, var_tp_status, var_tp_divre, var_tp_witel, var_tp_datel, var_tp_sto, var_tp_idlop, var_tp_lokasi, var_tp_mitra, var_tp_nokontrak, var_tp_ponumber, var_tp_nilai, var_tp_summary, var_tp_rab, var_tp_jmldistribusi, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_entry_project_method_submit_form_cb);
  } // do_ajax_form_entry_project_method_submit_form

  function do_ajax_form_entry_project_method_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_entry_project_method_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_entry_project_method_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_entry_project_method_navigate_form(var_tp_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_entry_project_method_navigate_form_cb);
  } // do_ajax_form_entry_project_method_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_entry_project_method_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_entry_project_method_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
...
{
?>
    do_ajax_form_entry_project_method_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_entry_project_method_navigate_form_cb
  function sc_hide_form_entry_project_method_form()
  {
