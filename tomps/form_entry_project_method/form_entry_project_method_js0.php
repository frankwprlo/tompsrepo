...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_entry_project_method"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_generate_odp_new()
{
  ...
  nm_gp_submit('<?php echo $this->Ini->link_form_master_odp_edit; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "var_projectid*scin' + var_btn_generate_odp_new_var_projectid + '*scout"; ?>', '', '_self', '0', '0', 'form_master_odp');
}
...
function sc_btn_generatejadwal()
{
  ...
  nm_gp_submit('<?php echo $this->Ini->link_timeplan_tahapan_new_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "var_idproject*scin' + var_btn_generatejadwal_var_idproject + '*scoutvar_var_tglmulaiproject*scin' + var_btn_generatejadwal_var_var_tglmulaiproject + '*scoutglob_mileage*scin' + var_btn_generatejadwal_glob_mileage + '*scout"; ?>', 'inicio', '_self', '0', '0', 'timeplan_tahapan_new');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['where_detal']))
  {
?>  
