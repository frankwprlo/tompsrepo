...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_entry_project_method/form_entry_project_method_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_entry_project_method_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_entry_project_method_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['recarga'];
}
?>
...
<?php
 include_once("form_entry_project_method_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_entry_project_method'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_entry_project_method'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['dashboard_info']['maximized']))
  {
?>
<tr><td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes != "novo") && ($opcao_botoes != "novo")) {
        $sCondStyle = ($this->nmgp_botoes['generatejadwal'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "generatejadwal", "sc_btn_generatejadwal()", "sc_btn_generatejadwal()", "sc_generatejadwal_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_thn_release_label" id="hidden_field_label_tp_thn_release" style="<?php echo $sStyleHidden_tp_thn_release; ?>"><span id="id_label_tp_thn_release"><?php echo $this->nm_new_label['tp_thn_release']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['php_cmp_required']['tp_thn_release']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['php_cmp_required']['tp_thn_release'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_batch_label" id="hidden_field_label_tp_batch" style="<?php echo $sStyleHidden_tp_batch; ?>"><span id="id_label_tp_batch"><?php echo $this->nm_new_label['tp_batch']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['php_cmp_required']['tp_batch']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['php_cmp_required']['tp_batch'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<span id="id_read_on_tp_namalop" class="sc-ui-readonly-tp_namalop css_tp_namalop_line" style="<?php echo $sStyleReadLab_tp_namalop; ?>"><?php echo $this->form_encode_input($this->tp_namalop); ?></span><span id="id_read_off_tp_namalop" style="white-space: nowrap;<?php echo $sStyleReadInp_tp_namalop; ?>">
 ...
 size=40 maxlength=40 alt="{datatype: 'text', maxLength: 40, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: 'upper', enterTab: true, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_templateproject_label" id="hidden_field_label_tp_templateproject" style="<?php echo $sStyleHidden_tp_templateproject; ?>"><span id="id_label_tp_templateproject"><?php echo $this->nm_new_label['tp_templateproject']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['php_cmp_required']['tp_templateproject']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['php_cmp_required']['tp_templateproject'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_targetwaktu_label" id="hidden_field_label_tp_targetwaktu" style="<?php echo $sStyleHidden_tp_targetwaktu; ?>"><span id="id_label_tp_targetwaktu"><?php echo $this->nm_new_label['tp_targetwaktu']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['php_cmp_required']['tp_targetwaktu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['php_cmp_required']['tp_targetwaktu'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_jenisproject_label" id="hidden_field_label_tp_jenisproject" style="<?php echo $sStyleHidden_tp_jenisproject; ?>"><span id="id_label_tp_jenisproject"><?php echo $this->nm_new_label['tp_jenisproject']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['php_cmp_required']['tp_jenisproject']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['php_cmp_required']['tp_jenisproject'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_planfinish_label" id="hidden_field_label_tp_planfinish" style="<?php echo $sStyleHidden_tp_planfinish; ?>"><span id="id_label_tp_planfinish"><?php echo $this->nm_new_label['tp_planfinish']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['php_cmp_required']['tp_planfinish']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['php_cmp_required']['tp_planfinish'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_divre_label" id="hidden_field_label_tp_divre" style="<?php echo $sStyleHidden_tp_divre; ?>"><span id="id_label_tp_divre"><?php echo $this->nm_new_label['tp_divre']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['php_cmp_required']['tp_divre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['php_cmp_required']['tp_divre'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_witel_label" id="hidden_field_label_tp_witel" style="<?php echo $sStyleHidden_tp_witel; ?>"><span id="id_label_tp_witel"><?php echo $this->nm_new_label['tp_witel']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['php_cmp_required']['tp_witel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['php_cmp_required']['tp_witel'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_sto_label" id="hidden_field_label_tp_sto" style="<?php echo $sStyleHidden_tp_sto; ?>"><span id="id_label_tp_sto"><?php echo $this->nm_new_label['tp_sto']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['php_cmp_required']['tp_sto']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['php_cmp_required']['tp_sto'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_idlop_label" id="hidden_field_label_tp_idlop" style="<?php echo $sStyleHidden_tp_idlop; ?>"><span id="id_label_tp_idlop"><?php echo $this->nm_new_label['tp_idlop']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['php_cmp_required']['tp_idlop']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['php_cmp_required']['tp_idlop'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_mitra_label" id="hidden_field_label_tp_mitra" style="<?php echo $sStyleHidden_tp_mitra; ?>"><span id="id_label_tp_mitra"><?php echo $this->nm_new_label['tp_mitra']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['php_cmp_required']['tp_mitra']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['php_cmp_required']['tp_mitra'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<span id="id_read_on_tp_nokontrak" class="sc-ui-readonly-tp_nokontrak css_tp_nokontrak_line" style="<?php echo $sStyleReadLab_tp_nokontrak; ?>"><?php echo $this->form_encode_input($this->tp_nokontrak); ?></span><span id="id_read_off_tp_nokontrak" style="white-space: nowrap;<?php echo $sStyleReadInp_tp_nokontrak; ?>">
 ...
 size=30 maxlength=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: 'upper', enterTab: true, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['dashboard_info']['maximized']))
  {
...
echo $this->nm_data->FormataSaida("j/n/Y @?#?@a@?#?@t g:i:s A");
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_method']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_entry_project_method");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_entry_project_method");
 parent.scAjaxDetailHeight("form_entry_project_method", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
