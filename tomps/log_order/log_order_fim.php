...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["projectamo_____log_order"]))
   {
      unset($_SESSION['session_sec_aplicacao']["projectamo_____log_order"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['log_order']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['log_order']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['log_order']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['log_order']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['log_order']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['log_order']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['log_order']['embutida_filho'] as $ind => $sc_init)
          {
