...
function ajax_navigate(opc, parm)
{
    ...
    $.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_project_edit_update_main_updatetask').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_project_edit_update_main_updatetask').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_project_edit_update_main_updatetask').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_project_edit_update_main_updatetask').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_project_edit_update_main_updatetask').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_project_edit_update_main_updatetask').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_project_edit_update_main_updatetask').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_project_edit_update_main_updatetask').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_project_edit_update_main_updatetask').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_project_edit_update_main_updatetask').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_project_edit_update_main_updatetask').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_project_edit_update_main_updatetask').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
