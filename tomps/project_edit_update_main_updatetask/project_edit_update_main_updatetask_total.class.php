...
class project_edit_update_main_updatetask_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['project_edit_update_main_updatetask']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['project_edit_update_main_updatetask']['campos_busca']))
      { 
