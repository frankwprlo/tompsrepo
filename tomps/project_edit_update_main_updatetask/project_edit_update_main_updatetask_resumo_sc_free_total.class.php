...
class project_edit_update_main_updatetask_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['pdf'] = "on";
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['dashboard_info']['under_dashboard'] ? "off" : "on";
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['dashboard_info']['under_dashboard'] ? "off" : "on";
      $this->nmgp_botoes['word'] = "on";
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['dashboard_info']['under_dashboard'] ? "off" : "on";
      $this->nmgp_botoes['xls'] = "on";
...
$_SESSION['scriptcase']['project_edit_update_main_updatetask']['contr_erro'] = 'off'; 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['array_graf_pdf'] = array();
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['contr_total_geral'] == "OK")
      {
      }
      else
      {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@project_edit_update_main_updatetask@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['pivot_order_start'][$iYAxysIndex])
                       {
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['opcao'] = "print";
      ...
      $this->Total   = new project_edit_update_main_updatetask_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['responsive_chart']['active']) {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_project_edit_update_main_updatetask_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_project_edit_update_main_updatetask_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_project_edit_update_main_updatetask_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "project_edit_update_main_updatetask/project_edit_update_main_updatetask_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rrtf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "project_edit_update_main_updatetask/project_edit_update_main_updatetask_config_word.php?nm_cor=AM&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "project_edit_update_main_updatetask/project_edit_update_main_updatetask_config_print.php?nm_opc=resumo&nm_cor=AM&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("project_edit_update_main_updatetask_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'project_edit_update_main_updatetask_config_pivot.php?nome_apl=project_edit_update_main_updatetask&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"project_edit_update_main_updatetask_iframe_prt.php\" \r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_project_edit_update_main_updatetask_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "project_edit_update_main_updatetask/project_edit_update_main_updatetask_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $ppo_id = $Busca_temp['ppo_id']; 
          $tmp_pos = strpos($ppo_id, "##@@");
          if ($tmp_pos !== false && !is_array($ppo_id))
          {
              $ppo_id = substr($ppo_id, 0, $tmp_pos);
          }
          $ppo_id_2 = $Busca_temp['ppo_id_input_2']; 
          $ppo_projectid = $Busca_temp['ppo_projectid']; 
          $tmp_pos = strpos($ppo_projectid, "##@@");
          if ($tmp_pos !== false && !is_array($ppo_projectid))
          {
              $ppo_projectid = substr($ppo_projectid, 0, $tmp_pos);
          }
          $ppo_projectid_2 = $Busca_temp['ppo_projectid_input_2']; 
          $ppo_tahapanproject = $Busca_temp['ppo_tahapanproject']; 
          $tmp_pos = strpos($ppo_tahapanproject, "##@@");
          if ($tmp_pos !== false && !is_array($ppo_tahapanproject))
          {
              $ppo_tahapanproject = substr($ppo_tahapanproject, 0, $tmp_pos);
          }
          $ppo_tahapanproject_2 = $Busca_temp['ppo_tahapanproject_input_2']; 
          $ppo_tasktahapan = $Busca_temp['ppo_tasktahapan']; 
          $tmp_pos = strpos($ppo_tasktahapan, "##@@");
          if ($tmp_pos !== false && !is_array($ppo_tasktahapan))
          {
   ...
   //---- 
   function adiciona_registro($sum_ppo_targethari, $sum_realisasi)
   {
      //----- Total
      if (empty($this->array_total_geral))
      {
         $this->array_total_geral[0] = 1;
         $this->array_total_geral[1] = $sum_ppo_targethari;
         $this->array_total_geral[2] = $sum_realisasi;
      }
      else
      {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->ppo_id = $rs_res->fields[0] ;  
            $this->ppo_projectid = $rs_res->fields[1] ;  
            $this->ppo_tahapanproject = $rs_res->fields[2] ;  
            $this->tmt_namatahapan = $rs_res->fields[3] ;  
            $this->statusname = $rs_res->fields[4] ;  
            $this->ppo_note = $rs_res->fields[5] ;  
            $this->ppo_tasktahapan = $rs_res->fields[6] ;  
            $this->tmt_target62 = $rs_res->fields[7] ;  
            $this->ppo_tglmulaiplan = $rs_res->fields[8] ;  
            $this->ppo_targethari = $rs_res->fields[9] ;  
            $this->ppo_targetselesai = $rs_res->fields[10] ;  
            $this->ppo_tglmulaiactual = $rs_res->fields[11] ;  
            $this->ppo_tglselesaiactual = $rs_res->fields[12] ;  
            $this->ppo_tasknumber = $rs_res->fields[13] ;  
            $this->ppo_entrydate = $rs_res->fields[14] ;  
            $this->ppo_entryby = $rs_res->fields[15] ;  
            $_SESSION['scriptcase']['project_edit_update_main_updatetask']['contr_erro'] = 'on';
if (!isset($_SESSION['glo_aktualsebelumnya'])) {$_SESSION['glo_aktualsebelumnya'] = "";}
if (!isset($this->sc_temp_glo_aktualsebelumnya)) {$this->sc_temp_glo_aktualsebelumnya = (isset($_SESSION['glo_aktualsebelumnya'])) ? $_SESSION['glo_aktualsebelumnya'] : "";}
if (!isset($_SESSION['glo_aktualbenarselesai'])) {$_SESSION['glo_aktualbenarselesai'] = "";}
