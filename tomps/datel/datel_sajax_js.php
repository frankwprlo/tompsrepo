...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate md_iddatel_
  function do_ajax_datel_validate_md_iddatel_(iNumLinha)
  {
    var nomeCampo_md_iddatel_ = "md_iddatel_" + iNumLinha;
    var var_md_iddatel_ = scAjaxGetFieldHidden(nomeCampo_md_iddatel_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_datel_validate_md_iddatel_(var_md_iddatel_, iNumLinha, var_script_case_init, do_ajax_datel_validate_md_iddatel__cb);
  } // do_ajax_datel_validate_md_iddatel_

  function do_ajax_datel_validate_md_iddatel__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "md_iddatel_" + iLineNumber;
    }
    else
    {
      sFieldValid = "md_iddatel_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "md_iddatel_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "md_iddatel_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_datel_validate_md_iddatel__cb

  // ---------- Validate md_idwitel_
  function do_ajax_datel_validate_md_idwitel_(iNumLinha)
  {
    var nomeCampo_md_idwitel_ = "md_idwitel_" + iNumLinha;
    var var_md_idwitel_ = scAjaxGetFieldSelect(nomeCampo_md_idwitel_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_datel_validate_md_idwitel_(var_md_idwitel_, iNumLinha, var_script_case_init, do_ajax_datel_validate_md_idwitel__cb);
  } // do_ajax_datel_validate_md_idwitel_

  function do_ajax_datel_validate_md_idwitel__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "md_idwitel_" + iLineNumber;
    }
    else
    {
      sFieldValid = "md_idwitel_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "md_idwitel_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "md_idwitel_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_datel_validate_md_idwitel__cb

  // ---------- Validate md_kodedatel_
  function do_ajax_datel_validate_md_kodedatel_(iNumLinha)
  {
    var nomeCampo_md_kodedatel_ = "md_kodedatel_" + iNumLinha;
    var var_md_kodedatel_ = scAjaxGetFieldText(nomeCampo_md_kodedatel_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_datel_validate_md_kodedatel_(var_md_kodedatel_, iNumLinha, var_script_case_init, do_ajax_datel_validate_md_kodedatel__cb);
  } // do_ajax_datel_validate_md_kodedatel_

  function do_ajax_datel_validate_md_kodedatel__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "md_kodedatel_" + iLineNumber;
    }
    else
    {
      sFieldValid = "md_kodedatel_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "md_kodedatel_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "md_kodedatel_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_datel_validate_md_kodedatel__cb

  // ---------- Validate md_namadatel_
  function do_ajax_datel_validate_md_namadatel_(iNumLinha)
  {
    var nomeCampo_md_namadatel_ = "md_namadatel_" + iNumLinha;
    var var_md_namadatel_ = scAjaxGetFieldText(nomeCampo_md_namadatel_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_datel_validate_md_namadatel_(var_md_namadatel_, iNumLinha, var_script_case_init, do_ajax_datel_validate_md_namadatel__cb);
  } // do_ajax_datel_validate_md_namadatel_

  function do_ajax_datel_validate_md_namadatel__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "md_namadatel_" + iLineNumber;
    }
    else
    {
      sFieldValid = "md_namadatel_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "md_namadatel_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "md_namadatel_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_datel_validate_md_namadatel__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_datel_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_datel_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_datel_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_datel_add_new_line_cb);
  } // do_ajax_datel_add_new_line

  function do_ajax_datel_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_datel_add_new_line_cb

  // ---------- backup_line
  function do_ajax_datel_backup_line(iNumLinha)
  {
    var var_md_iddatel_ = scAjaxGetFieldHidden("md_iddatel_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_datel_backup_line(var_md_iddatel_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_datel_backup_line_cb);
  } // do_ajax_datel_backup_line

  function do_ajax_datel_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_datel_backup_line_cb

  function do_ajax_datel_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_datel_cancel_insert

  function do_ajax_datel_cancel_update(iSeqVert)
  {
    do_ajax_datel_backup_line(iSeqVert);
...
?>
  } // do_ajax_datel_cancel_update

  function do_ajax_datel_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_datel_restore_buttons

  // ---------- table_refresh
  function do_ajax_datel_table_refresh()
  {
    var var_md_iddatel_ = document.F2.md_iddatel_.value;
    ...
    scAjaxProcOn();
    x_ajax_datel_table_refresh(var_md_iddatel_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_datel_table_refresh_cb);
  } //  do_ajax_datel_table_refresh

  function do_ajax_datel_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.md_iddatel_.value = scAjaxGetKeyValue("md_iddatel_");
    ...
    sc_insert_open = false;
  } // do_ajax_datel_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_datel_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_datel_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_md_iddatel_ = scAjaxGetFieldHidden("md_iddatel_" + iNumLinha);
    var var_md_idwitel_ = scAjaxGetFieldSelect("md_idwitel_" + iNumLinha);
    var var_md_kodedatel_ = scAjaxGetFieldText("md_kodedatel_" + iNumLinha);
    var var_md_namadatel_ = scAjaxGetFieldText("md_namadatel_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_datel_submit_form(var_md_iddatel_, var_md_idwitel_, var_md_kodedatel_, var_md_namadatel_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_datel_submit_form_cb);
  } // do_ajax_datel_submit_form

  function do_ajax_datel_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("md_iddatel_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("md_idwitel_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("md_kodedatel_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("md_namadatel_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_datel_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_datel_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_datel_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("md_iddatel_" + iNavForm);
      scAjaxHideErrorDisplay("md_idwitel_" + iNavForm);
      scAjaxHideErrorDisplay("md_kodedatel_" + iNavForm);
      scAjaxHideErrorDisplay("md_namadatel_" + iNavForm);
    }
    var var_md_iddatel_ = document.F2.md_iddatel_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_datel_navigate_form(var_md_iddatel_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_datel_navigate_form_cb);
  } // do_ajax_datel_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['datel']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_datel_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.md_iddatel_.value = scAjaxGetKeyValue("md_iddatel_" + var_last_index);
...
?>
  ...
  } // do_ajax_datel_navigate_form_cb
  function sc_hide_datel_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "md_iddatel_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "md_idwitel_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "md_kodedatel_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "md_namadatel_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["md_iddatel_" + iNumLinha] = {"label": "MD IDDATEL<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["md_idwitel_" + iNumLinha] = {"label": "MD IDWITEL<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["md_kodedatel_" + iNumLinha] = {"label": "MD KODEDATEL<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["md_namadatel_" + iNumLinha] = {"label": "MD NAMADATEL<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["md_iddatel_"][iNumLinha] = "md_iddatel_" + iNumLinha;
    ajax_field_mult["md_idwitel_"][iNumLinha] = "md_idwitel_" + iNumLinha;
    ajax_field_mult["md_kodedatel_"][iNumLinha] = "md_kodedatel_" + iNumLinha;
    ajax_field_mult["md_namadatel_"][iNumLinha] = "md_namadatel_" + iNumLinha;
    ajax_field_id["md_iddatel_" + iNumLinha] = new Array("hidden_field_label_md_iddatel_", "hidden_field_data_md_iddatel_" + iNumLinha);
    ajax_field_id["md_idwitel_" + iNumLinha] = new Array("hidden_field_label_md_idwitel_", "hidden_field_data_md_idwitel_" + iNumLinha);
    ajax_field_id["md_kodedatel_" + iNumLinha] = new Array("hidden_field_label_md_kodedatel_", "hidden_field_data_md_kodedatel_" + iNumLinha);
    ajax_field_id["md_namadatel_" + iNumLinha] = new Array("hidden_field_label_md_namadatel_", "hidden_field_data_md_namadatel_" + iNumLinha);
    ajax_error_count["md_iddatel_" + iNumLinha] = "off";
    ajax_error_count["md_idwitel_" + iNumLinha] = "off";
    ajax_error_count["md_kodedatel_" + iNumLinha] = "off";
    ajax_error_count["md_namadatel_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["md_iddatel_" + iNumLinha] = "on";
    ajax_read_only["md_idwitel_" + iNumLinha] = "off";
    ajax_read_only["md_kodedatel_" + iNumLinha] = "off";
    ajax_read_only["md_namadatel_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["md_iddatel_" + iNumLinha] = "on";
    ajax_read_only["md_idwitel_" + iNumLinha] = "on";
    ajax_read_only["md_kodedatel_" + iNumLinha] = "on";
    ajax_read_only["md_namadatel_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["md_iddatel_" + iNumLinha] = null;
    ajax_error_list["md_idwitel_" + iNumLinha] = null;
    ajax_error_list["md_kodedatel_" + iNumLinha] = null;
    ajax_error_list["md_namadatel_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "md_iddatel_": new Array(),
    "md_idwitel_": new Array(),
    "md_kodedatel_": new Array(),
    "md_namadatel_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["md_iddatel_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["md_iddatel_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["md_iddatel_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["md_iddatel_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["md_iddatel_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["md_idwitel_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["md_idwitel_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["md_idwitel_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["md_idwitel_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["md_idwitel_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["md_kodedatel_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["md_kodedatel_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["md_kodedatel_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["md_kodedatel_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["md_kodedatel_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["md_namadatel_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["md_namadatel_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["md_namadatel_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["md_namadatel_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["md_namadatel_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['md_iddatel_'])) ? $this->nmgp_cmp_readonly['md_iddatel_'] : 'on';
?>
    scAjaxFieldRead("md_iddatel_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['md_idwitel_'])) ? $this->nmgp_cmp_readonly['md_idwitel_'] : 'off';
?>
    scAjaxFieldRead("md_idwitel_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['md_kodedatel_'])) ? $this->nmgp_cmp_readonly['md_kodedatel_'] : 'off';
?>
    scAjaxFieldRead("md_kodedatel_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['md_namadatel_'])) ? $this->nmgp_cmp_readonly['md_namadatel_'] : 'off';
?>
    scAjaxFieldRead("md_namadatel_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("md_iddatel_" + iSeq, "on");
    scAjaxFieldRead("md_idwitel_" + iSeq, "on");
    scAjaxFieldRead("md_kodedatel_" + iSeq, "on");
    scAjaxFieldRead("md_namadatel_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["md_iddatel_" + iRow] || "on" == ajax_error_count["md_idwitel_" + iRow] || "on" == ajax_error_count["md_kodedatel_" + iRow] || "on" == ajax_error_count["md_namadatel_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_md_iddatel_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_md_idwitel_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_md_kodedatel_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_md_namadatel_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["md_iddatel_" + iRow] && "off" == ajax_error_count["md_idwitel_" + iRow] && "off" == ajax_error_count["md_kodedatel_" + iRow] && "off" == ajax_error_count["md_namadatel_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["md_iddatel_" + iRow] = "off";
        ajax_error_count["md_idwitel_" + iRow] = "off";
        ajax_error_count["md_kodedatel_" + iRow] = "off";
        ajax_error_count["md_namadatel_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_md_iddatel_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_md_idwitel_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_md_kodedatel_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_md_namadatel_" + iRow).removeClass("scFormErrorLine");
    }
  }
