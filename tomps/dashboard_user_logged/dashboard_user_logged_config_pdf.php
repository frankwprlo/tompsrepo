 ...
 */
    ...
    session_start();
    $SC_apl_proc = "dashboard_user_logged";
...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['dashboard_user_logged']['show_skip_charts_option']) || !$_SESSION['sc_session']['dashboard_user_logged']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
