...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_controlclose_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("project_edit_update_main_controlclose_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('project_edit_update_main_controlclose_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_controlclose_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_controlclose_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_controlclose_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_controlclose_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_controlclose_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_controlclose_mob']['recarga'];
}
?>
<body class="scFormPage" style="<?php echo $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['project_edit_update_main_controlclose']['error_buffer']) && '' != $_SESSION['scriptcase']['project_edit_update_main_controlclose']['error_buffer'])
{
    echo $_SESSION['scriptcase']['project_edit_update_main_controlclose']['error_buffer'];
}
...
<?php
 include_once("project_edit_update_main_controlclose_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="project_edit_update_main_controlclose_mob.php" 
               target="_self">
...
<?php
$_SESSION['scriptcase']['error_span_title']['project_edit_update_main_controlclose_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['project_edit_update_main_controlclose_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_controlclose_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_controlclose_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_controlclose_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_controlclose_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_controlclose_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_controlclose_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_controlclose_mob']['empty_filter'] = true;
       }
  }
  else
  {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_prepare_line" id="hidden_field_data_prepare" style="<?php echo $sStyleHidden_prepare; ?>"> <span class="scFormLabelOddFormat css_prepare_label"><span id="id_label_prepare"><?php echo $this->nm_new_label['prepare']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_perijinan_line" id="hidden_field_data_perijinan" style="<?php echo $sStyleHidden_perijinan; ?>"> <span class="scFormLabelOddFormat css_perijinan_label"><span id="id_label_perijinan"><?php echo $this->nm_new_label['perijinan']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_inst_testcomm_line" id="hidden_field_data_inst_testcomm" style="<?php echo $sStyleHidden_inst_testcomm; ?>"> <span class="scFormLabelOddFormat css_inst_testcomm_label"><span id="id_label_inst_testcomm"><?php echo $this->nm_new_label['inst_testcomm']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idproject_line" id="hidden_field_data_idproject" style="<?php echo $sStyleHidden_idproject; ?>"> <span class="scFormLabelOddFormat css_idproject_label"><span id="id_label_idproject"><?php echo $this->nm_new_label['idproject']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tahapanproject_line" id="hidden_field_data_tahapanproject" style="<?php echo $sStyleHidden_tahapanproject; ?>"> <span class="scFormLabelOddFormat css_tahapanproject_label"><span id="id_label_tahapanproject"><?php echo $this->nm_new_label['tahapanproject']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_templateproject_line" id="hidden_field_data_templateproject" style="<?php echo $sStyleHidden_templateproject; ?>"> <span class="scFormLabelOddFormat css_templateproject_label"><span id="id_label_templateproject"><?php echo $this->nm_new_label['templateproject']; ?></span></span><br>
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_controlclose_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_controlclose_mob']['dashboard_info']['under_dashboard']))) {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_controlclose_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_controlclose_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("project_edit_update_main_controlclose_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("project_edit_update_main_controlclose_mob");
 parent.scAjaxDetailHeight("project_edit_update_main_controlclose_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
