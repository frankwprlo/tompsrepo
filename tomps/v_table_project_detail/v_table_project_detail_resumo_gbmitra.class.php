...
class v_table_project_detail_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['pdf'] = "on";
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['dashboard_info']['under_dashboard'] ? "off" : "on";
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['dashboard_info']['under_dashboard'] ? "off" : "on";
      $this->nmgp_botoes['word'] = "on";
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['dashboard_info']['under_dashboard'] ? "off" : "on";
      $this->nmgp_botoes['xls'] = "on";
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['contr_total_geral'] == "OK")
      {
          $this->array_total_statusname = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['arr_total']['statusname'];
          $this->array_total_tm_namamitra = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['arr_total']['tm_namamitra'];
      }
      else
      {
          $this->array_total_statusname = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['tot_geral'][2];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['tot_geral'][3];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['tot_geral'][4];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['tot_geral'][5];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['tot_geral'][6];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
...
TestComm",
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['summarizing_fields_order']['gbmitra']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['summarizing_fields_order']['gbmitra'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['summarizing_fields_order']['gbmitra'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['summarizing_fields_display']['gbmitra'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['summarizing_fields_display']['gbmitra'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['summarizing_fields_display']['gbmitra'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['summarizing_fields_display']['gbmitra'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['summarizing_fields_display']['gbmitra'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['summarizing_fields_display']['gbmitra'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['summarizing_fields_display']['gbmitra'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_statusname as $i_statusname => $d_statusname) {
           ...
           foreach ($this->array_total_tm_namamitra[$i_statusname] as $i_tm_namamitra => $d_tm_namamitra) {
               if (!in_array($i_tm_namamitra, $this->comp_label[1][ $d_statusname[8] ], true)) {
                   $this->comp_index[1][ $d_tm_namamitra[8] ] = $d_tm_namamitra[7];
                   $this->comp_label[1][ $d_statusname[8] ][ $d_tm_namamitra[8] ] = $d_tm_namamitra[7];
               }
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@v_table_project_detail@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['pivot_order_start'][$iYAxysIndex])
                       {
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "v_table_project_detail_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['opcao'] = "print";
      ...
      $this->Total   = new v_table_project_detail_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['responsive_chart']['active']) {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_v_table_project_detail_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_v_table_project_detail_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_v_table_project_detail_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "v_table_project_detail/v_table_project_detail_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "v_table_project_detail/v_table_project_detail_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=XX&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&language=en_us&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rrtf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "v_table_project_detail/v_table_project_detail_config_word.php?nm_cor=AM&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "v_table_project_detail/v_table_project_detail_config_print.php?nm_opc=resumo&nm_cor=AM&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("v_table_project_detail_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'v_table_project_detail_config_pivot.php?nome_apl=v_table_project_detail&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_v_table_project_detail_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "v_table_project_detail/v_table_project_detail_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $tp_id = $Busca_temp['tp_id']; 
          $tmp_pos = strpos($tp_id, "##@@");
          if ($tmp_pos !== false && !is_array($tp_id))
          {
          ...
          $tp_projectname = $Busca_temp['tp_projectname']; 
          $tmp_pos = strpos($tp_projectname, "##@@");
          if ($tmp_pos !== false && !is_array($tp_projectname))
          {
              $tp_projectname = substr($tp_projectname, 0, $tmp_pos);
          }
          $tp_lokasi = $Busca_temp['tp_lokasi']; 
          $tmp_pos = strpos($tp_lokasi, "##@@");
          if ($tmp_pos !== false && !is_array($tp_lokasi))
          {
   ...
   //---- 
   function adiciona_registro($avg_prepare, $avg_perijinan, $avg_inst_testcomm, $avg_closing, $avg_pencapaian, $quebra_statusname, $quebra_tm_namamitra, $quebra_statusname_orig, $quebra_tm_namamitra_orig)
   {
      //----- STATUSNAME
      ...
      if (!isset($this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig]))
      {
         ...
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][1] = $avg_prepare;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][2] = $avg_perijinan;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][3] = $avg_inst_testcomm;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][4] = $avg_closing;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][5] = $avg_pencapaian;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][6] = 1;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][7] = $quebra_tm_namamitra;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][8] = $quebra_tm_namamitra_orig;
      }
      else
      {
         ...
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][4] += $avg_closing;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][5] += $avg_pencapaian;
         $this->array_total_tm_namamitra[$quebra_statusname_orig][$quebra_tm_namamitra_orig][6]++;
      }
      //----- Total
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['arr_total']['statusname'] as $campo_statusname => $dados_statusname)
      {
         ...
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['arr_total']['tm_namamitra'][$campo_statusname] as $campo_tm_namamitra => $dados_tm_namamitra)
         {
            ...
            $this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][1] = $dados_tm_namamitra[6];
         }
      }
   }
   //---- 
   function finaliza_arrays()
   {
      foreach ($this->array_total_statusname as $campo_statusname => $dados_statusname)
      {
         ...
         {
            if ($this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][0] != 0) {$this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][1] /= $this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][0];}
            nmgp_Trunc_Num($this->array_total_tm_namamitra[$campo_statusname][$campo_tm_namamitra][1], 2);
...
$_SESSION['scriptcase']['v_table_project_detail']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->prepare, $this->perijinan, $this->inst_testcomm, $this->closing, $this->pencapaian, $this->statusname, $this->tm_namamitra, $this->statusname_orig,  $this->tm_namamitra_orig);
            }
   }
//
...
$_SESSION['scriptcase']['v_table_project_detail']['contr_erro'] = 'off';
      ...
      $this->finaliza_arrays();
      $this->rs_grid->Close();
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['tot_geral'][2] = $this->array_total_geral[1];
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['tot_geral'][3] = $this->array_total_geral[2];
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['tot_geral'][4] = $this->array_total_geral[3];
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['tot_geral'][5] = $this->array_total_geral[4];
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['tot_geral'][6] = $this->array_total_geral[5];
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['tot_geral'][1] = $this->array_total_geral[0];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['arr_total']['statusname'] = $this->array_total_statusname;
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['arr_total']['tm_namamitra'] = $this->array_total_tm_namamitra;
      }
   }
