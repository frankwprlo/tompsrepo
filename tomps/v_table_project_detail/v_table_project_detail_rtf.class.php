...
class v_table_project_detail_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "v_table_project_detail.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['rtf_name']);
      }
...
$_SESSION['scriptcase']['v_table_project_detail']['contr_erro'] = 'off'; 
   ...
   function NM_export_mw_namawitel()
   {
         ...
         $this->mw_namawitel = str_replace('<', '&lt;', $this->mw_namawitel);
         $this->mw_namawitel = str_replace('>', '&gt;', $this->mw_namawitel);
         $this->Texto_tag .= "<td>" . $this->mw_namawitel . "</td>\r\n";
   }
   //----- md_namadatel
   function NM_export_md_namadatel()
   {
         ...
         $this->md_namadatel = str_replace('<', '&lt;', $this->md_namadatel);
         $this->md_namadatel = str_replace('>', '&gt;', $this->md_namadatel);
         $this->Texto_tag .= "<td>" . $this->md_namadatel . "</td>\r\n";
   }
   //----- ms_namasto
   function NM_export_ms_namasto()
   {
         ...
         $this->ms_namasto = str_replace('<', '&lt;', $this->ms_namasto);
         $this->ms_namasto = str_replace('>', '&gt;', $this->ms_namasto);
         $this->Texto_tag .= "<td>" . $this->ms_namasto . "</td>\r\n";
   }
   //----- templatename
   function NM_export_templatename()
   {
         ...
         $this->templatename = str_replace('>', '&gt;', $this->templatename);
         $this->Texto_tag .= "<td>" . $this->templatename . "</td>\r\n";
   }
   //----- statusname
   function NM_export_statusname()
   {
         ...
         $this->statusname = str_replace('<', '&lt;', $this->statusname);
         $this->statusname = str_replace('>', '&gt;', $this->statusname);
         $this->Texto_tag .= "<td>" . $this->statusname . "</td>\r\n";
   }
   //----- tm_namamitra
   function NM_export_tm_namamitra()
   {
         ...
         $this->tm_namamitra = str_replace('<', '&lt;', $this->tm_namamitra);
         $this->tm_namamitra = str_replace('>', '&gt;', $this->tm_namamitra);
         $this->Texto_tag .= "<td>" . $this->tm_namamitra . "</td>\r\n";
   }
   //----- tp_batch
   function NM_export_tp_batch()
   {
         ...
         $this->tp_batch = str_replace('<', '&lt;', $this->tp_batch);
         $this->tp_batch = str_replace('>', '&gt;', $this->tp_batch);
         $this->Texto_tag .= "<td>" . $this->tp_batch . "</td>\r\n";
   }
   //----- tp_projectname
   function NM_export_tp_projectname()
   {
         ...
         $this->tp_projectname = str_replace('<', '&lt;', $this->tp_projectname);
         $this->tp_projectname = str_replace('>', '&gt;', $this->tp_projectname);
         $this->Texto_tag .= "<td>" . $this->tp_projectname . "</td>\r\n";
   }
   //----- tp_lokasi
   function NM_export_tp_lokasi()
   {
         ...
         $this->tp_lokasi = str_replace('<', '&lt;', $this->tp_lokasi);
         $this->tp_lokasi = str_replace('>', '&gt;', $this->tp_lokasi);
         $this->Texto_tag .= "<td>" . $this->tp_lokasi . "</td>\r\n";
   }
   //----- tp_odp
   ...
   function NM_export_tp_summary()
   {
         ...
         $this->tp_summary = str_replace('<', '&lt;', $this->tp_summary);
         $this->tp_summary = str_replace('>', '&gt;', $this->tp_summary);
         $this->Texto_tag .= "<td>" . $this->tp_summary . "</td>\r\n";
   }
   //----- tp_status
   function NM_export_tp_status()
   {
         ...
         $this->tp_status = str_replace('<', '&lt;', $this->tp_status);
         $this->tp_status = str_replace('>', '&gt;', $this->tp_status);
         $this->Texto_tag .= "<td>" . $this->tp_status . "</td>\r\n";
   }
   //----- tp_jenisproject
   function NM_export_tp_jenisproject()
   {
         ...
         $this->tp_jenisproject = str_replace('<', '&lt;', $this->tp_jenisproject);
         $this->tp_jenisproject = str_replace('>', '&gt;', $this->tp_jenisproject);
         $this->Texto_tag .= "<td>" . $this->tp_jenisproject . "</td>\r\n";
   }
   //----- tp_prjtrelease
   function NM_export_tp_prjtrelease()
   {
         ...
         $this->tp_prjtrelease = str_replace('<', '&lt;', $this->tp_prjtrelease);
         $this->tp_prjtrelease = str_replace('>', '&gt;', $this->tp_prjtrelease);
         $this->Texto_tag .= "<td>" . $this->tp_prjtrelease . "</td>\r\n";
   }
   //----- tp_targetwaktu
   function NM_export_tp_targetwaktu()
   {
         ...
         $this->tp_targetwaktu = str_replace('<', '&lt;', $this->tp_targetwaktu);
         $this->tp_targetwaktu = str_replace('>', '&gt;', $this->tp_targetwaktu);
         $this->Texto_tag .= "<td>" . $this->tp_targetwaktu . "</td>\r\n";
   }
   //----- prepare
   function NM_export_prepare()
   {
         ...
         $this->prepare = str_replace('<', '&lt;', $this->prepare);
         $this->prepare = str_replace('>', '&gt;', $this->prepare);
         $this->Texto_tag .= "<td>" . $this->prepare . "</td>\r\n";
   }
   //----- perijinan
   function NM_export_perijinan()
   {
         ...
         $this->perijinan = str_replace('<', '&lt;', $this->perijinan);
         $this->perijinan = str_replace('>', '&gt;', $this->perijinan);
         $this->Texto_tag .= "<td>" . $this->perijinan . "</td>\r\n";
   }
   //----- inst_testcomm
   function NM_export_inst_testcomm()
   {
         ...
         $this->inst_testcomm = str_replace('<', '&lt;', $this->inst_testcomm);
         $this->inst_testcomm = str_replace('>', '&gt;', $this->inst_testcomm);
         $this->Texto_tag .= "<td>" . $this->inst_testcomm . "</td>\r\n";
   }
   //----- closing
   function NM_export_closing()
   {
         ...
         $this->closing = str_replace('<', '&lt;', $this->closing);
         $this->closing = str_replace('>', '&gt;', $this->closing);
         $this->Texto_tag .= "<td>" . $this->closing . "</td>\r\n";
   }
   //----- pencapaian
   function NM_export_pencapaian()
   {
         ...
         $this->pencapaian = str_replace('<', '&lt;', $this->pencapaian);
         $this->pencapaian = str_replace('>', '&gt;', $this->pencapaian);
         $this->Texto_tag .= "<td>" . $this->pencapaian . "</td>\r\n";
   }
   //----- tp_mitra
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_detail']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Resume Project Detail :: RTF</TITLE>
