...
class v_table_project_detail_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['v_table_project_detail']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['v_table_project_detail']['campos_busca']))
      { 
