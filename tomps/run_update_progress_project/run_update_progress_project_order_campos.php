<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new run_update_progress_project_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class run_update_progress_project_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["tp_id"]   = (isset($_SESSION['sc_session'][$sc_init]['run_update_progress_project']['labels']["tp_id"])) ? $_SESSION['sc_session'][$sc_init]['run_update_progress_project']['labels']["tp_id"] : "TP ID";
   ...
   $tab_labels["tp_templateproject"]   = (isset($_SESSION['sc_session'][$sc_init]['run_update_progress_project']['labels']["tp_templateproject"])) ? $_SESSION['sc_session'][$sc_init]['run_update_progress_project']['labels']["tp_templateproject"] : "TP TEMPLATEPROJECT";
   ...
   $tab_labels["tp_jenisproject"]   = (isset($_SESSION['sc_session'][$sc_init]['run_update_progress_project']['labels']["tp_jenisproject"])) ? $_SESSION['sc_session'][$sc_init]['run_update_progress_project']['labels']["tp_jenisproject"] : "TP JENISPROJECT";
   $tab_ger_campos['tp_status'] = "on";
   $tab_def_campos['tp_status'] = "TP_STATUS";
   $tab_converte["TP_STATUS"]   = "tp_status";
   $tab_labels["tp_status"]   = (isset($_SESSION['sc_session'][$sc_init]['run_update_progress_project']['labels']["tp_status"])) ? $_SESSION['sc_session'][$sc_init]['run_update_progress_project']['labels']["tp_status"] : "TP STATUS";
   $tab_ger_campos['tp_prosentase'] = "on";
   $tab_def_campos['tp_prosentase'] = "TP_PROSENTASE";
   $tab_converte["TP_PROSENTASE"]   = "tp_prosentase";
   $tab_labels["tp_prosentase"]   = (isset($_SESSION['sc_session'][$sc_init]['run_update_progress_project']['labels']["tp_prosentase"])) ? $_SESSION['sc_session'][$sc_init]['run_update_progress_project']['labels']["tp_prosentase"] : "TP PROSENTASE";
   ...
   $tab_labels["tp_tahapanaktif"]   = (isset($_SESSION['sc_session'][$sc_init]['run_update_progress_project']['labels']["tp_tahapanaktif"])) ? $_SESSION['sc_session'][$sc_init]['run_update_progress_project']['labels']["tp_tahapanaktif"] : "TP TAHAPANAKTIF";
   $tab_ger_campos['tp_taskaktif'] = "on";
   $tab_def_campos['tp_taskaktif'] = "TP_TASKAKTIF";
   $tab_converte["TP_TASKAKTIF"]   = "tp_taskaktif";
   $tab_labels["tp_taskaktif"]   = (isset($_SESSION['sc_session'][$sc_init]['run_update_progress_project']['labels']["tp_taskaktif"])) ? $_SESSION['sc_session'][$sc_init]['run_update_progress_project']['labels']["tp_taskaktif"] : "TP TASKAKTIF";
   $tab_ger_campos['prosentase'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prosentase'] = "prosentase";
       $tab_converte["prosentase"]   = "prosentase";
   }
   else
   {
       $tab_def_campos['prosentase'] = "";
       $tab_converte[""]   = "prosentase";
   }
   $tab_labels["prosentase"]   = (isset($_SESSION['sc_session'][$sc_init]['run_update_progress_project']['labels']["prosentase"])) ? $_SESSION['sc_session'][$sc_init]['run_update_progress_project']['labels']["prosentase"] : "prosentase";
   $tab_ger_campos['prosentase'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['run_update_progress_project']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['run_update_progress_project']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['run_update_progress_project']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['run_update_progress_project']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['run_update_progress_project']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['run_update_progress_project']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['run_update_progress_project']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['run_update_progress_project']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['run_update_progress_project']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - TBL_PROJECT</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "run_update_progress_project_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['run_update_progress_project']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['run_update_progress_project']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
