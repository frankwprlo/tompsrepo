...
class run_update_progress_project_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . run_update_progress_project_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . run_update_progress_project_pack_protect_string($Tipo_filter[0]) . "\">.." . run_update_progress_project_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_tp_templateproject($tp_templateproject)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct TP_TEMPLATEPROJECT from " . $this->Ini->nm_tabela . " where   CAST (TP_TEMPLATEPROJECT AS TEXT)  like '%" . $tp_templateproject . "%' order by TP_TEMPLATEPROJECT"; 
      }
      else
      {
          $nm_comando = "select distinct TP_TEMPLATEPROJECT from " . $this->Ini->nm_tabela . " where  TP_TEMPLATEPROJECT like '%" . $tp_templateproject . "%' order by TP_TEMPLATEPROJECT"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_tp_jenisproject($tp_jenisproject)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct TP_JENISPROJECT from " . $this->Ini->nm_tabela . " where   CAST (TP_JENISPROJECT AS TEXT)  like '%" . $tp_jenisproject . "%' order by TP_JENISPROJECT"; 
      }
      else
      {
          $nm_comando = "select distinct TP_JENISPROJECT from " . $this->Ini->nm_tabela . " where  TP_JENISPROJECT like '%" . $tp_jenisproject . "%' order by TP_JENISPROJECT"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_tp_status($tp_status)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct TP_STATUS from " . $this->Ini->nm_tabela . " where   CAST (TP_STATUS AS TEXT)  like '%" . $tp_status . "%' order by TP_STATUS"; 
      }
      else
      {
          $nm_comando = "select distinct TP_STATUS from " . $this->Ini->nm_tabela . " where  TP_STATUS like '%" . $tp_status . "%' order by TP_STATUS"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - TBL_PROJECT</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>run_update_progress_project/run_update_progress_project_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="run_update_progress_project_ajax_search.js"></script>
 <script type="text/javascript" src="run_update_progress_project_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_tp_id_input_2#NMF#' + search_get_text('SC_tp_id_input_2') + '@NMF@';
  ...
  str_out += 'SC_tp_templateproject_input_2#NMF#' + search_get_text('SC_tp_templateproject_input_2') + '@NMF@';
  ...
  str_out += 'SC_tp_jenisproject_input_2#NMF#' + search_get_text('SC_tp_jenisproject_input_2') + '@NMF@';
  ...
  str_out += 'SC_tp_status_input_2#NMF#' + search_get_text('SC_tp_status_input_2') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - TBL_PROJECT</span></td>
...
<?php
   ...
   {
      global 
             $tp_id_cond, $tp_id, $tp_id_input_2, $tp_id_autocomp,
             $tp_templateproject_cond, $tp_templateproject, $tp_templateproject_input_2, $tp_templateproject_autocomp,
             $tp_jenisproject_cond, $tp_jenisproject, $tp_jenisproject_input_2, $tp_jenisproject_autocomp,
             $tp_status_cond, $tp_status, $tp_status_input_2, $tp_status_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $tp_id = $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_id']; 
          $tp_id_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_id_input_2']; 
          $tp_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_id_cond']; 
          $tp_templateproject = $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_templateproject']; 
          $tp_templateproject_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_templateproject_input_2']; 
          $tp_templateproject_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_templateproject_cond']; 
          $tp_jenisproject = $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_jenisproject']; 
          $tp_jenisproject_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_jenisproject_input_2']; 
          $tp_jenisproject_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_jenisproject_cond']; 
          $tp_status = $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_status']; 
          $tp_status_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_status_input_2']; 
          $tp_status_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_status_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['NM_operador']; 
      } 
      ...
      $str_display_tp_id = ('bw' == $tp_id_cond) ? $display_aberto : $display_fechado;
      $str_display_tp_templateproject = ('bw' == $tp_templateproject_cond) ? $display_aberto : $display_fechado;
      $str_display_tp_jenisproject = ('bw' == $tp_jenisproject_cond) ? $display_aberto : $display_fechado;
      $str_display_tp_status = ('bw' == $tp_status_cond) ? $display_aberto : $display_fechado;
   ...
   <tr>
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_tp_id_cond" name="tp_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_tp_id'), this, 'tp_id')">
       ...
       <OPTION value="bw" <?php if ("bw" == $tp_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
...
?>
<INPUT  type="text" id="SC_tp_id" name="tp_id" value="<?php echo NM_encode_input($tp_id) ?>" size=22 alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_tp_id" name="tp_id_autocomp" size="22" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_tp_id"  <?php echo $str_display_tp_id; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_tp_id_input_2" name="tp_id_input_2" value="<?php echo NM_encode_input($tp_id_input_2) ?>" size=22 alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['tp_templateproject'])) ? $this->New_label['tp_templateproject'] : "TP TEMPLATEPROJECT"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_tp_templateproject_cond" name="tp_templateproject_cond" onChange="nm_campos_between(document.getElementById('id_vis_tp_templateproject'), this, 'tp_templateproject')">
       ...
       <OPTION value="bw" <?php if ("bw" == $tp_templateproject_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct TP_TEMPLATEPROJECT from " . $this->Ini->nm_tabela . " where TP_TEMPLATEPROJECT = $tp_templateproject_look order by TP_TEMPLATEPROJECT"; 
      }
      else
      {
          $nm_comando = "select distinct TP_TEMPLATEPROJECT from " . $this->Ini->nm_tabela . " where TP_TEMPLATEPROJECT = $tp_templateproject_look order by TP_TEMPLATEPROJECT"; 
...
?>
<INPUT  type="text" id="SC_tp_templateproject" name="tp_templateproject" value="<?php echo NM_encode_input($tp_templateproject) ?>" size=22 alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_tp_templateproject" name="tp_templateproject_autocomp" size="22" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_tp_templateproject"  <?php echo $str_display_tp_templateproject; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_tp_templateproject_input_2" name="tp_templateproject_input_2" value="<?php echo NM_encode_input($tp_templateproject_input_2) ?>" size=22 alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['tp_jenisproject'])) ? $this->New_label['tp_jenisproject'] : "TP JENISPROJECT"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_tp_jenisproject_cond" name="tp_jenisproject_cond" onChange="nm_campos_between(document.getElementById('id_vis_tp_jenisproject'), this, 'tp_jenisproject')">
       ...
       <OPTION value="bw" <?php if ("bw" == $tp_jenisproject_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct TP_JENISPROJECT from " . $this->Ini->nm_tabela . " where TP_JENISPROJECT = $tp_jenisproject_look order by TP_JENISPROJECT"; 
      }
      else
      {
          $nm_comando = "select distinct TP_JENISPROJECT from " . $this->Ini->nm_tabela . " where TP_JENISPROJECT = $tp_jenisproject_look order by TP_JENISPROJECT"; 
...
?>
<INPUT  type="text" id="SC_tp_jenisproject" name="tp_jenisproject" value="<?php echo NM_encode_input($tp_jenisproject) ?>" size=22 alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_tp_jenisproject" name="tp_jenisproject_autocomp" size="22" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_tp_jenisproject"  <?php echo $str_display_tp_jenisproject; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_tp_jenisproject_input_2" name="tp_jenisproject_input_2" value="<?php echo NM_encode_input($tp_jenisproject_input_2) ?>" size=22 alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['tp_status'])) ? $this->New_label['tp_status'] : "TP STATUS"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_tp_status_cond" name="tp_status_cond" onChange="nm_campos_between(document.getElementById('id_vis_tp_status'), this, 'tp_status')">
       ...
       <OPTION value="bw" <?php if ("bw" == $tp_status_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct TP_STATUS from " . $this->Ini->nm_tabela . " where TP_STATUS = $tp_status_look order by TP_STATUS"; 
      }
      else
      {
          $nm_comando = "select distinct TP_STATUS from " . $this->Ini->nm_tabela . " where TP_STATUS = $tp_status_look order by TP_STATUS"; 
...
?>
<INPUT  type="text" id="SC_tp_status" name="tp_status" value="<?php echo NM_encode_input($tp_status) ?>" size=22 alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_tp_status" name="tp_status_autocomp" size="22" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_tp_status"  <?php echo $str_display_tp_status; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_tp_status_input_2" name="tp_status_input_2" value="<?php echo NM_encode_input($tp_status_input_2) ?>" size=22 alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">
...
?>
<?php
   if (is_file("run_update_progress_project_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['run_update_progress_project']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['run_update_progress_project']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.tp_id_input_2.value = "";
   ...
   document.F1.tp_templateproject_input_2.value = "";
   ...
   document.F1.tp_jenisproject_input_2.value = "";
   ...
   document.F1.tp_status_input_2.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "projectamo/run_update_progress_project";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "run_update_progress_project/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_tp_id_input_2'] = 'text';
   ...
   {
      global $tp_id_cond, $tp_id, $tp_id_input_2, $tp_id_autocomp,
             $tp_templateproject_cond, $tp_templateproject, $tp_templateproject_input_2, $tp_templateproject_autocomp,
             $tp_jenisproject_cond, $tp_jenisproject, $tp_jenisproject_input_2, $tp_jenisproject_autocomp,
             $tp_status_cond, $tp_status, $tp_status_input_2, $tp_status_autocomp, $nmgp_tab_label;
      ...
      if ($tp_id_cond != "in")
      {
          nm_limpa_numero($tp_id_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      ...
      if ($tp_templateproject_cond != "in")
      {
          nm_limpa_numero($tp_templateproject_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      ...
      if ($tp_jenisproject_cond != "in")
      {
          nm_limpa_numero($tp_jenisproject_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      ...
      if ($tp_status_cond != "in")
      {
          nm_limpa_numero($tp_status_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_id'] = $tp_id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_id_input_2'] = $tp_id_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_id_cond'] = $tp_id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_templateproject'] = $tp_templateproject; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_templateproject_input_2'] = $tp_templateproject_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_templateproject_cond'] = $tp_templateproject_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_jenisproject'] = $tp_jenisproject; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_jenisproject_input_2'] = $tp_jenisproject_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_jenisproject_cond'] = $tp_jenisproject_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_status'] = $tp_status; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_status_input_2'] = $tp_status_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['tp_status_cond'] = $tp_status_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']['NM_operador'] = $this->NM_operador; 
      ...
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : TP TEMPLATEPROJECT";
      }
      ...
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : TP JENISPROJECT";
      }
      ...
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : TP STATUS";
      }
   ...
   { 
      ...
      $Conteudo = $tp_id_input_2;
      if (strtoupper($tp_id_cond) != "II" && strtoupper($tp_id_cond) != "QP" && strtoupper($tp_id_cond) != "NP" && strtoupper($tp_id_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['tp_id_input_2'] = $Conteudo;
      $tp_templateproject_look = substr($this->Db->qstr($tp_templateproject), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($tp_templateproject))
   { 
      ...
      $Conteudo = $tp_templateproject_input_2;
      if (strtoupper($tp_templateproject_cond) != "II" && strtoupper($tp_templateproject_cond) != "QP" && strtoupper($tp_templateproject_cond) != "NP" && strtoupper($tp_templateproject_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['tp_templateproject_input_2'] = $Conteudo;
      $tp_jenisproject_look = substr($this->Db->qstr($tp_jenisproject), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($tp_jenisproject))
   { 
      ...
      $Conteudo = $tp_jenisproject_input_2;
      if (strtoupper($tp_jenisproject_cond) != "II" && strtoupper($tp_jenisproject_cond) != "QP" && strtoupper($tp_jenisproject_cond) != "NP" && strtoupper($tp_jenisproject_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['tp_jenisproject_input_2'] = $Conteudo;
      $tp_status_look = substr($this->Db->qstr($tp_status), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($tp_status))
   { 
      ...
      $Conteudo = $tp_status_input_2;
      if (strtoupper($tp_status_cond) != "II" && strtoupper($tp_status_cond) != "QP" && strtoupper($tp_status_cond) != "NP" && strtoupper($tp_status_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['tp_status_input_2'] = $Conteudo;

      //----- $tp_id
      $this->Date_part = false;
      if (isset($tp_id) || $tp_id_cond == "nu" || $tp_id_cond == "nn" || $tp_id_cond == "ep" || $tp_id_cond == "ne")
      {
         $this->monta_condicao("TP_ID", $tp_id_cond, $tp_id, $tp_id_input_2, "tp_id");
      }
      ...
      {
         $this->monta_condicao("TP_TEMPLATEPROJECT", $tp_templateproject_cond, $tp_templateproject, $tp_templateproject_input_2, "tp_templateproject");
      }
      ...
      {
         $this->monta_condicao("TP_JENISPROJECT", $tp_jenisproject_cond, $tp_jenisproject, $tp_jenisproject_input_2, "tp_jenisproject");
      }
      ...
      {
         $this->monta_condicao("TP_STATUS", $tp_status_cond, $tp_status, $tp_status_input_2, "tp_status");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['run_update_progress_project']['where_pesq_ant'] = $this->comando . $this->comando_fim;
