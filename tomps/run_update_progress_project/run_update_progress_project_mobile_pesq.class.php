...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "tp_id";$Nm_numeric[] = "tp_templateproject";$Nm_numeric[] = "tp_jenisproject";$Nm_numeric[] = "tp_status";$Nm_numeric[] = "tp_prosentase";$Nm_numeric[] = "";$Nm_numeric[] = "tp_id";$Nm_numeric[] = "tp_templateproject";$Nm_numeric[] = "tp_jenisproject";$Nm_numeric[] = "tp_status";$Nm_numeric[] = "tp_prosentase";$Nm_numeric[] = "";
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_tp_id" name="tp_id_autocomp" size="22" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_tp_id"  <?php echo $str_display_tp_id; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_tp_id_input_2" name="tp_id_input_2" value="<?php echo NM_encode_input($tp_id_input_2) ?>" size=22 alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_tp_templateproject"  <?php echo $str_hide_tp_templateproject?>><?php
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_tp_templateproject" name="tp_templateproject_autocomp" size="22" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_tp_templateproject"  <?php echo $str_display_tp_templateproject; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_tp_templateproject_input_2" name="tp_templateproject_input_2" value="<?php echo NM_encode_input($tp_templateproject_input_2) ?>" size=22 alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_tp_jenisproject"  <?php echo $str_hide_tp_jenisproject?>><?php
      if ($tp_jenisproject != "")
      {
      $tp_jenisproject_look = substr($this->Db->qstr($tp_jenisproject), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_tp_jenisproject" name="tp_jenisproject_autocomp" size="22" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_tp_jenisproject"  <?php echo $str_display_tp_jenisproject; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_tp_jenisproject_input_2" name="tp_jenisproject_input_2" value="<?php echo NM_encode_input($tp_jenisproject_input_2) ?>" size=22 alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_tp_status"  <?php echo $str_hide_tp_status?>><?php
      if ($tp_status != "")
      {
      $tp_status_look = substr($this->Db->qstr($tp_status), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_tp_status" name="tp_status_autocomp" size="22" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_tp_status"  <?php echo $str_display_tp_status; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_tp_status_input_2" name="tp_status_input_2" value="<?php echo NM_encode_input($tp_status_input_2) ?>" size=22 alt="{datatype: 'integer', maxLength: 22, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
