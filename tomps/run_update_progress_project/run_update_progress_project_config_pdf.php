 ...
 */
    ...
    session_start();
    $SC_apl_proc = "run_update_progress_project";
...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['run_update_progress_project']['show_skip_charts_option']) || !$_SESSION['sc_session']['run_update_progress_project']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
