...
class report_resume_project_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['report_resume_project']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['report_resume_project']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $tp_witel, $tp_tahapanaktif;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(JMLLOP) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project']['tot_geral'][2] = $rt->fields[1]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project']['contr_total_geral'] = "OK";
   } 

   //-----  tp_tahapanaktif
   function quebra_tp_tahapanaktif_groupbywitel($tp_tahapanaktif, $arg_sum_tp_tahapanaktif) 
   {
      global $tot_tp_tahapanaktif, $tp_witel, $tp_tahapanaktif;
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project']['where_pesq'])) 
      { 
         $nm_comando .= " where TP_TAHAPANAKTIF" . $arg_sum_tp_tahapanaktif ; 
      } 
      else 
      { 
         $nm_comando .= " and TP_TAHAPANAKTIF" . $arg_sum_tp_tahapanaktif ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
   ...
   //-----  grouptaskaktif
   function quebra_grouptaskaktif_groupbywitel($tp_tahapanaktif, $grouptaskaktif, $arg_sum_tp_tahapanaktif, $arg_sum_grouptaskaktif) 
   {
      global $tot_grouptaskaktif, $tp_witel, $tp_tahapanaktif;
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project']['where_pesq'])) 
      { 
         $nm_comando .= " where TP_TAHAPANAKTIF" . $arg_sum_tp_tahapanaktif . " and GROUPTASKAKTIF" . $arg_sum_grouptaskaktif ; 
      } 
      else 
      { 
         $nm_comando .= " and TP_TAHAPANAKTIF" . $arg_sum_tp_tahapanaktif . " and GROUPTASKAKTIF" . $arg_sum_grouptaskaktif ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
   ...
   //-----  ketstatus
   function quebra_ketstatus_groupbywitel($tp_tahapanaktif, $grouptaskaktif, $ketstatus, $arg_sum_tp_tahapanaktif, $arg_sum_grouptaskaktif, $arg_sum_ketstatus) 
   {
      global $tot_ketstatus, $tp_witel, $tp_tahapanaktif;
      $tot_ketstatus = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(JMLLOP) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project']['where_pesq']; 
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project']['where_pesq'])) 
      { 
         $nm_comando .= " where TP_TAHAPANAKTIF" . $arg_sum_tp_tahapanaktif . " and GROUPTASKAKTIF" . $arg_sum_grouptaskaktif . " and KETSTATUS" . $arg_sum_ketstatus ; 
      } 
      else 
      { 
         $nm_comando .= " and TP_TAHAPANAKTIF" . $arg_sum_tp_tahapanaktif . " and GROUPTASKAKTIF" . $arg_sum_grouptaskaktif . " and KETSTATUS" . $arg_sum_ketstatus ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
      ...
      $tot_ketstatus[0] = NM_encode_input(sc_strip_script($ketstatus)) ; 
      $tot_ketstatus[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_ketstatus[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
   } 

   //-----  tp_witel
   function quebra_tp_witel_groupbywitel($tp_tahapanaktif, $grouptaskaktif, $ketstatus, $tp_witel, $arg_sum_tp_tahapanaktif, $arg_sum_grouptaskaktif, $arg_sum_ketstatus, $arg_sum_tp_witel) 
   {
      global $tot_tp_witel, $tp_witel, $tp_tahapanaktif;
      $tot_tp_witel = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(JMLLOP) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project']['where_pesq']; 
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project']['where_pesq'])) 
      { 
         $nm_comando .= " where TP_TAHAPANAKTIF" . $arg_sum_tp_tahapanaktif . " and GROUPTASKAKTIF" . $arg_sum_grouptaskaktif . " and KETSTATUS" . $arg_sum_ketstatus . " and TP_WITEL" . $arg_sum_tp_witel ; 
      } 
      else 
      { 
         $nm_comando .= " and TP_TAHAPANAKTIF" . $arg_sum_tp_tahapanaktif . " and GROUPTASKAKTIF" . $arg_sum_grouptaskaktif . " and KETSTATUS" . $arg_sum_ketstatus . " and TP_WITEL" . $arg_sum_tp_witel ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
   ...
   {
      global $nm_lang, $tp_witel, $tp_tahapanaktif;
      $this->nm_data = new nm_data("en_us");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('tp_tahapanaktif' => "TP_TAHAPANAKTIF",'grouptaskaktif' => "GROUPTASKAKTIF",'ketstatus' => "KETSTATUS",'tp_witel' => "TP_WITEL");
      $cmps_quebra_atual = array("tp_tahapanaktif","grouptaskaktif","ketstatus","tp_witel");
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_groupbywitel($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $cmp_sql_tp_num = array('tp_witel' => 'N','tp_datel' => 'N','tp_sto' => 'N','tp_status' => 'N','tp_templateproject' => 'N','tp_jenisproject' => 'N','tp_prjtrelease' => 'N','tp_mitra' => 'N','tp_taskaktif_number' => 'N','tp_taskaktifstatus' => 'N','grouptaskaktif' => 'N','jmllop' => 'N','nilai_rekon' => 'N','nilai_drm' => 'N');
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
         $cmd_simp = "select count(*), sum(JMLLOP)#@#cmps_quebras#@# from " . $this->Ini->nm_tabela . " " . $where_ok;
         $comando  = "select count(*), sum(SC_metric1)#@#cmps_quebras#@# from (";
         $comando .= "select JMLLOP as SC_metric1, " . $cmps_quebras1 . " from " . $this->Ini->nm_tabela . " " .  $where_ok . ") SC_sel1 INNER JOIN (";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['report_resume_project']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
      ...
      $format_dimensions['ketstatus']['reg'] = "S";
      $format_dimensions['ketstatus']['msk'] = "";
      ...
      while (!$rt->EOF)
      {
          ...
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              ...
              if ($Cada_dim == "tp_tahapanaktif") {
                  $this->Lookup->lookup_groupbywitel_tp_tahapanaktif($$Cada_dim,  $tp_tahapanaktif);
              }
          ...
          nmgp_Form_Num_Val($$Cada_dim, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
              ...
              if ($Cada_dim == "ketstatus") {
          nmgp_Form_Num_Val($$Cada_dim, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
              }
              if ($Cada_dim == "tp_witel") {
                  $this->Lookup->lookup_groupbywitel_tp_witel($$Cada_dim,  $tp_witel);
              }
              if (null === $$Cada_dim)
              {
                  $$Cada_dim = '';
