...
?>
   <span id="idAjaxSelect_tp_prjtrelease">
      <SELECT class="scFilterObjectEven" id="SC_tp_prjtrelease" name="tp_prjtrelease" onChange="nm_submit_form();" size="1">
       <OPTION value=""></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
...
?>
   <span id="idAjaxSelect_tp_witel">
      <SELECT class="scFilterObjectEven" id="SC_tp_witel" name="tp_witel" onChange="nm_submit_form();" size="1">
       <OPTION value=""></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
...
?>
   <span id="idAjaxSelect_tp_templateproject">
      <SELECT class="scFilterObjectEven" id="SC_tp_templateproject" name="tp_templateproject" onChange="nm_submit_form();" size="1">
       <OPTION value=""></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
