 ...
 */
    ...
    session_start();
    $SC_apl_proc = "timeplanrpoject_detail_new";
...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['timeplanrpoject_detail_new']['show_skip_charts_option']) || !$_SESSION['sc_session']['timeplanrpoject_detail_new']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
