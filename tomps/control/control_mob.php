...
//
   ...
   $_SESSION['scriptcase']['control_mob']['glo_nm_perfil']          = "conn_mysql_1";
   $_SESSION['scriptcase']['control_mob']['glo_nm_path_prod']       = "/libdemo/prod";
   $_SESSION['scriptcase']['control_mob']['glo_nm_path_imagens']    = "/libdemo/file/img";
   $_SESSION['scriptcase']['control_mob']['glo_nm_path_imag_temp']  = "/libdemo/tmp";
   $_SESSION['scriptcase']['control_mob']['glo_nm_path_doc']        = "/var/www/html/tompsdemo";
//
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['compact_mode']    = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["control_mob"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["control_mob"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['control_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'projectamo'); 
      } 
      else 
      { 
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['control_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['control_mob']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['control_mob']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['control_mob']['SC_sep_date1'];
           }
...
//
    ...
    {
        if ('ajax_control_mob_validate_coba' == $_POST['rs'])
        {
    ...
    elseif (isset($script_case_init) && !empty($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['control_mob']['parms']))
    {
        ...
        {
            $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['control_mob']['parms']);
            $todo  = explode("?@?", $todox);
            $ix = 0;
            while (!empty($todo[$ix]))
            {
    ...
    { 
        ...
        $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['control_mob']['iframe_menu']) ? false : true;
...
<?php
    ...
    sajax_init();
    //$sajax_debug_mode = 1;
    sajax_export("ajax_control_mob_validate_coba");
...
//
    ...
    function ajax_control_mob_validate_coba($coba, $script_case_init)
    {
        global $inicial_control_mob;
        //register_shutdown_function("control_mob_pack_ajax_response");
        $inicial_control_mob->contr_control_mob->NM_ajax_flag          = true;
        $inicial_control_mob->contr_control_mob->NM_ajax_opcao         = 'validate_coba';
    ...
    function ajax_control_mob_submit_form($coba, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_control_mob;
        //register_shutdown_function("control_mob_pack_ajax_response");
        $inicial_control_mob->contr_control_mob->NM_ajax_flag          = true;
...
//-----
      {
         ...
         if (isset($inicial_control_mob->contr_control_mob->NM_ajax_info['buttonDisplayVert']) && !empty($inicial_control_mob->contr_control_mob->NM_ajax_info['buttonDisplayVert']))
         {
            control_mob_pack_ajax_button_display_vert($aResp);
         }
   ...
   function control_mob_pack_ajax_button_display_vert(&$aResp)
   {
      global $inicial_control_mob;
      $aResp['buttonDisplayVert'] = array();
      foreach ($inicial_control_mob->contr_control_mob->NM_ajax_info['buttonDisplayVert'] as $aButtonData)
      {
