...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['control']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['control']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['control']['dashboard_info']['maximized']))
  {
?>
<tr><td>
...
<?php
        ...
        $sCondStyle = ($this->nmgp_botoes['insertdataproject'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "insertdataproject", "sc_btn_insertdataproject()", "sc_btn_insertdataproject()", "sc_insertdataproject_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control']['dashboard_info']['under_dashboard']))) {
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("control");
</script>
<?php
    }
    else {
