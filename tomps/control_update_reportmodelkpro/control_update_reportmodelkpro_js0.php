...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['control_update_reportmodelkpro']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="control_update_reportmodelkpro"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
var Crtl_btn_demo = false;
function sc_btn_demo()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_demo(); }, 500);
      return;
    }
    if (Crtl_btn_demo) {return;}
    Crtl_btn_demo = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?demo?@?";
    document.F1.action = "./";
    document.F1.target = "_self";
    document.F1.submit();
}
var Crtl_btn_pending = false;
function sc_btn_pending()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_pending(); }, 500);
      return;
    }
    if (Crtl_btn_pending) {return;}
    Crtl_btn_pending = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?pending?@?";
    document.F1.action = "./";
    document.F1.target = "_self";
    document.F1.submit();
}
var Crtl_btn_assign = false;
function sc_btn_assign()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_assign(); }, 500);
      return;
    }
    if (Crtl_btn_assign) {return;}
    Crtl_btn_assign = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?assign?@?";
    document.F1.action = "./";
    document.F1.target = "_self";
    document.F1.submit();
}
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_update_reportmodelkpro']['where_detal']))
  {
?>  
...
{ 
   ...
   document.F4.action               = "control_update_reportmodelkpro_fim.php";
   document.F4.submit(); 
} 
