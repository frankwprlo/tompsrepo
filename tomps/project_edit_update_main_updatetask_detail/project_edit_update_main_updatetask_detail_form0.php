...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("project_edit_update_main_updatetask_detail_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('project_edit_update_main_updatetask_detail_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['recarga'];
}
?>
...
<?php
 include_once("project_edit_update_main_updatetask_detail_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['project_edit_update_main_updatetask_detail'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['project_edit_update_main_updatetask_detail'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<input type="hidden" name="ppo_evident_one_ul_name" id="id_sc_field_ppo_evident_one_ul_name" value="<?php echo $this->form_encode_input($this->ppo_evident_one_ul_name);?>">
...
<ul class="scTabLine">
<li id="id_tabs_0_0" class="scTabActive"><a href="javascript: sc_control_tabs_0(0)">Update Task Project</a></li>
<li id="id_tabs_0_1" class="scTabInactive"><a href="javascript: sc_control_tabs_0(1)">Task Project Others</a></li>
</ul>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ppo_id_label" id="hidden_field_label_ppo_id" style="<?php echo $sStyleHidden_ppo_id; ?>"><span id="id_label_ppo_id"><?php echo $this->nm_new_label['ppo_id']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['php_cmp_required']['ppo_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['php_cmp_required']['ppo_id'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_ppo_id_line" id="hidden_field_data_ppo_id" style="<?php echo $sStyleHidden_ppo_id; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ppo_id_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ppo_status_label" id="hidden_field_label_ppo_status" style="<?php echo $sStyleHidden_ppo_status; ?>"><span id="id_label_ppo_status"><?php echo $this->nm_new_label['ppo_status']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['php_cmp_required']['ppo_status']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['php_cmp_required']['ppo_status'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_ppo_status_line" id="hidden_field_data_ppo_status" style="<?php echo $sStyleHidden_ppo_status; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ppo_status_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ppo_tglmulaiactual_label" id="hidden_field_label_ppo_tglmulaiactual" style="<?php echo $sStyleHidden_ppo_tglmulaiactual; ?>"><span id="id_label_ppo_tglmulaiactual"><?php echo $this->nm_new_label['ppo_tglmulaiactual']; ?></span></TD>
    <TD class="scFormDataOdd css_ppo_tglmulaiactual_line" id="hidden_field_data_ppo_tglmulaiactual" style="<?php echo $sStyleHidden_ppo_tglmulaiactual; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ppo_tglmulaiactual_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ppo_tglselesaiactual_label" id="hidden_field_label_ppo_tglselesaiactual" style="<?php echo $sStyleHidden_ppo_tglselesaiactual; ?>"><span id="id_label_ppo_tglselesaiactual"><?php echo $this->nm_new_label['ppo_tglselesaiactual']; ?></span></TD>
    <TD class="scFormDataOdd css_ppo_tglselesaiactual_line" id="hidden_field_data_ppo_tglselesaiactual" style="<?php echo $sStyleHidden_ppo_tglselesaiactual; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ppo_tglselesaiactual_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ppo_evident_one_label" id="hidden_field_label_ppo_evident_one" style="<?php echo $sStyleHidden_ppo_evident_one; ?>"><span id="id_label_ppo_evident_one"><?php echo $this->nm_new_label['ppo_evident_one']; ?></span></TD>
    <TD class="scFormDataOdd css_ppo_evident_one_line" id="hidden_field_data_ppo_evident_one" style="<?php echo $sStyleHidden_ppo_evident_one; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ppo_evident_one_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_keterangan_line" id="hidden_field_data_keterangan" style="<?php echo $sStyleHidden_keterangan; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_keterangan_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_keterangan css_keterangan_line" style="<?php echo $sStyleReadLab_keterangan; ?>"><?php echo $this->form_encode_input($this->keterangan); ?></span><span id="id_read_off_keterangan" style="<?php echo $sStyleReadInp_keterangan; ?>"><span id="id_ajax_label_keterangan"><?php echo $keterangan?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ppo_note_label" id="hidden_field_label_ppo_note" style="<?php echo $sStyleHidden_ppo_note; ?>"><span id="id_label_ppo_note"><?php echo $this->nm_new_label['ppo_note']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['php_cmp_required']['ppo_note']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['php_cmp_required']['ppo_note'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_ppo_note_line" id="hidden_field_data_ppo_note" style="<?php echo $sStyleHidden_ppo_note; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ppo_note_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ppo_projectid_label" id="hidden_field_label_ppo_projectid" style="<?php echo $sStyleHidden_ppo_projectid; ?>"><span id="id_label_ppo_projectid"><?php echo $this->nm_new_label['ppo_projectid']; ?></span></TD>
    <TD class="scFormDataOdd css_ppo_projectid_line" id="hidden_field_data_ppo_projectid" style="<?php echo $sStyleHidden_ppo_projectid; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ppo_projectid_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ppo_tahapanproject_label" id="hidden_field_label_ppo_tahapanproject" style="<?php echo $sStyleHidden_ppo_tahapanproject; ?>"><span id="id_label_ppo_tahapanproject"><?php echo $this->nm_new_label['ppo_tahapanproject']; ?></span></TD>
    <TD class="scFormDataOdd css_ppo_tahapanproject_line" id="hidden_field_data_ppo_tahapanproject" style="<?php echo $sStyleHidden_ppo_tahapanproject; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ppo_tahapanproject_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ppo_idtasktahapan_label" id="hidden_field_label_ppo_idtasktahapan" style="<?php echo $sStyleHidden_ppo_idtasktahapan; ?>"><span id="id_label_ppo_idtasktahapan"><?php echo $this->nm_new_label['ppo_idtasktahapan']; ?></span></TD>
    <TD class="scFormDataOdd css_ppo_idtasktahapan_line" id="hidden_field_data_ppo_idtasktahapan" style="<?php echo $sStyleHidden_ppo_idtasktahapan; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ppo_idtasktahapan_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ppo_tasktahapan_label" id="hidden_field_label_ppo_tasktahapan" style="<?php echo $sStyleHidden_ppo_tasktahapan; ?>"><span id="id_label_ppo_tasktahapan"><?php echo $this->nm_new_label['ppo_tasktahapan']; ?></span></TD>
    <TD class="scFormDataOdd css_ppo_tasktahapan_line" id="hidden_field_data_ppo_tasktahapan" style="<?php echo $sStyleHidden_ppo_tasktahapan; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ppo_tasktahapan_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ppo_tglmulaiplan_label" id="hidden_field_label_ppo_tglmulaiplan" style="<?php echo $sStyleHidden_ppo_tglmulaiplan; ?>"><span id="id_label_ppo_tglmulaiplan"><?php echo $this->nm_new_label['ppo_tglmulaiplan']; ?></span></TD>
    <TD class="scFormDataOdd css_ppo_tglmulaiplan_line" id="hidden_field_data_ppo_tglmulaiplan" style="<?php echo $sStyleHidden_ppo_tglmulaiplan; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ppo_tglmulaiplan_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ppo_targethari_label" id="hidden_field_label_ppo_targethari" style="<?php echo $sStyleHidden_ppo_targethari; ?>"><span id="id_label_ppo_targethari"><?php echo $this->nm_new_label['ppo_targethari']; ?></span></TD>
    <TD class="scFormDataOdd css_ppo_targethari_line" id="hidden_field_data_ppo_targethari" style="<?php echo $sStyleHidden_ppo_targethari; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ppo_targethari_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ppo_targetselesai_label" id="hidden_field_label_ppo_targetselesai" style="<?php echo $sStyleHidden_ppo_targetselesai; ?>"><span id="id_label_ppo_targetselesai"><?php echo $this->nm_new_label['ppo_targetselesai']; ?></span></TD>
    <TD class="scFormDataOdd css_ppo_targetselesai_line" id="hidden_field_data_ppo_targetselesai" style="<?php echo $sStyleHidden_ppo_targetselesai; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ppo_targetselesai_line" style="vertical-align: top;padding: 0px">
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
?>
    ...
    tb_show('', '<?php echo $this->Ini->path_link . SC_dir_app_name('project_edit_update_main_updatetask_detail'); ?>/project_edit_update_main_updatetask_detail.php?nm_cal_display=Y&field=' + sField + '&value=' + sValue + '&sVert=' + cVert + '&inter=' + iInter + '&week_ini=' + sWeekIni + '&format=' + aFormat[sField] + '&time_format=' + sTimeFormat + '&script_case_init=<?php  echo $this->form_encode_input($this->Ini->sc_page); ?>&script_case_session=<?php echo session_id(); ?>&TB_iframe=true&height=150&width=220&modal=true', '');
}
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("project_edit_update_main_updatetask_detail");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("project_edit_update_main_updatetask_detail");
 parent.scAjaxDetailHeight("project_edit_update_main_updatetask_detail", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
