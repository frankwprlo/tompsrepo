<?php
//
class project_edit_update_main_updatetask_detail_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_updatetask_detail']['nm_run_menu'] = 1;
      } 
      if (isset($_SESSION['sc_session'][$script_case_init]['project_edit_update_main_updatetask_detail']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_updatetask_detail']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_updatetask_detail']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['project_edit_update_main_updatetask_detail']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_updatetask_detail']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_updatetask_detail']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->usr_login)) 
          {
              $_SESSION['usr_login'] = $this->usr_login;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['project_edit_update_main_updatetask_detail']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_updatetask_detail']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_updatetask_detail']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_updatetask_detail']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['project_edit_update_main_updatetask_detail']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_updatetask_detail']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_updatetask_detail']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_updatetask_detail']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new project_edit_update_main_updatetask_detail_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("en_us");
      } 
      $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_updatetask_detail']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['project_edit_update_main_updatetask_detail']['upload_field_info']['ppo_evident_one'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'project_edit_update_main_updatetask_detail',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['project_edit_update_main_updatetask_detail']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['project_edit_update_main_updatetask_detail'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['project_edit_update_main_updatetask_detail']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['project_edit_update_main_updatetask_detail']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('project_edit_update_main_updatetask_detail') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['project_edit_update_main_updatetask_detail']['label'] = "Update Progress Tahapan Project";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "project_edit_update_main_updatetask_detail")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['project_edit_update_main_updatetask_detail']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['project_edit_update_main_updatetask_detail'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['upload_field_ul_name'][$this->ppo_evident_one_ul_name]))
          {
              $this->NM_ajax_info['param']['ppo_evident_one_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['upload_field_ul_name'][$this->ppo_evident_one_ul_name];
          }
      ...
      elseif (isset($this->ppo_evident_one_ul_name) && '' != $this->ppo_evident_one_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['upload_field_ul_name'][$this->ppo_evident_one_ul_name]))
          {
              $this->ppo_evident_one_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['upload_field_ul_name'][$this->ppo_evident_one_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_updatetask_detail']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_updatetask_detail']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_updatetask_detail']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_updatetask_detail']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_updatetask_detail']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_updatetask_detail']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_orig'] = " where PPO_PROJECTID=" . $_SESSION['var_projectid'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_pesq'] = " where PPO_PROJECTID=" . $_SESSION['var_projectid'] . "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_updatetask_detail']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_updatetask_detail']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_updatetask_detail']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['project_edit_update_main_updatetask_detail']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['project_edit_update_main_updatetask_detail'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['project_edit_update_main_updatetask_detail'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_updatetask_detail']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_updatetask_detail']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_updatetask_detail']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_updatetask_detail']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_updatetask_detail']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_updatetask_detail']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_updatetask_detail']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_updatetask_detail']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_updatetask_detail']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'project_edit_update_main_updatetask_detail/project_edit_update_main_updatetask_detail_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'project_edit_update_main_updatetask_detail_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'project_edit_update_main_updatetask_detail_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'project_edit_update_main_updatetask_detail_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'project_edit_update_main_updatetask_detail/project_edit_update_main_updatetask_detail_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "project_edit_update_main_updatetask_detail_erro.class.php"); 
      }
      $this->Erro      = new project_edit_update_main_updatetask_detail_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['opcao']))
         { 
             if ($this->ppo_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_updatetask_detail']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_updatetask_detail']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['project_edit_update_main_updatetask_detail']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['recarga'] = $this->nmgp_opcao;
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_project_edit_update_main_updatetask_detail']) || !is_array($this->NM_ajax_info['errList']['geral_project_edit_update_main_updatetask_detail']))
              {
                  $this->NM_ajax_info['errList']['geral_project_edit_update_main_updatetask_detail'] = array();
              }
              $this->NM_ajax_info['errList']['geral_project_edit_update_main_updatetask_detail'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_ppo_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['php_cmp_required']['ppo_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['php_cmp_required']['ppo_id'] == "on")) 
      { 
          if ($this->ppo_id == "")  
          { 
...
;
    ...
    {
        global $teste_validade;
      if ($this->ppo_status == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['php_cmp_required']['ppo_status']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['php_cmp_required']['ppo_status'] == "on"))
      {
          ...
          if (!empty($this->ppo_status) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['Lookup_ppo_status']) && !in_array($this->ppo_status, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['Lookup_ppo_status']))
          {
    ...
    function ValidateField_ppo_evident_one(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            {
                include_once 'project_edit_update_main_updatetask_detail_doc_name.php';
            }
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['php_cmp_required']['ppo_note']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['php_cmp_required']['ppo_note'] == "on")) 
      { 
          if ($this->ppo_note == "")  
          { 
    ...
    function ValidateField_ppo_projectid(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->ppo_projectid, 5, 0, 0, 0, "N") == false)  
              { 
    ...
    function ValidateField_ppo_idtasktahapan(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->ppo_idtasktahapan, 22, 0, 0, 0, "N") == false)  
              { 
    ...
    function ValidateField_ppo_targethari(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->ppo_targethari, 22, 0, 0, 0, "N") == false)  
              { 
...
//--------------------------------------------------------------------------------------
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['ppo_id']['keyVal'] = project_edit_update_main_updatetask_detail_pack_protect_string($this->nmgp_dados_form['ppo_id']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['Lookup_ppo_status']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['Lookup_ppo_status'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['Lookup_ppo_status']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['Lookup_ppo_status'] = array(); 
}
$aLookup[] = array(project_edit_update_main_updatetask_detail_pack_protect_string('') => project_edit_update_main_updatetask_detail_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['Lookup_ppo_status'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(project_edit_update_main_updatetask_detail_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => project_edit_update_main_updatetask_detail_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['Lookup_ppo_status'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['ppo_status']['valList'][$i] = project_edit_update_main_updatetask_detail_pack_protect_string($v);
          }
   ...
   function ajax_return_values_ppo_targetselesai($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_ex_update = true; 
          $SC_ex_upd_or = true; 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          $this->ppo_status = $this->ppo_status_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['total']);
              }
              ...
              fclose($arq_ppo_evident_one) ;  
              $this->sc_evento = "insert"; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['reg_start'] = 0; 
              }
    ...
    if ("update" == $this->sc_evento && $this->nmgp_opcao != "nada") {
        $_SESSION['scriptcase']['project_edit_update_main_updatetask_detail']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['project_edit_update_main_updatetask_detail']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['parms'] = "ppo_id?#?$this->ppo_id?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      ...
      { 
          ...
          $qt_geral_reg_project_edit_update_main_updatetask_detail = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['total'] = $qt_geral_reg_project_edit_update_main_updatetask_detail;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->ppo_id))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_project_edit_update_main_updatetask_detail = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['reg_start'] > $qt_geral_reg_project_edit_update_main_updatetask_detail)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['reg_start'] = $qt_geral_reg_project_edit_update_main_updatetask_detail; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_project_edit_update_main_updatetask_detail) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['reg_start'] = 0;
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['empty_filter'] = true;
                  return; 
              }
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['parms'] = "ppo_id?#?$this->ppo_id?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['sub_dir'][0]  = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['reg_start'] < $qt_geral_reg_project_edit_update_main_updatetask_detail;
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['reg_start'] + 1;
...
$error_message = 'tidak bisa merubah ke inprogress , masih ada task yg berstatus inprogress.'; 
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_project_edit_update_main_updatetask_detail' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['download_filenames'][$sTmpFile_ppo_evident_one] = $this->ppo_evident_one;
        ...
        $this->initFormPages();
    include_once("project_edit_update_main_updatetask_detail_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_filter_form'] . " and (PPO_PROJECTID=" . $_SESSION['var_projectid'] . ") and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_project_edit_update_main_updatetask_detail = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['total'] = $qt_geral_reg_project_edit_update_main_updatetask_detail;
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          project_edit_update_main_updatetask_detail_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "project_edit_update_main_updatetask_detail_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['nm_run_menu'] = 2;
       $nmgp_saida_form = "project_edit_update_main_updatetask_detail_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_updatetask_detail']['masterValue'] as $cmp_master => $val_master)
        {
?>
