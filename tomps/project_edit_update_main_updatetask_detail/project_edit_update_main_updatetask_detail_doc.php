<?php
   ...
   if ($nm_cod_doc == "documento_db")
   {
       ...
       $trab_doc = $root . $_SESSION['scriptcase']['project_edit_update_main_updatetask_detail']['glo_nm_path_imag_temp'] . "/" . $index_file;
   }
   else
   {
       $index_file = $nm_nome_doc;
   ...
   { 
       ...
       elseif ($accessError)
       {
           $Nm_lang[$errorIndex] = "Invalid access to file";
       }
       else
       {
           $Nm_lang[$errorIndex] = "The file does not exist";
       }
