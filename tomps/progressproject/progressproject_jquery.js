...
function ajax_navigate(opc, parm)
{
    ...
    $.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_progressproject').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_progressproject').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_progressproject').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_progressproject').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_progressproject').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_progressproject').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_progressproject').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_progressproject').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_progressproject').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_progressproject').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_progressproject').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_progressproject').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
