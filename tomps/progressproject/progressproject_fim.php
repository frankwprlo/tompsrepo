...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["projectamo_____progressproject"]))
   {
      unset($_SESSION['session_sec_aplicacao']["projectamo_____progressproject"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['progressproject']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['progressproject']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['progressproject']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['progressproject']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['progressproject']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['progressproject']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['progressproject']['embutida_filho'] as $ind => $sc_init)
          {
