...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="tracking_project_viewdetail"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['where_detal']))
  {
?>  
...
function lookup_tp_status(campo)
{
   dados  = document.F1.tp_status.value;
   jsrsExecute("<?php  echo $this->Ini->path_link . SC_dir_app_name('tracking_project_viewdetail')?>/tracking_project_viewdetail.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&script_case_session=<?php echo session_id() ?>&nmgp_opcao=lookup", recebe_tp_status, "tp_status", dados, false);
}
function recebe_tp_status(string)
{
   document.getElementById('id_lookup_tp_status').innerHTML = string;
}
<?php 
