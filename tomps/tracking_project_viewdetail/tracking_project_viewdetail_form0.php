...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("tracking_project_viewdetail_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('tracking_project_viewdetail_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['recarga'];
}
     if ('' != $this->tp_status)
     {
...
<?php
 include_once("tracking_project_viewdetail_js0.php");
?>
<script type="text/javascript" src="<?php  echo $this->Ini->path_js . "/nm_rpc.js" ?>"> 
</script> 
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['tracking_project_viewdetail'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['tracking_project_viewdetail'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['dashboard_info']['maximized']))
  {
?>
<tr><td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<ul class="scTabLine">
<li id="id_tabs_0_0" class="scTabActive"><a href="javascript: sc_control_tabs_0(0)">Data Project</a></li>
<li id="id_tabs_0_1" class="scTabInactive"><a href="javascript: sc_control_tabs_0(1)">Others</a></li>
<li id="id_tabs_0_2" class="scTabInactive"><a href="javascript: sc_control_tabs_0(2)">Others Field Info</a></li>
<li id="id_tabs_0_3" class="scTabInactive"><a href="javascript: sc_control_tabs_0(3)">Progress Info</a></li>
</ul>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_id_label" id="hidden_field_label_tp_id" style="<?php echo $sStyleHidden_tp_id; ?>"><span id="id_label_tp_id"><?php echo $this->nm_new_label['tp_id']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_id_line" id="hidden_field_data_tp_id" style="<?php echo $sStyleHidden_tp_id; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_id_line" style="vertical-align: top;padding: 0px">
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { 
 ?>
<span id="id_read_on_tp_id" css_tp_id_line" style="<?php echo $sStyleReadLab_tp_id; ?>"><?php echo $this->form_encode_input($this->tp_id); ?></span><span id="id_read_off_tp_id" style="<?php echo $sStyleReadInp_tp_id; ?>"><input type="hidden" name="tp_id" value="<?php echo $this->form_encode_input($tp_id) . "\">"?><span id="id_ajax_label_tp_id"><?php echo nl2br($tp_id); ?></span>
</span><?php } else { ?>
&nbsp;
<?php } ?>
</span></td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_tp_id_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_tp_id_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_thn_release_label" id="hidden_field_label_tp_thn_release" style="<?php echo $sStyleHidden_tp_thn_release; ?>"><span id="id_label_tp_thn_release"><?php echo $this->nm_new_label['tp_thn_release']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_thn_release_line" id="hidden_field_data_tp_thn_release" style="<?php echo $sStyleHidden_tp_thn_release; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_thn_release_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_prjtrelease_label" id="hidden_field_label_tp_prjtrelease" style="<?php echo $sStyleHidden_tp_prjtrelease; ?>"><span id="id_label_tp_prjtrelease"><?php echo $this->nm_new_label['tp_prjtrelease']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_prjtrelease']) || $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_prjtrelease'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_tp_prjtrelease_line" id="hidden_field_data_tp_prjtrelease" style="<?php echo $sStyleHidden_tp_prjtrelease; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_prjtrelease_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_batch_label" id="hidden_field_label_tp_batch" style="<?php echo $sStyleHidden_tp_batch; ?>"><span id="id_label_tp_batch"><?php echo $this->nm_new_label['tp_batch']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_batch_line" id="hidden_field_data_tp_batch" style="<?php echo $sStyleHidden_tp_batch; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_batch_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_divre_label" id="hidden_field_label_tp_divre" style="<?php echo $sStyleHidden_tp_divre; ?>"><span id="id_label_tp_divre"><?php echo $this->nm_new_label['tp_divre']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_divre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_divre'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_tp_divre_line" id="hidden_field_data_tp_divre" style="<?php echo $sStyleHidden_tp_divre; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_divre_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_witel_label" id="hidden_field_label_tp_witel" style="<?php echo $sStyleHidden_tp_witel; ?>"><span id="id_label_tp_witel"><?php echo $this->nm_new_label['tp_witel']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_witel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_witel'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_tp_witel_line" id="hidden_field_data_tp_witel" style="<?php echo $sStyleHidden_tp_witel; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_witel_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_datel_label" id="hidden_field_label_tp_datel" style="<?php echo $sStyleHidden_tp_datel; ?>"><span id="id_label_tp_datel"><?php echo $this->nm_new_label['tp_datel']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_datel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_datel'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_tp_datel_line" id="hidden_field_data_tp_datel" style="<?php echo $sStyleHidden_tp_datel; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_datel_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_sto_label" id="hidden_field_label_tp_sto" style="<?php echo $sStyleHidden_tp_sto; ?>"><span id="id_label_tp_sto"><?php echo $this->nm_new_label['tp_sto']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_sto']) || $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_sto'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_tp_sto_line" id="hidden_field_data_tp_sto" style="<?php echo $sStyleHidden_tp_sto; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_sto_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_idlop_label" id="hidden_field_label_tp_idlop" style="<?php echo $sStyleHidden_tp_idlop; ?>"><span id="id_label_tp_idlop"><?php echo $this->nm_new_label['tp_idlop']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_idlop_line" id="hidden_field_data_tp_idlop" style="<?php echo $sStyleHidden_tp_idlop; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_idlop_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_namalop_label" id="hidden_field_label_tp_namalop" style="<?php echo $sStyleHidden_tp_namalop; ?>"><span id="id_label_tp_namalop"><?php echo $this->nm_new_label['tp_namalop']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_namalop_line" id="hidden_field_data_tp_namalop" style="<?php echo $sStyleHidden_tp_namalop; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_namalop_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_mitra_label" id="hidden_field_label_tp_mitra" style="<?php echo $sStyleHidden_tp_mitra; ?>"><span id="id_label_tp_mitra"><?php echo $this->nm_new_label['tp_mitra']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_mitra']) || $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_mitra'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_tp_mitra_line" id="hidden_field_data_tp_mitra" style="<?php echo $sStyleHidden_tp_mitra; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_mitra_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_templateproject_label" id="hidden_field_label_tp_templateproject" style="<?php echo $sStyleHidden_tp_templateproject; ?>"><span id="id_label_tp_templateproject"><?php echo $this->nm_new_label['tp_templateproject']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_templateproject']) || $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_templateproject'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_tp_templateproject_line" id="hidden_field_data_tp_templateproject" style="<?php echo $sStyleHidden_tp_templateproject; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_templateproject_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_targetwaktu_label" id="hidden_field_label_tp_targetwaktu" style="<?php echo $sStyleHidden_tp_targetwaktu; ?>"><span id="id_label_tp_targetwaktu"><?php echo $this->nm_new_label['tp_targetwaktu']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_targetwaktu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_targetwaktu'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_tp_targetwaktu_line" id="hidden_field_data_tp_targetwaktu" style="<?php echo $sStyleHidden_tp_targetwaktu; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_targetwaktu_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_jenisproject_label" id="hidden_field_label_tp_jenisproject" style="<?php echo $sStyleHidden_tp_jenisproject; ?>"><span id="id_label_tp_jenisproject"><?php echo $this->nm_new_label['tp_jenisproject']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_jenisproject']) || $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_jenisproject'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_tp_jenisproject_line" id="hidden_field_data_tp_jenisproject" style="<?php echo $sStyleHidden_tp_jenisproject; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_jenisproject_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_projectname_label" id="hidden_field_label_tp_projectname" style="<?php echo $sStyleHidden_tp_projectname; ?>"><span id="id_label_tp_projectname"><?php echo $this->nm_new_label['tp_projectname']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_projectname']) || $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_projectname'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_tp_projectname_line" id="hidden_field_data_tp_projectname" style="<?php echo $sStyleHidden_tp_projectname; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_projectname_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_status_label" id="hidden_field_label_tp_status" style="<?php echo $sStyleHidden_tp_status; ?>"><span id="id_label_tp_status"><?php echo $this->nm_new_label['tp_status']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_status_line" id="hidden_field_data_tp_status" style="<?php echo $sStyleHidden_tp_status; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_status_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_prosentase_label" id="hidden_field_label_tp_prosentase" style="<?php echo $sStyleHidden_tp_prosentase; ?>"><span id="id_label_tp_prosentase"><?php echo $this->nm_new_label['tp_prosentase']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_prosentase_line" id="hidden_field_data_tp_prosentase" style="<?php echo $sStyleHidden_tp_prosentase; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_prosentase_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_planstart_label" id="hidden_field_label_tp_planstart" style="<?php echo $sStyleHidden_tp_planstart; ?>"><span id="id_label_tp_planstart"><?php echo $this->nm_new_label['tp_planstart']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_planstart']) || $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_planstart'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_tp_planstart_line" id="hidden_field_data_tp_planstart" style="<?php echo $sStyleHidden_tp_planstart; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_planstart_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_planfinish_label" id="hidden_field_label_tp_planfinish" style="<?php echo $sStyleHidden_tp_planfinish; ?>"><span id="id_label_tp_planfinish"><?php echo $this->nm_new_label['tp_planfinish']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_planfinish']) || $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['php_cmp_required']['tp_planfinish'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_tp_planfinish_line" id="hidden_field_data_tp_planfinish" style="<?php echo $sStyleHidden_tp_planfinish; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_planfinish_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_lokasi_label" id="hidden_field_label_tp_lokasi" style="<?php echo $sStyleHidden_tp_lokasi; ?>"><span id="id_label_tp_lokasi"><?php echo $this->nm_new_label['tp_lokasi']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_lokasi_line" id="hidden_field_data_tp_lokasi" style="<?php echo $sStyleHidden_tp_lokasi; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_lokasi_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_nokontrak_label" id="hidden_field_label_tp_nokontrak" style="<?php echo $sStyleHidden_tp_nokontrak; ?>"><span id="id_label_tp_nokontrak"><?php echo $this->nm_new_label['tp_nokontrak']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_nokontrak_line" id="hidden_field_data_tp_nokontrak" style="<?php echo $sStyleHidden_tp_nokontrak; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_nokontrak_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_ponumber_label" id="hidden_field_label_tp_ponumber" style="<?php echo $sStyleHidden_tp_ponumber; ?>"><span id="id_label_tp_ponumber"><?php echo $this->nm_new_label['tp_ponumber']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_ponumber_line" id="hidden_field_data_tp_ponumber" style="<?php echo $sStyleHidden_tp_ponumber; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_ponumber_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_nilai_label" id="hidden_field_label_tp_nilai" style="<?php echo $sStyleHidden_tp_nilai; ?>"><span id="id_label_tp_nilai"><?php echo $this->nm_new_label['tp_nilai']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_nilai_line" id="hidden_field_data_tp_nilai" style="<?php echo $sStyleHidden_tp_nilai; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_nilai_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_summary_label" id="hidden_field_label_tp_summary" style="<?php echo $sStyleHidden_tp_summary; ?>"><span id="id_label_tp_summary"><?php echo $this->nm_new_label['tp_summary']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_summary_line" id="hidden_field_data_tp_summary" style="<?php echo $sStyleHidden_tp_summary; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_summary_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_rab_label" id="hidden_field_label_tp_rab" style="<?php echo $sStyleHidden_tp_rab; ?>"><span id="id_label_tp_rab"><?php echo $this->nm_new_label['tp_rab']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_rab_line" id="hidden_field_data_tp_rab" style="<?php echo $sStyleHidden_tp_rab; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_rab_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_jmldistribusi_label" id="hidden_field_label_tp_jmldistribusi" style="<?php echo $sStyleHidden_tp_jmldistribusi; ?>"><span id="id_label_tp_jmldistribusi"><?php echo $this->nm_new_label['tp_jmldistribusi']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_jmldistribusi_line" id="hidden_field_data_tp_jmldistribusi" style="<?php echo $sStyleHidden_tp_jmldistribusi; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_jmldistribusi_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_odp_label" id="hidden_field_label_tp_odp" style="<?php echo $sStyleHidden_tp_odp; ?>"><span id="id_label_tp_odp"><?php echo $this->nm_new_label['tp_odp']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_odp_line" id="hidden_field_data_tp_odp" style="<?php echo $sStyleHidden_tp_odp; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_odp_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_jmlport_label" id="hidden_field_label_tp_jmlport" style="<?php echo $sStyleHidden_tp_jmlport; ?>"><span id="id_label_tp_jmlport"><?php echo $this->nm_new_label['tp_jmlport']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_jmlport_line" id="hidden_field_data_tp_jmlport" style="<?php echo $sStyleHidden_tp_jmlport; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_jmlport_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_actualstart_label" id="hidden_field_label_tp_actualstart" style="<?php echo $sStyleHidden_tp_actualstart; ?>"><span id="id_label_tp_actualstart"><?php echo $this->nm_new_label['tp_actualstart']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_actualstart_line" id="hidden_field_data_tp_actualstart" style="<?php echo $sStyleHidden_tp_actualstart; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_actualstart_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_actualfinish_label" id="hidden_field_label_tp_actualfinish" style="<?php echo $sStyleHidden_tp_actualfinish; ?>"><span id="id_label_tp_actualfinish"><?php echo $this->nm_new_label['tp_actualfinish']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_actualfinish_line" id="hidden_field_data_tp_actualfinish" style="<?php echo $sStyleHidden_tp_actualfinish; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_actualfinish_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_entrydate_label" id="hidden_field_label_tp_entrydate" style="<?php echo $sStyleHidden_tp_entrydate; ?>"><span id="id_label_tp_entrydate"><?php echo $this->nm_new_label['tp_entrydate']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_entrydate_line" id="hidden_field_data_tp_entrydate" style="<?php echo $sStyleHidden_tp_entrydate; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_entrydate_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_entryby_label" id="hidden_field_label_tp_entryby" style="<?php echo $sStyleHidden_tp_entryby; ?>"><span id="id_label_tp_entryby"><?php echo $this->nm_new_label['tp_entryby']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_entryby_line" id="hidden_field_data_tp_entryby" style="<?php echo $sStyleHidden_tp_entryby; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_entryby_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_updatedate_label" id="hidden_field_label_tp_updatedate" style="<?php echo $sStyleHidden_tp_updatedate; ?>"><span id="id_label_tp_updatedate"><?php echo $this->nm_new_label['tp_updatedate']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_updatedate_line" id="hidden_field_data_tp_updatedate" style="<?php echo $sStyleHidden_tp_updatedate; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_updatedate_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_updateby_label" id="hidden_field_label_tp_updateby" style="<?php echo $sStyleHidden_tp_updateby; ?>"><span id="id_label_tp_updateby"><?php echo $this->nm_new_label['tp_updateby']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_updateby_line" id="hidden_field_data_tp_updateby" style="<?php echo $sStyleHidden_tp_updateby; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_updateby_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_taskaktif_label" id="hidden_field_label_tp_taskaktif" style="<?php echo $sStyleHidden_tp_taskaktif; ?>"><span id="id_label_tp_taskaktif"><?php echo $this->nm_new_label['tp_taskaktif']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_taskaktif_line" id="hidden_field_data_tp_taskaktif" style="<?php echo $sStyleHidden_tp_taskaktif; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_taskaktif_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_taskaktif_number_label" id="hidden_field_label_tp_taskaktif_number" style="<?php echo $sStyleHidden_tp_taskaktif_number; ?>"><span id="id_label_tp_taskaktif_number"><?php echo $this->nm_new_label['tp_taskaktif_number']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_taskaktif_number_line" id="hidden_field_data_tp_taskaktif_number" style="<?php echo $sStyleHidden_tp_taskaktif_number; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_taskaktif_number_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_tahapanaktif_label" id="hidden_field_label_tp_tahapanaktif" style="<?php echo $sStyleHidden_tp_tahapanaktif; ?>"><span id="id_label_tp_tahapanaktif"><?php echo $this->nm_new_label['tp_tahapanaktif']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_tahapanaktif_line" id="hidden_field_data_tp_tahapanaktif" style="<?php echo $sStyleHidden_tp_tahapanaktif; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_tahapanaktif_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_taskaktifstatus_label" id="hidden_field_label_tp_taskaktifstatus" style="<?php echo $sStyleHidden_tp_taskaktifstatus; ?>"><span id="id_label_tp_taskaktifstatus"><?php echo $this->nm_new_label['tp_taskaktifstatus']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_taskaktifstatus_line" id="hidden_field_data_tp_taskaktifstatus" style="<?php echo $sStyleHidden_tp_taskaktifstatus; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_taskaktifstatus_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_taskaktifplanstart_label" id="hidden_field_label_tp_taskaktifplanstart" style="<?php echo $sStyleHidden_tp_taskaktifplanstart; ?>"><span id="id_label_tp_taskaktifplanstart"><?php echo $this->nm_new_label['tp_taskaktifplanstart']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_taskaktifplanfinish_label" id="hidden_field_label_tp_taskaktifplanfinish" style="<?php echo $sStyleHidden_tp_taskaktifplanfinish; ?>"><span id="id_label_tp_taskaktifplanfinish"><?php echo $this->nm_new_label['tp_taskaktifplanfinish']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_is_change_template_label" id="hidden_field_label_tp_is_change_template" style="<?php echo $sStyleHidden_tp_is_change_template; ?>"><span id="id_label_tp_is_change_template"><?php echo $this->nm_new_label['tp_is_change_template']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_ischangetempby_label" id="hidden_field_label_tp_ischangetempby" style="<?php echo $sStyleHidden_tp_ischangetempby; ?>"><span id="id_label_tp_ischangetempby"><?php echo $this->nm_new_label['tp_ischangetempby']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_ischangetempby_line" id="hidden_field_data_tp_ischangetempby" style="<?php echo $sStyleHidden_tp_ischangetempby; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_ischangetempby_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tp_ischangetempdate_label" id="hidden_field_label_tp_ischangetempdate" style="<?php echo $sStyleHidden_tp_ischangetempdate; ?>"><span id="id_label_tp_ischangetempdate"><?php echo $this->nm_new_label['tp_ischangetempdate']; ?></span></TD>
    <TD class="scFormDataOdd css_tp_ischangetempdate_line" id="hidden_field_data_tp_ischangetempdate" style="<?php echo $sStyleHidden_tp_ischangetempdate; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tp_ischangetempdate_line" style="vertical-align: top;padding: 0px">
...
<?php
  ...
  $nm_sc_blocos_aba    = array(0 => 0,1 => 0,2 => 0,3 => 0);
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['tracking_project_viewdetail']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("tracking_project_viewdetail");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("tracking_project_viewdetail");
 parent.scAjaxDetailHeight("tracking_project_viewdetail", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
