...
$old_error_handler = set_error_handler("tracking_project_viewdetail_scriptcase_error_handler");

function tracking_project_viewdetail_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['tracking_project_viewdetail']['contr_erro']) && $_SESSION['scriptcase']['tracking_project_viewdetail']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_tracking_project_viewdetail->contr_tracking_project_viewdetail->Apl_com_erro = true;
            if ($inicial_tracking_project_viewdetail->contr_tracking_project_viewdetail->NM_ajax_flag)
            {
                $inicial_tracking_project_viewdetail->contr_tracking_project_viewdetail->NM_ajax_info['errList']['geral_tracking_project_viewdetail'][] = $msg;
                return;
            }
            tracking_project_viewdetail_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function tracking_project_viewdetail_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['tracking_project_viewdetail'])  && '' != $_SESSION['scriptcase']['error_icon']['tracking_project_viewdetail'])  ? $_SESSION['scriptcase']['error_icon']['tracking_project_viewdetail']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['tracking_project_viewdetail']) && '' != $_SESSION['scriptcase']['error_close']['tracking_project_viewdetail']) ? $_SESSION['scriptcase']['error_close']['tracking_project_viewdetail'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['tracking_project_viewdetail']) && '' != $_SESSION['scriptcase']['error_span_title']['tracking_project_viewdetail']) ? $_SESSION['scriptcase']['error_span_title']['tracking_project_viewdetail'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['tracking_project_viewdetail']) && '' != $_SESSION['scriptcase']['error_icon_title']['tracking_project_viewdetail']) ? $_SESSION['scriptcase']['error_icon_title']['tracking_project_viewdetail'] : '';
?>
