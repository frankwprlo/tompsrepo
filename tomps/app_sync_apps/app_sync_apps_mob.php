...
//
   ...
   $_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_perfil']          = "conn_mysql_1";
   $_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_path_prod']       = "/libdemo/prod";
   $_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_path_imagens']    = "/libdemo/file/img";
   $_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_path_imag_temp']  = "/libdemo/tmp";
   $_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_path_doc']        = "/var/www/html/tompsdemo";
//
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'projectamo'); 
      } 
      else 
      { 
