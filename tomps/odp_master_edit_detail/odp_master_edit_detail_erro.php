...
$old_error_handler = set_error_handler("odp_master_edit_detail_scriptcase_error_handler");

function odp_master_edit_detail_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['odp_master_edit_detail']['contr_erro']) && $_SESSION['scriptcase']['odp_master_edit_detail']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_odp_master_edit_detail->contr_odp_master_edit_detail->Apl_com_erro = true;
            if ($inicial_odp_master_edit_detail->contr_odp_master_edit_detail->NM_ajax_flag)
            {
                $inicial_odp_master_edit_detail->contr_odp_master_edit_detail->NM_ajax_info['errList']['geral_odp_master_edit_detail'][] = $msg;
                return;
            }
            odp_master_edit_detail_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function odp_master_edit_detail_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['odp_master_edit_detail'])  && '' != $_SESSION['scriptcase']['error_icon']['odp_master_edit_detail'])  ? $_SESSION['scriptcase']['error_icon']['odp_master_edit_detail']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['odp_master_edit_detail']) && '' != $_SESSION['scriptcase']['error_close']['odp_master_edit_detail']) ? $_SESSION['scriptcase']['error_close']['odp_master_edit_detail'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['odp_master_edit_detail']) && '' != $_SESSION['scriptcase']['error_span_title']['odp_master_edit_detail']) ? $_SESSION['scriptcase']['error_span_title']['odp_master_edit_detail'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['odp_master_edit_detail']) && '' != $_SESSION['scriptcase']['error_icon_title']['odp_master_edit_detail']) ? $_SESSION['scriptcase']['error_icon_title']['odp_master_edit_detail'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['odp_master_edit_detail']['error_buffer'] .= ob_get_flush();
}
