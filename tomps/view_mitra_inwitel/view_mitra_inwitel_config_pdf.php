 ...
 */
    ...
    session_start();
    $SC_apl_proc = "view_mitra_inwitel";
...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['view_mitra_inwitel']['show_skip_charts_option']) || !$_SESSION['sc_session']['view_mitra_inwitel']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
