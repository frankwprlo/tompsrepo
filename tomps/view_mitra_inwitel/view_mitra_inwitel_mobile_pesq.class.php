...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "TM_ENTRYDATE";$Nm_datas[] = "TM_UPDATEDATE";$Nm_numeric[] = "tm_idmitra";$Nm_numeric[] = "tm_divre";$Nm_numeric[] = "tm_witel";
...
?>
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_tm_divre"  <?php echo $str_hide_tm_divre?>>
<?php
...
?>
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_tm_witel"  <?php echo $str_hide_tm_witel?>>
<?php
      $tm_witel_look = substr($this->Db->qstr($tm_witel), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT MW_IDWITEL, MW_NAMAWITEL  FROM TBL_MAS_WITEL WHERE MW_IDDIVRE=" . $_SESSION['TM_DIVRE'] . " ORDER BY MW_NAMAWITEL"; 
...
?>
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_tm_namamitra"  <?php echo $str_hide_tm_namamitra?>><?php
      if ($tm_namamitra != "")
      {
      $tm_namamitra_look = substr($this->Db->qstr($tm_namamitra), 1, -1); 
      $nmgp_def_dados = array(); 
