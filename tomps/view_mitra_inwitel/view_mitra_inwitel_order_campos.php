<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new view_mitra_inwitel_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class view_mitra_inwitel_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['tm_idmitra'] = "on";
   $tab_def_campos['tm_idmitra'] = "TM_IDMITRA";
   $tab_converte["TM_IDMITRA"]   = "tm_idmitra";
   $tab_labels["tm_idmitra"]   = (isset($_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['labels']["tm_idmitra"])) ? $_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['labels']["tm_idmitra"] : "TM IDMITRA";
   $tab_ger_campos['tm_namamitra'] = "on";
   $tab_def_campos['tm_namamitra'] = "TM_NAMAMITRA";
   $tab_converte["TM_NAMAMITRA"]   = "tm_namamitra";
   $tab_labels["tm_namamitra"]   = (isset($_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['labels']["tm_namamitra"])) ? $_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['labels']["tm_namamitra"] : "TM NAMAMITRA";
   $tab_ger_campos['tm_divre'] = "on";
   $tab_def_campos['tm_divre'] = "TM_DIVRE";
   $tab_converte["TM_DIVRE"]   = "tm_divre";
   $tab_labels["tm_divre"]   = (isset($_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['labels']["tm_divre"])) ? $_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['labels']["tm_divre"] : "TM DIVRE";
   $tab_ger_campos['tm_witel'] = "on";
   $tab_def_campos['tm_witel'] = "TM_WITEL";
   $tab_converte["TM_WITEL"]   = "tm_witel";
   $tab_labels["tm_witel"]   = (isset($_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['labels']["tm_witel"])) ? $_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['labels']["tm_witel"] : "TM WITEL";
   $tab_ger_campos['mw_kodewitel'] = "on";
   $tab_def_campos['mw_kodewitel'] = "MW_KODEWITEL";
   $tab_converte["MW_KODEWITEL"]   = "mw_kodewitel";
   $tab_labels["mw_kodewitel"]   = (isset($_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['labels']["mw_kodewitel"])) ? $_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['labels']["mw_kodewitel"] : "MW KODEWITEL";
   $tab_ger_campos['mw_namawitel'] = "on";
   $tab_def_campos['mw_namawitel'] = "MW_NAMAWITEL";
   $tab_converte["MW_NAMAWITEL"]   = "mw_namawitel";
   $tab_labels["mw_namawitel"]   = (isset($_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['labels']["mw_namawitel"])) ? $_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['labels']["mw_namawitel"] : "MW NAMAWITEL";
   $tab_ger_campos['md_kodedivre'] = "on";
   $tab_def_campos['md_kodedivre'] = "MD_KODEDIVRE";
   $tab_converte["MD_KODEDIVRE"]   = "md_kodedivre";
   $tab_labels["md_kodedivre"]   = (isset($_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['labels']["md_kodedivre"])) ? $_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['labels']["md_kodedivre"] : "MD KODEDIVRE";
   $tab_ger_campos['md_namadivre'] = "on";
   $tab_def_campos['md_namadivre'] = "MD_NAMADIVRE";
   $tab_converte["MD_NAMADIVRE"]   = "md_namadivre";
   $tab_labels["md_namadivre"]   = (isset($_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['labels']["md_namadivre"])) ? $_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['labels']["md_namadivre"] : "MD NAMADIVRE";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "view_mitra_inwitel_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['view_mitra_inwitel']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
