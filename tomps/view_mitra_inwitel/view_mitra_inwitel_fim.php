...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["projectamo_____view_mitra_inwitel"]))
   {
      unset($_SESSION['session_sec_aplicacao']["projectamo_____view_mitra_inwitel"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['view_mitra_inwitel']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['view_mitra_inwitel']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['view_mitra_inwitel']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['view_mitra_inwitel']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['view_mitra_inwitel']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>view_mitra_inwitel</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['view_mitra_inwitel']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['view_mitra_inwitel']['embutida_filho'] as $ind => $sc_init)
          {
