...
function ajax_navigate(opc, parm)
{
    ...
    $.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_tracking_project').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_tracking_project').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_tracking_project').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_tracking_project').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_tracking_project').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_tracking_project').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_tracking_project').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_tracking_project').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_tracking_project').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_tracking_project').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_tracking_project').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_tracking_project').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
