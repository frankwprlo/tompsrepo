...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate pswd
  function do_ajax_app_form_edit_users_validate_pswd()
  {
    var nomeCampo_pswd = "pswd";
    var var_pswd = scAjaxGetFieldText(nomeCampo_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_validate_pswd(var_pswd, var_script_case_init, do_ajax_app_form_edit_users_validate_pswd_cb);
  } // do_ajax_app_form_edit_users_validate_pswd

  function do_ajax_app_form_edit_users_validate_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pswd";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_validate_pswd_cb
  ...
  // ---------- Validate active
  function do_ajax_app_form_edit_users_validate_active()
  {
    var nomeCampo_active = "active";
    var var_active = scAjaxGetFieldRadio(nomeCampo_active);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_validate_active(var_active, var_script_case_init, do_ajax_app_form_edit_users_validate_active_cb);
  } // do_ajax_app_form_edit_users_validate_active

  function do_ajax_app_form_edit_users_validate_active_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "active";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_validate_active_cb

  // ---------- Validate priv_mitra
  function do_ajax_app_form_edit_users_validate_priv_mitra()
  {
    var nomeCampo_priv_mitra = "priv_mitra";
    var var_priv_mitra = scAjaxGetFieldRadio(nomeCampo_priv_mitra);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_validate_priv_mitra(var_priv_mitra, var_script_case_init, do_ajax_app_form_edit_users_validate_priv_mitra_cb);
  } // do_ajax_app_form_edit_users_validate_priv_mitra

  function do_ajax_app_form_edit_users_validate_priv_mitra_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_validate_priv_mitra_cb

  // ---------- Validate kodemitra
  function do_ajax_app_form_edit_users_validate_kodemitra()
  {
    var nomeCampo_kodemitra = "kodemitra";
    var var_kodemitra = scAjaxGetFieldSelect(nomeCampo_kodemitra);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_validate_kodemitra(var_kodemitra, var_script_case_init, do_ajax_app_form_edit_users_validate_kodemitra_cb);
  } // do_ajax_app_form_edit_users_validate_kodemitra

  function do_ajax_app_form_edit_users_validate_kodemitra_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_validate_kodemitra_cb

  // ---------- Validate priv_lokasi
  function do_ajax_app_form_edit_users_validate_priv_lokasi()
  {
    var nomeCampo_priv_lokasi = "priv_lokasi";
    var var_priv_lokasi = scAjaxGetFieldRadio(nomeCampo_priv_lokasi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_validate_priv_lokasi(var_priv_lokasi, var_script_case_init, do_ajax_app_form_edit_users_validate_priv_lokasi_cb);
  } // do_ajax_app_form_edit_users_validate_priv_lokasi

  function do_ajax_app_form_edit_users_validate_priv_lokasi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_validate_priv_lokasi_cb
  ...
  // ---------- Validate iddivre
  function do_ajax_app_form_edit_users_validate_iddivre()
  {
    var nomeCampo_iddivre = "iddivre";
    var var_iddivre = scAjaxGetFieldSelect(nomeCampo_iddivre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_validate_iddivre(var_iddivre, var_script_case_init, do_ajax_app_form_edit_users_validate_iddivre_cb);
  } // do_ajax_app_form_edit_users_validate_iddivre

  function do_ajax_app_form_edit_users_validate_iddivre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "iddivre";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_validate_iddivre_cb

  // ---------- Validate idwitel
  function do_ajax_app_form_edit_users_validate_idwitel()
  {
    var nomeCampo_idwitel = "idwitel";
    var var_idwitel = scAjaxGetFieldSelect(nomeCampo_idwitel);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_validate_idwitel(var_idwitel, var_script_case_init, do_ajax_app_form_edit_users_validate_idwitel_cb);
  } // do_ajax_app_form_edit_users_validate_idwitel

  function do_ajax_app_form_edit_users_validate_idwitel_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idwitel";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_validate_idwitel_cb

  // ---------- Validate name
  function do_ajax_app_form_edit_users_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_validate_name(var_name, var_script_case_init, do_ajax_app_form_edit_users_validate_name_cb);
  } // do_ajax_app_form_edit_users_validate_name

  function do_ajax_app_form_edit_users_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "name";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_validate_name_cb

  // ---------- Refresh iddivre
  function do_ajax_app_form_edit_users_refresh_iddivre()
  {
    var var_iddivre = scAjaxGetFieldSelect("iddivre");
    var var_nmgp_refresh_fields = "idwitel";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_app_form_edit_users_refresh_iddivre(var_iddivre, var_nmgp_refresh_fields, var_script_case_init, do_ajax_app_form_edit_users_refresh_iddivre_cb);
  } // do_ajax_app_form_edit_users_refresh_iddivre

  function do_ajax_app_form_edit_users_refresh_iddivre_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_refresh_iddivre_cb

  // ---------- Event onclick priv_lokasi
  function do_ajax_app_form_edit_users_event_priv_lokasi_onclick()
  {
    var var_priv_lokasi = scAjaxGetFieldRadio("priv_lokasi");
    var var_iddivre = scAjaxGetFieldSelect("iddivre");
    var var_idwitel = scAjaxGetFieldSelect("idwitel");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_app_form_edit_users_event_priv_lokasi_onclick(var_priv_lokasi, var_iddivre, var_idwitel, var_script_case_init, do_ajax_app_form_edit_users_event_priv_lokasi_onclick_cb);
  } // do_ajax_app_form_edit_users_event_priv_lokasi_onclick

  function do_ajax_app_form_edit_users_event_priv_lokasi_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "priv_lokasi";
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_app_form_edit_users_event_priv_lokasi_onclick_cb

  // ---------- Event onclick priv_mitra
  function do_ajax_app_form_edit_users_event_priv_mitra_onclick()
  {
    var var_priv_mitra = scAjaxGetFieldRadio("priv_mitra");
    var var_kodemitra = scAjaxGetFieldSelect("kodemitra");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_app_form_edit_users_event_priv_mitra_onclick(var_priv_mitra, var_kodemitra, var_script_case_init, do_ajax_app_form_edit_users_event_priv_mitra_onclick_cb);
  } // do_ajax_app_form_edit_users_event_priv_mitra_onclick

  function do_ajax_app_form_edit_users_event_priv_mitra_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "priv_mitra";
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_app_form_edit_users_event_priv_mitra_onclick_cb
  // ---------- Form
  function do_ajax_app_form_edit_users_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_edit_users_submit_form(var_login, var_pswd, var_confirm_pswd, var_email, var_active, var_priv_mitra, var_kodemitra, var_priv_lokasi, var_groups, var_iddivre, var_idwitel, var_name, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_edit_users_submit_form_cb);
...
?>
  ...
  ajax_field_list[5] = "priv_mitra";
  ajax_field_list[6] = "kodemitra";
  ajax_field_list[7] = "priv_lokasi";
  ajax_field_list[8] = "groups";
  ajax_field_list[9] = "iddivre";
  ajax_field_list[10] = "idwitel";
  ajax_field_list[11] = "name";
  ...
  var ajax_error_list = {
    ...
    "priv_mitra": {"label": "PRIV MITRA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "kodemitra": {"label": "KODEMITRA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "priv_lokasi": {"label": "PRIV LOKASI", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "iddivre": {"label": "IDDIVRE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idwitel": {"label": "IDWITEL", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
