...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['dashboard_info']['maximized']))
  {
?>
<tr><td>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['Lookup_priv_mitra'][] = 'Y'; ?>
<?php  if ("Y" == $this->priv_mitra)  { echo " checked" ;} ?>  onClick="do_ajax_app_form_edit_users_event_priv_mitra_onclick();" >Yes</TD>
  <TD class="scFormDataFontOdd css_priv_mitra_line">    <input  type=radio name="priv_mitra" value="N"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users']['Lookup_priv_mitra'][] = 'N'; ?>
<?php  if ("N" == $this->priv_mitra)  { echo " checked" ;} ?>  onClick="do_ajax_app_form_edit_users_event_priv_mitra_onclick();" >No</TD>
</TR></TABLE>
</div>
</span><?php  }?>
...
<?php
   ...
   while (!empty($todo[$x])) 
   {
          ...
          echo "  onClick=\"" . $sCheckInsert . "do_ajax_app_form_edit_users_event_priv_lokasi_onclick();\" >" ; 
          echo "" . $cadaradio[0] . "";
          $x++ ; 
          $y++ ; 
          echo "  </font></td>\r\n";
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_iddivre_label" id="hidden_field_label_iddivre" style="<?php echo $sStyleHidden_iddivre; ?>"><span id="id_label_iddivre"><?php echo $this->nm_new_label['iddivre']; ?></span></TD>
    <TD class="scFormDataOdd css_iddivre_line" id="hidden_field_data_iddivre" style="<?php echo $sStyleHidden_iddivre; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_iddivre_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idwitel_label" id="hidden_field_label_idwitel" style="<?php echo $sStyleHidden_idwitel; ?>"><span id="id_label_idwitel"><?php echo $this->nm_new_label['idwitel']; ?></span></TD>
    <TD class="scFormDataOdd css_idwitel_line" id="hidden_field_data_idwitel" style="<?php echo $sStyleHidden_idwitel; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idwitel_line" style="vertical-align: top;padding: 0px">
