...
//----- 
   function ini_controle()
   {
      ...
      $_SESSION['scriptcase']['error_icon']['app_form_edit_users_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
...
//---------------------------------------------------------
    ...
    function ValidateField_active(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->active != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_active']) && !in_array($this->active, $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_active']))
          {
    ...
    function ValidateField_priv_mitra(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->priv_mitra != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_priv_mitra']) && !in_array($this->priv_mitra, $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_priv_mitra']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->kodemitra) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_kodemitra']) && !in_array($this->kodemitra, $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_kodemitra']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_priv_lokasi(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->priv_lokasi != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_priv_lokasi']) && !in_array($this->priv_lokasi, $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_priv_lokasi']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
                  if ($this->groups != "" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_groups']) && !in_array($this->groups, $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_groups']))
                  {
                      $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->iddivre) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_iddivre']) && !in_array($this->iddivre, $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_iddivre']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->idwitel) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_idwitel']) && !in_array($this->idwitel, $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_idwitel']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
$aLookup[] = array(app_form_edit_users_mob_pack_protect_string('Y') => app_form_edit_users_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_opt_yes'] . ""));
$aLookup[] = array(app_form_edit_users_mob_pack_protect_string('N') => app_form_edit_users_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_opt_no'] . ""));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_active'][] = 'Y';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_active'][] = 'N';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
...
$aLookup[] = array(app_form_edit_users_mob_pack_protect_string('Y') => app_form_edit_users_mob_pack_protect_string("Yes"));
$aLookup[] = array(app_form_edit_users_mob_pack_protect_string('N') => app_form_edit_users_mob_pack_protect_string("No"));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_priv_mitra'][] = 'Y';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_priv_mitra'][] = 'N';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['priv_mitra']['valList'][$i] = app_form_edit_users_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_kodemitra']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_kodemitra'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_kodemitra']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_kodemitra'] = array(); 
}
$aLookup[] = array(app_form_edit_users_mob_pack_protect_string('') => app_form_edit_users_mob_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_kodemitra'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(app_form_edit_users_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => app_form_edit_users_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_kodemitra'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['kodemitra']['valList'][$i] = app_form_edit_users_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_priv_lokasi']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_priv_lokasi'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_priv_lokasi']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_priv_lokasi'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_priv_lokasi'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['priv_lokasi']['valList'][$i] = app_form_edit_users_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_iddivre']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_iddivre'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_iddivre']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_iddivre'] = array(); 
}
$aLookup[] = array(app_form_edit_users_mob_pack_protect_string('') => app_form_edit_users_mob_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_iddivre'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_iddivre'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['iddivre']['valList'][$i] = app_form_edit_users_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_idwitel']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_idwitel'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_idwitel']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_idwitel'] = array(); 
}
$aLookup[] = array(app_form_edit_users_mob_pack_protect_string('') => app_form_edit_users_mob_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_idwitel'][] = '';
if ($this->iddivre != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['Lookup_idwitel'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idwitel']['valList'][$i] = app_form_edit_users_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['scriptcase']['app_form_edit_users_mob']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['where_filter'])
      {
