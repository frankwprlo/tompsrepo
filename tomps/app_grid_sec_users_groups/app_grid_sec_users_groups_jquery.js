...
function ajax_navigate(opc, parm)
{
    ...
    $.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_app_grid_sec_users_groups').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_app_grid_sec_users_groups').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_app_grid_sec_users_groups').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_app_grid_sec_users_groups').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_app_grid_sec_users_groups').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_app_grid_sec_users_groups').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_app_grid_sec_users_groups').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_app_grid_sec_users_groups').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_app_grid_sec_users_groups').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_app_grid_sec_users_groups').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_app_grid_sec_users_groups').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_app_grid_sec_users_groups').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
