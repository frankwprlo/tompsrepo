...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["login"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["login"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["login"] : "" . $this->Nm_lang['lang_sec_users_fild_login'] . "";
   $tab_ger_campos['name'] = "on";
   $tab_def_campos['name'] = "NAME";
   $tab_converte["NAME"]   = "name";
   $tab_labels["name"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["name"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["name"] : "NAME";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "EMAIL";
   $tab_converte["EMAIL"]   = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["email"] : "" . $this->Nm_lang['lang_sec_users_fild_email'] . "";
   $tab_ger_campos['active'] = "on";
   $tab_def_campos['active'] = "ACTIVE";
   $tab_converte["ACTIVE"]   = "active";
   $tab_labels["active"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["active"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["active"] : "" . $this->Nm_lang['lang_sec_users_fild_active'] . "";
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
