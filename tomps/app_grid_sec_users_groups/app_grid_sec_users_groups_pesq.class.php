...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      else
      {
         ...
         $nome_sum = "AKSESSMR.SEC_USERS.$nome";
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_groups']['dashboard_info']['compact_mode'])
      {
          return;
      }
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR align="center" valign="middle">
        ...
        <TD class="scFilterHeaderFont">
          <?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - sec_users
        </TD>
       </TR>
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "projectamo/app_grid_sec_users_groups";
   ...
   function trata_campos()
   {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_groups']['psq_check_ret']['group'])) {
   ...
   function finaliza_resultado()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_groups']['where_pesq_ant'] = $this->comando . $this->comando_fim;
