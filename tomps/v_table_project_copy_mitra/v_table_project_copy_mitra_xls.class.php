...
class v_table_project_copy_mitra_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_mitra']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_mitra']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          $this->Arquivo   .= "_v_table_project_copy_mitra";
          $this->Arquivo   .= ".xls";
          $this->Tit_doc    = "v_table_project_copy_mitra.xls";
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_mitra']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_mitra']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_mitra']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_mitra']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      ...
      { 
          ...
          if (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['v_resume_detailproject']['embutida_label'] = true;
              $GLOBALS["script_case_init"] = $this->Ini->sc_page;
              $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xls?@?";
              if (method_exists($this->v_resume_detailproject, "controle"))
              {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_mitra']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_mitra']['embutida_label'])
      { 
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_mitra']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->templatename = $rs->fields[33] ;  
         $this->tm_namamitra = $rs->fields[34] ;  
         ...
         $this->Orig_tp_witel = $this->tp_witel;
         $this->Orig_tp_sto = $this->tp_sto;
         $this->Orig_tp_jmlport = $this->tp_jmlport;
         $this->Orig_tp_jmldistribusi = $this->tp_jmldistribusi;
         $this->Orig_tp_entrydate = $this->tp_entrydate;
         $this->Orig_tp_entryby = $this->tp_entryby;
         $this->Orig_tp_updatedate = $this->tp_updatedate;
         $this->Orig_tp_updateby = $this->tp_updateby;
         ...
         $this->Orig_tp_datel = $this->tp_datel;
...
$_SESSION['scriptcase']['v_table_project_copy_mitra']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_mitra']['embutida'])
         { 
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_mitra']['embutida'])
      { 
   ...
   function NM_export_tp_planstart()
   {
         ...
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tp_planstart);
   ...
   function NM_export_tp_planfinish()
   {
         ...
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tp_planfinish);
             $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getNumberFormat()->setFormatCode($this->SC_date_conf_region);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_prepare()
   {
         ...
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->prepare);
         $this->Xls_col++;
   }
   //----- perijinan
   ...
   function NM_export_inst_testcomm()
   {
         ...
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->inst_testcomm);
         $this->Xls_col++;
   }
   //----- closing
   function NM_export_closing()
   {
         ...
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->closing);
         $this->Xls_col++;
   }
   //----- tp_prosentase
   ...
   function NM_export_tp_mitra()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tp_mitra, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- tp_witel
   function NM_export_tp_witel()
   {
         ...
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tp_witel);
         $this->Xls_col++;
   }
   //----- tp_sto
   function NM_export_tp_sto()
   {
         ...
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tp_sto);
         $this->Xls_col++;
   }
   //----- tp_jmlport
   ...
   function NM_export_tp_entrydate()
   {
         ...
         {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tp_entrydate, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tp_entrydate);
             $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getNumberFormat()->setFormatCode($this->SC_date_conf_region);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_tp_entryby()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tp_entryby, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- tp_updatedate
   function NM_export_tp_updatedate()
   {
         ...
         {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tp_updatedate, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tp_updatedate);
             $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getNumberFormat()->setFormatCode($this->SC_date_conf_region);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_tp_updateby()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tp_updateby, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- tp_summary
   ...
   function NM_export_tp_status()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tp_status, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- tp_actualstart
   function NM_export_tp_actualstart()
   {
         ...
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tp_actualstart);
             $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getNumberFormat()->setFormatCode($this->SC_date_conf_region);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_tp_actualfinish()
   {
         ...
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tp_actualfinish);
             $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getNumberFormat()->setFormatCode($this->SC_date_conf_region);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_tp_datel()
   {
         ...
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tp_datel);
         $this->Xls_col++;
   }
   //----- mw_namawitel
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_mitra']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_mitra']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_mitra'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['v_table_project_copy_mitra'][$path_doc_md5][1] = $this->Tit_doc;
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE>List Project Witel <?php echo $_SESSION['kodewitel'] ?> - Mitra : <?php echo $_SESSION['namamitra'] ?> :: Excel</TITLE>
