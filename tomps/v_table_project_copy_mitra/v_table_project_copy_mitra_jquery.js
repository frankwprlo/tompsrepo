...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_v_table_project_copy_mitra').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_v_table_project_copy_mitra').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_v_table_project_copy_mitra').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_v_table_project_copy_mitra').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_v_table_project_copy_mitra').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_v_table_project_copy_mitra').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_v_table_project_copy_mitra').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_v_table_project_copy_mitra').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_v_table_project_copy_mitra').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_v_table_project_copy_mitra').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_v_table_project_copy_mitra').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_v_table_project_copy_mitra').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
