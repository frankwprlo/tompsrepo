 ...
 */
    ...
    session_start();
    $SC_apl_proc = "v_table_project_copy_mitra";
...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['v_table_project_copy_mitra']['show_skip_charts_option']) || !$_SESSION['sc_session']['v_table_project_copy_mitra']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
