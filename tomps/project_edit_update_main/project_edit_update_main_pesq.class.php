...
class project_edit_update_main_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $this->Ini->Str_btn_filter = "scriptcase8_ceropegia/scriptcase8_ceropegia" . $_SESSION['scriptcase']['reg_conf']['css_dir'] . ".php";
      $this->Str_btn_filter_css  = "scriptcase8_ceropegia/scriptcase8_ceropegia.css";
      include($this->Ini->path_btn . $this->Ini->Str_btn_filter);
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
   ...
   function lookup_ajax_tp_idlop($tp_idlop)
   {
      ...
      $nm_comando = "select distinct TP_IDLOP from " . $this->Ini->nm_tabela . " where TP_DIVRE='" . $_SESSION['iddivre'] . "' AND TP_WITEL='" . $_SESSION['idwitel'] . "' and  TP_IDLOP like '%" . $tp_idlop . "%' order by TP_IDLOP"; 
   ...
   function lookup_ajax_tp_datel()
   {
      ...
      $nmgp_def_dados = array(); 
      $nmgp_def_dados[] = array("" => ""); 
      $nm_comando = "SELECT MD_IDDATEL, MD_NAMADATEL  FROM TBL_MAS_DATEL  WHERE MD_IDWITEL='" . $_SESSION['idwitel'] . "'  ORDER BY MD_NAMADATEL"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['psq_check_ret']['tp_datel'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['psq_check_ret']['tp_datel'][] = trim($rs->fields[0]);
            $cmp1 = NM_charset_to_utf8(trim($rs->fields[0]));
   ...
   { 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['psq_check_ret']['tp_sto'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['psq_check_ret']['tp_sto'][] = trim($rs->fields[0]);
            $cmp1 = NM_charset_to_utf8(trim($rs->fields[0]));
            $cmp2 = NM_charset_to_utf8(trim($rs->fields[1]));
            $nmgp_def_dados[] = array($cmp1 . "##@@" . $cmp2 => $cmp2); 
            $rs->MoveNext() ; 
   ...
   function lookup_ajax_tp_id($tp_id)
   {
      ...
      {
          $nm_comando = "select distinct TP_ID from " . $this->Ini->nm_tabela . " where TP_DIVRE='" . $_SESSION['iddivre'] . "' AND TP_WITEL='" . $_SESSION['idwitel'] . "' and   CAST (TP_ID AS TEXT)  like '%" . $tp_id . "%' order by TP_ID"; 
      }
      else
      {
          $nm_comando = "select distinct TP_ID from " . $this->Ini->nm_tabela . " where TP_DIVRE='" . $_SESSION['iddivre'] . "' AND TP_WITEL='" . $_SESSION['idwitel'] . "' and  TP_ID like '%" . $tp_id . "%' order by TP_ID"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_tp_projectname($tp_projectname)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct TP_PROJECTNAME from " . $this->Ini->nm_tabela . " where TP_DIVRE='" . $_SESSION['iddivre'] . "' AND TP_WITEL='" . $_SESSION['idwitel'] . "' and  TP_PROJECTNAME like '%" . $tp_projectname . "%' order by TP_PROJECTNAME"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Search Form : Update Status Project</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>project_edit_update_main/project_edit_update_main_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="project_edit_update_main_ajax_search.js"></script>
 <script type="text/javascript" src="project_edit_update_main_ajax.js"></script>
 <script type="text/javascript">
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['dashboard_info']['compact_mode'])
      {
          return;
      }
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR align="center" valign="middle">
        ...
        <TD class="scFilterHeaderFont">
          Search Form : Update Status Project
        </TD>
       </TR>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $tp_idlop = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_idlop']; 
          $tp_idlop_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_idlop_cond']; 
          $tp_datel = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_datel']; 
          $tp_datel_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_datel_cond']; 
          $tp_sto = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_sto']; 
          $tp_sto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_sto_cond']; 
          $tp_mitra = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_mitra']; 
          $tp_mitra_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_mitra_cond']; 
          $tp_jenisproject = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_jenisproject']; 
          $tp_jenisproject_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_jenisproject_cond']; 
          $tp_prjtrelease = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_prjtrelease']; 
          $tp_prjtrelease_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_prjtrelease_cond']; 
          $tp_status = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_status']; 
          $tp_status_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_status_cond']; 
          $tp_id = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_id']; 
          $tp_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_id_cond']; 
          $tp_projectname = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_projectname']; 
          $tp_projectname_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_projectname_cond']; 
          $tp_planstart_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planstart_dia']; 
          $tp_planstart_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planstart_mes']; 
          $tp_planstart_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planstart_ano']; 
          $tp_planstart_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planstart_input_2_dia']; 
          $tp_planstart_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planstart_input_2_mes']; 
          $tp_planstart_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planstart_input_2_ano']; 
          $tp_planstart_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planstart_cond']; 
          $tp_planfinish_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planfinish_dia']; 
          $tp_planfinish_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planfinish_mes']; 
          $tp_planfinish_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planfinish_ano']; 
          $tp_planfinish_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planfinish_input_2_dia']; 
          $tp_planfinish_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planfinish_input_2_mes']; 
          $tp_planfinish_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planfinish_input_2_ano']; 
          $tp_planfinish_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planfinish_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['NM_operador']; 
      } 
 ...
 <TR align="center">
  ...
  <TD width="80%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd css_tp_idlop_fil_label"><?php echo (isset($this->New_label['tp_idlop'])) ? $this->New_label['tp_idlop'] : "ID LOP"; ?></TD>
      
      <INPUT type="hidden" id="SC_tp_idlop_cond" name="tp_idlop_cond" value="qp">
 
     <TD colspan=2 class="scFilterFieldOdd css_tp_idlop_fil_line">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tp_idlop" <?php echo $str_hide_tp_idlop?> valign="top">
        <TD class="scFilterFieldFontOdd css_tp_idlop_fil_line">
           <?php
...
<?php
      ...
      $tp_idlop_look = substr($this->Db->qstr($tp_idlop), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct TP_IDLOP from " . $this->Ini->nm_tabela . " where TP_DIVRE='" . $_SESSION['iddivre'] . "' AND TP_WITEL='" . $_SESSION['idwitel'] . "' and TP_IDLOP = '$tp_idlop_look' order by TP_IDLOP"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<INPUT  type="text" id="SC_tp_idlop" name="tp_idlop" value="<?php echo NM_encode_input($tp_idlop) ?>" size=18 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: true}" style="display: none">
<input class="sc-js-input scFilterObjectOdd css_tp_idlop_fil_obj" type="text" id="id_ac_tp_idlop" name="tp_idlop_autocomp" size="18" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 18, allowedChars: '', lettersCase: '', autoTab: false, enterTab: true}">
...
?>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['tp_sto'])) ? $this->New_label['tp_sto'] : "STO"; ?></TD>
...
?>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['tp_mitra'])) ? $this->New_label['tp_mitra'] : "Mitra"; ?></TD>
...
<?php
      ...
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT TM_IDMITRA, TM_NAMAMITRA  FROM TBL_MITRA  WHERE TM_WITEL='" . $_SESSION['idwitel'] . "' AND TM_DIVRE='" . $_SESSION['iddivre'] . "'  ORDER BY TM_NAMAMITRA"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['psq_check_ret']['tp_mitra'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['psq_check_ret']['tp_mitra'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['psq_check_ret']['tp_jenisproject'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['psq_check_ret']['tp_jenisproject'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['tp_prjtrelease'])) ? $this->New_label['tp_prjtrelease'] : "Project Release"; ?></TD>
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['psq_check_ret']['tp_prjtrelease'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['psq_check_ret']['tp_prjtrelease'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['tp_status'])) ? $this->New_label['tp_status'] : "Status"; ?></TD>
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['psq_check_ret']['tp_status'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['psq_check_ret']['tp_status'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
    ...
    <TR>
     <TD colspan="5" height="20" class="scFilterBlockBack">
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
       <TR>
        <TD class="scFilterBlockFont css_blk_1"><?php echo $Img_tit_blk_i ?>Filter Others<?php echo $Img_tit_blk_f ?></TD>
...
<?php echo $SC_Label ?><br><span id="id_hide_tp_id"  <?php echo $str_hide_tp_id?>><?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct TP_ID from " . $this->Ini->nm_tabela . " where TP_DIVRE='" . $_SESSION['iddivre'] . "' AND TP_WITEL='" . $_SESSION['idwitel'] . "' and TP_ID = $tp_id_look order by TP_ID"; 
      }
      else
      {
          $nm_comando = "select distinct TP_ID from " . $this->Ini->nm_tabela . " where TP_DIVRE='" . $_SESSION['iddivre'] . "' AND TP_WITEL='" . $_SESSION['idwitel'] . "' and TP_ID = $tp_id_look order by TP_ID"; 
...
?>
<INPUT  type="text" id="SC_tp_id" name="tp_id" value="<?php echo NM_encode_input($tp_id) ?>" size=16 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: true}" style="display: none">
<input class="sc-js-input scFilterObjectOdd css_tp_id_fil_obj" type="text" id="id_ac_tp_id" name="tp_id_autocomp" size="16" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 16, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: true}">
...
<?php echo $SC_Label ?><br><span id="id_hide_tp_projectname"  <?php echo $str_hide_tp_projectname?>><?php
      ...
      $tp_projectname_look = substr($this->Db->qstr($tp_projectname), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct TP_PROJECTNAME from " . $this->Ini->nm_tabela . " where TP_DIVRE='" . $_SESSION['iddivre'] . "' AND TP_WITEL='" . $_SESSION['idwitel'] . "' and TP_PROJECTNAME = '$tp_projectname_look' order by TP_PROJECTNAME"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<?php
   if (is_file("project_edit_update_main_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['opc_psq'])
   {
...
?>
 ...
 <TR align="center">
  <TD class="scFilterTableTd">
   <TABLE width="100%" class="scFilterFooter">
    <TR align="center">
     <TD>
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR align="center" valign="middle">
        <TD align="left" rowspan="2" class="scFilterFooterFont">
          <?php echo "Pilih Parameter untuk difilter lalu klik Search !" ?>
        </TD>
        <TD class="scFilterFooterFont">
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['orig_pesq'] == "grid")
   {
...
<SCRIPT type="text/javascript">
 ...
 function limpa_form()
 {
   ...
   document.F1.tp_planfinish_input_2_ano.value = "";
         ...
         function nm_display_calendar_tp_planstart(sField)
         {
             ...
             sValue   += document.F1.elements[sField_d].value;
             tb_show('', '<?php echo $this->Ini->path_link; ?>project_edit_update_main/project_edit_update_main.php?nm_cal_display=Y&field=' + sField + '&value=' + sValue + '&inter=10&week_ini=<?php echo $_SESSION['scriptcase']['reg_conf']['date_week_ini']; ?>&Orig=pesq&Seq=0&script_case_init=<?php  echo NM_encode_input($this->Ini->sc_page); ?>&script_case_session=<?php  echo session_id(); ?>&TB_iframe=true&height=150&width=220&modal=true', '');
         }
 ...
 {
    $('#SC_tp_planfinish_dia').bind('change', function() {sc_project_edit_update_main_valida_dia(this)});
    $('#SC_tp_planfinish_input_2_dia').bind('change', function() {sc_project_edit_update_main_valida_dia(this)});
    $('#SC_tp_planfinish_input_2_mes').bind('change', function() {sc_project_edit_update_main_valida_mes(this)});
    $('#SC_tp_planfinish_mes').bind('change', function() {sc_project_edit_update_main_valida_mes(this)});
    $('#SC_tp_planstart_dia').bind('change', function() {sc_project_edit_update_main_valida_dia(this)});
    $('#SC_tp_planstart_input_2_dia').bind('change', function() {sc_project_edit_update_main_valida_dia(this)});
    $('#SC_tp_planstart_input_2_mes').bind('change', function() {sc_project_edit_update_main_valida_mes(this)});
    $('#SC_tp_planstart_mes').bind('change', function() {sc_project_edit_update_main_valida_mes(this)});
 }
 function sc_project_edit_update_main_valida_dia(obj)
 {
 ...
 function sc_project_edit_update_main_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "projectamo/project_edit_update_main";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['psq_check_ret']['tp_datel'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['psq_check_ret']['tp_sto'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['psq_check_ret']['tp_mitra'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['psq_check_ret']['tp_jenisproject'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['psq_check_ret']['tp_prjtrelease'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['psq_check_ret']['tp_status'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_idlop'] = $tp_idlop; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_idlop_cond'] = $tp_idlop_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_datel'] = $tp_datel; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_datel_cond'] = $tp_datel_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_sto'] = $tp_sto; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_sto_cond'] = $tp_sto_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_mitra'] = $tp_mitra; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_mitra_cond'] = $tp_mitra_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_jenisproject'] = $tp_jenisproject; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_jenisproject_cond'] = $tp_jenisproject_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_prjtrelease'] = $tp_prjtrelease; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_prjtrelease_cond'] = $tp_prjtrelease_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_status'] = $tp_status; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_status_cond'] = $tp_status_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_id'] = $tp_id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_id_cond'] = $tp_id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_projectname'] = $tp_projectname; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_projectname_cond'] = $tp_projectname_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planstart_dia'] = $tp_planstart_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planstart_mes'] = $tp_planstart_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planstart_ano'] = $tp_planstart_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planstart_input_2_dia'] = $tp_planstart_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planstart_input_2_mes'] = $tp_planstart_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planstart_input_2_ano'] = $tp_planstart_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planstart_cond'] = $tp_planstart_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planfinish_dia'] = $tp_planfinish_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planfinish_mes'] = $tp_planfinish_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planfinish_ano'] = $tp_planfinish_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planfinish_input_2_dia'] = $tp_planfinish_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planfinish_input_2_mes'] = $tp_planfinish_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planfinish_input_2_ano'] = $tp_planfinish_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planfinish_cond'] = $tp_planfinish_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($tp_id_cond != "in" && $tp_id_cond != "bw" && !empty($tp_id) && !is_numeric($tp_id))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : ID Table";
      }
   ...
   { 
      ...
      if ($tp_planstart_cond != "TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planstart'] = $val[0];
          ...
          if ($tp_planstart_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planstart_input_2'] = $val[1];
      ...
      if ($tp_planfinish_cond != "TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planfinish'] = $val[0];
          ...
          if ($tp_planfinish_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']['tp_planfinish_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['contr_array_resumo'] = "NAO";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['where_pesq_ant'] = $this->comando . $this->comando_fim;
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['fast_search']);
...
WHERE TPC_IDPROJECT='$tp_id'";
      ...
      { 
          $rs_button = false;
          $rs_button_erro = $this->Db->ErrorMsg();
      } 
;
if (isset($rs_button[0][0]))     
{
    $tpc_generatetask  	= $rs_button[0][0];
    $tpc_progresstask  	= $rs_button[0][1];
	$tpc_jadwalproject  = $rs_button[0][2];
	$tpc_odpnew  		= $rs_button[0][3];
	
	if ($tpc_odpnew  == 'Y' && $tp_jmldistribusi  > 0){
	$this->nmgp_botoes["generate_odp_new"] = "off";;	
	}
	elseif ($tpc_odpnew  == 'N' && $tp_jmldistribusi  < 1) {
