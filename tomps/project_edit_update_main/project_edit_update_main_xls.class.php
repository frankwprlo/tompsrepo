...
class project_edit_update_main_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= "_project_edit_update_main";
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "project_edit_update_main.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['order_grid'];
      ...
      { 
          ...
          if ($Cada_col == "viewodp" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      while (!$rs->EOF)
      {
         ...
         $this->tm_namamitra = $rs->fields[3] ;  
         $this->tp_projectname = $rs->fields[4] ;  
         $this->tp_releasename = $rs->fields[5] ;  
         $this->tj_namajenis = $rs->fields[6] ;  
         $this->tp_lokasi = $rs->fields[7] ;  
         $this->tp_odp = $rs->fields[8] ;  
         $this->tp_odp = (string)$this->tp_odp;
         $this->tp_jmlport = $rs->fields[9] ;  
         $this->tp_jmlport = (string)$this->tp_jmlport;
         $this->tp_jmldistribusi = $rs->fields[10] ;  
         $this->tp_jmldistribusi = (string)$this->tp_jmldistribusi;
         $this->tp_planstart = $rs->fields[11] ;  
         $this->tp_planfinish = $rs->fields[12] ;  
         $this->tp_targetwaktu = $rs->fields[13] ;  
         $this->tp_targetwaktu = (string)$this->tp_targetwaktu;
         $this->tp_prosentase = $rs->fields[14] ;  
         $this->tp_prosentase =  str_replace(",", ".", $this->tp_prosentase);
         $this->tp_prosentase = (string)$this->tp_prosentase;
         $this->tp_batch = $rs->fields[15] ;  
         $this->tp_mitra = $rs->fields[16] ;  
         $this->tp_mitra = (string)$this->tp_mitra;
         $this->tp_witel = $rs->fields[17] ;  
         $this->tp_witel = (string)$this->tp_witel;
         $this->tp_sto = $rs->fields[18] ;  
         $this->tp_sto = (string)$this->tp_sto;
         $this->tp_entrydate = $rs->fields[19] ;  
         $this->tp_entryby = $rs->fields[20] ;  
         $this->tp_updatedate = $rs->fields[21] ;  
         $this->tp_updateby = $rs->fields[22] ;  
         $this->tp_summary = $rs->fields[23] ;  
         $this->tp_status = $rs->fields[24] ;  
         $this->tp_status = (string)$this->tp_status;
         $this->tp_actualstart = $rs->fields[25] ;  
         $this->tp_actualfinish = $rs->fields[26] ;  
         $this->tp_templateproject = $rs->fields[27] ;  
         $this->tp_templateproject = (string)$this->tp_templateproject;
         $this->tp_jenisproject = $rs->fields[28] ;  
         $this->tp_jenisproject = (string)$this->tp_jenisproject;
         $this->tp_prjtrelease = $rs->fields[29] ;  
         $this->tp_prjtrelease = (string)$this->tp_prjtrelease;
         $this->tp_datel = $rs->fields[30] ;  
         $this->tp_datel = (string)$this->tp_datel;
         $this->mw_namawitel = $rs->fields[31] ;  
         $this->md_namadatel = $rs->fields[32] ;  
         $this->ms_namasto = $rs->fields[33] ;  
         $this->templatename = $rs->fields[34] ;  
...
$_SESSION['scriptcase']['project_edit_update_main']['contr_erro'] = 'off'; 
   ...
   function NM_export_tp_jmlport()
   {
         ...
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->tp_jmlport);
         $this->Xls_col++;
   }
   //----- tp_jmldistribusi
   ...
   //----- viewodp
   function NM_export_viewodp()
   {
         $this->viewodp = html_entity_decode($this->viewodp, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->viewodp = strip_tags($this->viewodp);
         if (!NM_is_utf8($this->viewodp))
         {
             $this->viewodp = sc_convert_encoding($this->viewodp, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->viewodp, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main'][$path_doc_md5][1] = $this->Tit_doc;
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE>Form Update Status Project :: Excel</TITLE>
