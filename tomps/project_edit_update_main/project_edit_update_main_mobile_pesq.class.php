...
?>
    ...
    <TR>
     <TD colspan="1" height="20" class="scFilterBlockBack">
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
       <TR>
        <TD class="scFilterBlockFont css_blk_0"><?php echo $Img_tit_blk_i ?>Parameter Filter 1<?php echo $Img_tit_blk_f ?></TD>
    ...
    <TD nowrap class="scFilterLabelOdd css_tp_idlop_fil_label" > <?php
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_tp_projectname" name="tp_projectname_autocomp" size="20" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: true}">
...
?>
<?php echo $SC_Label ?><br>
      <SELECT class="sc-js-input scFilterObjectEven" alt="{autoTab: false, enterTab: true}" id="SC_tp_planfinish_cond" name="tp_planfinish_cond" onChange="nm_campos_between(document.getElementById('id_vis_tp_planfinish'), this, 'tp_planfinish')">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tp_planfinish_dia" name="tp_planfinish_dia" value="<?php echo NM_encode_input($tp_planfinish_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tp_planfinish_mes" name="tp_planfinish_mes" value="<?php echo NM_encode_input($tp_planfinish_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tp_planfinish_ano" name="tp_planfinish_ano" value="<?php echo NM_encode_input($tp_planfinish_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: true}">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tp_planfinish_input_2_dia" name="tp_planfinish_input_2_dia" value="<?php echo NM_encode_input($tp_planfinish_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tp_planfinish_input_2_mes" name="tp_planfinish_input_2_mes" value="<?php echo NM_encode_input($tp_planfinish_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_tp_planfinish_input_2_ano" name="tp_planfinish_input_2_ano" value="<?php echo NM_encode_input($tp_planfinish_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: true}">
