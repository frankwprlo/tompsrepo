...
class dashboard_lopinprogress_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['dashboard_lopinprogress']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['dashboard_lopinprogress']['campos_busca']))
      { 
