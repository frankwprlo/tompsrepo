 ...
 */
    ...
    session_start();
    $SC_apl_proc = "dashboard_lopinprogress";
...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['dashboard_lopinprogress']['show_skip_charts_option']) || !$_SESSION['sc_session']['dashboard_lopinprogress']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
