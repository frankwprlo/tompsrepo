...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate md_iddivre_
  function do_ajax_divre_validate_md_iddivre_(iNumLinha)
  {
    var nomeCampo_md_iddivre_ = "md_iddivre_" + iNumLinha;
    var var_md_iddivre_ = scAjaxGetFieldText(nomeCampo_md_iddivre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_divre_validate_md_iddivre_(var_md_iddivre_, iNumLinha, var_script_case_init, do_ajax_divre_validate_md_iddivre__cb);
  } // do_ajax_divre_validate_md_iddivre_

  function do_ajax_divre_validate_md_iddivre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "md_iddivre_" + iLineNumber;
    }
    else
    {
      sFieldValid = "md_iddivre_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "md_iddivre_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "md_iddivre_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_divre_validate_md_iddivre__cb

  // ---------- Validate md_kodedivre_
  function do_ajax_divre_validate_md_kodedivre_(iNumLinha)
  {
    var nomeCampo_md_kodedivre_ = "md_kodedivre_" + iNumLinha;
    var var_md_kodedivre_ = scAjaxGetFieldText(nomeCampo_md_kodedivre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_divre_validate_md_kodedivre_(var_md_kodedivre_, iNumLinha, var_script_case_init, do_ajax_divre_validate_md_kodedivre__cb);
  } // do_ajax_divre_validate_md_kodedivre_

  function do_ajax_divre_validate_md_kodedivre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "md_kodedivre_" + iLineNumber;
    }
    else
    {
      sFieldValid = "md_kodedivre_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "md_kodedivre_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "md_kodedivre_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_divre_validate_md_kodedivre__cb

  // ---------- Validate md_namadivre_
  function do_ajax_divre_validate_md_namadivre_(iNumLinha)
  {
    var nomeCampo_md_namadivre_ = "md_namadivre_" + iNumLinha;
    var var_md_namadivre_ = scAjaxGetFieldText(nomeCampo_md_namadivre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_divre_validate_md_namadivre_(var_md_namadivre_, iNumLinha, var_script_case_init, do_ajax_divre_validate_md_namadivre__cb);
  } // do_ajax_divre_validate_md_namadivre_

  function do_ajax_divre_validate_md_namadivre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "md_namadivre_" + iLineNumber;
    }
    else
    {
      sFieldValid = "md_namadivre_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "md_namadivre_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "md_namadivre_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_divre_validate_md_namadivre__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_divre_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_divre_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_divre_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_divre_add_new_line_cb);
  } // do_ajax_divre_add_new_line

  function do_ajax_divre_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_divre_add_new_line_cb

  // ---------- backup_line
  function do_ajax_divre_backup_line(iNumLinha)
  {
    var var_md_iddivre_ = scAjaxGetFieldText("md_iddivre_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_divre_backup_line(var_md_iddivre_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_divre_backup_line_cb);
  } // do_ajax_divre_backup_line

  function do_ajax_divre_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_divre_backup_line_cb

  function do_ajax_divre_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_divre_cancel_insert

  function do_ajax_divre_cancel_update(iSeqVert)
  {
    do_ajax_divre_backup_line(iSeqVert);
...
?>
  } // do_ajax_divre_cancel_update

  function do_ajax_divre_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_divre_restore_buttons

  // ---------- table_refresh
  function do_ajax_divre_table_refresh()
  {
    var var_md_iddivre_ = document.F2.md_iddivre_.value;
    ...
    scAjaxProcOn();
    x_ajax_divre_table_refresh(var_md_iddivre_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_divre_table_refresh_cb);
  } //  do_ajax_divre_table_refresh

  function do_ajax_divre_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.md_iddivre_.value = scAjaxGetKeyValue("md_iddivre_");
    ...
    sc_insert_open = false;
  } // do_ajax_divre_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_divre_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_divre_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_md_iddivre_ = scAjaxGetFieldText("md_iddivre_" + iNumLinha);
    var var_md_kodedivre_ = scAjaxGetFieldText("md_kodedivre_" + iNumLinha);
    var var_md_namadivre_ = scAjaxGetFieldText("md_namadivre_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_divre_submit_form(var_md_iddivre_, var_md_kodedivre_, var_md_namadivre_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_divre_submit_form_cb);
  } // do_ajax_divre_submit_form

  function do_ajax_divre_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("md_iddivre_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("md_kodedivre_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("md_namadivre_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_divre_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_divre_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_divre_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("md_iddivre_" + iNavForm);
      scAjaxHideErrorDisplay("md_kodedivre_" + iNavForm);
      scAjaxHideErrorDisplay("md_namadivre_" + iNavForm);
    }
    var var_md_iddivre_ = document.F2.md_iddivre_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_divre_navigate_form(var_md_iddivre_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_divre_navigate_form_cb);
  } // do_ajax_divre_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['divre']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_divre_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.md_iddivre_.value = scAjaxGetKeyValue("md_iddivre_" + var_last_index);
...
?>
  ...
  } // do_ajax_divre_navigate_form_cb
  function sc_hide_divre_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "md_iddivre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "md_kodedivre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "md_namadivre_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["md_iddivre_" + iNumLinha] = {"label": "IDDIVRE<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["md_kodedivre_" + iNumLinha] = {"label": "KODEDIVRE<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["md_namadivre_" + iNumLinha] = {"label": "NAMADIVRE<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["md_iddivre_"][iNumLinha] = "md_iddivre_" + iNumLinha;
    ajax_field_mult["md_kodedivre_"][iNumLinha] = "md_kodedivre_" + iNumLinha;
    ajax_field_mult["md_namadivre_"][iNumLinha] = "md_namadivre_" + iNumLinha;
    ajax_field_id["md_iddivre_" + iNumLinha] = new Array("hidden_field_label_md_iddivre_", "hidden_field_data_md_iddivre_" + iNumLinha);
    ajax_field_id["md_kodedivre_" + iNumLinha] = new Array("hidden_field_label_md_kodedivre_", "hidden_field_data_md_kodedivre_" + iNumLinha);
    ajax_field_id["md_namadivre_" + iNumLinha] = new Array("hidden_field_label_md_namadivre_", "hidden_field_data_md_namadivre_" + iNumLinha);
    ajax_error_count["md_iddivre_" + iNumLinha] = "off";
    ajax_error_count["md_kodedivre_" + iNumLinha] = "off";
    ajax_error_count["md_namadivre_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["md_iddivre_" + iNumLinha] = "on";
    ajax_read_only["md_kodedivre_" + iNumLinha] = "on";
    ajax_read_only["md_namadivre_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["md_iddivre_" + iNumLinha] = "on";
    ajax_read_only["md_kodedivre_" + iNumLinha] = "on";
    ajax_read_only["md_namadivre_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["md_iddivre_" + iNumLinha] = null;
    ajax_error_list["md_kodedivre_" + iNumLinha] = null;
    ajax_error_list["md_namadivre_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "md_iddivre_": new Array(),
    "md_kodedivre_": new Array(),
    "md_namadivre_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["md_iddivre_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["md_iddivre_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["md_iddivre_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["md_iddivre_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["md_iddivre_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["md_kodedivre_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["md_kodedivre_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["md_kodedivre_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["md_kodedivre_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["md_kodedivre_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["md_namadivre_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["md_namadivre_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["md_namadivre_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["md_namadivre_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["md_namadivre_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['md_iddivre_'])) ? $this->nmgp_cmp_readonly['md_iddivre_'] : 'on';
?>
    scAjaxFieldRead("md_iddivre_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['md_kodedivre_'])) ? $this->nmgp_cmp_readonly['md_kodedivre_'] : 'on';
?>
    scAjaxFieldRead("md_kodedivre_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['md_namadivre_'])) ? $this->nmgp_cmp_readonly['md_namadivre_'] : 'off';
?>
    scAjaxFieldRead("md_namadivre_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("md_iddivre_" + iSeq, "on");
    scAjaxFieldRead("md_kodedivre_" + iSeq, "on");
    scAjaxFieldRead("md_namadivre_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["md_iddivre_" + iRow] || "on" == ajax_error_count["md_kodedivre_" + iRow] || "on" == ajax_error_count["md_namadivre_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_md_iddivre_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_md_kodedivre_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_md_namadivre_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["md_iddivre_" + iRow] && "off" == ajax_error_count["md_kodedivre_" + iRow] && "off" == ajax_error_count["md_namadivre_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["md_iddivre_" + iRow] = "off";
        ajax_error_count["md_kodedivre_" + iRow] = "off";
        ajax_error_count["md_namadivre_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_md_iddivre_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_md_kodedivre_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_md_namadivre_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("md_iddivre_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
    }
    if ("md_kodedivre_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
    }
    if ("md_namadivre_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
