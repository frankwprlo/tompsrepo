...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_entry_project"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
var var_btn_generate_odp_new_namawitel = "<?php echo $this->form_encode_input($this->nmgp_dados_form['tp_witel']); ?>";
var var_btn_generate_odp_new_namasto = "<?php echo $this->form_encode_input($this->nmgp_dados_form['tp_sto']); ?>";
var var_btn_generate_odp_new_var_lop = "<?php echo $this->form_encode_input($this->nmgp_dados_form['tp_idlop']); ?>";
var var_btn_generate_odp_new_var_lokasi = "<?php echo $this->form_encode_input($this->nmgp_dados_form['tp_lokasi']); ?>";
var var_btn_generate_odp_new_var_namaproject = "<?php echo $this->form_encode_input($this->nmgp_dados_form['tp_projectname']); ?>";
function sc_btn_generate_odp_new()
{
  ...
  nm_gp_submit('<?php echo $this->Ini->link_form_master_odp_edit; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "var_projectid*scin' + var_btn_generate_odp_new_var_projectid + '*scoutnamawitel*scin' + var_btn_generate_odp_new_namawitel + '*scoutnamasto*scin' + var_btn_generate_odp_new_namasto + '*scoutvar_lop*scin' + var_btn_generate_odp_new_var_lop + '*scoutvar_lokasi*scin' + var_btn_generate_odp_new_var_lokasi + '*scoutvar_namaproject*scin' + var_btn_generate_odp_new_var_namaproject + '*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinS*scout"; ?>', '', '_self', '0', '0', 'form_master_odp');
}
var var_btn_generatejadwal_glob_mileage = "<?php echo $this->form_encode_input($this->nmgp_dados_form['tp_planstart']); ?>";
var var_btn_generatejadwal_var_var_tglmulaiproject = "<?php echo $this->form_encode_input($this->nmgp_dados_form['tp_planstart']); ?>";
var var_btn_generatejadwal_var_idproject = "<?php echo $this->form_encode_input($this->nmgp_dados_form['tp_id']); ?>";
var var_btn_generatejadwal_var_tpp_idproject = "<?php echo $this->form_encode_input($this->nmgp_dados_form['tp_id']); ?>";
function sc_btn_generatejadwal()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_generatejadwal(); }, 500);
      return;
    }
  nm_gp_submit('<?php echo $this->Ini->link_timeplan_tahapan_new_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "glob_mileage*scin' + var_btn_generatejadwal_glob_mileage + '*scoutvar_var_tglmulaiproject*scin' + var_btn_generatejadwal_var_var_tglmulaiproject + '*scoutvar_idproject*scin' + var_btn_generatejadwal_var_idproject + '*scoutvar_tpp_idproject*scin' + var_btn_generatejadwal_var_tpp_idproject + '*scout"; ?>', 'inicio', '_self', '0', '0', 'timeplan_tahapan_new');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project']['where_detal']))
  {
?>  
