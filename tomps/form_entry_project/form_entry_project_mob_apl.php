<?php
//
class form_entry_project_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_entry_project_mob']['nm_run_menu'] = 1;
      } 
      if (isset($_SESSION['sc_session'][$script_case_init]['form_entry_project_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_entry_project_mob']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_entry_project_mob']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_entry_project_mob($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_entry_project_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_entry_project_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_entry_project_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_entry_project_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->idwitel)) 
          {
              $_SESSION['idwitel'] = $this->idwitel;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_entry_project_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_entry_project_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_entry_project_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_entry_project_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_entry_project_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_entry_project_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_entry_project_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_entry_project_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_entry_project_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_entry_project_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_entry_project']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_entry_project'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_entry_project_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_entry_project_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_entry_project_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_entry_project_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_entry_project_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_entry_project_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_entry_project_mob']['label'] = "Form Update Data Proyek";
      ...
      $_SESSION['scriptcase']['error_icon']['form_entry_project_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_entry_project_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_orig'] = " where TP_WITEL=" . $_SESSION['idwitel'] . " AND TP_DIVRE=" . $_SESSION['iddivre'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_pesq'] = " where TP_WITEL=" . $_SESSION['idwitel'] . " AND TP_DIVRE=" . $_SESSION['iddivre'] . "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_entry_project_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_entry_project_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_entry_project_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['dados_form'];
          ...
          if (!isset($this->demo)){$this->demo = $this->nmgp_dados_form['demo'];} 
          if (!isset($this->coba)){$this->coba = $this->nmgp_dados_form['coba'];} 
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_entry_project_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_entry_project/form_entry_project_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_entry_project_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_entry_project_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_entry_project_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_entry_project/form_entry_project_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_entry_project_mob_erro.class.php"); 
      }
      $this->Erro      = new form_entry_project_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['opcao']))
         { 
             if ($this->tp_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_entry_project_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['generate_odp_new'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['botoes']['generate_odp_new'];
          $this->nmgp_botoes['generatejadwal'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['botoes']['generatejadwal'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      //-- demo
      $this->field_config['demo']               = array();
      $this->field_config['demo']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['demo']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['demo']['symbol_dec'] = '';
      $this->field_config['demo']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['demo']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- coba
      $this->field_config['coba']               = array();
      $this->field_config['coba']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_val'];
      $this->field_config['coba']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit'];
      $this->field_config['coba']['symbol_dec'] = $_SESSION['scriptcase']['reg_conf']['dec_val'];
      $this->field_config['coba']['symbol_mon'] = '';
      $this->field_config['coba']['format_pos'] = $_SESSION['scriptcase']['reg_conf']['monet_f_pos'];
      $this->field_config['coba']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['monet_f_neg'];
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          form_entry_project_mob_pack_ajax_response();
          exit;
      }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['scriptcase']['form_entry_project_mob']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['recarga'] = $this->nmgp_opcao;
      }
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_entry_project_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_entry_project_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_entry_project_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_entry_project_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
;
    ...
    {
        global $teste_validade;
               if (!empty($this->tp_thn_release) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_thn_release']) && !in_array($this->tp_thn_release, $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_thn_release']))
               {
    ...
    {
        global $teste_validade;
      if ($this->tp_prjtrelease == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_prjtrelease']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_prjtrelease'] == "on"))
      {
          ...
          if (!empty($this->tp_prjtrelease) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_prjtrelease']) && !in_array($this->tp_prjtrelease, $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_prjtrelease']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_prjtrelease']))
              {
    ...
    {
        global $teste_validade;
               if (!empty($this->tp_batch) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_batch']) && !in_array($this->tp_batch, $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_batch']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if ($this->nmgp_opcao == "incluir")
   {
      if ($this->tp_templateproject == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_templateproject']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_templateproject'] == "on"))
      {
          ...
          if (!empty($this->tp_templateproject) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_templateproject']) && !in_array($this->tp_templateproject, $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_templateproject']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_templateproject']))
              {
    ...
    function ValidateField_tp_targetwaktu(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_targetwaktu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_targetwaktu'] == "on") 
           { 
    ...
    {
        global $teste_validade;
      if ($this->tp_jenisproject == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_jenisproject']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_jenisproject'] == "on"))
      {
          ...
          if (!empty($this->tp_jenisproject) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_jenisproject']) && !in_array($this->tp_jenisproject, $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_jenisproject']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_jenisproject']))
              {
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_projectname']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_projectname'] == "on")) 
      { 
    ...
    function ValidateField_tp_planstart(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif ((!$this->NM_ajax_flag || 'validate_tp_planstart' != $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_planstart']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_planstart'] == "on")) 
           { 
    ...
    function ValidateField_tp_planfinish(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif ((!$this->NM_ajax_flag || 'validate_tp_planfinish' != $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_planfinish']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_planfinish'] == "on")) 
           { 
    ...
    {
        global $teste_validade;
      if ($this->tp_divre == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_divre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_divre'] == "on"))
      {
          $Campos_Falta[] = "Divre" ; 
          ...
          if (!empty($this->tp_divre) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_divre']) && !in_array($this->tp_divre, $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_divre']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_divre']))
              {
    ...
    {
        global $teste_validade;
      if ($this->tp_witel == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_witel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_witel'] == "on"))
      {
          $Campos_Falta[] = "Witel" ; 
          ...
          if (!empty($this->tp_witel) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_witel']) && !in_array($this->tp_witel, $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_witel']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_witel']))
              {
    ...
    {
        global $teste_validade;
      if ($this->tp_datel == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_datel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_datel'] == "on"))
      {
          $Campos_Falta[] = "Datel" ; 
          ...
          if (!empty($this->tp_datel) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_datel']) && !in_array($this->tp_datel, $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_datel']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_datel']))
              {
    ...
    {
        global $teste_validade;
      if ($this->tp_sto == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_sto']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_sto'] == "on"))
      {
          $Campos_Falta[] = "STO" ; 
          ...
          if (!empty($this->tp_sto) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_sto']) && !in_array($this->tp_sto, $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_sto']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_sto']))
              {
    ...
    {
        global $teste_validade;
      if ($this->tp_mitra == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_mitra']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['php_cmp_required']['tp_mitra'] == "on"))
      {
          $Campos_Falta[] = "Mitra" ; 
          ...
          if (!empty($this->tp_mitra) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_mitra']) && !in_array($this->tp_mitra, $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_mitra']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tp_mitra']))
              {
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['demo'] = $this->demo;
    $this->nmgp_dados_form['coba'] = $this->coba;
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['dados_form'] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      nm_limpa_numero($this->demo, $this->field_config['demo']['symbol_grp']) ; 
      if (!empty($this->field_config['coba']['symbol_dec']))
      {
         $this->sc_remove_currency($this->coba, $this->field_config['coba']['symbol_dec'], $this->field_config['coba']['symbol_grp'], $this->field_config['coba']['symbol_mon']);
         nm_limpa_valor($this->coba, $this->field_config['coba']['symbol_dec'], $this->field_config['coba']['symbol_grp']);
      }
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['tp_id']['keyVal'] = form_entry_project_mob_pack_protect_string($this->nmgp_dados_form['tp_id']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_thn_release']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_thn_release'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_thn_release']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_thn_release'] = array(); 
}
$aLookup[] = array(form_entry_project_mob_pack_protect_string('') => form_entry_project_mob_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_thn_release'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_entry_project_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_entry_project_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])));
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_thn_release'][] = $rs->fields[0];
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_thn_release']['valList'][$i] = form_entry_project_mob_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_prjtrelease']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_prjtrelease'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_prjtrelease']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_prjtrelease'] = array(); 
}
$aLookup[] = array(form_entry_project_mob_pack_protect_string('') => form_entry_project_mob_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_prjtrelease'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(form_entry_project_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_entry_project_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_prjtrelease'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_prjtrelease']['valList'][$i] = form_entry_project_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_batch']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_batch'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_batch']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_batch'] = array(); 
}
$aLookup[] = array(form_entry_project_mob_pack_protect_string('') => form_entry_project_mob_pack_protect_string('Pilh Batch'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_batch'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_batch'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_batch']['valList'][$i] = form_entry_project_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_templateproject']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_templateproject'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_templateproject']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_templateproject'] = array(); 
}
$aLookup[] = array(form_entry_project_mob_pack_protect_string('') => form_entry_project_mob_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_templateproject'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_templateproject'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_templateproject']['valList'][$i] = form_entry_project_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_jenisproject']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_jenisproject'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_jenisproject']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_jenisproject'] = array(); 
}
$aLookup[] = array(form_entry_project_mob_pack_protect_string('') => form_entry_project_mob_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_jenisproject'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_jenisproject'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_jenisproject']['valList'][$i] = form_entry_project_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_divre']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_divre'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_divre']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_divre'] = array(); 
}
$aLookup[] = array(form_entry_project_mob_pack_protect_string('') => form_entry_project_mob_pack_protect_string('Pilih Divre'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_divre'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_divre'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_divre']['valList'][$i] = form_entry_project_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_witel']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_witel'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_witel']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_witel'] = array(); 
}
$aLookup[] = array(form_entry_project_mob_pack_protect_string('') => form_entry_project_mob_pack_protect_string('Pilih Witel'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_witel'][] = '';
if ($this->tp_divre != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_witel'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_witel']['valList'][$i] = form_entry_project_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_datel']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_datel'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_datel']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_datel'] = array(); 
}
$aLookup[] = array(form_entry_project_mob_pack_protect_string('') => form_entry_project_mob_pack_protect_string(''));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_datel'][] = '';
if ($this->tp_witel != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_datel'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_datel']['valList'][$i] = form_entry_project_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_sto']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_sto'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_sto']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_sto'] = array(); 
}
$aLookup[] = array(form_entry_project_mob_pack_protect_string('') => form_entry_project_mob_pack_protect_string('Pilih STO'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_sto'][] = '';
if ($this->tp_datel != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_sto'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_sto']['valList'][$i] = form_entry_project_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_mitra']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_mitra'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_mitra']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_mitra'] = array(); 
}
$aLookup[] = array(form_entry_project_mob_pack_protect_string('') => form_entry_project_mob_pack_protect_string('Pilih Mitra'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_mitra'][] = '';
...
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['Lookup_tp_mitra'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tp_mitra']['valList'][$i] = form_entry_project_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_tp_jmldistribusi($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
   ...
   function ajax_add_parameters()
   {
       ...
       $this->NM_ajax_info['btnVars']['var_btn_generate_odp_new_namawitel'] = $this->form_encode_input($this->nmgp_dados_form['tp_witel']);
       $this->NM_ajax_info['btnVars']['var_btn_generate_odp_new_namasto'] = $this->form_encode_input($this->nmgp_dados_form['tp_sto']);
       $this->NM_ajax_info['btnVars']['var_btn_generate_odp_new_var_lop'] = $this->form_encode_input($this->nmgp_dados_form['tp_idlop']);
       $this->NM_ajax_info['btnVars']['var_btn_generate_odp_new_var_lokasi'] = $this->form_encode_input($this->nmgp_dados_form['tp_lokasi']);
       $this->NM_ajax_info['btnVars']['var_btn_generate_odp_new_var_namaproject'] = $this->form_encode_input($this->nmgp_dados_form['tp_projectname']);
       ...
       $this->NM_ajax_info['btnVars']['var_btn_generatejadwal_var_tpp_idproject'] = $this->form_encode_input($this->nmgp_dados_form['tp_id']);
   } // ajax_add_parameters
  function nm_proc_onload($bFormat = true)
  {
      if ($this->sc_evento == "novo" || $this->sc_evento == "incluir" || ($this->nmgp_opcao == "nada" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['opc_ant']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['opc_ant'] == "novo") || (isset($GLOBALS['erro_incl']) && 1 == $GLOBALS['erro_incl']))
      {
      }
      else
      {
          if (!isset($this->nmgp_cmp_hidden["tp_templateproject"]))
          {
              $this->nmgp_cmp_hidden["tp_templateproject"] = "off"; $this->NM_ajax_info['fieldDisplay']['tp_templateproject'] = 'off';
          }
      }
      $this->nm_guardar_campos();
...
//
   ...
   { 
      ...
      $this->coba = str_replace($sc_parm1, $sc_parm2, $this->coba); 
   } 
   ...
   { 
      ...
      $this->coba = str_replace("'", "", $this->coba); 
   } 
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->tp_id)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
   ...
   { 
      ...
      $NM_val_form['demo'] = $this->demo;
      $NM_val_form['coba'] = $this->coba;
      if ($this->tp_id == "")  
      { 
          $this->tp_id = 0;
      } 
      ...
      { 
          $this->demo = 0;
          $this->sc_force_zero[] = 'demo';
      } 
      if ($this->coba == "")  
      { 
          $this->coba = 0;
          $this->sc_force_zero[] = 'coba';
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_ex_update = true; 
          $SC_ex_upd_or = true; 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              if (isset($NM_val_form['tp_templateproject']) && $NM_val_form['tp_templateproject'] != $this->nmgp_dados_select['tp_templateproject']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " TP_TEMPLATEPROJECT = $this->tp_templateproject"; 
                  $comando_oracle        .= " TP_TEMPLATEPROJECT = $this->tp_templateproject"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              ...
              if (isset($NM_val_form['demo']) && $NM_val_form['demo'] != $this->nmgp_dados_select['demo']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " DEMO = $this->demo"; 
                  $comando_oracle        .= " DEMO = $this->demo"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              if (isset($NM_val_form['coba']) && $NM_val_form['coba'] != $this->nmgp_dados_select['coba']) 
              { 
                  if ($SC_ex_update || $SC_tem_cmp_update) 
                  { 
                      $comando        .= ","; 
                  ...
                  $comando        .= " COBA = $this->coba"; 
                  $comando_oracle        .= " COBA = $this->coba"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              $aDoNotUpdate = array();
          ...
          $this->tp_thn_release = $this->tp_thn_release_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['db_changed'] = true;
      ...
      { 
          ...
          { 
              $NM_seq_auto = "NEXT VALUE FOR TBL_PROJECT_SEQ, ";
              $NM_cmp_auto = "TP_ID, ";
          } 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          { 
              $NM_seq_auto = "TBL_PROJECT_SEQ.NEXTVAL, ";
              $NM_cmp_auto = "TP_ID, ";
          } 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
          { 
              $NM_seq_auto = "nextval('TBL_PROJECT_SEQ'), ";
              $NM_cmp_auto = "TP_ID, ";
          } 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $NM_seq_auto = "gen_id(TBL_PROJECT_SEQ, 1), ";
              $NM_cmp_auto = "TP_ID, ";
          } 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (TP_BATCH, TP_PROJECTNAME, TP_LOKASI, TP_MITRA, TP_WITEL, TP_STO, TP_ODP, TP_PLANSTART, TP_PLANFINISH, TP_ENTRYDATE, TP_ENTRYBY, TP_UPDATEDATE, TP_UPDATEBY, TP_SUMMARY, TP_STATUS, TP_ACTUALSTART, TP_ACTUALFINISH, TP_TEMPLATEPROJECT, TP_JENISPROJECT, TP_PRJTRELEASE, TP_TARGETWAKTU, TP_DATEL, TP_NOKONTRAK, TP_PONUMBER, TP_DIVRE, TP_IDLOP, TP_NAMALOP, TP_NILAI, TP_RAB, TP_IS_CHANGE_TEMPLATE, TP_ISCHANGETEMPBY, TP_ISCHANGETEMPDATE, TP_JMLDISTRIBUSI, TP_TASKAKTIF, TP_TASKAKTIF_NUMBER, TP_PROSENTASE, TP_TAHAPANAKTIF, TP_TASKAKTIFSTATUS, TP_TASKAKTIFPLANSTART, TP_TASKAKTIFPLANFINISH, TP_JMLPORT, TP_THN_RELEASE, DEMO, COBA) VALUES ('$this->tp_batch', '$this->tp_projectname', '$this->tp_lokasi', $this->tp_mitra, $this->tp_witel, $this->tp_sto, $this->tp_odp, #$this->tp_planstart#, #$this->tp_planfinish#, #$this->tp_entrydate#, '$this->tp_entryby', #$this->tp_updatedate#, '$this->tp_updateby', '$this->tp_summary', $this->tp_status, #$this->tp_actualstart#, #$this->tp_actualfinish#, $this->tp_templateproject, $this->tp_jenisproject, $this->tp_prjtrelease, $this->tp_targetwaktu, $this->tp_datel, '$this->tp_nokontrak', '$this->tp_ponumber', $this->tp_divre, '$this->tp_idlop', '$this->tp_namalop', $this->tp_nilai, $this->tp_rab, '$this->tp_is_change_template', '$this->tp_ischangetempby', #$this->tp_ischangetempdate#, $this->tp_jmldistribusi, '$this->tp_taskaktif', $this->tp_taskaktif_number, $this->tp_prosentase, '$this->tp_tahapanaktif', $this->tp_taskaktifstatus, #$this->tp_taskaktifplanstart#, #$this->tp_taskaktifplanfinish#, $this->tp_jmlport, '$this->tp_thn_release', $this->demo, $this->coba)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (TP_BATCH, TP_PROJECTNAME, TP_LOKASI, TP_MITRA, TP_WITEL, TP_STO, TP_ODP, TP_PLANSTART, TP_PLANFINISH, TP_ENTRYDATE, TP_ENTRYBY, TP_UPDATEDATE, TP_UPDATEBY, TP_SUMMARY, TP_STATUS, TP_ACTUALSTART, TP_ACTUALFINISH, TP_TEMPLATEPROJECT, TP_JENISPROJECT, TP_PRJTRELEASE, TP_TARGETWAKTU, TP_DATEL, TP_NOKONTRAK, TP_PONUMBER, TP_DIVRE, TP_IDLOP, TP_NAMALOP, TP_NILAI, TP_RAB, TP_IS_CHANGE_TEMPLATE, TP_ISCHANGETEMPBY, TP_ISCHANGETEMPDATE, TP_JMLDISTRIBUSI, TP_TASKAKTIF, TP_TASKAKTIF_NUMBER, TP_PROSENTASE, TP_TAHAPANAKTIF, TP_TASKAKTIFSTATUS, TP_TASKAKTIFPLANSTART, TP_TASKAKTIFPLANFINISH, TP_JMLPORT, TP_THN_RELEASE, DEMO, COBA) VALUES ('$this->tp_batch', '$this->tp_projectname', '$this->tp_lokasi', $this->tp_mitra, $this->tp_witel, $this->tp_sto, $this->tp_odp, " . $this->Ini->date_delim . $this->tp_planstart . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->tp_planfinish . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->tp_entrydate . $this->Ini->date_delim1 . ", '$this->tp_entryby', " . $this->Ini->date_delim . $this->tp_updatedate . $this->Ini->date_delim1 . ", '$this->tp_updateby', '$this->tp_summary', $this->tp_status, " . $this->Ini->date_delim . $this->tp_actualstart . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->tp_actualfinish . $this->Ini->date_delim1 . ", $this->tp_templateproject, $this->tp_jenisproject, $this->tp_prjtrelease, $this->tp_targetwaktu, $this->tp_datel, '$this->tp_nokontrak', '$this->tp_ponumber', $this->tp_divre, '$this->tp_idlop', '$this->tp_namalop', $this->tp_nilai, $this->tp_rab, '$this->tp_is_change_template', '$this->tp_ischangetempby', " . $this->Ini->date_delim . $this->tp_ischangetempdate . $this->Ini->date_delim1 . ", $this->tp_jmldistribusi, '$this->tp_taskaktif', $this->tp_taskaktif_number, $this->tp_prosentase, '$this->tp_tahapanaktif', $this->tp_taskaktifstatus, " . $this->Ini->date_delim . $this->tp_taskaktifplanstart . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->tp_taskaktifplanfinish . $this->Ini->date_delim1 . ", $this->tp_jmlport, '$this->tp_thn_release', $this->demo, $this->coba)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "TP_BATCH, TP_PROJECTNAME, TP_LOKASI, TP_MITRA, TP_WITEL, TP_STO, TP_ODP, TP_PLANSTART, TP_PLANFINISH, TP_ENTRYDATE, TP_ENTRYBY, TP_UPDATEDATE, TP_UPDATEBY, TP_SUMMARY, TP_STATUS, TP_ACTUALSTART, TP_ACTUALFINISH, TP_TEMPLATEPROJECT, TP_JENISPROJECT, TP_PRJTRELEASE, TP_TARGETWAKTU, TP_DATEL, TP_NOKONTRAK, TP_PONUMBER, TP_DIVRE, TP_IDLOP, TP_NAMALOP, TP_NILAI, TP_RAB, TP_IS_CHANGE_TEMPLATE, TP_ISCHANGETEMPBY, TP_ISCHANGETEMPDATE, TP_JMLDISTRIBUSI, TP_TASKAKTIF, TP_TASKAKTIF_NUMBER, TP_PROSENTASE, TP_TAHAPANAKTIF, TP_TASKAKTIFSTATUS, TP_TASKAKTIFPLANSTART, TP_TASKAKTIFPLANFINISH, TP_JMLPORT, TP_THN_RELEASE, DEMO, COBA) VALUES (" . $NM_seq_auto . "'$this->tp_batch', '$this->tp_projectname', '$this->tp_lokasi', $this->tp_mitra, $this->tp_witel, $this->tp_sto, $this->tp_odp, " . $this->Ini->date_delim . $this->tp_planstart . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->tp_planfinish . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->tp_entrydate . $this->Ini->date_delim1 . ", '$this->tp_entryby', " . $this->Ini->date_delim . $this->tp_updatedate . $this->Ini->date_delim1 . ", '$this->tp_updateby', EMPTY_CLOB(), $this->tp_status, " . $this->Ini->date_delim . $this->tp_actualstart . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->tp_actualfinish . $this->Ini->date_delim1 . ", $this->tp_templateproject, $this->tp_jenisproject, $this->tp_prjtrelease, $this->tp_targetwaktu, $this->tp_datel, '$this->tp_nokontrak', '$this->tp_ponumber', $this->tp_divre, '$this->tp_idlop', '$this->tp_namalop', $this->tp_nilai, $this->tp_rab, '$this->tp_is_change_template', '$this->tp_ischangetempby', " . $this->Ini->date_delim . $this->tp_ischangetempdate . $this->Ini->date_delim1 . ", $this->tp_jmldistribusi, '$this->tp_taskaktif', $this->tp_taskaktif_number, $this->tp_prosentase, '$this->tp_tahapanaktif', $this->tp_taskaktifstatus, " . $this->Ini->date_delim . $this->tp_taskaktifplanstart . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->tp_taskaktifplanfinish . $this->Ini->date_delim1 . ", $this->tp_jmlport, '$this->tp_thn_release', $this->demo, $this->coba)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "TP_BATCH, TP_PROJECTNAME, TP_LOKASI, TP_MITRA, TP_WITEL, TP_STO, TP_ODP, TP_PLANSTART, TP_PLANFINISH, TP_ENTRYDATE, TP_ENTRYBY, TP_UPDATEDATE, TP_UPDATEBY, TP_SUMMARY, TP_STATUS, TP_ACTUALSTART, TP_ACTUALFINISH, TP_TEMPLATEPROJECT, TP_JENISPROJECT, TP_PRJTRELEASE, TP_TARGETWAKTU, TP_DATEL, TP_NOKONTRAK, TP_PONUMBER, TP_DIVRE, TP_IDLOP, TP_NAMALOP, TP_NILAI, TP_RAB, TP_IS_CHANGE_TEMPLATE, TP_ISCHANGETEMPBY, TP_ISCHANGETEMPDATE, TP_JMLDISTRIBUSI, TP_TASKAKTIF, TP_TASKAKTIF_NUMBER, TP_PROSENTASE, TP_TAHAPANAKTIF, TP_TASKAKTIFSTATUS, TP_TASKAKTIFPLANSTART, TP_TASKAKTIFPLANFINISH, TP_JMLPORT, TP_THN_RELEASE, DEMO, COBA) VALUES (" . $NM_seq_auto . "'$this->tp_batch', '$this->tp_projectname', '$this->tp_lokasi', $this->tp_mitra, $this->tp_witel, $this->tp_sto, $this->tp_odp, EXTEND('$this->tp_planstart', YEAR TO DAY), EXTEND('$this->tp_planfinish', YEAR TO DAY), EXTEND('$this->tp_entrydate', YEAR TO DAY), '$this->tp_entryby', EXTEND('$this->tp_updatedate', YEAR TO DAY), '$this->tp_updateby', null, $this->tp_status, EXTEND('$this->tp_actualstart', YEAR TO DAY), EXTEND('$this->tp_actualfinish', YEAR TO DAY), $this->tp_templateproject, $this->tp_jenisproject, $this->tp_prjtrelease, $this->tp_targetwaktu, $this->tp_datel, '$this->tp_nokontrak', '$this->tp_ponumber', $this->tp_divre, '$this->tp_idlop', '$this->tp_namalop', $this->tp_nilai, $this->tp_rab, '$this->tp_is_change_template', '$this->tp_ischangetempby', EXTEND('$this->tp_ischangetempdate', YEAR TO DAY), $this->tp_jmldistribusi, '$this->tp_taskaktif', $this->tp_taskaktif_number, $this->tp_prosentase, '$this->tp_tahapanaktif', $this->tp_taskaktifstatus, EXTEND('$this->tp_taskaktifplanstart', YEAR TO DAY), EXTEND('$this->tp_taskaktifplanfinish', YEAR TO DAY), $this->tp_jmlport, '$this->tp_thn_release', $this->demo, $this->coba)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "TP_BATCH, TP_PROJECTNAME, TP_LOKASI, TP_MITRA, TP_WITEL, TP_STO, TP_ODP, TP_PLANSTART, TP_PLANFINISH, TP_ENTRYDATE, TP_ENTRYBY, TP_UPDATEDATE, TP_UPDATEBY, TP_SUMMARY, TP_STATUS, TP_ACTUALSTART, TP_ACTUALFINISH, TP_TEMPLATEPROJECT, TP_JENISPROJECT, TP_PRJTRELEASE, TP_TARGETWAKTU, TP_DATEL, TP_NOKONTRAK, TP_PONUMBER, TP_DIVRE, TP_IDLOP, TP_NAMALOP, TP_NILAI, TP_RAB, TP_IS_CHANGE_TEMPLATE, TP_ISCHANGETEMPBY, TP_ISCHANGETEMPDATE, TP_JMLDISTRIBUSI, TP_TASKAKTIF, TP_TASKAKTIF_NUMBER, TP_PROSENTASE, TP_TAHAPANAKTIF, TP_TASKAKTIFSTATUS, TP_TASKAKTIFPLANSTART, TP_TASKAKTIFPLANFINISH, TP_JMLPORT, TP_THN_RELEASE, DEMO, COBA) VALUES (" . $NM_seq_auto . "'$this->tp_batch', '$this->tp_projectname', '$this->tp_lokasi', $this->tp_mitra, $this->tp_witel, $this->tp_sto, $this->tp_odp, " . $this->Ini->date_delim . $this->tp_planstart . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->tp_planfinish . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->tp_entrydate . $this->Ini->date_delim1 . ", '$this->tp_entryby', " . $this->Ini->date_delim . $this->tp_updatedate . $this->Ini->date_delim1 . ", '$this->tp_updateby', '', $this->tp_status, " . $this->Ini->date_delim . $this->tp_actualstart . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->tp_actualfinish . $this->Ini->date_delim1 . ", $this->tp_templateproject, $this->tp_jenisproject, $this->tp_prjtrelease, $this->tp_targetwaktu, $this->tp_datel, '$this->tp_nokontrak', '$this->tp_ponumber', $this->tp_divre, '$this->tp_idlop', '$this->tp_namalop', $this->tp_nilai, $this->tp_rab, '$this->tp_is_change_template', '$this->tp_ischangetempby', " . $this->Ini->date_delim . $this->tp_ischangetempdate . $this->Ini->date_delim1 . ", $this->tp_jmldistribusi, '$this->tp_taskaktif', $this->tp_taskaktif_number, $this->tp_prosentase, '$this->tp_tahapanaktif', $this->tp_taskaktifstatus, " . $this->Ini->date_delim . $this->tp_taskaktifplanstart . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->tp_taskaktifplanfinish . $this->Ini->date_delim1 . ", $this->tp_jmlport, '$this->tp_thn_release', $this->demo, $this->coba)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "TP_BATCH, TP_PROJECTNAME, TP_LOKASI, TP_MITRA, TP_WITEL, TP_STO, TP_ODP, TP_PLANSTART, TP_PLANFINISH, TP_ENTRYDATE, TP_ENTRYBY, TP_UPDATEDATE, TP_UPDATEBY, TP_SUMMARY, TP_STATUS, TP_ACTUALSTART, TP_ACTUALFINISH, TP_TEMPLATEPROJECT, TP_JENISPROJECT, TP_PRJTRELEASE, TP_TARGETWAKTU, TP_DATEL, TP_NOKONTRAK, TP_PONUMBER, TP_DIVRE, TP_IDLOP, TP_NAMALOP, TP_NILAI, TP_RAB, TP_IS_CHANGE_TEMPLATE, TP_ISCHANGETEMPBY, TP_ISCHANGETEMPDATE, TP_JMLDISTRIBUSI, TP_TASKAKTIF, TP_TASKAKTIF_NUMBER, TP_PROSENTASE, TP_TAHAPANAKTIF, TP_TASKAKTIFSTATUS, TP_TASKAKTIFPLANSTART, TP_TASKAKTIFPLANFINISH, TP_JMLPORT, TP_THN_RELEASE, DEMO, COBA) VALUES (" . $NM_seq_auto . "'$this->tp_batch', '$this->tp_projectname', '$this->tp_lokasi', $this->tp_mitra, $this->tp_witel, $this->tp_sto, $this->tp_odp, " . $this->Ini->date_delim . $this->tp_planstart . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->tp_planfinish . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->tp_entrydate . $this->Ini->date_delim1 . ", '$this->tp_entryby', " . $this->Ini->date_delim . $this->tp_updatedate . $this->Ini->date_delim1 . ", '$this->tp_updateby', '', $this->tp_status, " . $this->Ini->date_delim . $this->tp_actualstart . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->tp_actualfinish . $this->Ini->date_delim1 . ", $this->tp_templateproject, $this->tp_jenisproject, $this->tp_prjtrelease, $this->tp_targetwaktu, $this->tp_datel, '$this->tp_nokontrak', '$this->tp_ponumber', $this->tp_divre, '$this->tp_idlop', '$this->tp_namalop', $this->tp_nilai, $this->tp_rab, '$this->tp_is_change_template', '$this->tp_ischangetempby', " . $this->Ini->date_delim . $this->tp_ischangetempdate . $this->Ini->date_delim1 . ", $this->tp_jmldistribusi, '$this->tp_taskaktif', $this->tp_taskaktif_number, $this->tp_prosentase, '$this->tp_tahapanaktif', $this->tp_taskaktifstatus, " . $this->Ini->date_delim . $this->tp_taskaktifplanstart . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->tp_taskaktifplanfinish . $this->Ini->date_delim1 . ", $this->tp_jmlport, '$this->tp_thn_release', $this->demo, $this->coba)"; 
              ...
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "TP_BATCH, TP_PROJECTNAME, TP_LOKASI, TP_MITRA, TP_WITEL, TP_STO, TP_ODP, TP_PLANSTART, TP_PLANFINISH, TP_ENTRYDATE, TP_ENTRYBY, TP_UPDATEDATE, TP_UPDATEBY, TP_SUMMARY, TP_STATUS, TP_ACTUALSTART, TP_ACTUALFINISH, TP_TEMPLATEPROJECT, TP_JENISPROJECT, TP_PRJTRELEASE, TP_TARGETWAKTU, TP_DATEL, TP_NOKONTRAK, TP_PONUMBER, TP_DIVRE, TP_IDLOP, TP_NAMALOP, TP_NILAI, TP_RAB, TP_IS_CHANGE_TEMPLATE, TP_ISCHANGETEMPBY, TP_ISCHANGETEMPDATE, TP_JMLDISTRIBUSI, TP_TASKAKTIF, TP_TASKAKTIF_NUMBER, TP_PROSENTASE, TP_TAHAPANAKTIF, TP_TASKAKTIFSTATUS, TP_TASKAKTIFPLANSTART, TP_TASKAKTIFPLANFINISH, TP_JMLPORT, TP_THN_RELEASE, DEMO, COBA) VALUES (" . $NM_seq_auto . "'$this->tp_batch', '$this->tp_projectname', '$this->tp_lokasi', $this->tp_mitra, $this->tp_witel, $this->tp_sto, $this->tp_odp, " . $this->Ini->date_delim . $this->tp_planstart . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->tp_planfinish . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->tp_entrydate . $this->Ini->date_delim1 . ", '$this->tp_entryby', " . $this->Ini->date_delim . $this->tp_updatedate . $this->Ini->date_delim1 . ", '$this->tp_updateby', '$this->tp_summary', $this->tp_status, " . $this->Ini->date_delim . $this->tp_actualstart . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->tp_actualfinish . $this->Ini->date_delim1 . ", $this->tp_templateproject, $this->tp_jenisproject, $this->tp_prjtrelease, $this->tp_targetwaktu, $this->tp_datel, '$this->tp_nokontrak', '$this->tp_ponumber', $this->tp_divre, '$this->tp_idlop', '$this->tp_namalop', $this->tp_nilai, $this->tp_rab, '$this->tp_is_change_template', '$this->tp_ischangetempby', " . $this->Ini->date_delim . $this->tp_ischangetempdate . $this->Ini->date_delim1 . ", $this->tp_jmldistribusi, '$this->tp_taskaktif', $this->tp_taskaktif_number, $this->tp_prosentase, '$this->tp_tahapanaktif', $this->tp_taskaktifstatus, " . $this->Ini->date_delim . $this->tp_taskaktifplanstart . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->tp_taskaktifplanfinish . $this->Ini->date_delim1 . ", $this->tp_jmlport, '$this->tp_thn_release', $this->demo, $this->coba)"; 
              }
              $comando = str_replace("N'null'", "null", $comando) ; 
              $comando = str_replace("'null'", "null", $comando) ; 
              $comando = str_replace("#null#", "null", $comando) ; 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select TBL_PROJECT_SEQ.currval from dual"; 
                  $rsy = $this->Db->Execute($_SESSION['scriptcase']['sc_sql_ult_comando']); 
                  if ($rsy === false && !$rsy->EOF)  
                  { 
                      $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_db2))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "values PREVVAL FOR TBL_PROJECT_SEQ"; 
                  $rsy = $this->Db->Execute($_SESSION['scriptcase']['sc_sql_ult_comando']); 
                  if ($rsy === false && !$rsy->EOF)  
                  { 
                      $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select CURRVAL('TBL_PROJECT_SEQ')"; 
                  $rsy = $this->Db->Execute($_SESSION['scriptcase']['sc_sql_ult_comando']); 
                  if ($rsy === false && !$rsy->EOF)  
                  { 
                      $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select gen_id(TBL_PROJECT_SEQ, 0) from " . $this->Ini->nm_tabela; 
                  $rsy = $this->Db->Execute($_SESSION['scriptcase']['sc_sql_ult_comando']); 
                  if ($rsy === false && !$rsy->EOF)  
                  { 
                      $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['total']);
              }

              $this->sc_evento = "insert"; 
              $this->sc_insert_on = true; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_start'] = 0; 
              }
    ...
    if ("insert" == $this->sc_evento && $this->nmgp_opcao != "nada") {
        ...
        $_SESSION['scriptcase']['form_entry_project_mob']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_entry_project_mob']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['parms'] = "tp_id?#?$this->tp_id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['run_iframe'] == "R")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      ...
      { 
          ...
          $qt_geral_reg_form_entry_project_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['total'] = $qt_geral_reg_form_entry_project_mob;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->tp_id))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_entry_project_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_start'] > $qt_geral_reg_form_entry_project_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_start'] = $qt_geral_reg_form_entry_project_mob; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_entry_project_mob) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          { 
              ...
              $this->demo = $rs->fields[43] ; 
              $this->nmgp_dados_select['demo'] = $this->demo;
              $this->coba = $rs->fields[44] ; 
              $this->nmgp_dados_select['coba'] = $this->coba;
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              $this->nm_troca_decimal(",", ".");
              ...
              $this->demo = (string)$this->demo; 
              $this->coba = (string)$this->coba; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['parms'] = "tp_id?#?$this->tp_id?@?";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_start'] < $qt_geral_reg_form_entry_project_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['dados_select'];
                  ...
                  $this->demo = $this->nmgp_dados_select['demo'];  
                  $this->coba = $this->nmgp_dados_select['coba'];  
              }
          }
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['foreign_key']))
          {
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['reg_start'] + 1;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
if (false == $this->rs )     
{
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_entry_project_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$insert_table  = 'AKSESSMR.TBL_PROJECT_DETAIL';      
$insert_fields = array(   
     'PPO_ID' => "TBL_PROJECT_DETAIL_SEQ.NEXTVAL",
...
$insert_sql = 'INSERT INTO ' . $insert_table
    ...
    $this->rs->Close();
     ...
     $nm_select ="UPDATE AKSESSMR.TBL_PROJECT_CONTROL SET TPC_GENERATETASK='Y' WHERE TPC_IDPROJECT='$this->tp_id'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$insert_table_control  = 'AKSESSMR.TBL_PROJECT_CONTROL';      
...
$insert_table_mastodp  = 'AKSESSMR.TBL_PROJECT_MASTER_ODP';      
$insert_fields_mastodp = array(   
     'TPMO_ID' => "TBL_PROJECT_MASTER_ODP_SEQ.NEXTVAL",
...
$check_sql = "SELECT PROJECTPHASEID,PHASETARGET FROM AKSESSMR.TB_TAHAPAN_PROJECT WHERE TEMPLATEPROJECT='$this->tp_templateproject'";
...
$insert_fields = array(   
     'TPP_IDTABLE' => "TBL_PROJECT_PROGRESS_SEQ.NEXTVAL",
...
$insert_sql = 'INSERT INTO ' . $insert_table
    ...
    $this->rs->Close();
     ...
     $nm_select ="UPDATE AKSESSMR.TBL_PROJECT_CONTROL SET TPC_PROGRESSTASK='Y' WHERE TPC_IDPROJECT='$this->tp_id'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_entry_project_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['csrf_token'];
    }
...
{ 
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_filter_form'] . " and (TP_WITEL=" . $_SESSION['idwitel'] . " AND TP_DIVRE=" . $_SESSION['iddivre'] . ") and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_entry_project_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['total'] = $qt_geral_reg_form_entry_project_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_entry_project_mob_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_entry_project_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_entry_project_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['masterValue']))
{
...
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_entry_project_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
