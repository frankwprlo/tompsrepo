 ...
 */
    ...
    session_start();
    $SC_apl_proc = "v_resume_detailproject";
...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['v_resume_detailproject']['show_skip_charts_option']) || !$_SESSION['sc_session']['v_resume_detailproject']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
