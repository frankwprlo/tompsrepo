 ...
 */
    ...
    session_start();
    $SC_apl_proc = "resume_realisasi_project_inregional";
...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['resume_realisasi_project_inregional']['show_skip_charts_option']) || !$_SESSION['sc_session']['resume_realisasi_project_inregional']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
