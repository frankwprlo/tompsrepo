...
class resume_realisasi_project_inregional_resumo
{
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inregional']['summarizing_fields_order']['groupbywiteldanmitra']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inregional']['summarizing_fields_order']['groupbywiteldanmitra'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inregional']['summarizing_fields_order']['groupbywiteldanmitra'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inregional']['summarizing_fields_display']['groupbywiteldanmitra'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inregional']['summarizing_fields_display']['groupbywiteldanmitra'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inregional']['summarizing_fields_display']['groupbywiteldanmitra'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inregional']['summarizing_fields_display']['groupbywiteldanmitra'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inregional']['summarizing_fields_display']['groupbywiteldanmitra'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inregional']['summarizing_fields_display']['groupbywiteldanmitra'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['resume_realisasi_project_inregional']['summarizing_fields_display']['groupbywiteldanmitra'] as $i_sum => $d_sum)
           {
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_groupbywiteldanmitra("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_tp_rab, $sum_tp_nilai, $sum_tp_odp, $avg_realisasi, $quebra_tp_releasename, $quebra_tp_releasename_orig)
   {
      //----- Release Project
...
$_SESSION['scriptcase']['resume_realisasi_project_inregional']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->tp_rab, $this->tp_nilai, $this->tp_odp, $this->realisasi, $this->tp_releasename, $this->tp_releasename_orig);
            }
   }
//
