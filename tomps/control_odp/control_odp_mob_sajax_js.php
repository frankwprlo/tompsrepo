  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_odp_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate merk
  function do_ajax_control_odp_mob_validate_merk()
  {
    var nomeCampo_merk = "merk";
    var var_merk = scAjaxGetFieldText(nomeCampo_merk);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_odp_mob_validate_merk(var_merk, var_script_case_init, do_ajax_control_odp_mob_validate_merk_cb);
  } // do_ajax_control_odp_mob_validate_merk

  function do_ajax_control_odp_mob_validate_merk_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_odp_mob_validate_merk_cb

  // ---------- Validate kapasitas
  function do_ajax_control_odp_mob_validate_kapasitas()
  {
    var nomeCampo_kapasitas = "kapasitas";
    var var_kapasitas = scAjaxGetFieldText(nomeCampo_kapasitas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_odp_mob_validate_kapasitas(var_kapasitas, var_script_case_init, do_ajax_control_odp_mob_validate_kapasitas_cb);
  } // do_ajax_control_odp_mob_validate_kapasitas

  function do_ajax_control_odp_mob_validate_kapasitas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "kapasitas";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_odp_mob_validate_kapasitas_cb

  // ---------- Validate nosp
  function do_ajax_control_odp_mob_validate_nosp()
  {
    var nomeCampo_nosp = "nosp";
    var var_nosp = scAjaxGetFieldText(nomeCampo_nosp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_odp_mob_validate_nosp(var_nosp, var_script_case_init, do_ajax_control_odp_mob_validate_nosp_cb);
  } // do_ajax_control_odp_mob_validate_nosp

  function do_ajax_control_odp_mob_validate_nosp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nosp";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_odp_mob_validate_nosp_cb
  // ---------- Form
  function do_ajax_control_odp_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_odp_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_merk = scAjaxGetFieldText("merk");
    var var_kapasitas = scAjaxGetFieldText("kapasitas");
    var var_nosp = scAjaxGetFieldText("nosp");
    ...
    scAjaxProcOn();
    x_ajax_control_odp_mob_submit_form(var_merk, var_kapasitas, var_nosp, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_odp_mob_submit_form_cb);
  } // do_ajax_control_odp_mob_submit_form

  function do_ajax_control_odp_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_control_odp_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_odp_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_odp_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_odp_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_odp_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_control_odp_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_odp_mob_navigate_form_cb
  function sc_hide_control_odp_mob_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_odp_mob_form
  ...
  ajax_field_list[0] = "merk";
  ajax_field_list[1] = "kapasitas";
  ajax_field_list[2] = "nosp";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "merk": {"label": "Merk", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "kapasitas": {"label": "Kapasitas ODP", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nosp": {"label": "NO SP", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["merk"][1] = "merk";
  ajax_field_mult["kapasitas"][1] = "kapasitas";
  ajax_field_mult["nosp"][1] = "nosp";

  var ajax_field_id = {
    "merk": new Array("hidden_field_label_merk", "hidden_field_data_merk"),
    "kapasitas": new Array("hidden_field_label_kapasitas", "hidden_field_data_kapasitas"),
    "nosp": new Array("hidden_field_label_nosp", "hidden_field_data_nosp")
  };
