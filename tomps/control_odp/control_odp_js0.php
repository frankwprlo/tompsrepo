...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['control_odp']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="control_odp"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
var Crtl_btn_test = false;
function sc_btn_test()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_test(); }, 500);
      return;
    }
    if (Crtl_btn_test) {return;}
    Crtl_btn_test = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?test?@?";
    document.F1.action = "./";
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_odp']['where_detal']))
  {
?>  
...
{ 
   ...
   document.F4.action               = "control_odp_fim.php";
   document.F4.submit(); 
} 
