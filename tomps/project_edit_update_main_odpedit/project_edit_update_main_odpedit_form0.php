...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("project_edit_update_main_odpedit_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('project_edit_update_main_odpedit_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['recarga'];
}
?>
...
<?php
 include_once("project_edit_update_main_odpedit_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['project_edit_update_main_odpedit'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['project_edit_update_main_odpedit'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<ul class="scTabLine">
<li id="id_tabs_0_0" class="scTabActive"><a href="javascript: sc_control_tabs_0(0)">ODP Master</a></li>
<li id="id_tabs_0_1" class="scTabInactive"><a href="javascript: sc_control_tabs_0(1)">ODP Detail</a></li>
</ul>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tpmo_id_line" id="hidden_field_data_tpmo_id" style="<?php echo $sStyleHidden_tpmo_id; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tpmo_id_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tpmo_id_label"><span id="id_label_tpmo_id"><?php echo $this->nm_new_label['tpmo_id']; ?></span></span><br>
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { 
 ?>
<span id="id_read_on_tpmo_id" css_tpmo_id_line" style="<?php echo $sStyleReadLab_tpmo_id; ?>"><?php echo $this->form_encode_input($this->tpmo_id); ?></span><span id="id_read_off_tpmo_id" style="<?php echo $sStyleReadInp_tpmo_id; ?>"><input type="hidden" name="tpmo_id" value="<?php echo $this->form_encode_input($tpmo_id) . "\">"?><span id="id_ajax_label_tpmo_id"><?php echo nl2br($tpmo_id); ?></span>
</span><?php } else { ?>
&nbsp;
<?php } ?>
</span></td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_tpmo_id_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_tpmo_id_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tpmo_projectid_line" id="hidden_field_data_tpmo_projectid" style="<?php echo $sStyleHidden_tpmo_projectid; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tpmo_projectid_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tpmo_projectid_label"><span id="id_label_tpmo_projectid"><?php echo $this->nm_new_label['tpmo_projectid']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['php_cmp_required']['tpmo_projectid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['php_cmp_required']['tpmo_projectid'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tpmo_namanode_line" id="hidden_field_data_tpmo_namanode" style="<?php echo $sStyleHidden_tpmo_namanode; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tpmo_namanode_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tpmo_namanode_label"><span id="id_label_tpmo_namanode"><?php echo $this->nm_new_label['tpmo_namanode']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['php_cmp_required']['tpmo_namanode']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['php_cmp_required']['tpmo_namanode'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_tpmo_id_dumb = ('' == $sStyleHidden_tpmo_id) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_tpmo_id_dumb" style="<?php echo $sStyleHidden_tpmo_id_dumb; ?>"></TD>
<?php $sStyleHidden_tpmo_projectid_dumb = ('' == $sStyleHidden_tpmo_projectid) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_tpmo_projectid_dumb" style="<?php echo $sStyleHidden_tpmo_projectid_dumb; ?>"></TD>
<?php $sStyleHidden_tpmo_namanode_dumb = ('' == $sStyleHidden_tpmo_namanode) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_tpmo_namanode_dumb" style="<?php echo $sStyleHidden_tpmo_namanode_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tpmo_awal_line" id="hidden_field_data_tpmo_awal" style="<?php echo $sStyleHidden_tpmo_awal; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tpmo_awal_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tpmo_awal_label"><span id="id_label_tpmo_awal"><?php echo $this->nm_new_label['tpmo_awal']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['php_cmp_required']['tpmo_awal']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['php_cmp_required']['tpmo_awal'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tpmo_jmlodp_line" id="hidden_field_data_tpmo_jmlodp" style="<?php echo $sStyleHidden_tpmo_jmlodp; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tpmo_jmlodp_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tpmo_jmlodp_label"><span id="id_label_tpmo_jmlodp"><?php echo $this->nm_new_label['tpmo_jmlodp']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['php_cmp_required']['tpmo_jmlodp']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['php_cmp_required']['tpmo_jmlodp'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tpmo_akhir_line" id="hidden_field_data_tpmo_akhir" style="<?php echo $sStyleHidden_tpmo_akhir; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tpmo_akhir_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tpmo_akhir_label"><span id="id_label_tpmo_akhir"><?php echo $this->nm_new_label['tpmo_akhir']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['php_cmp_required']['tpmo_akhir']) || $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['php_cmp_required']['tpmo_akhir'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_tpmo_awal_dumb = ('' == $sStyleHidden_tpmo_awal) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_tpmo_awal_dumb" style="<?php echo $sStyleHidden_tpmo_awal_dumb; ?>"></TD>
<?php $sStyleHidden_tpmo_jmlodp_dumb = ('' == $sStyleHidden_tpmo_jmlodp) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_tpmo_jmlodp_dumb" style="<?php echo $sStyleHidden_tpmo_jmlodp_dumb; ?>"></TD>
<?php $sStyleHidden_tpmo_akhir_dumb = ('' == $sStyleHidden_tpmo_akhir) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_tpmo_akhir_dumb" style="<?php echo $sStyleHidden_tpmo_akhir_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $sStyleHidden_tpmo_merk_dumb = ('' == $sStyleHidden_tpmo_merk) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_tpmo_merk_dumb" style="<?php echo $sStyleHidden_tpmo_merk_dumb; ?>"></TD>
<?php $sStyleHidden_tpmo_kapport_dumb = ('' == $sStyleHidden_tpmo_kapport) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_tpmo_kapport_dumb" style="<?php echo $sStyleHidden_tpmo_kapport_dumb; ?>"></TD>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detail'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detail'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['odp_master_edit_detail_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detail'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['odp_master_edit_detail_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['odp_master_edit_detail_script_case_init'] ]['odp_master_edit_detail']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['odp_master_edit_detail_script_case_init'] ]['odp_master_edit_detail']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['odp_master_edit_detail_script_case_init'] ]['odp_master_edit_detail']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['odp_master_edit_detail_script_case_init'] ]['odp_master_edit_detail']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['odp_master_edit_detail_script_case_init'] ]['odp_master_edit_detail']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['odp_master_edit_detail_script_case_init'] ]['odp_master_edit_detail']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['odp_master_edit_detail_script_case_init'] ]['odp_master_edit_detail']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['odp_master_edit_detail_script_case_init'] ]['odp_master_edit_detail']['embutida_liga_form_btn_nav'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['odp_master_edit_detail_script_case_init'] ]['odp_master_edit_detail']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['odp_master_edit_detail_script_case_init'] ]['odp_master_edit_detail']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['odp_master_edit_detail_script_case_init'] ]['odp_master_edit_detail']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['odp_master_edit_detail_script_case_init'] ]['odp_master_edit_detail']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['odp_master_edit_detail_script_case_init'] ]['project_edit_update_main_odpedit']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'project_edit_update_main_odpedit_empty.htm' : $this->Ini->link_odp_master_edit_detail_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_detail']) && 'nmsc_iframe_liga_odp_master_edit_detail' != $this->Ini->sc_lig_target['C_@scinf_detail'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detail'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['odp_master_edit_detail_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_odp_master_edit_detail"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_odp_master_edit_detail"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['project_edit_update_main_odpedit']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("project_edit_update_main_odpedit");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("project_edit_update_main_odpedit");
 parent.scAjaxDetailHeight("project_edit_update_main_odpedit", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
