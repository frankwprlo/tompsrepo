...
$old_error_handler = set_error_handler("project_edit_update_main_odpedit_scriptcase_error_handler");

function project_edit_update_main_odpedit_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['project_edit_update_main_odpedit']['contr_erro']) && $_SESSION['scriptcase']['project_edit_update_main_odpedit']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_project_edit_update_main_odpedit->contr_project_edit_update_main_odpedit->Apl_com_erro = true;
            if ($inicial_project_edit_update_main_odpedit->contr_project_edit_update_main_odpedit->NM_ajax_flag)
            {
                $inicial_project_edit_update_main_odpedit->contr_project_edit_update_main_odpedit->NM_ajax_info['errList']['geral_project_edit_update_main_odpedit'][] = $msg;
                return;
            }
            project_edit_update_main_odpedit_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function project_edit_update_main_odpedit_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['project_edit_update_main_odpedit'])  && '' != $_SESSION['scriptcase']['error_icon']['project_edit_update_main_odpedit'])  ? $_SESSION['scriptcase']['error_icon']['project_edit_update_main_odpedit']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['project_edit_update_main_odpedit']) && '' != $_SESSION['scriptcase']['error_close']['project_edit_update_main_odpedit']) ? $_SESSION['scriptcase']['error_close']['project_edit_update_main_odpedit'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['project_edit_update_main_odpedit']) && '' != $_SESSION['scriptcase']['error_span_title']['project_edit_update_main_odpedit']) ? $_SESSION['scriptcase']['error_span_title']['project_edit_update_main_odpedit'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['project_edit_update_main_odpedit']) && '' != $_SESSION['scriptcase']['error_icon_title']['project_edit_update_main_odpedit']) ? $_SESSION['scriptcase']['error_icon_title']['project_edit_update_main_odpedit'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['project_edit_update_main_odpedit']['error_buffer'] .= ob_get_flush();
}
