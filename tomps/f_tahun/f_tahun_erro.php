...
$old_error_handler = set_error_handler("f_tahun_scriptcase_error_handler");

function f_tahun_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['f_tahun']['contr_erro']) && $_SESSION['scriptcase']['f_tahun']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_f_tahun->contr_f_tahun->Apl_com_erro = true;
            if ($inicial_f_tahun->contr_f_tahun->NM_ajax_flag)
            {
                $inicial_f_tahun->contr_f_tahun->NM_ajax_info['errList']['geral_f_tahun'][] = $msg;
                return;
            }
            f_tahun_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function f_tahun_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['f_tahun'])  && '' != $_SESSION['scriptcase']['error_icon']['f_tahun'])  ? $_SESSION['scriptcase']['error_icon']['f_tahun']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['f_tahun']) && '' != $_SESSION['scriptcase']['error_close']['f_tahun']) ? $_SESSION['scriptcase']['error_close']['f_tahun'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['f_tahun']) && '' != $_SESSION['scriptcase']['error_span_title']['f_tahun']) ? $_SESSION['scriptcase']['error_span_title']['f_tahun'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['f_tahun']) && '' != $_SESSION['scriptcase']['error_icon_title']['f_tahun']) ? $_SESSION['scriptcase']['error_icon_title']['f_tahun'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['f_tahun']['error_buffer'] .= ob_get_flush();
}
