<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="tmt_tahun_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['tmt_tahun_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="f_tahun"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_f_tahun_submit_form(y, z); 
} 
<?php
}
?>
