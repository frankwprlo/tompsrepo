 ...
 */
    ...
    session_start();
    $SC_apl_proc = "project_edit_update_main_jadwal";
...
<?php
 ...
 $sDisplay = !isset($_SESSION['sc_session']['project_edit_update_main_jadwal']['show_skip_charts_option']) || !$_SESSION['sc_session']['project_edit_update_main_jadwal']['show_skip_charts_option'] ? ' style="display: none"' : '';
?>
 <tr<?php echo $sDisplay; ?>>
   <td class="scGridFieldOddFont">
